...
FT_02_WD=%p
FT_03_LB=_Link 
FT_03_CM=catalina %o *.obj -o "%e"
FT_03_WD=%p
FT_04_LB=Clea_n
FT_04_CM=cmd.exe /c "del /f /q %e *.binary *.eeprom *.bin *.debug *.dbg *.lst *.obj *.s"
FT_04_WD=%p
FT_05_LB=
FT_05_CM=
FT_05_WD=
...
EX_05_CM=cmd.exe /k "%LCCDIR%/use_catalina"  
EX_05_WD=%p
