...
'
 ...
 alignl ' align long
C_s7gs_5f5d7be0_two_digits_L000001 ' <symbol:two_digits>
 PRIMITIVE(#PSHM)
 ...
 cmps r19,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_s7gs_5f5d7be0_two_digits_L000001_3 ' NEI4
 ...
 mov r22, #32 ' reg <- coni
 wrbyte r22, r23 ' ASGNU1 reg reg
C_s7gs_5f5d7be0_two_digits_L000001_3
...
' C_s7gs_5f5d7be0_two_digits_L000001_2 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETN)


 alignl ' align long
C_s7gs1_5f5d7be0_four_digits_L000005 ' <symbol:four_digits>
 PRIMITIVE(#PSHM)
 ...
 mov r23, r22 ' CVI, CVU or LOAD
 mov r0, r22 ' CVI, CVU or LOAD
' C_s7gs1_5f5d7be0_four_digits_L000005_6 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETN)
...
C_asctime_16
 ...
 PRIMITIVE(#CALA)
 long @C_s7gs_5f5d7be0_two_digits_L000001
 add SP, #8 ' CALL addrg
 ...
 sub SP, #4 ' stack space for reg ARGs
 PRIMITIVE(#CALA)
 long @C_s7gs1_5f5d7be0_four_digits_L000005
 add SP, #4 ' CALL addrg
 PRIMITIVE(#LODL)
 long @C_asctime_buf_L000009
 mov r0, RI ' reg <- addrg
