...
DAT ' initialized data segment
 ...
 alignl ' align long
C_snls_619c55ed_rxbase_L000002 ' <symbol:rxbase>
 long $0

 alignl ' align long
C_snls1_619c55ed_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_snls2_619c55ed_initialize_L000004 ' <symbol:initialize>
 PRIMITIVE(#NEWF)
 sub SP, #8
 PRIMITIVE(#PSHM)
 long $540000 ' save registers
 PRIMITIVE(#LODI)
 long @C_snls_619c55ed_rxbase_L000002
 mov r22, RI ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_snls2_619c55ed_initialize_L000004_6 ' NEU4
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_snls2_619c55ed_initialize_L000004_8 ' LTI4
 ...
 PRIMITIVE(#LODL)
 long @C_snls1_619c55ed_lock_L000003
 ...
 cmps r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_snls2_619c55ed_initialize_L000004_10 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_snls2_619c55ed_initialize_L000004_11 ' LTI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODI)
 ...
 PRIMITIVE(#JMPA)
 long @C_snls2_619c55ed_initialize_L000004_11 ' JUMPV addrg
C_snls2_619c55ed_initialize_L000004_10
 PRIMITIVE(#LODL)
 long @C_snls1_619c55ed_lock_L000003
 ...
 long @C_snls1_619c55ed_lock_L000003
 wrlong r22, RI ' ASGNI4 addrg reg
C_snls2_619c55ed_initialize_L000004_11
C_snls2_619c55ed_initialize_L000004_8
C_snls2_619c55ed_initialize_L000004_6
' C_snls2_619c55ed_initialize_L000004_5 ' (symbol refcount = 0)
...
C_s4_rxflush ' <symbol:s4_rxflush>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_snls2_619c55ed_initialize_L000004 ' CALL addrg
C_s4_rxflush_15
 cmp r23,  #3 wcz 
 PRIMITIVE(#BRBE)
...
C_s4_rxcheck_27
 ...
 PRIMITIVE(#JMPA)
 long @C_s4_rxcheck_30 ' JUMPV addrg
C_s4_rxcheck_29
 PRIMITIVE(#LODL)
 long -1
 mov r22, RI ' reg <- con
...
C_s4_rx_34
 cmp r23,  #3 wcz 
 PRIMITIVE(#BRBE)
 long @C_s4_rx_39 ' LEU4
 PRIMITIVE(#LODL)
 long -1
 mov r0, RI ' reg <- con
 PRIMITIVE(#JMPA)
 long @C_s4_rx_33 ' JUMPV addrg
C_s4_rx_38
C_s4_rx_39
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_s4_tx_42
 cmp r23,  #3 wcz 
 PRIMITIVE(#BRBE)
 long @C_s4_tx_44 ' LEU4
 PRIMITIVE(#LODL)
 long -1
 mov r0, RI ' reg <- con
 PRIMITIVE(#JMPA)
 long @C_s4_tx_41 ' JUMPV addrg
C_s4_tx_44
 PRIMITIVE(#LODI)
 long @C_snls1_619c55ed_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
...
C_s4_txflush_56
 cmp r23,  #3 wcz 
 PRIMITIVE(#BRBE)
 long @C_s4_txflush_58 ' LEU4
 PRIMITIVE(#LODL)
 long -1
 mov r0, RI ' reg <- con
 PRIMITIVE(#JMPA)
 long @C_s4_txflush_55 ' JUMPV addrg
C_s4_txflush_58
 PRIMITIVE(#LODI)
 long @C_snls1_619c55ed_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
...
C_s4_txflush_63
 ...
 cmps r18, r22 wz
 PRIMITIVE(#BRNZ)
 long @C_s4_txflush_62 ' NEI4
 PRIMITIVE(#LODI)
 long @C_snls1_619c55ed_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_s4_txflush_65 ' LTI4
 PRIMITIVE(#LODI)
 long @C_snls1_619c55ed_lock_L000003
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_s4_txcheck_68
 cmp r23,  #3 wcz 
 PRIMITIVE(#BRBE)
 long @C_s4_txcheck_70 ' LEU4
 PRIMITIVE(#LODL)
 long -1
 mov r0, RI ' reg <- con
 PRIMITIVE(#JMPA)
 long @C_s4_txcheck_67 ' JUMPV addrg
C_s4_txcheck_70
 PRIMITIVE(#LODI)
 long @C_snls1_619c55ed_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
