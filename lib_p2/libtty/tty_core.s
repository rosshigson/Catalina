...
DAT ' initialized data segment
 ...
 alignl ' align long
C_se0o_6188be6f_rxbase_L000002 ' <symbol:rxbase>
 long $0

 alignl ' align long
C_se0o1_6188be6f_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_se0o2_6188be6f_initialize_L000004 ' <symbol:initialize>
 PRIMITIVE(#NEWF)
 sub SP, #8
 PRIMITIVE(#PSHM)
 long $540000 ' save registers
 PRIMITIVE(#LODI)
 long @C_se0o_6188be6f_rxbase_L000002
 mov r22, RI ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_se0o2_6188be6f_initialize_L000004_6 ' NEU4
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_se0o2_6188be6f_initialize_L000004_8 ' LTI4
 ...
 PRIMITIVE(#LODL)
 long @C_se0o1_6188be6f_lock_L000003
 ...
 cmps r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_se0o2_6188be6f_initialize_L000004_10 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_se0o2_6188be6f_initialize_L000004_11 ' LTI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODI)
 ...
 PRIMITIVE(#JMPA)
 long @C_se0o2_6188be6f_initialize_L000004_11 ' JUMPV addrg
C_se0o2_6188be6f_initialize_L000004_10
 PRIMITIVE(#LODL)
 long @C_se0o1_6188be6f_lock_L000003
 ...
 long @C_se0o1_6188be6f_lock_L000003
 wrlong r22, RI ' ASGNI4 addrg reg
C_se0o2_6188be6f_initialize_L000004_11
C_se0o2_6188be6f_initialize_L000004_8
C_se0o2_6188be6f_initialize_L000004_6
' C_se0o2_6188be6f_initialize_L000004_5 ' (symbol refcount = 0)
...
C_tty_rxflush ' <symbol:tty_rxflush>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_se0o2_6188be6f_initialize_L000004 ' CALL addrg
C_tty_rxflush_17
C_tty_rxflush_18
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
