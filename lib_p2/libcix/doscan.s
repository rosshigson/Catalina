...
'
 ...
 alignl ' align long
C_scso2_6174ad1b_o_collect_L000005 ' <symbol:o_collect>
 PRIMITIVE(#NEWF)
 PRIMITIVE(#PSHM)
 ...
 PRIMITIVE(#LODL)
 long @C_scso1_6174ad1b_inp_buf_L000004
 ...
 cmps r11, r22 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_10 ' EQI4
 cmps r11, r22 wcz
 PRIMITIVE(#BR_A)
 long @C_scso2_6174ad1b_o_collect_L000005_15 ' GTI4
' C_scso2_6174ad1b_o_collect_L000005_14 ' (symbol refcount = 0)
 mov r22, #88 ' reg <- coni
 cmps r11, r22 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_10 ' EQI4
 cmps r11, r22 wcz
 PRIMITIVE(#BR_B)
 long @C_scso2_6174ad1b_o_collect_L000005_7 ' LTI4
' C_scso2_6174ad1b_o_collect_L000005_16 ' (symbol refcount = 0)
 cmps r11,  #98 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_13 ' EQI4
 cmps r11,  #100 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_11 ' EQI4
 PRIMITIVE(#JMPA)
 long @C_scso2_6174ad1b_o_collect_L000005_7 ' JUMPV addrg
C_scso2_6174ad1b_o_collect_L000005_15
 mov r22, #111 ' reg <- coni
 cmps r11, r22 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_12 ' EQI4
 cmps r11,  #112 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_10 ' EQI4
 cmps r11, r22 wcz
 PRIMITIVE(#BR_B)
 long @C_scso2_6174ad1b_o_collect_L000005_7 ' LTI4
' C_scso2_6174ad1b_o_collect_L000005_17 ' (symbol refcount = 0)
 cmps r11,  #117 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_11 ' EQI4
 cmps r11,  #120 wz
 ...
 PRIMITIVE(#JMPA)
 long @C_scso2_6174ad1b_o_collect_L000005_7 ' JUMPV addrg
C_scso2_6174ad1b_o_collect_L000005_10
 mov r13, #16 ' reg <- coni
 PRIMITIVE(#JMPA)
 long @C_scso2_6174ad1b_o_collect_L000005_8 ' JUMPV addrg
C_scso2_6174ad1b_o_collect_L000005_11
 mov r13, #10 ' reg <- coni
 PRIMITIVE(#JMPA)
 long @C_scso2_6174ad1b_o_collect_L000005_8 ' JUMPV addrg
C_scso2_6174ad1b_o_collect_L000005_12
 mov r13, #8 ' reg <- coni
 PRIMITIVE(#JMPA)
 long @C_scso2_6174ad1b_o_collect_L000005_8 ' JUMPV addrg
C_scso2_6174ad1b_o_collect_L000005_13
 mov r13, #2 ' reg <- coni
C_scso2_6174ad1b_o_collect_L000005_7
C_scso2_6174ad1b_o_collect_L000005_8
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #45 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_20 ' EQI4
 cmps r22,  #43 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_18 ' NEI4
C_scso2_6174ad1b_o_collect_L000005_20
 ...
 cmps r22,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_21 ' EQI4
...
C_scso2_6174ad1b_o_collect_L000005_21
C_scso2_6174ad1b_o_collect_L000005_18
 cmps r19,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_23 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #48 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_23 ' NEI4
 cmps r13,  #16 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_23 ' NEI4
 mov r22, r15 ' CVI, CVU or LOAD
 ...
 cmps r22,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_25 ' EQI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 PRIMITIVE(#CALA)
 long @C_getc ' CALL addrg
 ...
 long 8
 wrlong r0, RI ' ASGNI4 addrl reg
C_scso2_6174ad1b_o_collect_L000005_25
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #120 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_27 ' EQI4
 cmps r22,  #88 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_27 ' EQI4
 mov r22, r21 ' CVUI
 ...
 cmps r22,  #105 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_38 ' NEI4
 mov r13, #8 ' reg <- coni
 PRIMITIVE(#JMPA)
 long @C_scso2_6174ad1b_o_collect_L000005_38 ' JUMPV addrg
C_scso2_6174ad1b_o_collect_L000005_27
 cmps r19,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_38 ' EQI4
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, FP
 ...
 PRIMITIVE(#JMPA)
 long @C_scso2_6174ad1b_o_collect_L000005_38 ' JUMPV addrg
C_scso2_6174ad1b_o_collect_L000005_23
 mov r22, r21 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #105 wz
 PRIMITIVE(#BRNZ)
 ...
 PRIMITIVE(#JMPA)
 long @C_scso2_6174ad1b_o_collect_L000005_38 ' JUMPV addrg
C_scso2_6174ad1b_o_collect_L000005_37
 cmps r13,  #10 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_44 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 cmp r22,  #10 wcz 
 PRIMITIVE(#BR_B)
 long @C_scso2_6174ad1b_o_collect_L000005_47' LTU4
C_scso2_6174ad1b_o_collect_L000005_44
 cmps r13,  #16 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_46 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 PRIMITIVE(#LODL)
 ...
 cmps r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_47 ' NEI4
C_scso2_6174ad1b_o_collect_L000005_46
 cmps r13,  #8 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_49 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, r22
 ...
 cmp r20,  #10 wcz 
 PRIMITIVE(#BRAE)
 long @C_scso2_6174ad1b_o_collect_L000005_49 ' GEU4
 cmps r22,  #56 wcz
 PRIMITIVE(#BR_B)
 long @C_scso2_6174ad1b_o_collect_L000005_47 ' LTI4
C_scso2_6174ad1b_o_collect_L000005_49
 cmps r13,  #2 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_39 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, r22
 ...
 cmp r20,  #10 wcz 
 PRIMITIVE(#BRAE)
 long @C_scso2_6174ad1b_o_collect_L000005_39 ' GEU4
 cmps r22,  #50 wcz
 PRIMITIVE(#BRAE)
 long @C_scso2_6174ad1b_o_collect_L000005_39 ' GEI4
C_scso2_6174ad1b_o_collect_L000005_47
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, FP
 ...
 cmps r22,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_41 ' EQI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 PRIMITIVE(#CALA)
 long @C_getc ' CALL addrg
 ...
 long 8
 wrlong r0, RI ' ASGNI4 addrl reg
C_scso2_6174ad1b_o_collect_L000005_41
C_scso2_6174ad1b_o_collect_L000005_38
 cmps r19,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_37 ' NEI4
C_scso2_6174ad1b_o_collect_L000005_39
 cmps r19,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_scso2_6174ad1b_o_collect_L000005_52 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 PRIMITIVE(#LODL)
 ...
 long @C_ungetc
 add SP, #4 ' CALL addrg
C_scso2_6174ad1b_o_collect_L000005_52
 mov r22, r21 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #105 wz
 PRIMITIVE(#BRNZ)
 long @C_scso2_6174ad1b_o_collect_L000005_54 ' NEI4
 mov r13, #0 ' reg <- coni
C_scso2_6174ad1b_o_collect_L000005_54
...
' C_scso2_6174ad1b_o_collect_L000005_6 ' (symbol refcount = 0)
...
C__doscan_133
 ...
 PRIMITIVE(#CALA)
 long @C_scso2_6174ad1b_o_collect_L000005
...
C__doscan_196
 PRIMITIVE(#LODL)
 long @C_scso_6174ad1b_X_table_L000003
...
C__doscan_200
 mov r22, r17 ' CVI, CVU or LOAD
 PRIMITIVE(#LODL)
 long @C_scso_6174ad1b_X_table_L000003+256
 mov r20, RI ' reg <- addrg
 cmp r22, r20 wcz 
 PRIMITIVE(#BR_B)
...
C__doscan_209
 mov r22, #1 ' reg <- coni
 PRIMITIVE(#LODL)
 long @C_scso_6174ad1b_X_table_L000003+45
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_scso1_6174ad1b_inp_buf_L000004 ' <symbol:inp_buf>
 byte 0[512]

 alignl ' align long
C_scso_6174ad1b_X_table_L000003 ' <symbol:Xtable>
 byte 0[256]
