...
C_spi_readE_E_P_R_O_M__2
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_spi_readE_E_P_R_O_M__7 ' LTI4
 PRIMITIVE(#LODI)
 long @C__spi_lock
...
C_spi_readE_E_P_R_O_M__7
 ...
 cmp r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_spi_readE_E_P_R_O_M__6 ' NEU4
 mov r22, r19
...
' C_spi_readE_E_P_R_O_M__10 ' (symbol refcount = 0)
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_spi_readE_E_P_R_O_M__12 ' LTI4
 PRIMITIVE(#LODI)
 long @C__spi_lock
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_spi_readE_E_P_R_O_M__12
 ...
 cmp r22,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_spi_readE_E_P_R_O_M__15 ' EQU4
 mov r17, #1 ' reg <- coni
 PRIMITIVE(#JMPA)
 long @C_spi_readE_E_P_R_O_M__16 ' JUMPV addrg
