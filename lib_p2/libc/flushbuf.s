...
'
 ...
 alignl ' align long
C_sf4g_6188be79_do_write_L000003 ' <symbol:do_write>
 PRIMITIVE(#PSHM)
 ...
 PRIMITIVE(#JMPA)
 long @C_sf4g_6188be79_do_write_L000003_6 ' JUMPV addrg
C_sf4g_6188be79_do_write_L000003_5
 subs r19, r17 ' SUBI/P (1)
 adds r21, r17 ' ADDI/P (2)
C_sf4g_6188be79_do_write_L000003_6
 ...
 cmps r0,  #0 wcz
 PRIMITIVE(#BRBE)
 long @C_sf4g_6188be79_do_write_L000003_8 ' LEI4
 cmps r17, r19 wcz
 PRIMITIVE(#BR_B)
 long @C_sf4g_6188be79_do_write_L000003_5 ' LTI4
C_sf4g_6188be79_do_write_L000003_8
 cmps r17,  #0 wcz
 PRIMITIVE(#BRBE)
 long @C_sf4g_6188be79_do_write_L000003_10 ' LEI4
 mov r15, #1 ' reg <- coni
 PRIMITIVE(#JMPA)
 long @C_sf4g_6188be79_do_write_L000003_11 ' JUMPV addrg
C_sf4g_6188be79_do_write_L000003_10
 mov r15, #0 ' reg <- coni
C_sf4g_6188be79_do_write_L000003_11
 mov r0, r15 ' CVI, CVU or LOAD
' C_sf4g_6188be79_do_write_L000003_4 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETN)


 alignl ' align long
C_sf4g1_6188be79_get_buf_L000012 ' <symbol:get_buf>
 PRIMITIVE(#NEWF)
 sub SP, #4
 PRIMITIVE(#PSHM)
 ...
 cmps r22, r20 wz
 PRIMITIVE(#BRNZ)
 long @C_sf4g1_6188be79_get_buf_L000012_14 ' NEI4
...
C_sf4g1_6188be79_get_buf_L000012_14
 PRIMITIVE(#LODI)
 long @C___iolock
 mov r22, RI ' reg <- INDIRI4 addrg
 PRIMITIVE(#LODL)
 ...
 cmps r22, r20 wz
 PRIMITIVE(#BRNZ)
 long @C_sf4g1_6188be79_get_buf_L000012_16 ' NEI4
 PRIMITIVE(#LODL)
 long 0
 mov r0, RI ' reg <- con
 PRIMITIVE(#JMPA)
 long @C_sf4g1_6188be79_get_buf_L000012_13 ' JUMPV addrg
C_sf4g1_6188be79_get_buf_L000012_16
 PRIMITIVE(#LODI)
 long @C___iolock
 ...
 cmps r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_sf4g1_6188be79_get_buf_L000012_18 ' NEI4
 PRIMITIVE(#LODL)
 long @C___iobuff
 mov BC, FP
 sub BC, #-(-4)
 ...
 PRIMITIVE(#JMPA)
 long @C_sf4g1_6188be79_get_buf_L000012_19 ' JUMPV addrg
C_sf4g1_6188be79_get_buf_L000012_18
 PRIMITIVE(#LODL)
 long 0
 mov r22, RI ' reg <- con
 PRIMITIVE(#LODF)
...
C_sf4g1_6188be79_get_buf_L000012_19
 PRIMITIVE(#LODI)
 long @C___iolock
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_sf4g1_6188be79_get_buf_L000012_13
 PRIMITIVE(#POPM) ' restore registers
 add SP, #4 ' framesize
 PRIMITIVE(#RETF)
...
C___flushbuf_41
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_sf4g1_6188be79_get_buf_L000012 ' CALL addrg
 mov r20, r21
...
C___flushbuf_62
 ...
 sub SP, #8 ' stack space for reg ARGs
 PRIMITIVE(#CALA)
 long @C_sf4g_6188be79_do_write_L000003
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C___flushbuf_58 ' NEI4
