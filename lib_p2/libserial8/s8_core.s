...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sgo0_6174ad00_s8base_L000002 ' <symbol:s8base>
 long $0

 alignl ' align long
C_sgo01_6174ad00_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_sgo03_6174ad00_pinconfig_L000005 ' <symbol:pinconfig>
 PRIMITIVE(#NEWF)
 sub SP, #4
 PRIMITIVE(#PSHM)
 ...
 cmps r17,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_sgo03_6174ad00_pinconfig_L000005_7 ' NEI4
 mov r22, #62 ' reg <- coni
 PRIMITIVE(#LODF)
 long -4
 ...
 cmp r22,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_sgo03_6174ad00_pinconfig_L000005_8 ' EQU4
 mov r22, FP
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 PRIMITIVE(#JMPA)
 long @C_sgo03_6174ad00_pinconfig_L000005_8 ' JUMPV addrg
C_sgo03_6174ad00_pinconfig_L000005_7
 ...
 cmps r13,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sgo03_6174ad00_pinconfig_L000005_11 ' LTI4
 cmps r13,  #3 wcz
 PRIMITIVE(#BR_A)
 long @C_sgo03_6174ad00_pinconfig_L000005_11 ' GTI4
 mov r22, r13
 shl r22, #2 ' LSHI4 coni
 PRIMITIVE(#LODL)
 long @C_sgo03_6174ad00_pinconfig_L000005_18_L000020
...
DAT ' const data segment
 ...
 alignl ' align long
C_sgo03_6174ad00_pinconfig_L000005_18_L000020 ' <symbol:18>
 long @C_sgo03_6174ad00_pinconfig_L000005_12
 long @C_sgo03_6174ad00_pinconfig_L000005_15
 long @C_sgo03_6174ad00_pinconfig_L000005_16
 long @C_sgo03_6174ad00_pinconfig_L000005_17

' Catalina Code

DAT ' code segment
C_sgo03_6174ad00_pinconfig_L000005_15
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODL)
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 PRIMITIVE(#JMPA)
 long @C_sgo03_6174ad00_pinconfig_L000005_12 ' JUMPV addrg
C_sgo03_6174ad00_pinconfig_L000005_16
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODL)
 ...
 PRIMITIVE(#JMPA)
 long @C_sgo03_6174ad00_pinconfig_L000005_12 ' JUMPV addrg
C_sgo03_6174ad00_pinconfig_L000005_17
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODL)
 ...
 long -4
 wrlong r22, RI ' ASGNU4 addrl reg
C_sgo03_6174ad00_pinconfig_L000005_11
C_sgo03_6174ad00_pinconfig_L000005_12
C_sgo03_6174ad00_pinconfig_L000005_8
...
' C_sgo03_6174ad00_pinconfig_L000005_6 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sgo06_6174ad00_p_config_L000021 ' <symbol:p_config>
 PRIMITIVE(#NEWF)
 PRIMITIVE(#PSHM)
 ...
 PRIMITIVE(#LODI)
 long @C_sgo0_6174ad00_s8base_L000002
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_sgo06_6174ad00_p_config_L000021_22 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETF)


 alignl ' align long
C_sgo07_6174ad00_autoinitialize_L000023 ' <symbol:autoinitialize>
 PRIMITIVE(#PSHM)
 long $fea800 ' save registers
 PRIMITIVE(#LODL)
 long @C_sgo02_6174ad00_txrxbuff_L000004
 ...
 cmp r22,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_sgo07_6174ad00_autoinitialize_L000023_25 ' EQU4
 mov r15, #0 ' reg <- coni
C_sgo07_6174ad00_autoinitialize_L000023_27
 mov r21, r15
 ...
 cmps r23,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sgo07_6174ad00_autoinitialize_L000023_31 ' LTI4
 cmps r23,  #63 wcz
 PRIMITIVE(#BR_A)
 long @C_sgo07_6174ad00_autoinitialize_L000023_31 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 PRIMITIVE(#LODI)
 long @C_sgo0_6174ad00_s8base_L000002
 ...
 sub SP, #12 ' stack space for reg ARGs
 PRIMITIVE(#CALA)
 long @C_sgo03_6174ad00_pinconfig_L000005
 add SP, #12 ' CALL addrg
 mov r2, r19
 ...
 PRIMITIVE(#CALA)
 long @C_sgo06_6174ad00_p_config_L000021
 add SP, #20 ' CALL addrg
C_sgo07_6174ad00_autoinitialize_L000023_31
 ...
 cmps r23,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sgo07_6174ad00_autoinitialize_L000023_33 ' LTI4
 cmps r23,  #63 wcz
 PRIMITIVE(#BR_A)
 long @C_sgo07_6174ad00_autoinitialize_L000023_33 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 PRIMITIVE(#LODI)
 long @C_sgo0_6174ad00_s8base_L000002
 ...
 long @C_sgo06_6174ad00_p_config_L000021
 add SP, #20 ' CALL addrg
C_sgo07_6174ad00_autoinitialize_L000023_33
 add r19, #128 ' ADDU4 coni
 add r17, #128 ' ADDU4 coni
' C_sgo07_6174ad00_autoinitialize_L000023_28 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
 cmps r15,  #8 wcz
 PRIMITIVE(#BR_B)
 long @C_sgo07_6174ad00_autoinitialize_L000023_27 ' LTI4
C_sgo07_6174ad00_autoinitialize_L000023_25
' C_sgo07_6174ad00_autoinitialize_L000023_24 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETN)


 alignl ' align long
C_sgo08_6174ad00_initialize_L000035 ' <symbol:initialize>
 PRIMITIVE(#NEWF)
 sub SP, #8
 PRIMITIVE(#PSHM)
 ...
 cmp r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_sgo08_6174ad00_initialize_L000035_37 ' NEU4
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sgo08_6174ad00_initialize_L000035_39 ' LTI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 ...
 PRIMITIVE(#LODL)
 long @C_sgo01_6174ad00_lock_L000003
 mov r20, RI ' reg <- addrg
 ...
 cmps r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_sgo08_6174ad00_initialize_L000035_41 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sgo08_6174ad00_initialize_L000035_42 ' LTI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODI)
 ...
 PRIMITIVE(#JMPA)
 long @C_sgo08_6174ad00_initialize_L000035_42 ' JUMPV addrg
C_sgo08_6174ad00_initialize_L000035_41
 PRIMITIVE(#LODL)
 long @C_sgo01_6174ad00_lock_L000003
 mov r22, RI ' reg <- addrg
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 long @C_sgo01_6174ad00_lock_L000003
 wrlong r22, RI ' ASGNI4 addrg reg
C_sgo08_6174ad00_initialize_L000035_42
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_sgo07_6174ad00_autoinitialize_L000023 ' CALL addrg
C_sgo08_6174ad00_initialize_L000035_39
C_sgo08_6174ad00_initialize_L000035_37
' C_sgo08_6174ad00_initialize_L000035_36 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 add SP, #8 ' framesize
 PRIMITIVE(#RETF)
...
C_s8_closeport ' <symbol:s8_closeport>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_sgo08_6174ad00_initialize_L000035 ' CALL addrg
C_s8_closeport_46
 cmp r23,  #8 wcz 
 PRIMITIVE(#BRAE)
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_sgo02_6174ad00_txrxbuff_L000004 ' <symbol:txrxbuff>
 byte 0[1024]
