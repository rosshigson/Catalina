...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sjdc_6132d0dd_s8base_L000002 ' <symbol:s8base>
 long $0

 alignl ' align long
C_sjdc1_6132d0dd_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_sjdc3_6132d0dd_pinclear_L000005 ' <symbol:pinclear>
 PRIMITIVE(#PSHM)
 ...
 long @C__wrpin
 add SP, #4 ' CALL addrg
' C_sjdc3_6132d0dd_pinclear_L000005_6 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETN)


 alignl ' align long
C_sjdc4_6132d0dd_pinstart_L000007 ' <symbol:pinstart>
 PRIMITIVE(#PSHM)
...
' C_sjdc4_6132d0dd_pinstart_L000007_8 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETN)


 alignl ' align long
C_sjdc5_6132d0dd_pinconfig_L000009 ' <symbol:pinconfig>
 PRIMITIVE(#NEWF)
 sub SP, #4
 PRIMITIVE(#PSHM)
 ...
 cmps r17,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_sjdc5_6132d0dd_pinconfig_L000009_11 ' NEI4
 mov r22, #62 ' reg <- coni
 PRIMITIVE(#LODF)
 long -4
 ...
 cmp r22,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_sjdc5_6132d0dd_pinconfig_L000009_12 ' EQU4
 mov r22, FP
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 PRIMITIVE(#JMPA)
 long @C_sjdc5_6132d0dd_pinconfig_L000009_12 ' JUMPV addrg
C_sjdc5_6132d0dd_pinconfig_L000009_11
 ...
 cmps r13,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sjdc5_6132d0dd_pinconfig_L000009_15 ' LTI4
 cmps r13,  #3 wcz
 PRIMITIVE(#BR_A)
 long @C_sjdc5_6132d0dd_pinconfig_L000009_15 ' GTI4
 mov r22, r13
 shl r22, #2 ' LSHI4 coni
 PRIMITIVE(#LODL)
 long @C_sjdc5_6132d0dd_pinconfig_L000009_22_L000024
...
DAT ' const data segment
 ...
 alignl ' align long
C_sjdc5_6132d0dd_pinconfig_L000009_22_L000024 ' <symbol:22>
 long @C_sjdc5_6132d0dd_pinconfig_L000009_16
 long @C_sjdc5_6132d0dd_pinconfig_L000009_19
 long @C_sjdc5_6132d0dd_pinconfig_L000009_20
 long @C_sjdc5_6132d0dd_pinconfig_L000009_21

' Catalina Code

DAT ' code segment
C_sjdc5_6132d0dd_pinconfig_L000009_19
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODL)
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 PRIMITIVE(#JMPA)
 long @C_sjdc5_6132d0dd_pinconfig_L000009_16 ' JUMPV addrg
C_sjdc5_6132d0dd_pinconfig_L000009_20
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODL)
 ...
 PRIMITIVE(#JMPA)
 long @C_sjdc5_6132d0dd_pinconfig_L000009_16 ' JUMPV addrg
C_sjdc5_6132d0dd_pinconfig_L000009_21
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODL)
 ...
 long -4
 wrlong r22, RI ' ASGNU4 addrl reg
C_sjdc5_6132d0dd_pinconfig_L000009_15
C_sjdc5_6132d0dd_pinconfig_L000009_16
C_sjdc5_6132d0dd_pinconfig_L000009_12
 ...
 PRIMITIVE(#CALA)
 long @C_sjdc4_6132d0dd_pinstart_L000007
 add SP, #12 ' CALL addrg
' C_sjdc5_6132d0dd_pinconfig_L000009_10 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 add SP, #4 ' framesize
 PRIMITIVE(#RETF)
 ...
 alignl ' align long
C_sjdc8_6132d0dd_p_config_L000025 ' <symbol:p_config>
 PRIMITIVE(#NEWF)
 PRIMITIVE(#PSHM)
 ...
 PRIMITIVE(#LODI)
 long @C_sjdc_6132d0dd_s8base_L000002
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_sjdc8_6132d0dd_p_config_L000025_26 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETF)


 alignl ' align long
C_sjdc9_6132d0dd_autoinitialize_L000027 ' <symbol:autoinitialize>
 PRIMITIVE(#PSHM)
 long $fea800 ' save registers
 PRIMITIVE(#LODL)
 long @C_sjdc2_6132d0dd_txrxbuff_L000004
 ...
 cmp r22,  #0 wz
 PRIMITIVE(#BR_Z)
 long @C_sjdc9_6132d0dd_autoinitialize_L000027_29 ' EQU4
 mov r15, #0 ' reg <- coni
C_sjdc9_6132d0dd_autoinitialize_L000027_31
 mov r21, r15
 ...
 cmps r23,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sjdc9_6132d0dd_autoinitialize_L000027_35 ' LTI4
 cmps r23,  #63 wcz
 PRIMITIVE(#BR_A)
 long @C_sjdc9_6132d0dd_autoinitialize_L000027_35 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 PRIMITIVE(#LODI)
 long @C_sjdc_6132d0dd_s8base_L000002
 ...
 sub SP, #12 ' stack space for reg ARGs
 PRIMITIVE(#CALA)
 long @C_sjdc5_6132d0dd_pinconfig_L000009
 add SP, #12 ' CALL addrg
 mov r2, r19
 ...
 PRIMITIVE(#CALA)
 long @C_sjdc8_6132d0dd_p_config_L000025
 add SP, #20 ' CALL addrg
C_sjdc9_6132d0dd_autoinitialize_L000027_35
 ...
 cmps r23,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sjdc9_6132d0dd_autoinitialize_L000027_37 ' LTI4
 cmps r23,  #63 wcz
 PRIMITIVE(#BR_A)
 long @C_sjdc9_6132d0dd_autoinitialize_L000027_37 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 PRIMITIVE(#LODI)
 long @C_sjdc_6132d0dd_s8base_L000002
 ...
 long @C_sjdc8_6132d0dd_p_config_L000025
 add SP, #20 ' CALL addrg
C_sjdc9_6132d0dd_autoinitialize_L000027_37
 add r19, #128 ' ADDU4 coni
 add r17, #128 ' ADDU4 coni
' C_sjdc9_6132d0dd_autoinitialize_L000027_32 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
 cmps r15,  #8 wcz
 PRIMITIVE(#BR_B)
 long @C_sjdc9_6132d0dd_autoinitialize_L000027_31 ' LTI4
C_sjdc9_6132d0dd_autoinitialize_L000027_29
' C_sjdc9_6132d0dd_autoinitialize_L000027_28 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETN)


 alignl ' align long
C_sjdca_6132d0dd_initialize_L000039 ' <symbol:initialize>
 PRIMITIVE(#NEWF)
 sub SP, #8
 PRIMITIVE(#PSHM)
 ...
 cmp r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_sjdca_6132d0dd_initialize_L000039_41 ' NEU4
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sjdca_6132d0dd_initialize_L000039_43 ' LTI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 ...
 PRIMITIVE(#LODL)
 long @C_sjdc1_6132d0dd_lock_L000003
 mov r20, RI ' reg <- addrg
 ...
 cmps r22,  #0 wz
 PRIMITIVE(#BRNZ)
 long @C_sjdca_6132d0dd_initialize_L000039_45 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 ...
 cmps r22,  #0 wcz
 PRIMITIVE(#BR_B)
 long @C_sjdca_6132d0dd_initialize_L000039_46 ' LTI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 PRIMITIVE(#LODI)
 ...
 PRIMITIVE(#JMPA)
 long @C_sjdca_6132d0dd_initialize_L000039_46 ' JUMPV addrg
C_sjdca_6132d0dd_initialize_L000039_45
 PRIMITIVE(#LODL)
 long @C_sjdc1_6132d0dd_lock_L000003
 mov r22, RI ' reg <- addrg
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 long @C_sjdc1_6132d0dd_lock_L000003
 wrlong r22, RI ' ASGNI4 addrg reg
C_sjdca_6132d0dd_initialize_L000039_46
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_sjdc9_6132d0dd_autoinitialize_L000027 ' CALL addrg
C_sjdca_6132d0dd_initialize_L000039_43
C_sjdca_6132d0dd_initialize_L000039_41
' C_sjdca_6132d0dd_initialize_L000039_40 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 add SP, #8 ' framesize
 PRIMITIVE(#RETF)
...
C_s8_closeport ' <symbol:s8_closeport>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_sjdca_6132d0dd_initialize_L000039 ' CALL addrg
C_s8_closeport_50
 cmp r23,  #8 wcz 
 PRIMITIVE(#BRAE)
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 PRIMITIVE(#CALA)
 long @C_sjdc3_6132d0dd_pinclear_L000005 ' CALL addrg
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 PRIMITIVE(#LODI)
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_sjdc2_6132d0dd_txrxbuff_L000004 ' <symbol:txrxbuff>
 byte 0[1024]
