...
C_safe_gets ' <symbol:safe_gets>
 ...
 PRIMITIVE(#JMPA)
 long @C_safe_gets_3 ' JUMPV addrg
C_safe_gets_2
 ...
 cmps r17,  #8 wz
 PRIMITIVE(#BR_Z)
 long @C_safe_gets_7 ' EQI4
 cmps r17,  #127 wz
 PRIMITIVE(#BRNZ)
 long @C_safe_gets_5 ' NEI4
C_safe_gets_7
 mov r22, r19 ' CVI, CVU or LOAD
 mov r20, r23 ' CVI, CVU or LOAD
 cmp r22, r20 wcz 
 PRIMITIVE(#BRBE)
 long @C_safe_gets_8 ' LEU4
 PRIMITIVE(#LODL)
 long @C_safe_gets_10_L000011
...
C_safe_gets_12
 cmps r17,  #13 wz
 PRIMITIVE(#BR_Z)
 long @C_safe_gets_16 ' EQI4
 cmps r17,  #10 wz
 PRIMITIVE(#BRNZ)
 long @C_safe_gets_14 ' NEI4
C_safe_gets_16
 PRIMITIVE(#JMPA)
 long @C_safe_gets_4 ' JUMPV addrg
C_safe_gets_14
 mov r22, r19 ' CVI, CVU or LOAD
 mov r19, r22
