...
C_spi_readE_E_P_R_O_M__2
 ...
 alignl ' align long
 long I32_BR_B + (@C_spi_readE_E_P_R_O_M__7)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
...
C_spi_readE_E_P_R_O_M__7
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_readE_E_P_R_O_M__6)<<S32 ' NEU4 reg coni
...
' C_spi_readE_E_P_R_O_M__10 ' (symbol refcount = 0)
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_spi_readE_E_P_R_O_M__12)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_spi_readE_E_P_R_O_M__12
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_spi_readE_E_P_R_O_M__15)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r17)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_spi_readE_E_P_R_O_M__16)<<S32 ' JUMPV addrg
 alignl ' align long
