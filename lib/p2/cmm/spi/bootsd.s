...
C_spi_bootS_D_C_ard_5
 ...
 alignl ' align long
 long I32_BR_B + (@C_spi_bootS_D_C_ard_10)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
...
C_spi_bootS_D_C_ard_10
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_bootS_D_C_ard_9)<<S32 ' NEU4 reg coni
...
C_spi_bootS_D_C_ard_12
 ...
 alignl ' align long
 long I32_BR_Z + (@C_spi_bootS_D_C_ard_16)<<S32 ' EQI4 reg reg
...
' C_spi_bootS_D_C_ard_13 ' (symbol refcount = 0)
 ...
 alignl ' align long
 long I32_BR_B + (@C_spi_bootS_D_C_ard_12)<<S32 ' LTI4 reg coni
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_spi_bootS_D_C_ard_18)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_spi_bootS_D_C_ard_18
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_spi_bootS_D_C_ard_23)<<S32 ' LEI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_spi_bootS_D_C_ard_23
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_bootS_D_C_ard_22)<<S32 ' NEU4 reg coni
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_spi_getC_ontrol)<<S32 ' CALL addrg
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_spi_bootS_D_C_ard_26)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r13)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_spi_bootS_D_C_ard_27)<<S32 ' JUMPV addrg
 alignl ' align long
