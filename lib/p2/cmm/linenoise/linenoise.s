...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s634_67ea424d_unsupported_term_L000027 ' <symbol:unsupported_term>
 long @C_s6341_67ea424d_28_L000029
 long @C_s6342_67ea424d_30_L000031
 long @C_s6343_67ea424d_32_L000033
 long $0

 alignl ' align long
C_s6344_67ea424d_completionC_allback_L000034 ' <symbol:completionCallback>
 long $0

 alignl ' align long
C_s6345_67ea424d_hintsC_allback_L000035 ' <symbol:hintsCallback>
 long $0

 alignl ' align long
C_s6346_67ea424d_freeH_intsC_allback_L000036 ' <symbol:freeHintsCallback>
 long $0

 alignl ' align long
C_s634a_67ea424d_maskmode_L000040 ' <symbol:maskmode>
 long 0

 alignl ' align long
C_s634b_67ea424d_rawmode_L000041 ' <symbol:rawmode>
 long 0

 alignl ' align long
C_s634c_67ea424d_mlmode_L000042 ' <symbol:mlmode>
 long 0

 alignl ' align long
C_s634d_67ea424d_atexit_registered_L000043 ' <symbol:atexit_registered>
 long 0

 alignl ' align long
C_s634e_67ea424d_history_max_len_L000044 ' <symbol:history_max_len>
 long 100

 alignl ' align long
C_s634f_67ea424d_history_len_L000045 ' <symbol:history_len>
 long 0

 alignl ' align long
C_s634g_67ea424d_history_L000046 ' <symbol:history>
 long $0
...
C_linenoiseM_askM_odeE_nable ' <symbol:linenoiseMaskModeEnable>
 ...
 alignl ' align long
 long I32_LODA + (@C_s634a_67ea424d_maskmode_L000040)<<S32
...
C_linenoiseS_etM_ultiL_ine ' <symbol:linenoiseSetMultiLine>
 alignl ' align long
 long I32_LODA + (@C_s634c_67ea424d_mlmode_L000042)<<S32
...
' C_linenoiseS_etM_ultiL_ine_51 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s634j_67ea424d_isU_nsupportedT_erm_L000052 ' <symbol:isUnsupportedTerm>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $f00000<<S32 ' save registers
 ...
 alignl ' align long
 long @C_s634j_67ea424d_isU_nsupportedT_erm_L000052_54_L000055 ' reg ARG ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s634j_67ea424d_isU_nsupportedT_erm_L000052_56)<<S32 ' NEU4 reg coni
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_s634j_67ea424d_isU_nsupportedT_erm_L000052_53)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634j_67ea424d_isU_nsupportedT_erm_L000052_56
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_s634j_67ea424d_isU_nsupportedT_erm_L000052_61)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634j_67ea424d_isU_nsupportedT_erm_L000052_58
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_s634_67ea424d_unsupported_term_L000027 ' reg <- addrg
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s634j_67ea424d_isU_nsupportedT_erm_L000052_62)<<S32 ' NEI4 reg coni
 word I16A_MOVI + R0<<D16A + (1)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_s634j_67ea424d_isU_nsupportedT_erm_L000052_53)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634j_67ea424d_isU_nsupportedT_erm_L000052_62
' C_s634j_67ea424d_isU_nsupportedT_erm_L000052_59 ' (symbol refcount = 0)
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
C_s634j_67ea424d_isU_nsupportedT_erm_L000052_61
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s634j_67ea424d_isU_nsupportedT_erm_L000052_58)<<S32 ' NEU4 reg coni
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
C_s634j_67ea424d_isU_nsupportedT_erm_L000052_53
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064 ' <symbol:getCursorPosition>
 alignl ' align long
 ...
 alignl ' align long
 long @C_s634l_67ea424d_getC_ursorP_osition_L000064_68_L000069 ' reg ARG ADDRG
 ...
 alignl ' align long
 long I32_BR_Z + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_71)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_65)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_70
 ...
 alignl ' align long
 long I32_BR_Z + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_73)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_72)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_73
 word I16B_LODF + ((-36)&$1FF)<<S16B
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- addrl16
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_75)<<S32 ' NEI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_72)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_75
 word I16A_ADDI + (r19)<<D16A + (1)<<S16A ' ADDU4 reg coni
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_71
 word I16A_CMPI + (r19)<<D16A + (31)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_70)<<S32 ' LTU4 reg coni
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_72
 word I16B_LODF + ((-36)&$1FF)<<S16B
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- addrl16
 word I16A_ADDS + (r22)<<D16A + (r19)<<S16A ' ADDI/P (2)
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_80)<<S32 ' NEI4 reg coni
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_77)<<S32 ' EQI4 reg coni
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_80
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_65)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_77
 ...
 alignl ' align long
 long @C_s634l_67ea424d_getC_ursorP_osition_L000064_84_L000085 ' reg ARG ADDRG
 ...
 alignl ' align long
 long I32_BR_Z + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_81)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_s634l_67ea424d_getC_ursorP_osition_L000064_65)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_81
 word I16B_LODF + ((-40)&$1FF)<<S16B
 word I16A_RDLONG + (r0)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_65
 word I16B_POPM + 10<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086 ' <symbol:getColumns>
 alignl ' align long
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s634l_67ea424d_getC_ursorP_osition_L000064)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r17)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r17)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s634o_67ea424d_getC_olumns_L000086_88)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_s634o_67ea424d_getC_olumns_L000086_90)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086_88
 word I16A_MOVI + (r2)<<D16A + (6)<<S16A ' reg ARG coni
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s634o_67ea424d_getC_olumns_L000086_93_L000094 ' reg ARG ADDRG
 word I16A_MOV + (r4)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_my_write)<<S32
 ...
 alignl ' align long
 long I32_BR_Z + (@C_s634o_67ea424d_getC_olumns_L000086_91)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s634o_67ea424d_getC_olumns_L000086_90)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086_91
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s634o_67ea424d_getC_olumns_L000086_95)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_s634o_67ea424d_getC_olumns_L000086_90)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086_95
 word I16A_CMPS + (r19)<<D16A + (r17)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s634o_67ea424d_getC_olumns_L000086_97)<<S32 ' LEI4 reg reg
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' SUBI/P
 word I16A_SUBS + (r2)<<D16A + (r17)<<S16A ' SUBI/P (3)
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s634o_67ea424d_getC_olumns_L000086_99_L000100 ' reg ARG ADDRG
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s634o_67ea424d_getC_olumns_L000086_101)<<S32 ' NEI4 reg reg
 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086_101
 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086_97
 word I16A_MOV + (r0)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_s634o_67ea424d_getC_olumns_L000086_87)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086_90
 alignl ' align long
 long I32_MOVI + R0<<D32 + (80)<<S32 ' RET conli
 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086_87
...
' C_linenoiseC_learS_creen_103 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s634s_67ea424d_linenoiseB_eep_L000108 ' <symbol:linenoiseBeep>
 alignl ' align long
 long I32_NEWF + 0<<S32
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s634s_67ea424d_linenoiseB_eep_L000108_110_L000111 ' reg ARG ADDRG
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
...
' C_s634s_67ea424d_linenoiseB_eep_L000108_109 ' (symbol refcount = 0)
 word I16B_RETF + 0<<S32
 alignl ' align long

 alignl ' align long
C_s634u_67ea424d_freeC_ompletions_L000112 ' <symbol:freeCompletions>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $f00000<<S32 ' save registers
 ...
 alignl ' align long
 long I32_JMPA + (@C_s634u_67ea424d_freeC_ompletions_L000112_117)<<S32 ' JUMPV addrg
 alignl ' align long
C_s634u_67ea424d_freeC_ompletions_L000112_114
...
' C_s634u_67ea424d_freeC_ompletions_L000112_115 ' (symbol refcount = 0)
 word I16A_ADDI + (r21)<<D16A + (1)<<S16A ' ADDU4 reg coni
 alignl ' align long
C_s634u_67ea424d_freeC_ompletions_L000112_117
 word I16A_RDLONG + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRU4 reg
 word I16A_CMP + (r21)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s634u_67ea424d_freeC_ompletions_L000112_114)<<S32 ' LTU4 reg reg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s634u_67ea424d_freeC_ompletions_L000112_118)<<S32 ' EQU4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 long I32_CALA + (@C_free)<<S32 ' CALL addrg
 alignl ' align long
C_s634u_67ea424d_freeC_ompletions_L000112_118
' C_s634u_67ea424d_freeC_ompletions_L000112_113 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
DAT ' const data segment
 ...
 alignl ' align long
C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_121_L000122 ' <symbol:121>
 long $0
 long $0
...
DAT ' code segment
 ...
 alignl ' align long
C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038 ' <symbol:refreshLineWithCompletion>
 alignl ' align long
 ...
 alignl ' align long
 long @C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_121_L000122 ' reg <- addrg
 alignl ' align long
 long I32_CPYB + 8<<S32 ' ASGNB
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_123)<<S32 ' NEU4 reg coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 ...
 alignl ' align long
 long I32_LODI + (@C_s6344_67ea424d_completionC_allback_L000034)<<S32
 ...
 alignl ' align long
C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_123
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 alignl ' align long
 long I32_BRAE + (@C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_125)<<S32 ' GEU4 reg reg
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s6349_67ea424d_refreshL_ineW_ithF_lags_L000039)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
 ...
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNP4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_126)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_125
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_126
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- addrl16
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_130)<<S32 ' EQU4 reg reg
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s634u_67ea424d_freeC_ompletions_L000112)<<S32 ' CALL addrg
 alignl ' align long
C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_130
' C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038_120 ' (symbol refcount = 0)
...
DAT ' const data segment
 ...
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_134_L000135 ' <symbol:134>
 long $0
 long $0
...
DAT ' code segment
 ...
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132 ' <symbol:completeLine>
 alignl ' align long
 ...
 word I16B_LODL + (r1)<<D16B
 alignl ' align long
 long @C_s63410_67ea424d_completeL_ine_L000132_134_L000135 ' reg <- addrg
 alignl ' align long
 long I32_CPYB + 8<<S32 ' ASGNB
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((-16)&$1FF)<<S16B
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s63410_67ea424d_completeL_ine_L000132_136)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_CALA + (@C_s634s_67ea424d_linenoiseB_eep_L000108)<<S32 ' CALL addrg
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r23)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_s63410_67ea424d_completeL_ine_L000132_137)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_136
 word I16B_LODF + ((-16)&$1FF)<<S16B
 word I16A_RDBYTE + (r22)<<D16A + RI<<S16A ' reg <- INDIRU1 addrl16
 ...
 alignl ' align long
 long I32_BR_Z + (@C_s63410_67ea424d_completeL_ine_L000132_141)<<S32 ' EQI4 reg coni
 word I16A_CMPSI + (r19)<<D16A + (9)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s63410_67ea424d_completeL_ine_L000132_138)<<S32 ' LTI4 reg coni
' C_s63410_67ea424d_completeL_ine_L000132_154 ' (symbol refcount = 0)
 word I16A_CMPSI + (r19)<<D16A + (27)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s63410_67ea424d_completeL_ine_L000132_146)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s63410_67ea424d_completeL_ine_L000132_138)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_141
 word I16A_RDLONG + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s63410_67ea424d_completeL_ine_L000132_142)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (1)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r23)<<S16A ' ASGNI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_s63410_67ea424d_completeL_ine_L000132_143)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_142
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s63410_67ea424d_completeL_ine_L000132_144)<<S32 ' NEU4 reg reg
 alignl ' align long
 long I32_CALA + (@C_s634s_67ea424d_linenoiseB_eep_L000108)<<S32 ' CALL addrg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_144
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_143
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16B_LODF + ((-16)&$1FF)<<S16B
 word I16A_WRBYTE + (r22)<<D16A + RI<<S16A ' ASGNU1 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_s63410_67ea424d_completeL_ine_L000132_139)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_146
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 word I16B_LODF + ((-12)&$1FF)<<S16B
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_s63410_67ea424d_completeL_ine_L000132_147)<<S32 ' GEU4 reg reg
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s634i_67ea424d_refreshL_ine_L000048)<<S32 ' CALL addrg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_147
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r23)<<S16A ' ASGNI4 reg reg
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16B_LODF + ((-16)&$1FF)<<S16B
 ...
 long I32_JMPA + (@C_s63410_67ea424d_completeL_ine_L000132_139)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_138
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 word I16B_LODF + ((-12)&$1FF)<<S16B
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_s63410_67ea424d_completeL_ine_L000132_149)<<S32 ' GEU4 reg reg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 ...
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s63410_67ea424d_completeL_ine_L000132_151_L000152 ' reg ARG ADDRG
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 ...
 word I16A_WRLONG + (r22)<<D16A + (r20)<<S16A ' ASGNU4 reg reg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_149
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r23)<<S16A ' ASGNI4 reg reg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_139
 word I16A_RDLONG + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s63410_67ea424d_completeL_ine_L000132_155)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 word I16B_LODF + ((-12)&$1FF)<<S16B
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_s63410_67ea424d_completeL_ine_L000132_155)<<S32 ' GEU4 reg reg
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_s6348_67ea424d_refreshL_ineW_ithC_ompletion_L000038)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_s63410_67ea424d_completeL_ine_L000132_156)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_155
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s634i_67ea424d_refreshL_ine_L000048)<<S32 ' CALL addrg
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_156
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_137
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
...
' C_s63410_67ea424d_completeL_ine_L000132_133 ' (symbol refcount = 0)
...
C_linenoiseS_etC_ompletionC_allback ' <symbol:linenoiseSetCompletionCallback>
 alignl ' align long
 long I32_LODA + (@C_s6344_67ea424d_completionC_allback_L000034)<<S32
...
C_linenoiseS_etH_intsC_allback ' <symbol:linenoiseSetHintsCallback>
 alignl ' align long
 long I32_LODA + (@C_s6345_67ea424d_hintsC_allback_L000035)<<S32
 word I16A_WRLONG + (r2)<<D16A + RI<<S16A ' ASGNP4 addrg reg
...
C_linenoiseS_etF_reeH_intsC_allback ' <symbol:linenoiseSetFreeHintsCallback>
 alignl ' align long
 long I32_LODA + (@C_s6346_67ea424d_freeH_intsC_allback_L000036)<<S32
 word I16A_WRLONG + (r2)<<D16A + RI<<S16A ' ASGNP4 addrg reg
...
C_linenoiseA_ddC_ompletion_160
 ...
 alignl ' align long
C_s63413_67ea424d_abI_nit_L000165 ' <symbol:abInit>
 alignl ' align long
...
' C_s63413_67ea424d_abI_nit_L000165_166 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_s63414_67ea424d_abA_ppend_L000167 ' <symbol:abAppend>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $fa0000<<S32 ' save registers
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s63414_67ea424d_abA_ppend_L000167_169)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s63414_67ea424d_abA_ppend_L000167_168)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63414_67ea424d_abA_ppend_L000167_169
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
 alignl ' align long
C_s63414_67ea424d_abA_ppend_L000167_168
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s63415_67ea424d_abF_ree_L000171 ' <symbol:abFree>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_CALA + (@C_free)<<S32 ' CALL addrg
' C_s63415_67ea424d_abF_ree_L000171_172 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_refreshS_howH_ints ' <symbol:refreshShowHints>
 ...
 word I16A_MOV + (r19)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl ' align long
 long I32_LODI + (@C_s6345_67ea424d_hintsC_allback_L000035)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
...
C_refreshS_howH_ints_183
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_s63414_67ea424d_abA_ppend_L000167)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16B_LODF + ((-84)&$1FF)<<S16B
 word I16A_RDLONG + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRLi
 word I16B_LODF + ((-80)&$1FF)<<S16B
...
C_refreshS_howH_ints_187
 alignl ' align long
 long I32_LODI + (@C_s6346_67ea424d_freeH_intsC_allback_L000036)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
...
' C_refreshS_howH_ints_173 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194 ' <symbol:refreshSingleLine>
 alignl ' align long
 ...
 alignl ' align long
 long I32_JMPA + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_197)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_196
 ...
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_197
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_196)<<S32 ' GEU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_200)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_199
 word I16A_SUBI + (r19)<<D16A + (1)<<S16A ' SUBU4 reg coni
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_200
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A ' ADDU
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_199)<<S32 ' GTU4 reg reg
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s63413_67ea424d_abI_nit_L000165)<<S32 ' CALL addrg
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s63418_67ea424d_refreshS_ingleL_ine_L000194_202_L000203 ' reg ARG ADDRG
 alignl ' align long
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_204)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (24)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
 long I32_LODI + (@C_s634a_67ea424d_maskmode_L000040)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (1)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_206)<<S32 ' NEI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_209)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_208
 word I16A_MOVI + (r2)<<D16A + (1)<<S16A ' reg ARG coni
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s63418_67ea424d_refreshS_ingleL_ine_L000194_211_L000212 ' reg ARG ADDRG
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r4)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_209
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r19)<<D16A + (r22)<<S16A
 word I16A_SUBI + (r19)<<D16A + (1)<<S16A ' SUBU4 reg coni
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_208)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_207)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_206
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_207
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_204
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s63418_67ea424d_refreshS_ingleL_ine_L000194_213_L000214 ' reg ARG ADDRG
 alignl ' align long
 long I32_MOVI + (r3)<<D32 + (64)<<S32 ' reg ARG coni
 word I16B_LODF + ((-76)&$1FF)<<S16B
 word I16A_MOV + (r4)<<D16A + RI<<S16A ' reg ARG ADDRLi
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_215)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A ' ADDU
 word I16A_ADD + (r22)<<D16A + (r17)<<S16A ' ADDU (3)
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s63418_67ea424d_refreshS_ingleL_ine_L000194_217_L000218 ' reg ARG ADDRG
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_215
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((-12)&$1FF)<<S16B
 ...
 word I16A_CMPS + (r0)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194_219)<<S32 ' NEI4 reg reg
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_219
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s63415_67ea424d_abF_ree_L000171)<<S32 ' CALL addrg
' C_s63418_67ea424d_refreshS_ingleL_ine_L000194_195 ' (symbol refcount = 0)
 word I16B_POPM + 19<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222 ' <symbol:refreshMultiLine>
 alignl ' align long
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_224)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((-80)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_226)<<S32 ' LEI4 reg coni
 word I16B_LODF + ((-80)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_228_L000229 ' reg ARG ADDRG
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_230_L000231 ' reg ARG ADDRG
 alignl ' align long
 long I32_MOVI + (r4)<<D32 + (64)<<S32 ' reg ARG coni
 word I16B_LODF + ((-68)&$1FF)<<S16B
 word I16A_MOV + (r5)<<D16A + RI<<S16A ' reg ARG ADDRLi
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_226
 word I16A_MOVI + (r19)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_235)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_232
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_236_L000237 ' reg ARG ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_my_lndebug)<<S32 ' CALL addrg
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_238_L000239 ' reg ARG ADDRG
 alignl ' align long
 long I32_MOVI + (r3)<<D32 + (64)<<S32 ' reg ARG coni
 word I16B_LODF + ((-68)&$1FF)<<S16B
 word I16A_MOV + (r4)<<D16A + RI<<S16A ' reg ARG ADDRLi
 ...
 long I32_CALA + (@C_s63414_67ea424d_abA_ppend_L000167)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
' C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_233 ' (symbol refcount = 0)
 word I16A_ADDSI + (r19)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_235
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_SUBSI + (r22)<<D16A + (1)<<S16A ' SUBI4 reg coni
 word I16A_CMPS + (r19)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_232)<<S32 ' LTI4 reg reg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_224
 word I16A_MOVI + (r22)<<D16A + (3)<<S16A ' reg <- coni
 word I16A_AND + (r22)<<D16A + (r21)<<S16A ' BANDI/U (2)
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_240)<<S32 ' EQI4 reg coni
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_242_L000243 ' reg ARG ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_my_lndebug)<<S32 ' CALL addrg
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_244_L000245 ' reg ARG ADDRG
 alignl ' align long
 long I32_MOVI + (r3)<<D32 + (64)<<S32 ' reg ARG coni
 word I16B_LODF + ((-68)&$1FF)<<S16B
 word I16A_MOV + (r4)<<D16A + RI<<S16A ' reg ARG ADDRLi
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_240
 word I16A_MOVI + (r22)<<D16A + (2)<<S16A ' reg <- coni
 word I16A_AND + (r22)<<D16A + (r21)<<S16A ' BANDI/U (2)
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_246)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (24)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 word I16A_CMPSI + (r22)<<D16A + (1)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_248)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r11)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_253)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_250
 word I16A_MOVI + (r2)<<D16A + (1)<<S16A ' reg ARG coni
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s63418_67ea424d_refreshS_ingleL_ine_L000194_211_L000212 ' reg ARG ADDRG
 ...
 long I32_CALA + (@C_s63414_67ea424d_abA_ppend_L000167)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
' C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_251 ' (symbol refcount = 0)
 word I16A_ADDI + (r11)<<D16A + (1)<<S16A ' ADDU4 reg coni
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_253
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((40)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r23)<<S16A ' ADDI/P (2)
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 ...
 alignl ' align long
 long I32_BR_B + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_250)<<S32 ' LTU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_249)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_248
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((40)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r23)<<S16A ' ADDI/P (2)
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_249
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_254)<<S32 ' EQU4 reg coni
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((40)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r20)<<D16A + (r23)<<S16A ' ADDI/P (2)
 word I16A_RDLONG + (r20)<<D16A + (r20)<<S16A ' reg <- INDIRU4 reg
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_254)<<S32 ' NEU4 reg reg
 word I16A_MOV + (r20)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16A_ADD + (r22)<<D16A + (r20)<<S16A ' ADDU (1)
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((44)&$7FFFF)<<S32 ' reg <- cons
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_254)<<S32 ' NEU4 reg coni
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_256_L000257 ' reg ARG ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_my_lndebug)<<S32 ' CALL addrg
 word I16A_MOVI + (r2)<<D16A + (1)<<S16A ' reg ARG coni
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_258_L000259 ' reg ARG ADDRG
 word I16B_LODF + ((-76)&$1FF)<<S16B
 word I16A_MOV + (r4)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRBE + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_260)<<S32 ' LEI4 reg reg
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((48)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r23)<<S16A ' ADDI/P (2)
 word I16A_MOV + (r20)<<D16A + (r13)<<S16A ' CVI, CVU or LOAD
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNU4 reg reg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_260
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_254
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((44)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r23)<<S16A ' ADDI/P (2)
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 ...
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_262_L000263 ' reg ARG ADDRG
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_my_lndebug)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_264)<<S32 ' LEI4 reg coni
 word I16B_LODF + ((-84)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_266_L000267 ' reg ARG ADDRG
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_my_lndebug)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 ...
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_268_L000269 ' reg ARG ADDRG
 alignl ' align long
 long I32_MOVI + (r4)<<D32 + (64)<<S32 ' reg ARG coni
 word I16B_LODF + ((-68)&$1FF)<<S16B
 word I16A_MOV + (r5)<<D16A + RI<<S16A ' reg ARG ADDRLi
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_264
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((32)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r23)<<S16A ' ADDI/P (2)
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 ...
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_270_L000271 ' reg ARG ADDRG
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_my_lndebug)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_272)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((-92)&$1FF)<<S16B
 word I16A_RDLONG + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRLi
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_273)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_272
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s63418_67ea424d_refreshS_ingleL_ine_L000194_202_L000203 ' reg ARG ADDRG
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_273
 word I16B_LODF + ((-68)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_246
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_258_L000259 ' reg ARG ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 word I16A_CMPS + (r0)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_274)<<S32 ' NEI4 reg reg
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_274
 word I16B_LODF + ((-76)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s63415_67ea424d_abF_ree_L000171)<<S32 ' CALL addrg
' C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_223 ' (symbol refcount = 0)
 word I16B_POPM + 22<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s6349_67ea424d_refreshL_ineW_ithF_lags_L000039 ' <symbol:refreshLineWithFlags>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $e00000<<S32 ' save registers
 ...
 word I16A_MOV + (r21)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl ' align long
 long I32_LODI + (@C_s634c_67ea424d_mlmode_L000042)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s6349_67ea424d_refreshL_ineW_ithF_lags_L000039_278)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s6341d_67ea424d_refreshM_ultiL_ine_L000222)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_s6349_67ea424d_refreshL_ineW_ithF_lags_L000039_279)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6349_67ea424d_refreshL_ineW_ithF_lags_L000039_278
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s63418_67ea424d_refreshS_ingleL_ine_L000194)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_s6349_67ea424d_refreshL_ineW_ithF_lags_L000039_279
' C_s6349_67ea424d_refreshL_ineW_ithF_lags_L000039_277 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s634i_67ea424d_refreshL_ine_L000048 ' <symbol:refreshLine>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $800000<<S32 ' save registers
 ...
 long I32_CALA + (@C_s6349_67ea424d_refreshL_ineW_ithF_lags_L000039)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
' C_s634i_67ea424d_refreshL_ine_L000048_280 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_linenoiseE_ditH_istoryN_ext ' <symbol:linenoiseEditHistoryNext>
 ...
 word I16A_MOV + (r21)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl ' align long
 long I32_LODI + (@C_s634f_67ea424d_history_len_L000045)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (1)<<S16A
 alignl ' align long
 ...
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_s634g_67ea424d_history_L000046)<<S32
...
C_linenoiseE_ditS_tart_342
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s634o_67ea424d_getC_olumns_L000086)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r20)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 alignl ' align long
...
C_linenoiseE_ditM_ore ' <symbol:linenoiseEditMore>
 long @C_s6341r_67ea424d_347_L000348
...
C_linenoiseE_ditF_eed_354
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s63410_67ea424d_completeL_ine_L000132)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRBYTE + (r22)<<D16A + RI<<S16A ' ASGNU1 addrl16 reg
...
C_linenoiseE_ditF_eed_362
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_s634f_67ea424d_history_len_L000045 ' reg <- addrg
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_SUBSI + (r20)<<D16A + (1)<<S16A ' SUBI4 reg coni
 alignl ' align long
 long I32_LODA + (@C_s634f_67ea424d_history_len_L000045)<<S32
...
' C_linenoiseE_ditS_top_441 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s63420_67ea424d_linenoiseB_lockingE_dit_L000442 ' <symbol:linenoiseBlockingEdit>
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s63420_67ea424d_linenoiseB_lockingE_dit_L000442_444)<<S32 ' NEU4 reg coni
 ...
 long 0 ' RET con
 alignl ' align long
 long I32_JMPA + (@C_s63420_67ea424d_linenoiseB_lockingE_dit_L000442_443)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63420_67ea424d_linenoiseB_lockingE_dit_L000442_444
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 ...
 alignl ' align long
C_s63420_67ea424d_linenoiseB_lockingE_dit_L000442_446
' C_s63420_67ea424d_linenoiseB_lockingE_dit_L000442_447 ' (symbol refcount = 0)
 word I16B_LODF + ((-60)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s63420_67ea424d_linenoiseB_lockingE_dit_L000442_446)<<S32 ' EQU4 reg reg
 word I16B_LODF + ((-60)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 ...
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_s63420_67ea424d_linenoiseB_lockingE_dit_L000442_443
...
' C_linenoiseP_rintK_eyC_odes_449 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037 ' <symbol:linenoiseNoTTY>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $fa0000<<S32 ' save registers
 ...
 word I16A_MOVI + (r19)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_470)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_469
 word I16A_CMP + (r21)<<D16A + (r19)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_472)<<S32 ' NEU4 reg reg
 word I16A_CMPI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_474)<<S32 ' NEU4 reg coni
 word I16A_MOVI + (r19)<<D16A + (16)<<S16A ' reg <- coni
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_474
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_476)<<S32 ' NEU4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_478)<<S32 ' EQU4 reg coni
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_free)<<S32 ' CALL addrg
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_478
 word I16B_LODL + R0<<D16B
 alignl ' align long
 long 0 ' RET con
 alignl ' align long
 long I32_JMPA + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_468)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_476
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_472
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 ...
 word I16A_CMPS + (r17)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_482)<<S32 ' EQI4 reg reg
 word I16A_CMPSI + (r17)<<D16A + (10)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_480)<<S32 ' NEI4 reg coni
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_482
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r17)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_483)<<S32 ' NEI4 reg reg
 word I16A_CMPI + (r21)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_483)<<S32 ' NEU4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_free)<<S32 ' CALL addrg
 ...
 long I32_JMPA + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_468)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_483
 ...
 long I32_JMPA + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_468)<<S32 ' JUMPV addrg
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_480
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' ADDI/P
 word I16A_ADDS + (r22)<<D16A + (r23)<<S16A ' ADDI/P (3)
 word I16A_MOV + (r20)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 word I16A_ADDI + (r21)<<D16A + (1)<<S16A ' ADDU4 reg coni
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_470
 alignl ' align long
 long I32_JMPA + (@C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_469)<<S32 ' JUMPV addrg
 word I16B_LODL + R0<<D16B
 alignl ' align long
 long 0 ' RET con
 alignl ' align long
C_s6347_67ea424d_linenoiseN_oT_T_Y__L000037_468
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_linenoise ' <symbol:linenoise>
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_s63420_67ea424d_linenoiseB_lockingE_dit_L000442)<<S32
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 alignl ' align long
...
C_linenoiseF_ree_486
 ...
 alignl ' align long
C_s63424_67ea424d_freeH_istory_L000489 ' <symbol:freeHistory>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $d00000<<S32 ' save registers
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s63424_67ea424d_freeH_istory_L000489_491)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_s63424_67ea424d_freeH_istory_L000489_496)<<S32 ' JUMPV addrg
 alignl ' align long
C_s63424_67ea424d_freeH_istory_L000489_493
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_s634g_67ea424d_history_L000046)<<S32
 ...
 alignl ' align long
 long I32_CALA + (@C_free)<<S32 ' CALL addrg
' C_s63424_67ea424d_freeH_istory_L000489_494 ' (symbol refcount = 0)
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
C_s63424_67ea424d_freeH_istory_L000489_496
 alignl ' align long
 long I32_LODI + (@C_s634f_67ea424d_history_len_L000045)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPS + (r23)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s63424_67ea424d_freeH_istory_L000489_493)<<S32 ' LTI4 reg reg
 alignl ' align long
 long I32_LODI + (@C_s634g_67ea424d_history_L000046)<<S32
 ...
 long I32_CALA + (@C_free)<<S32 ' CALL addrg
 alignl ' align long
C_s63424_67ea424d_freeH_istory_L000489_491
' C_s63424_67ea424d_freeH_istory_L000489_490 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s634h_67ea424d_linenoiseA_tE_xit_L000047 ' <symbol:linenoiseAtExit>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_CALA + (@C_s63424_67ea424d_freeH_istory_L000489)<<S32 ' CALL addrg
' C_s634h_67ea424d_linenoiseA_tE_xit_L000047_497 ' (symbol refcount = 0)
 word I16B_RETF + 0<<S32
 alignl ' align long
...
C_linenoiseH_istoryA_dd ' <symbol:linenoiseHistoryAdd>
 ...
 word I16A_MOV + (r23)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl ' align long
 long I32_LODI + (@C_s634e_67ea424d_history_max_len_L000044)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
...
C_linenoiseH_istoryA_dd_499
 ...
 long I32_CALA + (@C_malloc)<<S32 ' CALL addrg
 alignl ' align long
 long I32_LODA + (@C_s634g_67ea424d_history_L000046)<<S32
...
C_linenoiseH_istoryS_etM_axL_en_514
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_s634e_67ea424d_history_max_len_L000044 ' reg <- addrg
 alignl ' align long
 long I32_LODA + (@C_s634e_67ea424d_history_max_len_L000044)<<S32
...
C_linenoiseP_rintK_eyC_odes_450_L000451 ' <symbol:450>
 ...
 alignl ' align long
C_s6341r_67ea424d_347_L000348 ' <symbol:347>
 byte 73
 byte 102
 byte 32
 byte 121
...
C_linenoiseE_ditS_tart_343_L000344 ' <symbol:343>
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_270_L000271 ' <symbol:270>
 byte 115
 byte 101
 byte 116
 byte 32
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_268_L000269 ' <symbol:268>
 byte 27
 byte 91
 byte 37
 byte 100
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_266_L000267 ' <symbol:266>
 byte 103
 byte 111
 byte 45
 byte 117
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_262_L000263 ' <symbol:262>
 byte 114
 byte 112
 byte 111
 byte 115
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_258_L000259 ' <symbol:258>
 byte 10
 byte 0

 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_256_L000257 ' <symbol:256>
 byte 60
 byte 110
 byte 101
 byte 119
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_244_L000245 ' <symbol:244>
 byte 13
 byte 27
 byte 91
 byte 48
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_242_L000243 ' <symbol:242>
 byte 99
 byte 108
 byte 101
 byte 97
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_238_L000239 ' <symbol:238>
 byte 13
 byte 27
 byte 91
 byte 48
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_236_L000237 ' <symbol:236>
 byte 99
 byte 108
 byte 101
 byte 97
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_230_L000231 ' <symbol:230>
 byte 27
 byte 91
 byte 37
 byte 100
 ...
 alignl ' align long
C_s6341d_67ea424d_refreshM_ultiL_ine_L000222_228_L000229 ' <symbol:228>
 byte 103
 byte 111
 byte 32
 byte 100
 ...
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_217_L000218 ' <symbol:217>
 byte 13
 byte 27
 byte 91
 byte 37
 ...
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_213_L000214 ' <symbol:213>
 byte 27
 byte 91
 byte 48
 byte 75
 ...
 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_211_L000212 ' <symbol:211>
 byte 42
 byte 0

 alignl ' align long
C_s63418_67ea424d_refreshS_ingleL_ine_L000194_202_L000203 ' <symbol:202>
 byte 13
 byte 0
...
C_refreshS_howH_ints_185_L000186 ' <symbol:185>
 ...
 alignl ' align long
C_s63410_67ea424d_completeL_ine_L000132_151_L000152 ' <symbol:151>
 byte 37
 byte 115
 byte 0

 alignl ' align long
C_s634s_67ea424d_linenoiseB_eep_L000108_110_L000111 ' <symbol:110>
 byte 7
 byte 0
...
C_linenoiseC_learS_creen_106_L000107 ' <symbol:106>
 ...
 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086_99_L000100 ' <symbol:99>
 byte 27
 byte 91
 byte 37
 byte 100
 ...
 alignl ' align long
C_s634o_67ea424d_getC_olumns_L000086_93_L000094 ' <symbol:93>
 byte 27
 byte 91
 byte 57
 byte 57
 ...
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_84_L000085 ' <symbol:84>
 byte 37
 byte 100
 byte 59
 byte 37
 ...
 alignl ' align long
C_s634l_67ea424d_getC_ursorP_osition_L000064_68_L000069 ' <symbol:68>
 byte 27
 byte 91
 byte 54
 byte 110
 ...
 alignl ' align long
C_s634j_67ea424d_isU_nsupportedT_erm_L000052_54_L000055 ' <symbol:54>
 byte 84
 byte 69
 byte 82
 byte 77
 ...
 alignl ' align long
C_s6343_67ea424d_32_L000033 ' <symbol:32>
 byte 101
 byte 109
 byte 97
 byte 99
 ...
 alignl ' align long
C_s6342_67ea424d_30_L000031 ' <symbol:30>
 byte 99
 byte 111
 byte 110
 byte 115
 ...
 alignl ' align long
C_s6341_67ea424d_28_L000029 ' <symbol:28>
 byte 100
 byte 117
 byte 109
 byte 98
