...
C_strcspn ' <symbol:strcspn>
 ...
 alignl ' align long
 long I32_JMPA + (@C_strcspn_5)<<S32 ' JUMPV addrg
 alignl ' align long
C_strcspn_2
 word I16A_MOV + (r21)<<D16A + (r2)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_strcspn_9)<<S32 ' JUMPV addrg
 alignl ' align long
C_strcspn_6
...
C_strcspn_9
 ...
 alignl ' align long
 long I32_BR_Z + (@C_strcspn_10)<<S32 ' EQI4 reg reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_strcspn_6)<<S32 ' NEI4 reg coni
 alignl ' align long
C_strcspn_10
 word I16A_RDBYTE + (r22)<<D16A + (r21)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_strcspn_11)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_strcspn_4)<<S32 ' JUMPV addrg
 alignl ' align long
C_strcspn_11
...
C_strcspn_5
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_strcspn_2)<<S32 ' NEI4 reg coni
 alignl ' align long
C_strcspn_4
