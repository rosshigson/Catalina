...
C_ldiv ' <symbol:ldiv>
 ...
 alignl ' align long
 long I32_BR_Z + (@C_ldiv_6)<<S32 ' EQI4 reg coni
 word I16A_CMPSI + (r3)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_ldiv_12)<<S32 ' LEI4 reg coni
 word I16A_MOVI + (r23)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_ldiv_13)<<S32 ' JUMPV addrg
 alignl ' align long
C_ldiv_12
...
C_ldiv_13
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_ldiv_14)<<S32 ' LEI4 reg coni
 word I16A_MOVI + (r21)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_ldiv_15)<<S32 ' JUMPV addrg
 alignl ' align long
C_ldiv_14
...
C_ldiv_15
 ...
 alignl ' align long
 long I32_BR_Z + (@C_ldiv_6)<<S32 ' EQI4 reg reg
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
