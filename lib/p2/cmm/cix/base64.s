...
DAT ' const data segment
 ...
 alignl ' align long
C_sb7s_67cacd64_cb64_L000003 ' <symbol:cb64>
 byte 65
 byte 66
 byte 67
 byte 68
 ...
 alignl ' align long
C_sb7s1_67cacd64_cd64_L000004 ' <symbol:cd64>
 byte 124
 byte 36
 byte 36
 byte 36
...
DAT ' code segment
 ...
 alignl ' align long
C_sb7s2_67cacd64_encodeblock_L000005 ' <symbol:encodeblock>
 alignl ' align long
 ...
 alignl ' align long
 long @C_sb7s_67cacd64_cb64_L000003 ' reg <- addrg
 ...
 alignl ' align long
 long I32_BRBE + (@C_sb7s2_67cacd64_encodeblock_L000005_8)<<S32 ' LEI4 reg coni
 ...
 alignl ' align long
 long I32_JMPA + (@C_sb7s2_67cacd64_encodeblock_L000005_9)<<S32 ' JUMPV addrg
 alignl ' align long
C_sb7s2_67cacd64_encodeblock_L000005_8
 alignl ' align long
 long I32_LODS + (r23)<<D32S + ((61)&$7FFFF)<<S32 ' reg <- cons
 alignl ' align long
C_sb7s2_67cacd64_encodeblock_L000005_9
 word I16A_MOV + (r22)<<D16A + (r3)<<S16A
 ...
 alignl ' align long
 long I32_BRBE + (@C_sb7s2_67cacd64_encodeblock_L000005_11)<<S32 ' LEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r4)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (2)<<S16A ' ADDP4 reg coni
 word I16A_RDBYTE + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 ...
 alignl ' align long
 long I32_JMPA + (@C_sb7s2_67cacd64_encodeblock_L000005_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_sb7s2_67cacd64_encodeblock_L000005_11
 alignl ' align long
 long I32_LODS + (r21)<<D32S + ((61)&$7FFFF)<<S32 ' reg <- cons
 alignl ' align long
C_sb7s2_67cacd64_encodeblock_L000005_12
 word I16A_MOV + (r22)<<D16A + (r3)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (3)<<S16A ' ADDP4 reg coni
 word I16A_MOV + (r20)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_sb7s2_67cacd64_encodeblock_L000005_6 ' (symbol refcount = 0)
...
' C_encode_buff_22 ' (symbol refcount = 0)
 ...
 alignl ' align long
 long I32_CALA + (@C_sb7s2_67cacd64_encodeblock_L000005)<<S32
...
' C_encode_buff_13 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sb7s3_67cacd64_decodeblock_L000040 ' <symbol:decodeblock>
 alignl ' align long
 ...
 word I16A_OR + (r20)<<D16A + (r18)<<S16A ' BORI/U (1)
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_sb7s3_67cacd64_decodeblock_L000040_41 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
C_decode_buff_57
 ...
 alignl ' align long
 long @C_sb7s1_67cacd64_cd64_L000004-43 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r15)<<S16A ' ADDI/P (2)
 word I16A_RDBYTE + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU1 reg
...
C_decode_buff_70
 ...
 alignl ' align long
 long I32_CALA + (@C_sb7s3_67cacd64_decodeblock_L000040)<<S32
