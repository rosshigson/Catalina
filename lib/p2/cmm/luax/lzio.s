...
C_luaZ__fill ' <symbol:luaZ_fill>
 ...
 alignl_p1
 long I32_BR_Z + (@C_luaZ__fill_15)<<S32 ' EQU4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_luaZ__fill_13)<<S32 ' NEU4 reg coni
 alignl_label
C_luaZ__fill_15
 alignl_p1
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl_p1
 long I32_JMPA + (@C_luaZ__fill_12)<<S32 ' JUMPV addrg
 alignl_label
C_luaZ__fill_13
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
...
' C_luaZ__init_16 ' (symbol refcount = 0)
...
C_luaZ__read_18
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_luaZ__read_21)<<S32 ' NEU4 reg coni
 ...
 alignl_p1
 long I32_BRNZ + (@C_luaZ__read_23)<<S32 ' NEI4 reg reg
 word I16A_MOV + (r0)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 alignl_p1
 long I32_JMPA + (@C_luaZ__read_17)<<S32 ' JUMPV addrg
 alignl_label
C_luaZ__read_23
 word I16A_RDLONG + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRU4 reg
...
C_luaZ__read_21
 ...
 alignl_p1
 long I32_BR_A + (@C_luaZ__read_26)<<S32 ' GTU4 reg reg
 word I16A_MOV + (r15)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 alignl_p1
 long I32_JMPA + (@C_luaZ__read_27)<<S32 ' JUMPV addrg
 alignl_label
C_luaZ__read_26
...
C_luaZ__read_19
 ...
 alignl_p1
 long I32_BRNZ + (@C_luaZ__read_18)<<S32 ' NEU4 reg coni
