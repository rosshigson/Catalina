...
C_psram_getR_esult ' <symbol:psram_getResult>
 ...
 alignl ' align long
 long I32_BRAE + (@C_psram_getR_esult_3)<<S32 ' GEI4 reg coni
 word I16A_CMPSI + (r23)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_psram_getR_esult_8)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-24)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_psram_getR_esult_2)<<S32 ' JUMPV addrg
 alignl ' align long
...
C_psram_getR_esult_8
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_psram_getR_esult_7)<<S32 ' LTI4 reg coni
 alignl ' align long
