...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sjbc_67da4006_startupD_ata_L000002 ' <symbol:startupData>
 long $0

 alignl ' align long
C_sjbc1_67da4006_deviceD_ata_L000003 ' <symbol:deviceData>
 long $0

 alignl ' align long
C_sjbc2_67da4006_Q_osD_ata_L000004 ' <symbol:QosData>
 long $0

 alignl ' align long
C_sjbc3_67da4006_mailboxes_L000005 ' <symbol:mailboxes>
 long $0

 alignl ' align long
C_sjbc4_67da4006_drivercog_L000006 ' <symbol:drivercog>
 long -1

 alignl ' align long
C_sjbc5_67da4006_driverlock_L000007 ' <symbol:driverlock>
 long -1

 alignl ' align long
C_sjbc6_67da4006_delayT_able_L000008 ' <symbol:delayTable>
 long $7
 long $57bcf00
 long $8f0d180
 long $c474f80
...
C_psram_getM_ailbox ' <symbol:psram_getMailbox>
 ...
 alignl ' align long
 long I32_LODI + (@C_sjbc3_67da4006_mailboxes_L000005)<<S32
...
C_psram_initialize ' <symbol:psram_initialize>
 ...
 alignl ' align long
 long I32_LODI + (@C_sjbc_67da4006_startupD_ata_L000002)<<S32
 ...
 alignl ' align long
 long I32_LODA + (@C_sjbc4_67da4006_drivercog_L000006)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODI + (@C_sjbc4_67da4006_drivercog_L000006)<<S32
 ...
 alignl ' align long
 long I32_LODA + (@C_sjbc2_67da4006_Q_osD_ata_L000004)<<S32
 word I16A_WRLONG + (r20)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDS + (r22)<<D16A + (r16)<<S16A ' ADDI/P (1)
 alignl ' align long
 long I32_LODA + (@C_sjbc3_67da4006_mailboxes_L000005)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_sjbc5_67da4006_driverlock_L000007 ' reg <- addrg
 word I16A_MOV + (r20)<<D16A + (r18)<<S16A
 word I16A_SHRI + (r20)<<D16A + (24)<<S16A ' SHRU4 reg coni
 alignl ' align long
 long I32_LODA + (@C_sjbc5_67da4006_driverlock_L000007)<<S32
 ...
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODI + (@C_sjbc5_67da4006_driverlock_L000007)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
...
' C_psram_getD_riverL_ock_30 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031 ' <symbol:psram_modifyBankParams>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_33)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-15)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_32)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_33
 alignl ' align long
 long I32_LODI + (@C_sjbc4_67da4006_drivercog_L000006)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 alignl ' align long
 long I32_JMPA + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_36)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_35
 word I16A_MOVI + (r2)<<D16A + (1)<<S16A ' reg ARG coni
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C__waitms)<<S32 ' CALL addrg
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_36
 alignl ' align long
 long I32_LODI + (@C_sjbc5_67da4006_driverlock_L000007)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_35)<<S32 ' EQI4 reg coni
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_38
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_sjbc1_67da4006_deviceD_ata_L000003)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 ...
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_42
 word I16A_RDLONG + (r19)<<D16A + (r17)<<S16A ' reg <- INDIRI4 reg
' C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_43 ' (symbol refcount = 0)
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_42)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_45)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_sjbc1_67da4006_deviceD_ata_L000003)<<S32
 ...
 word I16A_WRLONG + (r13)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_46)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_45
 word I16A_NEG + (r19)<<D16A + (r19)<<S16A ' NEGI4
 alignl ' align long
 long I32_JMPA + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_40)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_46
' C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_39 ' (symbol refcount = 0)
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_CMPSI + (r15)<<D16A + (2)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_38)<<S32 ' LTI4 reg coni
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_40
 alignl ' align long
 long I32_LODI + (@C_sjbc5_67da4006_driverlock_L000007)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 alignl ' align long
C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031_32
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjbc8_67da4006_psram_lookupD_elay_L000047 ' <symbol:psram_lookupDelay>
 alignl ' align long
 ...
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sjbc6_67da4006_delayT_able_L000008 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 word I16A_MOV + (r21)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjbc8_67da4006_psram_lookupD_elay_L000047_50)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjbc8_67da4006_psram_lookupD_elay_L000047_49
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r20)<<D16A + (r23)<<S16A
 word I16A_SHLI + (r20)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r18)<<D16B
 alignl ' align long
 long @C_sjbc6_67da4006_delayT_able_L000008+4 ' reg <- addrg
 word I16A_ADDS + (r20)<<D16A + (r18)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + (r20)<<D16A + (r20)<<S16A ' reg <- INDIRU4 reg
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_sjbc8_67da4006_psram_lookupD_elay_L000047_53)<<S32 ' GEU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjbc8_67da4006_psram_lookupD_elay_L000047_51)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjbc8_67da4006_psram_lookupD_elay_L000047_53
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_ADDSI + (r21)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
C_sjbc8_67da4006_psram_lookupD_elay_L000047_50
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjbc8_67da4006_psram_lookupD_elay_L000047_49)<<S32 ' NEU4 reg coni
 alignl ' align long
C_sjbc8_67da4006_psram_lookupD_elay_L000047_51
 word I16A_MOV + (r0)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
' C_sjbc8_67da4006_psram_lookupD_elay_L000047_48 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
C_psram_setD_elay ' <symbol:psram_setDelay>
 ...
 alignl ' align long
 long I32_CALA + (@C_sjbc7_67da4006_psram_modifyB_ankP_arams_L000031)<<S32
...
C_psram_setF_requency_58
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjbc8_67da4006_psram_lookupD_elay_L000047)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
...
C_psram_setQ_os_66
 ...
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_sjbc2_67da4006_Q_osD_ata_L000004)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 alignl ' align long
