...
' Catalina Export psram_readWord

 alignl ' align long
C_psram_readW_ord ' <symbol:psram_readWord>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_psram_readW_ord_3)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-15)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_psram_readW_ord_2)<<S32 ' JUMPV addrg
 alignl ' align long
C_psram_readW_ord_3
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRAE + (@C_psram_readW_ord_5)<<S32 ' GEI4 reg coni
 alignl ' align long
...
' C_psram_readW_ord_8 ' (symbol refcount = 0)
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_psram_readW_ord_7)<<S32 ' LTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
...
' Catalina Export psram_writeWord

 alignl ' align long
C_psram_writeW_ord ' <symbol:psram_writeWord>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $fe8000<<S32 ' save registers
 ...
 word I16A_CMPS + (r15)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_psram_writeW_ord_11)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-15)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_psram_writeW_ord_10)<<S32 ' JUMPV addrg
 alignl ' align long
C_psram_writeW_ord_11
 alignl ' align long
 long I32_CALA + (@C__cogid)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_psram_writeW_ord_13)<<S32 ' GEI4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-28)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_psram_writeW_ord_10)<<S32 ' JUMPV addrg
 alignl ' align long
C_psram_writeW_ord_13
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (8)<<S16A ' ADDP4 reg coni
 ...
 word I16A_WRLONG + (r22)<<D16A + (r17)<<S16A ' ASGNI4 reg reg
 alignl ' align long
C_psram_writeW_ord_15
 word I16A_RDLONG + (r19)<<D16A + (r17)<<S16A ' reg <- INDIRI4 reg
' C_psram_writeW_ord_16 ' (symbol refcount = 0)
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_psram_writeW_ord_15)<<S32 ' LTI4 reg coni
 word I16A_NEG + (r0)<<D16A + (r19)<<S16A ' NEGI4
 alignl ' align long
C_psram_writeW_ord_10
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
