...
DAT ' code segment
 ...
 alignl_label
C_sb20_686cc49f__calls_L000003 ' <symbol:_calls>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_JMPA + (@C_sb20_686cc49f__calls_L000003_6)<<S32 ' JUMPV addrg
 alignl_label
C_sb20_686cc49f__calls_L000003_5
 ...
 alignl
 alignl_label
C_sb20_686cc49f__calls_L000003_6
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_SUBSI + (r22)<<D16A + (1)<<S16A ' SUBI4 reg coni
 word I16A_MOV + (r23)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRAE + (@C_sb20_686cc49f__calls_L000003_5)<<S32 ' GEI4 reg coni
' C_sb20_686cc49f__calls_L000003_4 ' (symbol refcount = 0)
...
C_exit ' <symbol:exit>
 ...
 alignl_p1
 long I32_CALA + (@C_sb20_686cc49f__calls_L000003)<<S32 ' CALL addrg
 alignl_p1
