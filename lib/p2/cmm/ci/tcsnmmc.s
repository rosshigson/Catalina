...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s108o_67cacd4e_nmmtd_array_L000001 ' <symbol:nmmtd_array>
 long $fd900108
 long $fd9001fc
 long $fd900220
 long $fd900248
...
' Catalina Export MY_NMM_LUT_LIBRARY_array

 alignl ' align long
C_M_Y__N_M_M__L_U_T__L_I_B_R_A_R_Y__array ' <symbol:MY_NMM_LUT_LIBRARY_array>
 long $fd102c17
 long $fd602c18
 long $d602e19
 long $f6007817
...
' Catalina Export _threaded_cogstart_NMM_cog
...
DAT ' code segment
 ...
 alignl ' align long
C__threaded_cogstart_N_M_M__cog ' <symbol:_threaded_cogstart_NMM_cog>
 alignl ' align long
 ...
 alignl ' align long
 long I32_MOVI + (r22)<<D32 +(137)<<S32 ' reg <- conli
 word I16B_LODF + ((-24)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_M_Y__N_M_M__L_U_T__L_I_B_R_A_R_Y__array ' reg <- addrg
 ...
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_s108o_67cacd4e_nmmtd_array_L000001 ' reg <- addrg
