...
'
 ...
 alignl_label
C_s854_68804ff8_strdup_L000005 ' <symbol:strdup>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_BR_Z + (@C_s854_68804ff8_strdup_L000005_7)<<S32 ' EQU4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 ...
 alignl_label
C_s854_68804ff8_strdup_L000005_7
 word I16A_MOV + (r0)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
' C_s854_68804ff8_strdup_L000005_6 ' (symbol refcount = 0)
...
C__load_L_ua_service_list_76
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s854_68804ff8_strdup_L000005)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + (r20)<<D16A + (28)<<S16A ' reg <- coni
 word I16A_MOV + (r0)<<D16A + (r20)<<S16A ' setup r0/r1 (2)
