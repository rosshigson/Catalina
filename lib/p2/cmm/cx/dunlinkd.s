...
C_D_F_S__U_nlinkD_ir ' <symbol:DFS_UnlinkDir>
 ...
 alignl ' align long
 long I32_BR_Z + (@C_D_F_S__U_nlinkD_ir_5)<<S32 ' EQU4 reg coni
 word I16A_MOVI + R0<<D16A + (3)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_D_F_S__U_nlinkD_ir_4)<<S32 ' JUMPV addrg
 alignl ' align long
C_D_F_S__U_nlinkD_ir_5
 ...
 word I16A_CMPI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_D_F_S__U_nlinkD_ir_7)<<S32 ' EQU4 reg coni
...
C_D_F_S__U_nlinkD_ir_7
 ...
 word I16A_CMPI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_D_F_S__U_nlinkD_ir_15)<<S32 ' EQU4 reg coni
 word I16A_NEGI + (r0)<<D16A + (-($ffffffff)&$1F)<<S16A ' reg <- conn
 alignl ' align long
 long I32_JMPA + (@C_D_F_S__U_nlinkD_ir_4)<<S32 ' JUMPV addrg
 alignl ' align long
...
C_D_F_S__U_nlinkD_ir_15
 ...
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__U_nlinkD_ir_24)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-20)&$1FF)<<S16B
 ...
 alignl ' align long
 long I32_BRAE + (@C_D_F_S__U_nlinkD_ir_25)<<S32 ' GEU4 reg reg
 alignl ' align long
C_D_F_S__U_nlinkD_ir_24
 ...
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__U_nlinkD_ir_26)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-20)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
...
C_D_F_S__U_nlinkD_ir_26
 ...
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__U_nlinkD_ir_14)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-20)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_D_F_S__U_nlinkD_ir_14)<<S32 ' LTU4 reg reg
 alignl ' align long
