...
'
 ...
 alignl ' align long
C_sh7c_67d10fc3_two_digits_L000001 ' <symbol:two_digits>
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sh7c_67d10fc3_two_digits_L000001_3)<<S32 ' NEI4 reg coni
 ...
 word I16A_WRBYTE + (r22)<<D16A + (r4)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sh7c_67d10fc3_two_digits_L000001_3
...
' C_sh7c_67d10fc3_two_digits_L000001_2 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_sh7c1_67d10fc3_four_digits_L000005 ' <symbol:four_digits>
 alignl ' align long
 long I32_PSHM + $500000<<S32 ' save registers
 alignl ' align long
 ...
 word I16A_MOV + (r0)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
' C_sh7c1_67d10fc3_four_digits_L000005_6 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
C_asctime_16
 ...
 alignl ' align long
 long I32_CALA + (@C_sh7c_67d10fc3_two_digits_L000001)<<S32
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sh7c1_67d10fc3_four_digits_L000005)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
