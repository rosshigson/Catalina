...
'
 ...
 alignl ' align long
C_s10t4_67cacd7c_wait100ms_L000003 ' <symbol:wait100ms>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
...
' C_s10t4_67cacd7c_wait100ms_L000003_4 ' (symbol refcount = 0)
...
C_D_F_S__R_eadS_ector_6
 ...
 alignl ' align long
 long I32_CALA + (@C_sd_sectread)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r13)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__R_eadS_ector_10)<<S32 ' NEI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_D_F_S__R_eadS_ector_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_D_F_S__R_eadS_ector_10
 alignl ' align long
 long I32_CALA + (@C_s10t4_67cacd7c_wait100ms_L000003)<<S32 ' CALL addrg
' C_D_F_S__R_eadS_ector_7 ' (symbol refcount = 0)
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_CMPSI + (r15)<<D16A + (10)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_D_F_S__R_eadS_ector_6)<<S32 ' LTI4 reg coni
 alignl ' align long
