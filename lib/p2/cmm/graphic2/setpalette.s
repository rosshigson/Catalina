...
C_g_palette ' <symbol:g_palette>
 ...
 word I16A_SUBS + (r18)<<D16A + (r23)<<S16A ' SUBI/P (3)
 word I16A_AND + (r20)<<D16A + (r18)<<S16A ' BANDI/U (2)
 word I16A_SHLI + (r20)<<D16A + (3)<<S16A ' SHLI4 reg coni
 word I16A_MOV + (r18)<<D16A + (r22)<<S16A ' LSHI/U
 word I16A_SHL + (r18)<<D16A + (r20)<<S16A ' LSHI/U (3)
 word I16B_CPL + (r18)<<D16B ' BCOMI4
 word I16A_MOV + (r7)<<D16A + (r18)<<S16A ' CVI, CVU or LOAD
 ...
 alignl_p1
 long I32_JMPA + (@C_g_palette_8)<<S32 ' JUMPV addrg
 alignl_label
C_g_palette_5
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 alignl_p1
 long I32_JMPA + (@C_g_palette_12)<<S32 ' JUMPV addrg
 alignl_label
C_g_palette_9
 ...
 word I16A_ADDS + (r15)<<D16A + (r11)<<S16A ' ADDI/P (3)
 ...
 word I16A_AND + (r19)<<D16A + (r7)<<S16A ' BANDI/U (1)
 word I16A_OR + (r19)<<D16A + (r6)<<S16A ' BORI/U (1)
...
' C_g_palette_10 ' (symbol refcount = 0)
 ...
 alignl_label
C_g_palette_12
 word I16A_CMPS + (r17)<<D16A + (r9)<<S16A
 alignl_p1
 long I32_BR_B + (@C_g_palette_9)<<S32 ' LTI4 reg reg
...
C_g_palette_8
 ...
 alignl_p1
 long I32_BR_B + (@C_g_palette_5)<<S32 ' LTI4 reg reg
 alignl_p1
 long I32_CALA + (@C_cgi_palette)<<S32 ' CALL addrg
