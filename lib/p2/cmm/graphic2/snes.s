...
C_snes_encode ' <symbol:snes_encode>
 ...
 alignl_p1
 long I32_BRNZ + (@C_snes_encode_5)<<S32 ' NEI4 reg coni
 alignl_p1
...
C_snes_encode_5
 ...
 alignl_p1
 long I32_BRNZ + (@C_snes_encode_7)<<S32 ' NEI4 reg coni
 alignl_p1
...
C_snes_encode_7
 ...
 alignl_p1
 long I32_BRNZ + (@C_snes_encode_9)<<S32 ' NEI4 reg coni
 alignl_p1
...
C_snes_encode_9
 ...
 alignl_p1
 long I32_BRNZ + (@C_snes_encode_11)<<S32 ' NEI4 reg coni
...
C_snes_encode_11
 ...
 alignl_p1
 long I32_BR_Z + (@C_snes_encode_13)<<S32 ' EQU4 reg coni
 alignl_p1
...
C_snes_encode_13
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_snes_encode_15)<<S32 ' EQU4 reg coni
...
C_snes_encode_15
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_snes_encode_17)<<S32 ' EQU4 reg coni
...
C_snes_encode_17
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_snes_encode_19)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r22)<<D16A + (4)<<S16A ' reg <- coni
 word I16A_OR + (r23)<<D16A + (r22)<<S16A ' BORI/U (1)
 alignl_label
C_snes_encode_19
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_snes_encode_21)<<S32 ' EQU4 reg coni
 word I16B_LODL + (r22)<<D16B
 alignl_p1
 long 1024 ' reg <- con
 word I16A_OR + (r23)<<D16A + (r22)<<S16A ' BORI/U (1)
...
C_snes_encode_21
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_snes_encode_23)<<S32 ' EQU4 reg coni
 word I16B_LODL + (r22)<<D16B
 alignl_p1
 long 2048 ' reg <- con
 word I16A_OR + (r23)<<D16A + (r22)<<S16A ' BORI/U (1)
...
C_snes_encode_23
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_snes_encode_25)<<S32 ' EQU4 reg coni
 word I16B_LODL + (r22)<<D16B
 alignl_p1
 long 512 ' reg <- con
 word I16A_OR + (r23)<<D16A + (r22)<<S16A ' BORI/U (1)
...
C_snes_encode_25
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_snes_encode_27)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r22)<<D16A + (2)<<S16A ' reg <- coni
 word I16A_OR + (r23)<<D16A + (r22)<<S16A ' BORI/U (1)
 alignl_label
C_snes_encode_27
...
C_g_snes ' <symbol:g_snes>
 ...
 alignl_p1
 long I32_BR_Z + (@C_g_snes_30)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 ...
 alignl_p1
 long I32_CALA + (@C_snes_encode)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl_p1
 long I32_JMPA + (@C_g_snes_29)<<S32 ' JUMPV addrg
 alignl_label
C_g_snes_30
