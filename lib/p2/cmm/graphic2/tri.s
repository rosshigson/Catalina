...
C_g_tri ' <symbol:g_tri>
 ...
 alignl_p1
 long I32_BR_B + (@C_g_tri_11)<<S32 ' LTI4 reg reg
 word I16A_MOVI + (r13)<<D16A + (4)<<S16A ' reg <- coni
 alignl_p1
 long I32_JMPA + (@C_g_tri_12)<<S32 ' JUMPV addrg
 alignl_label
C_g_tri_11
...
C_g_tri_12
 ...
 alignl_p1
 long I32_BR_B + (@C_g_tri_13)<<S32 ' LTI4 reg reg
 word I16A_MOVI + (r11)<<D16A + (2)<<S16A ' reg <- coni
 alignl_p1
 long I32_JMPA + (@C_g_tri_14)<<S32 ' JUMPV addrg
 alignl_label
C_g_tri_13
...
C_g_tri_14
 ...
 alignl_p1
 long I32_BR_B + (@C_g_tri_15)<<S32 ' LTI4 reg reg
 word I16A_MOVI + (r10)<<D16A + (1)<<S16A ' reg <- coni
 alignl_p1
 long I32_JMPA + (@C_g_tri_16)<<S32 ' JUMPV addrg
 alignl_label
C_g_tri_15
...
C_g_tri_16
 ...
 alignl_p1
 long I32_BR_B + (@C_g_tri_5)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r15)<<D16A + (5)<<S16A
 alignl_p1
 long I32_BR_A + (@C_g_tri_5)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 long @C_g_tri_22_L000024 ' reg <- addrg
...
C_g_tri_17
 ...
 alignl_p1
 long I32_JMPA + (@C_g_tri_6)<<S32 ' JUMPV addrg
 alignl_label
C_g_tri_18
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
