...
C_g_justify ' <symbol:g_justify>
 ...
 alignl_p1
 long I32_LODI + (@C_G__V_A_R_+20)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 ...
 alignl_p1
 long I32_BR_B + (@C_g_justify_8)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r17)<<D16A + (3)<<S16A
 alignl_p1
 long I32_BR_A + (@C_g_justify_8)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 long @C_g_justify_16_L000018 ' reg <- addrg
...
C_g_justify_12
 ...
 alignl_p1
 long I32_JMPA + (@C_g_justify_9)<<S32 ' JUMPV addrg
 alignl_label
C_g_justify_13
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
...
C_g_justify_9
 ...
 alignl_p1
 long I32_BR_B + (@C_g_justify_19)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r15)<<D16A + (3)<<S16A
 alignl_p1
 long I32_BR_A + (@C_g_justify_19)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 long @C_g_justify_29_L000031 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + RI<<D16A + (r22)<<S16A
 word I16B_JMPI ' JUMPV INDIR reg
 alignl_p1
...
C_g_justify_23
 ...
 alignl_p1
 long I32_JMPA + (@C_g_justify_20)<<S32 ' JUMPV addrg
 alignl_label
C_g_justify_24
 alignl_p1
