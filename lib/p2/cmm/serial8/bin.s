...
C_s8_bin ' <symbol:s8_bin>
 ...
 alignl ' align long
 long I32_JMPA + (@C_s8_bin_3)<<S32 ' JUMPV addrg
 alignl ' align long
C_s8_bin_2
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s8_bin_6)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_LODS + (r17)<<D32S + ((48)&$7FFFF)<<S32 ' reg <- cons
 alignl ' align long
 long I32_JMPA + (@C_s8_bin_7)<<S32 ' JUMPV addrg
 alignl ' align long
C_s8_bin_6
 alignl ' align long
...
C_s8_bin_3
 ...
 alignl ' align long
 long I32_BR_A + (@C_s8_bin_2)<<S32 ' GTI4 reg coni
