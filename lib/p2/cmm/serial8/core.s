...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s2fk_6709f978_s8base_L000002 ' <symbol:s8base>
 long $0

 alignl ' align long
C_s2fk1_6709f978_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_s2fk2_6709f978_pinconfig_L000004 ' <symbol:pinconfig>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s2fk2_6709f978_pinconfig_L000004_6)<<S32 ' NEI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_s2fk2_6709f978_pinconfig_L000004_7)<<S32 ' EQU4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_s2fk2_6709f978_pinconfig_L000004_7)<<S32 ' JUMPV addrg
 alignl ' align long
C_s2fk2_6709f978_pinconfig_L000004_6
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_s2fk2_6709f978_pinconfig_L000004_10)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r13)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s2fk2_6709f978_pinconfig_L000004_10)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r13)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_s2fk2_6709f978_pinconfig_L000004_17_L000019 ' reg <- addrg
...
DAT ' const data segment
 ...
 alignl ' align long
C_s2fk2_6709f978_pinconfig_L000004_17_L000019 ' <symbol:17>
 long @C_s2fk2_6709f978_pinconfig_L000004_11
 long @C_s2fk2_6709f978_pinconfig_L000004_14
 long @C_s2fk2_6709f978_pinconfig_L000004_15
 long @C_s2fk2_6709f978_pinconfig_L000004_16

' Catalina Code

DAT ' code segment
 alignl ' align long
C_s2fk2_6709f978_pinconfig_L000004_14
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_s2fk2_6709f978_pinconfig_L000004_11)<<S32 ' JUMPV addrg
 alignl ' align long
C_s2fk2_6709f978_pinconfig_L000004_15
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 long I32_JMPA + (@C_s2fk2_6709f978_pinconfig_L000004_11)<<S32 ' JUMPV addrg
 alignl ' align long
C_s2fk2_6709f978_pinconfig_L000004_16
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
C_s2fk2_6709f978_pinconfig_L000004_10
 alignl ' align long
C_s2fk2_6709f978_pinconfig_L000004_11
 alignl ' align long
C_s2fk2_6709f978_pinconfig_L000004_7
 alignl ' align long
...
' C_s2fk2_6709f978_pinconfig_L000004_5 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s2fk5_6709f978_p_config_L000020 ' <symbol:p_config>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODI + (@C_s2fk_6709f978_s8base_L000002)<<S32
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_s2fk5_6709f978_p_config_L000020_21 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s2fk6_6709f978_autoinitialize_L000022 ' <symbol:autoinitialize>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s2fk6_6709f978_autoinitialize_L000022_24)<<S32 ' EQU4 reg coni
 alignl ' align long
 long I32_LODI + (@C_s2fk_6709f978_s8base_L000002)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 ...
 alignl ' align long
C_s2fk6_6709f978_autoinitialize_L000022_26
 ...
 alignl ' align long
 long I32_BR_B + (@C_s2fk6_6709f978_autoinitialize_L000022_30)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (63)<<S32
 word I16A_CMPS + (r23)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s2fk6_6709f978_autoinitialize_L000022_30)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_SHLI + (r22)<<D16A + (4)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_s2fk_6709f978_s8base_L000002)<<S32
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_s2fk2_6709f978_pinconfig_L000004)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 alignl ' align long
 long I32_MOVI + (r22)<<D32 +(32)<<S32 ' reg <- conli
 ...
 alignl ' align long
 long I32_CALA + (@C_s2fk5_6709f978_p_config_L000020)<<S32
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 alignl ' align long
C_s2fk6_6709f978_autoinitialize_L000022_30
 ...
 word I16A_CMPSI + (r23)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s2fk6_6709f978_autoinitialize_L000022_32)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (63)<<S32
 word I16A_CMPS + (r23)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s2fk6_6709f978_autoinitialize_L000022_32)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_SHLI + (r22)<<D16A + (4)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_s2fk_6709f978_s8base_L000002)<<S32
 ...
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 alignl ' align long
C_s2fk6_6709f978_autoinitialize_L000022_32
 alignl ' align long
 long I32_MOVI + (r22)<<D32 +(64)<<S32 ' reg <- conli
 word I16A_ADD + (r19)<<D16A + (r22)<<S16A ' ADDU (1)
 word I16A_ADD + (r15)<<D16A + (r22)<<S16A ' ADDU (1)
' C_s2fk6_6709f978_autoinitialize_L000022_27 ' (symbol refcount = 0)
 word I16A_ADDSI + (r17)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_CMPSI + (r17)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s2fk6_6709f978_autoinitialize_L000022_26)<<S32 ' LTI4 reg coni
 alignl ' align long
C_s2fk6_6709f978_autoinitialize_L000022_24
' C_s2fk6_6709f978_autoinitialize_L000022_23 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s2fk7_6709f978_initialize_L000034 ' <symbol:initialize>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $540000<<S32 ' save registers
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s2fk7_6709f978_initialize_L000034_36)<<S32 ' NEU4 reg coni
 ...
 alignl ' align long
 long I32_BR_B + (@C_s2fk7_6709f978_initialize_L000034_38)<<S32 ' LTI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODA + (@C_s2fk_6709f978_s8base_L000002)<<S32
 word I16A_WRLONG + (r20)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_s2fk1_6709f978_lock_L000003 ' reg <- addrg
 word I16A_SHRI + (r22)<<D16A + (24)<<S16A ' SHRU4 reg coni
 alignl ' align long
 long I32_LODA + (@C_s2fk1_6709f978_lock_L000003)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16A_RDLONG + (r22)<<D16A + (r20)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s2fk7_6709f978_initialize_L000034_40)<<S32 ' NEI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODI + (@C_s2fk1_6709f978_lock_L000003)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s2fk7_6709f978_initialize_L000034_41)<<S32 ' LTI4 reg coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 alignl ' align long
 long I32_LODI + (@C_s2fk1_6709f978_lock_L000003)<<S32
 ...
 alignl ' align long
 long I32_JMPA + (@C_s2fk7_6709f978_initialize_L000034_41)<<S32 ' JUMPV addrg
 alignl ' align long
C_s2fk7_6709f978_initialize_L000034_40
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
C_s2fk7_6709f978_initialize_L000034_41
 alignl ' align long
 long I32_CALA + (@C_s2fk6_6709f978_autoinitialize_L000022)<<S32 ' CALL addrg
 alignl ' align long
C_s2fk7_6709f978_initialize_L000034_38
 alignl ' align long
C_s2fk7_6709f978_initialize_L000034_36
' C_s2fk7_6709f978_initialize_L000034_35 ' (symbol refcount = 0)
...
C_s8_closeport ' <symbol:s8_closeport>
 ...
 alignl ' align long
 long I32_CALA + (@C_s2fk7_6709f978_initialize_L000034)<<S32 ' CALL addrg
 alignl ' align long
C_s8_closeport_45
