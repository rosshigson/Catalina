...
' Catalina Export hyper_readByte

 alignl ' align long
C_hyper_readB_yte ' <symbol:hyper_readByte>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_hyper_readB_yte_3)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-15)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_hyper_readB_yte_2)<<S32 ' JUMPV addrg
 alignl ' align long
C_hyper_readB_yte_3
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRAE + (@C_hyper_readB_yte_5)<<S32 ' GEI4 reg coni
 alignl ' align long
...
' C_hyper_readB_yte_8 ' (symbol refcount = 0)
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_hyper_readB_yte_7)<<S32 ' LTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
...
' Catalina Export hyper_writeByte

 alignl ' align long
C_hyper_writeB_yte ' <symbol:hyper_writeByte>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $fe8000<<S32 ' save registers
 ...
 word I16A_CMPS + (r15)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_hyper_writeB_yte_11)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-15)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_hyper_writeB_yte_10)<<S32 ' JUMPV addrg
 alignl ' align long
C_hyper_writeB_yte_11
 alignl ' align long
 long I32_CALA + (@C__cogid)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_hyper_writeB_yte_13)<<S32 ' GEI4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-28)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_hyper_writeB_yte_10)<<S32 ' JUMPV addrg
 alignl ' align long
C_hyper_writeB_yte_13
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (8)<<S16A ' ADDP4 reg coni
 ...
 word I16A_WRLONG + (r22)<<D16A + (r17)<<S16A ' ASGNI4 reg reg
 alignl ' align long
C_hyper_writeB_yte_15
 word I16A_RDLONG + (r19)<<D16A + (r17)<<S16A ' reg <- INDIRI4 reg
' C_hyper_writeB_yte_16 ' (symbol refcount = 0)
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_hyper_writeB_yte_15)<<S32 ' LTI4 reg coni
 word I16A_NEG + (r0)<<D16A + (r19)<<S16A ' NEGI4
 alignl ' align long
C_hyper_writeB_yte_10
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
