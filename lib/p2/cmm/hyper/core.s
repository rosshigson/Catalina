...
DAT ' initialized data segment
 ...
 alignl ' align long
C_snhc_67b110eb_startupD_ata_L000002 ' <symbol:startupData>
 long $0

 alignl ' align long
C_snhc1_67b110eb_deviceD_ata_L000003 ' <symbol:deviceData>
 long $0

 alignl ' align long
C_snhc2_67b110eb_Q_osD_ata_L000004 ' <symbol:QosData>
 long $0

 alignl ' align long
C_snhc3_67b110eb_mailboxes_L000005 ' <symbol:mailboxes>
 long $0

 alignl ' align long
C_snhc4_67b110eb_drivercog_L000006 ' <symbol:drivercog>
 long -1

 alignl ' align long
C_snhc5_67b110eb_driverlock_L000007 ' <symbol:driverlock>
 long -1

 alignl ' align long
C_snhc6_67b110eb_delayT_able_r_L000008 ' <symbol:delayTable_r>
 long $6
 long $57bcf00
 long $80befc0
 long $b34a700
 ...
 alignl ' align long
C_snhc7_67b110eb_delayT_able_f_L000009 ' <symbol:delayTable_f>
 long $5
 long $42c1d80
 long $68e7780
 long $9896800
...
C_hyper_getM_ailbox ' <symbol:hyper_getMailbox>
 ...
 alignl ' align long
 long I32_LODI + (@C_snhc3_67b110eb_mailboxes_L000005)<<S32
...
C_hyper_initialize ' <symbol:hyper_initialize>
 ...
 alignl ' align long
 long I32_LODI + (@C_snhc_67b110eb_startupD_ata_L000002)<<S32
 ...
 alignl ' align long
 long I32_LODA + (@C_snhc4_67b110eb_drivercog_L000006)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODI + (@C_snhc4_67b110eb_drivercog_L000006)<<S32
 ...
 alignl ' align long
 long I32_LODA + (@C_snhc2_67b110eb_Q_osD_ata_L000004)<<S32
 word I16A_WRLONG + (r20)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDS + (r22)<<D16A + (r16)<<S16A ' ADDI/P (1)
 alignl ' align long
 long I32_LODA + (@C_snhc3_67b110eb_mailboxes_L000005)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_snhc5_67b110eb_driverlock_L000007 ' reg <- addrg
 word I16A_MOV + (r20)<<D16A + (r18)<<S16A
 word I16A_SHRI + (r20)<<D16A + (24)<<S16A ' SHRU4 reg coni
 alignl ' align long
 long I32_LODA + (@C_snhc5_67b110eb_driverlock_L000007)<<S32
 ...
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODI + (@C_snhc5_67b110eb_driverlock_L000007)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
...
' C_hyper_getD_riverL_ock_32 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033 ' <symbol:hyper_getStartBank>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_snhc1_67b110eb_deviceD_ata_L000003)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 ...
 alignl ' align long
 long I32_BRNZ + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_35)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (14)<<S16A ' reg <- coni
 word I16A_AND + (r23)<<D16A + (r22)<<S16A ' BANDI/U (1)
 alignl ' align long
 long I32_JMPA + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_36)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_35
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_CMPSI + (r22)<<D16A + (26)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_37)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (12)<<S16A ' reg <- coni
 word I16A_AND + (r23)<<D16A + (r22)<<S16A ' BANDI/U (1)
 alignl ' align long
 long I32_JMPA + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_38)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_37
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_CMPSI + (r22)<<D16A + (27)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_39)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (8)<<S16A ' reg <- coni
 word I16A_AND + (r23)<<D16A + (r22)<<S16A ' BANDI/U (1)
 alignl ' align long
 long I32_JMPA + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_40)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_39
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_CMPSI + (r22)<<D16A + (28)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_41)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_42)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_41
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_CMPSI + (r22)<<D16A + (28)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_43)<<S32 ' LEI4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-6)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_34)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_43
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_42
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_40
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_38
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_36
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033_34
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_hyper_modifyB_ankP_arams_73
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_snhc8_67b110eb_hyper_getS_tartB_ank_L000033)<<S32 ' CALL addrg
...
C_hyper_modifyB_ankP_arams_72
 ...
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092 ' <symbol:getBankParams>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_JMPA + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_95)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_94
 word I16A_MOVI + (r2)<<D16A + (1)<<S16A ' reg ARG coni
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C__waitms)<<S32 ' CALL addrg
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_95
 alignl ' align long
 long I32_LODI + (@C_snhc5_67b110eb_driverlock_L000007)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_94)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_CALA + (@C__cogid)<<S32 ' CALL addrg
 alignl ' align long
 ...
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_97
 word I16A_RDLONG + (r19)<<D16A + (r17)<<S16A ' reg <- INDIRI4 reg
' C_snhc9_67b110eb_getB_ankP_arams_L000092_98 ' (symbol refcount = 0)
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_97)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_100)<<S32 ' LEI4 reg coni
 ...
 alignl ' align long
 long I32_JMPA + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_93)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_100
 word I16A_CMPSI + (r21)<<D16A + (1)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_102)<<S32 ' NEI4 reg coni
 ...
 alignl ' align long
 long I32_JMPA + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_103)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_102
 word I16A_CMPSI + (r21)<<D16A + (2)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_104)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 ...
 word I16A_MOV + (r19)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_105)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_104
 word I16A_CMPSI + (r21)<<D16A + (4)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_106)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 ...
 word I16A_MOV + (r19)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_107)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_106
 word I16A_CMPSI + (r21)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_108)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16B_LODL + (r20)<<D16B
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_110)<<S32 ' EQU4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_SHRI + (r22)<<D16A + (16)<<S16A ' SHRU4 reg coni
 ...
 word I16A_MOV + (r19)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_109)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_110
 word I16A_MOVI + (r19)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_snhc9_67b110eb_getB_ankP_arams_L000092_109)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_108
 word I16A_NEGI + (r19)<<D16A + (-(-6)&$1F)<<S16A ' reg <- conn
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_109
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_107
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_105
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_103
 alignl ' align long
 long I32_LODI + (@C_snhc5_67b110eb_driverlock_L000007)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 word I16A_MOV + (r0)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_snhc9_67b110eb_getB_ankP_arams_L000092_93
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_snhca_67b110eb_validH_yperR_A_M__L000112 ' <symbol:validHyperRAM>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $500000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_snhca_67b110eb_validH_yperR_A_M__L000112_114)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-23)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_snhca_67b110eb_validH_yperR_A_M__L000112_113)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhca_67b110eb_validH_yperR_A_M__L000112_114
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
C_snhca_67b110eb_validH_yperR_A_M__L000112_113
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116 ' <symbol:hyper_lookupDelay>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_snhca_67b110eb_validH_yperR_A_M__L000112)<<S32 ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_118)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_snhc6_67b110eb_delayT_able_r_L000008 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 word I16A_MOV + (r17)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_121)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116_120
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r20)<<D16A + (r19)<<S16A
 word I16A_SHLI + (r20)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r18)<<D16B
 alignl ' align long
 long @C_snhc6_67b110eb_delayT_able_r_L000008+4 ' reg <- addrg
 word I16A_ADDS + (r20)<<D16A + (r18)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + (r20)<<D16A + (r20)<<S16A ' reg <- INDIRU4 reg
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_124)<<S32 ' GEU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_119)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116_124
 word I16A_ADDSI + (r19)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_ADDSI + (r17)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116_121
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_120)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_119)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116_118
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_snhc7_67b110eb_delayT_able_f_L000009 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU4 reg
 word I16A_MOV + (r17)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_128)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116_127
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r20)<<D16A + (r19)<<S16A
 word I16A_SHLI + (r20)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r18)<<D16B
 alignl ' align long
 long @C_snhc7_67b110eb_delayT_able_f_L000009+4 ' reg <- addrg
 word I16A_ADDS + (r20)<<D16A + (r18)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + (r20)<<D16A + (r20)<<S16A ' reg <- INDIRU4 reg
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_131)<<S32 ' GEU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_129)<<S32 ' JUMPV addrg
 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116_131
 word I16A_ADDSI + (r19)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_ADDSI + (r17)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116_128
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116_127)<<S32 ' NEU4 reg coni
 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116_129
 alignl ' align long
C_snhcb_67b110eb_hyper_lookupD_elay_L000116_119
 word I16A_MOV + (r0)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
' C_snhcb_67b110eb_hyper_lookupD_elay_L000116_117 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_hyper_setD_elayF_requency_138
 ...
 alignl ' align long
 long I32_CALA + (@C_snhcb_67b110eb_hyper_lookupD_elay_L000116)<<S32
...
C_hyper_getD_elay ' <symbol:hyper_getDelay>
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_snhc9_67b110eb_getB_ankP_arams_L000092)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
...
C_hyper_setQ_os_151
 ...
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_snhc2_67b110eb_Q_osD_ata_L000004)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 alignl ' align long
