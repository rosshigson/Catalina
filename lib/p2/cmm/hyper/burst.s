...
C_hyper_read ' <symbol:hyper_read>
 ...
 alignl ' align long
 long I32_BRNZ + (@C_hyper_read_3)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-15)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_hyper_read_2)<<S32 ' JUMPV addrg
 alignl ' align long
C_hyper_read_3
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_hyper_read_5)<<S32 ' NEI4 reg coni
...
C_hyper_read_5
 ...
 alignl ' align long
 long I32_BRAE + (@C_hyper_read_7)<<S32 ' GEI4 reg coni
 alignl ' align long
...
' C_hyper_read_10 ' (symbol refcount = 0)
 ...
 alignl ' align long
 long I32_BR_B + (@C_hyper_read_9)<<S32 ' LTI4 reg coni
...
C_hyper_write ' <symbol:hyper_write>
 ...
 word I16A_CMPS + (r13)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_hyper_write_13)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-15)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_hyper_write_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_hyper_write_13
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_hyper_write_15)<<S32 ' NEI4 reg coni
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_hyper_write_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_hyper_write_15
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_hyper_write_17)<<S32 ' GEI4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-28)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_hyper_write_12)<<S32 ' JUMPV addrg
...
' C_hyper_write_20 ' (symbol refcount = 0)
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_hyper_write_19)<<S32 ' LTI4 reg coni
 word I16A_NEG + (r0)<<D16A + (r17)<<S16A ' NEGI4
 alignl ' align long
C_hyper_write_12
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
