...
DAT ' initialized data segment
 ...
 alignl_label
C_s878_6a858b6b_mailbox_L000002 ' <symbol:mailbox>
 long $0

 alignl_label
C_s8781_6a858b6b_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl_label
C_s8782_6a858b6b_initialize_L000004 ' <symbol:initialize>
 alignl_p1
 long I32_NEWF + 8<<S32
 alignl_p1
 long I32_PSHM + $540000<<S32 ' save registers
 alignl_p1
 long I32_LODI + (@C_s878_6a858b6b_mailbox_L000002)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s8782_6a858b6b_initialize_L000004_6)<<S32 ' NEU4 reg coni
 ...
 alignl_p1
 long I32_BR_B + (@C_s8782_6a858b6b_initialize_L000004_8)<<S32 ' LTI4 reg coni
 alignl_p1
 ...
 alignl_p1
 long I32_LODA + (@C_s878_6a858b6b_mailbox_L000002)<<S32
 word I16A_WRLONG + (r20)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 long @C_s8781_6a858b6b_lock_L000003 ' reg <- addrg
 word I16A_SHRI + (r22)<<D16A + (24)<<S16A ' SHRU4 reg coni
 alignl_p1
 long I32_LODA + (@C_s8781_6a858b6b_lock_L000003)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16A_RDLONG + (r22)<<D16A + (r20)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s8782_6a858b6b_initialize_L000004_10)<<S32 ' NEI4 reg coni
 alignl_p1
 ...
 alignl_p1
 long I32_LODI + (@C_s8781_6a858b6b_lock_L000003)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_B + (@C_s8782_6a858b6b_initialize_L000004_11)<<S32 ' LTI4 reg coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 alignl_p1
 long I32_LODI + (@C_s8781_6a858b6b_lock_L000003)<<S32
 ...
 alignl_p1
 long I32_JMPA + (@C_s8782_6a858b6b_initialize_L000004_11)<<S32 ' JUMPV addrg
 alignl_label
C_s8782_6a858b6b_initialize_L000004_10
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl_label
C_s8782_6a858b6b_initialize_L000004_11
 alignl_label
C_s8782_6a858b6b_initialize_L000004_8
 alignl_label
C_s8782_6a858b6b_initialize_L000004_6
' C_s8782_6a858b6b_initialize_L000004_5 ' (symbol refcount = 0)
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s8783_6a858b6b_s_wait_rxready_L000014 ' <symbol:s_wait_rxready>
 alignl_p1
 long I32_PSHM + $d00000<<S32 ' save registers
 word I16A_NEGI + (r23)<<D16A + (-(-2)&$1F)<<S16A ' reg <- conn
 word I16A_CMPSI + (r2)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRBE + (@C_s8783_6a858b6b_s_wait_rxready_L000014_16)<<S32 ' LEI4 reg coni
 alignl_label
C_s8783_6a858b6b_s_wait_rxready_L000014_18
 ...
 alignl_p1
 long I32_BRNZ + (@C_s8783_6a858b6b_s_wait_rxready_L000014_21)<<S32 ' NEI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r3)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 alignl_p1
 ...
 alignl_label
C_s8783_6a858b6b_s_wait_rxready_L000014_21
' C_s8783_6a858b6b_s_wait_rxready_L000014_19 ' (symbol refcount = 0)
 word I16A_CMPSI + (r2)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_A + (@C_s8783_6a858b6b_s_wait_rxready_L000014_18)<<S32 ' GTI4 reg coni
 word I16A_NEGI + (r22)<<D16A + (-(-10)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r2)<<D16A + (r22)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s8783_6a858b6b_s_wait_rxready_L000014_17)<<S32 ' NEI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r3)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 alignl_p1
 ...
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
 alignl_p1
 long I32_JMPA + (@C_s8783_6a858b6b_s_wait_rxready_L000014_17)<<S32 ' JUMPV addrg
 alignl_label
C_s8783_6a858b6b_s_wait_rxready_L000014_16
 alignl_label
C_s8783_6a858b6b_s_wait_rxready_L000014_25
' C_s8783_6a858b6b_s_wait_rxready_L000014_26 ' (symbol refcount = 0)
 word I16A_MOV + (r22)<<D16A + (r3)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 alignl_p1
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s8783_6a858b6b_s_wait_rxready_L000014_25)<<S32 ' NEI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r3)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 alignl_p1
 ...
 word I16A_RDLONG + (r23)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 alignl_label
C_s8783_6a858b6b_s_wait_rxready_L000014_17
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_s8783_6a858b6b_s_wait_rxready_L000014_15 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl_p1

 alignl_label
C_s8784_6a858b6b_s_read_async_L000028 ' <symbol:s_read_async>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_CALA + (@C_s8783_6a858b6b_s_wait_rxready_L000014)<<S32
...
' C_s8784_6a858b6b_s_read_async_L000028_29 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s8785_6a858b6b_s_read_L000030 ' <symbol:s_read>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 alignl_p1
 long I32_CALA + (@C_s8784_6a858b6b_s_read_async_L000028)<<S32
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_s8785_6a858b6b_s_read_L000030_31 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s8786_6a858b6b_s_wait_txready_L000032 ' <symbol:s_wait_txready>
 alignl_p1
 long I32_PSHM + $500000<<S32 ' save registers
 alignl_label
C_s8786_6a858b6b_s_wait_txready_L000032_34
' C_s8786_6a858b6b_s_wait_txready_L000032_35 ' (symbol refcount = 0)
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s8786_6a858b6b_s_wait_txready_L000032_34)<<S32 ' NEI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 alignl_p1
...
' C_s8786_6a858b6b_s_wait_txready_L000032_33 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl_p1

 alignl_label
C_s8787_6a858b6b_s_write_async_L000037 ' <symbol:s_write_async>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 long I32_PSHM + $f80000<<S32 ' save registers
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s8786_6a858b6b_s_wait_txready_L000032)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 alignl_p1
 ...
 word I16A_ADDSI + (r22)<<D16A + (8)<<S16A ' ADDP4 reg coni
 word I16A_WRLONG + (r21)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
' C_s8787_6a858b6b_s_write_async_L000037_38 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s8788_6a858b6b_s_write_L000039 ' <symbol:s_write>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 long I32_PSHM + $e80000<<S32 ' save registers
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl_p1
 long I32_CALA + (@C_s8787_6a858b6b_s_write_async_L000037)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s8786_6a858b6b_s_wait_txready_L000032)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_s8788_6a858b6b_s_write_L000039_40 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s8789_6a858b6b_s_txsize_L000041 ' <symbol:s_txsize>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl_p1
 long I32_CALA + (@C_s8788_6a858b6b_s_write_L000039)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_s8789_6a858b6b_s_txsize_L000041_42 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s878a_6a858b6b_s_txfree_L000043 ' <symbol:s_txfree>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 long I32_PSHM + $c00000<<S32 ' save registers
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_s878a_6a858b6b_s_txfree_L000043_44 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_s_rxcheck ' <symbol:s_rxcheck>
 ...
 alignl_p1
 long I32_CALA + (@C_s8782_6a858b6b_initialize_L000004)<<S32 ' CALL addrg
 alignl_label
C_s_rxcheck_46
 alignl_p1
 long I32_LODI + (@C_s878_6a858b6b_mailbox_L000002)<<S32
...
C_s_rxcheck_51
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl_p1
 long I32_CALA + (@C_s8785_6a858b6b_s_read_L000030)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl_p1
...
C_s_txflush_104
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s8789_6a858b6b_s_txsize_L000041)<<S32 ' CALL addrg
...
' C_s_txflush_107 ' (symbol refcount = 0)
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl_p1
 long I32_CALA + (@C_s878a_6a858b6b_s_txfree_L000043)<<S32 ' CALL addrg
