...
' Catalina Export s2_str

 alignl ' align long
C_s2_str ' <symbol:s2_str>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_JMPA + (@C_s2_str_3)<<S32 ' JUMPV addrg
 alignl ' align long
C_s2_str_2
...
C_s2_str_3
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s2_str_2)<<S32 ' NEI4 reg coni
' C_s2_str_1 ' (symbol refcount = 0)
