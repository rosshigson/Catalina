...
' Catalina Export s2_decl

 alignl ' align long
C_s2_decl ' <symbol:s2_decl>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRAE + (@C_s2_decl_2)<<S32 ' GEI4 reg coni
 word I16A_MOVI + (r19)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
C_s2_decl_2
 word I16A_CMPSI + (r19)<<D16A + (10)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s2_decl_4)<<S32 ' LEI4 reg coni
 word I16A_MOVI + (r19)<<D16A + (10)<<S16A ' reg <- coni
 alignl ' align long
C_s2_decl_4
 word I16A_CMPSI + (r21)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_s2_decl_6)<<S32 ' GEI4 reg coni
...
' C_s2_decl_11 ' (symbol refcount = 0)
 word I16A_SUBSI + (r13)<<D16A + (1)<<S16A ' SUBI4 reg coni
 alignl ' align long
C_s2_decl_13
 word I16A_CMPSI + (r13)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s2_decl_10)<<S32 ' GTI4 reg coni
 alignl ' align long
C_s2_decl_8
 word I16A_MOVI + (r13)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_s2_decl_17)<<S32 ' JUMPV addrg
 alignl ' align long
C_s2_decl_14
 word I16A_CMPS + (r21)<<D16A + (r15)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s2_decl_18)<<S32 ' LTI4 reg reg
 ...
 alignl ' align long
 long I32_JMPA + (@C_s2_decl_19)<<S32 ' JUMPV addrg
 alignl ' align long
C_s2_decl_18
 word I16A_CMPSI + (r15)<<D16A + (1)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s2_decl_23)<<S32 ' EQI4 reg coni
 word I16A_CMPSI + (r11)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s2_decl_23)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (2)<<S16A ' reg <- coni
 word I16A_AND + (r22)<<D16A + (r17)<<S16A ' BANDI/U (2)
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s2_decl_20)<<S32 ' EQI4 reg coni
 alignl ' align long
C_s2_decl_23
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_s2_decl_21)<<S32 ' JUMPV addrg
 alignl ' align long
C_s2_decl_20
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s2_decl_24)<<S32 ' EQI4 reg coni
 alignl ' align long
...
C_s2_decl_19
 ...
 word I16B_DIVS ' DIVI
 word I16A_MOV + (r15)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_s2_decl_15 ' (symbol refcount = 0)
 word I16A_ADDSI + (r13)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
C_s2_decl_17
 word I16A_CMPS + (r13)<<D16A + (r19)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s2_decl_14)<<S32 ' LTI4 reg reg
' C_s2_decl_1 ' (symbol refcount = 0)
