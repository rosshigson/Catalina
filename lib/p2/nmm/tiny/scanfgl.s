...
'
 ...
 alignl ' align long
C_s4p0_6709f9bc_charT_oI_nt_L000001 ' <symbol:charToInt>
 calld PA,#PSHM
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #10 wcz
 if_b jmp #\C_s4p0_6709f9bc_charT_oI_nt_L000001_3 ' LTI4
 mov r22, r2 ' CVUI
 and r22, cviu_m1 ' zero extend
 subs r22, #7 ' SUBI4 coni
 mov r2, r22 ' CVI, CVU or LOAD
C_s4p0_6709f9bc_charT_oI_nt_L000001_3
 mov r22, r2 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #15 wcz
 if_be jmp #\C_s4p0_6709f9bc_charT_oI_nt_L000001_5 ' LEI4
 mov r22, r2 ' CVUI
 and r22, cviu_m1 ' zero extend
 subs r22, #32 ' SUBI4 coni
 mov r2, r22 ' CVI, CVU or LOAD
C_s4p0_6709f9bc_charT_oI_nt_L000001_5
 mov r0, r2 ' CVUI
 and r0, cviu_m1 ' zero extend
' C_s4p0_6709f9bc_charT_oI_nt_L000001_2 ' (symbol refcount = 0)
...
C__scanf_getl_19
 ...
 calld PA,#CALA
 long @C_s4p0_6709f9bc_charT_oI_nt_L000001 ' CALL addrg
