...
'
 ...
 alignl ' align long
C_scbo_69f67cc3_isspace_L000001 ' <symbol:isspace>
 calld PA,#PSHM
 long $800000 ' save registers
 cmps r2,  #0 wz
 if_z jmp #\C_scbo_69f67cc3_isspace_L000001_11 ' EQI4
 cmps r2,  #32 wz
 if_z jmp #\C_scbo_69f67cc3_isspace_L000001_11 ' EQI4
 cmps r2,  #12 wz
 if_z jmp #\C_scbo_69f67cc3_isspace_L000001_11 ' EQI4
 ...
 if_z jmp #\C_scbo_69f67cc3_isspace_L000001_11 ' EQI4
 cmps r2,  #10 wz
 if_nz jmp #\C_scbo_69f67cc3_isspace_L000001_4 ' NEI4
C_scbo_69f67cc3_isspace_L000001_11
 mov r23, #1 ' reg <- coni
 jmp #\@C_scbo_69f67cc3_isspace_L000001_5 ' JUMPV addrg
C_scbo_69f67cc3_isspace_L000001_4
 mov r23, #0 ' reg <- coni
C_scbo_69f67cc3_isspace_L000001_5
 mov r0, r23 ' CVI, CVU or LOAD
' C_scbo_69f67cc3_isspace_L000001_2 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETN


 alignl ' align long
C_scbo1_69f67cc3_trim_L000012 ' <symbol:trim>
 calld PA,#NEWF
 calld PA,#PSHM
 long $c00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 jmp #\@C_scbo1_69f67cc3_trim_L000012_15 ' JUMPV addrg
C_scbo1_69f67cc3_trim_L000012_14
 adds r23, #1 ' ADDP4 coni
C_scbo1_69f67cc3_trim_L000012_15
 rdbyte r2, r23 ' reg <- CVUI4 INDIRU1 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scbo_69f67cc3_isspace_L000001 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_scbo1_69f67cc3_trim_L000012_14 ' NEI4
 mov r0, r23 ' CVI, CVU or LOAD
' C_scbo1_69f67cc3_trim_L000012_13 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_scbo2_69f67cc3__scanf_gets_L000017 ' <symbol:_scanf_gets>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 jmp #\@C_scbo2_69f67cc3__scanf_gets_L000017_20 ' JUMPV addrg
C_scbo2_69f67cc3__scanf_gets_L000017_19
...
C_scbo2_69f67cc3__scanf_gets_L000017_20
 mov r22, r19 ' CVI, CVU or LOAD
 mov r19, r22
 sub r19, #1 ' SUBU4 coni
 cmp r22,  #0 wz
 if_z jmp #\C_scbo2_69f67cc3__scanf_gets_L000017_22 ' EQU4
 cmps r17,  #0 wz
 if_nz jmp #\C_scbo2_69f67cc3__scanf_gets_L000017_19 ' NEI4
 rdbyte r2, r23 ' reg <- CVUI4 INDIRU1 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scbo_69f67cc3_isspace_L000001 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_scbo2_69f67cc3__scanf_gets_L000017_19 ' EQI4
C_scbo2_69f67cc3__scanf_gets_L000017_22
 cmps r17,  #0 wz
 if_nz jmp #\C_scbo2_69f67cc3__scanf_gets_L000017_23 ' NEI4
 mov r22, #0 ' reg <- coni
 wrbyte r22, r21 ' ASGNU1 reg reg
C_scbo2_69f67cc3__scanf_gets_L000017_23
 mov r0, r23 ' CVI, CVU or LOAD
' C_scbo2_69f67cc3__scanf_gets_L000017_18 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C__doscanf_26
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scbo1_69f67cc3_trim_L000012 ' CALL addrg
...
C__doscanf_49
 ...
 calld PA,#CALA
 long @C_scbo2_69f67cc3__scanf_gets_L000017
