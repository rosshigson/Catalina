...
C_g_tri ' <symbol:g_tri>
 ...
 cmps r22, r21 wcz
 if_b jmp #\C_g_tri_11 ' LTI4
 mov r13, #4 ' reg <- coni
 jmp #\@C_g_tri_12 ' JUMPV addrg
C_g_tri_11
 mov r13, #0 ' reg <- coni
C_g_tri_12
 cmps r21, r17 wcz
 if_b jmp #\C_g_tri_13 ' LTI4
 mov r11, #2 ' reg <- coni
 jmp #\@C_g_tri_14 ' JUMPV addrg
C_g_tri_13
 mov r11, #0 ' reg <- coni
C_g_tri_14
 mov r22, FP
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22, r17 wcz
 if_b jmp #\C_g_tri_15 ' LTI4
 mov r9, #1 ' reg <- coni
 jmp #\@C_g_tri_16 ' JUMPV addrg
C_g_tri_15
 mov r9, #0 ' reg <- coni
C_g_tri_16
 mov r22, r13 ' BORI/U
 ...
 or r15, r9 ' BORI/U (3)
 cmps r15,  #0 wcz
 if_b jmp #\C_g_tri_5 ' LTI4
 cmps r15,  #5 wcz
 if_a jmp #\C_g_tri_5 ' GTI4
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_g_tri_22_L000024 ' reg <- addrg
