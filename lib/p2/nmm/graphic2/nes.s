...
C_nes_encode ' <symbol:nes_encode>
 ...
 mov r23, #0 ' reg <- coni
 cmps r3,  #255 wz
 if_nz jmp #\C_nes_encode_5 ' NEI4
 or r23, #1 ' BORU4 coni
C_nes_encode_5
 cmps r3,  #0 wz
 if_nz jmp #\C_nes_encode_7 ' NEI4
 or r23, #2 ' BORU4 coni
C_nes_encode_7
 cmps r4,  #255 wz
 if_nz jmp #\C_nes_encode_9 ' NEI4
 or r23, #4 ' BORU4 coni
C_nes_encode_9
 cmps r4,  #0 wz
 if_nz jmp #\C_nes_encode_11 ' NEI4
 or r23, #8 ' BORU4 coni
C_nes_encode_11
 mov r22, r2
 and r22, #2 ' BANDU4 coni
 cmp r22,  #0 wz
 if_z jmp #\C_nes_encode_13 ' EQU4
 or r23, #128 ' BORU4 coni
C_nes_encode_13
 mov r22, r2
 and r22, #4 ' BANDU4 coni
 cmp r22,  #0 wz
 if_z jmp #\C_nes_encode_15 ' EQU4
 or r23, #64 ' BORU4 coni
C_nes_encode_15
 mov r22, ##512 ' reg <- con
 and r22, r2 ' BANDI/U (2)
 cmp r22,  #0 wz
 if_z jmp #\C_nes_encode_17 ' EQU4
 or r23, #16 ' BORU4 coni
C_nes_encode_17
 mov r22, r2
 and r22, #256 ' BANDU4 coni
 cmp r22,  #0 wz
 if_z jmp #\C_nes_encode_19 ' EQU4
