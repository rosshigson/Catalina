...
C_g_setup_2 ' <symbol:g_setup_2>
 ...
 wrlong r22, ##@C_G__V_A_R_ ' ASGNI4 addrg reg
 wrlong r23, ##@C_G__V_A_R_+4 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+8 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+12 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 ...
 wrlong r0, ##@C_G__V_A_R_+24 ' ASGNP4 addrg reg
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C_cgi_slices ' CALL addrg
 wrlong r0, ##@C_G__V_A_R_+28 ' ASGNP4 addrg reg
 mov r2, #0 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_cgi_screen_data ' CALL addrg
 wrlong r0, ##@C_G__V_A_R_+32 ' ASGNP4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+36 ' ASGNU4 addrg reg
 mov r22, ##$55555555 ' reg <- con
 wrlong r22, ##@C_G__V_A_R_+36+4 ' ASGNU4 addrg reg
 mov r22, ##$aaaaaaaa ' reg <- con
 wrlong r22, ##@C_G__V_A_R_+36+8 ' ASGNU4 addrg reg
 mov r22, ##$ffffffff ' reg <- con
 wrlong r22, ##@C_G__V_A_R_+36+12 ' ASGNU4 addrg reg
