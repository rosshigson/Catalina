...
DAT ' initialized data segment
 ...
 alignl ' align long
C_so9s_67cacddc_startupD_ata_L000002 ' <symbol:startupData>
 long $0

 alignl ' align long
C_so9s1_67cacddc_deviceD_ata_L000003 ' <symbol:deviceData>
 long $0

 alignl ' align long
C_so9s2_67cacddc_Q_osD_ata_L000004 ' <symbol:QosData>
 long $0

 alignl ' align long
C_so9s3_67cacddc_mailboxes_L000005 ' <symbol:mailboxes>
 long $0

 alignl ' align long
C_so9s4_67cacddc_drivercog_L000006 ' <symbol:drivercog>
 long -1

 alignl ' align long
C_so9s5_67cacddc_driverlock_L000007 ' <symbol:driverlock>
 long -1

 alignl ' align long
C_so9s6_67cacddc_delayT_able_r_L000008 ' <symbol:delayTable_r>
 long $6
 long $57bcf00
 long $80befc0
 long $b34a700
 ...
 alignl ' align long
C_so9s7_67cacddc_delayT_able_f_L000009 ' <symbol:delayTable_f>
 long $5
 long $42c1d80
 long $68e7780
 long $9896800
...
C_hyper_getM_ailbox ' <symbol:hyper_getMailbox>
 ...
 mov r20, ##@C_so9s3_67cacddc_mailboxes_L000005
...
C_hyper_initialize ' <symbol:hyper_initialize>
 ...
 mov r22, ##@C_so9s_67cacddc_startupD_ata_L000002
 ...
 wrlong r0, ##@C_so9s4_67cacddc_drivercog_L000006 ' ASGNI4 addrg reg
 mov r22, ##@C_so9s4_67cacddc_drivercog_L000006
 ...
 mov r18, ##@C_so9s4_67cacddc_drivercog_L000006
 ...
 mov r22, ##@C_so9s_67cacddc_startupD_ata_L000002 ' reg <- addrg
 mov r18, FP
 sub r18, #-(-8) ' reg <- addrli
 rdlong r18, r18 ' reg <- INDIRU4 reg
 and r20, r18 ' BANDI/U (2)
 wrlong r20, ##@C_so9s_67cacddc_startupD_ata_L000002 ' ASGNP4 addrg reg
 mov r20, ##@C_so9s1_67cacddc_deviceD_ata_L000003 ' reg <- addrg
 rdlong r22, r22 ' reg <- INDIRP4 reg
 adds r22, #32 ' ADDP4 coni
 wrlong r22, ##@C_so9s1_67cacddc_deviceD_ata_L000003 ' ASGNP4 addrg reg
 mov r22, ##@C_so9s2_67cacddc_Q_osD_ata_L000004 ' reg <- addrg
 rdlong r20, r20 ' reg <- INDIRP4 reg
 adds r20, #128 ' ADDP4 coni
 wrlong r20, ##@C_so9s2_67cacddc_Q_osD_ata_L000004 ' ASGNP4 addrg reg
 rdlong r22, r22 ' reg <- INDIRP4 reg
 adds r22, #32 ' ADDP4 coni
 wrlong r22, ##@C_so9s3_67cacddc_mailboxes_L000005 ' ASGNP4 addrg reg
 mov r22, ##@C_so9s5_67cacddc_driverlock_L000007 ' reg <- addrg
 mov r20, r18
 shr r20, #24 ' RSHU4 coni
 wrlong r20, ##@C_so9s5_67cacddc_driverlock_L000007 ' ASGNI4 addrg reg
 ...
 wrlong r0, ##@C_so9s5_67cacddc_driverlock_L000007 ' ASGNI4 addrg reg
 mov r22, ##@C_so9s5_67cacddc_driverlock_L000007
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, ##@C_so9s5_67cacddc_driverlock_L000007
 ...
 calld PA,#CALA
 long @C__registry ' CALL addrg
 mov r20, ##@C_so9s4_67cacddc_drivercog_L000006
 rdlong r20, r20 ' reg <- INDIRI4 addrg
...
C_hyper_initialize_16
 ...
 wrlong r22, ##@C_so9s5_67cacddc_driverlock_L000007 ' ASGNI4 addrg reg
C_hyper_initialize_17
C_hyper_initialize_14
C_hyper_initialize_12
 mov r0, ##@C_so9s4_67cacddc_drivercog_L000006
...
C_hyper_stop_21
 mov r22, ##-1 ' reg <- con
 wrlong r22, ##@C_so9s4_67cacddc_drivercog_L000006 ' ASGNI4 addrg reg
 mov r20, ##@C_so9s5_67cacddc_driverlock_L000007
 rdlong r20, r20 ' reg <- INDIRI4 addrg
 cmps r20, r22 wz
 if_z jmp #\C_hyper_stop_29 ' EQI4
 mov r2, ##@C_so9s5_67cacddc_driverlock_L000007
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
C_hyper_getD_riverL_ock ' <symbol:hyper_getDriverLock>
 ...
 calld PA,#CALA
 long @C_hyper_initialize ' CALL addrg
 mov r0, ##@C_so9s5_67cacddc_driverlock_L000007
 rdlong r0, r0 ' reg <- INDIRI4 addrg
' C_hyper_getD_riverL_ock_32 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033 ' <symbol:hyper_getStartBank>
 calld PA,#NEWF
 sub SP, #4
 calld PA,#PSHM
 ...
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_so9s1_67cacddc_deviceD_ata_L000003
 rdlong r20, r20 ' reg <- INDIRP4 addrg
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #25 wz
 if_nz jmp #\C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_35 ' NEI4
 and r23, #14 ' BANDI4 coni
 jmp #\@C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_36 ' JUMPV addrg
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_35
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #26 wz
 if_nz jmp #\C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_37 ' NEI4
 and r23, #12 ' BANDI4 coni
 jmp #\@C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_38 ' JUMPV addrg
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_37
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #27 wz
 if_nz jmp #\C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_39 ' NEI4
 and r23, #8 ' BANDI4 coni
 jmp #\@C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_40 ' JUMPV addrg
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_39
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #28 wz
 if_nz jmp #\C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_41 ' NEI4
 mov r23, #0 ' reg <- coni
 jmp #\@C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_42 ' JUMPV addrg
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_41
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #28 wcz
 if_be jmp #\C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_43 ' LEI4
 mov r0, ##-6 ' RET con
 jmp #\@C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_34 ' JUMPV addrg
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_43
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_42
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_40
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_38
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_36
 mov r0, r23 ' CVI, CVU or LOAD
C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033_34
 calld PA,#POPM ' restore registers
 add SP, #4 ' framesize
 calld PA,#RETF
...
C_hyper_getF_lashS_ize_46
 ...
 mov r20, r21
 shl r20, #2 ' LSHI4 coni
 mov r18, ##@C_so9s1_67cacddc_deviceD_ata_L000003
...
C_hyper_readR_aw ' <symbol:hyper_readRaw>
 ...
 calld PA,#CALA
 long @C_hyper_initialize ' CALL addrg
 mov r2, ##@C_so9s4_67cacddc_drivercog_L000006
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
C_hyper_modifyB_ankP_arams_73
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_so9s8_67cacddc_hyper_getS_tartB_ank_L000033 ' CALL addrg
...
C_hyper_modifyB_ankP_arams_72
 ...
 alignl ' align long
C_so9s9_67cacddc_getB_ankP_arams_L000092 ' <symbol:getBankParams>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 jmp #\@C_so9s9_67cacddc_getB_ankP_arams_L000092_95 ' JUMPV addrg
C_so9s9_67cacddc_getB_ankP_arams_L000092_94
 mov r2, #1 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__waitms ' CALL addrg
C_so9s9_67cacddc_getB_ankP_arams_L000092_95
 mov r2, ##@C_so9s5_67cacddc_driverlock_L000007
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 long @C__locktry ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_so9s9_67cacddc_getB_ankP_arams_L000092_94 ' EQI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cogid ' CALL addrg
...
C_so9s9_67cacddc_getB_ankP_arams_L000092_97
 rdlong r19, r17 ' reg <- INDIRI4 reg
' C_so9s9_67cacddc_getB_ankP_arams_L000092_98 ' (symbol refcount = 0)
 cmps r19,  #0 wcz
 if_b jmp #\C_so9s9_67cacddc_getB_ankP_arams_L000092_97 ' LTI4
 cmps r19,  #0 wcz
 if_be jmp #\C_so9s9_67cacddc_getB_ankP_arams_L000092_100 ' LEI4
 neg r19, r19 ' NEGI4
 mov r2, ##@C_so9s5_67cacddc_driverlock_L000007
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 ...
 jmp #\@C_so9s9_67cacddc_getB_ankP_arams_L000092_93 ' JUMPV addrg
C_so9s9_67cacddc_getB_ankP_arams_L000092_100
 cmps r21,  #1 wz
 if_nz jmp #\C_so9s9_67cacddc_getB_ankP_arams_L000092_102 ' NEI4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 shr r22, #16 ' RSHU4 coni
 mov r19, r22 ' CVI, CVU or LOAD
 jmp #\@C_so9s9_67cacddc_getB_ankP_arams_L000092_103 ' JUMPV addrg
C_so9s9_67cacddc_getB_ankP_arams_L000092_102
 cmps r21,  #2 wz
 if_nz jmp #\C_so9s9_67cacddc_getB_ankP_arams_L000092_104 ' NEI4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 and r22, #15 ' BANDU4 coni
 mov r19, r22 ' CVI, CVU or LOAD
 jmp #\@C_so9s9_67cacddc_getB_ankP_arams_L000092_105 ' JUMPV addrg
C_so9s9_67cacddc_getB_ankP_arams_L000092_104
 cmps r21,  #4 wz
 if_nz jmp #\C_so9s9_67cacddc_getB_ankP_arams_L000092_106 ' NEI4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 and r22, #15 ' BANDU4 coni
 mov r19, r22 ' CVI, CVU or LOAD
 jmp #\@C_so9s9_67cacddc_getB_ankP_arams_L000092_107 ' JUMPV addrg
C_so9s9_67cacddc_getB_ankP_arams_L000092_106
 cmps r21,  #3 wz
 if_nz jmp #\C_so9s9_67cacddc_getB_ankP_arams_L000092_108 ' NEI4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 and r22, r20 ' BANDI/U (1)
 cmp r22,  #0 wz
 if_z jmp #\C_so9s9_67cacddc_getB_ankP_arams_L000092_110 ' EQU4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 shr r22, #16 ' RSHU4 coni
 ...
 add r22, r20 ' ADDU (1)
 mov r19, r22 ' CVI, CVU or LOAD
 jmp #\@C_so9s9_67cacddc_getB_ankP_arams_L000092_109 ' JUMPV addrg
C_so9s9_67cacddc_getB_ankP_arams_L000092_110
 mov r19, #0 ' reg <- coni
 jmp #\@C_so9s9_67cacddc_getB_ankP_arams_L000092_109 ' JUMPV addrg
C_so9s9_67cacddc_getB_ankP_arams_L000092_108
 mov r19, ##-6 ' reg <- con
C_so9s9_67cacddc_getB_ankP_arams_L000092_109
C_so9s9_67cacddc_getB_ankP_arams_L000092_107
C_so9s9_67cacddc_getB_ankP_arams_L000092_105
C_so9s9_67cacddc_getB_ankP_arams_L000092_103
 mov r2, ##@C_so9s5_67cacddc_driverlock_L000007
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 long @C__lockclr ' CALL addrg
 mov r0, r19 ' CVI, CVU or LOAD
C_so9s9_67cacddc_getB_ankP_arams_L000092_93
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_so9sa_67cacddc_validH_yperR_A_M__L000112 ' <symbol:validHyperRAM>
 calld PA,#NEWF
 sub SP, #4
 calld PA,#PSHM
 long $500000 ' save registers
 ...
 and r22, r20 ' BANDI/U (1)
 cmps r22,  #0 wz
 if_z jmp #\C_so9sa_67cacddc_validH_yperR_A_M__L000112_114 ' EQI4
 mov r0, ##-23 ' RET con
 jmp #\@C_so9sa_67cacddc_validH_yperR_A_M__L000112_113 ' JUMPV addrg
C_so9sa_67cacddc_validH_yperR_A_M__L000112_114
 mov r0, #0 ' reg <- coni
C_so9sa_67cacddc_validH_yperR_A_M__L000112_113
 calld PA,#POPM ' restore registers
 add SP, #4 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_so9sb_67cacddc_hyper_lookupD_elay_L000116 ' <symbol:hyper_lookupDelay>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_so9sa_67cacddc_validH_yperR_A_M__L000112 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_so9sb_67cacddc_hyper_lookupD_elay_L000116_118 ' NEI4
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_so9s6_67cacddc_delayT_able_r_L000008 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r17, r22 ' CVI, CVU or LOAD
 jmp #\@C_so9sb_67cacddc_hyper_lookupD_elay_L000116_121 ' JUMPV addrg
C_so9sb_67cacddc_hyper_lookupD_elay_L000116_120
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r19
 shl r20, #2 ' LSHI4 coni
 mov r18, ##@C_so9s6_67cacddc_delayT_able_r_L000008+4 ' reg <- addrg
 adds r20, r18 ' ADDI/P (1)
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_ae jmp #\C_so9sb_67cacddc_hyper_lookupD_elay_L000116_124 ' GEU4
 jmp #\@C_so9sb_67cacddc_hyper_lookupD_elay_L000116_119 ' JUMPV addrg
C_so9sb_67cacddc_hyper_lookupD_elay_L000116_124
 adds r19, #1 ' ADDI4 coni
 adds r17, #1 ' ADDI4 coni
C_so9sb_67cacddc_hyper_lookupD_elay_L000116_121
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_so9s6_67cacddc_delayT_able_r_L000008+4 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_so9sb_67cacddc_hyper_lookupD_elay_L000116_120  ' NEU4
 jmp #\@C_so9sb_67cacddc_hyper_lookupD_elay_L000116_119 ' JUMPV addrg
C_so9sb_67cacddc_hyper_lookupD_elay_L000116_118
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_so9s7_67cacddc_delayT_able_f_L000009 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r17, r22 ' CVI, CVU or LOAD
 jmp #\@C_so9sb_67cacddc_hyper_lookupD_elay_L000116_128 ' JUMPV addrg
C_so9sb_67cacddc_hyper_lookupD_elay_L000116_127
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r19
 shl r20, #2 ' LSHI4 coni
 mov r18, ##@C_so9s7_67cacddc_delayT_able_f_L000009+4 ' reg <- addrg
 adds r20, r18 ' ADDI/P (1)
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_ae jmp #\C_so9sb_67cacddc_hyper_lookupD_elay_L000116_131 ' GEU4
 jmp #\@C_so9sb_67cacddc_hyper_lookupD_elay_L000116_129 ' JUMPV addrg
C_so9sb_67cacddc_hyper_lookupD_elay_L000116_131
 adds r19, #1 ' ADDI4 coni
 adds r17, #1 ' ADDI4 coni
C_so9sb_67cacddc_hyper_lookupD_elay_L000116_128
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_so9s7_67cacddc_delayT_able_f_L000009+4 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_so9sb_67cacddc_hyper_lookupD_elay_L000116_127  ' NEU4
C_so9sb_67cacddc_hyper_lookupD_elay_L000116_129
C_so9sb_67cacddc_hyper_lookupD_elay_L000116_119
 mov r0, r17 ' CVI, CVU or LOAD
' C_so9sb_67cacddc_hyper_lookupD_elay_L000116_117 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_hyper_setD_elayF_requency_138
 ...
 calld PA,#CALA
 long @C_so9sb_67cacddc_hyper_lookupD_elay_L000116
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 mov r2, r22 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
...
C_hyper_getD_elay ' <symbol:hyper_getDelay>
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_so9s9_67cacddc_getB_ankP_arams_L000092
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
C_hyper_setQ_os_151
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_so9s2_67cacddc_Q_osD_ata_L000004
 rdlong r20, r20 ' reg <- INDIRP4 addrg
 adds r22, r20 ' ADDI/P (1)
 mov r20, ##-512 ' reg <- con
 and r20, r21 ' BANDI/U (2)
