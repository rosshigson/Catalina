...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_flashC_og_L000005 ' <symbol:flashCog>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002 ' <symbol:hyper_setFlashAccess>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 cmps r0,  #0 wcz
 if_ae jmp #\C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_9 ' GEI4
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_3 ' JUMPV addrg
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_8
 mov r2, #1 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__waitms ' CALL addrg
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_9
 mov r2, r19 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__locktry ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_8 ' EQI4
 cmps r21,  #0 wz
 if_z jmp #\C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_11 ' EQI4
 mov r22, ##@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_flashC_og_L000005
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_ae jmp #\C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_13 ' GEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cogid ' CALL addrg
 wrlong r0, ##@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_flashC_og_L000005 ' ASGNI4 addrg reg
 jmp #\@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_12 ' JUMPV addrg
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_13
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cogid ' CALL addrg
 mov r20, ##@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_flashC_og_L000005
 rdlong r20, r20 ' reg <- INDIRI4 addrg
 cmps r20, r0 wz
 if_z jmp #\C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_12 ' EQI4
 mov r2, r19 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 ...
 mov r0, ##-5 ' RET con
 jmp #\@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_3 ' JUMPV addrg
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_11
 mov r22, ##@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_flashC_og_L000005
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_ae jmp #\C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_17 ' GEI4
 mov r2, r19 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__lockclr ' CALL addrg
 mov r0, #0 ' reg <- coni
 jmp #\@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_3 ' JUMPV addrg
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_17
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cogid ' CALL addrg
 mov r20, ##@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_flashC_og_L000005
 rdlong r20, r20 ' reg <- INDIRI4 addrg
 cmps r20, r0 wz
 if_nz jmp #\C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_19 ' NEI4
 mov r22, ##-1 ' reg <- con
 wrlong r22, ##@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_flashC_og_L000005 ' ASGNI4 addrg reg
 jmp #\@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_20 ' JUMPV addrg
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_19
 mov r2, r19 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__lockclr ' CALL addrg
 mov r0, ##-6 ' RET con
 jmp #\@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_3 ' JUMPV addrg
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_20
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_12
 cmps r21,  #0 wz
 if_z jmp #\C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_22 ' EQI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cogid ' CALL addrg
 mov r22, r0
 ...
 jmp #\@C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_23 ' JUMPV addrg
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_22
 mov r15, #0 ' reg <- coni
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_23
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r17,  #0 wcz
 if_ae jmp #\C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_24 ' GEI4
 mov r2, r19 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__lockclr ' CALL addrg
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_24
 mov r0, r17 ' CVI, CVU or LOAD
C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002_3
...
C_hyper_lockF_lashA_ccess ' <symbol:hyper_lockFlashAccess>
 ...
 calld PA,#CALA
 long @C_sndc_68f73a12_hyper_setF_lashA_ccess_L000002
 add SP, #4 ' CALL addrg
...
' C_hyper_writeR_eg_29 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sndc2_68f73a12_erase_L000030 ' <symbol:erase>
 calld PA,#NEWF
 sub SP, #16
 calld PA,#PSHM
 ...
 cmps r22,  #0 wcz
 if_ae jmp #\C_sndc2_68f73a12_erase_L000030_32 ' GEI4
 mov r0, ##-22 ' RET con
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_32
 mov r22, ##262144 ' reg <- con
 and r22, r21 ' BANDI/U (2)
 cmps r22,  #0 wz
 if_z jmp #\C_sndc2_68f73a12_erase_L000030_34 ' EQI4
 ...
 sub RI, #-(-16)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #\@C_sndc2_68f73a12_erase_L000030_35 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_34
 mov r22, ##268435456 ' reg <- con
 and r22, r21 ' BANDI/U (2)
 cmps r22,  #0 wz
 if_z jmp #\C_sndc2_68f73a12_erase_L000030_36 ' EQI4
 ...
 sub RI, #-(-16)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #\@C_sndc2_68f73a12_erase_L000030_37 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_36
 mov r0, ##-6 ' RET con
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_37
C_sndc2_68f73a12_erase_L000030_35
 mov r22, ##262144 ' reg <- con
 and r22, r21 ' BANDI/U (2)
 cmps r22,  #0 wz
 if_z jmp #\C_sndc2_68f73a12_erase_L000030_38 ' EQI4
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_z jmp #\C_sndc2_68f73a12_erase_L000030_40 ' EQI4
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_40
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_nz jmp #\C_sndc2_68f73a12_erase_L000030_42 ' NEI4
 mov r2, #0 ' reg ARG coni
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 add SP, #4 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
C_sndc2_68f73a12_erase_L000030_42
 cmps r17,  #0 wcz
 if_ae jmp #\C_sndc2_68f73a12_erase_L000030_44 ' GEI4
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_44
 mov r22, r17
 and r22, #128 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_sndc2_68f73a12_erase_L000030_46 ' NEI4
 mov r0, ##-20 ' RET con
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_46
 mov r22, r17
 and r22, #32 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_sndc2_68f73a12_erase_L000030_48 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_48
 ...
 long @C_hyper_writeR_eg
 add SP, #8 ' CALL addrg
C_sndc2_68f73a12_erase_L000030_38
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_sndc2_68f73a12_erase_L000030_56 ' NEI4
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_z jmp #\C_sndc2_68f73a12_erase_L000030_50 ' EQI4
C_sndc2_68f73a12_erase_L000030_56
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_50
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 ...
 sub RI, #-(-20)
 wrlong r22, RI ' ASGNI4 addrli reg
C_sndc2_68f73a12_erase_L000030_57
 mov r2, #112 ' reg ARG coni
 mov r3, ##1365 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_nz jmp #\C_sndc2_68f73a12_erase_L000030_60 ' NEI4
 mov r2, #0 ' reg ARG coni
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 add SP, #4 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
C_sndc2_68f73a12_erase_L000030_60
 cmps r17,  #0 wcz
 if_ae jmp #\C_sndc2_68f73a12_erase_L000030_62 ' GEI4
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_62
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cnt ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 ...
 #endif
 cmp r15, r0 wcz 
 if_be jmp #\C_sndc2_68f73a12_erase_L000030_64 ' LEU4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__clockfreq ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
C_sndc2_68f73a12_erase_L000030_64
 mov r2, #10 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__waitms ' CALL addrg
' C_sndc2_68f73a12_erase_L000030_58 ' (symbol refcount = 0)
 mov r22, r17
 and r22, #128 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_sndc2_68f73a12_erase_L000030_66 ' NEI4
 mov r22, r19 ' CVI, CVU or LOAD
 cmp r11, r22 wcz 
 if_be jmp #\C_sndc2_68f73a12_erase_L000030_57 ' LEU4
C_sndc2_68f73a12_erase_L000030_66
 mov r22, r17
 and r22, #128 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_sndc2_68f73a12_erase_L000030_67 ' NEI4
 mov r0, ##-20 ' RET con
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_67
 mov r2, #113 ' reg ARG coni
 mov r3, ##1365 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 and r22, #32 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_sndc2_68f73a12_erase_L000030_69 ' EQI4
 mov r22, r17
 and r22, #2 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_sndc2_68f73a12_erase_L000030_71 ' EQI4
 mov r0, ##-21 ' RET con
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_71
 mov r0, ##-18 ' RET con
 jmp #\@C_sndc2_68f73a12_erase_L000030_31 ' JUMPV addrg
C_sndc2_68f73a12_erase_L000030_69
 mov r0, #0 ' reg <- coni
C_sndc2_68f73a12_erase_L000030_31
 calld PA,#POPM ' restore registers
 add SP, #16 ' framesize
 calld PA,#RETF
...
C_hyper_eraseF_lash_83
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_sndc2_68f73a12_erase_L000030
 add SP, #8 ' CALL addrg
 mov r19, r0 ' CVI, CVU or LOAD
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_hyper_eraseF_lash_73
 ...
 alignl ' align long
C_sndc3_68f73a12_programF_lashL_ine_L000085 ' <symbol:programFlashLine>
 calld PA,#NEWF
 calld PA,#PSHM
 long $faa000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 mov r19, r2 ' reg var <- reg arg
 cmp r19,  #0 wz
 if_nz jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_87  ' NEU4
 mov r0, #0 ' reg <- coni
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_87
 mov r22, #0 ' reg <- coni
 mov r20, r23 ' CVI, CVU or LOAD
 and r20, #1 ' BANDU4 coni
 cmp r20, r22 wz
 if_nz jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_91  ' NEU4
 mov r20, r19
 and r20, #1 ' BANDU4 coni
 cmp r20, r22 wz
 if_z jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_89 ' EQU4
C_sndc3_68f73a12_programF_lashL_ine_L000085_91
 mov r0, ##-4 ' RET con
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_89
 mov r22, r23 ' CVI, CVU or LOAD
 and r22, #511 ' BANDU4 coni
 add r22, r19 ' ADDU (2)
 mov r20, ##512 ' reg <- con
 cmp r22, r20 wcz 
 if_be jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_92 ' LEU4
 mov r0, ##-4 ' RET con
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_92
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_hyper_lockF_lashA_ccess ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wcz
 if_ae jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_94 ' GEI4
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_94
 mov r2, #170 ' reg ARG coni
 mov r3, ##1365 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r17, r22 ' CVI, CVU or LOAD
 cmps r22,  #0 wz
 if_nz jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_99 ' NEI4
 mov r2, #85 ' reg ARG coni
 mov r3, ##682 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_z jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_96 ' EQI4
C_sndc3_68f73a12_programF_lashL_ine_L000085_99
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_hyper_unlockF_lashA_ccess ' CALL addrg
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_96
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wcz
 if_ae jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_100 ' GEI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_hyper_unlockF_lashA_ccess ' CALL addrg
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_100
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cnt ' CALL addrg
 mov r13, r0 ' CVI, CVU or LOAD
 mov r15, #0 ' reg <- coni
C_sndc3_68f73a12_programF_lashL_ine_L000085_102
 mov r2, #112 ' reg ARG coni
 mov r3, ##1365 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_nz jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_105 ' NEI4
 mov r2, #0 ' reg ARG coni
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 add SP, #4 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
C_sndc3_68f73a12_programF_lashL_ine_L000085_105
 cmps r17,  #0 wcz
 if_ae jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_107 ' GEI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_hyper_unlockF_lashA_ccess ' CALL addrg
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_107
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cnt ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_sndc3_68f73a12_programF_lashL_ine_L000085_103 ' (symbol refcount = 0)
 mov r22, r17
 and r22, #128 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_109 ' NEI4
 cmp r15,  #2 wcz 
 if_be jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_102 ' LEU4
C_sndc3_68f73a12_programF_lashL_ine_L000085_109
 mov r22, r17
 and r22, #128 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_110 ' NEI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_hyper_unlockF_lashA_ccess ' CALL addrg
 mov r0, ##-20 ' RET con
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_110
 mov r2, #113 ' reg ARG coni
 mov r3, ##1365 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_112 ' EQI4
 mov r22, r17
 and r22, #2 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_sndc3_68f73a12_programF_lashL_ine_L000085_114 ' EQI4
 mov r0, ##-21 ' RET con
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_114
 mov r0, ##-19 ' RET con
 jmp #\@C_sndc3_68f73a12_programF_lashL_ine_L000085_86 ' JUMPV addrg
C_sndc3_68f73a12_programF_lashL_ine_L000085_112
 mov r0, #0 ' reg <- coni
C_sndc3_68f73a12_programF_lashL_ine_L000085_86
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_hyper_programF_lash_161
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_sndc3_68f73a12_programF_lashL_ine_L000085
 add SP, #8 ' CALL addrg
 mov r13, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wcz
...
C_hyper_programF_lashL_ong_181
 ...
 alignl ' align long
C_sndc4_68f73a12_readF_lashS_R__L000185 ' <symbol:readFlashSR>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wcz
 if_ae jmp #\C_sndc4_68f73a12_readF_lashS_R__L000185_187 ' GEI4
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #\@C_sndc4_68f73a12_readF_lashS_R__L000185_186 ' JUMPV addrg
C_sndc4_68f73a12_readF_lashS_R__L000185_187
 mov r2, #170 ' reg ARG coni
 mov r3, ##1365 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_nz jmp #\C_sndc4_68f73a12_readF_lashS_R__L000185_189 ' NEI4
 mov r2, #85 ' reg ARG coni
 mov r3, ##682 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_nz jmp #\C_sndc4_68f73a12_readF_lashS_R__L000185_191 ' NEI4
 ...
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_nz jmp #\C_sndc4_68f73a12_readF_lashS_R__L000185_193 ' NEI4
 mov r2, #0 ' reg ARG coni
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 add SP, #4 ' CALL addrg
 mov r19, r0 ' CVI, CVU or LOAD
C_sndc4_68f73a12_readF_lashS_R__L000185_193
C_sndc4_68f73a12_readF_lashS_R__L000185_191
C_sndc4_68f73a12_readF_lashS_R__L000185_189
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_hyper_unlockF_lashA_ccess ' CALL addrg
 mov r0, r19 ' CVI, CVU or LOAD
C_sndc4_68f73a12_readF_lashS_R__L000185_186
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_hyper_readF_lashI_C_R_ ' <symbol:hyper_readFlashICR>
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_sndc4_68f73a12_readF_lashS_R__L000185
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_hyper_readF_lashV_C_R__211 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sndc5_68f73a12_writeF_lashS_R__L000212 ' <symbol:writeFlashSR>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wcz
 if_ae jmp #\C_sndc5_68f73a12_writeF_lashS_R__L000212_214 ' GEI4
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_sndc5_68f73a12_writeF_lashS_R__L000212_213 ' JUMPV addrg
C_sndc5_68f73a12_writeF_lashS_R__L000212_214
 mov r2, #170 ' reg ARG coni
 mov r3, ##1365 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_nz jmp #\C_sndc5_68f73a12_writeF_lashS_R__L000212_216 ' NEI4
 mov r2, #85 ' reg ARG coni
 mov r3, ##682 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_nz jmp #\C_sndc5_68f73a12_writeF_lashS_R__L000212_218 ' NEI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, ##1365 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r17, r0 ' CVI, CVU or LOAD
 cmps r0,  #0 wz
 if_nz jmp #\C_sndc5_68f73a12_writeF_lashS_R__L000212_220 ' NEI4
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, #0 ' reg ARG coni
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 add SP, #8 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
C_sndc5_68f73a12_writeF_lashS_R__L000212_220
C_sndc5_68f73a12_writeF_lashS_R__L000212_218
C_sndc5_68f73a12_writeF_lashS_R__L000212_216
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_hyper_unlockF_lashA_ccess ' CALL addrg
 mov r0, r17 ' CVI, CVU or LOAD
C_sndc5_68f73a12_writeF_lashS_R__L000212_213
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_hyper_writeF_lashI_C_R_ ' <symbol:hyper_writeFlashICR>
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_sndc5_68f73a12_writeF_lashS_R__L000212
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
