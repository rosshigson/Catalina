...
DAT ' initialized data segment
 ...
 alignl ' align long
C_scfs_686cc545_unsupported_term_L000027 ' <symbol:unsupported_term>
 long @C_scfs1_686cc545_28_L000029
 long @C_scfs2_686cc545_30_L000031
 long @C_scfs3_686cc545_32_L000033
 long $0

 alignl ' align long
C_scfs4_686cc545_completionC_allback_L000034 ' <symbol:completionCallback>
 long $0

 alignl ' align long
C_scfs5_686cc545_hintsC_allback_L000035 ' <symbol:hintsCallback>
 long $0

 alignl ' align long
C_scfs6_686cc545_freeH_intsC_allback_L000036 ' <symbol:freeHintsCallback>
 long $0

 alignl ' align long
C_scfsa_686cc545_maskmode_L000040 ' <symbol:maskmode>
 long 0

 alignl ' align long
C_scfsb_686cc545_rawmode_L000041 ' <symbol:rawmode>
 long 0

 alignl ' align long
C_scfsc_686cc545_mlmode_L000042 ' <symbol:mlmode>
 long 0

 alignl ' align long
C_scfsd_686cc545_atexit_registered_L000043 ' <symbol:atexit_registered>
 long 0

 alignl ' align long
C_scfse_686cc545_history_max_len_L000044 ' <symbol:history_max_len>
 long 100

 alignl ' align long
C_scfsf_686cc545_history_len_L000045 ' <symbol:history_len>
 long 0

 alignl ' align long
C_scfsg_686cc545_history_L000046 ' <symbol:history>
 long $0
...
C_linenoiseM_askM_odeE_nable ' <symbol:linenoiseMaskModeEnable>
 ...
 long $400000 ' save registers
 mov r22, #1 ' reg <- coni
 wrlong r22, ##@C_scfsa_686cc545_maskmode_L000040 ' ASGNI4 addrg reg
...
C_linenoiseS_etM_ultiL_ine ' <symbol:linenoiseSetMultiLine>
 wrlong r2, ##@C_scfsc_686cc545_mlmode_L000042 ' ASGNI4 addrg reg
' C_linenoiseS_etM_ultiL_ine_51 ' (symbol refcount = 0)
 calld PA,#RETN


 alignl ' align long
C_scfsj_686cc545_isU_nsupportedT_erm_L000052 ' <symbol:isUnsupportedTerm>
 calld PA,#NEWF
 calld PA,#PSHM
 long $f00000 ' save registers
 mov r2, ##@C_scfsj_686cc545_isU_nsupportedT_erm_L000052_54_L000055 ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 ...
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_scfsj_686cc545_isU_nsupportedT_erm_L000052_56  ' NEU4
 mov r0, #0 ' reg <- coni
 jmp #\@C_scfsj_686cc545_isU_nsupportedT_erm_L000052_53 ' JUMPV addrg
C_scfsj_686cc545_isU_nsupportedT_erm_L000052_56
 mov r23, #0 ' reg <- coni
 jmp #\@C_scfsj_686cc545_isU_nsupportedT_erm_L000052_61 ' JUMPV addrg
C_scfsj_686cc545_isU_nsupportedT_erm_L000052_58
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_scfs_686cc545_unsupported_term_L000027 ' reg <- addrg
 ...
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_scfsj_686cc545_isU_nsupportedT_erm_L000052_62 ' NEI4
 mov r0, #1 ' reg <- coni
 jmp #\@C_scfsj_686cc545_isU_nsupportedT_erm_L000052_53 ' JUMPV addrg
C_scfsj_686cc545_isU_nsupportedT_erm_L000052_62
' C_scfsj_686cc545_isU_nsupportedT_erm_L000052_59 ' (symbol refcount = 0)
 adds r23, #1 ' ADDI4 coni
C_scfsj_686cc545_isU_nsupportedT_erm_L000052_61
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_scfs_686cc545_unsupported_term_L000027 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_scfsj_686cc545_isU_nsupportedT_erm_L000052_58  ' NEU4
 mov r0, #0 ' reg <- coni
C_scfsj_686cc545_isU_nsupportedT_erm_L000052_53
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_scfsl_686cc545_getC_ursorP_osition_L000064 ' <symbol:getCursorPosition>
 calld PA,#NEWF
 sub SP, #40
 calld PA,#PSHM
 ...
 mov r3, ##@C_scfsl_686cc545_getC_ursorP_osition_L000064_68_L000069 ' reg ARG ADDRG
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #4 wz
 if_z jmp #\C_scfsl_686cc545_getC_ursorP_osition_L000064_71 ' EQI4
 mov r0, ##-1 ' RET con
 jmp #\@C_scfsl_686cc545_getC_ursorP_osition_L000064_65 ' JUMPV addrg
C_scfsl_686cc545_getC_ursorP_osition_L000064_70
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #1 wz
 if_z jmp #\C_scfsl_686cc545_getC_ursorP_osition_L000064_73 ' EQI4
 jmp #\@C_scfsl_686cc545_getC_ursorP_osition_L000064_72 ' JUMPV addrg
C_scfsl_686cc545_getC_ursorP_osition_L000064_73
 mov r22, FP
 sub r22, #-(-36) ' reg <- addrli
 adds r22, r19 ' ADDI/P (2)
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #82 wz
 if_nz jmp #\C_scfsl_686cc545_getC_ursorP_osition_L000064_75 ' NEI4
 jmp #\@C_scfsl_686cc545_getC_ursorP_osition_L000064_72 ' JUMPV addrg
C_scfsl_686cc545_getC_ursorP_osition_L000064_75
 add r19, #1 ' ADDU4 coni
C_scfsl_686cc545_getC_ursorP_osition_L000064_71
 cmp r19,  #31 wcz 
 if_b jmp #\C_scfsl_686cc545_getC_ursorP_osition_L000064_70 ' LTU4
C_scfsl_686cc545_getC_ursorP_osition_L000064_72
 mov r22, FP
 sub r22, #-(-36) ' reg <- addrli
 adds r22, r19 ' ADDI/P (2)
 mov r20, #0 ' reg <- coni
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #27 wz
 if_nz jmp #\C_scfsl_686cc545_getC_ursorP_osition_L000064_80 ' NEI4
 mov r22, FP
 sub r22, #-(-35) ' reg <- addrli
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #91 wz
 if_z jmp #\C_scfsl_686cc545_getC_ursorP_osition_L000064_77 ' EQI4
C_scfsl_686cc545_getC_ursorP_osition_L000064_80
 mov r0, ##-1 ' RET con
 jmp #\@C_scfsl_686cc545_getC_ursorP_osition_L000064_65 ' JUMPV addrg
C_scfsl_686cc545_getC_ursorP_osition_L000064_77
 mov r2, FP
 sub r2, #-(-40) ' reg ARG ADDRLi
 mov r3, FP
 sub r3, #-(-44) ' reg ARG ADDRLi
 mov r4, ##@C_scfsl_686cc545_getC_ursorP_osition_L000064_84_L000085 ' reg ARG ADDRG
 mov r5, FP
 ...
 cmps r0,  #2 wz
 if_z jmp #\C_scfsl_686cc545_getC_ursorP_osition_L000064_81 ' EQI4
 mov r0, ##-1 ' RET con
 jmp #\@C_scfsl_686cc545_getC_ursorP_osition_L000064_65 ' JUMPV addrg
C_scfsl_686cc545_getC_ursorP_osition_L000064_81
 mov r22, FP
 sub r22, #-(-40) ' reg <- addrli
 rdlong r0, r22 ' reg <- INDIRI4 reg
C_scfsl_686cc545_getC_ursorP_osition_L000064_65
 calld PA,#POPM ' restore registers
 add SP, #40 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_scfso_686cc545_getC_olumns_L000086 ' <symbol:getColumns>
 calld PA,#NEWF
 sub SP, #32
 calld PA,#PSHM
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_scfsl_686cc545_getC_ursorP_osition_L000064
 add SP, #4 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
 mov r22, ##-1 ' reg <- con
 cmps r17, r22 wz
 if_nz jmp #\C_scfso_686cc545_getC_olumns_L000086_88 ' NEI4
 jmp #\@C_scfso_686cc545_getC_olumns_L000086_90 ' JUMPV addrg
C_scfso_686cc545_getC_olumns_L000086_88
 mov r2, #6 ' reg ARG coni
 mov r3, ##@C_scfso_686cc545_getC_olumns_L000086_93_L000094 ' reg ARG ADDRG
 mov r4, r21 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #6 wz
 if_z jmp #\C_scfso_686cc545_getC_olumns_L000086_91 ' EQI4
 jmp #\@C_scfso_686cc545_getC_olumns_L000086_90 ' JUMPV addrg
C_scfso_686cc545_getC_olumns_L000086_91
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 mov r22, ##-1 ' reg <- con
 cmps r19, r22 wz
 if_nz jmp #\C_scfso_686cc545_getC_olumns_L000086_95 ' NEI4
 jmp #\@C_scfso_686cc545_getC_olumns_L000086_90 ' JUMPV addrg
C_scfso_686cc545_getC_olumns_L000086_95
 cmps r19, r17 wcz
 if_be jmp #\C_scfso_686cc545_getC_olumns_L000086_97 ' LEI4
 mov r2, r19 ' SUBI/P
 subs r2, r17 ' SUBI/P (3)
 mov r3, ##@C_scfso_686cc545_getC_olumns_L000086_99_L000100 ' reg ARG ADDRG
 ...
 mov r20, ##-1 ' reg <- con
 cmps r0, r20 wz
 if_nz jmp #\C_scfso_686cc545_getC_olumns_L000086_101 ' NEI4
C_scfso_686cc545_getC_olumns_L000086_101
C_scfso_686cc545_getC_olumns_L000086_97
 mov r0, r19 ' CVI, CVU or LOAD
 jmp #\@C_scfso_686cc545_getC_olumns_L000086_87 ' JUMPV addrg
C_scfso_686cc545_getC_olumns_L000086_90
 mov r0, #80 ' reg <- coni
C_scfso_686cc545_getC_olumns_L000086_87
 calld PA,#POPM ' restore registers
 add SP, #32 ' framesize
 calld PA,#RETF
...
' C_linenoiseC_learS_creen_103 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_scfss_686cc545_linenoiseB_eep_L000108 ' <symbol:linenoiseBeep>
 calld PA,#NEWF
 mov r2, ##@C_scfss_686cc545_linenoiseB_eep_L000108_110_L000111 ' reg ARG ADDRG
...
' C_scfss_686cc545_linenoiseB_eep_L000108_109 ' (symbol refcount = 0)
 calld PA,#RETF


 alignl ' align long
C_scfsu_686cc545_freeC_ompletions_L000112 ' <symbol:freeCompletions>
 calld PA,#NEWF
 calld PA,#PSHM
 long $f00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 mov r21, #0 ' reg <- coni
 jmp #\@C_scfsu_686cc545_freeC_ompletions_L000112_117 ' JUMPV addrg
C_scfsu_686cc545_freeC_ompletions_L000112_114
 mov r22, r21
...
' C_scfsu_686cc545_freeC_ompletions_L000112_115 ' (symbol refcount = 0)
 add r21, #1 ' ADDU4 coni
C_scfsu_686cc545_freeC_ompletions_L000112_117
 rdlong r22, r23 ' reg <- INDIRU4 reg
 cmp r21, r22 wcz 
 if_b jmp #\C_scfsu_686cc545_freeC_ompletions_L000112_114 ' LTU4
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_z jmp #\C_scfsu_686cc545_freeC_ompletions_L000112_118 ' EQU4
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_free ' CALL addrg
C_scfsu_686cc545_freeC_ompletions_L000112_118
' C_scfsu_686cc545_freeC_ompletions_L000112_113 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
DAT ' const data segment
 ...
 alignl ' align long
C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_121_L000122 ' <symbol:121>
 long $0
 long $0
...
DAT ' code segment
 ...
 alignl ' align long
C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038 ' <symbol:refreshLineWithCompletion>
 calld PA,#NEWF
 sub SP, #64
 calld PA,#PSHM
 ...
 mov r1, ##@C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_121_L000122 ' reg <- addrg
 calld PA,#CPYB
 long 8 ' ASGNB
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_123  ' NEU4
 mov r2, FP
 sub r2, #-(-12) ' reg ARG ADDRLi
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 rdlong r3, r22 ' reg <- INDIRP4 reg
 mov r22, ##@C_scfs4_686cc545_completionC_allback_L000034
...
C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_123
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 rdlong r20, r21 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_ae jmp #\C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_125 ' GEU4
 mov r0, FP
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_scfs9_686cc545_refreshL_ineW_ithF_lags_L000039
 add SP, #4 ' CALL addrg
 mov r22, r23
 ...
 rdlong r20, r20 ' reg <- INDIRP4 reg
 wrlong r20, r22 ' ASGNP4 reg reg
 jmp #\@C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_126 ' JUMPV addrg
C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_125
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 long @C_scfs9_686cc545_refreshL_ineW_ithF_lags_L000039
 add SP, #4 ' CALL addrg
C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_126
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, FP
 sub r20, #-(-12) ' reg <- addrli
 cmp r22, r20 wz
 if_z jmp #\C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_130 ' EQU4
 mov r2, FP
 sub r2, #-(-12) ' reg ARG ADDRLi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scfsu_686cc545_freeC_ompletions_L000112 ' CALL addrg
C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_130
' C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038_120 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #64 ' framesize
 calld PA,#RETF
...
DAT ' const data segment
 ...
 alignl ' align long
C_scfs10_686cc545_completeL_ine_L000132_134_L000135 ' <symbol:134>
 long $0
 long $0
...
DAT ' code segment
 ...
 alignl ' align long
C_scfs10_686cc545_completeL_ine_L000132 ' <symbol:completeLine>
 calld PA,#NEWF
 sub SP, #16
 calld PA,#PSHM
 long $fc0000 ' save registers
 ...
 mov r0, FP
 sub r0, #-(-12) ' reg <- addrli
 mov r1, ##@C_scfs10_686cc545_completeL_ine_L000132_134_L000135 ' reg <- addrg
 calld PA,#CPYB
 long 8 ' ASGNB
 mov r22, r21 ' CVI, CVU or LOAD
 mov RI, FP
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_scfs10_686cc545_completeL_ine_L000132_136  ' NEU4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C_scfss_686cc545_linenoiseB_eep_L000108 ' CALL addrg
 mov r22, #0 ' reg <- coni
 wrlong r22, r23 ' ASGNI4 reg reg
 jmp #\@C_scfs10_686cc545_completeL_ine_L000132_137 ' JUMPV addrg
C_scfs10_686cc545_completeL_ine_L000132_136
 mov r22, FP
 sub r22, #-(-16) ' reg <- addrli
 rdbyte r19, r22 ' reg <- CVUI4 INDIRU1 reg
 mov r22, #9 ' reg <- coni
 cmps r19, r22 wz
 if_z jmp #\C_scfs10_686cc545_completeL_ine_L000132_141 ' EQI4
 cmps r19, r22 wcz
 if_b jmp #\C_scfs10_686cc545_completeL_ine_L000132_138 ' LTI4
' C_scfs10_686cc545_completeL_ine_L000132_154 ' (symbol refcount = 0)
 cmps r19,  #27 wz
 if_z jmp #\C_scfs10_686cc545_completeL_ine_L000132_146 ' EQI4
 jmp #\@C_scfs10_686cc545_completeL_ine_L000132_138 ' JUMPV addrg
C_scfs10_686cc545_completeL_ine_L000132_141
 rdlong r22, r23 ' reg <- INDIRI4 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_scfs10_686cc545_completeL_ine_L000132_142 ' NEI4
 mov r22, #1 ' reg <- coni
 wrlong r22, r23 ' ASGNI4 reg reg
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 mov r20, #0 ' reg <- coni
 wrlong r20, r22 ' ASGNU4 reg reg
 jmp #\@C_scfs10_686cc545_completeL_ine_L000132_143 ' JUMPV addrg
C_scfs10_686cc545_completeL_ine_L000132_142
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 ...
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wz
 if_nz jmp #\C_scfs10_686cc545_completeL_ine_L000132_144  ' NEU4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C_scfss_686cc545_linenoiseB_eep_L000108 ' CALL addrg
C_scfs10_686cc545_completeL_ine_L000132_144
C_scfs10_686cc545_completeL_ine_L000132_143
 mov r22, #0 ' reg <- coni
 mov RI, FP
 sub RI, #-(-16)
 wrbyte r22, RI ' ASGNU1 addrli reg
 jmp #\@C_scfs10_686cc545_completeL_ine_L000132_139 ' JUMPV addrg
C_scfs10_686cc545_completeL_ine_L000132_146
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, FP
 ...
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_ae jmp #\C_scfs10_686cc545_completeL_ine_L000132_147 ' GEU4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scfsi_686cc545_refreshL_ine_L000048 ' CALL addrg
C_scfs10_686cc545_completeL_ine_L000132_147
 mov r22, #0 ' reg <- coni
 wrlong r22, r23 ' ASGNI4 reg reg
 mov r22, #0 ' reg <- coni
 mov RI, FP
 ...
 wrbyte r22, RI ' ASGNU1 addrli reg
 jmp #\@C_scfs10_686cc545_completeL_ine_L000132_139 ' JUMPV addrg
C_scfs10_686cc545_completeL_ine_L000132_138
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, FP
 ...
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_ae jmp #\C_scfs10_686cc545_completeL_ine_L000132_149 ' GEU4
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 shl r22, #2 ' LSHU4 coni
 ...
 adds r22, r20 ' ADDI/P (1)
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov r3, ##@C_scfs10_686cc545_completeL_ine_L000132_151_L000152 ' reg ARG ADDRG
 mov r22, r23
 ...
 adds r20, #40 ' ADDP4 coni
 wrlong r22, r20 ' ASGNU4 reg reg
C_scfs10_686cc545_completeL_ine_L000132_149
 mov r22, #0 ' reg <- coni
 wrlong r22, r23 ' ASGNI4 reg reg
C_scfs10_686cc545_completeL_ine_L000132_139
 rdlong r22, r23 ' reg <- INDIRI4 reg
 cmps r22,  #0 wz
 if_z jmp #\C_scfs10_686cc545_completeL_ine_L000132_155 ' EQI4
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, FP
 ...
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_ae jmp #\C_scfs10_686cc545_completeL_ine_L000132_155 ' GEU4
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_scfs8_686cc545_refreshL_ineW_ithC_ompletion_L000038
 add SP, #8 ' CALL addrg
 jmp #\@C_scfs10_686cc545_completeL_ine_L000132_156 ' JUMPV addrg
C_scfs10_686cc545_completeL_ine_L000132_155
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scfsi_686cc545_refreshL_ine_L000048 ' CALL addrg
C_scfs10_686cc545_completeL_ine_L000132_156
C_scfs10_686cc545_completeL_ine_L000132_137
 mov r2, FP
 sub r2, #-(-12) ' reg ARG ADDRLi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
' C_scfs10_686cc545_completeL_ine_L000132_133 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #16 ' framesize
 calld PA,#RETF
...
C_linenoiseS_etC_ompletionC_allback ' <symbol:linenoiseSetCompletionCallback>
 wrlong r2, ##@C_scfs4_686cc545_completionC_allback_L000034 ' ASGNP4 addrg reg
...
C_linenoiseS_etH_intsC_allback ' <symbol:linenoiseSetHintsCallback>
 wrlong r2, ##@C_scfs5_686cc545_hintsC_allback_L000035 ' ASGNP4 addrg reg
...
C_linenoiseS_etF_reeH_intsC_allback ' <symbol:linenoiseSetFreeHintsCallback>
 wrlong r2, ##@C_scfs6_686cc545_freeH_intsC_allback_L000036 ' ASGNP4 addrg reg
...
C_linenoiseA_ddC_ompletion_160
 ...
 alignl ' align long
C_scfs13_686cc545_abI_nit_L000165 ' <symbol:abInit>
 calld PA,#PSHM
...
' C_scfs13_686cc545_abI_nit_L000165_166 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETN


 alignl ' align long
C_scfs14_686cc545_abA_ppend_L000167 ' <symbol:abAppend>
 calld PA,#NEWF
 calld PA,#PSHM
 long $fa0000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 mov r22, r17 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_scfs14_686cc545_abA_ppend_L000167_169  ' NEU4
 jmp #\@C_scfs14_686cc545_abA_ppend_L000167_168 ' JUMPV addrg
C_scfs14_686cc545_abA_ppend_L000167_169
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r21 ' CVI, CVU or LOAD
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 ...
 wrlong r20, r22 ' ASGNI4 reg reg
C_scfs14_686cc545_abA_ppend_L000167_168
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_scfs15_686cc545_abF_ree_L000171 ' <symbol:abFree>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 calld PA,#CALA
 long @C_free ' CALL addrg
' C_scfs15_686cc545_abF_ree_L000171_172 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_refreshS_howH_ints ' <symbol:refreshShowHints>
 ...
 mov r21, r3 ' reg var <- reg arg
 mov r19, r2 ' reg var <- reg arg
 mov r22, ##@C_scfs5_686cc545_hintsC_allback_L000035
 rdlong r22, r22 ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
...
C_refreshS_howH_ints_183
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
 mov RI, FP
 sub RI, #-(-84)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
...
C_refreshS_howH_ints_187
 mov r22, ##@C_scfs6_686cc545_freeH_intsC_allback_L000036
 rdlong r22, r22 ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
...
' C_refreshS_howH_ints_173 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_scfs18_686cc545_refreshS_ingleL_ine_L000194 ' <symbol:refreshSingleLine>
 calld PA,#NEWF
 sub SP, #76
 calld PA,#PSHM
 ...
 jmp #\@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_197 ' JUMPV addrg
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_196
 adds r13, #1 ' ADDP4 coni
 sub r19, #1 ' SUBU4 coni
 sub r15, #1 ' SUBU4 coni
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_197
 mov r22, r17 ' ADDU
 add r22, r15 ' ADDU (3)
 mov r20, r23
 adds r20, #44 ' ADDP4 coni
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_ae jmp #\C_scfs18_686cc545_refreshS_ingleL_ine_L000194_196 ' GEU4
 jmp #\@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_200 ' JUMPV addrg
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_199
 sub r19, #1 ' SUBU4 coni
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_200
 mov r22, r17 ' ADDU
 add r22, r19 ' ADDU (3)
 mov r20, r23
 adds r20, #44 ' ADDP4 coni
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_a jmp #\C_scfs18_686cc545_refreshS_ingleL_ine_L000194_199 ' GTU4
 mov r2, FP
 sub r2, #-(-12) ' reg ARG ADDRLi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scfs13_686cc545_abI_nit_L000165 ' CALL addrg
 mov r2, ##@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_202_L000203 ' reg ARG ADDRG
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_scfs18_686cc545_refreshS_ingleL_ine_L000194_204 ' EQI4
 mov r22, r23
 adds r22, #24 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
 mov r22, ##@C_scfsa_686cc545_maskmode_L000040
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #1 wz
 if_nz jmp #\C_scfs18_686cc545_refreshS_ingleL_ine_L000194_206 ' NEI4
 jmp #\@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_209 ' JUMPV addrg
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_208
 mov r2, #1 ' reg ARG coni
 mov r3, ##@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_211_L000212 ' reg ARG ADDRG
 mov r4, FP
 sub r4, #-(-12) ' reg ARG ADDRLi
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_209
 mov r22, r19 ' CVI, CVU or LOAD
 mov r19, r22
 sub r19, #1 ' SUBU4 coni
 cmp r22,  #0 wz
 if_nz jmp #\C_scfs18_686cc545_refreshS_ingleL_ine_L000194_208  ' NEU4
 jmp #\@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_207 ' JUMPV addrg
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_206
 mov r2, r19 ' CVI, CVU or LOAD
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_207
 ...
 add SP, #8 ' CALL addrg
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_204
 mov r2, ##@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_213_L000214 ' reg ARG ADDRG
 mov r3, #64 ' reg ARG coni
 mov r4, FP
 sub r4, #-(-76) ' reg ARG ADDRLi
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 and r22, #2 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_scfs18_686cc545_refreshS_ingleL_ine_L000194_215 ' EQI4
 mov r22, r15 ' ADDU
 add r22, r17 ' ADDU (3)
 mov r2, r22 ' CVI, CVU or LOAD
 mov r3, ##@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_217_L000218 ' reg ARG ADDRG
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_215
 mov r22, FP
 ...
 mov r20, ##-1 ' reg <- con
 cmps r0, r20 wz
 if_nz jmp #\C_scfs18_686cc545_refreshS_ingleL_ine_L000194_219 ' NEI4
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_219
 mov r2, FP
 sub r2, #-(-12) ' reg ARG ADDRLi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scfs15_686cc545_abF_ree_L000171 ' CALL addrg
' C_scfs18_686cc545_refreshS_ingleL_ine_L000194_195 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #76 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222 ' <symbol:refreshMultiLine>
 calld PA,#NEWF
 sub SP, #88
 calld PA,#PSHM
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_224 ' EQI4
 mov r22, FP
 sub r22, #-(-80) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 subs r22, r17
 ...
 cmps r22,  #0 wcz
 if_be jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_226 ' LEI4
 mov r22, FP
 sub r22, #-(-80) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r2, r17 ' SUBI/P
 subs r2, r22 ' SUBI/P (3)
 mov r3, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_228_L000229 ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_my_lndebug
 ...
 mov r2, r17 ' SUBI/P
 subs r2, r22 ' SUBI/P (3)
 mov r3, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_230_L000231 ' reg ARG ADDRG
 mov r4, #64 ' reg ARG coni
 mov r5, FP
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_226
 mov r19, #0 ' reg <- coni
 jmp #\@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_235 ' JUMPV addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_232
 mov r2, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_236_L000237 ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_my_lndebug ' CALL addrg
 mov r2, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_238_L000239 ' reg ARG ADDRG
 mov r3, #64 ' reg ARG coni
 mov r4, FP
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
' C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_233 ' (symbol refcount = 0)
 adds r19, #1 ' ADDI4 coni
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_235
 mov r22, r17
 subs r22, #1 ' SUBI4 coni
 cmps r19, r22 wcz
 if_b jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_232 ' LTI4
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_224
 mov r22, r21
 and r22, #3 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_240 ' EQI4
 mov r2, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_242_L000243 ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_my_lndebug ' CALL addrg
 mov r2, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_244_L000245 ' reg ARG ADDRG
 mov r3, #64 ' reg ARG coni
 mov r4, FP
 sub r4, #-(-68) ' reg ARG ADDRLi
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_240
 mov r22, r21
 and r22, #2 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_246 ' EQI4
 mov r22, r23
 adds r22, #24 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #1 wz
 if_nz jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_248 ' NEI4
 mov r11, #0 ' reg <- coni
 jmp #\@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_253 ' JUMPV addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_250
 mov r2, #1 ' reg ARG coni
 mov r3, ##@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_211_L000212 ' reg ARG ADDRG
 mov r4, FP
 sub r4, #-(-76) ' reg ARG ADDRLi
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
' C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_251 ' (symbol refcount = 0)
 add r11, #1 ' ADDU4 coni
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_253
 mov r22, r23
 adds r22, #40 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r11, r22 wcz 
 if_b jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_250 ' LTU4
 jmp #\@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_249 ' JUMPV addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_248
 mov r22, r23
 adds r22, #40 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r2, r22 ' CVI, CVU or LOAD
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_249
 ...
 mov r20, #0 ' reg <- coni
 cmp r22, r20 wz
 if_z jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_254 ' EQU4
 mov r18, r23
 adds r18, #40 ' ADDP4 coni
 rdlong r18, r18 ' reg <- INDIRU4 reg
 cmp r22, r18 wz
 if_nz jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_254  ' NEU4
 ...
 cmp r1, r20 wz
 if_nz jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_254  ' NEU4
 mov r2, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_256_L000257 ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_my_lndebug ' CALL addrg
 mov r2, #1 ' reg ARG coni
 mov r3, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_258_L000259 ' reg ARG ADDRG
 mov r4, FP
 sub r4, #-(-76) ' reg ARG ADDRLi
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmps r13, r22 wcz
 if_be jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_260 ' LEI4
 mov r22, r23
 adds r22, #48 ' ADDP4 coni
 mov r20, r13 ' CVI, CVU or LOAD
 wrlong r20, r22 ' ASGNU4 reg reg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_260
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_254
 mov r22, r23
 adds r22, #44 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, r15 ' CVI, CVU or LOAD
 ...
 sub RI, #-(-84)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov r3, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_262_L000263 ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_my_lndebug
 ...
 neg r22, r22 ' SUBI/P (2)
 cmps r22,  #0 wcz
 if_be jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_264 ' LEI4
 mov r22, FP
 sub r22, #-(-84) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r2, r13 ' SUBI/P
 subs r2, r22 ' SUBI/P (3)
 mov r3, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_266_L000267 ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_my_lndebug
 ...
 mov r2, r13 ' SUBI/P
 subs r2, r22 ' SUBI/P (3)
 mov r3, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_268_L000269 ' reg ARG ADDRG
 mov r4, #64 ' reg ARG coni
 mov r5, FP
 sub r5, #-(-68) ' reg ARG ADDRLi
 mov BC, #16 ' arg size, rpsize = 16, spsize = 16
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_264
 mov r22, r23
 adds r22, #32 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 ...
 mov r3, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_270_L000271 ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_my_lndebug
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #0 wz
 if_z jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_272 ' EQI4
 mov RI, FP
 sub RI, #-(-92)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov r3, ##@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_217_L000218 ' reg ARG ADDRG
 ...
 long @C_snprintf
 add SP, #12 ' CALL addrg
 jmp #\@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_273 ' JUMPV addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_272
 mov r2, ##@C_scfs18_686cc545_refreshS_ingleL_ine_L000194_202_L000203 ' reg ARG ADDRG
 mov r3, #64 ' reg ARG coni
 mov r4, FP
 sub r4, #-(-68) ' reg ARG ADDRLi
 ...
 long @C_snprintf
 add SP, #8 ' CALL addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_273
 mov r2, FP
 sub r2, #-(-68) ' reg ARG ADDRLi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 ...
 long @C_scfs14_686cc545_abA_ppend_L000167
 add SP, #8 ' CALL addrg
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_246
 mov r2, ##@C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_258_L000259 ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_my_lndebug ' CALL addrg
 mov r22, r23
 ...
 mov r20, ##-1 ' reg <- con
 cmps r0, r20 wz
 if_nz jmp #\C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_274 ' NEI4
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_274
 mov r2, FP
 sub r2, #-(-76) ' reg ARG ADDRLi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scfs15_686cc545_abF_ree_L000171 ' CALL addrg
' C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_223 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #88 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_scfs9_686cc545_refreshL_ineW_ithF_lags_L000039 ' <symbol:refreshLineWithFlags>
 calld PA,#NEWF
 calld PA,#PSHM
 long $e00000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 mov r21, r2 ' reg var <- reg arg
 mov r22, ##@C_scfsc_686cc545_mlmode_L000042
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wz
 if_z jmp #\C_scfs9_686cc545_refreshL_ineW_ithF_lags_L000039_278 ' EQI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_scfs1d_686cc545_refreshM_ultiL_ine_L000222
 add SP, #4 ' CALL addrg
 jmp #\@C_scfs9_686cc545_refreshL_ineW_ithF_lags_L000039_279 ' JUMPV addrg
C_scfs9_686cc545_refreshL_ineW_ithF_lags_L000039_278
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_scfs18_686cc545_refreshS_ingleL_ine_L000194
 add SP, #4 ' CALL addrg
C_scfs9_686cc545_refreshL_ineW_ithF_lags_L000039_279
' C_scfs9_686cc545_refreshL_ineW_ithF_lags_L000039_277 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_scfsi_686cc545_refreshL_ine_L000048 ' <symbol:refreshLine>
 calld PA,#NEWF
 calld PA,#PSHM
 long $800000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 ...
 long @C_scfs9_686cc545_refreshL_ineW_ithF_lags_L000039
 add SP, #4 ' CALL addrg
' C_scfsi_686cc545_refreshL_ine_L000048_280 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_linenoiseE_ditH_istoryN_ext ' <symbol:linenoiseEditHistoryNext>
 ...
 mov r23, r3 ' reg var <- reg arg
 mov r21, r2 ' reg var <- reg arg
 mov r22, ##@C_scfsf_686cc545_history_len_L000045
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #1 wcz
 ...
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_scfsg_686cc545_history_L000046
 ...
 mov r20, ##@C_scfsf_686cc545_history_len_L000045
 ...
 mov r18, ##@C_scfsg_686cc545_history_L000046
...
C_linenoiseE_ditS_tart_342
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_scfso_686cc545_getC_olumns_L000086
 add SP, #4 ' CALL addrg
 mov r20, FP
 add r20, #8 ' reg <- addrfi
 rdlong r20, r20 ' reg <- INDIRP4 reg
...
C_linenoiseE_ditM_ore ' <symbol:linenoiseEditMore>
 long @C_scfs1r_686cc545_347_L000348
...
C_linenoiseE_ditF_eed_354
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_scfs10_686cc545_completeL_ine_L000132
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 mov RI, FP
 sub RI, #-(-8)
...
C_linenoiseE_ditF_eed_362
 mov r22, ##@C_scfsf_686cc545_history_len_L000045 ' reg <- addrg
 rdlong r20, r22 ' reg <- INDIRI4 reg
 subs r20, #1 ' SUBI4 coni
 wrlong r20, ##@C_scfsf_686cc545_history_len_L000045 ' ASGNI4 addrg reg
 rdlong r22, r22 ' reg <- INDIRI4 reg
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_scfsg_686cc545_history_L000046
 rdlong r20, r20 ' reg <- INDIRP4 addrg
...
C_linenoiseE_ditF_eed_363
 ...
 wrlong r22, RI ' ASGNP4 addrli reg
 mov r22, ##0 ' reg <- con
 wrlong r22, ##@C_scfs5_686cc545_hintsC_allback_L000035 ' ASGNP4 addrg reg
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_scfsi_686cc545_refreshL_ine_L000048 ' CALL addrg
...
' C_linenoiseE_ditS_top_441 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_scfs20_686cc545_linenoiseB_lockingE_dit_L000442 ' <symbol:linenoiseBlockingEdit>
 calld PA,#NEWF
 sub SP, #56
 calld PA,#PSHM
 long $fa8000 ' save registers
 ...
 mov r17, r2 ' reg var <- reg arg
 cmp r19,  #0 wz
 if_nz jmp #\C_scfs20_686cc545_linenoiseB_lockingE_dit_L000442_444  ' NEU4
 mov r22, #22 ' reg <- coni
 wrlong r22, ##@C_errno ' ASGNI4 addrg reg
 mov r0, ##0 ' RET con
 jmp #\@C_scfs20_686cc545_linenoiseB_lockingE_dit_L000442_443 ' JUMPV addrg
C_scfs20_686cc545_linenoiseB_lockingE_dit_L000442_444
 mov r2, r17 ' CVI, CVU or LOAD
...
C_scfs20_686cc545_linenoiseB_lockingE_dit_L000442_446
' C_scfs20_686cc545_linenoiseB_lockingE_dit_L000442_447 ' (symbol refcount = 0)
 mov r2, FP
 ...
 rdlong r20, r20 ' reg <- INDIRP4 addrg
 cmp r22, r20 wz
 if_z jmp #\C_scfs20_686cc545_linenoiseB_lockingE_dit_L000442_446 ' EQU4
 mov r2, FP
 sub r2, #-(-60) ' reg ARG ADDRLi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 ...
 mov r0, r15 ' CVI, CVU or LOAD
C_scfs20_686cc545_linenoiseB_lockingE_dit_L000442_443
 calld PA,#POPM ' restore registers
 add SP, #56 ' framesize
 calld PA,#RETF
...
' C_linenoiseP_rintK_eyC_odes_449 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037 ' <symbol:linenoiseNoTTY>
 calld PA,#NEWF
 calld PA,#PSHM
 long $fa0000 ' save registers
 mov r23, ##0 ' reg <- con
 mov r21, #0 ' reg <- coni
 mov r19, #0 ' reg <- coni
 jmp #\@C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_470 ' JUMPV addrg
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_469
 cmp r21, r19 wz
 if_nz jmp #\C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_472  ' NEU4
 cmp r19,  #0 wz
 if_nz jmp #\C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_474  ' NEU4
 mov r19, #16 ' reg <- coni
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_474
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_476  ' NEU4
 mov r22, r17 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_z jmp #\C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_478 ' EQU4
 mov r2, r17 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_free ' CALL addrg
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_478
 mov r0, ##0 ' RET con
 jmp #\@C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_468 ' JUMPV addrg
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_476
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_472
 ...
 mov r22, ##-1 ' reg <- con
 cmps r17, r22 wz
 if_z jmp #\C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_482 ' EQI4
 cmps r17,  #10 wz
 if_nz jmp #\C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_480 ' NEI4
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_482
 mov r22, ##-1 ' reg <- con
 cmps r17, r22 wz
 if_nz jmp #\C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_483 ' NEI4
 cmp r21,  #0 wz
 if_nz jmp #\C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_483  ' NEU4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_free ' CALL addrg
 mov r0, ##0 ' RET con
 jmp #\@C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_468 ' JUMPV addrg
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_483
 mov r22, r21 ' ADDI/P
 ...
 jmp #\@C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_468 ' JUMPV addrg
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_480
 mov r22, r21 ' ADDI/P
 adds r22, r23 ' ADDI/P (3)
 mov r20, r17 ' CVI, CVU or LOAD
 wrbyte r20, r22 ' ASGNU1 reg reg
 add r21, #1 ' ADDU4 coni
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_470
 jmp #\@C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_469 ' JUMPV addrg
 mov r0, ##0 ' RET con
C_scfs7_686cc545_linenoiseN_oT_T_Y__L000037_468
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
' reg ARG ADDRL
 ...
 add SP, #4 ' correct for new kernel !!! 
 calld PA,#CALA
 long @C_scfs20_686cc545_linenoiseB_lockingE_dit_L000442
 add SP, #16 ' CALL addrg
 mov RI, ##-1032
 adds RI, FP
...
C_linenoiseF_ree_486
 ...
 alignl ' align long
C_scfs24_686cc545_freeH_istory_L000489 ' <symbol:freeHistory>
 calld PA,#NEWF
 calld PA,#PSHM
 long $d00000 ' save registers
 mov r22, ##@C_scfsg_686cc545_history_L000046
 rdlong r22, r22 ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
 if_z jmp #\C_scfs24_686cc545_freeH_istory_L000489_491 ' EQU4
 mov r23, #0 ' reg <- coni
 jmp #\@C_scfs24_686cc545_freeH_istory_L000489_496 ' JUMPV addrg
C_scfs24_686cc545_freeH_istory_L000489_493
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_scfsg_686cc545_history_L000046
 rdlong r20, r20 ' reg <- INDIRP4 addrg
 ...
 calld PA,#CALA
 long @C_free ' CALL addrg
' C_scfs24_686cc545_freeH_istory_L000489_494 ' (symbol refcount = 0)
 adds r23, #1 ' ADDI4 coni
C_scfs24_686cc545_freeH_istory_L000489_496
 mov r22, ##@C_scfsf_686cc545_history_len_L000045
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r23, r22 wcz
 if_b jmp #\C_scfs24_686cc545_freeH_istory_L000489_493 ' LTI4
 mov r2, ##@C_scfsg_686cc545_history_L000046
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_free ' CALL addrg
C_scfs24_686cc545_freeH_istory_L000489_491
' C_scfs24_686cc545_freeH_istory_L000489_490 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_scfsh_686cc545_linenoiseA_tE_xit_L000047 ' <symbol:linenoiseAtExit>
 calld PA,#NEWF
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C_scfs24_686cc545_freeH_istory_L000489 ' CALL addrg
' C_scfsh_686cc545_linenoiseA_tE_xit_L000047_497 ' (symbol refcount = 0)
 calld PA,#RETF
...
C_linenoiseH_istoryA_dd ' <symbol:linenoiseHistoryAdd>
 ...
 long $f00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 mov r22, ##@C_scfse_686cc545_history_max_len_L000044
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wz
...
C_linenoiseH_istoryA_dd_499
 ...
 calld PA,#CALA
 long @C_malloc ' CALL addrg
 wrlong r0, ##@C_scfsg_686cc545_history_L000046 ' ASGNP4 addrg reg
 mov r22, ##@C_scfsg_686cc545_history_L000046
 rdlong r22, r22 ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
...
C_linenoiseH_istoryA_dd_503
 ...
 shl r2, #2 ' LSHU4 coni
 mov r3, #0 ' reg ARG coni
 mov r4, ##@C_scfsg_686cc545_history_L000046
 rdlong r4, r4
 ' reg ARG INDIR ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
...
C_linenoiseH_istoryA_dd_507
 mov r22, ##@C_scfsf_686cc545_history_len_L000045
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 mov r20, ##@C_scfse_686cc545_history_max_len_L000044
 rdlong r20, r20 ' reg <- INDIRI4 addrg
 cmps r22, r20 wz
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 subs r22, #1 ' SUBI4 coni
 wrlong r22, ##@C_scfsf_686cc545_history_len_L000045 ' ASGNI4 addrg reg
...
C_linenoiseH_istoryS_etM_axL_en_512
 ...
 mov r21, ##@C_scfsf_686cc545_history_len_L000045
...
C_linenoiseH_istoryS_etM_axL_en_518
 ...
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 reg
 wrlong r22, ##@C_scfsg_686cc545_history_L000046 ' ASGNP4 addrg reg
C_linenoiseH_istoryS_etM_axL_en_514
 mov r22, ##@C_scfse_686cc545_history_max_len_L000044 ' reg <- addrg
 wrlong r23, ##@C_scfse_686cc545_history_max_len_L000044 ' ASGNI4 addrg reg
 mov r20, ##@C_scfsf_686cc545_history_len_L000045
 rdlong r20, r20 ' reg <- INDIRI4 addrg
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r20, r22 wcz
...
C_linenoiseP_rintK_eyC_odes_450_L000451 ' <symbol:450>
 ...
 alignl ' align long
C_scfs1r_686cc545_347_L000348 ' <symbol:347>
 byte 73
 byte 102
 byte 32
 byte 121
...
C_linenoiseE_ditS_tart_343_L000344 ' <symbol:343>
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_270_L000271 ' <symbol:270>
 byte 115
 byte 101
 byte 116
 byte 32
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_268_L000269 ' <symbol:268>
 byte 27
 byte 91
 byte 37
 byte 100
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_266_L000267 ' <symbol:266>
 byte 103
 byte 111
 byte 45
 byte 117
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_262_L000263 ' <symbol:262>
 byte 114
 byte 112
 byte 111
 byte 115
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_258_L000259 ' <symbol:258>
 byte 10
 byte 0

 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_256_L000257 ' <symbol:256>
 byte 60
 byte 110
 byte 101
 byte 119
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_244_L000245 ' <symbol:244>
 byte 13
 byte 27
 byte 91
 byte 48
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_242_L000243 ' <symbol:242>
 byte 99
 byte 108
 byte 101
 byte 97
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_238_L000239 ' <symbol:238>
 byte 13
 byte 27
 byte 91
 byte 48
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_236_L000237 ' <symbol:236>
 byte 99
 byte 108
 byte 101
 byte 97
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_230_L000231 ' <symbol:230>
 byte 27
 byte 91
 byte 37
 byte 100
 ...
 alignl ' align long
C_scfs1d_686cc545_refreshM_ultiL_ine_L000222_228_L000229 ' <symbol:228>
 byte 103
 byte 111
 byte 32
 byte 100
 ...
 alignl ' align long
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_217_L000218 ' <symbol:217>
 byte 13
 byte 27
 byte 91
 byte 37
 ...
 alignl ' align long
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_213_L000214 ' <symbol:213>
 byte 27
 byte 91
 byte 48
 byte 75
 ...
 alignl ' align long
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_211_L000212 ' <symbol:211>
 byte 42
 byte 0

 alignl ' align long
C_scfs18_686cc545_refreshS_ingleL_ine_L000194_202_L000203 ' <symbol:202>
 byte 13
 byte 0
...
C_refreshS_howH_ints_185_L000186 ' <symbol:185>
 ...
 alignl ' align long
C_scfs10_686cc545_completeL_ine_L000132_151_L000152 ' <symbol:151>
 byte 37
 byte 115
 byte 0

 alignl ' align long
C_scfss_686cc545_linenoiseB_eep_L000108_110_L000111 ' <symbol:110>
 byte 7
 byte 0
...
C_linenoiseC_learS_creen_106_L000107 ' <symbol:106>
 ...
 alignl ' align long
C_scfso_686cc545_getC_olumns_L000086_99_L000100 ' <symbol:99>
 byte 27
 byte 91
 byte 37
 byte 100
 ...
 alignl ' align long
C_scfso_686cc545_getC_olumns_L000086_93_L000094 ' <symbol:93>
 byte 27
 byte 91
 byte 57
 byte 57
 ...
 alignl ' align long
C_scfsl_686cc545_getC_ursorP_osition_L000064_84_L000085 ' <symbol:84>
 byte 37
 byte 100
 byte 59
 byte 37
 ...
 alignl ' align long
C_scfsl_686cc545_getC_ursorP_osition_L000064_68_L000069 ' <symbol:68>
 byte 27
 byte 91
 byte 54
 byte 110
 ...
 alignl ' align long
C_scfsj_686cc545_isU_nsupportedT_erm_L000052_54_L000055 ' <symbol:54>
 byte 84
 byte 69
 byte 82
 byte 77
 ...
 alignl ' align long
C_scfs3_686cc545_32_L000033 ' <symbol:32>
 byte 101
 byte 109
 byte 97
 byte 99
 ...
 alignl ' align long
C_scfs2_686cc545_30_L000031 ' <symbol:30>
 byte 99
 byte 111
 byte 110
 byte 115
 ...
 alignl ' align long
C_scfs1_686cc545_28_L000029 ' <symbol:28>
 byte 100
 byte 117
 byte 109
 byte 98
