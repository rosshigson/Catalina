...
C_wifi_L_I_S_T_E_N_ ' <symbol:wifi_LISTEN>
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_wifi_L_I_S_T_E_N__2 ' NEI4
 mov r0, #16 ' reg <- coni
 jmp #\@C_wifi_L_I_S_T_E_N__1 ' JUMPV addrg
C_wifi_L_I_S_T_E_N__2
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #247 wz
 if_nz jmp #\C_wifi_L_I_S_T_E_N__4 ' NEI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, ##@C_wifi_L_I_S_T_E_N__6_L000007 ' reg ARG ADDRG
 mov r4, FP
 ...
 long @C_isprintf
 add SP, #8 ' CALL addrg
 jmp #\@C_wifi_L_I_S_T_E_N__5 ' JUMPV addrg
C_wifi_L_I_S_T_E_N__4
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #246 wz
 if_nz jmp #\C_wifi_L_I_S_T_E_N__8 ' NEI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, ##@C_wifi_L_I_S_T_E_N__10_L000011 ' reg ARG ADDRG
 mov r4, FP
 sub r4, #-(-264) ' reg ARG ADDRLi
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 long @C_isprintf
 add SP, #8 ' CALL addrg
 jmp #\@C_wifi_L_I_S_T_E_N__9 ' JUMPV addrg
C_wifi_L_I_S_T_E_N__8
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #245 wz
 if_nz jmp #\C_wifi_L_I_S_T_E_N__12 ' NEI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, ##@C_wifi_L_I_S_T_E_N__14_L000015 ' reg ARG ADDRG
 mov r4, FP
 sub r4, #-(-264) ' reg ARG ADDRLi
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 long @C_isprintf
 add SP, #8 ' CALL addrg
 jmp #\@C_wifi_L_I_S_T_E_N__13 ' JUMPV addrg
C_wifi_L_I_S_T_E_N__12
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, r23 ' CVUI
 and r3, cviu_m1 ' zero extend
 mov r4, ##@C_wifi_L_I_S_T_E_N__16_L000017 ' reg ARG ADDRG
 mov r5, FP
...
C_wifi_L_I_S_T_E_N__5
 ...
 cmps r17,  #0 wz
 if_nz jmp #\C_wifi_L_I_S_T_E_N__18 ' NEI4
