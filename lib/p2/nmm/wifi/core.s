...
C_wifi_S_end_C_ommand ' <symbol:wifi_Send_Command>
 ...
 cmp r0,  #256 wcz 
 if_be jmp #\C_wifi_S_end_C_ommand_2 ' LEU4
 mov r0, #16 ' reg <- coni
 jmp #\@C_wifi_S_end_C_ommand_1 ' JUMPV addrg
C_wifi_S_end_C_ommand_2
 mov r2, #13 ' reg ARG coni
 mov r3, r23 ' CVI, CVU or LOAD
 mov r4, #254 ' reg ARG coni
 mov r5, ##@C_wifi_S_end_C_ommand_4_L000005 ' reg ARG ADDRG
...
C_wifi_S_end_C_ommand_W_ith_D_ata ' <symbol:wifi_Send_Command_With_Data>
 ...
 long @C_strlen ' CALL addrg
 cmp r0,  #256 wcz 
 if_be jmp #\C_wifi_S_end_C_ommand_W_ith_D_ata_7 ' LEU4
 mov r0, #16 ' reg <- coni
 jmp #\@C_wifi_S_end_C_ommand_W_ith_D_ata_6 ' JUMPV addrg
C_wifi_S_end_C_ommand_W_ith_D_ata_7
 ...
 add SP, #4 ' CALL addrg
 mov r17, #0 ' reg <- coni
 jmp #\@C_wifi_S_end_C_ommand_W_ith_D_ata_12 ' JUMPV addrg
C_wifi_S_end_C_ommand_W_ith_D_ata_9
 ...
 calld PA,#DIVS ' DIVI
 cmps r1,  #0 wz
 if_nz jmp #\C_wifi_S_end_C_ommand_W_ith_D_ata_13 ' NEI4
 mov r2, #0 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_s_txflush ' CALL addrg
...
C_wifi_S_end_C_ommand_W_ith_D_ata_12
 cmps r17, r19 wcz
 if_b jmp #\C_wifi_S_end_C_ommand_W_ith_D_ata_9 ' LTI4
 mov r2, #0 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_s_txflush ' CALL addrg
...
C_wifi_timed_rx ' <symbol:wifi_timed_rx>
 ...
 mov r23, r2 ' reg var <- reg arg
 mov r21, #0 ' reg <- coni
 jmp #\@C_wifi_timed_rx_17 ' JUMPV addrg
C_wifi_timed_rx_16
 mov r22, r21 ' CVI, CVU or LOAD
 mov r21, r22
 adds r21, #1 ' ADDI4 coni
 cmps r22, r23 wcz
 if_be jmp #\C_wifi_timed_rx_19 ' LEI4
 mov r0, ##-1 ' RET con
 jmp #\@C_wifi_timed_rx_15 ' JUMPV addrg
C_wifi_timed_rx_19
...
C_wifi_timed_rx_17
 ...
 cmps r0,  #0 wz
 if_z jmp #\C_wifi_timed_rx_16 ' EQI4
 mov r2, #0 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
C_wifi_R_ead_V_alue ' <symbol:wifi_Read_Value>
 ...
 jmp #\@C_wifi_R_ead_V_alue_23 ' JUMPV addrg
C_wifi_R_ead_V_alue_22
 ...
 cmps r19,  #0 wcz
 if_ae jmp #\C_wifi_R_ead_V_alue_25 ' GEI4
 mov r0, #15 ' reg <- coni
 jmp #\@C_wifi_R_ead_V_alue_21 ' JUMPV addrg
C_wifi_R_ead_V_alue_25
C_wifi_R_ead_V_alue_23
 cmps r19,  #254 wz
 if_nz jmp #\C_wifi_R_ead_V_alue_22 ' NEI4
 jmp #\@C_wifi_R_ead_V_alue_28 ' JUMPV addrg
C_wifi_R_ead_V_alue_27
 ...
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r19,  #0 wcz
 if_ae jmp #\C_wifi_R_ead_V_alue_30 ' GEI4
 mov r0, #15 ' reg <- coni
 jmp #\@C_wifi_R_ead_V_alue_21 ' JUMPV addrg
C_wifi_R_ead_V_alue_30
 cmps r19,  #13 wz
 if_z jmp #\C_wifi_R_ead_V_alue_32 ' EQI4
 ...
 jmp #\@C_wifi_R_ead_V_alue_33 ' JUMPV addrg
C_wifi_R_ead_V_alue_32
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
 cmps r17,  #3 wcz
 if_b jmp #\C_wifi_R_ead_V_alue_34 ' LTI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov r3, FP
 sub r3, #-(-268) ' reg ARG ADDRLi
 mov r4, ##@C_wifi_R_ead_V_alue_36_L000037 ' reg ARG ADDRG
 mov r5, FP
 ...
 cmps r22,  #83 wz
 if_nz jmp #\C_wifi_R_ead_V_alue_38 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_wifi_R_ead_V_alue_21 ' JUMPV addrg
C_wifi_R_ead_V_alue_38
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #69 wz
 if_nz jmp #\C_wifi_R_ead_V_alue_40 ' NEI4
 mov r2, FP
 sub r2, #-(-272) ' reg ARG ADDRLi
 mov r3, ##@C_wifi_R_ead_V_alue_45_L000046 ' reg ARG ADDRG
 mov r4, FP
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #1 wz
 if_nz jmp #\C_wifi_R_ead_V_alue_42 ' NEI4
 mov r22, FP
 sub r22, #-(-272) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #14 wcz 
 if_a jmp #\C_wifi_R_ead_V_alue_42 ' GTU4
 mov r22, FP
 sub r22, #-(-272) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
...
C_wifi_R_ead_V_alue_28
 cmps r17, r21 wcz
 if_b jmp #\C_wifi_R_ead_V_alue_27 ' LTI4
 mov r0, #16 ' reg <- coni
...
C_wifi_R_ead_C_ode ' <symbol:wifi_Read_Code>
 ...
 mov r21, #0 ' reg <- coni
 mov r19, #0 ' reg <- coni
 jmp #\@C_wifi_R_ead_C_ode_49 ' JUMPV addrg
C_wifi_R_ead_C_ode_48
 ...
 cmps r21,  #0 wcz
 if_ae jmp #\C_wifi_R_ead_C_ode_51 ' GEI4
 mov r0, #15 ' reg <- coni
 jmp #\@C_wifi_R_ead_C_ode_47 ' JUMPV addrg
C_wifi_R_ead_C_ode_51
C_wifi_R_ead_C_ode_49
 cmps r21,  #254 wz
 if_nz jmp #\C_wifi_R_ead_C_ode_48 ' NEI4
 jmp #\@C_wifi_R_ead_C_ode_54 ' JUMPV addrg
C_wifi_R_ead_C_ode_53
 ...
 mov r21, r0 ' CVI, CVU or LOAD
 cmps r21,  #0 wcz
 if_ae jmp #\C_wifi_R_ead_C_ode_56 ' GEI4
 mov r0, #15 ' reg <- coni
 jmp #\@C_wifi_R_ead_C_ode_47 ' JUMPV addrg
C_wifi_R_ead_C_ode_56
 cmps r21,  #13 wz
 if_z jmp #\C_wifi_R_ead_C_ode_58 ' EQI4
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
 jmp #\@C_wifi_R_ead_C_ode_59 ' JUMPV addrg
C_wifi_R_ead_C_ode_58
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
 cmps r19,  #3 wcz
 if_b jmp #\C_wifi_R_ead_C_ode_60 ' LTI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov r3, FP
 sub r3, #-(-268) ' reg ARG ADDRLi
 mov r4, ##@C_wifi_R_ead_C_ode_62_L000063 ' reg ARG ADDRG
 mov r5, FP
 sub r5, #-(-264) ' reg ARG ADDRLi
 mov BC, #16 ' arg size, rpsize = 16, spsize = 16
 sub SP, #12 ' stack space for reg ARGs
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #83 wz
 if_nz jmp #\C_wifi_R_ead_C_ode_64 ' NEI4
 cmps r19,  #2 wz
 if_nz jmp #\C_wifi_R_ead_C_ode_64 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_wifi_R_ead_C_ode_47 ' JUMPV addrg
C_wifi_R_ead_C_ode_64
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #69 wz
 if_nz jmp #\C_wifi_R_ead_C_ode_66 ' NEI4
 cmps r19,  #2 wz
 if_nz jmp #\C_wifi_R_ead_C_ode_66 ' NEI4
 rdlong r22, r23 ' reg <- INDIRI4 reg
 cmps r22,  #14 wcz
 if_a jmp #\C_wifi_R_ead_C_ode_68 ' GTI4
...
C_wifi_R_ead_C_ode_54
 cmps r19,  #256 wcz
 if_b jmp #\C_wifi_R_ead_C_ode_53 ' LTI4
 mov r0, #16 ' reg <- coni
...
C_wifi_R_ead_I_d ' <symbol:wifi_Read_Id>
 ...
 sub RI, #-(-272)
 wrlong r22, RI ' ASGNU4 addrli reg
 jmp #\@C_wifi_R_ead_I_d_72 ' JUMPV addrg
C_wifi_R_ead_I_d_71
 ...
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r19,  #0 wcz
 if_ae jmp #\C_wifi_R_ead_I_d_74 ' GEI4
 mov r0, #15 ' reg <- coni
 jmp #\@C_wifi_R_ead_I_d_70 ' JUMPV addrg
C_wifi_R_ead_I_d_74
C_wifi_R_ead_I_d_72
 cmps r19,  #254 wz
 if_nz jmp #\C_wifi_R_ead_I_d_71 ' NEI4
 jmp #\@C_wifi_R_ead_I_d_77 ' JUMPV addrg
C_wifi_R_ead_I_d_76
 mov r2, ##1000 ' reg ARG con
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 ...
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r19,  #0 wcz
 if_ae jmp #\C_wifi_R_ead_I_d_79 ' GEI4
 mov r0, #15 ' reg <- coni
 jmp #\@C_wifi_R_ead_I_d_70 ' JUMPV addrg
C_wifi_R_ead_I_d_79
 cmps r19,  #13 wz
 if_z jmp #\C_wifi_R_ead_I_d_81 ' EQI4
 mov r22, r17 ' CVI, CVU or LOAD
 mov r17, r22
 adds r17, #1 ' ADDI4 coni
 mov r20, FP
 ...
 mov r20, r19 ' CVI, CVU or LOAD
 wrbyte r20, r22 ' ASGNU1 reg reg
 jmp #\@C_wifi_R_ead_I_d_82 ' JUMPV addrg
C_wifi_R_ead_I_d_81
 mov r22, FP
 sub r22, #-(-264) ' reg <- addrli
 adds r22, r17 ' ADDI/P (2)
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
 cmps r17,  #3 wcz
 if_b jmp #\C_wifi_R_ead_I_d_83 ' LTI4
 mov r2, FP
 sub r2, #-(-272) ' reg ARG ADDRLi
 mov r3, FP
 sub r3, #-(-268) ' reg ARG ADDRLi
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #83 wz
 if_nz jmp #\C_wifi_R_ead_I_d_85 ' NEI4
 cmps r17,  #2 wz
 if_nz jmp #\C_wifi_R_ead_I_d_85 ' NEI4
 mov r22, FP
 sub r22, #-(-272) ' reg <- addrli
...
C_wifi_R_ead_I_d_85
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #69 wz
 if_nz jmp #\C_wifi_R_ead_I_d_87 ' NEI4
 cmps r17,  #2 wz
 if_nz jmp #\C_wifi_R_ead_I_d_87 ' NEI4
 mov r22, FP
 sub r22, #-(-272) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #14 wcz 
 if_a jmp #\C_wifi_R_ead_I_d_89 ' GTU4
 mov r22, FP
 sub r22, #-(-272) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 wrlong r22, r23 ' ASGNI4 reg reg
...
C_wifi_R_ead_I_d_77
 cmps r17,  #256 wcz
 if_b jmp #\C_wifi_R_ead_I_d_76 ' LTI4
 mov r0, #16 ' reg <- coni
C_wifi_R_ead_I_d_70
 calld PA,#POPM ' restore registers
 add SP, #268 ' framesize
...
C_wifi_B_R_E_A_K_ ' <symbol:wifi_BREAK>
 ...
 calld PA,#PSHM
 long $400000 ' save registers
 mov r22, ##@C_wifi_pin_brk
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_b jmp #\C_wifi_B_R_E_A_K__119 ' LTI4
 cmps r22,  #63 wcz
 if_a jmp #\C_wifi_B_R_E_A_K__119 ' GTI4
 mov r2, #100 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__waitms ' CALL addrg
 mov r2, ##@C_wifi_pin_brk
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
C_wifi_R_E_S_E_T_ ' <symbol:wifi_RESET>
 ...
 calld PA,#PSHM
 long $400000 ' save registers
 mov r22, ##@C_wifi_pin_res
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_b jmp #\C_wifi_R_E_S_E_T__122 ' LTI4
 cmps r22,  #63 wcz
 if_a jmp #\C_wifi_R_E_S_E_T__122 ' GTI4
 mov r2, ##@C_wifi_pin_res
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
C_wifi_P_G_M_ ' <symbol:wifi_PGM>
 ...
 calld PA,#PSHM
 long $c00000 ' save registers
 mov r22, ##@C_wifi_pin_pgm
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_b jmp #\C_wifi_P_G_M__125 ' LTI4
 cmps r22,  #63 wcz
 if_a jmp #\C_wifi_P_G_M__125 ' GTI4
 mov r23, #0 ' reg <- coni
C_wifi_P_G_M__127
 mov r2, ##@C_wifi_pin_pgm
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
' C_wifi_P_G_M__128 ' (symbol refcount = 0)
 ...
 cmps r23,  #4 wcz
 if_b jmp #\C_wifi_P_G_M__127 ' LTI4
C_wifi_P_G_M__125
...
C_wifi_O_K_ ' <symbol:wifi_OK>
 ...
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wz
 if_nz jmp #\C_wifi_O_K__132 ' NEI4
 mov r0, #16 ' reg <- coni
 jmp #\@C_wifi_O_K__131 ' JUMPV addrg
C_wifi_O_K__132
 mov r2, ##@C_wifi_O_K__134_L000135 ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_wifi_S_end_C_ommand ' CALL addrg
 mov r23, r0 ' CVI, CVU or LOAD
 cmps r23,  #0 wz
 if_nz jmp #\C_wifi_O_K__136 ' NEI4
 mov r2, FP
...
C_wifi_I_N_I_T_ ' <symbol:wifi_INIT>
 ...
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wz
 if_nz jmp #\C_wifi_I_N_I_T__139 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 wrlong r22, ##@C_wifi_pin_di ' ASGNI4 addrg reg
 wrlong r23, ##@C_wifi_pin_do ' ASGNI4 addrg reg
 wrlong r21, ##@C_wifi_pin_brk ' ASGNI4 addrg reg
 mov r22, ##@C_wifi_pin_res ' reg <- addrg
 wrlong r19, ##@C_wifi_pin_res ' ASGNI4 addrg reg
 wrlong r17, ##@C_wifi_pin_pgm ' ASGNI4 addrg reg
 ...
 mov r22, #1 ' reg <- coni
 wrlong r22, ##@C_wifi_init ' ASGNI4 addrg reg
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C_wifi_O_K_ ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_wifi_I_N_I_T__141 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_wifi_I_N_I_T__138 ' JUMPV addrg
C_wifi_I_N_I_T__141
C_wifi_I_N_I_T__139
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_wifi_init ' ASGNI4 addrg reg
