...
'
 ...
 alignl ' align long
C_sifs_67e4d9a1_strdup_L000005 ' <symbol:strdup>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 cmp r22,  #0 wz
 if_z jmp #\C_sifs_67e4d9a1_strdup_L000005_7 ' EQU4
 mov r2, r23 ' CVI, CVU or LOAD
 ...
 long @C_strcpy
 add SP, #4 ' CALL addrg
C_sifs_67e4d9a1_strdup_L000005_7
 mov r0, r21 ' CVI, CVU or LOAD
' C_sifs_67e4d9a1_strdup_L000005_6 ' (symbol refcount = 0)
...
C__load_L_ua_service_list_76
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_sifs_67e4d9a1_strdup_L000005 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 mov r20, #28 ' reg <- coni
 #ifndef NO_INTERRUPTS
  stalli
