...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s4uo_6880504d_maxE_xponent_L000003 ' <symbol:maxExponent>
 long 511

 alignl ' align long
C_s4uo1_6880504d_powersO_f10_L000004 ' <symbol:powersOf10>
 long $41200000 ' float
 long $42c80000 ' float
 long $461c4000 ' float
 long $4cbebc20 ' float
...
C_strtod_58
 mov r9, #0 ' reg <- coni
C_strtod_59
 mov r22, ##@C_s4uo_6880504d_maxE_xponent_L000003
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r19, r22 wcz
 if_be jmp #\C_strtod_60 ' LEI4
 mov r19, ##@C_s4uo_6880504d_maxE_xponent_L000003
...
C_strtod_60
 ...
 mov r15, ##@C_s4uo1_6880504d_powersO_f10_L000004 ' reg <- addrg
