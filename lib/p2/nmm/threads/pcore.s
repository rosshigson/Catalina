...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s5mc_690edbb5_K_ernel_lock_L000004 ' <symbol:Kernel_lock>
 long -1

 alignl ' align long
C_s5mc1_690edbb5_P_thread_L_ock_L000005 ' <symbol:Pthread_Lock>
 long -1

 alignl ' align long
C_s5mc2_690edbb5_P_rintf_L_ock_L000006 ' <symbol:Printf_Lock>
 long -1

 alignl ' align long
C_s5mc3_690edbb5_O_nce_L_ock_L000007 ' <symbol:Once_Lock>
 long -1

 alignl ' align long
C_s5mc4_690edbb5_concurrency_L000008 ' <symbol:concurrency>
 long 0
...
DAT ' code segment
 ...
 alignl ' align long
C_s5mc5_690edbb5__ensure_lock_L000009 ' <symbol:_ensure_lock>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 cmps r22,  #0 wcz
 if_a jmp #\C_s5mc5_690edbb5__ensure_lock_L000009_11 ' GTI4
 mov r2, ##@C__P_thread_P_ool ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__thread_locknew ' CALL addrg
 wrlong r0, r23 ' ASGNI4 reg reg
C_s5mc5_690edbb5__ensure_lock_L000009_11
' C_s5mc5_690edbb5__ensure_lock_L000009_10 ' (symbol refcount = 0)
...
C__pthread_init_lock_pool ' <symbol:_pthread_init_lock_pool>
 ...
 mov r23, r2 ' reg var <- reg arg
 mov r22, ##@C_s5mc_690edbb5_K_ernel_lock_L000004
 ...
 wrlong r0, ##@C_s5mc_690edbb5_K_ernel_lock_L000004 ' ASGNI4 addrg reg
 mov r2, ##@C_s5mc_690edbb5_K_ernel_lock_L000004
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
C__pthread_init_lock_pool_14
 ...
 mov r22, ##@C_s5mc1_690edbb5_P_thread_L_ock_L000005
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 mov r20, ##-1 ' reg <- con
 cmps r22, r20 wz
 ...
 calld PA,#CALA
 long @C__locknew ' CALL addrg
 wrlong r0, ##@C_s5mc1_690edbb5_P_thread_L_ock_L000005 ' ASGNI4 addrg reg
 mov r2, ##@C_s5mc1_690edbb5_P_thread_L_ock_L000005
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
...
C__pthread_init_lock_pool_16
 mov r2, ##@C_s5mc2_690edbb5_P_rintf_L_ock_L000006 ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_s5mc5_690edbb5__ensure_lock_L000009 ' CALL addrg
 mov r2, ##@C_s5mc3_690edbb5_O_nce_L_ock_L000007 ' reg ARG ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_s5mc5_690edbb5__ensure_lock_L000009 ' CALL addrg
...
C_pthread_printf_25
 ...
 long @C__thread_yield ' CALL addrg
C_pthread_printf_26
 mov r2, ##@C_s5mc2_690edbb5_P_rintf_L_ock_L000006
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
...
C_pthread_lock_check_39
 ...
 long @C_t_printf
 add SP, #4 ' CALL addrg
 mov r22, ##@C_s5mc2_690edbb5_P_rintf_L_ock_L000006
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
...
' C_pthread_equal_56 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s5mcd_690edbb5_dummy_function_L000060 ' <symbol:dummy_function>
 calld PA,#NEWF
 sub SP, #12
 calld PA,#PSHM
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_s5mcd_690edbb5_dummy_function_L000060_62 ' NEI4
 mov r22, FP
...
C_s5mcd_690edbb5_dummy_function_L000060_62
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r0, r22 ' reg <- INDIRI4 reg
' C_s5mcd_690edbb5_dummy_function_L000060_61 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #12 ' framesize
 calld PA,#RETF
...
C_pthread_create_70
 ...
 mov r5, ##@C_s5mcd_690edbb5_dummy_function_L000060 ' reg ARG ADDRG
...
C_pthread_create_64
 ...
 alignl ' align long
C_s5mce_690edbb5_foreman_L000075 ' <symbol:foreman>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 calld PA,#CALA
 long @C__thread_set_lock ' CALL addrg
 jmp #\@C_s5mce_690edbb5_foreman_L000075_78 ' JUMPV addrg
C_s5mce_690edbb5_foreman_L000075_77
 mov r2, #100 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C__thread_wait ' CALL addrg
C_s5mce_690edbb5_foreman_L000075_78
 jmp #\@C_s5mce_690edbb5_foreman_L000075_77 ' JUMPV addrg
 mov r0, #0 ' reg <- coni
' C_s5mce_690edbb5_foreman_L000075_76 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_pthread_createaffinity_81
 ...
 mov r5, ##@C_s5mce_690edbb5_foreman_L000075 ' reg ARG ADDRG
 mov BC, #16 ' arg size, rpsize = 16, spsize = 16
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C__thread_cog
...
C_pthread_once ' <symbol:pthread_once>
 ...
 calld PA,#CALA
 long @C__pthread_init_lock_pool ' CALL addrg
 mov r2, ##@C_s5mc3_690edbb5_O_nce_L_ock_L000007
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov r3, ##@C__P_thread_P_ool ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
...
C_pthread_setconcurrency ' <symbol:pthread_setconcurrency>
 wrlong r2, ##@C_s5mc4_690edbb5_concurrency_L000008 ' ASGNI4 addrg reg
 mov r0, #0 ' reg <- coni
...
C_pthread_getconcurrency ' <symbol:pthread_getconcurrency>
 mov r0, ##@C_s5mc4_690edbb5_concurrency_L000008
