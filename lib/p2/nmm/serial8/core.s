...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sei8_68fd78b2_s8base_L000002 ' <symbol:s8base>
 long $0

 alignl ' align long
C_sei81_68fd78b2_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_sei82_68fd78b2_pinconfig_L000004 ' <symbol:pinconfig>
 calld PA,#NEWF
 sub SP, #4
 calld PA,#PSHM
 ...
 cmps r17,  #0 wz
 if_nz jmp #\C_sei82_68fd78b2_pinconfig_L000004_6 ' NEI4
 mov r22, #62 ' reg <- coni
 mov RI, FP
 sub RI, #-(-8)
 ...
 cmp r22,  #0 wz
 if_z jmp #\C_sei82_68fd78b2_pinconfig_L000004_7 ' EQU4
 mov r22, FP
 ...
 sub RI, #-(-8)
 wrlong r22, RI ' ASGNU4 addrli reg
 jmp #\@C_sei82_68fd78b2_pinconfig_L000004_7 ' JUMPV addrg
C_sei82_68fd78b2_pinconfig_L000004_6
 ...
 cmps r13,  #0 wcz
 if_b jmp #\C_sei82_68fd78b2_pinconfig_L000004_10 ' LTI4
 cmps r13,  #3 wcz
 if_a jmp #\C_sei82_68fd78b2_pinconfig_L000004_10 ' GTI4
 mov r22, r13
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_sei82_68fd78b2_pinconfig_L000004_17_L000019 ' reg <- addrg
...
DAT ' const data segment
 ...
 alignl ' align long
C_sei82_68fd78b2_pinconfig_L000004_17_L000019 ' <symbol:17>
 long @C_sei82_68fd78b2_pinconfig_L000004_11
 long @C_sei82_68fd78b2_pinconfig_L000004_14
 long @C_sei82_68fd78b2_pinconfig_L000004_15
 long @C_sei82_68fd78b2_pinconfig_L000004_16

' Catalina Code

DAT ' code segment
C_sei82_68fd78b2_pinconfig_L000004_14
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 ...
 sub RI, #-(-8)
 wrlong r22, RI ' ASGNU4 addrli reg
 jmp #\@C_sei82_68fd78b2_pinconfig_L000004_11 ' JUMPV addrg
C_sei82_68fd78b2_pinconfig_L000004_15
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 ...
 wrlong r22, RI ' ASGNU4 addrli reg
 jmp #\@C_sei82_68fd78b2_pinconfig_L000004_11 ' JUMPV addrg
C_sei82_68fd78b2_pinconfig_L000004_16
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 ...
 sub RI, #-(-8)
 wrlong r22, RI ' ASGNU4 addrli reg
C_sei82_68fd78b2_pinconfig_L000004_10
C_sei82_68fd78b2_pinconfig_L000004_11
C_sei82_68fd78b2_pinconfig_L000004_7
...
' C_sei82_68fd78b2_pinconfig_L000004_5 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sei85_68fd78b2_p_config_L000020 ' <symbol:p_config>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 mov r20, ##@C_sei8_68fd78b2_s8base_L000002
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_sei85_68fd78b2_p_config_L000020_21 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_sei86_68fd78b2_autoinitialize_L000022 ' <symbol:autoinitialize>
 calld PA,#NEWF
 calld PA,#PSHM
 long $fea800 ' save registers
 mov r22, ##@C_sei8_68fd78b2_s8base_L000002
 rdlong r22, r22 ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
 if_z jmp #\C_sei86_68fd78b2_autoinitialize_L000022_24 ' EQU4
 mov r22, ##@C_sei8_68fd78b2_s8base_L000002
 rdlong r22, r22 ' reg <- INDIRP4 addrg
 ...
 add r15, r22 ' ADDU (3)
 mov r17, #0 ' reg <- coni
C_sei86_68fd78b2_autoinitialize_L000022_26
 mov r21, r17
 ...
 cmps r23,  #0 wcz
 if_b jmp #\C_sei86_68fd78b2_autoinitialize_L000022_30 ' LTI4
 cmps r23,  #63 wcz
 if_a jmp #\C_sei86_68fd78b2_autoinitialize_L000022_30 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 mov r20, ##@C_sei8_68fd78b2_s8base_L000002
 rdlong r20, r20 ' reg <- INDIRP4 addrg
 ...
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_sei82_68fd78b2_pinconfig_L000004
 add SP, #12 ' CALL addrg
 mov r22, ##1024 ' reg <- con
 mov r2, r19 ' ADDU
 add r2, r22 ' ADDU (3)
 ...
 calld PA,#CALA
 long @C_sei85_68fd78b2_p_config_L000020
 add SP, #20 ' CALL addrg
C_sei86_68fd78b2_autoinitialize_L000022_30
 ...
 mov r23, r22 ' CVI, CVU or LOAD
 cmps r23,  #0 wcz
 if_b jmp #\C_sei86_68fd78b2_autoinitialize_L000022_32 ' LTI4
 cmps r23,  #63 wcz
 if_a jmp #\C_sei86_68fd78b2_autoinitialize_L000022_32 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 mov r20, ##@C_sei8_68fd78b2_s8base_L000002
 rdlong r20, r20 ' reg <- INDIRP4 addrg
 ...
 long @C_sei85_68fd78b2_p_config_L000020
 add SP, #20 ' CALL addrg
C_sei86_68fd78b2_autoinitialize_L000022_32
 mov r22, ##2048 ' reg <- con
 add r19, r22 ' ADDU (1)
 add r15, r22 ' ADDU (1)
' C_sei86_68fd78b2_autoinitialize_L000022_27 ' (symbol refcount = 0)
 adds r17, #1 ' ADDI4 coni
 cmps r17,  #8 wcz
 if_b jmp #\C_sei86_68fd78b2_autoinitialize_L000022_26 ' LTI4
C_sei86_68fd78b2_autoinitialize_L000022_24
' C_sei86_68fd78b2_autoinitialize_L000022_23 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_sei87_68fd78b2_initialize_L000034 ' <symbol:initialize>
 calld PA,#NEWF
 sub SP, #8
 calld PA,#PSHM
 ...
 rdlong r22, r22 ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
 if_nz jmp #\C_sei87_68fd78b2_initialize_L000034_36  ' NEU4
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #0 wcz
 if_b jmp #\C_sei87_68fd78b2_initialize_L000034_38 ' LTI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 ...
 wrlong r20, ##@C_sei8_68fd78b2_s8base_L000002 ' ASGNP4 addrg reg
 mov r20, ##@C_sei81_68fd78b2_lock_L000003 ' reg <- addrg
 shr r22, #24 ' RSHU4 coni
 wrlong r22, ##@C_sei81_68fd78b2_lock_L000003 ' ASGNI4 addrg reg
 rdlong r22, r20 ' reg <- INDIRI4 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_sei87_68fd78b2_initialize_L000034_40 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__locknew ' CALL addrg
 wrlong r0, ##@C_sei81_68fd78b2_lock_L000003 ' ASGNI4 addrg reg
 mov r22, ##@C_sei81_68fd78b2_lock_L000003
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_b jmp #\C_sei87_68fd78b2_initialize_L000034_41 ' LTI4
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, ##@C_sei81_68fd78b2_lock_L000003
 ...
 jmp #\@C_sei87_68fd78b2_initialize_L000034_41 ' JUMPV addrg
C_sei87_68fd78b2_initialize_L000034_40
 mov r22, ##@C_sei81_68fd78b2_lock_L000003 ' reg <- addrg
 rdlong r22, r22 ' reg <- INDIRI4 reg
 subs r22, #1 ' SUBI4 coni
 wrlong r22, ##@C_sei81_68fd78b2_lock_L000003 ' ASGNI4 addrg reg
C_sei87_68fd78b2_initialize_L000034_41
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C_sei86_68fd78b2_autoinitialize_L000022 ' CALL addrg
C_sei87_68fd78b2_initialize_L000034_38
C_sei87_68fd78b2_initialize_L000034_36
' C_sei87_68fd78b2_initialize_L000034_35 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #8 ' framesize
 calld PA,#RETF
...
C_s_closeport ' <symbol:s_closeport>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C_sei87_68fd78b2_initialize_L000034 ' CALL addrg
C_s_closeport_45
 cmp r23,  #8 wcz 
...
C_s_rxcheck_73
 ...
 mov r2, ##@C_sei81_68fd78b2_lock_L000003
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
