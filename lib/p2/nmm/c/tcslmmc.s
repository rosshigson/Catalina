...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s10vc_67cacdc4_lmmtd_array_L000001 ' <symbol:lmmtd_array>
 long $fd900164
 long $fd900dd0
 long $fd9001cc
 long $fd9001d0
...
C__threaded_cogstart_L_M_M__cog ' <symbol:_threaded_cogstart_LMM_cog>
 ...
 sub RI, #-(-24)
 wrlong r22, RI ' ASGNU4 addrli reg
 mov r22, ##@C_M_Y__L_M_M__L_U_T__L_I_B_R_A_R_Y__array ' reg <- addrg
 mov RI, FP
 sub RI, #-(-20)
 wrlong r22, RI ' ASGNU4 addrli reg
 mov r22, #0 ' reg <- coni
 ...
 mov r22, #2 ' reg <- coni
 mov r20, ##@C_s10vc_67cacdc4_lmmtd_array_L000001 ' reg <- addrg
 mov r3, r20 ' RSHI
 sar r3, r22 ' RSHI (3)
 mov r20, FP
