...
DAT ' const data segment
 ...
 alignl ' align long
C_s288_696de09b_udatatypename_L000015 ' <symbol:udatatypename>
 byte 117
 byte 115
 byte 101
 byte 114
...
C_luaT__typenames_ ' <symbol:luaT_typenames_>
 long @C_s2881_696de09b_16_L000017
 long @C_s2882_696de09b_18_L000019
 long @C_s2883_696de09b_20_L000021
 long @C_s288_696de09b_udatatypename_L000015
 long @C_s2884_696de09b_22_L000023
 long @C_s2885_696de09b_24_L000025
 long @C_s2886_696de09b_26_L000027
 long @C_s2887_696de09b_28_L000029
 long @C_s288_696de09b_udatatypename_L000015
 long @C_s2888_696de09b_30_L000031
 long @C_s2889_696de09b_32_L000033
 long @C_s288a_696de09b_34_L000035
...
C_luaT__init_89
 ...
 mov r20, ##@C_luaT__init_luaT__eventname_L000038 ' reg <- addrg
...
C_luaT__gettm ' <symbol:luaT_gettm>
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_luaT__gettm_94 ' NEI4
 mov r22, r23
 ...
 mov r0, ##0 ' RET con
 jmp #\@C_luaT__gettm_93 ' JUMPV addrg
C_luaT__gettm_94
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
...
C_luaT__gettmbyobj ' <symbol:luaT_gettmbyobj>
 ...
 cmps r17,  #5 wz
 if_z jmp #\C_luaT__gettmbyobj_100 ' EQI4
 cmps r17,  #7 wz
 if_z jmp #\C_luaT__gettmbyobj_101 ' EQI4
 jmp #\@C_luaT__gettmbyobj_97 ' JUMPV addrg
C_luaT__gettmbyobj_100
 ...
 jmp #\@C_luaT__gettmbyobj_98 ' JUMPV addrg
...
C_luaT__gettmbyobj_98
 ...
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_z jmp #\C_luaT__gettmbyobj_103 ' EQU4
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 mov r20, r23
 adds r20, #16 ' ADDP4 coni
 ...
 jmp #\@C_luaT__gettmbyobj_104 ' JUMPV addrg
...
C_luaT__objtypename ' <symbol:luaT_objtypename>
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #69 wz
 if_nz jmp #\C_luaT__objtypename_109 ' NEI4
 rdlong r22, r21 ' reg <- INDIRP4 reg
 adds r22, #24 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 wrlong r22, RI ' ASGNP4 addrli reg
 cmp r22,  #0 wz
 if_nz jmp #\C_luaT__objtypename_108  ' NEU4
C_luaT__objtypename_109
 mov r22, r21
 adds r22, #4 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #71 wz
 if_nz jmp #\C_luaT__objtypename_106 ' NEI4
 rdlong r22, r21 ' reg <- INDIRP4 reg
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 wrlong r22, RI ' ASGNP4 addrli reg
 cmp r22,  #0 wz
 if_z jmp #\C_luaT__objtypename_106 ' EQU4
C_luaT__objtypename_108
 mov r2, ##@C_luaT__objtypename_110_L000111 ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 cmps r20, r22 wz
 if_nz jmp #\C_luaT__objtypename_112 ' NEI4
 mov r22, FP
 ...
 jmp #\@C_luaT__objtypename_105 ' JUMPV addrg
...
C_luaT__callT_M_ ' <symbol:luaT_callTM>
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_luaT__callT_M__116 ' NEI4
 ...
 long @C_luaD__call
 add SP, #8 ' CALL addrg
 jmp #\@C_luaT__callT_M__117 ' JUMPV addrg
...
C_luaT__callT_M_res ' <symbol:luaT_callTMres>
 ...
 and r22, #10 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_luaT__callT_M_res_119 ' NEI4
 ...
 long @C_luaD__call
 add SP, #8 ' CALL addrg
 jmp #\@C_luaT__callT_M_res_120 ' JUMPV addrg
...
' C_luaT__callT_M_res_118 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s28816_696de09b_callbinT_M__L000121 ' <symbol:callbinTM>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 and r22, #15 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_s28816_696de09b_callbinT_M__L000121_123 ' NEI4
 mov r2, r17 ' CVI, CVU or LOAD
 ...
 add SP, #8 ' CALL addrg
 mov r15, r0 ' CVI, CVU or LOAD
C_s28816_696de09b_callbinT_M__L000121_123
 mov r22, r15
 adds r22, #4 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 and r22, #15 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_s28816_696de09b_callbinT_M__L000121_125 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_s28816_696de09b_callbinT_M__L000121_122 ' JUMPV addrg
C_s28816_696de09b_callbinT_M__L000121_125
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r21 ' CVI, CVU or LOAD
 ...
 mov r0, #1 ' reg <- coni
C_s28816_696de09b_callbinT_M__L000121_122
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_luaT__trybinT_M_ ' <symbol:luaT_trybinTM>
 ...
 add SP, #4 ' correct for new kernel !!! 
 calld PA,#CALA
 long @C_s28816_696de09b_callbinT_M__L000121
 add SP, #16 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_luaT__trybinT_M__128 ' NEI4
 mov r15, r17 ' CVI, CVU or LOAD
 cmps r15,  #13 wcz
 if_b jmp #\C_luaT__trybinT_M__130 ' LTI4
 cmps r15,  #19 wcz
 if_a jmp #\C_luaT__trybinT_M__130 ' GTI4
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_luaT__trybinT_M__140_L000142-52 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 rdlong RI, r22
...
C_luaT__trybinT_M__133
 ...
 and r20, #15 ' BANDI4 coni
 cmps r20, r22 wz
 if_nz jmp #\C_luaT__trybinT_M__134 ' NEI4
 mov r20, r21
 adds r20, #4 ' ADDP4 coni
 rdbyte r20, r20 ' reg <- CVUI4 INDIRU1 reg
 and r20, #15 ' BANDI4 coni
 ...
 add SP, #8 ' CALL addrg
 jmp #\@C_luaT__trybinT_M__135 ' JUMPV addrg
C_luaT__trybinT_M__134
 mov r2, ##@C_luaT__trybinT_M__136_L000137 ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov RI, FP
 add RI, #8
...
C_luaT__trybinT_M__130
 mov r2, ##@C_luaT__trybinT_M__138_L000139 ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov RI, FP
 add RI, #8
...
C_luaT__tryconcatT_M_ ' <symbol:luaT_tryconcatTM>
 ...
 add SP, #16 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_luaT__tryconcatT_M__145 ' NEI4
 mov r22, ##-8 ' reg <- con
 mov r2, r21 ' ADDI/P
...
C_luaT__trybinassocT_M_ ' <symbol:luaT_trybinassocTM>
 ...
 mov r17, r2 ' reg var <- reg arg
 cmps r21,  #0 wz
 if_z jmp #\C_luaT__trybinassocT_M__148 ' EQI4
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, r19 ' CVI, CVU or LOAD
 mov RI, FP
 add RI, #12
 ...
 add SP, #16 ' CALL addrg
 jmp #\@C_luaT__trybinassocT_M__149 ' JUMPV addrg
...
C_luaT__callorderT_M_ ' <symbol:luaT_callorderTM>
 ...
 add SP, #16 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_luaT__callorderT_M__152 ' EQI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 adds r22, #4 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #1 wz
 if_z jmp #\C_luaT__callorderT_M__155 ' EQI4
 and r22, #15 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_luaT__callorderT_M__155 ' EQI4
 mov r15, #1 ' reg <- coni
 jmp #\@C_luaT__callorderT_M__156 ' JUMPV addrg
C_luaT__callorderT_M__155
 mov r15, #0 ' reg <- coni
C_luaT__callorderT_M__156
 mov r0, r15 ' CVI, CVU or LOAD
 jmp #\@C_luaT__callorderT_M__151 ' JUMPV addrg
...
C_luaT__callorderiT_M_ ' <symbol:luaT_callorderiTM>
 ...
 mov r17, r2 ' reg var <- reg arg
 cmps r19,  #0 wz
 if_z jmp #\C_luaT__callorderiT_M__158 ' EQI4
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 mov RI, FP
 sub RI, #-(-20)
 ...
 mov r20, #19 ' reg <- coni
 wrbyte r20, r22 ' ASGNU1 reg reg
 jmp #\@C_luaT__callorderiT_M__159 ' JUMPV addrg
...
C_luaT__callorderiT_M__159
 cmps r21,  #0 wz
 if_z jmp #\C_luaT__callorderiT_M__160 ' EQI4
 mov r22, FP
 ...
 jmp #\@C_luaT__callorderiT_M__161 ' JUMPV addrg
...
C_luaT__adjustvarargs ' <symbol:luaT_adjustvarargs>
 ...
 cmps r0, r22 wcz
 if_a jmp #\C_luaT__adjustvarargs_163 ' GTI4
 mov r22, #1 ' reg <- coni
 mov r2, r22 ' CVI, CVU or LOAD
 mov r22, r17
 adds r22, #8 ' ADDP4 coni
...
' C_luaT__adjustvarargs_164 ' (symbol refcount = 0)
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
 mov r15, #1 ' reg <- coni
 jmp #\@C_luaT__adjustvarargs_168 ' JUMPV addrg
...
C_luaT__adjustvarargs_168
 cmps r15, r21 wcz
 if_be jmp #\C_luaT__adjustvarargs_165 ' LEI4
 mov r22, r13
 shl r22, #3 ' LSHI4 coni
...
C_luaT__getvarargs ' <symbol:luaT_getvarargs>
 ...
 cmps r17,  #0 wcz
 if_ae jmp #\C_luaT__getvarargs_170 ' GEI4
 ...
 calld PA,#DIVS ' DIVI
 cmps r0, r13 wcz
 if_a jmp #\C_luaT__getvarargs_172 ' GTI4
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #0 wcz
 if_be jmp #\C_luaT__getvarargs_174 ' LEI4
...
C_luaT__getvarargs_170
 mov r15, #0 ' reg <- coni
 jmp #\@C_luaT__getvarargs_179 ' JUMPV addrg
...
C_luaT__getvarargs_179
 cmps r15, r17 wcz
 if_ae jmp #\C_luaT__getvarargs_180 ' GEI4
 cmps r15, r13 wcz
 if_b jmp #\C_luaT__getvarargs_176 ' LTI4
C_luaT__getvarargs_180
 jmp #\@C_luaT__getvarargs_184 ' JUMPV addrg
...
C_luaT__getvarargs_184
 cmps r15, r17 wcz
 if_b jmp #\C_luaT__getvarargs_181 ' LTI4
...
C_luaT__init_39_L000040 ' <symbol:39>
 ...
 alignl ' align long
C_s288a_696de09b_34_L000035 ' <symbol:34>
 byte 112
 byte 114
 byte 111
 byte 116
 ...
 alignl ' align long
C_s2889_696de09b_32_L000033 ' <symbol:32>
 byte 117
 byte 112
 byte 118
 byte 97
 ...
 alignl ' align long
C_s2888_696de09b_30_L000031 ' <symbol:30>
 byte 116
 byte 104
 byte 114
 byte 101
 ...
 alignl ' align long
C_s2887_696de09b_28_L000029 ' <symbol:28>
 byte 102
 byte 117
 byte 110
 byte 99
 ...
 alignl ' align long
C_s2886_696de09b_26_L000027 ' <symbol:26>
 byte 116
 byte 97
 byte 98
 byte 108
 ...
 alignl ' align long
C_s2885_696de09b_24_L000025 ' <symbol:24>
 byte 115
 byte 116
 byte 114
 byte 105
 ...
 alignl ' align long
C_s2884_696de09b_22_L000023 ' <symbol:22>
 byte 110
 byte 117
 byte 109
 byte 98
 ...
 alignl ' align long
C_s2883_696de09b_20_L000021 ' <symbol:20>
 byte 98
 byte 111
 byte 111
 byte 108
 ...
 alignl ' align long
C_s2882_696de09b_18_L000019 ' <symbol:18>
 byte 110
 byte 105
 byte 108
 byte 0
 ...
 alignl ' align long
C_s2881_696de09b_16_L000017 ' <symbol:16>
 byte 110
 byte 111
 byte 32
 byte 118
