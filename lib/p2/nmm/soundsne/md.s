...
C_md_begin_5
 ...
 getqx r0
  ...
  allowi
 #endif
 mov r22, ##@C_C_+24 ' reg <- addrg
 adds r22, r0 ' ADDI/P (2)
 mov r20, ##@C__adsrD_efault ' reg <- addrg
...
C_md_millis ' <symbol:md_millis>
 ...
 mov r22, ##@C_md_millis_ms_L000013
 rdlong r22, r22 ' reg <- INDIRU4 addrg
 cmp r22,  #0 wz
 if_nz jmp #\C_md_millis_14  ' NEU4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cnt ' CALL addrg
 wrlong r0, ##@C_md_millis_ms_L000013 ' ASGNU4 addrg reg
 mov r0, #0 ' reg <- coni
 jmp #\@C_md_millis_11 ' JUMPV addrg
C_md_millis_14
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C__cnt ' CALL addrg
...
C_md_setA_D_S_R_ ' <symbol:md_setADSR>
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #4 wcz
 if_ae jmp #\C_md_setA_D_S_R__17 ' GEI4
 mov r2, r23 ' CVUI
 ...
 cmp r0,  #0 wz
 if_z jmp #\C_md_setA_D_S_R__19 ' EQU4
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_md_setA_D_S_R__21  ' NEU4
 mov r22, #28 ' reg <- coni
 mov r20, r23 ' CVUI
 and r20, cviu_m1 ' zero extend
 #ifndef NO_INTERRUPTS
 ...
 mov r20, ##@C__adsrD_efault ' reg <- addrg
 wrlong r20, r22 ' ASGNP4 reg reg
 jmp #\@C_md_setA_D_S_R__22 ' JUMPV addrg
C_md_setA_D_S_R__21
 mov r22, #28 ' reg <- coni
 mov r20, r23 ' CVUI
 and r20, cviu_m1 ' zero extend
...
C_md_setA_llA_D_S_R_ ' <symbol:md_setAllADSR>
 ...
 mov r19, #1 ' reg <- coni
 mov r21, #0 ' reg <- coni
 jmp #\@C_md_setA_llA_D_S_R__29 ' JUMPV addrg
...
C_md_setA_llA_D_S_R__29
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #4 wcz
 if_b jmp #\C_md_setA_llA_D_S_R__26 ' LTI4
...
C_md_isI_dle ' <symbol:md_isIdle>
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #4 wcz
 if_ae jmp #\C_md_isI_dle_31 ' GEI4
 mov r22, #28 ' reg <- coni
 mov r20, r2 ' CVUI
 and r20, cviu_m1 ' zero extend
 #ifndef NO_INTERRUPTS
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_md_isI_dle_35 ' NEI4
 mov r23, #1 ' reg <- coni
 jmp #\@C_md_isI_dle_36 ' JUMPV addrg
C_md_isI_dle_35
 mov r23, #0 ' reg <- coni
C_md_isI_dle_36
...
C_calcT_s ' <symbol:calcTs>
 ...
 cmps r20, r22 wcz
 if_ae jmp #\C_calcT_s_40 ' GEI4
 mov r2, #1 ' reg <- coni
 jmp #\@C_calcT_s_41 ' JUMPV addrg
C_calcT_s_40
 mov r22, #28 ' reg <- coni
 mov r20, r3 ' CVUI
 and r20, cviu_m1 ' zero extend
...
C_md_tone ' <symbol:md_tone>
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #3 wcz
 if_ae jmp #\C_md_tone_49 ' GEI4
 mov r22, r21 ' CVUI
 and r22, cviu_m2 ' zero extend
 cmps r22,  #0 wz
 if_z jmp #\C_md_tone_51 ' EQI4
 mov r22, #28 ' reg <- coni
 mov r20, r23 ' CVUI
 and r20, cviu_m1 ' zero extend
 #ifndef NO_INTERRUPTS
 ...
 getqx r0
  ...
  allowi
 #endif
 mov r18, ##@C_C_+1 ' reg <- addrg
 adds r18, r0 ' ADDI/P (2)
 wrbyte r22, r18 ' ASGNU1 reg reg
 mov r18, ##@C_C_ ' reg <- addrg
 mov r20, r0 ' ADDI/P
...
C_md_note ' <symbol:md_note>
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #3 wcz
 if_ae jmp #\C_md_note_60 ' GEI4
 mov r22, r21 ' CVUI
 and r22, cviu_m2 ' zero extend
 cmps r22,  #0 wz
 if_z jmp #\C_md_note_62 ' EQI4
 mov r22, #28 ' reg <- coni
 mov r20, r23 ' CVUI
 and r20, cviu_m1 ' zero extend
 #ifndef NO_INTERRUPTS
...
C_md_noise ' <symbol:md_noise>
 ...
 cmps r23,  #15 wz
 if_z jmp #\C_md_noise_71 ' EQI4
 mov r22, r23 ' CVI, CVU or LOAD
 wrword r22, ##@C_C_+84+4 ' ASGNU2 addrg reg
 mov r2, r21 ' CVUI
 and r2, cviu_m1 ' zero extend
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_saneV_olume ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 wrbyte r22, ##@C_C_+84+1 ' ASGNU1 addrg reg
 wrbyte r22, ##@C_C_+84 ' ASGNU1 addrg reg
 mov r2, r19 ' CVUI
 and r2, cviu_m2 ' zero extend
 ...
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 wrword r22, ##@C_C_+84+6 ' ASGNU2 addrg reg
 mov r22, #3 ' reg <- coni
 wrlong r22, ##@C_C_+84+12 ' ASGNI4 addrg reg
 jmp #\@C_md_noise_72 ' JUMPV addrg
C_md_noise_71
 mov r22, #7 ' reg <- coni
 wrlong r22, ##@C_C_+84+12 ' ASGNI4 addrg reg
C_md_noise_72
...
C_md_play_85
 ...
 cmps r21,  #0 wcz
 if_b jmp #\C_md_play_89 ' LTI4
 cmps r21,  #8 wcz
 if_a jmp #\C_md_play_89 ' GTI4
 mov r22, r21
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_md_play_205_L000207 ' reg <- addrg
...
C_md_play_93
 ...
 getqx r0
  ...
  allowi
 #endif
 mov r22, ##@C_C_+1 ' reg <- addrg
 adds r22, r0 ' ADDI/P (2)
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_z jmp #\C_md_play_90 ' EQI4
 mov r2, #0 ' reg ARG coni
 mov r3, r23 ' CVUI
 and r3, cviu_m1 ' zero extend
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
...
C_md_play_97
 ...
 getqx r0
  ...
  allowi
 #endif
 mov r20, ##@C_C_+4 ' reg <- addrg
 adds r20, r0 ' ADDI/P (2)
 rdword r2, r20 ' reg <- CVUI4 INDIRU2 reg
 mov r3, r22 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
...
C_md_play_109
 ...
 #endif
 mov r22, r0 ' CVI, CVU or LOAD
 mov r20, ##@C_C_+24 ' reg <- addrg
 adds r20, r22 ' ADDI/P (2)
 rdlong r20, r20 ' reg <- INDIRP4 reg
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r20,  #0 wz
 if_z jmp #\C_md_play_113 ' EQU4
 mov r17, ##-1 ' reg <- con
 jmp #\@C_md_play_114 ' JUMPV addrg
C_md_play_113
 mov r17, #1 ' reg <- coni
C_md_play_114
 mov r20, ##@C_C_+2 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
...
C_md_play_120
 ...
 getqx r0
  ...
  allowi
 #endif
 mov r18, ##@C_C_+16 ' reg <- addrg
 adds r18, r0 ' ADDI/P (2)
 rdlong r18, r18 ' reg <- INDIRU4 reg
 sub r22, r18 ' SUBU (1)
 mov r18, ##@C_C_+20 ' reg <- addrg
 mov r20, r0 ' ADDI/P
 adds r20, r18 ' ADDI/P (3)
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_b jmp #\C_md_play_90 ' LTU4
 mov r22, #28 ' reg <- coni
 mov r20, r23 ' CVUI
 and r20, cviu_m1 ' zero extend
 #ifndef NO_INTERRUPTS
 ...
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r20,  #0 wz
 if_z jmp #\C_md_play_132 ' EQU4
 mov r20, ##@C_C_+1 ' reg <- addrg
 mov r22, r0 ' ADDI/P
 adds r22, r20 ' ADDI/P (3)
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_z jmp #\C_md_play_131 ' EQI4
C_md_play_132
 mov r22, #28 ' reg <- coni
 mov r20, r23 ' CVUI
 and r20, cviu_m1 ' zero extend
...
C_md_play_143
 ...
 neg r22, r22 ' SUBI/P (2)
 cmps r22,  #0 wcz
 if_ae jmp #\C_md_play_151 ' GEI4
 mov r19, #0 ' reg <- coni
 jmp #\@C_md_play_152 ' JUMPV addrg
C_md_play_151
 mov r22, #28 ' reg <- coni
 mov r20, r23 ' CVUI
 and r20, cviu_m1 ' zero extend
...
C_md_play_162
 ...
 #endif
 mov r22, r0 ' CVI, CVU or LOAD
 mov r20, ##@C_C_+8 ' reg <- addrg
 adds r20, r22 ' ADDI/P (2)
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r20,  #0 wz
 if_z jmp #\C_md_play_173 ' EQU4
 mov r19, #0 ' reg <- coni
 jmp #\@C_md_play_174 ' JUMPV addrg
C_md_play_173
 mov r19, #7 ' reg <- coni
C_md_play_174
 mov r20, ##@C_C_+12 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
...
C_md_play_175
 ...
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r20,  #0 wz
 if_z jmp #\C_md_play_183 ' EQU4
 mov r19, #1 ' reg <- coni
 jmp #\@C_md_play_184 ' JUMPV addrg
C_md_play_183
 mov r19, ##-1 ' reg <- con
C_md_play_184
 mov r20, ##@C_C_+2 ' reg <- addrg
...
C_md_play_186
 ...
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r20,  #0 wz
 if_nz jmp #\C_md_play_198  ' NEU4
 mov r20, ##@C_C_+1 ' reg <- addrg
 mov r22, r0 ' ADDI/P
 adds r22, r20 ' ADDI/P (3)
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_z jmp #\C_md_play_197 ' EQI4
C_md_play_198
 mov r22, #28 ' reg <- coni
 mov r20, r23 ' CVUI
 and r20, cviu_m1 ' zero extend
...
C_saneV_olume ' <symbol:saneVolume>
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #15 wcz
 if_be jmp #\C_saneV_olume_209 ' LEI4
 mov r2, #15 ' reg <- coni
C_saneV_olume_209
 mov r0, r2 ' CVUI
...
C_md_setV_olume ' <symbol:md_setVolume>
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #4 wcz
 if_ae jmp #\C_md_setV_olume_214 ' GEI4
 mov r2, r21 ' CVUI
 and r2, cviu_m1 ' zero extend
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
...
C_md_setA_llV_olume ' <symbol:md_setAllVolume>
 ...
 mov r23, r2 ' reg var <- reg arg
 mov r21, #0 ' reg <- coni
 jmp #\@C_md_setA_llV_olume_220 ' JUMPV addrg
...
C_md_setA_llV_olume_220
 ...
 sar r22, #24 ' sign extend
 cmps r22,  #4 wcz
 if_b jmp #\C_md_setA_llV_olume_217 ' LTI4
...
C_md_setF_requency ' <symbol:md_setFrequency>
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #3 wcz
 if_ae jmp #\C_md_setF_requency_222 ' GEI4
 mov r22, ##$3d0900 ' reg <- con
 mov r20, r21 ' CVUI
 and r20, cviu_m2 ' zero extend
...
C_md_setN_oise ' <symbol:md_setNoise>
 ...
 mov r23, r2 ' reg var <- reg arg
 cmps r23,  #15 wz
 if_z jmp #\C_md_setN_oise_225 ' EQI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov r3, #3 ' reg ARG coni
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 long @C_sne_setF_req
 add SP, #4 ' CALL addrg
 jmp #\@C_md_setN_oise_226 ' JUMPV addrg
C_md_setN_oise_225
 mov r2, #0 ' reg ARG coni
 mov r3, #3 ' reg ARG coni
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
