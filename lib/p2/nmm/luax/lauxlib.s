...
'
 ...
 alignl ' align long
C_saak_66c68cf9_findfield_L000004 ' <symbol:findfield>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 cmps r19,  #0 wz
 if_z jmp #\C_saak_66c68cf9_findfield_L000004_8 ' EQI4
 ...
 add SP, #4 ' CALL addrg
 cmps r0,  #5 wz
 if_z jmp #\C_saak_66c68cf9_findfield_L000004_6 ' EQI4
C_saak_66c68cf9_findfield_L000004_8
 mov r0, #0 ' reg <- coni
 jmp #\@C_saak_66c68cf9_findfield_L000004_5 ' JUMPV addrg
C_saak_66c68cf9_findfield_L000004_6
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_lua_pushnil ' CALL addrg
 jmp #\@C_saak_66c68cf9_findfield_L000004_10 ' JUMPV addrg
C_saak_66c68cf9_findfield_L000004_9
 ...
 add SP, #4 ' CALL addrg
 cmps r0,  #4 wz
 if_nz jmp #\C_saak_66c68cf9_findfield_L000004_12 ' NEI4
 mov r2, ##-1 ' reg ARG con
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_saak_66c68cf9_findfield_L000004_14 ' EQI4
 mov r2, ##-2 ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 mov r0, #1 ' reg <- coni
 jmp #\@C_saak_66c68cf9_findfield_L000004_5 ' JUMPV addrg
C_saak_66c68cf9_findfield_L000004_14
 mov r2, r19
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak_66c68cf9_findfield_L000004
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_saak_66c68cf9_findfield_L000004_16 ' EQI4
 mov r2, ##@C_saak_66c68cf9_findfield_L000004_18_L000019 ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 mov r0, #1 ' reg <- coni
 jmp #\@C_saak_66c68cf9_findfield_L000004_5 ' JUMPV addrg
C_saak_66c68cf9_findfield_L000004_16
C_saak_66c68cf9_findfield_L000004_12
 mov r2, ##-2 ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 long @C_lua_settop
 add SP, #4 ' CALL addrg
C_saak_66c68cf9_findfield_L000004_10
 mov r2, ##-2 ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_saak_66c68cf9_findfield_L000004_9 ' NEI4
 mov r0, #0 ' reg <- coni
C_saak_66c68cf9_findfield_L000004_5
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saak2_66c68cf9_pushglobalfuncname_L000020 ' <symbol:pushglobalfuncname>
 calld PA,#NEWF
 sub SP, #4
 calld PA,#PSHM
 long $e80000 ' save registers
 ...
 mov r3, ##@C_saak2_66c68cf9_pushglobalfuncname_L000020_22_L000023 ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_lua_getinfo
 add SP, #8 ' CALL addrg
 mov r2, ##@C_saak2_66c68cf9_pushglobalfuncname_L000020_24_L000025 ' reg ARG ADDRG
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_saak2_66c68cf9_pushglobalfuncname_L000020_26 ' EQI4
 ...
 mov r2, #3 ' reg ARG coni
 mov r3, ##@C_saak2_66c68cf9_pushglobalfuncname_L000020_30_L000031 ' reg ARG ADDRG
 mov RI, FP
 sub RI, #-(-8)
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_saak2_66c68cf9_pushglobalfuncname_L000020_28 ' NEI4
 mov r22, FP
 ...
 long @C_lua_settop
 add SP, #4 ' CALL addrg
C_saak2_66c68cf9_pushglobalfuncname_L000020_28
 mov r2, r19
 ...
 add SP, #4 ' CALL addrg
 mov r0, #1 ' reg <- coni
 jmp #\@C_saak2_66c68cf9_pushglobalfuncname_L000020_21 ' JUMPV addrg
C_saak2_66c68cf9_pushglobalfuncname_L000020_26
 ...
 add SP, #4 ' CALL addrg
 mov r0, #0 ' reg <- coni
C_saak2_66c68cf9_pushglobalfuncname_L000020_21
 calld PA,#POPM ' restore registers
 add SP, #4 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_saak6_66c68cf9_pushfuncname_L000032 ' <symbol:pushfuncname>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak2_66c68cf9_pushglobalfuncname_L000020
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_saak6_66c68cf9_pushfuncname_L000032_34 ' EQI4
 mov r2, ##0 ' reg ARG con
 mov r3, ##-1 ' reg ARG con
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 mov r3, ##@C_saak6_66c68cf9_pushfuncname_L000032_36_L000037 ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 long @C_lua_settop
 add SP, #4 ' CALL addrg
 jmp #\@C_saak6_66c68cf9_pushfuncname_L000032_35 ' JUMPV addrg
C_saak6_66c68cf9_pushfuncname_L000032_34
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_z jmp #\C_saak6_66c68cf9_pushfuncname_L000032_38 ' EQI4
 mov r22, r21
 ...
 mov r4, ##@C_saak6_66c68cf9_pushfuncname_L000032_40_L000041 ' reg ARG ADDRG
 ...
 jmp #\@C_saak6_66c68cf9_pushfuncname_L000032_39 ' JUMPV addrg
C_saak6_66c68cf9_pushfuncname_L000032_38
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #109 wz
 if_nz jmp #\C_saak6_66c68cf9_pushfuncname_L000032_42 ' NEI4
 mov r2, ##@C_saak6_66c68cf9_pushfuncname_L000032_44_L000045 ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_lua_pushstring
 add SP, #4 ' CALL addrg
 jmp #\@C_saak6_66c68cf9_pushfuncname_L000032_43 ' JUMPV addrg
C_saak6_66c68cf9_pushfuncname_L000032_42
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #67 wz
 if_z jmp #\C_saak6_66c68cf9_pushfuncname_L000032_46 ' EQI4
 mov r22, r21
 adds r22, #28 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRI4 reg
 mov r3, r21
 adds r3, #44 ' ADDP4 coni
 mov r4, ##@C_saak6_66c68cf9_pushfuncname_L000032_48_L000049 ' reg ARG ADDRG
 mov r5, r23 ' CVI, CVU or LOAD
 mov BC, #16 ' arg size, rpsize = 16, spsize = 16
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_lua_pushfstring
 add SP, #12 ' CALL addrg
 jmp #\@C_saak6_66c68cf9_pushfuncname_L000032_47 ' JUMPV addrg
C_saak6_66c68cf9_pushfuncname_L000032_46
 mov r2, ##@C_saak6_66c68cf9_pushfuncname_L000032_50_L000051 ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_lua_pushstring
 add SP, #4 ' CALL addrg
C_saak6_66c68cf9_pushfuncname_L000032_47
C_saak6_66c68cf9_pushfuncname_L000032_43
C_saak6_66c68cf9_pushfuncname_L000032_39
C_saak6_66c68cf9_pushfuncname_L000032_35
' C_saak6_66c68cf9_pushfuncname_L000032_33 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saakc_66c68cf9_lastlevel_L000052 ' <symbol:lastlevel>
 calld PA,#NEWF
 sub SP, #108
 calld PA,#PSHM
 ...
 mov r19, #1 ' reg <- coni
 mov r21, #1 ' reg <- coni
 jmp #\@C_saakc_66c68cf9_lastlevel_L000052_55 ' JUMPV addrg
C_saakc_66c68cf9_lastlevel_L000052_54
 mov r19, r21 ' CVI, CVU or LOAD
 shl r21, #1 ' LSHI4 coni
C_saakc_66c68cf9_lastlevel_L000052_55
 mov r2, FP
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_saakc_66c68cf9_lastlevel_L000052_54 ' NEI4
 jmp #\@C_saakc_66c68cf9_lastlevel_L000052_58 ' JUMPV addrg
C_saakc_66c68cf9_lastlevel_L000052_57
 mov r22, r19 ' ADDI/P
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_saakc_66c68cf9_lastlevel_L000052_60 ' EQI4
 mov r19, r17
 adds r19, #1 ' ADDI4 coni
 jmp #\@C_saakc_66c68cf9_lastlevel_L000052_61 ' JUMPV addrg
C_saakc_66c68cf9_lastlevel_L000052_60
 mov r21, r17 ' CVI, CVU or LOAD
C_saakc_66c68cf9_lastlevel_L000052_61
C_saakc_66c68cf9_lastlevel_L000052_58
 cmps r19, r21 wcz
 if_b jmp #\C_saakc_66c68cf9_lastlevel_L000052_57 ' LTI4
 mov r0, r21
 subs r0, #1 ' SUBI4 coni
' C_saakc_66c68cf9_lastlevel_L000052_53 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
...
C_luaL__traceback ' <symbol:luaL_traceback>
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_saakc_66c68cf9_lastlevel_L000052 ' CALL addrg
...
C_luaL__traceback_84
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak6_66c68cf9_pushfuncname_L000032
 add SP, #4 ' CALL addrg
 mov r2, FP
 sub r2, #-(-384) ' reg ARG ADDRLi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_luaL__argerror_120
 mov r17, ##@C_saak6_66c68cf9_pushfuncname_L000032_50_L000051 ' reg <- addrg
...
' C_luaL__typeerror_125 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_saakr_66c68cf9_tag_error_L000136 ' <symbol:tag_error>
 calld PA,#NEWF
 calld PA,#PSHM
 long $e80000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 add SP, #8 ' CALL addrg
' C_saakr_66c68cf9_tag_error_L000136_137 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_luaL__checktype ' <symbol:luaL_checktype>
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saakr_66c68cf9_tag_error_L000136
 add SP, #8 ' CALL addrg
...
' C_luaL__optnumber_224 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_saak15_66c68cf9_interror_L000228 ' <symbol:interror>
 calld PA,#NEWF
 calld PA,#PSHM
 long $e00000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_saak15_66c68cf9_interror_L000228_230 ' EQI4
 mov r2, ##@C_saak15_66c68cf9_interror_L000228_232_L000233 ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 long @C_luaL__argerror
 add SP, #8 ' CALL addrg
 jmp #\@C_saak15_66c68cf9_interror_L000228_231 ' JUMPV addrg
C_saak15_66c68cf9_interror_L000228_230
 mov r2, #3 ' reg ARG coni
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 long @C_saakr_66c68cf9_tag_error_L000136
 add SP, #8 ' CALL addrg
C_saak15_66c68cf9_interror_L000228_231
' C_saak15_66c68cf9_interror_L000228_229 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_luaL__checkinteger ' <symbol:luaL_checkinteger>
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak15_66c68cf9_interror_L000228
 add SP, #4 ' CALL addrg
...
' C_luaL__optinteger_237 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_saak17_66c68cf9_resizebox_L000241 ' <symbol:resizebox>
 calld PA,#NEWF
 sub SP, #8
 calld PA,#PSHM
 ...
 cmp r20, r22 wz
 if_nz jmp #\C_saak17_66c68cf9_resizebox_L000241_243  ' NEU4
 cmp r19, r22 wz
 if_z jmp #\C_saak17_66c68cf9_resizebox_L000241_243 ' EQU4
 mov r2, ##@C_saak17_66c68cf9_resizebox_L000241_245_L000246 ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 calld PA,#CALA
 long @C_lua_error ' CALL addrg
C_saak17_66c68cf9_resizebox_L000241_243
 wrlong r15, r17 ' ASGNP4 reg reg
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 wrlong r19, r22 ' ASGNU4 reg reg
 mov r0, r15 ' CVI, CVU or LOAD
' C_saak17_66c68cf9_resizebox_L000241_242 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #8 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_saak19_66c68cf9_boxgc_L000247 ' <symbol:boxgc>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak17_66c68cf9_resizebox_L000241
 add SP, #8 ' CALL addrg
 mov r0, #0 ' reg <- coni
' C_saak19_66c68cf9_boxgc_L000247_248 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
DAT ' const data segment
 ...
 alignl ' align long
C_saak1a_66c68cf9_boxmt_L000249 ' <symbol:boxmt>
 long @C_saak1b_66c68cf9_250_L000251
 long @C_saak19_66c68cf9_boxgc_L000247
 long @C_saak1c_66c68cf9_252_L000253
 long @C_saak19_66c68cf9_boxgc_L000247
 long $0
 long $0
...
DAT ' code segment
 ...
 alignl ' align long
C_saak1d_66c68cf9_newbox_L000254 ' <symbol:newbox>
 calld PA,#NEWF
 calld PA,#PSHM
 long $f00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 ...
 mov r2, ##@C_saak1d_66c68cf9_newbox_L000254_258_L000259 ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_saak1d_66c68cf9_newbox_L000254_256 ' EQI4
 mov r2, #0 ' reg ARG coni
 mov r3, ##@C_saak1a_66c68cf9_boxmt_L000249 ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 add SP, #8 ' CALL addrg
C_saak1d_66c68cf9_newbox_L000254_256
 mov r2, ##-2 ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 long @C_lua_setmetatable
 add SP, #4 ' CALL addrg
' C_saak1d_66c68cf9_newbox_L000254_255 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saak1f_66c68cf9_newbuffsize_L000260 ' <symbol:newbuffsize>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 if_ae jmp #\C_saak1f_66c68cf9_newbuffsize_L000260_262 ' GEU4
 mov r2, ##@C_saak1f_66c68cf9_newbuffsize_L000260_264_L000265 ' reg ARG ADDRG
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r3, r22 ' reg <- INDIRP4 reg
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 ...
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #\@C_saak1f_66c68cf9_newbuffsize_L000260_261 ' JUMPV addrg
C_saak1f_66c68cf9_newbuffsize_L000260_262
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 add r22, r21 ' ADDU (1)
 cmp r19, r22 wcz 
 if_ae jmp #\C_saak1f_66c68cf9_newbuffsize_L000260_266 ' GEU4
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r19, r22 ' ADDU
 add r19, r21 ' ADDU (3)
C_saak1f_66c68cf9_newbuffsize_L000260_266
 mov r0, r19 ' CVI, CVU or LOAD
C_saak1f_66c68cf9_newbuffsize_L000260_261
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saak1h_66c68cf9_prepbuffsize_L000268 ' <symbol:prepbuffsize>
 calld PA,#NEWF
 sub SP, #12
 calld PA,#PSHM
 long $f80000 ' save registers
 ...
 sub r22, r20 ' SUBU (1)
 cmp r22, r21 wcz 
 if_b jmp #\C_saak1h_66c68cf9_prepbuffsize_L000268_270 ' LTU4
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 ...
 jmp #\@C_saak1h_66c68cf9_prepbuffsize_L000268_269 ' JUMPV addrg
C_saak1h_66c68cf9_prepbuffsize_L000268_270
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak1f_66c68cf9_newbuffsize_L000260
 add SP, #4 ' CALL addrg
 mov RI, FP
 sub RI, #-(-12)
 ...
 cmp r22, r20 wz
 if_z jmp #\C_saak1h_66c68cf9_prepbuffsize_L000268_272 ' EQU4
 mov RI, FP
 sub RI, #-(-12)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov r3, r19 ' CVI, CVU or LOAD
 ...
 sub RI, #-(-16)
 wrlong r0, RI ' ASGNP4 addrli reg
 jmp #\@C_saak1h_66c68cf9_prepbuffsize_L000268_273 ' JUMPV addrg
C_saak1h_66c68cf9_prepbuffsize_L000268_272
 mov r2, ##-1 ' reg ARG con
 mov r3, r19 ' CVI, CVU or LOAD
 mov RI, FP
 sub RI, #-(-8)
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_saak1d_66c68cf9_newbox_L000254 ' CALL addrg
 mov r2, #1 ' reg ARG coni
 mov r3, r19 ' CVI, CVU or LOAD
 mov RI, FP
 sub RI, #-(-8)
 ...
 long @C_memcpy
 add SP, #8 ' CALL addrg
C_saak1h_66c68cf9_prepbuffsize_L000268_273
 mov r22, FP
 ...
 mov r0, r22 ' ADDI/P
 adds r0, r20 ' ADDI/P (3)
C_saak1h_66c68cf9_prepbuffsize_L000268_269
 calld PA,#POPM ' restore registers
 add SP, #12 ' framesize
 calld PA,#RETF
...
C_luaL__prepbuffsize ' <symbol:luaL_prepbuffsize>
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak1h_66c68cf9_prepbuffsize_L000268
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_luaL__unref_293 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_saak1i_66c68cf9_getF__L000296 ' <symbol:getF>
 calld PA,#NEWF
 calld PA,#PSHM
 long $ea0000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 cmps r22,  #0 wcz
 if_be jmp #\C_saak1i_66c68cf9_getF__L000296_298 ' LEI4
 rdlong r22, r17 ' reg <- INDIRI4 reg
 wrlong r22, r19 ' ASGNU4 reg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, r17 ' ASGNI4 reg reg
 jmp #\@C_saak1i_66c68cf9_getF__L000296_299 ' JUMPV addrg
C_saak1i_66c68cf9_getF__L000296_298
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 adds r22, #8 ' ADDP4 coni
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_saak1i_66c68cf9_getF__L000296_300 ' EQI4
 mov r0, ##0 ' RET con
 jmp #\@C_saak1i_66c68cf9_getF__L000296_297 ' JUMPV addrg
C_saak1i_66c68cf9_getF__L000296_300
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
...
C_saak1i_66c68cf9_getF__L000296_299
 mov r0, r17
 adds r0, #8 ' ADDP4 coni
C_saak1i_66c68cf9_getF__L000296_297
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saak1j_66c68cf9_errfile_L000302 ' <symbol:errfile>
 calld PA,#NEWF
 sub SP, #8
 calld PA,#PSHM
 long $e80000 ' save registers
 ...
 rdlong r3, RI ' reg ARG INDIR ADDRLi
 mov r4, r21 ' CVI, CVU or LOAD
 mov r5, ##@C_saak1j_66c68cf9_errfile_L000302_304_L000305 ' reg ARG ADDRG
 sub SP, #16 ' stack space for reg ARGs
 mov RI, r23
 wrlong RI, --PTRA ' stack ARG
 mov BC, #20 ' arg size, rpsize = 0, spsize = 20
 ...
 add SP, #4 ' CALL addrg
 mov r0, #6 ' reg <- coni
' C_saak1j_66c68cf9_errfile_L000302_303 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #8 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_saak1l_66c68cf9_skipB_O_M__L000306 ' <symbol:skipBOM>
 calld PA,#NEWF
 calld PA,#PSHM
 long $f80000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 mov r19, ##@C_saak1l_66c68cf9_skipB_O_M__L000306_308_L000309 ' reg <- addrg
 mov r22, #0 ' reg <- coni
 wrlong r22, r23 ' ASGNI4 reg reg
C_saak1l_66c68cf9_skipB_O_M__L000306_310
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 mov r22, ##-1 ' reg <- con
 cmps r21, r22 wz
 if_z jmp #\C_saak1l_66c68cf9_skipB_O_M__L000306_315 ' EQI4
 mov r22, r19 ' CVI, CVU or LOAD
 mov r19, r22
 adds r19, #1 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r21, r22 wz
 if_z jmp #\C_saak1l_66c68cf9_skipB_O_M__L000306_313 ' EQI4
C_saak1l_66c68cf9_skipB_O_M__L000306_315
 mov r0, r21 ' CVI, CVU or LOAD
 jmp #\@C_saak1l_66c68cf9_skipB_O_M__L000306_307 ' JUMPV addrg
C_saak1l_66c68cf9_skipB_O_M__L000306_313
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_saak1l_66c68cf9_skipB_O_M__L000306_311 ' (symbol refcount = 0)
 rdbyte r22, r19 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_saak1l_66c68cf9_skipB_O_M__L000306_310 ' NEI4
 mov r22, #0 ' reg <- coni
 wrlong r22, r23 ' ASGNI4 reg reg
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 ...
 long @C_getc ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
C_saak1l_66c68cf9_skipB_O_M__L000306_307
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saak1n_66c68cf9_skipcomment_L000316 ' <symbol:skipcomment>
 calld PA,#NEWF
 calld PA,#PSHM
 long $e80000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_saak1l_66c68cf9_skipB_O_M__L000306 ' CALL addrg
 wrlong r0, r21 ' ASGNI4 reg reg
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r19,  #35 wz
 if_nz jmp #\C_saak1n_66c68cf9_skipcomment_L000316_318 ' NEI4
C_saak1n_66c68cf9_skipcomment_L000316_320
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 long @C_getc ' CALL addrg
 mov r19, r0 ' CVI, CVU or LOAD
' C_saak1n_66c68cf9_skipcomment_L000316_321 ' (symbol refcount = 0)
 mov r22, ##-1 ' reg <- con
 cmps r19, r22 wz
 if_z jmp #\C_saak1n_66c68cf9_skipcomment_L000316_323 ' EQI4
 cmps r19,  #10 wz
 if_nz jmp #\C_saak1n_66c68cf9_skipcomment_L000316_320 ' NEI4
C_saak1n_66c68cf9_skipcomment_L000316_323
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 wrlong r0, r21 ' ASGNI4 reg reg
 mov r0, #1 ' reg <- coni
 jmp #\@C_saak1n_66c68cf9_skipcomment_L000316_317 ' JUMPV addrg
C_saak1n_66c68cf9_skipcomment_L000316_318
 mov r0, #0 ' reg <- coni
C_saak1n_66c68cf9_skipcomment_L000316_317
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_luaL__loadfilex_325
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak1j_66c68cf9_errfile_L000302
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' reg ARG ADDRL
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak1n_66c68cf9_skipcomment_L000316
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
...
C_luaL__loadfilex_356
 ...
 adds r4, ##(-524)
' reg ARG ADDRL
 mov r5, ##@C_saak1i_66c68cf9_getF__L000296 ' reg ARG ADDRG
 sub SP, #16 ' stack space for reg ARGs
 mov RI, r23
 wrlong RI, --PTRA ' stack ARG
 mov BC, #20 ' arg size, rpsize = 0, spsize = 20
...
C_luaL__loadfilex_324
 ...
 alignl ' align long
C_saak20_66c68cf9_getS__L000370 ' <symbol:getS>
 calld PA,#PSHM
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_saak20_66c68cf9_getS__L000370_372  ' NEU4
 mov r0, ##0 ' RET con
 jmp #\@C_saak20_66c68cf9_getS__L000370_371 ' JUMPV addrg
C_saak20_66c68cf9_getS__L000370_372
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
...
C_saak20_66c68cf9_getS__L000370_371
 calld PA,#POPM ' restore registers
 calld PA,#RETN
...
C_luaL__loadbufferx ' <symbol:luaL_loadbufferx>
 ...
 mov r5, ##@C_saak20_66c68cf9_getS__L000370 ' reg ARG ADDRG
 sub SP, #16 ' stack space for reg ARGs
 calld PA,#PSHF
...
' C_luaL__gsub_456 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_saak2d_66c68cf9_l_alloc_L000457 ' <symbol:l_alloc>
 calld PA,#NEWF
 sub SP, #4
 calld PA,#PSHM
 long $ea0000 ' save registers
 ...
 mov r17, r2 ' reg var <- reg arg
 cmp r17,  #0 wz
 if_nz jmp #\C_saak2d_66c68cf9_l_alloc_L000457_459  ' NEU4
 mov r2, r21 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_free ' CALL addrg
 mov r0, ##0 ' RET con
 jmp #\@C_saak2d_66c68cf9_l_alloc_L000457_458 ' JUMPV addrg
C_saak2d_66c68cf9_l_alloc_L000457_459
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, r21 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_z jmp #\C_saak2d_66c68cf9_l_alloc_L000457_461 ' EQU4
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_saak2d_66c68cf9_l_alloc_L000457_463  ' NEU4
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, #0 ' reg ARG coni
 mov RI, FP
 sub RI, #-(-8)
 ...
 long @C_memset
 add SP, #8 ' CALL addrg
 jmp #\@C_saak2d_66c68cf9_l_alloc_L000457_464 ' JUMPV addrg
C_saak2d_66c68cf9_l_alloc_L000457_463
 cmp r17, r19 wcz 
 if_be jmp #\C_saak2d_66c68cf9_l_alloc_L000457_465 ' LEU4
 mov r2, r17 ' SUBU
 sub r2, r19 ' SUBU (3)
 mov r3, #0 ' reg ARG coni
 mov r22, FP
 ...
 long @C_memset
 add SP, #8 ' CALL addrg
C_saak2d_66c68cf9_l_alloc_L000457_465
C_saak2d_66c68cf9_l_alloc_L000457_464
C_saak2d_66c68cf9_l_alloc_L000457_461
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r0, r22 ' reg <- INDIRP4 reg
C_saak2d_66c68cf9_l_alloc_L000457_458
 calld PA,#POPM ' restore registers
 add SP, #4 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_saak2e_66c68cf9_panic_L000467 ' <symbol:panic>
 calld PA,#NEWF
 calld PA,#PSHM
 long $e00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 ...
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_saak2e_66c68cf9_panic_L000467_469  ' NEU4
 mov r21, ##@C_saak2e_66c68cf9_panic_L000467_471_L000472 ' reg <- addrg
C_saak2e_66c68cf9_panic_L000467_469
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, ##@C_saak2e_66c68cf9_panic_L000467_473_L000474 ' reg ARG ADDRG
 ...
 mov r0, #0 ' reg <- coni
' C_saak2e_66c68cf9_panic_L000467_468 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saak2k_66c68cf9_checkcontrol_L000478 ' <symbol:checkcontrol>
 calld PA,#NEWF
 calld PA,#PSHM
 long $e80000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 mov r19, r2 ' reg var <- reg arg
 cmps r19,  #0 wz
 if_nz jmp #\C_saak2k_66c68cf9_checkcontrol_L000478_482 ' NEI4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r21, r22
 adds r21, #1 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #64 wz
 if_z jmp #\C_saak2k_66c68cf9_checkcontrol_L000478_480 ' EQI4
C_saak2k_66c68cf9_checkcontrol_L000478_482
 mov r0, #0 ' reg <- coni
 jmp #\@C_saak2k_66c68cf9_checkcontrol_L000478_479 ' JUMPV addrg
C_saak2k_66c68cf9_checkcontrol_L000478_480
 mov r2, ##@C_saak2k_66c68cf9_checkcontrol_L000478_485_L000486 ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_saak2k_66c68cf9_checkcontrol_L000478_483 ' NEI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov r3, ##@C_saak2h_66c68cf9_warnfoff_L000475 ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_lua_setwarnf
 add SP, #8 ' CALL addrg
 jmp #\@C_saak2k_66c68cf9_checkcontrol_L000478_484 ' JUMPV addrg
C_saak2k_66c68cf9_checkcontrol_L000478_483
 mov r2, ##@C_saak2k_66c68cf9_checkcontrol_L000478_489_L000490 ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_saak2k_66c68cf9_checkcontrol_L000478_487 ' NEI4
 mov r2, r23 ' CVI, CVU or LOAD
 mov r3, ##@C_saak2i_66c68cf9_warnfon_L000476 ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_lua_setwarnf
 add SP, #8 ' CALL addrg
C_saak2k_66c68cf9_checkcontrol_L000478_487
C_saak2k_66c68cf9_checkcontrol_L000478_484
 mov r0, #1 ' reg <- coni
C_saak2k_66c68cf9_checkcontrol_L000478_479
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saak2h_66c68cf9_warnfoff_L000475 ' <symbol:warnfoff>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak2k_66c68cf9_checkcontrol_L000478
 add SP, #8 ' CALL addrg
' C_saak2h_66c68cf9_warnfoff_L000475_491 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saak2j_66c68cf9_warnfcont_L000477 ' <symbol:warnfcont>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, ##@C_saak2j_66c68cf9_warnfcont_L000477_493_L000494 ' reg ARG ADDRG
 mov r4, ##@C___stderr ' reg ARG ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 long @C_fflush ' CALL addrg
 cmps r19,  #0 wz
 if_z jmp #\C_saak2j_66c68cf9_warnfcont_L000477_495 ' EQI4
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, ##@C_saak2j_66c68cf9_warnfcont_L000477 ' reg ARG ADDRG
 ...
 long @C_lua_setwarnf
 add SP, #8 ' CALL addrg
 jmp #\@C_saak2j_66c68cf9_warnfcont_L000477_496 ' JUMPV addrg
C_saak2j_66c68cf9_warnfcont_L000477_495
 mov r2, ##@C_saak2j_66c68cf9_warnfcont_L000477_497_L000498 ' reg ARG ADDRG
 mov r3, ##@C_saak2j_66c68cf9_warnfcont_L000477_493_L000494 ' reg ARG ADDRG
 mov r4, ##@C___stderr ' reg ARG ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 long @C_lua_setwarnf
 add SP, #8 ' CALL addrg
C_saak2j_66c68cf9_warnfcont_L000477_496
' C_saak2j_66c68cf9_warnfcont_L000477_492 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_saak2i_66c68cf9_warnfon_L000476 ' <symbol:warnfon>
 calld PA,#NEWF
 calld PA,#PSHM
 long $e80000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_z jmp #\C_saak2i_66c68cf9_warnfon_L000476_500 ' EQI4
 jmp #\@C_saak2i_66c68cf9_warnfon_L000476_499 ' JUMPV addrg
C_saak2i_66c68cf9_warnfon_L000476_500
 mov r2, ##@C_saak2i_66c68cf9_warnfon_L000476_502_L000503 ' reg ARG ADDRG
 mov r3, ##@C_saak2j_66c68cf9_warnfcont_L000477_493_L000494 ' reg ARG ADDRG
 mov r4, ##@C___stderr ' reg ARG ADDRG
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_saak2j_66c68cf9_warnfcont_L000477
 add SP, #8 ' CALL addrg
C_saak2i_66c68cf9_warnfon_L000476_499
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_luaL__newstate ' <symbol:luaL_newstate>
 ...
 mov r2, ##0 ' reg ARG con
 mov r3, ##@C_saak2d_66c68cf9_l_alloc_L000457 ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_lua_newstate
 ...
 mov r2, ##@C_saak2e_66c68cf9_panic_L000467 ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
...
C_luaL__checkversion__510_L000511 ' <symbol:510>
 ...
 alignl ' align long
C_saak2i_66c68cf9_warnfon_L000476_502_L000503 ' <symbol:502>
 byte 76
 byte 117
 byte 97
 byte 32
 ...
 alignl ' align long
C_saak2j_66c68cf9_warnfcont_L000477_497_L000498 ' <symbol:497>
 byte 10
 byte 0

 alignl ' align long
C_saak2j_66c68cf9_warnfcont_L000477_493_L000494 ' <symbol:493>
 byte 37
 byte 115
 byte 0

 alignl ' align long
C_saak2k_66c68cf9_checkcontrol_L000478_489_L000490 ' <symbol:489>
 byte 111
 byte 110
 byte 0

 alignl ' align long
C_saak2k_66c68cf9_checkcontrol_L000478_485_L000486 ' <symbol:485>
 byte 111
 byte 102
 byte 102
 byte 0
 ...
 alignl ' align long
C_saak2e_66c68cf9_panic_L000467_473_L000474 ' <symbol:473>
 byte 80
 byte 65
 byte 78
 byte 73
 ...
 alignl ' align long
C_saak2e_66c68cf9_panic_L000467_471_L000472 ' <symbol:471>
 byte 101
 byte 114
 byte 114
 byte 111
...
C_luaL__loadfilex_327_L000328 ' <symbol:327>
 ...
 alignl ' align long
C_saak1l_66c68cf9_skipB_O_M__L000306_308_L000309 ' <symbol:308>
 byte 239
 byte 187
 byte 191
 byte 0
 ...
 alignl ' align long
C_saak1j_66c68cf9_errfile_L000302_304_L000305 ' <symbol:304>
 byte 99
 byte 97
 byte 110
 byte 110
 ...
 alignl ' align long
C_saak1f_66c68cf9_newbuffsize_L000260_264_L000265 ' <symbol:264>
 byte 98
 byte 117
 byte 102
 byte 102
 ...
 alignl ' align long
C_saak1d_66c68cf9_newbox_L000254_258_L000259 ' <symbol:258>
 byte 95
 byte 85
 byte 66
 byte 79
 ...
 alignl ' align long
C_saak1c_66c68cf9_252_L000253 ' <symbol:252>
 byte 95
 byte 95
 byte 99
 byte 108
 ...
 alignl ' align long
C_saak1b_66c68cf9_250_L000251 ' <symbol:250>
 byte 95
 byte 95
 byte 103
 byte 99
 ...
 alignl ' align long
C_saak17_66c68cf9_resizebox_L000241_245_L000246 ' <symbol:245>
 byte 110
 byte 111
 byte 116
 byte 32
 ...
 alignl ' align long
C_saak15_66c68cf9_interror_L000228_232_L000233 ' <symbol:232>
 byte 110
 byte 117
 byte 109
 byte 98
...
C_luaL__traceback_72_L000073 ' <symbol:72>
 ...
 alignl ' align long
C_saak6_66c68cf9_pushfuncname_L000032_50_L000051 ' <symbol:50>
 byte 63
 byte 0

 alignl ' align long
C_saak6_66c68cf9_pushfuncname_L000032_48_L000049 ' <symbol:48>
 byte 102
 byte 117
 byte 110
 byte 99
 ...
 alignl ' align long
C_saak6_66c68cf9_pushfuncname_L000032_44_L000045 ' <symbol:44>
 byte 109
 byte 97
 byte 105
 byte 110
 ...
 alignl ' align long
C_saak6_66c68cf9_pushfuncname_L000032_40_L000041 ' <symbol:40>
 byte 37
 byte 115
 byte 32
 byte 39
 ...
 alignl ' align long
C_saak6_66c68cf9_pushfuncname_L000032_36_L000037 ' <symbol:36>
 byte 102
 byte 117
 byte 110
 byte 99
 ...
 alignl ' align long
C_saak2_66c68cf9_pushglobalfuncname_L000020_30_L000031 ' <symbol:30>
 byte 95
 byte 71
 byte 46
 byte 0
 ...
 alignl ' align long
C_saak2_66c68cf9_pushglobalfuncname_L000020_24_L000025 ' <symbol:24>
 byte 95
 byte 76
 byte 79
 byte 65
 ...
 alignl ' align long
C_saak2_66c68cf9_pushglobalfuncname_L000020_22_L000023 ' <symbol:22>
 byte 102
 byte 0

 alignl ' align long
C_saak_66c68cf9_findfield_L000004_18_L000019 ' <symbol:18>
 byte 46
 byte 0
