...
C_luaS__eqlngstr ' <symbol:luaS_eqlngstr>
 ...
 cmp r22, r20 wz
 if_z jmp #\C_luaS__eqlngstr_16 ' EQU4
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r19, r22 wz
 if_nz jmp #\C_luaS__eqlngstr_14  ' NEU4
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_luaS__eqlngstr_14 ' NEI4
C_luaS__eqlngstr_16
 mov r17, #1 ' reg <- coni
 jmp #\@C_luaS__eqlngstr_15 ' JUMPV addrg
C_luaS__eqlngstr_14
 mov r17, #0 ' reg <- coni
C_luaS__eqlngstr_15
...
C_luaS__hash ' <symbol:luaS_hash>
 ...
 jmp #\@C_luaS__hash_21 ' JUMPV addrg
C_luaS__hash_18
 mov r22, r23
...
C_luaS__hash_21
 cmp r3,  #0 wz
 if_nz jmp #\C_luaS__hash_18  ' NEU4
...
C_luaS__hashlongstr ' <symbol:luaS_hashlongstr>
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_luaS__hashlongstr_23 ' NEI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov RI, FP
...
' C_luaS__hashlongstr_22 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_smrk_66cc65e6_tablerehash_L000025 ' <symbol:tablerehash>
 calld PA,#PSHM
 long $fa0000 ' save registers
 mov r23, r3 ' CVI, CVU or LOAD
 jmp #\@C_smrk_66cc65e6_tablerehash_L000025_30 ' JUMPV addrg
C_smrk_66cc65e6_tablerehash_L000025_27
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 adds r22, r4 ' ADDI/P (1)
 mov r20, ##0 ' reg <- con
 wrlong r20, r22 ' ASGNP4 reg reg
' C_smrk_66cc65e6_tablerehash_L000025_28 ' (symbol refcount = 0)
 adds r23, #1 ' ADDI4 coni
C_smrk_66cc65e6_tablerehash_L000025_30
 cmps r23, r2 wcz
 if_b jmp #\C_smrk_66cc65e6_tablerehash_L000025_27 ' LTI4
 mov r23, #0 ' reg <- coni
 jmp #\@C_smrk_66cc65e6_tablerehash_L000025_34 ' JUMPV addrg
C_smrk_66cc65e6_tablerehash_L000025_31
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 adds r22, r4 ' ADDI/P (1)
 ...
 mov r20, ##0 ' reg <- con
 wrlong r20, r22 ' ASGNP4 reg reg
 jmp #\@C_smrk_66cc65e6_tablerehash_L000025_36 ' JUMPV addrg
C_smrk_66cc65e6_tablerehash_L000025_35
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
...
C_smrk_66cc65e6_tablerehash_L000025_36
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_smrk_66cc65e6_tablerehash_L000025_35  ' NEU4
' C_smrk_66cc65e6_tablerehash_L000025_32 ' (symbol refcount = 0)
 adds r23, #1 ' ADDI4 coni
C_smrk_66cc65e6_tablerehash_L000025_34
 cmps r23, r3 wcz
 if_b jmp #\C_smrk_66cc65e6_tablerehash_L000025_31 ' LTI4
' C_smrk_66cc65e6_tablerehash_L000025_26 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETN
...
C_luaS__resize ' <symbol:luaS_resize>
 ...
 cmps r21, r19 wcz
 if_ae jmp #\C_luaS__resize_39 ' GEI4
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_smrk_66cc65e6_tablerehash_L000025
 add SP, #8 ' CALL addrg
C_luaS__resize_39
 mov r22, r21 ' CVI, CVU or LOAD
 mov r2, r22
 ...
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_luaS__resize_41  ' NEU4
 cmps r21, r19 wcz
 if_ae jmp #\C_luaS__resize_42 ' GEI4
 mov r2, r19 ' CVI, CVU or LOAD
 ...
 long @C_smrk_66cc65e6_tablerehash_L000025
 add SP, #8 ' CALL addrg
 jmp #\@C_luaS__resize_42 ' JUMPV addrg
C_luaS__resize_41
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 reg
 ...
 cmps r21, r19 wcz
 if_be jmp #\C_luaS__resize_45 ' LEI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov r3, r19 ' CVI, CVU or LOAD
 mov RI, FP
 sub RI, #-(-8)
...
C_luaS__clearcache_52
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_luaS__clearcache_56 ' EQI4
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 mov r20, r21
 shl r20, #3 ' LSHI4 coni
...
' C_luaS__clearcache_53 ' (symbol refcount = 0)
 adds r23, #1 ' ADDI4 coni
 cmps r23,  #2 wcz
 if_b jmp #\C_luaS__clearcache_52 ' LTI4
' C_luaS__clearcache_49 ' (symbol refcount = 0)
 adds r21, #1 ' ADDI4 coni
 cmps r21,  #53 wcz
 if_b jmp #\C_luaS__clearcache_48 ' LTI4
...
C_luaS__init ' <symbol:luaS_init>
 ...
 mov r3, ##@C_luaS__init_59_L000060 ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
...
' C_luaS__init_66 ' (symbol refcount = 0)
 adds r21, #1 ' ADDI4 coni
 cmps r21,  #2 wcz
 if_b jmp #\C_luaS__init_65 ' LTI4
' C_luaS__init_62 ' (symbol refcount = 0)
 adds r17, #1 ' ADDI4 coni
 cmps r17,  #53 wcz
 if_b jmp #\C_luaS__init_61 ' LTI4
' C_luaS__init_58 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_smrk2_66cc65e6_createstrobj_L000069 ' <symbol:createstrobj>
 calld PA,#NEWF
 sub SP, #8
 calld PA,#PSHM
...
' C_smrk2_66cc65e6_createstrobj_L000069_70 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #8 ' framesize
 calld PA,#RETF
...
C_luaS__createlngstrobj ' <symbol:luaS_createlngstrobj>
 ...
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_smrk2_66cc65e6_createstrobj_L000069
 add SP, #12 ' CALL addrg
...
C_luaS__remove ' <symbol:luaS_remove>
 ...
 jmp #\@C_luaS__remove_74 ' JUMPV addrg
C_luaS__remove_73
...
C_luaS__remove_74
 ...
 cmp r22, r20 wz
 if_nz jmp #\C_luaS__remove_73  ' NEU4
 rdlong r22, r23 ' reg <- INDIRP4 reg
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
...
' C_luaS__remove_72 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_smrk3_66cc65e6_growstrtab_L000076 ' <symbol:growstrtab>
 calld PA,#NEWF
 calld PA,#PSHM
 long $f00000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 cmps r22, r20 wz
 if_nz jmp #\C_smrk3_66cc65e6_growstrtab_L000076_78 ' NEI4
 ...
 mov r20, ##2147483647 ' reg <- con
 cmps r22, r20 wz
 if_nz jmp #\C_smrk3_66cc65e6_growstrtab_L000076_80 ' NEI4
 ...
 long @C_luaD__throw
 add SP, #4 ' CALL addrg
C_smrk3_66cc65e6_growstrtab_L000076_80
C_smrk3_66cc65e6_growstrtab_L000076_78
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, ##536870911 ' reg <- con
 cmps r22, r20 wcz
 if_a jmp #\C_smrk3_66cc65e6_growstrtab_L000076_82 ' GTI4
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r2, r22
 ...
 long @C_luaS__resize
 add SP, #4 ' CALL addrg
C_smrk3_66cc65e6_growstrtab_L000076_82
' C_smrk3_66cc65e6_growstrtab_L000076_77 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF


 alignl ' align long
C_smrk4_66cc65e6_internshrstr_L000084 ' <symbol:internshrstr>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 jmp #\@C_smrk4_66cc65e6_internshrstr_L000084_89 ' JUMPV addrg
C_smrk4_66cc65e6_internshrstr_L000084_86
 mov r22, r17
 adds r22, #7 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmp r19, r22 wz
 if_nz jmp #\C_smrk4_66cc65e6_internshrstr_L000084_90  ' NEU4
 mov r22, #1 ' reg <- coni
 #ifndef NO_INTERRUPTS
  stalli
 #endif
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_smrk4_66cc65e6_internshrstr_L000084_90 ' NEI4
 mov r22, r17
 adds r22, #5 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 mov r20, r15
 ...
 and r22, r20 ' BANDI/U (1)
 cmps r22,  #0 wz
 if_z jmp #\C_smrk4_66cc65e6_internshrstr_L000084_92 ' EQI4
 mov r22, r17
 adds r22, #5 ' ADDP4 coni
 rdbyte r20, r22 ' reg <- CVUI4 INDIRU1 reg
 xor r20, #24 ' BXORI4 coni
 wrbyte r20, r22 ' ASGNU1 reg reg
C_smrk4_66cc65e6_internshrstr_L000084_92
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #\@C_smrk4_66cc65e6_internshrstr_L000084_85 ' JUMPV addrg
C_smrk4_66cc65e6_internshrstr_L000084_90
' C_smrk4_66cc65e6_internshrstr_L000084_87 ' (symbol refcount = 0)
 mov r22, r17
 adds r22, #12 ' ADDP4 coni
 rdlong r17, r22 ' reg <- INDIRP4 reg
C_smrk4_66cc65e6_internshrstr_L000084_89
 mov r22, r17 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_smrk4_66cc65e6_internshrstr_L000084_86  ' NEU4
 mov r22, r13
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, r13
 ...
 rdlong r20, r20 ' reg <- INDIRI4 reg
 cmps r22, r20 wcz
 if_b jmp #\C_smrk4_66cc65e6_internshrstr_L000084_94 ' LTI4
 mov r2, r13 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_smrk3_66cc65e6_growstrtab_L000076
 add SP, #4 ' CALL addrg
 mov r22, r13
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 mov r11, r22 ' ADDI/P
 adds r11, r20 ' ADDI/P (3)
C_smrk4_66cc65e6_internshrstr_L000084_94
 ...
 wrlong r20, r22 ' ASGNI4 reg reg
 mov r0, r17 ' CVI, CVU or LOAD
C_smrk4_66cc65e6_internshrstr_L000084_85
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_luaS__newlstr ' <symbol:luaS_newlstr>
 ...
 mov r19, r2 ' reg var <- reg arg
 cmp r19,  #40 wcz 
 if_a jmp #\C_luaS__newlstr_97 ' GTU4
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_smrk4_66cc65e6_internshrstr_L000084
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #\@C_luaS__newlstr_96 ' JUMPV addrg
C_luaS__newlstr_97
 mov r22, ##$7fffffeb ' reg <- con
 cmp r19, r22 wcz 
 if_b jmp #\C_luaS__newlstr_99 ' LTU4
...
C_luaS__new_102
 ...
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_luaS__new_106 ' NEI4
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 adds r22, r17 ' ADDI/P (1)
 rdlong r0, r22 ' reg <- INDIRP4 reg
 jmp #\@C_luaS__new_101 ' JUMPV addrg
C_luaS__new_106
' C_luaS__new_103 ' (symbol refcount = 0)
 adds r19, #1 ' ADDI4 coni
 cmps r19,  #2 wcz
 if_b jmp #\C_luaS__new_102 ' LTI4
 mov r19, #1 ' reg <- coni
C_luaS__new_108
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
...
C_luaS__newudata ' <symbol:luaS_newudata>
 ...
 mov r19, r2 ' reg var <- reg arg
 cmps r19,  #0 wz
 if_nz jmp #\C_luaS__newudata_116 ' NEI4
 mov r13, #16 ' reg <- coni
 jmp #\@C_luaS__newudata_117 ' JUMPV addrg
...
C_luaS__newudata_117
 ...
 sub r22, r13 ' SUBU (1)
 cmp r21, r22 wcz 
 if_be jmp #\C_luaS__newudata_113 ' LEU4
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_luaM__toobig ' CALL addrg
C_luaS__newudata_113
 cmps r19,  #0 wz
 if_nz jmp #\C_luaS__newudata_119 ' NEI4
 mov r11, #16 ' reg <- coni
 jmp #\@C_luaS__newudata_120 ' JUMPV addrg
...
C_luaS__newudata_120
 ...
 wrlong r20, r22 ' ASGNP4 reg reg
 mov r17, #0 ' reg <- coni
 jmp #\@C_luaS__newudata_124 ' JUMPV addrg
...
C_luaS__newudata_124
 cmps r17, r19 wcz
 if_b jmp #\C_luaS__newudata_121 ' LTI4
 mov r0, r15 ' CVI, CVU or LOAD
