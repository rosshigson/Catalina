...
DAT ' code segment
 ...
 alignl ' align long
C_s1jo_68805064_index2value_L000013 ' <symbol:index2value>
 calld PA,#NEWF
 sub SP, #8
 calld PA,#PSHM
 ...
 cmps r2,  #0 wcz
 if_be jmp #\C_s1jo_68805064_index2value_L000013_15 ' LEI4
 mov r22, r2
 ...
 rdlong r20, r20 ' reg <- INDIRP4 reg
 cmp r22, r20 wcz 
 if_b jmp #\C_s1jo_68805064_index2value_L000013_17 ' LTU4
 mov r22, r3
 adds r22, #16 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r0, r22
 adds r0, #44 ' ADDP4 coni
 jmp #\@C_s1jo_68805064_index2value_L000013_14 ' JUMPV addrg
C_s1jo_68805064_index2value_L000013_17
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r0, r22 ' reg <- INDIRP4 reg
 jmp #\@C_s1jo_68805064_index2value_L000013_14 ' JUMPV addrg
C_s1jo_68805064_index2value_L000013_15
 mov r22, ##-1001000 ' reg <- con
 cmps r2, r22 wcz
 if_be jmp #\C_s1jo_68805064_index2value_L000013_19 ' LEI4
 mov r22, r2
 shl r22, #3 ' LSHI4 coni
 mov r20, r3
 adds r20, #12 ' ADDP4 coni
 ...
 jmp #\@C_s1jo_68805064_index2value_L000013_14 ' JUMPV addrg
C_s1jo_68805064_index2value_L000013_19
 mov r22, ##-1001000 ' reg <- con
 cmps r2, r22 wz
 if_nz jmp #\C_s1jo_68805064_index2value_L000013_21 ' NEI4
 mov r22, r3
 adds r22, #16 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r0, r22
 ...
 jmp #\@C_s1jo_68805064_index2value_L000013_14 ' JUMPV addrg
C_s1jo_68805064_index2value_L000013_21
 mov r22, ##-1001000 ' reg <- con
 subs r2, r22
 neg r2, r2 ' SUBI/P (2)
 mov r22, FP
 ...
 cmps r22,  #102 wz
 if_nz jmp #\C_s1jo_68805064_index2value_L000013_23 ' NEI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 reg
 rdlong r22, r22 ' reg <- INDIRP4 reg
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r2, r22 wcz
 if_a jmp #\C_s1jo_68805064_index2value_L000013_26 ' GTI4
 mov r22, r2
 shl r22, #3 ' LSHI4 coni
 ...
 jmp #\@C_s1jo_68805064_index2value_L000013_27 ' JUMPV addrg
C_s1jo_68805064_index2value_L000013_26
 mov r22, r3
 adds r22, #16 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r23, r22
 adds r23, #44 ' ADDP4 coni
C_s1jo_68805064_index2value_L000013_27
 mov r0, r23 ' CVI, CVU or LOAD
 jmp #\@C_s1jo_68805064_index2value_L000013_14 ' JUMPV addrg
C_s1jo_68805064_index2value_L000013_23
 mov r22, r3
 adds r22, #16 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r0, r22
 adds r0, #44 ' ADDP4 coni
C_s1jo_68805064_index2value_L000013_14
 ...
 alignl ' align long
C_s1jo1_68805064_index2stack_L000028 ' <symbol:index2stack>
 calld PA,#NEWF
 sub SP, #8
 calld PA,#PSHM
 ...
 wrlong r22, RI ' ASGNP4 addrli reg
 cmps r2,  #0 wcz
 if_be jmp #\C_s1jo1_68805064_index2stack_L000028_30 ' LEI4
 mov r22, r2
 shl r22, #3 ' LSHI4 coni
 mov r20, FP
 sub r20, #-(-8) ' reg <- addrli
 ...
 sub r22, #-(-12) ' reg <- addrli
 rdlong r0, r22 ' reg <- INDIRP4 reg
 jmp #\@C_s1jo1_68805064_index2stack_L000028_29 ' JUMPV addrg
C_s1jo1_68805064_index2stack_L000028_30
 mov r22, r2
 shl r22, #3 ' LSHI4 coni
 mov r20, r3
 adds r20, #12 ' ADDP4 coni
 ...
 mov r0, r22 ' ADDI/P
 adds r0, r20 ' ADDI/P (3)
C_s1jo1_68805064_index2stack_L000028_29
 calld PA,#POPM ' restore registers
 add SP, #8 ' framesize
 calld PA,#RETF
...
C_lua_closeslot ' <symbol:lua_closeslot>
 ...
 calld PA,#CALA
 long @C_s1jo1_68805064_index2stack_L000028
 add SP, #4 ' CALL addrg
 mov r19, r0 ' CVI, CVU or LOAD
 mov r2, #0 ' reg ARG coni
 mov r3, ##-1 ' reg ARG con
...
' C_lua_closeslot_65 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s1jo3_68805064_reverse_L000066 ' <symbol:reverse>
 calld PA,#NEWF
 sub SP, #8
 calld PA,#PSHM
 long $f00000 ' save registers
 jmp #\@C_s1jo3_68805064_reverse_L000066_71 ' JUMPV addrg
C_s1jo3_68805064_reverse_L000066_68
 mov r23, FP
 ...
 rdbyte r20, r20 ' reg <- INDIRU1 reg
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_s1jo3_68805064_reverse_L000066_69 ' (symbol refcount = 0)
 adds r3, #8 ' ADDP4 coni
 mov r22, ##-8 ' reg <- con
 adds r2, r22 ' ADDI/P (1)
C_s1jo3_68805064_reverse_L000066_71
 mov r22, r3 ' CVI, CVU or LOAD
 mov r20, r2 ' CVI, CVU or LOAD
 cmp r22, r20 wcz 
 if_b jmp #\C_s1jo3_68805064_reverse_L000066_68 ' LTU4
' C_s1jo3_68805064_reverse_L000066_67 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #8 ' framesize
 calld PA,#RETF
...
C_lua_rotate_75
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_s1jo3_68805064_reverse_L000066
 add SP, #8 ' CALL addrg
...
C_lua_copy ' <symbol:lua_copy>
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_s1jo_68805064_index2value_L000013
 add SP, #4 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
...
C_lua_tocfunction_175
 ...
 alignl ' align long
C_s1jo5_68805064_touserdata_L000180 ' <symbol:touserdata>
 calld PA,#PSHM
 ...
 mov r22, #2 ' reg <- coni
 cmps r23, r22 wz
 if_z jmp #\C_s1jo5_68805064_touserdata_L000180_189 ' EQI4
 cmps r23, r22 wcz
 if_b jmp #\C_s1jo5_68805064_touserdata_L000180_182 ' LTI4
' C_s1jo5_68805064_touserdata_L000180_190 ' (symbol refcount = 0)
 cmps r23,  #7 wz
 if_z jmp #\C_s1jo5_68805064_touserdata_L000180_185 ' EQI4
 jmp #\@C_s1jo5_68805064_touserdata_L000180_182 ' JUMPV addrg
C_s1jo5_68805064_touserdata_L000180_185
 rdlong r22, r2 ' reg <- INDIRP4 reg
 adds r22, #6 ' ADDP4 coni
 rdword r22, r22 ' reg <- CVUI4 INDIRU2 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_s1jo5_68805064_touserdata_L000180_187 ' NEI4
 mov r21, #16 ' reg <- coni
 jmp #\@C_s1jo5_68805064_touserdata_L000180_188 ' JUMPV addrg
C_s1jo5_68805064_touserdata_L000180_187
 rdlong r22, r2 ' reg <- INDIRP4 reg
 adds r22, #6 ' ADDP4 coni
 rdword r22, r22 ' reg <- CVUI4 INDIRU2 reg
...
C_s1jo5_68805064_touserdata_L000180_188
 rdlong r22, r2 ' reg <- INDIRP4 reg
 mov r0, r21 ' ADDI/P
 adds r0, r22 ' ADDI/P (3)
 jmp #\@C_s1jo5_68805064_touserdata_L000180_181 ' JUMPV addrg
C_s1jo5_68805064_touserdata_L000180_189
 rdlong r0, r2 ' reg <- INDIRP4 reg
 jmp #\@C_s1jo5_68805064_touserdata_L000180_181 ' JUMPV addrg
C_s1jo5_68805064_touserdata_L000180_182
 mov r0, ##0 ' RET con
C_s1jo5_68805064_touserdata_L000180_181
 calld PA,#POPM ' restore registers
 calld PA,#RETN
...
C_lua_touserdata ' <symbol:lua_touserdata>
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 calld PA,#CALA
 long @C_s1jo5_68805064_touserdata_L000180 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_lua_pushthread_241 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s1jo7_68805064_auxgetstr_L000245 ' <symbol:auxgetstr>
 calld PA,#NEWF
 sub SP, #12
 calld PA,#PSHM
 long $faa000 ' save registers
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #69 wz
 if_z jmp #\C_s1jo7_68805064_auxgetstr_L000245_251 ' EQI4
 mov r17, ##0 ' reg <- con
 mov r15, #0 ' reg <- coni
 jmp #\@C_s1jo7_68805064_auxgetstr_L000245_252 ' JUMPV addrg
C_s1jo7_68805064_auxgetstr_L000245_251
 mov RI, FP
 sub RI, #-(-8)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 ...
 and r22, #15 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_s1jo7_68805064_auxgetstr_L000245_253 ' EQI4
 mov r13, #1 ' reg <- coni
 jmp #\@C_s1jo7_68805064_auxgetstr_L000245_254 ' JUMPV addrg
C_s1jo7_68805064_auxgetstr_L000245_253
 mov r13, #0 ' reg <- coni
C_s1jo7_68805064_auxgetstr_L000245_254
 mov r15, r13 ' CVI, CVU or LOAD
C_s1jo7_68805064_auxgetstr_L000245_252
 cmps r15,  #0 wz
 if_z jmp #\C_s1jo7_68805064_auxgetstr_L000245_247 ' EQI4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 adds r20, #8 ' ADDP4 coni
 wrlong r20, r22 ' ASGNP4 reg reg
 jmp #\@C_s1jo7_68805064_auxgetstr_L000245_248 ' JUMPV addrg
C_s1jo7_68805064_auxgetstr_L000245_247
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 add SP, #16 ' CALL addrg
C_s1jo7_68805064_auxgetstr_L000245_248
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r20, ##-4 ' reg <- con
...
' C_s1jo7_68805064_auxgetstr_L000245_246 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #12 ' framesize
 calld PA,#RETF
...
C_lua_getglobal ' <symbol:lua_getglobal>
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_s1jo7_68805064_auxgetstr_L000245
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_lua_geti_266 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s1jo8_68805064_finishrawget_L000278 ' <symbol:finishrawget>
 calld PA,#NEWF
 sub SP, #8
 calld PA,#PSHM
 long $500000 ' save registers
 ...
 and r22, #15 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_s1jo8_68805064_finishrawget_L000278_280 ' NEI4
 mov r22, r3
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 adds r22, #4 ' ADDP4 coni
 mov r20, #0 ' reg <- coni
 wrbyte r20, r22 ' ASGNU1 reg reg
 jmp #\@C_s1jo8_68805064_finishrawget_L000278_281 ' JUMPV addrg
C_s1jo8_68805064_finishrawget_L000278_280
 mov r22, r3
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 rdbyte r20, r20 ' reg <- INDIRU1 reg
 wrbyte r20, r22 ' ASGNU1 reg reg
C_s1jo8_68805064_finishrawget_L000278_281
 mov r22, r3
 adds r22, #12 ' ADDP4 coni
 rdlong r20, r22 ' reg <- INDIRP4 reg
 adds r20, #8 ' ADDP4 coni
 ...
 mov r0, r22
 and r0, #15 ' BANDI4 coni
' C_s1jo8_68805064_finishrawget_L000278_279 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #8 ' framesize
 calld PA,#RETF
 ...
 alignl ' align long
C_s1jo9_68805064_gettable_L000282 ' <symbol:gettable>
 calld PA,#NEWF
 sub SP, #4
 calld PA,#PSHM
 long $e00000 ' save registers
 ...
 rdlong r22, r22 ' reg <- INDIRP4 reg
 rdlong r0, r22 ' reg <- INDIRP4 reg
' C_s1jo9_68805064_gettable_L000282_283 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #4 ' framesize
 calld PA,#RETF
...
C_lua_rawget ' <symbol:lua_rawget>
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_s1jo9_68805064_gettable_L000282
 add SP, #4 ' CALL addrg
 mov RI, FP
 sub RI, #-(-8)
 wrlong r0, RI ' ASGNP4 addrli reg
 ...
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_s1jo8_68805064_finishrawget_L000278
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_lua_getiuservalue_301 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s1joa_68805064_auxsetstr_L000305 ' <symbol:auxsetstr>
 calld PA,#NEWF
 sub SP, #12
 calld PA,#PSHM
 long $fea000 ' save registers
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #69 wz
 if_z jmp #\C_s1joa_68805064_auxsetstr_L000305_311 ' EQI4
 mov r17, ##0 ' reg <- con
 mov r15, #0 ' reg <- coni
 jmp #\@C_s1joa_68805064_auxsetstr_L000305_312 ' JUMPV addrg
C_s1joa_68805064_auxsetstr_L000305_311
 mov RI, FP
 sub RI, #-(-8)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 rdlong r3, r21 ' reg <- INDIRP4 reg
 ...
 and r22, #15 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_s1joa_68805064_auxsetstr_L000305_313 ' EQI4
 mov r13, #1 ' reg <- coni
 jmp #\@C_s1joa_68805064_auxsetstr_L000305_314 ' JUMPV addrg
C_s1joa_68805064_auxsetstr_L000305_313
 mov r13, #0 ' reg <- coni
C_s1joa_68805064_auxsetstr_L000305_314
 mov r15, r13 ' CVI, CVU or LOAD
C_s1joa_68805064_auxsetstr_L000305_312
 cmps r15,  #0 wz
 if_z jmp #\C_s1joa_68805064_auxsetstr_L000305_307 ' EQI4
 mov RI, FP
 sub RI, #-(-12)
 wrlong r17, RI ' ASGNP4 addrli reg
 mov r22, r23
 ...
 cmps r18, r20 wz
 if_z jmp #\C_s1joa_68805064_auxsetstr_L000305_316 ' EQI4
 ...
 add SP, #4 ' CALL addrg
 jmp #\@C_s1joa_68805064_auxsetstr_L000305_316 ' JUMPV addrg
C_s1joa_68805064_auxsetstr_L000305_316
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r20, r22 ' reg <- INDIRP4 reg
 mov r18, ##-8 ' reg <- con
 adds r20, r18 ' ADDI/P (1)
 wrlong r20, r22 ' ASGNP4 reg reg
 jmp #\@C_s1joa_68805064_auxsetstr_L000305_308 ' JUMPV addrg
C_s1joa_68805064_auxsetstr_L000305_307
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 adds r20, r18 ' ADDI/P (1)
 wrlong r20, r22 ' ASGNP4 reg reg
C_s1joa_68805064_auxsetstr_L000305_308
' C_s1joa_68805064_auxsetstr_L000305_306 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 add SP, #12 ' framesize
 calld PA,#RETF
...
C_lua_setglobal ' <symbol:lua_setglobal>
 ...
 sub SP, #8 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_s1joa_68805064_auxsetstr_L000305
 add SP, #8 ' CALL addrg
...
' C_lua_seti_330 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s1job_68805064_aux_rawset_L000344 ' <symbol:aux_rawset>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 and r18, #64 ' BANDI4 coni
 cmps r18, r20 wz
 if_z jmp #\C_s1job_68805064_aux_rawset_L000344_347 ' EQI4
 mov r18, r15
 adds r18, #5 ' ADDP4 coni
 rdbyte r18, r18 ' reg <- CVUI4 INDIRU1 reg
 and r18, #32 ' BANDI4 coni
 ...
 long @C_luaC__barrierback_
 add SP, #4 ' CALL addrg
 jmp #\@C_s1job_68805064_aux_rawset_L000344_347 ' JUMPV addrg
C_s1job_68805064_aux_rawset_L000344_347
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r20, r22 ' reg <- INDIRP4 reg
 mov r18, r17
 ...
 subs r20, r18 ' SUBI/P (1)
 wrlong r20, r22 ' ASGNP4 reg reg
' C_s1job_68805064_aux_rawset_L000344_345 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_lua_rawset ' <symbol:lua_rawset>
 ...
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_s1job_68805064_aux_rawset_L000344
 add SP, #12 ' CALL addrg
...
' C_lua_callk_374 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s1joc_68805064_f_call_L000379 ' <symbol:f_call>
 calld PA,#NEWF
 calld PA,#PSHM
 long $e80000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 long @C_luaD__callnoyield
 add SP, #8 ' CALL addrg
' C_s1joc_68805064_f_call_L000379_380 ' (symbol refcount = 0)
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_lua_pcallk_386
 ...
 mov r4, FP
 sub r4, #-(-12) ' reg ARG ADDRLi
 mov r5, ##@C_s1joc_68805064_f_call_L000379 ' reg ARG ADDRG
 sub SP, #16 ' stack space for reg ARGs
 mov RI, r22
 wrlong RI, --PTRA ' stack ARG
 mov BC, #20 ' arg size, rpsize = 0, spsize = 20
...
' C_lua_newuserdatauv_473 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s1jog_68805064_aux_upvalue_L000479 ' <symbol:aux_upvalue>
 calld PA,#NEWF
 sub SP, #12
 calld PA,#PSHM
 long $f00000 ' save registers
 ...
 mov r22, #6 ' reg <- coni
 cmps r23, r22 wz
 if_z jmp #\C_s1jog_68805064_aux_upvalue_L000479_489 ' EQI4
 cmps r23, r22 wcz
 if_b jmp #\C_s1jog_68805064_aux_upvalue_L000479_481 ' LTI4
' C_s1jog_68805064_aux_upvalue_L000479_499 ' (symbol refcount = 0)
 cmps r23,  #38 wz
 if_z jmp #\C_s1jog_68805064_aux_upvalue_L000479_484 ' EQI4
 jmp #\@C_s1jog_68805064_aux_upvalue_L000479_481 ' JUMPV addrg
C_s1jog_68805064_aux_upvalue_L000479_484
 ...
 rdbyte r20, r20 ' reg <- CVUI4 INDIRU1 reg
 cmp r22, r20 wcz 
 if_b jmp #\C_s1jog_68805064_aux_upvalue_L000479_485 ' LTU4
 mov r0, ##0 ' RET con
 jmp #\@C_s1jog_68805064_aux_upvalue_L000479_480 ' JUMPV addrg
C_s1jog_68805064_aux_upvalue_L000479_485
 mov r22, r4
 shl r22, #3 ' LSHI4 coni
 subs r22, #8 ' SUBI4 coni
 mov r20, FP
 ...
 mov r22, r2 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_z jmp #\C_s1jog_68805064_aux_upvalue_L000479_487 ' EQU4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 reg
 wrlong r22, r2 ' ASGNP4 reg reg
C_s1jog_68805064_aux_upvalue_L000479_487
 mov r0, ##@C_lua_pushlstring_210_L000211 ' reg <- addrg
 jmp #\@C_s1jog_68805064_aux_upvalue_L000479_480 ' JUMPV addrg
C_s1jog_68805064_aux_upvalue_L000479_489
 rdlong r22, r5 ' reg <- INDIRP4 reg
 mov RI, FP
 sub RI, #-(-8)
 wrlong r22, RI ' ASGNP4 addrli reg
 ...
 rdlong r20, r20 ' reg <- INDIRI4 reg
 cmp r22, r20 wcz 
 if_b jmp #\C_s1jog_68805064_aux_upvalue_L000479_490 ' LTU4
 mov r0, ##0 ' RET con
 jmp #\@C_s1jog_68805064_aux_upvalue_L000479_480 ' JUMPV addrg
C_s1jog_68805064_aux_upvalue_L000479_490
 mov r22, r4
 shl r22, #2 ' LSHI4 coni
 ...
 mov r22, r2 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_z jmp #\C_s1jog_68805064_aux_upvalue_L000479_492 ' EQU4
 mov r22, r4
 shl r22, #2 ' LSHI4 coni
 subs r22, #4 ' SUBI4 coni
 mov r20, FP
 ...
 rdlong r22, r22 ' reg <- INDIRP4 reg
 wrlong r22, r2 ' ASGNP4 reg reg
C_s1jog_68805064_aux_upvalue_L000479_492
 mov r22, r4
 shl r22, #3 ' LSHI4 coni
 subs r22, #8 ' SUBI4 coni
 mov r20, FP
 ...
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_s1jog_68805064_aux_upvalue_L000479_497  ' NEU4
 mov r21, ##@C_s1jog_68805064_aux_upvalue_L000479_494_L000495 ' reg <- addrg
 jmp #\@C_s1jog_68805064_aux_upvalue_L000479_498 ' JUMPV addrg
C_s1jog_68805064_aux_upvalue_L000479_497
 mov r22, FP
 sub r22, #-(-16) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r21, r22
 adds r21, #16 ' ADDP4 coni
C_s1jog_68805064_aux_upvalue_L000479_498
 mov r0, r21 ' CVI, CVU or LOAD
 jmp #\@C_s1jog_68805064_aux_upvalue_L000479_480 ' JUMPV addrg
C_s1jog_68805064_aux_upvalue_L000479_481
 mov r0, ##0 ' RET con
C_s1jog_68805064_aux_upvalue_L000479_480
 calld PA,#POPM ' restore registers
 add SP, #12 ' framesize
 calld PA,#RETF
...
C_lua_getupvalue ' <symbol:lua_getupvalue>
 ...
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_s1jog_68805064_aux_upvalue_L000479
 add SP, #12 ' CALL addrg
 mov r17, r0 ' CVI, CVU or LOAD
 mov r22, r17 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
...
DAT ' const data segment
 ...
 alignl ' align long
C_s1joi_68805064_getupvalref_L000508_nullup_L000511 ' <symbol:nullup>
 long $0
...
DAT ' code segment
 ...
 alignl ' align long
C_s1joi_68805064_getupvalref_L000508 ' <symbol:getupvalref>
 calld PA,#NEWF
 sub SP, #4
 calld PA,#PSHM
 long $fa8000 ' save registers
 ...
 mov r22, r17 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_z jmp #\C_s1joi_68805064_getupvalref_L000508_512 ' EQU4
 wrlong r15, r17 ' ASGNP4 reg reg
C_s1joi_68805064_getupvalref_L000508_512
 mov r22, #1 ' reg <- coni
 cmps r22, r19 wcz
 if_a jmp #\C_s1joi_68805064_getupvalref_L000508_514 ' GTI4
 mov r22, r15
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 adds r22, #12 ' ADDP4 coni
 ...
 mov r0, r22 ' ADDI/P
 adds r0, r20 ' ADDI/P (3)
 jmp #\@C_s1joi_68805064_getupvalref_L000508_509 ' JUMPV addrg
C_s1joi_68805064_getupvalref_L000508_514
 mov r0, ##@C_s1joi_68805064_getupvalref_L000508_nullup_L000511 ' reg <- addrg
C_s1joi_68805064_getupvalref_L000508_509
 calld PA,#POPM ' restore registers
 add SP, #4 ' framesize
 calld PA,#RETF
...
C_lua_upvalueid_520
 ...
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_s1joi_68805064_getupvalref_L000508
 add SP, #12 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 rdlong r0, r22 ' reg <- INDIRP4 reg
...
DAT ' const data segment
 ...
 alignl ' align long
C_s1jog_68805064_aux_upvalue_L000479_494_L000495 ' <symbol:494>
 byte 40
 byte 110
 byte 111
 byte 32
