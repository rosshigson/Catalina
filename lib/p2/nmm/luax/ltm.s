...
DAT ' const data segment
 ...
 alignl ' align long
C_s10tk_68fd7895_udatatypename_L000013 ' <symbol:udatatypename>
 byte 117
 byte 115
 byte 101
 byte 114
...
C_luaT__typenames_ ' <symbol:luaT_typenames_>
 long @C_s10tk1_68fd7895_14_L000015
 long @C_s10tk2_68fd7895_16_L000017
 long @C_s10tk3_68fd7895_18_L000019
 long @C_s10tk_68fd7895_udatatypename_L000013
 long @C_s10tk4_68fd7895_20_L000021
 long @C_s10tk5_68fd7895_22_L000023
 long @C_s10tk6_68fd7895_24_L000025
 long @C_s10tk7_68fd7895_26_L000027
 long @C_s10tk_68fd7895_udatatypename_L000013
 long @C_s10tk8_68fd7895_28_L000029
 long @C_s10tk9_68fd7895_30_L000031
 long @C_s10tka_68fd7895_32_L000033
...
C_luaT__init_87
 ...
 mov r20, ##@C_luaT__init_luaT__eventname_L000036 ' reg <- addrg
...
C_luaT__gettm ' <symbol:luaT_gettm>
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_luaT__gettm_92 ' NEI4
 mov r22, r23
 ...
 mov r0, ##0 ' RET con
 jmp #\@C_luaT__gettm_91 ' JUMPV addrg
C_luaT__gettm_92
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
...
C_luaT__gettmbyobj ' <symbol:luaT_gettmbyobj>
 ...
 cmps r17,  #5 wz
 if_z jmp #\C_luaT__gettmbyobj_98 ' EQI4
 cmps r17,  #7 wz
 if_z jmp #\C_luaT__gettmbyobj_99 ' EQI4
 jmp #\@C_luaT__gettmbyobj_95 ' JUMPV addrg
C_luaT__gettmbyobj_98
 ...
 jmp #\@C_luaT__gettmbyobj_96 ' JUMPV addrg
...
C_luaT__gettmbyobj_96
 ...
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_z jmp #\C_luaT__gettmbyobj_101 ' EQU4
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 mov r20, r23
 adds r20, #16 ' ADDP4 coni
 ...
 jmp #\@C_luaT__gettmbyobj_102 ' JUMPV addrg
...
C_luaT__objtypename ' <symbol:luaT_objtypename>
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #69 wz
 if_nz jmp #\C_luaT__objtypename_107 ' NEI4
 rdlong r22, r21 ' reg <- INDIRP4 reg
 adds r22, #24 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 wrlong r22, RI ' ASGNP4 addrli reg
 cmp r22,  #0 wz
 if_nz jmp #\C_luaT__objtypename_106  ' NEU4
C_luaT__objtypename_107
 mov r22, r21
 adds r22, #4 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #71 wz
 if_nz jmp #\C_luaT__objtypename_104 ' NEI4
 rdlong r22, r21 ' reg <- INDIRP4 reg
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov RI, FP
 ...
 wrlong r22, RI ' ASGNP4 addrli reg
 cmp r22,  #0 wz
 if_z jmp #\C_luaT__objtypename_104 ' EQU4
C_luaT__objtypename_106
 mov r2, ##@C_luaT__objtypename_108_L000109 ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 calld PA,#CALA
 ...
 cmps r20, r22 wz
 if_nz jmp #\C_luaT__objtypename_110 ' NEI4
 mov r22, FP
 ...
 jmp #\@C_luaT__objtypename_103 ' JUMPV addrg
...
C_luaT__callT_M_ ' <symbol:luaT_callTM>
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_luaT__callT_M__114 ' NEI4
 ...
 long @C_luaD__call
 add SP, #8 ' CALL addrg
 jmp #\@C_luaT__callT_M__115 ' JUMPV addrg
...
C_luaT__callT_M_res ' <symbol:luaT_callTMres>
 ...
 and r22, #10 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_luaT__callT_M_res_117 ' NEI4
 ...
 long @C_luaD__call
 add SP, #8 ' CALL addrg
 jmp #\@C_luaT__callT_M_res_118 ' JUMPV addrg
...
' C_luaT__callT_M_res_116 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s10tk16_68fd7895_callbinT_M__L000119 ' <symbol:callbinTM>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 and r22, #15 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_s10tk16_68fd7895_callbinT_M__L000119_121 ' NEI4
 mov r2, r17 ' CVI, CVU or LOAD
 ...
 add SP, #8 ' CALL addrg
 mov r15, r0 ' CVI, CVU or LOAD
C_s10tk16_68fd7895_callbinT_M__L000119_121
 mov r22, r15
 adds r22, #4 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 and r22, #15 ' BANDI4 coni
 cmps r22,  #0 wz
 if_nz jmp #\C_s10tk16_68fd7895_callbinT_M__L000119_123 ' NEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_s10tk16_68fd7895_callbinT_M__L000119_120 ' JUMPV addrg
C_s10tk16_68fd7895_callbinT_M__L000119_123
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r21 ' CVI, CVU or LOAD
 ...
 mov r0, #1 ' reg <- coni
C_s10tk16_68fd7895_callbinT_M__L000119_120
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_luaT__trybinT_M_ ' <symbol:luaT_trybinTM>
 ...
 add SP, #4 ' correct for new kernel !!! 
 calld PA,#CALA
 long @C_s10tk16_68fd7895_callbinT_M__L000119
 add SP, #16 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_luaT__trybinT_M__126 ' NEI4
 mov r15, r17 ' CVI, CVU or LOAD
 cmps r15,  #13 wcz
 if_b jmp #\C_luaT__trybinT_M__128 ' LTI4
 cmps r15,  #19 wcz
 if_a jmp #\C_luaT__trybinT_M__128 ' GTI4
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_luaT__trybinT_M__138_L000140-52 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 rdlong RI, r22
...
C_luaT__trybinT_M__131
 ...
 and r20, #15 ' BANDI4 coni
 cmps r20, r22 wz
 if_nz jmp #\C_luaT__trybinT_M__132 ' NEI4
 mov r20, r21
 adds r20, #4 ' ADDP4 coni
 rdbyte r20, r20 ' reg <- CVUI4 INDIRU1 reg
 and r20, #15 ' BANDI4 coni
 ...
 add SP, #8 ' CALL addrg
 jmp #\@C_luaT__trybinT_M__133 ' JUMPV addrg
C_luaT__trybinT_M__132
 mov r2, ##@C_luaT__trybinT_M__134_L000135 ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov RI, FP
 add RI, #8
...
C_luaT__trybinassocT_M_ ' <symbol:luaT_trybinassocTM>
 ...
 mov r17, r2 ' reg var <- reg arg
 cmps r21,  #0 wz
 if_z jmp #\C_luaT__trybinassocT_M__146 ' EQI4
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, r19 ' CVI, CVU or LOAD
 mov RI, FP
 add RI, #12
 ...
 add SP, #16 ' CALL addrg
 jmp #\@C_luaT__trybinassocT_M__147 ' JUMPV addrg
...
C_luaT__callorderT_M_ ' <symbol:luaT_callorderTM>
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #1 wz
 if_z jmp #\C_luaT__callorderT_M__153 ' EQI4
 and r22, #15 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_luaT__callorderT_M__153 ' EQI4
 mov r15, #1 ' reg <- coni
 jmp #\@C_luaT__callorderT_M__154 ' JUMPV addrg
C_luaT__callorderT_M__153
 mov r15, #0 ' reg <- coni
C_luaT__callorderT_M__154
 mov r0, r15 ' CVI, CVU or LOAD
 jmp #\@C_luaT__callorderT_M__149 ' JUMPV addrg
...
C_luaT__callorderiT_M_ ' <symbol:luaT_callorderiTM>
 ...
 mov r17, r2 ' reg var <- reg arg
 cmps r19,  #0 wz
 if_z jmp #\C_luaT__callorderiT_M__156 ' EQI4
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 mov RI, FP
 sub RI, #-(-20)
 ...
 mov r20, #19 ' reg <- coni
 wrbyte r20, r22 ' ASGNU1 reg reg
 jmp #\@C_luaT__callorderiT_M__157 ' JUMPV addrg
...
C_luaT__adjustvarargs ' <symbol:luaT_adjustvarargs>
 ...
 cmps r0, r22 wcz
 if_a jmp #\C_luaT__adjustvarargs_161 ' GTI4
 mov r22, #1 ' reg <- coni
 mov r2, r22 ' CVI, CVU or LOAD
 mov r22, r17
 adds r22, #8 ' ADDP4 coni
...
' C_luaT__adjustvarargs_162 ' (symbol refcount = 0)
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
 mov r15, #1 ' reg <- coni
 jmp #\@C_luaT__adjustvarargs_166 ' JUMPV addrg
...
C_luaT__adjustvarargs_166
 cmps r15, r21 wcz
 if_be jmp #\C_luaT__adjustvarargs_163 ' LEI4
 mov r22, r13
 shl r22, #3 ' LSHI4 coni
...
C_luaT__getvarargs ' <symbol:luaT_getvarargs>
 ...
 cmps r17,  #0 wcz
 if_ae jmp #\C_luaT__getvarargs_168 ' GEI4
 ...
 calld PA,#DIVS ' DIVI
 cmps r0, r13 wcz
 if_a jmp #\C_luaT__getvarargs_170 ' GTI4
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #0 wcz
 if_be jmp #\C_luaT__getvarargs_172 ' LEI4
...
C_luaT__getvarargs_168
 mov r15, #0 ' reg <- coni
 jmp #\@C_luaT__getvarargs_177 ' JUMPV addrg
...
C_luaT__getvarargs_177
 cmps r15, r17 wcz
 if_ae jmp #\C_luaT__getvarargs_178 ' GEI4
 cmps r15, r13 wcz
 if_b jmp #\C_luaT__getvarargs_174 ' LTI4
C_luaT__getvarargs_178
 jmp #\@C_luaT__getvarargs_182 ' JUMPV addrg
...
C_luaT__getvarargs_182
 cmps r15, r17 wcz
 if_b jmp #\C_luaT__getvarargs_179 ' LTI4
...
C_luaT__init_37_L000038 ' <symbol:37>
 ...
 alignl ' align long
C_s10tka_68fd7895_32_L000033 ' <symbol:32>
 byte 112
 byte 114
 byte 111
 byte 116
 ...
 alignl ' align long
C_s10tk9_68fd7895_30_L000031 ' <symbol:30>
 byte 117
 byte 112
 byte 118
 byte 97
 ...
 alignl ' align long
C_s10tk8_68fd7895_28_L000029 ' <symbol:28>
 byte 116
 byte 104
 byte 114
 byte 101
 ...
 alignl ' align long
C_s10tk7_68fd7895_26_L000027 ' <symbol:26>
 byte 102
 byte 117
 byte 110
 byte 99
 ...
 alignl ' align long
C_s10tk6_68fd7895_24_L000025 ' <symbol:24>
 byte 116
 byte 97
 byte 98
 byte 108
 ...
 alignl ' align long
C_s10tk5_68fd7895_22_L000023 ' <symbol:22>
 byte 115
 byte 116
 byte 114
 byte 105
 ...
 alignl ' align long
C_s10tk4_68fd7895_20_L000021 ' <symbol:20>
 byte 110
 byte 117
 byte 109
 byte 98
 ...
 alignl ' align long
C_s10tk3_68fd7895_18_L000019 ' <symbol:18>
 byte 98
 byte 111
 byte 111
 byte 108
 ...
 alignl ' align long
C_s10tk2_68fd7895_16_L000017 ' <symbol:16>
 byte 110
 byte 105
 byte 108
 byte 0
 ...
 alignl ' align long
C_s10tk1_68fd7895_14_L000015 ' <symbol:14>
 byte 110
 byte 111
 byte 32
 byte 118
