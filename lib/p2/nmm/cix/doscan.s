...
'
 ...
 alignl ' align long
C_sgus_6709f9df_o_collect_L000003 ' <symbol:o_collect>
 calld PA,#NEWF
 calld PA,#PSHM
 ...
 cmps r11, r22 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_8 ' EQI4
 cmps r11, r22 wcz
 if_a jmp #\C_sgus_6709f9df_o_collect_L000003_13 ' GTI4
' C_sgus_6709f9df_o_collect_L000003_12 ' (symbol refcount = 0)
 mov r22, #88 ' reg <- coni
 cmps r11, r22 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_8 ' EQI4
 cmps r11, r22 wcz
 if_b jmp #\C_sgus_6709f9df_o_collect_L000003_5 ' LTI4
' C_sgus_6709f9df_o_collect_L000003_14 ' (symbol refcount = 0)
 cmps r11,  #98 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_11 ' EQI4
 cmps r11,  #100 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_9 ' EQI4
 jmp #\@C_sgus_6709f9df_o_collect_L000003_5 ' JUMPV addrg
C_sgus_6709f9df_o_collect_L000003_13
 mov r22, #111 ' reg <- coni
 cmps r11, r22 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_10 ' EQI4
 cmps r11,  #112 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_8 ' EQI4
 cmps r11, r22 wcz
 if_b jmp #\C_sgus_6709f9df_o_collect_L000003_5 ' LTI4
' C_sgus_6709f9df_o_collect_L000003_15 ' (symbol refcount = 0)
 cmps r11,  #117 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_9 ' EQI4
 cmps r11,  #120 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_8 ' EQI4
 jmp #\@C_sgus_6709f9df_o_collect_L000003_5 ' JUMPV addrg
C_sgus_6709f9df_o_collect_L000003_8
 mov r13, #16 ' reg <- coni
 jmp #\@C_sgus_6709f9df_o_collect_L000003_6 ' JUMPV addrg
C_sgus_6709f9df_o_collect_L000003_9
 mov r13, #10 ' reg <- coni
 jmp #\@C_sgus_6709f9df_o_collect_L000003_6 ' JUMPV addrg
C_sgus_6709f9df_o_collect_L000003_10
 mov r13, #8 ' reg <- coni
 jmp #\@C_sgus_6709f9df_o_collect_L000003_6 ' JUMPV addrg
C_sgus_6709f9df_o_collect_L000003_11
 mov r13, #2 ' reg <- coni
C_sgus_6709f9df_o_collect_L000003_5
C_sgus_6709f9df_o_collect_L000003_6
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #45 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_18 ' EQI4
 cmps r22,  #43 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_16 ' NEI4
C_sgus_6709f9df_o_collect_L000003_18
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_19 ' EQI4
 mov RI, FP
 add RI, #12
...
C_sgus_6709f9df_o_collect_L000003_19
C_sgus_6709f9df_o_collect_L000003_16
 cmps r21,  #0 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_21 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #48 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_21 ' NEI4
 cmps r13,  #16 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_21 ' NEI4
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 ...
 mov r21, r22 ' CVI, CVU or LOAD
 cmps r22,  #0 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_23 ' EQI4
 mov RI, FP
 add RI, #12
 rdlong r2, RI ' reg ARG INDIR ADDRFi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 add RI,#8
 wrlong r0, RI ' ASGNI4 addrfi reg
C_sgus_6709f9df_o_collect_L000003_23
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #120 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_25 ' EQI4
 cmps r22,  #88 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_25 ' EQI4
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #105 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_36 ' NEI4
 mov r13, #8 ' reg <- coni
 jmp #\@C_sgus_6709f9df_o_collect_L000003_36 ' JUMPV addrg
C_sgus_6709f9df_o_collect_L000003_25
 cmps r21,  #0 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_36 ' EQI4
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, FP
 ...
 wrlong r0, RI ' ASGNI4 addrfi reg
 jmp #\@C_sgus_6709f9df_o_collect_L000003_36 ' JUMPV addrg
C_sgus_6709f9df_o_collect_L000003_21
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #105 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_36 ' NEI4
 mov r13, #10 ' reg <- coni
 jmp #\@C_sgus_6709f9df_o_collect_L000003_36 ' JUMPV addrg
C_sgus_6709f9df_o_collect_L000003_35
 cmps r13,  #10 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_42 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 subs r22, #48 ' SUBI4 coni
 cmp r22,  #10 wcz 
 if_b jmp #\C_sgus_6709f9df_o_collect_L000003_45 ' LTU4
C_sgus_6709f9df_o_collect_L000003_42
 cmps r13,  #16 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_44 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_45 ' NEI4
C_sgus_6709f9df_o_collect_L000003_44
 cmps r13,  #8 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_47 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, r22
 ...
 cmp r20,  #10 wcz 
 if_ae jmp #\C_sgus_6709f9df_o_collect_L000003_47 ' GEU4
 cmps r22,  #56 wcz
 if_b jmp #\C_sgus_6709f9df_o_collect_L000003_45 ' LTI4
C_sgus_6709f9df_o_collect_L000003_47
 cmps r13,  #2 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_37 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, r22
 subs r20, #48 ' SUBI4 coni
 cmp r20,  #10 wcz 
 if_ae jmp #\C_sgus_6709f9df_o_collect_L000003_37 ' GEU4
 cmps r22,  #50 wcz
 if_ae jmp #\C_sgus_6709f9df_o_collect_L000003_37 ' GEI4
C_sgus_6709f9df_o_collect_L000003_45
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, FP
 ...
 mov r21, r22 ' CVI, CVU or LOAD
 cmps r22,  #0 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_39 ' EQI4
 mov RI, FP
 add RI, #12
 rdlong r2, RI ' reg ARG INDIR ADDRFi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 add RI,#8
 wrlong r0, RI ' ASGNI4 addrfi reg
C_sgus_6709f9df_o_collect_L000003_39
C_sgus_6709f9df_o_collect_L000003_36
 cmps r21,  #0 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_35 ' NEI4
C_sgus_6709f9df_o_collect_L000003_37
 cmps r21,  #0 wz
 if_z jmp #\C_sgus_6709f9df_o_collect_L000003_50 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, ##-1 ' reg <- con
 ...
 long @C_ungetc
 add SP, #4 ' CALL addrg
C_sgus_6709f9df_o_collect_L000003_50
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #105 wz
 if_nz jmp #\C_sgus_6709f9df_o_collect_L000003_52 ' NEI4
 mov r13, #0 ' reg <- coni
C_sgus_6709f9df_o_collect_L000003_52
...
' C_sgus_6709f9df_o_collect_L000003_4 ' (symbol refcount = 0)
...
' reg ARG ADDRL
 ...
 calld PA,#CALA
 long @C_sgus_6709f9df_o_collect_L000003
