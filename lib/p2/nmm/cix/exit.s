...
DAT ' code segment
 ...
 alignl ' align long
C_s6g0_67070707__calls_L000003 ' <symbol:_calls>
 calld PA,#NEWF
 calld PA,#PSHM
 long $d00000 ' save registers
 mov r23, ##@C___funccnt
 rdlong r23, r23 ' reg <- INDIRI4 addrg
 jmp #\@C_s6g0_67070707__calls_L000003_6 ' JUMPV addrg
C_s6g0_67070707__calls_L000003_5
 mov r22, r23
...
C_s6g0_67070707__calls_L000003_6
 mov r22, r23
 subs r22, #1 ' SUBI4 coni
 mov r23, r22 ' CVI, CVU or LOAD
 cmps r22,  #0 wcz
 if_ae jmp #\C_s6g0_67070707__calls_L000003_5 ' GEI4
' C_s6g0_67070707__calls_L000003_4 ' (symbol refcount = 0)
...
C_exit ' <symbol:exit>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 calld PA,#CALA
 long @C_s6g0_67070707__calls_L000003 ' CALL addrg
 mov r22, ##@C__clean
