...
DAT ' initialized data segment
 ...
 alignl ' align long
C_slbg_67ea41b8_lmmtd_array_L000001 ' <symbol:lmmtd_array>
 long $fd900164
 long $fd900dd0
 long $fd9001cc
 long $fd9001d0
...
C__threaded_cogstart_L_M_M__cog ' <symbol:_threaded_cogstart_LMM_cog>
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 mov r15, #0 ' reg <- coni
C__threaded_cogstart_L_M_M__cog_11
 mov r22, r15
 ...
 jmp #LODL
 long @C_slbg_67ea41b8_lmmtd_array_L000001
...
' C__threaded_cogstart_L_M_M__cog_12 ' (symbol refcount = 0)
 ...
 cmps r15, r22 wz,wc
 jmp #BR_B
 long @C__threaded_cogstart_L_M_M__cog_11 ' LTI4
 mov r15, #0 ' reg <- coni
C__threaded_cogstart_L_M_M__cog_15
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 jmp #LODF
 long -4100
 ...
 mov BC, r22
 jmp #WLNG ' ASGNI4 reg reg
' C__threaded_cogstart_L_M_M__cog_16 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
 cmps r15,  #153 wz,wc
 jmp #BR_B
 long @C__threaded_cogstart_L_M_M__cog_15 ' LTI4
 jmp #LODF
 long -4100
