...
C_g_justify ' <symbol:g_justify>
 ...
 cmps r17,  #0 wz,wc
 jmp #BR_B
 long @C_g_justify_8 ' LTI4
 cmps r17,  #3 wz,wc
 jmp #BR_A
 long @C_g_justify_8 ' GTI4
 mov r22, r17
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_g_justify_16_L000018
...
C_g_justify_12
 ...
 jmp #JMPA
 long @C_g_justify_9 ' JUMPV addrg
C_g_justify_13
 mov r22, FP
...
C_g_justify_9
 ...
 cmps r15,  #0 wz,wc
 jmp #BR_B
 long @C_g_justify_19 ' LTI4
 cmps r15,  #3 wz,wc
 jmp #BR_A
 long @C_g_justify_19 ' GTI4
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_g_justify_29_L000031
 mov r20, RI ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 mov RI, r22
 jmp #RLNG
...
C_g_justify_23
 ...
 jmp #WLNG ' ASGNI4 reg reg
 jmp #JMPA
 long @C_g_justify_20 ' JUMPV addrg
C_g_justify_24
 jmp #LODI
 long @C_G__V_A_R_+12
 mov r22, RI ' reg <- INDIRI4 addrg
