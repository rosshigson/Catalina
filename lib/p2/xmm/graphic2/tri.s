...
C_g_tri ' <symbol:g_tri>
 ...
 cmps r22, r21 wz,wc
 jmp #BR_B
 long @C_g_tri_11 ' LTI4
 mov r13, #4 ' reg <- coni
 jmp #JMPA
 long @C_g_tri_12 ' JUMPV addrg
C_g_tri_11
 mov r13, #0 ' reg <- coni
C_g_tri_12
 cmps r21, r17 wz,wc
 jmp #BR_B
 long @C_g_tri_13 ' LTI4
 mov r11, #2 ' reg <- coni
 jmp #JMPA
 long @C_g_tri_14 ' JUMPV addrg
C_g_tri_13
 mov r11, #0 ' reg <- coni
C_g_tri_14
 mov r22, FP
 ...
 cmps r22, r17 wz,wc
 jmp #BR_B
 long @C_g_tri_15 ' LTI4
 mov r9, #1 ' reg <- coni
 jmp #JMPA
 long @C_g_tri_16 ' JUMPV addrg
C_g_tri_15
 mov r9, #0 ' reg <- coni
C_g_tri_16
 mov r22, r13 ' BORI/U
