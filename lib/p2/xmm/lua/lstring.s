...
' C_luaS__hashlongstr_24 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_shng_6a9cb603_tablerehash_L000027 ' <symbol:tablerehash>
 jmp #PSHM
 long $fa0000 ' save registers
 mov r23, r3 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_shng_6a9cb603_tablerehash_L000027_32 ' JUMPV addrg
C_shng_6a9cb603_tablerehash_L000027_29
 mov r22, r23
...
' C_shng_6a9cb603_tablerehash_L000027_30 ' (symbol refcount = 0)
 adds r23, #1 ' ADDI4 coni
C_shng_6a9cb603_tablerehash_L000027_32
 cmps r23, r2 wz,wc
 jmp #BR_B
 long @C_shng_6a9cb603_tablerehash_L000027_29 ' LTI4
 mov r23, #0 ' reg <- coni
 jmp #JMPA
 long @C_shng_6a9cb603_tablerehash_L000027_36 ' JUMPV addrg
C_shng_6a9cb603_tablerehash_L000027_33
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 adds r22, r4 ' ADDI/P (1)
 mov RI, r22
 ...
 jmp #WLNG ' ASGNP4 reg reg
 jmp #JMPA
 long @C_shng_6a9cb603_tablerehash_L000027_38 ' JUMPV addrg
C_shng_6a9cb603_tablerehash_L000027_37
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
...
C_shng_6a9cb603_tablerehash_L000027_38
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_shng_6a9cb603_tablerehash_L000027_37 ' NEU4
' C_shng_6a9cb603_tablerehash_L000027_34 ' (symbol refcount = 0)
 adds r23, #1 ' ADDI4 coni
C_shng_6a9cb603_tablerehash_L000027_36
 cmps r23, r3 wz,wc
 jmp #BR_B
 long @C_shng_6a9cb603_tablerehash_L000027_33 ' LTI4
' C_shng_6a9cb603_tablerehash_L000027_28 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C_luaS__resize ' <symbol:luaS_resize>
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_shng_6a9cb603_tablerehash_L000027
 add SP, #8 ' CALL addrg
C_luaS__resize_41
 mov r22, r21 ' CVI, CVU or LOAD
 mov r2, r22
...
' C_luaS__init_60 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_shng2_6a9cb603_createstrobj_L000071 ' <symbol:createstrobj>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
...
' C_shng2_6a9cb603_createstrobj_L000071_72 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_luaS__createlngstrobj ' <symbol:luaS_createlngstrobj>
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_shng2_6a9cb603_createstrobj_L000071
 add SP, #12 ' CALL addrg
...
' C_luaS__remove_74 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_shng3_6a9cb603_growstrtab_L000078 ' <symbol:growstrtab>
 jmp #NEWF
 jmp #PSHM
 long $f00000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 cmps r22, r20 wz
 jmp #BRNZ
 long @C_shng3_6a9cb603_growstrtab_L000078_80 ' NEI4
 ...
 cmps r22, r20 wz
 jmp #BRNZ
 long @C_shng3_6a9cb603_growstrtab_L000078_82 ' NEI4
 ...
 long @C_luaD__throw
 add SP, #4 ' CALL addrg
C_shng3_6a9cb603_growstrtab_L000078_82
C_shng3_6a9cb603_growstrtab_L000078_80
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 cmps r22, r20 wz,wc
 jmp #BR_A
 long @C_shng3_6a9cb603_growstrtab_L000078_84 ' GTI4
 mov r22, r21
 adds r22, #8 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 long @C_luaS__resize
 add SP, #4 ' CALL addrg
C_shng3_6a9cb603_growstrtab_L000078_84
' C_shng3_6a9cb603_growstrtab_L000078_79 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_shng4_6a9cb603_internshrstr_L000086 ' <symbol:internshrstr>
 jmp #NEWF
 jmp #PSHM
 ...
 mov r17, BC ' reg <- INDIRP4 reg
 jmp #JMPA
 long @C_shng4_6a9cb603_internshrstr_L000086_91 ' JUMPV addrg
C_shng4_6a9cb603_internshrstr_L000086_88
 mov r22, r17
 adds r22, #7 ' ADDP4 coni
 mov RI, r22
 jmp #RBYT
 ...
 cmp r19, r22 wz
 jmp #BRNZ
 long @C_shng4_6a9cb603_internshrstr_L000086_92 ' NEU4
 mov r22, #1 ' reg <- coni
 mov r0, r22 ' setup r0/r1 (2)
 ...
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_shng4_6a9cb603_internshrstr_L000086_92 ' NEI4
 mov r22, r17
 adds r22, #5 ' ADDP4 coni
 mov RI, r22
 jmp #RBYT
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_shng4_6a9cb603_internshrstr_L000086_94 ' EQI4
 mov r22, r17
 adds r22, #5 ' ADDP4 coni
 mov RI, r22
 jmp #RBYT
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
C_shng4_6a9cb603_internshrstr_L000086_94
 mov r0, r17 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_shng4_6a9cb603_internshrstr_L000086_87 ' JUMPV addrg
C_shng4_6a9cb603_internshrstr_L000086_92
' C_shng4_6a9cb603_internshrstr_L000086_89 ' (symbol refcount = 0)
 mov r22, r17
 adds r22, #12 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 mov r17, BC ' reg <- INDIRP4 reg
C_shng4_6a9cb603_internshrstr_L000086_91
 mov r22, r17 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_shng4_6a9cb603_internshrstr_L000086_88 ' NEU4
 mov r22, r13
 adds r22, #4 ' ADDP4 coni
 mov RI, r22
 jmp #RLNG
 ...
 cmps r22, r20 wz,wc
 jmp #BR_B
 long @C_shng4_6a9cb603_internshrstr_L000086_96 ' LTI4
 mov r2, r13 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_shng3_6a9cb603_growstrtab_L000078
 add SP, #4 ' CALL addrg
 mov r22, r13
 adds r22, #8 ' ADDP4 coni
 mov RI, r22
 ...
 mov r11, r22 ' ADDI/P
 adds r11, r20 ' ADDI/P (3)
C_shng4_6a9cb603_internshrstr_L000086_96
 ...
 jmp #WLNG ' ASGNI4 reg reg
 mov r0, r17 ' CVI, CVU or LOAD
C_shng4_6a9cb603_internshrstr_L000086_87
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaS__newlstr ' <symbol:luaS_newlstr>
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_shng4_6a9cb603_internshrstr_L000086
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
