...
'
 ...
 alignl ' align long
C_so88_67ea419d__seed_L000001 ' <symbol:_seed>
 jmp #PSHM
 long $400000 ' save registers
' loading argument C_so88_67ea419d__seed_L000001_3_L000004 to PASM eliminated
'START PASM ... 
getct r0
...
' C_so88_67ea419d__seed_L000001_2 ' (symbol refcount = 0)
...
C_getrand ' <symbol:getrand>
 ...
 jmp #CALA
 long @C_so88_67ea419d__seed_L000001 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
