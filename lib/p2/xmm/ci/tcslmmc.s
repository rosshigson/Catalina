...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s1020_68fd76e1_lmmtd_array_L000001 ' <symbol:lmmtd_array>
 long $fd900164
 long $fd900dd0
 long $fd9001cc
 long $fd9001d0
...
' Catalina Export _threaded_cogstart_LMM_cog
...
C__threaded_cogstart_L_M_M__cog ' <symbol:_threaded_cogstart_LMM_cog>
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 jmp #LODL
 long @C_M_Y__L_M_M__L_U_T__L_I_B_R_A_R_Y__array
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 mov r15, #0 ' reg <- coni
C__threaded_cogstart_L_M_M__cog_12
 mov r22, r15
 ...
 jmp #LODL
 long @C_s1020_68fd76e1_lmmtd_array_L000001
...
' C__threaded_cogstart_L_M_M__cog_13 ' (symbol refcount = 0)
 ...
 cmps r15, r22 wz,wc
 jmp #BR_B
 long @C__threaded_cogstart_L_M_M__cog_12 ' LTI4
 mov r15, #0 ' reg <- coni
C__threaded_cogstart_L_M_M__cog_16
 mov r22, r15
 shl r22, #2 ' LSHI4 coni
 jmp #LODF
 long -4100
 ...
 mov BC, r22
 jmp #WLNG ' ASGNI4 reg reg
' C__threaded_cogstart_L_M_M__cog_17 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
 cmps r15,  #153 wz,wc
 jmp #BR_B
 long @C__threaded_cogstart_L_M_M__cog_16 ' LTI4
 jmp #LODF
 long -4100
