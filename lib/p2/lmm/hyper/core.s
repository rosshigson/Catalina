...
DAT ' initialized data segment
 ...
 alignl ' align long
C_svnc_68fd7599_startupD_ata_L000002 ' <symbol:startupData>
 long $0

 alignl ' align long
C_svnc1_68fd7599_deviceD_ata_L000003 ' <symbol:deviceData>
 long $0

 alignl ' align long
C_svnc2_68fd7599_Q_osD_ata_L000004 ' <symbol:QosData>
 long $0

 alignl ' align long
C_svnc3_68fd7599_mailboxes_L000005 ' <symbol:mailboxes>
 long $0

 alignl ' align long
C_svnc4_68fd7599_drivercog_L000006 ' <symbol:drivercog>
 long -1

 alignl ' align long
C_svnc5_68fd7599_driverlock_L000007 ' <symbol:driverlock>
 long -1

 alignl ' align long
C_svnc6_68fd7599_delayT_able_r_L000008 ' <symbol:delayTable_r>
 long $6
 long $57bcf00
 long $80befc0
 long $b34a700
 ...
 alignl ' align long
C_svnc7_68fd7599_delayT_able_f_L000009 ' <symbol:delayTable_f>
 long $5
 long $42c1d80
 long $68e7780
 long $9896800
...
C_hyper_getM_ailbox ' <symbol:hyper_getMailbox>
 ...
 jmp #LODI
 long @C_svnc3_68fd7599_mailboxes_L000005
...
C_hyper_initialize ' <symbol:hyper_initialize>
 ...
 jmp #LODI
 long @C_svnc_68fd7599_startupD_ata_L000002
 ...
 jmp #LODL
 long @C_svnc4_68fd7599_drivercog_L000006
 ...
 jmp #LODL
 long @C_svnc1_68fd7599_deviceD_ata_L000003
 ...
 jmp #LODL
 long @C_svnc2_68fd7599_Q_osD_ata_L000004
 mov r22, RI ' reg <- addrg
 ...
 wrlong r22, RI ' ASGNP4 addrg reg
 jmp #LODL
 long @C_svnc5_68fd7599_driverlock_L000007
 mov r22, RI ' reg <- addrg
 mov r20, r18
...
' C_hyper_getD_riverL_ock_32 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033 ' <symbol:hyper_getStartBank>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r22,  #25 wz
 jmp #BRNZ
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_35 ' NEI4
 and r23, #14 ' BANDI4 coni
 jmp #JMPA
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_36 ' JUMPV addrg
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_35
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #26 wz
 jmp #BRNZ
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_37 ' NEI4
 and r23, #12 ' BANDI4 coni
 jmp #JMPA
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_38 ' JUMPV addrg
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_37
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #27 wz
 jmp #BRNZ
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_39 ' NEI4
 and r23, #8 ' BANDI4 coni
 jmp #JMPA
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_40 ' JUMPV addrg
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_39
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #28 wz
 jmp #BRNZ
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_41 ' NEI4
 mov r23, #0 ' reg <- coni
 jmp #JMPA
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_42 ' JUMPV addrg
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_41
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #28 wcz
 jmp #BRBE
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_43 ' LEI4
 jmp #LODL
 long -6
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_34 ' JUMPV addrg
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_43
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_42
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_40
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_38
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_36
 mov r0, r23 ' CVI, CVU or LOAD
C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033_34
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_hyper_modifyB_ankP_arams_73
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_svnc8_68fd7599_hyper_getS_tartB_ank_L000033 ' CALL addrg
...
C_hyper_modifyB_ankP_arams_72
 ...
 alignl ' align long
C_svnc9_68fd7599_getB_ankP_arams_L000092 ' <symbol:getBankParams>
 jmp #NEWF
 jmp #PSHM
 ...
 jmp #JMPA
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_95 ' JUMPV addrg
C_svnc9_68fd7599_getB_ankP_arams_L000092_94
 mov r2, #1 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C__waitms ' CALL addrg
C_svnc9_68fd7599_getB_ankP_arams_L000092_95
 jmp #LODI
 long @C_svnc5_68fd7599_driverlock_L000007
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_94 ' EQI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C__cogid ' CALL addrg
...
C_svnc9_68fd7599_getB_ankP_arams_L000092_97
 rdlong r19, r17 ' reg <- INDIRI4 reg
' C_svnc9_68fd7599_getB_ankP_arams_L000092_98 ' (symbol refcount = 0)
 cmps r19,  #0 wcz
 jmp #BR_B
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_97 ' LTI4
 cmps r19,  #0 wcz
 jmp #BRBE
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_100 ' LEI4
 neg r19, r19 ' NEGI4
 jmp #LODI
 long @C_svnc5_68fd7599_driverlock_L000007
 mov r2, RI ' reg ARG INDIR ADDRG
 ...
 jmp #JMPA
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_93 ' JUMPV addrg
C_svnc9_68fd7599_getB_ankP_arams_L000092_100
 cmps r21,  #1 wz
 jmp #BRNZ
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_102 ' NEI4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 shr r22, #16 ' RSHU4 coni
 ...
 jmp #JMPA
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_103 ' JUMPV addrg
C_svnc9_68fd7599_getB_ankP_arams_L000092_102
 cmps r21,  #2 wz
 jmp #BRNZ
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_104 ' NEI4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 mov r19, r22 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_105 ' JUMPV addrg
C_svnc9_68fd7599_getB_ankP_arams_L000092_104
 cmps r21,  #4 wz
 jmp #BRNZ
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_106 ' NEI4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 mov r19, r22 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_107 ' JUMPV addrg
C_svnc9_68fd7599_getB_ankP_arams_L000092_106
 cmps r21,  #3 wz
 jmp #BRNZ
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_108 ' NEI4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 jmp #LODL
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_110 ' EQU4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
 shr r22, #16 ' RSHU4 coni
 ...
 mov r19, r22 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_109 ' JUMPV addrg
C_svnc9_68fd7599_getB_ankP_arams_L000092_110
 mov r19, #0 ' reg <- coni
 jmp #JMPA
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092_109 ' JUMPV addrg
C_svnc9_68fd7599_getB_ankP_arams_L000092_108
 jmp #LODL
 long -6
 mov r19, RI ' reg <- con
C_svnc9_68fd7599_getB_ankP_arams_L000092_109
C_svnc9_68fd7599_getB_ankP_arams_L000092_107
C_svnc9_68fd7599_getB_ankP_arams_L000092_105
C_svnc9_68fd7599_getB_ankP_arams_L000092_103
 jmp #LODI
 long @C_svnc5_68fd7599_driverlock_L000007
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 long @C__lockclr ' CALL addrg
 mov r0, r19 ' CVI, CVU or LOAD
C_svnc9_68fd7599_getB_ankP_arams_L000092_93
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_svnca_68fd7599_validH_yperR_A_M__L000112 ' <symbol:validHyperRAM>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $500000 ' save registers
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_svnca_68fd7599_validH_yperR_A_M__L000112_114 ' EQI4
 jmp #LODL
 long -23
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_svnca_68fd7599_validH_yperR_A_M__L000112_113 ' JUMPV addrg
C_svnca_68fd7599_validH_yperR_A_M__L000112_114
 mov r0, #0 ' RET coni
C_svnca_68fd7599_validH_yperR_A_M__L000112_113
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_svncb_68fd7599_hyper_lookupD_elay_L000116 ' <symbol:hyper_lookupDelay>
 jmp #NEWF
 jmp #PSHM
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_svnca_68fd7599_validH_yperR_A_M__L000112 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_118 ' NEI4
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_svnc6_68fd7599_delayT_able_r_L000008
 mov r20, RI ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r17, r22 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_121 ' JUMPV addrg
C_svncb_68fd7599_hyper_lookupD_elay_L000116_120
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r19
 shl r20, #2 ' LSHI4 coni
 jmp #LODL
 long @C_svnc6_68fd7599_delayT_able_r_L000008+4
 mov r18, RI ' reg <- addrg
 adds r20, r18 ' ADDI/P (1)
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 jmp #BRAE
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_124 ' GEU4
 jmp #JMPA
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_119 ' JUMPV addrg
C_svncb_68fd7599_hyper_lookupD_elay_L000116_124
 adds r19, #1 ' ADDI4 coni
 adds r17, #1 ' ADDI4 coni
C_svncb_68fd7599_hyper_lookupD_elay_L000116_121
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_svnc6_68fd7599_delayT_able_r_L000008+4
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_120 ' NEU4
 jmp #JMPA
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_119 ' JUMPV addrg
C_svncb_68fd7599_hyper_lookupD_elay_L000116_118
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_svnc7_68fd7599_delayT_able_f_L000009
 mov r20, RI ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r17, r22 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_128 ' JUMPV addrg
C_svncb_68fd7599_hyper_lookupD_elay_L000116_127
 mov r22, r21 ' CVI, CVU or LOAD
 mov r20, r19
 shl r20, #2 ' LSHI4 coni
 jmp #LODL
 long @C_svnc7_68fd7599_delayT_able_f_L000009+4
 mov r18, RI ' reg <- addrg
 adds r20, r18 ' ADDI/P (1)
 rdlong r20, r20 ' reg <- INDIRU4 reg
 cmp r22, r20 wcz 
 jmp #BRAE
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_131 ' GEU4
 jmp #JMPA
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_129 ' JUMPV addrg
C_svncb_68fd7599_hyper_lookupD_elay_L000116_131
 adds r19, #1 ' ADDI4 coni
 adds r17, #1 ' ADDI4 coni
C_svncb_68fd7599_hyper_lookupD_elay_L000116_128
 mov r22, r19
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_svnc7_68fd7599_delayT_able_f_L000009+4
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116_127 ' NEU4
C_svncb_68fd7599_hyper_lookupD_elay_L000116_129
C_svncb_68fd7599_hyper_lookupD_elay_L000116_119
 mov r0, r17 ' CVI, CVU or LOAD
' C_svncb_68fd7599_hyper_lookupD_elay_L000116_117 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_hyper_setD_elayF_requency_138
 ...
 jmp #CALA
 long @C_svncb_68fd7599_hyper_lookupD_elay_L000116
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 mov r2, r22 ' CVI, CVU or LOAD
 mov r3, r23 ' CVI, CVU or LOAD
...
C_hyper_getD_elay ' <symbol:hyper_getDelay>
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_svnc9_68fd7599_getB_ankP_arams_L000092
 add SP, #4 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
