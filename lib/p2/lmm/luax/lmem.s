...
C_luaM__growaux_ ' <symbol:luaM_growaux_>
 ...
 cmps r22, r15 wcz
 jmp #BR_A
 long @C_luaM__growaux__15 ' GTI4
 mov r22, FP
 add r22, #12 ' reg <- addrfi
 rdlong r0, r22 ' reg <- INDIRP4 reg
 jmp #JMPA
 long @C_luaM__growaux__14 ' JUMPV addrg
C_luaM__growaux__15
 mov r22, #2 ' reg <- coni
 ...
 cmps r15, r19 wcz
 jmp #BR_B
 long @C_luaM__growaux__19 ' LTI4
 mov r2, r19 ' CVI, CVU or LOAD
 mov r3, r17 ' CVI, CVU or LOAD
 jmp #LODL
 long @C_luaM__growaux__21_L000022
...
C_luaM__growaux__19
 ...
 jmp #JMPA
 long @C_luaM__growaux__18 ' JUMPV addrg
C_luaM__growaux__17
 shl r15, #1 ' LSHI4 coni
 cmps r15,  #4 wcz
 jmp #BRAE
 long @C_luaM__growaux__23 ' GEI4
 mov r15, #4 ' reg <- coni
C_luaM__growaux__23
C_luaM__growaux__18
...
C_luaM__toobig ' <symbol:luaM_toobig>
 ...
 jmp #LODL
 long @C_luaM__toobig_27_L000028
...
' C_luaM__free__29 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_srg42_696ddd96_tryagain_L000030 ' <symbol:tryagain>
 jmp #NEWF
 jmp #PSHM
 long $fa8000 ' save registers
 mov r23, r5 ' reg var <- reg arg
 ...
 cmps r20, r22 wz
 jmp #BRNZ
 long @C_srg42_696ddd96_tryagain_L000030_32 ' NEI4
 mov r20, r15
 ...
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_srg42_696ddd96_tryagain_L000030_31 ' JUMPV addrg
C_srg42_696ddd96_tryagain_L000030_32
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
C_srg42_696ddd96_tryagain_L000030_31
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaM__realloc_ ' <symbol:luaM_realloc_>
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_srg42_696ddd96_tryagain_L000030
 add SP, #12 ' CALL addrg
 mov r13, r0 ' CVI, CVU or LOAD
 mov r22, r13 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_luaM__realloc__37 ' NEU4
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_luaM__realloc__34 ' JUMPV addrg
C_luaM__realloc__37
C_luaM__realloc__35
 mov r22, r15
 adds r22, #12 ' ADDP4 coni
...
C_luaM__saferealloc_ ' <symbol:luaM_saferealloc_>
 ...
 cmp r20, r22 wz
 jmp #BRNZ
 long @C_luaM__saferealloc__40 ' NEU4
 cmp r17, r22 wz
 jmp #BR_Z
 long @C_luaM__saferealloc__40 ' EQU4
...
C_luaM__malloc_ ' <symbol:luaM_malloc_>
 ...
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_luaM__malloc__42 ' JUMPV addrg
C_luaM__malloc__43
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
