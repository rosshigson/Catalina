...
DAT ' initialized data segment
 ...
 alignl ' align long
C_srm4_686cc28d_s8base_L000002 ' <symbol:s8base>
 long $0

 alignl ' align long
C_srm41_686cc28d_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_srm42_686cc28d_pinconfig_L000004 ' <symbol:pinconfig>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r17,  #0 wz
 jmp #BRNZ
 long @C_srm42_686cc28d_pinconfig_L000004_6 ' NEI4
 mov r22, #62 ' reg <- coni
 jmp #LODF
 long -8
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_srm42_686cc28d_pinconfig_L000004_7 ' EQU4
 mov r22, FP
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 jmp #JMPA
 long @C_srm42_686cc28d_pinconfig_L000004_7 ' JUMPV addrg
C_srm42_686cc28d_pinconfig_L000004_6
 ...
 cmps r13,  #0 wcz
 jmp #BR_B
 long @C_srm42_686cc28d_pinconfig_L000004_10 ' LTI4
 cmps r13,  #3 wcz
 jmp #BR_A
 long @C_srm42_686cc28d_pinconfig_L000004_10 ' GTI4
 mov r22, r13
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_srm42_686cc28d_pinconfig_L000004_17_L000019
...
DAT ' const data segment
 ...
 alignl ' align long
C_srm42_686cc28d_pinconfig_L000004_17_L000019 ' <symbol:17>
 long @C_srm42_686cc28d_pinconfig_L000004_11
 long @C_srm42_686cc28d_pinconfig_L000004_14
 long @C_srm42_686cc28d_pinconfig_L000004_15
 long @C_srm42_686cc28d_pinconfig_L000004_16

' Catalina Code

DAT ' code segment
C_srm42_686cc28d_pinconfig_L000004_14
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODL
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 jmp #JMPA
 long @C_srm42_686cc28d_pinconfig_L000004_11 ' JUMPV addrg
C_srm42_686cc28d_pinconfig_L000004_15
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODL
 ...
 jmp #JMPA
 long @C_srm42_686cc28d_pinconfig_L000004_11 ' JUMPV addrg
C_srm42_686cc28d_pinconfig_L000004_16
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODL
 ...
 long -8
 wrlong r22, RI ' ASGNU4 addrl reg
C_srm42_686cc28d_pinconfig_L000004_10
C_srm42_686cc28d_pinconfig_L000004_11
C_srm42_686cc28d_pinconfig_L000004_7
...
' C_srm42_686cc28d_pinconfig_L000004_5 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_srm45_686cc28d_p_config_L000020 ' <symbol:p_config>
 jmp #NEWF
 jmp #PSHM
 ...
 jmp #LODI
 long @C_srm4_686cc28d_s8base_L000002
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_srm45_686cc28d_p_config_L000020_21 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_srm46_686cc28d_autoinitialize_L000022 ' <symbol:autoinitialize>
 jmp #NEWF
 jmp #PSHM
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_srm46_686cc28d_autoinitialize_L000022_24 ' EQU4
 jmp #LODI
 long @C_srm4_686cc28d_s8base_L000002
 mov r22, RI ' reg <- INDIRP4 addrg
 ...
 add r15, r22 ' ADDU (3)
 mov r17, #0 ' reg <- coni
C_srm46_686cc28d_autoinitialize_L000022_26
 mov r21, r17
 ...
 cmps r23,  #0 wcz
 jmp #BR_B
 long @C_srm46_686cc28d_autoinitialize_L000022_30 ' LTI4
 cmps r23,  #63 wcz
 jmp #BR_A
 long @C_srm46_686cc28d_autoinitialize_L000022_30 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 jmp #LODI
 long @C_srm4_686cc28d_s8base_L000002
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_srm42_686cc28d_pinconfig_L000004
 add SP, #12 ' CALL addrg
 jmp #LODL
 long 1024
 mov r22, RI ' reg <- con
 ...
 jmp #CALA
 long @C_srm45_686cc28d_p_config_L000020
 add SP, #20 ' CALL addrg
C_srm46_686cc28d_autoinitialize_L000022_30
 ...
 cmps r23,  #0 wcz
 jmp #BR_B
 long @C_srm46_686cc28d_autoinitialize_L000022_32 ' LTI4
 cmps r23,  #63 wcz
 jmp #BR_A
 long @C_srm46_686cc28d_autoinitialize_L000022_32 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 jmp #LODI
 long @C_srm4_686cc28d_s8base_L000002
 ...
 long @C_srm45_686cc28d_p_config_L000020
 add SP, #20 ' CALL addrg
C_srm46_686cc28d_autoinitialize_L000022_32
 jmp #LODL
 long 2048
 mov r22, RI ' reg <- con
 add r19, r22 ' ADDU (1)
 add r15, r22 ' ADDU (1)
' C_srm46_686cc28d_autoinitialize_L000022_27 ' (symbol refcount = 0)
 adds r17, #1 ' ADDI4 coni
 cmps r17,  #8 wcz
 jmp #BR_B
 long @C_srm46_686cc28d_autoinitialize_L000022_26 ' LTI4
C_srm46_686cc28d_autoinitialize_L000022_24
' C_srm46_686cc28d_autoinitialize_L000022_23 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_srm47_686cc28d_initialize_L000034 ' <symbol:initialize>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_srm47_686cc28d_initialize_L000034_36 ' NEU4
 ...
 cmps r22,  #0 wcz
 jmp #BR_B
 long @C_srm47_686cc28d_initialize_L000034_38 ' LTI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 ...
 jmp #LODL
 long @C_srm41_686cc28d_lock_L000003
 mov r20, RI ' reg <- addrg
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_srm47_686cc28d_initialize_L000034_40 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 ...
 cmps r22,  #0 wcz
 jmp #BR_B
 long @C_srm47_686cc28d_initialize_L000034_41 ' LTI4
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODI
 ...
 jmp #JMPA
 long @C_srm47_686cc28d_initialize_L000034_41 ' JUMPV addrg
C_srm47_686cc28d_initialize_L000034_40
 jmp #LODL
 long @C_srm41_686cc28d_lock_L000003
 ...
 long @C_srm41_686cc28d_lock_L000003
 wrlong r22, RI ' ASGNI4 addrg reg
C_srm47_686cc28d_initialize_L000034_41
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_srm46_686cc28d_autoinitialize_L000022 ' CALL addrg
C_srm47_686cc28d_initialize_L000034_38
C_srm47_686cc28d_initialize_L000034_36
' C_srm47_686cc28d_initialize_L000034_35 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_s_closeport ' <symbol:s_closeport>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_srm47_686cc28d_initialize_L000034 ' CALL addrg
C_s_closeport_45
 cmp r23,  #8 wcz 
 jmp #BRAE
