...
C_m_bound_limits ' <symbol:m_bound_limits>
 ...
 jmp #LODL
 long @C_s6qk_686cc2bf_m_min_L000002
 wrlong r22, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s6qk1_686cc2bf_m_max_L000003
 wrlong r4, RI ' ASGNI4 addrg reg
 mov r22, FP
 add r22, #12 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 jmp #LODL
 long @C_s6qk_686cc2bf_m_min_L000002+4
 wrlong r22, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s6qk1_686cc2bf_m_max_L000003+4
 wrlong r3, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s6qk_686cc2bf_m_min_L000002+8
 wrlong r5, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s6qk1_686cc2bf_m_max_L000003+8
...
C_m_bound_scales ' <symbol:m_bound_scales>
 jmp #LODL
 long @C_s6qk2_686cc2bf_m_div_L000004
 wrlong r4, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s6qk2_686cc2bf_m_div_L000004+4
 wrlong r3, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_s6qk2_686cc2bf_m_div_L000004+8
 wrlong r2, RI ' ASGNI4 addrg reg
...
C_m_bound_preset_20
 ...
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_s6qk3_686cc2bf_m_acc_L000005
 mov r20, RI ' reg <- addrg
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_s6qk3_686cc2bf_m_acc_L000005 ' <symbol:m_acc>
 byte 0[12]

 alignl ' align long
C_s6qk2_686cc2bf_m_div_L000004 ' <symbol:m_div>
 byte 0[12]

 alignl ' align long
C_s6qk1_686cc2bf_m_max_L000003 ' <symbol:m_max>
 byte 0[12]

 alignl ' align long
C_s6qk_686cc2bf_m_min_L000002 ' <symbol:m_min>
 byte 0[12]
