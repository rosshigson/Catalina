...
'
 ...
 long ' align long
C_sbf0_619c55ae_isspace_L000001 ' <symbol:isspace>
 jmp #PSHM
 long $800000 ' save registers
 cmps r2,  #32 wz
 jmp #BR_Z
 long @C_sbf0_619c55ae_isspace_L000001_8 ' EQI4
 cmps r2,  #9 wz
 jmp #BR_Z
 long @C_sbf0_619c55ae_isspace_L000001_8 ' EQI4
 cmps r2,  #13 wz
 ...
 cmps r2,  #10 wz
 jmp #BRNZ
 long @C_sbf0_619c55ae_isspace_L000001_4 ' NEI4
C_sbf0_619c55ae_isspace_L000001_8
 mov r23, #1 ' reg <- coni
 jmp #JMPA
 long @C_sbf0_619c55ae_isspace_L000001_5 ' JUMPV addrg
C_sbf0_619c55ae_isspace_L000001_4
 mov r23, #0 ' reg <- coni
C_sbf0_619c55ae_isspace_L000001_5
 mov r0, r23 ' CVI, CVU or LOAD
' C_sbf0_619c55ae_isspace_L000001_2 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 long ' align long
C_sbf01_619c55ae_trim_L000009 ' <symbol:trim>
 jmp #PSHM
 long $c00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 jmp #JMPA
 long @C_sbf01_619c55ae_trim_L000009_12 ' JUMPV addrg
C_sbf01_619c55ae_trim_L000009_11
 adds r23, #1 ' ADDP4 coni
C_sbf01_619c55ae_trim_L000009_12
 rdbyte r22, r23 ' reg <- INDIRU1 reg
 mov r2, r22 ' CVUI
 and r2, cviu_m1 ' zero extend
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sbf0_619c55ae_isspace_L000001 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_sbf01_619c55ae_trim_L000009_11 ' NEI4
 mov r0, r23 ' CVI, CVU or LOAD
' C_sbf01_619c55ae_trim_L000009_10 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 long ' align long
C_sbf02_619c55ae__scanf_gets_L000014 ' <symbol:_scanf_gets>
 jmp #PSHM
 ...
 jmp #JMPA
 long @C_sbf02_619c55ae__scanf_gets_L000014_17 ' JUMPV addrg
C_sbf02_619c55ae__scanf_gets_L000014_16
...
C_sbf02_619c55ae__scanf_gets_L000014_17
 mov r22, r19 ' CVI, CVU or LOAD
 mov r19, r22
 sub r19, #1 ' SUBU4 coni
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sbf02_619c55ae__scanf_gets_L000014_19 ' EQU4
 cmps r17,  #0 wz
 jmp #BRNZ
 long @C_sbf02_619c55ae__scanf_gets_L000014_16 ' NEI4
 rdbyte r22, r23 ' reg <- INDIRU1 reg
 mov r2, r22 ' CVUI
 and r2, cviu_m1 ' zero extend
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_sbf02_619c55ae__scanf_gets_L000014_16 ' EQI4
C_sbf02_619c55ae__scanf_gets_L000014_19
 cmps r17,  #0 wz
 jmp #BRNZ
 long @C_sbf02_619c55ae__scanf_gets_L000014_20 ' NEI4
 mov r22, #0 ' reg <- coni
 wrbyte r22, r21 ' ASGNU1 reg reg
C_sbf02_619c55ae__scanf_gets_L000014_20
 mov r0, r23 ' CVI, CVU or LOAD
' C_sbf02_619c55ae__scanf_gets_L000014_15 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN
...
C__doscanf_23
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sbf01_619c55ae_trim_L000009 ' CALL addrg
...
C__doscanf_46
 ...
 jmp #CALA
 long @C_sbf02_619c55ae__scanf_gets_L000014
