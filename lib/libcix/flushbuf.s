...
'
 ...
 long ' align long
C_sa9g_5f5d7bbe_do_write_L000003 ' <symbol:do_write>
 jmp #PSHM
 ...
 jmp #JMPA
 long @C_sa9g_5f5d7bbe_do_write_L000003_6 ' JUMPV addrg
C_sa9g_5f5d7bbe_do_write_L000003_5
 subs r19, r17 ' SUBI/P (1)
 adds r21, r17 ' ADDI/P (2)
C_sa9g_5f5d7bbe_do_write_L000003_6
 ...
 cmps r0,  #0 wz,wc
 jmp #BRBE
 long @C_sa9g_5f5d7bbe_do_write_L000003_8 ' LEI4
 cmps r17, r19 wz,wc
 jmp #BR_B
 long @C_sa9g_5f5d7bbe_do_write_L000003_5 ' LTI4
C_sa9g_5f5d7bbe_do_write_L000003_8
 cmps r17,  #0 wz,wc
 jmp #BRBE
 long @C_sa9g_5f5d7bbe_do_write_L000003_10 ' LEI4
 mov r15, #1 ' reg <- coni
 jmp #JMPA
 long @C_sa9g_5f5d7bbe_do_write_L000003_11 ' JUMPV addrg
C_sa9g_5f5d7bbe_do_write_L000003_10
 mov r15, #0 ' reg <- coni
C_sa9g_5f5d7bbe_do_write_L000003_11
 mov r0, r15 ' CVI, CVU or LOAD
' C_sa9g_5f5d7bbe_do_write_L000003_4 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 long ' align long
C_sa9g1_5f5d7bbe_get_buf_L000012 ' <symbol:get_buf>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r22, r20 wz
 jmp #BRNZ
 long @C_sa9g1_5f5d7bbe_get_buf_L000012_14 ' NEI4
...
C_sa9g1_5f5d7bbe_get_buf_L000012_14
 jmp #LODI
 long @C___iolock
 mov r22, RI ' reg <- INDIRI4 addrg
 jmp #LODL
 ...
 cmps r22, r20 wz
 jmp #BRNZ
 long @C_sa9g1_5f5d7bbe_get_buf_L000012_16 ' NEI4
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_sa9g1_5f5d7bbe_get_buf_L000012_13 ' JUMPV addrg
C_sa9g1_5f5d7bbe_get_buf_L000012_16
 jmp #LODI
 long @C___iolock
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sa9g1_5f5d7bbe_get_buf_L000012_18 ' NEI4
 jmp #LODL
 long @C___iobuff
 mov BC, FP
 sub BC, #-(-4)
 ...
 jmp #JMPA
 long @C_sa9g1_5f5d7bbe_get_buf_L000012_19 ' JUMPV addrg
C_sa9g1_5f5d7bbe_get_buf_L000012_18
 jmp #LODL
 long 0
 mov r22, RI ' reg <- con
 jmp #LODF
...
C_sa9g1_5f5d7bbe_get_buf_L000012_19
 jmp #LODI
 long @C___iolock
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_sa9g1_5f5d7bbe_get_buf_L000012_13
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C___flushbuf_41
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_sa9g1_5f5d7bbe_get_buf_L000012 ' CALL addrg
 mov r20, r21
...
C___flushbuf_62
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_sa9g_5f5d7bbe_do_write_L000003
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C___flushbuf_58 ' NEI4
