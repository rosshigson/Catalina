...
DAT ' initialized data segment
 ...
 long ' align long
C_sa6c_616ac836_s8base_L000002 ' <symbol:s8base>
 long $0

 long ' align long
C_sa6c1_616ac836_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 long ' align long
C_sa6c3_616ac836_pinclear_L000005 ' <symbol:pinclear>
 jmp #PSHM
 ...
 long @C__wrpin
 add SP, #4 ' CALL addrg
' C_sa6c3_616ac836_pinclear_L000005_6 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 long ' align long
C_sa6c4_616ac836_pinstart_L000007 ' <symbol:pinstart>
 jmp #PSHM
...
' C_sa6c4_616ac836_pinstart_L000007_8 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 long ' align long
C_sa6c5_616ac836_pinconfig_L000009 ' <symbol:pinconfig>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r17,  #0 wz
 jmp #BRNZ
 long @C_sa6c5_616ac836_pinconfig_L000009_11 ' NEI4
 mov r22, #62 ' reg <- coni
 jmp #LODF
 long -4
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sa6c5_616ac836_pinconfig_L000009_12 ' EQU4
 mov r22, FP
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 jmp #JMPA
 long @C_sa6c5_616ac836_pinconfig_L000009_12 ' JUMPV addrg
C_sa6c5_616ac836_pinconfig_L000009_11
 ...
 cmps r13,  #0 wz,wc
 jmp #BR_B
 long @C_sa6c5_616ac836_pinconfig_L000009_15 ' LTI4
 cmps r13,  #3 wz,wc
 jmp #BR_A
 long @C_sa6c5_616ac836_pinconfig_L000009_15 ' GTI4
 mov r22, r13
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_sa6c5_616ac836_pinconfig_L000009_22_L000024
...
DAT ' const data segment
 ...
 long ' align long
C_sa6c5_616ac836_pinconfig_L000009_22_L000024 ' <symbol:22>
 long @C_sa6c5_616ac836_pinconfig_L000009_16
 long @C_sa6c5_616ac836_pinconfig_L000009_19
 long @C_sa6c5_616ac836_pinconfig_L000009_20
 long @C_sa6c5_616ac836_pinconfig_L000009_21

' Catalina Code

DAT ' code segment
C_sa6c5_616ac836_pinconfig_L000009_19
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODL
 ...
 wrlong r22, RI ' ASGNU4 addrl reg
 jmp #JMPA
 long @C_sa6c5_616ac836_pinconfig_L000009_16 ' JUMPV addrg
C_sa6c5_616ac836_pinconfig_L000009_20
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODL
 ...
 jmp #JMPA
 long @C_sa6c5_616ac836_pinconfig_L000009_16 ' JUMPV addrg
C_sa6c5_616ac836_pinconfig_L000009_21
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODL
 ...
 long -4
 wrlong r22, RI ' ASGNU4 addrl reg
C_sa6c5_616ac836_pinconfig_L000009_15
C_sa6c5_616ac836_pinconfig_L000009_16
C_sa6c5_616ac836_pinconfig_L000009_12
 ...
 jmp #CALA
 long @C_sa6c4_616ac836_pinstart_L000007
 add SP, #12 ' CALL addrg
' C_sa6c5_616ac836_pinconfig_L000009_10 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 long ' align long
C_sa6c8_616ac836_p_config_L000025 ' <symbol:p_config>
 jmp #NEWF
 jmp #PSHM
 ...
 jmp #LODI
 long @C_sa6c_616ac836_s8base_L000002
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_sa6c8_616ac836_p_config_L000025_26 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 long ' align long
C_sa6c9_616ac836_autoinitialize_L000027 ' <symbol:autoinitialize>
 jmp #PSHM
 long $fea800 ' save registers
 jmp #LODL
 long @C_sa6c2_616ac836_txrxbuff_L000004
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sa6c9_616ac836_autoinitialize_L000027_29 ' EQU4
 mov r15, #0 ' reg <- coni
C_sa6c9_616ac836_autoinitialize_L000027_31
 mov r21, r15
 ...
 cmps r23,  #0 wz,wc
 jmp #BR_B
 long @C_sa6c9_616ac836_autoinitialize_L000027_35 ' LTI4
 cmps r23,  #63 wz,wc
 jmp #BR_A
 long @C_sa6c9_616ac836_autoinitialize_L000027_35 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 jmp #LODI
 long @C_sa6c_616ac836_s8base_L000002
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_sa6c5_616ac836_pinconfig_L000009
 add SP, #12 ' CALL addrg
 mov r2, r19
 ...
 jmp #CALA
 long @C_sa6c8_616ac836_p_config_L000025
 add SP, #20 ' CALL addrg
C_sa6c9_616ac836_autoinitialize_L000027_35
 ...
 cmps r23,  #0 wz,wc
 jmp #BR_B
 long @C_sa6c9_616ac836_autoinitialize_L000027_37 ' LTI4
 cmps r23,  #63 wz,wc
 jmp #BR_A
 long @C_sa6c9_616ac836_autoinitialize_L000027_37 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 jmp #LODI
 long @C_sa6c_616ac836_s8base_L000002
 ...
 long @C_sa6c8_616ac836_p_config_L000025
 add SP, #20 ' CALL addrg
C_sa6c9_616ac836_autoinitialize_L000027_37
 add r19, #128 ' ADDU4 coni
 add r17, #128 ' ADDU4 coni
' C_sa6c9_616ac836_autoinitialize_L000027_32 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
 cmps r15,  #8 wz,wc
 jmp #BR_B
 long @C_sa6c9_616ac836_autoinitialize_L000027_31 ' LTI4
C_sa6c9_616ac836_autoinitialize_L000027_29
' C_sa6c9_616ac836_autoinitialize_L000027_28 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 long ' align long
C_sa6ca_616ac836_initialize_L000039 ' <symbol:initialize>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sa6ca_616ac836_initialize_L000039_41 ' NEU4
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_sa6ca_616ac836_initialize_L000039_43 ' LTI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 ...
 jmp #LODL
 long @C_sa6c1_616ac836_lock_L000003
 mov r20, RI ' reg <- addrg
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sa6ca_616ac836_initialize_L000039_45 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_sa6ca_616ac836_initialize_L000039_46 ' LTI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODI
 ...
 jmp #JMPA
 long @C_sa6ca_616ac836_initialize_L000039_46 ' JUMPV addrg
C_sa6ca_616ac836_initialize_L000039_45
 jmp #LODL
 long @C_sa6c1_616ac836_lock_L000003
 mov r22, RI ' reg <- addrg
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 long @C_sa6c1_616ac836_lock_L000003
 wrlong r22, RI ' ASGNI4 addrg reg
C_sa6ca_616ac836_initialize_L000039_46
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_sa6c9_616ac836_autoinitialize_L000027 ' CALL addrg
C_sa6ca_616ac836_initialize_L000039_43
C_sa6ca_616ac836_initialize_L000039_41
' C_sa6ca_616ac836_initialize_L000039_40 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_s8_closeport ' <symbol:s8_closeport>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_sa6ca_616ac836_initialize_L000039 ' CALL addrg
C_s8_closeport_50
 cmp r23,  #8 wz,wc 
 jmp #BRAE
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_sa6c3_616ac836_pinclear_L000005 ' CALL addrg
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 jmp #LODI
...
DAT ' uninitialized data segment
 ...
 long ' align long
C_sa6c2_616ac836_txrxbuff_L000004 ' <symbol:txrxbuff>
 byte 0[1024]
