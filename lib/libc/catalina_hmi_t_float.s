...
C_itoa ' <symbol:itoa>
 ...
 jmp #LODL
 long @C_s16k_6132d0a2_itoa_buf_L000001+12-1
...
' C_itoa_2 ' (symbol refcount = 0)
 ...
 long ' align long
C_s16k1_6132d0a2_N_anO_rI_nf_L000012 ' <symbol:NanOrInf>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmp r20, r22 wz
 jmp #BRNZ
 long @C_s16k1_6132d0a2_N_anO_rI_nf_L000012_14 ' NEU4
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s16k1_6132d0a2_N_anO_rI_nf_L000012_16 ' NEU4
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODL
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_s16k1_6132d0a2_N_anO_rI_nf_L000012_18 ' EQU4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r21, r22
 adds r21, #1 ' ADDP4 coni
 mov r20, #45 ' reg <- coni
 wrbyte r20, r22 ' ASGNU1 reg reg
C_s16k1_6132d0a2_N_anO_rI_nf_L000012_18
 jmp #LODL
 long @C_s16k1_6132d0a2_N_anO_rI_nf_L000012_20_L000021
 ...
 jmp #JMPA
 long @C_s16k1_6132d0a2_N_anO_rI_nf_L000012_13 ' JUMPV addrg
C_s16k1_6132d0a2_N_anO_rI_nf_L000012_16
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 jmp #LODL
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_s16k1_6132d0a2_N_anO_rI_nf_L000012_22 ' EQU4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r21, r22
 adds r21, #1 ' ADDP4 coni
 mov r20, #45 ' reg <- coni
 wrbyte r20, r22 ' ASGNU1 reg reg
C_s16k1_6132d0a2_N_anO_rI_nf_L000012_22
 jmp #LODL
 long @C_s16k1_6132d0a2_N_anO_rI_nf_L000012_24_L000025
 mov r2, RI ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 jmp #JMPA
 long @C_s16k1_6132d0a2_N_anO_rI_nf_L000012_13 ' JUMPV addrg
C_s16k1_6132d0a2_N_anO_rI_nf_L000012_14
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
C_s16k1_6132d0a2_N_anO_rI_nf_L000012_13
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
...
C_t_float_27
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s16k1_6132d0a2_N_anO_rI_nf_L000012
 add SP, #4 ' CALL addrg
...
DAT ' uninitialized data segment
 ...
 long ' align long
C_s16k_6132d0a2_itoa_buf_L000001 ' <symbol:itoa_buf>
 byte 0[12]
...
C_t_float_33_L000034 ' <symbol:33>
 ...
 long ' align long
C_s16k1_6132d0a2_N_anO_rI_nf_L000012_24_L000025 ' <symbol:24>
 byte 110
 byte 97
 byte 110
 byte 0
 ...
 long ' align long
C_s16k1_6132d0a2_N_anO_rI_nf_L000012_20_L000021 ' <symbol:20>
 byte 105
 byte 110
 byte 102
 byte 0
