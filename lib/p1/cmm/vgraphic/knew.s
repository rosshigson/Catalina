...
C_gk_new ' <symbol:gk_new>
 ...
 alignl ' align long
 long I32_BRNZ + (@C_gk_new_3)<<S32 ' NEU4 reg coni
 alignl ' align long
...
C_gk_new_3
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_gk_new_5)<<S32 ' EQU4 reg coni
 alignl ' align long
 long I32_LODI + (@C_kb_block)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 ...
 alignl ' align long
 long I32_CALA + (@C_gk_wait)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_gk_new_2)<<S32 ' JUMPV addrg
 alignl ' align long
C_gk_new_5
