...
'
 ...
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003 ' <symbol:o_collect>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_8)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (105)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sl54_67e3468b_o_collect_L000003_13)<<S32 ' GTI4 reg coni
' C_sl54_67e3468b_o_collect_L000003_12 ' (symbol refcount = 0)
 alignl ' align long
 ...
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sl54_67e3468b_o_collect_L000003_5)<<S32 ' LTI4 reg coni
' C_sl54_67e3468b_o_collect_L000003_14 ' (symbol refcount = 0)
 alignl ' align long
 long I32_MOVI + RI<<D32 + (98)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_11)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (100)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_9)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_sl54_67e3468b_o_collect_L000003_5)<<S32 ' JUMPV addrg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_13
 alignl ' align long
 long I32_MOVI + RI<<D32 + (111)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_10)<<S32 ' EQI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_sl54_67e3468b_o_collect_L000003_5)<<S32 ' LTI4 reg coni
' C_sl54_67e3468b_o_collect_L000003_15 ' (symbol refcount = 0)
 alignl ' align long
 ...
 long I32_JMPA + (@C_sl54_67e3468b_o_collect_L000003_5)<<S32 ' JUMPV addrg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_8
 word I16A_MOVI + (r13)<<D16A + (16)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sl54_67e3468b_o_collect_L000003_6)<<S32 ' JUMPV addrg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_9
 word I16A_MOVI + (r13)<<D16A + (10)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sl54_67e3468b_o_collect_L000003_6)<<S32 ' JUMPV addrg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_10
 word I16A_MOVI + (r13)<<D16A + (8)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sl54_67e3468b_o_collect_L000003_6)<<S32 ' JUMPV addrg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_11
 word I16A_MOVI + (r13)<<D16A + (2)<<S16A ' reg <- coni
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_5
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_6
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_18)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (43)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_16)<<S32 ' NEI4 reg coni
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_18
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_19)<<S32 ' EQI4 reg coni
 ...
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_19
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_16
 word I16A_CMPSI + (r21)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_21)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_21)<<S32 ' NEI4 reg coni
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_23)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 ...
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_23
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 long I32_MOVI + RI<<D32 + (120)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_25)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (88)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_36)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r13)<<D16A + (8)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sl54_67e3468b_o_collect_L000003_36)<<S32 ' JUMPV addrg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_25
 word I16A_CMPSI + (r21)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_36)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r15)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDP4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 ...
 long I32_JMPA + (@C_sl54_67e3468b_o_collect_L000003_36)<<S32 ' JUMPV addrg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_21
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 long I32_MOVI + RI<<D32 + (105)<<S32
 ...
 long I32_JMPA + (@C_sl54_67e3468b_o_collect_L000003_36)<<S32 ' JUMPV addrg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_35
 word I16A_CMPSI + (r13)<<D16A + (10)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_42)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_sl54_67e3468b_o_collect_L000003_45)<<S32 ' LTU4 reg coni
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_42
 word I16A_CMPSI + (r13)<<D16A + (16)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_44)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_45)<<S32 ' NEI4 reg coni
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_44
 word I16A_CMPSI + (r13)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_47)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((48)&$7FFFF)<<S32 ' reg <- cons
 ...
 alignl ' align long
 long I32_BRAE + (@C_sl54_67e3468b_o_collect_L000003_47)<<S32 ' GEU4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (56)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sl54_67e3468b_o_collect_L000003_45)<<S32 ' LTI4 reg coni
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_47
 word I16A_CMPSI + (r13)<<D16A + (2)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_37)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((48)&$7FFFF)<<S32 ' reg <- cons
 ...
 word I16A_CMPI + (r20)<<D16A + (10)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_sl54_67e3468b_o_collect_L000003_37)<<S32 ' GEU4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (50)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRAE + (@C_sl54_67e3468b_o_collect_L000003_37)<<S32 ' GEI4 reg coni
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_45
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r15)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDP4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_39)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 ...
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_39
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_36
 word I16A_CMPSI + (r21)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_35)<<S32 ' NEI4 reg coni
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_37
 word I16A_CMPSI + (r21)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_50)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_NEGI + (r20)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sl54_67e3468b_o_collect_L000003_50)<<S32 ' EQI4 reg reg
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 word I16B_LODF + ((8)&$1FF)<<S16B
 ...
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_50
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 long I32_MOVI + RI<<D32 + (105)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sl54_67e3468b_o_collect_L000003_52)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r13)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sl54_67e3468b_o_collect_L000003_52
...
' C_sl54_67e3468b_o_collect_L000003_4 ' (symbol refcount = 0)
...
C__doscan_131
 ...
 alignl ' align long
 long I32_CALA + (@C_sl54_67e3468b_o_collect_L000003)<<S32
