...
C_s4_rxtime ' <symbol:s4_rxtime>
 ...
 alignl ' align long
 long I32_JMPA + (@C_s4_rxtime_3)<<S32 ' JUMPV addrg
 alignl ' align long
C_s4_rxtime_2
 ...
 alignl ' align long
 long I32_BRAE + (@C_s4_rxtime_7)<<S32 ' GEI4 reg coni
 alignl ' align long
 long I32_CALA + (@C__cnt)<<S32 ' CALL addrg
 ...
 alignl ' align long
 long I32_BRBE + (@C_s4_rxtime_5)<<S32 ' LEU4 reg reg
 alignl ' align long
C_s4_rxtime_7
 alignl ' align long
 long I32_JMPA + (@C_s4_rxtime_4)<<S32 ' JUMPV addrg
 alignl ' align long
C_s4_rxtime_5
 alignl ' align long
C_s4_rxtime_3
 alignl ' align long
 long I32_JMPA + (@C_s4_rxtime_2)<<S32 ' JUMPV addrg
 alignl ' align long
C_s4_rxtime_4
