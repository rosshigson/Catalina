...
' Catalina Export s4_hex

 alignl ' align long
C_s4_hex ' <symbol:s4_hex>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRAE + (@C_s4_hex_2)<<S32 ' GEI4 reg coni
 word I16A_MOVI + (r19)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
C_s4_hex_2
 word I16A_CMPSI + (r19)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s4_hex_4)<<S32 ' LEI4 reg coni
...
C_s4_hex_4
 ...
 alignl ' align long
 long I32_JMPA + (@C_s4_hex_9)<<S32 ' JUMPV addrg
 alignl ' align long
C_s4_hex_6
 ...
 alignl ' align long
 long I32_BRBE + (@C_s4_hex_10)<<S32 ' LEI4 reg coni
...
' C_s4_hex_7 ' (symbol refcount = 0)
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
C_s4_hex_9
 word I16A_CMPS + (r15)<<D16A + (r19)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s4_hex_6)<<S32 ' LTI4 reg reg
' C_s4_hex_1 ' (symbol refcount = 0)
