...
'
 ...
 alignl ' align long
C_s6dc7_66c68c58_recalculate_L000008 ' <symbol:recalculate>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODA + (@C_s6dc_66c68c58_old_freq_L000001)<<S32
 ...
 word I16B_DIVU ' DIVU
 alignl ' align long
 long I32_LODA + (@C_s6dc1_66c68c58_cnt_usec_L000002)<<S32
 ...
 word I16B_DIVU ' DIVU
 alignl ' align long
 long I32_LODA + (@C_s6dc2_66c68c58_cnt_msec_L000003)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNU4 addrg reg
 ...
 alignl ' align long
 long I32_LODA + (@C_s6dc3_66c68c58_min_tick_L000004)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNU4 addrg reg
 alignl ' align long
 ...
 word I16B_DIVU ' DIVU
 alignl ' align long
 long I32_LODA + (@C_s6dc4_66c68c58_min_usec_L000005)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNU4 addrg reg
 alignl ' align long
 long I32_LODI + (@C_s6dc2_66c68c58_cnt_msec_L000003)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRU4 addrg
 ...
 word I16B_DIVU ' DIVU
 alignl ' align long
 long I32_LODA + (@C_s6dc5_66c68c58_min_msec_L000006)<<S32
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNU4 addrg reg
' C_s6dc7_66c68c58_recalculate_L000008_9 ' (symbol refcount = 0)
...
C_min_waitus ' <symbol:min_waitus>
 ...
 alignl ' align long
 long I32_LODI + (@C_s6dc_66c68c58_old_freq_L000001)<<S32
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_s6dc7_66c68c58_recalculate_L000008)<<S32 ' CALL addrg
 alignl ' align long
C_min_waitus_11
 alignl ' align long
 long I32_LODI + (@C_s6dc4_66c68c58_min_usec_L000005)<<S32
...
C_min_waitms_14
 alignl ' align long
 long I32_LODI + (@C_s6dc5_66c68c58_min_msec_L000006)<<S32
 word I16A_MOV + (r0)<<D16A + RI<<S16A ' reg <- INDIRU4 addrg
...
C__waitus_23
 ...
 alignl ' align long
 long I32_LODI + (@C_s6dc6_66c68c58_overhead_L000007)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRU4 addrg
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_s6dc6_66c68c58_overhead_L000007 ' <symbol:overhead>
 byte 0[4]

 alignl ' align long
C_s6dc5_66c68c58_min_msec_L000006 ' <symbol:min_msec>
 byte 0[4]

 alignl ' align long
C_s6dc4_66c68c58_min_usec_L000005 ' <symbol:min_usec>
 byte 0[4]

 alignl ' align long
C_s6dc3_66c68c58_min_tick_L000004 ' <symbol:min_tick>
 byte 0[4]

 alignl ' align long
C_s6dc2_66c68c58_cnt_msec_L000003 ' <symbol:cnt_msec>
 byte 0[4]

 alignl ' align long
C_s6dc1_66c68c58_cnt_usec_L000002 ' <symbol:cnt_usec>
 byte 0[4]

 alignl ' align long
C_s6dc_66c68c58_old_freq_L000001 ' <symbol:old_freq>
 byte 0[4]
