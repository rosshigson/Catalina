...
C_puts ' <symbol:puts>
 ...
 alignl ' align long
 long I32_JMPA + (@C_puts_3)<<S32 ' JUMPV addrg
 alignl ' align long
C_puts_2
 ...
 alignl ' align long
 long I32_BRNZ + (@C_puts_5)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_puts_1)<<S32 ' JUMPV addrg
 alignl ' align long
C_puts_5
...
C_puts_3
 ...
 alignl ' align long
 long I32_BRNZ + (@C_puts_2)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_CMPS + (r0)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_puts_7)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_puts_1)<<S32 ' JUMPV addrg
