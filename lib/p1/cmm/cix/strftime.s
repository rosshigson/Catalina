...
'
 ...
 alignl ' align long
C_s9v0_67d10f5d_s_prnt_L000001 ' <symbol:s_prnt>
 alignl ' align long
 long I32_PSHM + $500000<<S32 ' save registers
 alignl ' align long
 long I32_JMPA + (@C_s9v0_67d10f5d_s_prnt_L000001_4)<<S32 ' JUMPV addrg
 alignl ' align long
C_s9v0_67d10f5d_s_prnt_L000001_3
 word I16A_CMPI + (r4)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s9v0_67d10f5d_s_prnt_L000001_6)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s9v0_67d10f5d_s_prnt_L000001_5)<<S32 ' JUMPV addrg
 alignl ' align long
C_s9v0_67d10f5d_s_prnt_L000001_6
 ...
 alignl ' align long
C_s9v0_67d10f5d_s_prnt_L000001_4
 word I16A_CMPSI + (r2)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s9v0_67d10f5d_s_prnt_L000001_3)<<S32 ' GTI4 reg coni
 word I16A_CMPSI + (r2)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_s9v0_67d10f5d_s_prnt_L000001_8)<<S32 ' GEI4 reg coni
 word I16A_RDBYTE + (r22)<<D16A + (r3)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s9v0_67d10f5d_s_prnt_L000001_3)<<S32 ' NEI4 reg coni
 alignl ' align long
C_s9v0_67d10f5d_s_prnt_L000001_8
 alignl ' align long
C_s9v0_67d10f5d_s_prnt_L000001_5
 word I16A_MOV + (r0)<<D16A + (r5)<<S16A ' CVI, CVU or LOAD
' C_s9v0_67d10f5d_s_prnt_L000001_2 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_s9v01_67d10f5d_u_prnt_L000009 ' <symbol:u_prnt>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s9v01_67d10f5d_u_prnt_L000009_13)<<S32 ' GTI4 reg coni
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_s9v01_67d10f5d_u_prnt_L000009_11)<<S32 ' GEI4 reg coni
 word I16A_CMPI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s9v01_67d10f5d_u_prnt_L000009_11)<<S32 ' EQU4 reg coni
 alignl ' align long
C_s9v01_67d10f5d_u_prnt_L000009_13
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPI + (r21)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s9v01_67d10f5d_u_prnt_L000009_15)<<S32 ' EQU4 reg coni
 word I16A_MOV + (r15)<<D16A + (r21)<<S16A
 word I16A_SUBI + (r15)<<D16A + (1)<<S16A ' SUBU4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_s9v01_67d10f5d_u_prnt_L000009_16)<<S32 ' JUMPV addrg
 alignl ' align long
C_s9v01_67d10f5d_u_prnt_L000009_15
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_s9v01_67d10f5d_u_prnt_L000009_16
 word I16A_MOV + (r4)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r5)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_s9v01_67d10f5d_u_prnt_L000009)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 word I16A_MOV + (r23)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_s9v01_67d10f5d_u_prnt_L000009_11
 word I16A_CMPI + (r21)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s9v01_67d10f5d_u_prnt_L000009_17)<<S32 ' EQU4 reg coni
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_s9v01_67d10f5d_u_prnt_L000009_17
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_s9v01_67d10f5d_u_prnt_L000009_10 ' (symbol refcount = 0)
...
C_strftime_36
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_s9v0_67d10f5d_s_prnt_L000001)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 word I16A_MOV + (r23)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
