...
' Catalina Export _thread_char

 alignl ' align long
C__thread_char ' <symbol:_thread_char>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
C__thread_char_3
' C__thread_char_4 ' (symbol refcount = 0)
 ...
 alignl ' align long
 long I32_BR_Z + (@C__thread_char_3)<<S32 ' EQI4 reg coni
...
' C__thread_char_2 ' (symbol refcount = 0)
