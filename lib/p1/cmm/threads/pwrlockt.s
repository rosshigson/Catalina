...
C_pthread_rwlock_timedwrlock ' <symbol:pthread_rwlock_timedwrlock>
 ...
 alignl_p1
 long I32_BRNZ + (@C_pthread_rwlock_timedwrlock_5)<<S32 ' NEU4 reg coni
 ...
 alignl_p1
 long I32_JMPA + (@C_pthread_rwlock_timedwrlock_4)<<S32 ' JUMPV addrg
 alignl_label
C_pthread_rwlock_timedwrlock_5
 ...
 alignl_p1
 long I32_JMPA + (@C_pthread_rwlock_timedwrlock_8)<<S32 ' JUMPV addrg
 alignl_label
C_pthread_rwlock_timedwrlock_10
 ...
 alignl_p1
 long I32_BR_B + (@C_pthread_rwlock_timedwrlock_13)<<S32 ' LTI4 reg coni
 word I16A_MOVI + (r19)<<D16A + (1)<<S16A ' reg <- coni
 alignl_p1
 long I32_JMPA + (@C_pthread_rwlock_timedwrlock_12)<<S32 ' JUMPV addrg
 alignl_label
...
C_pthread_rwlock_timedwrlock_11
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_pthread_rwlock_timedwrlock_10)<<S32 ' EQI4 reg coni
 alignl_label
C_pthread_rwlock_timedwrlock_12
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_pthread_rwlock_timedwrlock_15)<<S32 ' EQI4 reg coni
 alignl_p1
...
C_pthread_rwlock_timedwrlock_15
 ...
 alignl_p1
 long I32_BRNZ + (@C_pthread_rwlock_timedwrlock_17)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_pthread_rwlock_timedwrlock_19)<<S32 ' NEU4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r23)<<S16A ' reg <- INDIRI4 reg
 word I16B_LODL + (r3)<<D16B
 alignl_p1
 long @C__P_thread_P_ool ' reg ARG ADDRG
...
C_pthread_rwlock_timedwrlock_8
 alignl_p1
 long I32_JMPA + (@C_pthread_rwlock_timedwrlock_11)<<S32 ' JUMPV addrg
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl_label
