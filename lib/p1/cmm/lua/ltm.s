...
DAT ' const data segment
 ...
 alignl_label
C_s1088_6a9cb6b1_udatatypename_L000015 ' <symbol:udatatypename>
 byte 117
 byte 115
 byte 101
 byte 114
...
C_luaT__typenames_ ' <symbol:luaT_typenames_>
 long @C_s10881_6a9cb6b1_16_L000017
 long @C_s10882_6a9cb6b1_18_L000019
 long @C_s10883_6a9cb6b1_20_L000021
 long @C_s1088_6a9cb6b1_udatatypename_L000015
 long @C_s10884_6a9cb6b1_22_L000023
 long @C_s10885_6a9cb6b1_24_L000025
 long @C_s10886_6a9cb6b1_26_L000027
 long @C_s10887_6a9cb6b1_28_L000029
 long @C_s1088_6a9cb6b1_udatatypename_L000015
 long @C_s10888_6a9cb6b1_30_L000031
 long @C_s10889_6a9cb6b1_32_L000033
 long @C_s1088a_6a9cb6b1_34_L000035
...
DAT ' const data segment
 ...
 alignl_label
C_luaT__init_luaT__eventname_L000038 ' <symbol:luaT_eventname>
...
C_luaT__init_89
 ...
 alignl_p1
 long @C_luaT__init_luaT__eventname_L000038 ' reg <- addrg
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
' C_luaT__init_90 ' (symbol refcount = 0)
 word I16A_ADDSI + (r21)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_CMPSI + (r21)<<D16A + (25)<<S16A
 alignl_p1
 long I32_BR_B + (@C_luaT__init_89)<<S32 ' LTI4 reg coni
' C_luaT__init_36 ' (symbol refcount = 0)
...
C_luaT__gettm ' <symbol:luaT_gettm>
 ...
 alignl_p1
 long I32_BRNZ + (@C_luaT__gettm_94)<<S32 ' NEI4 reg coni
 ...
 long 0 ' RET con
 alignl_p1
 long I32_JMPA + (@C_luaT__gettm_93)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__gettm_94
 word I16B_LODF + ((-8)&$1FF)<<S16B
...
C_luaT__gettmbyobj ' <symbol:luaT_gettmbyobj>
 ...
 alignl_p1
 long I32_BR_Z + (@C_luaT__gettmbyobj_100)<<S32 ' EQI4 reg coni
 word I16A_CMPSI + (r17)<<D16A + (7)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_luaT__gettmbyobj_101)<<S32 ' EQI4 reg coni
 alignl_p1
 long I32_JMPA + (@C_luaT__gettmbyobj_97)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__gettmbyobj_100
 ...
 alignl_p1
 long I32_JMPA + (@C_luaT__gettmbyobj_98)<<S32 ' JUMPV addrg
 alignl_label
...
C_luaT__gettmbyobj_98
 ...
 alignl_p1
 long I32_BR_Z + (@C_luaT__gettmbyobj_103)<<S32 ' EQU4 reg coni
 ...
 alignl_p1
 long I32_JMPA + (@C_luaT__gettmbyobj_104)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__gettmbyobj_103
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 ...
 alignl_label
C_luaT__gettmbyobj_104
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
' C_luaT__gettmbyobj_96 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_luaT__objtypename ' <symbol:luaT_objtypename>
 ...
 alignl_p1
 long I32_BRNZ + (@C_luaT__objtypename_109)<<S32 ' NEI4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r21)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDSI + (r22)<<D16A + (24)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_luaT__objtypename_108)<<S32 ' NEU4 reg coni
 alignl_label
C_luaT__objtypename_109
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDBYTE + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl_p1
 long I32_BRNZ + (@C_luaT__objtypename_106)<<S32 ' NEI4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r21)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_luaT__objtypename_106)<<S32 ' EQU4 reg coni
 alignl_label
C_luaT__objtypename_108
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_luaT__objtypename_110_L000111 ' reg ARG ADDRG
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl_p1
 long I32_CALA + (@C_luaS__new)<<S32
 ...
 alignl_p1
 long I32_BRNZ + (@C_luaT__objtypename_112)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 ...
 alignl_p1
 long I32_JMPA + (@C_luaT__objtypename_105)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__objtypename_112
 alignl_label
...
C_luaT__callT_M_ ' <symbol:luaT_callTM>
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_luaT__callT_M__116)<<S32 ' NEI4 reg coni
 ...
 alignl_p1
 long I32_JMPA + (@C_luaT__callT_M__117)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__callT_M__116
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 word I16A_MOV + (r3)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r4)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl_label
C_luaT__callT_M__117
' C_luaT__callT_M__115 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_luaT__callT_M_res ' <symbol:luaT_callTMres>
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_luaT__callT_M_res_119)<<S32 ' NEI4 reg coni
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl_p1
 long I32_JMPA + (@C_luaT__callT_M_res_120)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__callT_M_res_119
 word I16A_MOVI + (r2)<<D16A + (1)<<S16A ' reg ARG coni
 word I16A_MOV + (r3)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r4)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
...
C_luaT__callT_M_res_120
 ...
 word I16A_RDBYTE + (r20)<<D16A + (r20)<<S16A ' reg <- INDIRU1 reg
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_luaT__callT_M_res_118 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl_p1

 alignl_label
C_s108816_6a9cb6b1_callbinT_M__L000121 ' <symbol:callbinTM>
 alignl_p1
 long I32_NEWF + 0<<S32
 alignl_p1
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s108816_6a9cb6b1_callbinT_M__L000121_123)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_MOV + (r15)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl_label
C_s108816_6a9cb6b1_callbinT_M__L000121_123
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDBYTE + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_s108816_6a9cb6b1_callbinT_M__L000121_125)<<S32 ' NEI4 reg coni
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl_p1
 long I32_JMPA + (@C_s108816_6a9cb6b1_callbinT_M__L000121_122)<<S32 ' JUMPV addrg
 alignl_label
C_s108816_6a9cb6b1_callbinT_M__L000121_125
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 ...
 alignl_label
C_s108816_6a9cb6b1_callbinT_M__L000121_122
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_luaT__trybinT_M_ ' <symbol:luaT_trybinTM>
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl_p1
 long I32_CALA + (@C_s108816_6a9cb6b1_callbinT_M__L000121)<<S32
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_luaT__trybinT_M__128)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r15)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPSI + (r15)<<D16A + (13)<<S16A
 alignl_p1
 long I32_BR_B + (@C_luaT__trybinT_M__130)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r15)<<D16A + (19)<<S16A
 alignl_p1
 long I32_BR_A + (@C_luaT__trybinT_M__130)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl_p1
 long @C_luaT__trybinT_M__140_L000142-52 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
...
DAT ' const data segment
 ...
 alignl_label
C_luaT__trybinT_M__140_L000142 ' <symbol:140>
 long @C_luaT__trybinT_M__133
 long @C_luaT__trybinT_M__133
 long @C_luaT__trybinT_M__133
 long @C_luaT__trybinT_M__133
 long @C_luaT__trybinT_M__133
 long @C_luaT__trybinT_M__130
 long @C_luaT__trybinT_M__133
...
C_luaT__trybinT_M__133
 ...
 alignl_p1
 long I32_BRNZ + (@C_luaT__trybinT_M__134)<<S32 ' NEI4 reg coni
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl_p1
 long I32_JMPA + (@C_luaT__trybinT_M__135)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__trybinT_M__134
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 ...
 alignl_label
C_luaT__trybinT_M__135
 alignl_label
C_luaT__trybinT_M__130
 word I16B_LODL + (r2)<<D16B
 alignl_p1
 long @C_luaT__trybinT_M__138_L000139 ' reg ARG ADDRG
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r5)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
...
' C_luaT__trybinT_M__127 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_luaT__tryconcatT_M_ ' <symbol:luaT_tryconcatTM>
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRNZ + (@C_luaT__tryconcatT_M__145)<<S32 ' NEI4 reg coni
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl_label
C_luaT__tryconcatT_M__145
' C_luaT__tryconcatT_M__144 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_luaT__trybinassocT_M_ ' <symbol:luaT_trybinassocTM>
 ...
 alignl_p1
 long I32_BR_Z + (@C_luaT__trybinassocT_M__148)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r4)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 ...
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 alignl_p1
 long I32_JMPA + (@C_luaT__trybinassocT_M__149)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__trybinassocT_M__148
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((12)&$1FF)<<S16B
 ...
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 alignl_label
C_luaT__trybinassocT_M__149
' C_luaT__trybinassocT_M__147 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
' C_luaT__trybiniT_M__150 ' (symbol refcount = 0)
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
C_luaT__callorderT_M_ ' <symbol:luaT_callorderTM>
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_luaT__callorderT_M__152)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 alignl_p1
 long I32_BR_Z + (@C_luaT__callorderT_M__155)<<S32 ' EQI4 reg coni
 word I16A_MOVI + (r20)<<D16A + (15)<<S16A ' reg <- coni
 word I16A_AND + (r22)<<D16A + (r20)<<S16A ' BANDI/U (1)
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 ...
 alignl_p1
 long I32_JMPA + (@C_luaT__callorderT_M__156)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__callorderT_M__155
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl_label
C_luaT__callorderT_M__156
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 alignl_p1
 long I32_JMPA + (@C_luaT__callorderT_M__151)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__callorderT_M__152
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
...
C_luaT__callorderiT_M__159
 word I16A_CMPSI + (r21)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BR_Z + (@C_luaT__callorderiT_M__160)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNP4 addrl16 reg
 alignl_p1
 long I32_JMPA + (@C_luaT__callorderiT_M__161)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__callorderiT_M__160
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- addrl16
 word I16B_LODF + ((-16)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNP4 addrl16 reg
 alignl_label
C_luaT__callorderiT_M__161
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((-16)&$1FF)<<S16B
 word I16A_RDLONG + (r3)<<D16A + RI<<S16A ' reg ARG INDIR ADDRLi
 word I16B_LODF + ((12)&$1FF)<<S16B
 ...
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_luaT__callorderiT_M__157 ' (symbol refcount = 0)
...
C_luaT__adjustvarargs ' <symbol:luaT_adjustvarargs>
 ...
 alignl_p1
 long I32_BR_A + (@C_luaT__adjustvarargs_163)<<S32 ' GTI4 reg reg
...
' C_luaT__adjustvarargs_164 ' (symbol refcount = 0)
 ...
 word I16A_MOVI + (r15)<<D16A + (1)<<S16A ' reg <- coni
 alignl_p1
 long I32_JMPA + (@C_luaT__adjustvarargs_168)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__adjustvarargs_165
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_MOV + (r18)<<D16A + (r20)<<S16A
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_luaT__adjustvarargs_166 ' (symbol refcount = 0)
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl_label
C_luaT__adjustvarargs_168
 word I16A_CMPS + (r15)<<D16A + (r21)<<S16A
 alignl_p1
 long I32_BRBE + (@C_luaT__adjustvarargs_165)<<S32 ' LEI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r13)<<S16A
 word I16A_SHLI + (r22)<<D16A + (3)<<S16A ' SHLI4 reg coni
...
C_luaT__getvarargs ' <symbol:luaT_getvarargs>
 ...
 alignl_p1
 long I32_BRAE + (@C_luaT__getvarargs_170)<<S32 ' GEI4 reg coni
 ...
 alignl_p1
 long I32_BR_A + (@C_luaT__getvarargs_172)<<S32 ' GTI4 reg reg
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl_p1
 long I32_BRBE + (@C_luaT__getvarargs_174)<<S32 ' LEI4 reg coni
...
' C_luaT__getvarargs_173 ' (symbol refcount = 0)
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_MOV + (r20)<<D16A + (r13)<<S16A
 word I16A_SHLI + (r20)<<D16A + (3)<<S16A ' SHLI4 reg coni
...
C_luaT__getvarargs_170
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl_p1
 long I32_JMPA + (@C_luaT__getvarargs_179)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__getvarargs_176
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A
 word I16A_SHLI + (r22)<<D16A + (3)<<S16A ' SHLI4 reg coni
 ...
 word I16A_RDBYTE + (r20)<<D16A + (r20)<<S16A ' reg <- INDIRU1 reg
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_luaT__getvarargs_177 ' (symbol refcount = 0)
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl_label
C_luaT__getvarargs_179
 word I16A_CMPS + (r15)<<D16A + (r17)<<S16A
 alignl_p1
 long I32_BRAE + (@C_luaT__getvarargs_180)<<S32 ' GEI4 reg reg
 word I16A_CMPS + (r15)<<D16A + (r13)<<S16A
 alignl_p1
 long I32_BR_B + (@C_luaT__getvarargs_176)<<S32 ' LTI4 reg reg
 alignl_label
C_luaT__getvarargs_180
 alignl_p1
 long I32_JMPA + (@C_luaT__getvarargs_184)<<S32 ' JUMPV addrg
 alignl_label
C_luaT__getvarargs_181
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A
 word I16A_SHLI + (r22)<<D16A + (3)<<S16A ' SHLI4 reg coni
 ...
 word I16A_MOVI + (r20)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_luaT__getvarargs_182 ' (symbol refcount = 0)
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl_label
C_luaT__getvarargs_184
 word I16A_CMPS + (r15)<<D16A + (r17)<<S16A
 alignl_p1
 long I32_BR_B + (@C_luaT__getvarargs_181)<<S32 ' LTI4 reg reg
' C_luaT__getvarargs_169 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl_p1
...
DAT ' const data segment
 ...
 alignl_label
C_luaT__trybinT_M__138_L000139 ' <symbol:138>
 byte 112
 byte 101
 byte 114
 byte 102
...
C_luaT__trybinT_M__136_L000137 ' <symbol:136>
 ...
 alignl_label
C_luaT__objtypename_110_L000111 ' <symbol:110>
 byte 95
 byte 95
 byte 110
 byte 97
 ...
 alignl_label
C_luaT__init_87_L000088 ' <symbol:87>
 byte 95
 byte 95
 byte 99
 byte 108
...
C_luaT__init_39_L000040 ' <symbol:39>
 ...
 alignl_label
C_s1088a_6a9cb6b1_34_L000035 ' <symbol:34>
 byte 112
 byte 114
 byte 111
 byte 116
 ...
 alignl_label
C_s10889_6a9cb6b1_32_L000033 ' <symbol:32>
 byte 117
 byte 112
 byte 118
 byte 97
 ...
 alignl_label
C_s10888_6a9cb6b1_30_L000031 ' <symbol:30>
 byte 116
 byte 104
 byte 114
 byte 101
 ...
 alignl_label
C_s10887_6a9cb6b1_28_L000029 ' <symbol:28>
 byte 102
 byte 117
 byte 110
 byte 99
 ...
 alignl_label
C_s10886_6a9cb6b1_26_L000027 ' <symbol:26>
 byte 116
 byte 97
 byte 98
 byte 108
 ...
 alignl_label
C_s10885_6a9cb6b1_24_L000025 ' <symbol:24>
 byte 115
 byte 116
 byte 114
 byte 105
 ...
 alignl_label
C_s10884_6a9cb6b1_22_L000023 ' <symbol:22>
 byte 110
 byte 117
 byte 109
 byte 98
 ...
 alignl_label
C_s10883_6a9cb6b1_20_L000021 ' <symbol:20>
 byte 98
 byte 111
 byte 111
 byte 108
 ...
 alignl_label
C_s10882_6a9cb6b1_18_L000019 ' <symbol:18>
 byte 110
 byte 105
 byte 108
 byte 0
 ...
 alignl_label
C_s10881_6a9cb6b1_16_L000017 ' <symbol:16>
 byte 110
 byte 111
 byte 32
 byte 118
