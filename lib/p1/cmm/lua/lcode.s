...
' C_luaK__semerror_24 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk1_67ea41f0_tonumeral_L000025 ' <symbol:tonumeral>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1_67ea41f0_tonumeral_L000025_27)<<S32 ' EQI4 reg reg
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk1_67ea41f0_tonumeral_L000025_26)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1_67ea41f0_tonumeral_L000025_27
 word I16A_RDLONG + (r23)<<D16A + (r3)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r23)<<D16A + (5)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1_67ea41f0_tonumeral_L000025_35)<<S32 ' EQI4 reg coni
 word I16A_CMPSI + (r23)<<D16A + (6)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1_67ea41f0_tonumeral_L000025_32)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk1_67ea41f0_tonumeral_L000025_29)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1_67ea41f0_tonumeral_L000025_32
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1_67ea41f0_tonumeral_L000025_33)<<S32 ' EQU4 reg coni
 ...
 alignl ' align long
C_sjdk1_67ea41f0_tonumeral_L000025_33
 word I16A_MOVI + R0<<D16A + (1)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk1_67ea41f0_tonumeral_L000025_26)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1_67ea41f0_tonumeral_L000025_35
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1_67ea41f0_tonumeral_L000025_36)<<S32 ' EQU4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r2)<<D16A + RI<<S16A ' ASGNP4 addrl16 reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sjdk1_67ea41f0_tonumeral_L000025_36
 word I16A_MOVI + R0<<D16A + (1)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk1_67ea41f0_tonumeral_L000025_26)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1_67ea41f0_tonumeral_L000025_29
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
C_sjdk1_67ea41f0_tonumeral_L000025_26
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2_67ea41f0_const2val_L000038 ' <symbol:const2val>
 alignl ' align long
...
' C_sjdk2_67ea41f0_const2val_L000038_39 ' (symbol refcount = 0)
...
C_luaK__exp2const_50
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk2_67ea41f0_const2val_L000038)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16B_LODF + ((-12)&$1FF)<<S16B
...
C_luaK__exp2const_43
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk1_67ea41f0_tonumeral_L000025)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
...
DAT ' const data segment
 ...
 alignl ' align long
C_sjdk5_67ea41f0_previousinstruction_L000056_invalidinstr_L000059 ' <symbol:invalidinstruction>
 long $ffffffff
...
DAT ' code segment
 ...
 alignl ' align long
C_sjdk5_67ea41f0_previousinstruction_L000056 ' <symbol:previousinstruction>
 alignl ' align long
 long I32_PSHM + $540000<<S32 ' save registers
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_sjdk5_67ea41f0_previousinstruction_L000056_60)<<S32 ' LEI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 ...
 word I16A_ADDS + (r0)<<D16A + (r20)<<S16A ' ADDI/P (3)
 alignl ' align long
 long I32_JMPA + (@C_sjdk5_67ea41f0_previousinstruction_L000056_57)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk5_67ea41f0_previousinstruction_L000056_60
 word I16B_LODL + (r0)<<D16B
 alignl ' align long
 long @C_sjdk5_67ea41f0_previousinstruction_L000056_invalidinstr_L000059 ' reg <- addrg
 alignl ' align long
C_sjdk5_67ea41f0_previousinstruction_L000056_57
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
C_luaK__nil ' <symbol:luaK_nil>
 ...
 alignl ' align long
 long I32_CALA + (@C_sjdk5_67ea41f0_previousinstruction_L000056)<<S32 ' CALL addrg
...
C_luaK__nil_62
 ...
 alignl ' align long
C_sjdk7_67ea41f0_getjump_L000073 ' <symbol:getjump>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $540000<<S32 ' save registers
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk7_67ea41f0_getjump_L000073_75)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_sjdk7_67ea41f0_getjump_L000073_74)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk7_67ea41f0_getjump_L000073_75
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r20)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16A_ADDS + (r0)<<D16A + (r20)<<S16A ' ADDI/P (3)
 alignl ' align long
C_sjdk7_67ea41f0_getjump_L000073_74
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk8_67ea41f0_fixjump_L000077 ' <symbol:fixjump>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $fe8000<<S32 ' save registers
 ...
 alignl ' align long
 long I32_BR_A + (@C_sjdk8_67ea41f0_fixjump_L000077_81)<<S32 ' GTI4 reg reg
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long 16777216 ' reg <- con
 word I16A_CMPS + (r17)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_sjdk8_67ea41f0_fixjump_L000077_79)<<S32 ' LEI4 reg reg
 alignl ' align long
C_sjdk8_67ea41f0_fixjump_L000077_81
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_sjdk8_67ea41f0_fixjump_L000077_82_L000083 ' reg ARG ADDRG
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (8)<<S16A ' ADDP4 reg coni
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_sjdk8_67ea41f0_fixjump_L000077_79
...
' C_sjdk8_67ea41f0_fixjump_L000077_78 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__concat_90
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk7_67ea41f0_getjump_L000073)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 ...
 alignl ' align long
 long I32_CALA + (@C_sjdk8_67ea41f0_fixjump_L000077)<<S32
...
C_luaK__jump ' <symbol:luaK_jump>
 ...
 alignl ' align long
 long I32_CALA + (@C_sjdk_67ea41f0_codesJ__L000023)<<S32
...
' C_luaK__ret_93 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdka_67ea41f0_condjump_L000098 ' <symbol:condjump>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_sjdka_67ea41f0_condjump_L000098_99 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
' C_luaK__getlabel_100 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdkb_67ea41f0_getjumpcontrol_L000101 ' <symbol:getjumpcontrol>
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_sjdkb_67ea41f0_getjumpcontrol_L000101_103)<<S32 ' LTI4 reg coni
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sjdkb_67ea41f0_getjumpcontrol_L000101_103)<<S32 ' EQI4 reg coni
 word I16A_NEGI + (r22)<<D16A + (-(-4)&$1F)<<S16A ' reg <- conn
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' ADDI/P
 word I16A_ADDS + (r0)<<D16A + (r22)<<S16A ' ADDI/P (3)
 alignl ' align long
 long I32_JMPA + (@C_sjdkb_67ea41f0_getjumpcontrol_L000101_102)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkb_67ea41f0_getjumpcontrol_L000101_103
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_sjdkb_67ea41f0_getjumpcontrol_L000101_102
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkc_67ea41f0_patchtestreg_L000105 ' <symbol:patchtestreg>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $fe0000<<S32 ' save registers
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdkb_67ea41f0_getjumpcontrol_L000101)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r17)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_RDLONG + (r22)<<D16A + (r17)<<S16A ' reg <- INDIRU4 reg
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sjdkc_67ea41f0_patchtestreg_L000105_107)<<S32 ' EQI4 reg coni
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdkc_67ea41f0_patchtestreg_L000105_106)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkc_67ea41f0_patchtestreg_L000105_107
 alignl ' align long
 long I32_MOVI + RI<<D32 + (255)<<S32
 word I16A_CMPS + (r19)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdkc_67ea41f0_patchtestreg_L000105_109)<<S32 ' EQI4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r17)<<S16A ' reg <- INDIRU4 reg
 word I16A_SHRI + (r22)<<D16A + (16)<<S16A ' SHRU4 reg coni
 alignl ' align long
 long I32_MOVI + (r20)<<D32 +(255)<<S32 ' reg <- conli
 ...
 word I16A_CMPS + (r19)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdkc_67ea41f0_patchtestreg_L000105_109)<<S32 ' EQI4 reg reg
 word I16A_RDLONG + (r22)<<D16A + (r17)<<S16A ' reg <- INDIRU4 reg
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long $ffff807f ' reg <- con
 ...
 word I16A_WRLONG + (r22)<<D16A + (r17)<<S16A ' ASGNU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdkc_67ea41f0_patchtestreg_L000105_110)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkc_67ea41f0_patchtestreg_L000105_109
 word I16A_RDLONG + (r22)<<D16A + (r17)<<S16A ' reg <- INDIRU4 reg
 ...
 word I16A_WRLONG + (r22)<<D16A + (r17)<<S16A ' ASGNU4 reg reg
 alignl ' align long
C_sjdkc_67ea41f0_patchtestreg_L000105_110
 word I16A_MOVI + R0<<D16A + (1)<<S16A ' RET coni
 alignl ' align long
C_sjdkc_67ea41f0_patchtestreg_L000105_106
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkd_67ea41f0_removevalues_L000111 ' <symbol:removevalues>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 word I16A_MOV + (r21)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl ' align long
 long I32_JMPA + (@C_sjdkd_67ea41f0_removevalues_L000111_116)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkd_67ea41f0_removevalues_L000111_113
 alignl ' align long
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdkc_67ea41f0_patchtestreg_L000105)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
' C_sjdkd_67ea41f0_removevalues_L000111_114 ' (symbol refcount = 0)
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 alignl ' align long
C_sjdkd_67ea41f0_removevalues_L000111_116
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r21)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdkd_67ea41f0_removevalues_L000111_113)<<S32 ' NEI4 reg reg
' C_sjdkd_67ea41f0_removevalues_L000111_112 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdke_67ea41f0_patchlistaux_L000117 ' <symbol:patchlistaux>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 word I16A_MOV + (r17)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl ' align long
 long I32_JMPA + (@C_sjdke_67ea41f0_patchlistaux_L000117_120)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdke_67ea41f0_patchlistaux_L000117_119
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sjdke_67ea41f0_patchlistaux_L000117_122)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r4)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sjdke_67ea41f0_patchlistaux_L000117_123)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdke_67ea41f0_patchlistaux_L000117_122
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r4)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_sjdke_67ea41f0_patchlistaux_L000117_123
 word I16A_MOV + (r23)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_sjdke_67ea41f0_patchlistaux_L000117_120
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r23)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdke_67ea41f0_patchlistaux_L000117_119)<<S32 ' NEI4 reg reg
' C_sjdke_67ea41f0_patchlistaux_L000117_118 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__patchlist ' <symbol:luaK_patchlist>
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdke_67ea41f0_patchlistaux_L000117)<<S32
...
' C_luaK__patchtohere_125 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdkf_67ea41f0_savelineinfo_L000126 ' <symbol:savelineinfo>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $fe8000<<S32 ' save registers
 ...
 alignl ' align long
 long I32_BRAE + (@C_sjdkf_67ea41f0_savelineinfo_L000126_130)<<S32 ' GEI4 reg coni
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjdkf_67ea41f0_savelineinfo_L000126_128)<<S32 ' LTI4 reg coni
 alignl ' align long
C_sjdkf_67ea41f0_savelineinfo_L000126_130
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_sjdkf_67ea41f0_savelineinfo_L000126_131_L000132 ' reg ARG ADDRG
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sjdkf_67ea41f0_savelineinfo_L000126_128
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_sjdkf_67ea41f0_savelineinfo_L000126_133_L000134 ' reg ARG ADDRG
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 ...
 word I16A_ADDSI + (r22)<<D16A + (24)<<S16A ' ADDP4 reg coni
 word I16A_WRLONG + (r19)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
' C_sjdkf_67ea41f0_savelineinfo_L000126_127 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdki_67ea41f0_removelastlineinfo_L000135 ' <symbol:removelastlineinfo>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdki_67ea41f0_removelastlineinfo_L000135_137)<<S32 ' EQI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (24)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16B_LODF + ((-12)&$1FF)<<S16B
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdki_67ea41f0_removelastlineinfo_L000135_138)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdki_67ea41f0_removelastlineinfo_L000135_137
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((36)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r2)<<S16A ' ADDI/P (2)
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sjdki_67ea41f0_removelastlineinfo_L000135_138
' C_sjdki_67ea41f0_removelastlineinfo_L000135_136 ' (symbol refcount = 0)
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkj_67ea41f0_removelastinstruction_L000139 ' <symbol:removelastinstruction>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $d00000<<S32 ' save registers
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjdki_67ea41f0_removelastlineinfo_L000135)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_SUBSI + (r20)<<D16A + (1)<<S16A ' SUBI4 reg coni
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
' C_sjdkj_67ea41f0_removelastinstruction_L000139_140 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__code ' <symbol:luaK_code>
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdkf_67ea41f0_savelineinfo_L000126)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
...
' C_luaK__codeA_sB_x_144 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk_67ea41f0_codesJ__L000023 ' <symbol:codesJ>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $fa0000<<S32 ' save registers
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_sjdk_67ea41f0_codesJ__L000023_145 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkk_67ea41f0_codeextraarg_L000146 ' <symbol:codeextraarg>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $f00000<<S32 ' save registers
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_sjdkk_67ea41f0_codeextraarg_L000146_147 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkl_67ea41f0_luaK__codek_L000148 ' <symbol:luaK_codek>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $e80000<<S32 ' save registers
 ...
 word I16A_CMPS + (r19)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjdkl_67ea41f0_luaK__codek_L000148_150)<<S32 ' GTI4 reg reg
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjdkl_67ea41f0_luaK__codek_L000148_149)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkl_67ea41f0_luaK__codek_L000148_150
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + (r4)<<D16A + (4)<<S16A ' reg ARG coni
 word I16A_MOV + (r5)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdkk_67ea41f0_codeextraarg_L000146)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r0)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
C_sjdkl_67ea41f0_luaK__codek_L000148_149
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
' C_luaK__reserveregs_159 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdkn_67ea41f0_freereg_L000160 ' <symbol:freereg>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $f00000<<S32 ' save registers
 ...
 alignl ' align long
 long I32_BR_B + (@C_sjdkn_67ea41f0_freereg_L000160_162)<<S32 ' LTI4 reg reg
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((52)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r23)<<S16A ' ADDI/P (2)
 word I16A_RDBYTE + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRU1 reg
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sjdkn_67ea41f0_freereg_L000160_162
' C_sjdkn_67ea41f0_freereg_L000160_161 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdko_67ea41f0_freeregs_L000164 ' <symbol:freeregs>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $a80000<<S32 ' save registers
 ...
 alignl ' align long
 long I32_BRBE + (@C_sjdko_67ea41f0_freeregs_L000164_166)<<S32 ' LEI4 reg reg
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdkn_67ea41f0_freereg_L000160)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sjdko_67ea41f0_freeregs_L000164_167)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdko_67ea41f0_freeregs_L000164_166
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_sjdko_67ea41f0_freeregs_L000164_167
' C_sjdko_67ea41f0_freeregs_L000164_165 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkp_67ea41f0_freeexp_L000168 ' <symbol:freeexp>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $e00000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r22)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdkp_67ea41f0_freeexp_L000168_170)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_sjdkp_67ea41f0_freeexp_L000168_170
' C_sjdkp_67ea41f0_freeexp_L000168_169 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkq_67ea41f0_freeexps_L000172 ' <symbol:freeexps>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $ea8000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r22)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdkq_67ea41f0_freeexps_L000172_175)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r17)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 alignl ' align long
 long I32_JMPA + (@C_sjdkq_67ea41f0_freeexps_L000172_176)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkq_67ea41f0_freeexps_L000172_175
 word I16A_NEGI + (r17)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 alignl ' align long
C_sjdkq_67ea41f0_freeexps_L000172_176
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r17)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 word I16A_RDLONG + (r22)<<D16A + (r19)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdkq_67ea41f0_freeexps_L000172_178)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r15)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 alignl ' align long
 long I32_JMPA + (@C_sjdkq_67ea41f0_freeexps_L000172_179)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkq_67ea41f0_freeexps_L000172_178
 word I16A_NEGI + (r15)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 alignl ' align long
C_sjdkq_67ea41f0_freeexps_L000172_179
 word I16B_LODF + ((-12)&$1FF)<<S16B
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdko_67ea41f0_freeregs_L000164)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
' C_sjdkq_67ea41f0_freeexps_L000172_173 ' (symbol refcount = 0)
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkr_67ea41f0_addk_L000180 ' <symbol:addk>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjdkr_67ea41f0_addk_L000180_182)<<S32 ' NEI4 reg coni
 ...
 alignl ' align long
 long I32_BRAE + (@C_sjdkr_67ea41f0_addk_L000180_184)<<S32 ' GEI4 reg reg
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjdkr_67ea41f0_addk_L000180_184)<<S32 ' NEI4 reg reg
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdkr_67ea41f0_addk_L000180_184)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r0)<<D16A + (r13)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjdkr_67ea41f0_addk_L000180_181)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkr_67ea41f0_addk_L000180_184
 alignl ' align long
C_sjdkr_67ea41f0_addk_L000180_182
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r15)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 ...
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_sjdkr_67ea41f0_addk_L000180_186_L000187 ' reg ARG ADDRG
 word I16B_LODL + (r3)<<D16B
 alignl ' align long
 ...
 word I16A_WRLONG + (r0)<<D16A + (r22)<<S16A ' ASGNP4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdkr_67ea41f0_addk_L000180_189)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkr_67ea41f0_addk_L000180_188
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sjdkr_67ea41f0_addk_L000180_189
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPS + (r15)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjdkr_67ea41f0_addk_L000180_188)<<S32 ' LTI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r13)<<S16A
 word I16A_SHLI + (r22)<<D16A + (3)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((48)&$7FFFF)<<S32 ' reg <- cons
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdkr_67ea41f0_addk_L000180_192)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sjdkr_67ea41f0_addk_L000180_192)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkr_67ea41f0_addk_L000180_192
 word I16A_MOV + (r0)<<D16A + (r13)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_sjdkr_67ea41f0_addk_L000180_181
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkt_67ea41f0_stringK__L000193 ' <symbol:stringK>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $fe0000<<S32 ' save registers
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdkr_67ea41f0_addk_L000180)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_sjdkt_67ea41f0_stringK__L000193_194 ' (symbol refcount = 0)
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdku_67ea41f0_luaK__intK__L000195 ' <symbol:luaK_intK>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $f80000<<S32 ' save registers
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_sjdku_67ea41f0_luaK__intK__L000195_196 ' (symbol refcount = 0)
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdkv_67ea41f0_luaK__numberK__L000197 ' <symbol:luaK_numberK>
 alignl ' align long
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdkv_67ea41f0_luaK__numberK__L000197_199)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r3)<<D16A + RI<<S16A ' reg ARG ADDRLi
 ...
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjdkv_67ea41f0_luaK__numberK__L000197_198)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkv_67ea41f0_luaK__numberK__L000197_199
 ...
 alignl ' align long
 long I32_LODI + (@C_sjdkv_67ea41f0_luaK__numberK__L000197_201_L000202)<<S32
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdkv_67ea41f0_luaK__numberK__L000197_204)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-20)&$1FF)<<S16B
 word I16A_RDLONG + (r19)<<D16A + RI<<S16A ' reg <- INDIRF4 addrl16
 alignl ' align long
 long I32_JMPA + (@C_sjdkv_67ea41f0_luaK__numberK__L000197_205)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdkv_67ea41f0_luaK__numberK__L000197_204
 word I16B_LODF + ((-20)&$1FF)<<S16B
 ...
 alignl ' align long
C_sjdkv_67ea41f0_luaK__numberK__L000197_205
 ...
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_sjdkv_67ea41f0_luaK__numberK__L000197_198
 word I16B_POPM + 9<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk11_67ea41f0_boolF__L000206 ' <symbol:boolF>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $c00000<<S32 ' save registers
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_sjdk11_67ea41f0_boolF__L000206_207 ' (symbol refcount = 0)
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk12_67ea41f0_boolT__L000209 ' <symbol:boolT>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $c00000<<S32 ' save registers
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_sjdk12_67ea41f0_boolT__L000209_210 ' (symbol refcount = 0)
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk13_67ea41f0_nilK__L000212 ' <symbol:nilK>
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_sjdk13_67ea41f0_nilK__L000212_213 ' (symbol refcount = 0)
 word I16B_POPM + 5<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk14_67ea41f0_fitsC__L000215 ' <symbol:fitsC>
 alignl ' align long
 long I32_PSHM + $d00000<<S32 ' save registers
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_A + (@C_sjdk14_67ea41f0_fitsC__L000215_218)<<S32 ' GTU4 reg coni
 word I16A_MOVI + (r23)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk14_67ea41f0_fitsC__L000215_219)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk14_67ea41f0_fitsC__L000215_218
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk14_67ea41f0_fitsC__L000215_219
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sjdk14_67ea41f0_fitsC__L000215_216 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk15_67ea41f0_fitsB_x_L000220 ' <symbol:fitsBx>
 alignl ' align long
 long I32_PSHM + $c00000<<S32 ' save registers
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((-65535)&$7FFFF)<<S32 ' reg <- cons
 ...
 alignl ' align long
 long I32_BR_A + (@C_sjdk15_67ea41f0_fitsB_x_L000220_223)<<S32 ' GTI4 reg reg
 alignl ' align long
 ...
 word I16A_MOVI + (r23)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk15_67ea41f0_fitsB_x_L000220_224)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk15_67ea41f0_fitsB_x_L000220_223
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk15_67ea41f0_fitsB_x_L000220_224
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sjdk15_67ea41f0_fitsB_x_L000220_221 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
C_luaK__int ' <symbol:luaK_int>
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjdk15_67ea41f0_fitsB_x_L000220)<<S32 ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
...
C_luaK__int_226
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdku_67ea41f0_luaK__intK__L000195)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdkl_67ea41f0_luaK__codek_L000148)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_luaK__int_227
' C_luaK__int_225 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk16_67ea41f0_luaK__float_L000228 ' <symbol:luaK_float>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $e80000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk16_67ea41f0_luaK__float_L000228_230)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sjdk16_67ea41f0_luaK__float_L000228_231)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk16_67ea41f0_luaK__float_L000228_230
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdkv_67ea41f0_luaK__numberK__L000197)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_sjdk16_67ea41f0_luaK__float_L000228_231
' C_sjdk16_67ea41f0_luaK__float_L000228_229 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232 ' <symbol:const2exp>
 alignl ' align long
 long I32_PSHM + $d00000<<S32 ' save registers
 word I16A_MOV + (r22)<<D16A + (r3)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 alignl ' align long
 long I32_BR_B + (@C_sjdk17_67ea41f0_const2exp_L000232_234)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r23)<<D16A + (4)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjdk17_67ea41f0_const2exp_L000232_243)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sjdk17_67ea41f0_const2exp_L000232_244_L000246 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + RI<<D16A + (r22)<<S16A
 word I16B_JMPI ' JUMPV INDIR reg
 alignl ' align long
...
DAT ' const data segment
 ...
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_244_L000246 ' <symbol:244>
 long @C_sjdk17_67ea41f0_const2exp_L000232_241
 long @C_sjdk17_67ea41f0_const2exp_L000232_239
 long @C_sjdk17_67ea41f0_const2exp_L000232_234
 long @C_sjdk17_67ea41f0_const2exp_L000232_237
 long @C_sjdk17_67ea41f0_const2exp_L000232_242

' Catalina Code

DAT ' code segment
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_243
 word I16A_CMPSI + (r23)<<D16A + (17)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk17_67ea41f0_const2exp_L000232_240)<<S32 ' EQI4 reg coni
 word I16A_CMPSI + (r23)<<D16A + (19)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk17_67ea41f0_const2exp_L000232_238)<<S32 ' EQI4 reg coni
 word I16A_CMPSI + (r23)<<D16A + (20)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk17_67ea41f0_const2exp_L000232_242)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk17_67ea41f0_const2exp_L000232_234)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_237
 ...
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk17_67ea41f0_const2exp_L000232_235)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_238
 ...
 long I32_JMPA + (@C_sjdk17_67ea41f0_const2exp_L000232_235)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_239
 word I16A_MOVI + (r22)<<D16A + (3)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r2)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk17_67ea41f0_const2exp_L000232_235)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_240
 word I16A_MOVI + (r22)<<D16A + (2)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r2)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk17_67ea41f0_const2exp_L000232_235)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_241
 word I16A_MOVI + (r22)<<D16A + (1)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r2)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk17_67ea41f0_const2exp_L000232_235)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_242
 ...
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNP4 reg reg
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_234
 alignl ' align long
C_sjdk17_67ea41f0_const2exp_L000232_235
' C_sjdk17_67ea41f0_const2exp_L000232_233 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
' C_luaK__setreturns_247 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk1a_67ea41f0_str2K__L000250 ' <symbol:str2K>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $f00000<<S32 ' save registers
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdkt_67ea41f0_stringK__L000193)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
...
' C_sjdk1a_67ea41f0_str2K__L000250_251 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__dischargevars_261
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk17_67ea41f0_const2exp_L000232)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
...
' C_luaK__dischargevars_257 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273 ' <symbol:discharge2reg>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 word I16A_CMPSI + (r17)<<D16A + (1)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_274)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r17)<<D16A + (17)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_274)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_289_L000291-4 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + RI<<D16A + (r22)<<S16A
 word I16B_JMPI ' JUMPV INDIR reg
 alignl ' align long
...
DAT ' const data segment
 ...
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_289_L000291 ' <symbol:289>
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_278
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_280
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_279
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_282
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_283
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_284
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_281
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_286
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_274
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_274
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_274
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_274
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_274
 ...
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_274
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_274
 long @C_sjdk1d_67ea41f0_discharge2reg_L000273_285

' Catalina Code

DAT ' code segment
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_278
 word I16A_MOVI + (r2)<<D16A + (1)<<S16A ' reg ARG coni
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_276)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_279
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 ...
 long I32_JMPA + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_276)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_280
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 ...
 long I32_JMPA + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_276)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_281
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk1a_67ea41f0_str2K__L000250)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_282
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 ...
 long I32_JMPA + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_276)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_283
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdk16_67ea41f0_luaK__float_L000228)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_276)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_284
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 ...
 long I32_JMPA + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_276)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_285
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 ...
 long I32_JMPA + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_276)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_286
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPS + (r19)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1d_67ea41f0_discharge2reg_L000273_276)<<S32 ' EQI4 reg reg
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 ...
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_276
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_WRLONG + (r19)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
 word I16A_MOVI + (r22)<<D16A + (8)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r21)<<S16A ' ASGNI4 reg reg
 alignl ' align long
C_sjdk1d_67ea41f0_discharge2reg_L000273_274
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk1g_67ea41f0_discharge2anyreg_L000293 ' <symbol:discharge2anyreg>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $e00000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r22)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1g_67ea41f0_discharge2anyreg_L000293_295)<<S32 ' EQI4 reg coni
 word I16A_MOVI + (r2)<<D16A + (1)<<S16A ' reg ARG coni
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdk1d_67ea41f0_discharge2reg_L000273)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_sjdk1g_67ea41f0_discharge2anyreg_L000293_295
' C_sjdk1g_67ea41f0_discharge2anyreg_L000293_294 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk1h_67ea41f0_code_loadbool_L000297 ' <symbol:code_loadbool>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $e80000<<S32 ' save registers
 ...
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
' C_sjdk1h_67ea41f0_code_loadbool_L000297_298 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk1i_67ea41f0_need_value_L000299 ' <symbol:need_value>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $e80000<<S32 ' save registers
 ...
 word I16A_MOV + (r21)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl ' align long
 long I32_JMPA + (@C_sjdk1i_67ea41f0_need_value_L000299_304)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1i_67ea41f0_need_value_L000299_301
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1i_67ea41f0_need_value_L000299_305)<<S32 ' EQI4 reg coni
 word I16A_MOVI + R0<<D16A + (1)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk1i_67ea41f0_need_value_L000299_300)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1i_67ea41f0_need_value_L000299_305
' C_sjdk1i_67ea41f0_need_value_L000299_302 ' (symbol refcount = 0)
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_MOV + (r21)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_sjdk1i_67ea41f0_need_value_L000299_304
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r21)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk1i_67ea41f0_need_value_L000299_301)<<S32 ' NEI4 reg reg
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
C_sjdk1i_67ea41f0_need_value_L000299_300
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk1j_67ea41f0_exp2reg_L000307 ' <symbol:exp2reg>
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjdk1j_67ea41f0_exp2reg_L000307_309)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 ...
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 alignl ' align long
C_sjdk1j_67ea41f0_exp2reg_L000307_309
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (8)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOV + (r20)<<D16A + (r21)<<S16A
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1j_67ea41f0_exp2reg_L000307_311)<<S32 ' EQI4 reg reg
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk1i_67ea41f0_need_value_L000299)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk1j_67ea41f0_exp2reg_L000307_315)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk1j_67ea41f0_exp2reg_L000307_313)<<S32 ' EQI4 reg coni
 alignl ' align long
C_sjdk1j_67ea41f0_exp2reg_L000307_315
 word I16A_RDLONG + (r22)<<D16A + (r21)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (16)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk1j_67ea41f0_exp2reg_L000307_317)<<S32 ' NEI4 reg coni
 word I16A_NEGI + (r17)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 alignl ' align long
 long I32_JMPA + (@C_sjdk1j_67ea41f0_exp2reg_L000307_318)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1j_67ea41f0_exp2reg_L000307_317
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_luaK__jump)<<S32 ' CALL addrg
 ...
 alignl ' align long
C_sjdk1j_67ea41f0_exp2reg_L000307_318
 word I16B_LODF + ((-20)&$1FF)<<S16B
 word I16A_WRLONG + (r17)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdk1h_67ea41f0_code_loadbool_L000297)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_sjdk1j_67ea41f0_exp2reg_L000307_313
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_luaK__getlabel)<<S32 ' CALL addrg
 ...
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 alignl ' align long
C_sjdk1j_67ea41f0_exp2reg_L000307_311
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_MOV + (r20)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r20)<<D16A + (8)<<S16A ' ADDP4 reg coni
 ...
 word I16A_MOVI + (r22)<<D16A + (8)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r21)<<S16A ' ASGNI4 reg reg
' C_sjdk1j_67ea41f0_exp2reg_L000307_308 ' (symbol refcount = 0)
...
C_luaK__exp2nextreg ' <symbol:luaK_exp2nextreg>
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdkp_67ea41f0_freeexp_L000168)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOVI + (r2)<<D16A + (1)<<S16A ' reg ARG coni
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdk1j_67ea41f0_exp2reg_L000307)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
...
' C_luaK__exp2val_331 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334 ' <symbol:luaK_exp2K>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $f80000<<S32 ' save registers
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_336)<<S32 ' NEI4 reg reg
 word I16A_RDLONG + (r19)<<D16A + (r21)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r19)<<D16A + (1)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_338)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r19)<<D16A + (7)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_338)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sjdk1k_67ea41f0_luaK__exp2K__L000334_348_L000350-4 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + RI<<D16A + (r22)<<S16A
 word I16B_JMPI ' JUMPV INDIR reg
 alignl ' align long
...
DAT ' const data segment
 ...
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_348_L000350 ' <symbol:348>
 long @C_sjdk1k_67ea41f0_luaK__exp2K__L000334_343
 long @C_sjdk1k_67ea41f0_luaK__exp2K__L000334_341
 long @C_sjdk1k_67ea41f0_luaK__exp2K__L000334_342
 long @C_sjdk1k_67ea41f0_luaK__exp2K__L000334_347
 long @C_sjdk1k_67ea41f0_luaK__exp2K__L000334_345
 long @C_sjdk1k_67ea41f0_luaK__exp2K__L000334_344
 long @C_sjdk1k_67ea41f0_luaK__exp2K__L000334_346

' Catalina Code

DAT ' code segment
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_341
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjdk12_67ea41f0_boolT__L000209)<<S32 ' CALL addrg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_339)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_342
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjdk11_67ea41f0_boolF__L000206)<<S32 ' CALL addrg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_339)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_343
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjdk13_67ea41f0_nilK__L000212)<<S32 ' CALL addrg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_339)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_344
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 ...
 long I32_JMPA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_339)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_345
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRF4 reg
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 ...
 long I32_JMPA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_339)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_346
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 ...
 long I32_JMPA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_339)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_347
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 long I32_JMPA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_339)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_338
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_335)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_339
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 long I32_MOVI + RI<<D32 + (255)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_352)<<S32 ' GTI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (4)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r21)<<S16A ' ASGNI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 long I32_JMPA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334_335)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_352
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_336
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
C_sjdk1k_67ea41f0_luaK__exp2K__L000334_335
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__exp2R_K_ ' <symbol:luaK_exp2RK>
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk1k_67ea41f0_luaK__exp2K__L000334)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
...
C_luaK__exp2R_K__354
 ...
 alignl ' align long
C_sjdk1n_67ea41f0_codeA_B_R_K__L000357 ' <symbol:codeABRK>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $ea0000<<S32 ' save registers
 ...
 long I32_CALA + (@C_luaK__codeA_B_C_k)<<S32
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
' C_sjdk1n_67ea41f0_codeA_B_R_K__L000357_358 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__storevar_365
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdk1n_67ea41f0_codeA_B_R_K__L000357)<<S32
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_luaK__storevar_361)<<S32 ' JUMPV addrg
 alignl ' align long
...
' C_luaK__self_373 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk1q_67ea41f0_negatecondition_L000374 ' <symbol:negatecondition>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $fc0000<<S32 ' save registers
...
' C_sjdk1q_67ea41f0_negatecondition_L000374_375 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk1r_67ea41f0_jumponcond_L000376 ' <symbol:jumponcond>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $fe0000<<S32 ' save registers
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjdk1r_67ea41f0_jumponcond_L000376_378)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk1r_67ea41f0_jumponcond_L000376_380)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjdkj_67ea41f0_removelastinstruction_L000139)<<S32 ' CALL addrg
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk1r_67ea41f0_jumponcond_L000376_383)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r17)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk1r_67ea41f0_jumponcond_L000376_384)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1r_67ea41f0_jumponcond_L000376_383
 word I16A_MOVI + (r17)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk1r_67ea41f0_jumponcond_L000376_384
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_MOV + (r3)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdka_67ea41f0_condjump_L000098)<<S32
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjdk1r_67ea41f0_jumponcond_L000376_377)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1r_67ea41f0_jumponcond_L000376_380
 alignl ' align long
C_sjdk1r_67ea41f0_jumponcond_L000376_378
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk1g_67ea41f0_discharge2anyreg_L000293)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 ...
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_sjdk1r_67ea41f0_jumponcond_L000376_377
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__goiftrue_389
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk1q_67ea41f0_negatecondition_L000374)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
...
C_luaK__goiftrue_386
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdk1r_67ea41f0_jumponcond_L000376)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
...
' C_luaK__goiffalse_396 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk1u_67ea41f0_codenot_L000403 ' <symbol:codenot>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $f80000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r19)<<D16A + (1)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjdk1u_67ea41f0_codenot_L000403_405)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r19)<<D16A + (17)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjdk1u_67ea41f0_codenot_L000403_405)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sjdk1u_67ea41f0_codenot_L000403_412_L000414-4 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + RI<<D16A + (r22)<<S16A
 word I16B_JMPI ' JUMPV INDIR reg
 alignl ' align long
...
DAT ' const data segment
 ...
 alignl ' align long
C_sjdk1u_67ea41f0_codenot_L000403_412_L000414 ' <symbol:412>
 long @C_sjdk1u_67ea41f0_codenot_L000403_408
 long @C_sjdk1u_67ea41f0_codenot_L000403_409
 long @C_sjdk1u_67ea41f0_codenot_L000403_408
 long @C_sjdk1u_67ea41f0_codenot_L000403_409
 long @C_sjdk1u_67ea41f0_codenot_L000403_409
 long @C_sjdk1u_67ea41f0_codenot_L000403_409
 long @C_sjdk1u_67ea41f0_codenot_L000403_409
 long @C_sjdk1u_67ea41f0_codenot_L000403_411
 long @C_sjdk1u_67ea41f0_codenot_L000403_405
 long @C_sjdk1u_67ea41f0_codenot_L000403_405
 long @C_sjdk1u_67ea41f0_codenot_L000403_405
 long @C_sjdk1u_67ea41f0_codenot_L000403_405
 long @C_sjdk1u_67ea41f0_codenot_L000403_405
 long @C_sjdk1u_67ea41f0_codenot_L000403_405
 long @C_sjdk1u_67ea41f0_codenot_L000403_405
 long @C_sjdk1u_67ea41f0_codenot_L000403_410
 long @C_sjdk1u_67ea41f0_codenot_L000403_411
...
DAT ' code segment
 alignl ' align long
C_sjdk1u_67ea41f0_codenot_L000403_408
 word I16A_MOVI + (r22)<<D16A + (2)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r21)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk1u_67ea41f0_codenot_L000403_406)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1u_67ea41f0_codenot_L000403_409
 word I16A_MOVI + (r22)<<D16A + (3)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r21)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk1u_67ea41f0_codenot_L000403_406)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1u_67ea41f0_codenot_L000403_410
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 long I32_JMPA + (@C_sjdk1u_67ea41f0_codenot_L000403_406)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk1u_67ea41f0_codenot_L000403_411
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + (r21)<<S16A ' ASGNI4 reg reg
 alignl ' align long
C_sjdk1u_67ea41f0_codenot_L000403_405
 alignl ' align long
C_sjdk1u_67ea41f0_codenot_L000403_406
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdkd_67ea41f0_removevalues_L000111)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (8)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 ...
 long I32_CALA + (@C_sjdkd_67ea41f0_removevalues_L000111)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
' C_sjdk1u_67ea41f0_codenot_L000403_404 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk21_67ea41f0_isK_str_L000416 ' <symbol:isKstr>
 alignl ' align long
 long I32_PSHM + $d40000<<S32 ' save registers
 word I16A_RDLONG + (r22)<<D16A + (r2)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (4)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk21_67ea41f0_isK_str_L000416_419)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (8)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOV + (r20)<<D16A + (r2)<<S16A
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk21_67ea41f0_isK_str_L000416_419)<<S32 ' NEI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjdk21_67ea41f0_isK_str_L000416_419)<<S32 ' GTI4 reg coni
 word I16A_SHLI + (r22)<<D16A + (3)<<S16A ' SHLI4 reg coni
 word I16A_RDLONG + (r20)<<D16A + (r3)<<S16A ' reg <- INDIRP4 reg
 alignl ' align long
 long I32_LODS + (r18)<<D32S + ((48)&$7FFFF)<<S32 ' reg <- cons
 ...
 word I16A_MOVI + (r23)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk21_67ea41f0_isK_str_L000416_420)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk21_67ea41f0_isK_str_L000416_419
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk21_67ea41f0_isK_str_L000416_420
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sjdk21_67ea41f0_isK_str_L000416_417 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
' C_luaK__isK_int_421 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk22_67ea41f0_isC_int_L000425 ' <symbol:isCint>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $e00000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk22_67ea41f0_isC_int_L000425_428)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 alignl ' align long
 ...
 word I16A_CMP + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjdk22_67ea41f0_isC_int_L000425_428)<<S32 ' GTU4 reg coni
 word I16A_MOVI + (r21)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk22_67ea41f0_isC_int_L000425_429)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk22_67ea41f0_isC_int_L000425_428
 word I16A_MOVI + (r21)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk22_67ea41f0_isC_int_L000425_429
 word I16A_MOV + (r0)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
' C_sjdk22_67ea41f0_isC_int_L000425_426 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk23_67ea41f0_isS_C_int_L000430 ' <symbol:isSCint>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 long I32_PSHM + $e00000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk23_67ea41f0_isS_C_int_L000430_433)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r2)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjdk14_67ea41f0_fitsC__L000215)<<S32 ' CALL addrg
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk23_67ea41f0_isS_C_int_L000430_433)<<S32 ' EQI4 reg coni
 word I16A_MOVI + (r21)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk23_67ea41f0_isS_C_int_L000430_434)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk23_67ea41f0_isS_C_int_L000430_433
 word I16A_MOVI + (r21)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk23_67ea41f0_isS_C_int_L000430_434
 word I16A_MOV + (r0)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
' C_sjdk23_67ea41f0_isS_C_int_L000430_431 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk24_67ea41f0_isS_C_number_L000435 ' <symbol:isSCnumber>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $f80000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r22)<<D16A + (6)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk24_67ea41f0_isS_C_number_L000435_437)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk24_67ea41f0_isS_C_number_L000435_438)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk24_67ea41f0_isS_C_number_L000435_437
 word I16A_RDLONG + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (5)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk24_67ea41f0_isS_C_number_L000435_439)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_MOV + (r3)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk24_67ea41f0_isS_C_number_L000435_439)<<S32 ' EQI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (1)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r19)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk24_67ea41f0_isS_C_number_L000435_440)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk24_67ea41f0_isS_C_number_L000435_439
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk24_67ea41f0_isS_C_number_L000435_436)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk24_67ea41f0_isS_C_number_L000435_440
 alignl ' align long
C_sjdk24_67ea41f0_isS_C_number_L000435_438
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (8)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16A_MOV + (r20)<<D16A + (r23)<<S16A
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk24_67ea41f0_isS_C_number_L000435_441)<<S32 ' NEI4 reg reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRLi
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk24_67ea41f0_isS_C_number_L000435_441)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 ...
 long I32_JMPA + (@C_sjdk24_67ea41f0_isS_C_number_L000435_436)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk24_67ea41f0_isS_C_number_L000435_441
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
C_sjdk24_67ea41f0_isS_C_number_L000435_436
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__indexed_444
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk21_67ea41f0_isK_str_L000416)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_luaK__indexed_446)<<S32 ' NEI4 reg coni
...
C_luaK__indexed_453
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjdk22_67ea41f0_isC_int_L000425)<<S32 ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
...
' C_luaK__indexed_443 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457 ' <symbol:validop>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $fa8000<<S32 ' save registers
 ...
 alignl ' align long
 long I32_BR_B + (@C_sjdk25_67ea41f0_validop_L000457_459)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r23)<<D16A + (13)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjdk25_67ea41f0_validop_L000457_459)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sjdk25_67ea41f0_validop_L000457_474_L000476-12 ' reg <- addrg
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (1)
 word I16A_RDLONG + RI<<D16A + (r22)<<S16A
 word I16B_JMPI ' JUMPV INDIR reg
 alignl ' align long
...
DAT ' const data segment
 ...
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_474_L000476 ' <symbol:474>
 long @C_sjdk25_67ea41f0_validop_L000457_465
 long @C_sjdk25_67ea41f0_validop_L000457_459
 long @C_sjdk25_67ea41f0_validop_L000457_465
 long @C_sjdk25_67ea41f0_validop_L000457_465
 long @C_sjdk25_67ea41f0_validop_L000457_461
 long @C_sjdk25_67ea41f0_validop_L000457_461
 long @C_sjdk25_67ea41f0_validop_L000457_461
 long @C_sjdk25_67ea41f0_validop_L000457_461
 long @C_sjdk25_67ea41f0_validop_L000457_461
...
DAT ' code segment
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_461
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_MOV + (r3)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOV + (r4)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk25_67ea41f0_validop_L000457_463)<<S32 ' EQI4 reg coni
 ...
 word I16A_MOVI + (r17)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk25_67ea41f0_validop_L000457_464)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_463
 word I16A_MOVI + (r17)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_464
 word I16A_MOV + (r0)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjdk25_67ea41f0_validop_L000457_458)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_465
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDBYTE + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_CMPSI + (r22)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk25_67ea41f0_validop_L000457_470)<<S32 ' NEI4 reg coni
 word I16A_RDLONG + (r0)<<D16A + (r19)<<S16A ' reg <- INDIRI4 reg
 word I16B_FLTP + FLIN<<S16B ' CVIF4
 word I16A_MOV + (r15)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjdk25_67ea41f0_validop_L000457_471)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_470
 word I16A_RDLONG + (r15)<<D16A + (r19)<<S16A ' reg <- INDIRF4 reg
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_471
 alignl ' align long
 long I32_LODI + (@C_sjdk25_67ea41f0_validop_L000457_472_L000473)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRF4 addrg
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' setup r0/r1 (2)
 word I16A_MOV + (r1)<<D16A + (r22)<<S16A ' setup r0/r1 (2)
 word I16B_FLTP + FCMP<<S16B
 alignl ' align long
 long I32_BR_Z + (@C_sjdk25_67ea41f0_validop_L000457_468)<<S32 ' EQF4
 word I16A_MOVI + (r17)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk25_67ea41f0_validop_L000457_469)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_468
 word I16A_MOVI + (r17)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_469
 word I16A_MOV + (r0)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjdk25_67ea41f0_validop_L000457_458)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_459
 word I16A_MOVI + R0<<D16A + (1)<<S16A ' RET coni
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_458
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk29_67ea41f0_constfolding_L000478 ' <symbol:constfolding>
 alignl ' align long
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk29_67ea41f0_constfolding_L000478_483)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((-20)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16A_MOV + (r3)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdk25_67ea41f0_validop_L000457)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk29_67ea41f0_constfolding_L000478_480)<<S32 ' NEI4 reg coni
 alignl ' align long
C_sjdk29_67ea41f0_constfolding_L000478_483
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk29_67ea41f0_constfolding_L000478_479)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk29_67ea41f0_constfolding_L000478_480
 word I16B_LODF + ((-28)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16B_LODF + ((-20)&$1FF)<<S16B
 word I16A_MOV + (r3)<<D16A + RI<<S16A ' reg ARG ADDRLi
 ...
 word I16A_CMPSI + (r22)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk29_67ea41f0_constfolding_L000478_484)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (6)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r19)<<S16A ' ASGNI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk29_67ea41f0_constfolding_L000478_485)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk29_67ea41f0_constfolding_L000478_484
 word I16B_LODF + ((-28)&$1FF)<<S16B
 ...
 word I16B_FLTP + FCMP<<S16B
 alignl ' align long
 long I32_BRNZ + (@C_sjdk29_67ea41f0_constfolding_L000478_489)<<S32 ' NEF4
 alignl ' align long
 long I32_LODI + (@C_sjdk25_67ea41f0_validop_L000457_472_L000473)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRF4 addrg
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' setup r0/r1 (2)
 ...
 word I16B_FLTP + FCMP<<S16B
 alignl ' align long
 long I32_BRNZ + (@C_sjdk29_67ea41f0_constfolding_L000478_487)<<S32 ' NEF4
 alignl ' align long
C_sjdk29_67ea41f0_constfolding_L000478_489
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk29_67ea41f0_constfolding_L000478_479)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk29_67ea41f0_constfolding_L000478_487
 word I16A_MOVI + (r22)<<D16A + (5)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r19)<<S16A ' ASGNI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 alignl ' align long
C_sjdk29_67ea41f0_constfolding_L000478_485
 word I16A_MOVI + R0<<D16A + (1)<<S16A ' RET coni
 alignl ' align long
C_sjdk29_67ea41f0_constfolding_L000478_479
 word I16B_POPM + 6<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2a_67ea41f0_codeunexpval_L000490 ' <symbol:codeunexpval>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $fa0000<<S32 ' save registers
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
' C_sjdk2a_67ea41f0_codeunexpval_L000490_491 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2b_67ea41f0_finishbinexpval_L000492 ' <symbol:finishbinexpval>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $fa8000<<S32 ' save registers
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdkq_67ea41f0_freeexps_L000172)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 long I32_CALA + (@C_luaK__fixline)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
' C_sjdk2b_67ea41f0_finishbinexpval_L000492_493 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2c_67ea41f0_codebinexpval_L000494 ' <symbol:codebinexpval>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $ea0000<<S32 ' save registers
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdk2b_67ea41f0_finishbinexpval_L000492)<<S32
 alignl ' align long
 long I32_LODA + 32<<S32
 word I16A_ADD + SP<<D16A + RI<<S16A ' CALL addrg
' C_sjdk2c_67ea41f0_codebinexpval_L000494_495 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2d_67ea41f0_codebini_L000496 ' <symbol:codebini>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $fa0000<<S32 ' save registers
 ...
 long I32_LODA + 32<<S32
 word I16A_ADD + SP<<D16A + RI<<S16A ' CALL addrg
' C_sjdk2d_67ea41f0_codebini_L000496_497 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2e_67ea41f0_finishbinexpneg_L000498 ' <symbol:finishbinexpneg>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $ff0000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk2e_67ea41f0_finishbinexpneg_L000498_500)<<S32 ' NEI4 reg coni
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk2e_67ea41f0_finishbinexpneg_L000498_499)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2e_67ea41f0_finishbinexpneg_L000498_500
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2e_67ea41f0_finishbinexpneg_L000498_504)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk2e_67ea41f0_finishbinexpneg_L000498_502)<<S32 ' NEI4 reg coni
 alignl ' align long
C_sjdk2e_67ea41f0_finishbinexpneg_L000498_504
 word I16A_MOVI + R0<<D16A + (0)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk2e_67ea41f0_finishbinexpneg_L000498_499)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2e_67ea41f0_finishbinexpneg_L000498_502
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 ...
 word I16A_MOVI + R0<<D16A + (1)<<S16A ' RET coni
 alignl ' align long
C_sjdk2e_67ea41f0_finishbinexpneg_L000498_499
 word I16B_POPM + 2<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2f_67ea41f0_swapexps_L000505 ' <symbol:swapexps>
 alignl ' align long
 long I32_NEWF + 16<<S32
 word I16B_LODF + ((-20)&$1FF)<<S16B
 ...
 alignl ' align long
 long I32_CPYB + 16<<S32 ' ASGNB
' C_sjdk2f_67ea41f0_swapexps_L000505_506 ' (symbol refcount = 0)
 word I16B_RETF + 16<<S32
 alignl ' align long

 alignl ' align long
C_sjdk2g_67ea41f0_codearith_L000507 ' <symbol:codearith>
 alignl ' align long
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2g_67ea41f0_codearith_L000507_509)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r3)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 ...
 word I16A_ADD + SP<<D16A + RI<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sjdk2g_67ea41f0_codearith_L000507_510)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2g_67ea41f0_codearith_L000507_509
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 ...
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2g_67ea41f0_codearith_L000507_511)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk2f_67ea41f0_swapexps_L000505)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_sjdk2g_67ea41f0_codearith_L000507_511
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((-12)&$1FF)<<S16B
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdk2c_67ea41f0_codebinexpval_L000494)<<S32
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 alignl ' align long
C_sjdk2g_67ea41f0_codearith_L000507_510
' C_sjdk2g_67ea41f0_codearith_L000507_508 ' (symbol refcount = 0)
 word I16B_POPM + 3<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2h_67ea41f0_codecommutative_L000513 ' <symbol:codecommutative>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $ea0000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2h_67ea41f0_codecommutative_L000513_515)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
C_sjdk2h_67ea41f0_codecommutative_L000513_515
 word I16A_CMPSI + (r23)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk2h_67ea41f0_codecommutative_L000513_517)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjdk23_67ea41f0_isS_C_int_L000430)<<S32 ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2h_67ea41f0_codecommutative_L000513_517)<<S32 ' EQI4 reg coni
 word I16A_MOVI + (r2)<<D16A + (6)<<S16A ' reg ARG coni
 word I16A_MOV + (r3)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r4)<<D16A + RI<<S16A ' reg ARG INDIR ADDRLi
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdk2d_67ea41f0_codebini_L000496)<<S32
 word I16A_ADDI + SP<<D16A + 24<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sjdk2h_67ea41f0_codecommutative_L000513_518)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2h_67ea41f0_codecommutative_L000513_517
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r3)<<D16A + RI<<S16A ' reg ARG INDIR ADDRLi
 word I16A_MOV + (r4)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdk2g_67ea41f0_codearith_L000507)<<S32
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 alignl ' align long
C_sjdk2h_67ea41f0_codecommutative_L000513_518
' C_sjdk2h_67ea41f0_codecommutative_L000513_514 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2i_67ea41f0_codebitwise_L000519 ' <symbol:codebitwise>
 alignl ' align long
 long I32_NEWF + 12<<S32
 alignl ' align long
 long I32_PSHM + $ea0000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r22)<<D16A + (6)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk2i_67ea41f0_codebitwise_L000519_521)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r3)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2i_67ea41f0_codebitwise_L000519_521)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk2i_67ea41f0_codebitwise_L000519_522)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2i_67ea41f0_codebitwise_L000519_521
 word I16A_RDLONG + (r22)<<D16A + (r19)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (6)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk2i_67ea41f0_codebitwise_L000519_525)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r3)<<D16A + RI<<S16A ' reg ARG INDIR ADDRFi
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk2i_67ea41f0_codebitwise_L000519_523)<<S32 ' NEI4 reg coni
 alignl ' align long
C_sjdk2i_67ea41f0_codebitwise_L000519_525
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((34)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r22)<<D16A + (r23)<<S16A ' ADDI/P (2)
 word I16B_LODF + ((-12)&$1FF)<<S16B
 ...
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_sjdk2i_67ea41f0_codebitwise_L000519_520)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2i_67ea41f0_codebitwise_L000519_523
 alignl ' align long
C_sjdk2i_67ea41f0_codebitwise_L000519_522
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRI4 reg
 word I16B_LODF + ((-16)&$1FF)<<S16B
 ...
 word I16A_ADD + SP<<D16A + RI<<S16A ' CALL addrg
 alignl ' align long
C_sjdk2i_67ea41f0_codebitwise_L000519_520
 word I16B_POPM + 3<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2j_67ea41f0_codeorder_L000526 ' <symbol:codeorder>
 alignl ' align long
 long I32_NEWF + 16<<S32
 alignl ' align long
 long I32_PSHM + $fa8000<<S32 ' save registers
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_sjdk24_67ea41f0_isS_C_number_L000435)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2j_67ea41f0_codeorder_L000526_528)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 alignl ' align long
 long I32_JMPA + (@C_sjdk2j_67ea41f0_codeorder_L000526_529)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2j_67ea41f0_codeorder_L000526_528
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r3)<<D16A + RI<<S16A ' reg ARG ADDRLi
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2j_67ea41f0_codeorder_L000526_530)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjdk2j_67ea41f0_codeorder_L000526_533)<<S32 ' NEI4 reg coni
 alignl ' align long
 long I32_LODS + (r15)<<D32S + ((64)&$7FFFF)<<S32 ' reg <- cons
 alignl ' align long
 long I32_JMPA + (@C_sjdk2j_67ea41f0_codeorder_L000526_534)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2j_67ea41f0_codeorder_L000526_533
 alignl ' align long
 long I32_LODS + (r15)<<D32S + ((65)&$7FFFF)<<S32 ' reg <- cons
 alignl ' align long
C_sjdk2j_67ea41f0_codeorder_L000526_534
 word I16A_MOV + (r21)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjdk2j_67ea41f0_codeorder_L000526_531)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2j_67ea41f0_codeorder_L000526_530
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
C_sjdk2j_67ea41f0_codeorder_L000526_531
 alignl ' align long
C_sjdk2j_67ea41f0_codeorder_L000526_529
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 ...
 word I16A_WRLONG + (r22)<<D16A + (r19)<<S16A ' ASGNI4 reg reg
' C_sjdk2j_67ea41f0_codeorder_L000526_527 ' (symbol refcount = 0)
 word I16B_POPM + 4<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjdk2k_67ea41f0_codeeq_L000535 ' <symbol:codeeq>
 alignl ' align long
 long I32_NEWF + 20<<S32
 alignl ' align long
 long I32_PSHM + $fa8000<<S32 ' save registers
 ...
 word I16A_CMPSI + (r22)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2k_67ea41f0_codeeq_L000535_537)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_sjdk2k_67ea41f0_codeeq_L000535_537
 word I16A_MOV + (r2)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2k_67ea41f0_codeeq_L000535_539)<<S32 ' EQI4 reg coni
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk2k_67ea41f0_codeeq_L000535_540)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2k_67ea41f0_codeeq_L000535_539
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2k_67ea41f0_codeeq_L000535_541)<<S32 ' EQI4 reg coni
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk2k_67ea41f0_codeeq_L000535_542)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2k_67ea41f0_codeeq_L000535_541
 alignl ' align long
 ...
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
C_sjdk2k_67ea41f0_codeeq_L000535_542
 alignl ' align long
C_sjdk2k_67ea41f0_codeeq_L000535_540
 word I16A_MOV + (r2)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r4)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjdk2k_67ea41f0_codeeq_L000535_544)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r15)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk2k_67ea41f0_codeeq_L000535_545)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2k_67ea41f0_codeeq_L000535_544
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk2k_67ea41f0_codeeq_L000535_545
 ...
 word I16A_MOVI + (r22)<<D16A + (16)<<S16A ' reg <- coni
 word I16A_WRLONG + (r22)<<D16A + (r19)<<S16A ' ASGNI4 reg reg
' C_sjdk2k_67ea41f0_codeeq_L000535_536 ' (symbol refcount = 0)
 word I16B_POPM + 5<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__prefix_552
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_sjdk29_67ea41f0_constfolding_L000478)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
...
C_luaK__prefix_555
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_sjdk2a_67ea41f0_codeunexpval_L000490)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_luaK__prefix_550)<<S32 ' JUMPV addrg
 alignl ' align long
C_luaK__prefix_556
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk1u_67ea41f0_codenot_L000403)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_luaK__prefix_549
 alignl ' align long
...
' C_luaK__infix_560 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk2q_67ea41f0_codeconcat_L000579 ' <symbol:codeconcat>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 long I32_PSHM + $fe8000<<S32 ' save registers
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjdk2q_67ea41f0_codeconcat_L000579_581)<<S32 ' NEI4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r15)<<S16A ' reg <- INDIRU4 reg
 word I16A_SHRI + (r22)<<D16A + (16)<<S16A ' SHRU4 reg coni
 alignl ' align long
 long I32_MOVI + (r20)<<D32 +(255)<<S32 ' reg <- conli
 ...
 word I16A_WRLONG + (r22)<<D16A + (r15)<<S16A ' ASGNU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjdk2q_67ea41f0_codeconcat_L000579_582)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2q_67ea41f0_codeconcat_L000579_581
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r3)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + (r4)<<D16A + (2)<<S16A ' reg ARG coni
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_sjdk2q_67ea41f0_codeconcat_L000579_582
' C_sjdk2q_67ea41f0_codeconcat_L000579_580 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_luaK__posfix_591
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_sjdk2q_67ea41f0_codeconcat_L000579)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_luaK__posfix_587)<<S32 ' JUMPV addrg
 alignl ' align long
C_luaK__posfix_592
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdk2h_67ea41f0_codecommutative_L000513)<<S32
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_luaK__posfix_587)<<S32 ' JUMPV addrg
 alignl ' align long
C_luaK__posfix_593
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdk2e_67ea41f0_finishbinexpneg_L000498)<<S32
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
...
C_luaK__posfix_597
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' correct for new kernel !!! 
 alignl ' align long
 long I32_CALA + (@C_sjdk2i_67ea41f0_codebitwise_L000519)<<S32
 word I16A_ADDI + SP<<D16A + 16<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_luaK__posfix_587)<<S32 ' JUMPV addrg
 alignl ' align long
...
C_luaK__posfix_606
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_sjdk2k_67ea41f0_codeeq_L000535)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_luaK__posfix_587)<<S32 ' JUMPV addrg
 alignl ' align long
C_luaK__posfix_607
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_sjdk2j_67ea41f0_codeorder_L000526)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 alignl ' align long
 long I32_JMPA + (@C_luaK__posfix_587)<<S32 ' JUMPV addrg
 alignl ' align long
...
' C_luaK__setlist_620 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sjdk2t_67ea41f0_finaltarget_L000625 ' <symbol:finaltarget>
 alignl ' align long
 long I32_PSHM + $f00000<<S32 ' save registers
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjdk2t_67ea41f0_finaltarget_L000625_627
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjdk2t_67ea41f0_finaltarget_L000625_631)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_sjdk2t_67ea41f0_finaltarget_L000625_629)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjdk2t_67ea41f0_finaltarget_L000625_631
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_SHRI + (r22)<<D16A + (7)<<S16A ' SHRU4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
...
' C_sjdk2t_67ea41f0_finaltarget_L000625_628 ' (symbol refcount = 0)
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (100)<<S32
 word I16A_CMPS + (r23)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjdk2t_67ea41f0_finaltarget_L000625_627)<<S32 ' LTI4 reg coni
 alignl ' align long
C_sjdk2t_67ea41f0_finaltarget_L000625_629
 word I16A_MOV + (r0)<<D16A + (r2)<<S16A ' CVI, CVU or LOAD
' C_sjdk2t_67ea41f0_finaltarget_L000625_626 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
C_luaK__finish_649
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sjdk2t_67ea41f0_finaltarget_L000625)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 word I16B_LODF + ((-8)&$1FF)<<S16B
...
DAT ' const data segment
 ...
 alignl ' align long
C_sjdk25_67ea41f0_validop_L000457_472_L000473 ' <symbol:472>
 long $0 ' float

 alignl ' align long
C_sjdkv_67ea41f0_luaK__numberK__L000197_201_L000202 ' <symbol:201>
 long $3f800000 ' float

 alignl ' align long
C_sjdkr_67ea41f0_addk_L000180_186_L000187 ' <symbol:186>
 byte 99
 byte 111
 byte 110
 byte 115
...
C_luaK__checkstack_157_L000158 ' <symbol:157>
 ...
 alignl ' align long
C_sjdkf_67ea41f0_savelineinfo_L000126_133_L000134 ' <symbol:133>
 byte 111
 byte 112
 byte 99
 byte 111
 ...
 alignl ' align long
C_sjdkf_67ea41f0_savelineinfo_L000126_131_L000132 ' <symbol:131>
 byte 108
 byte 105
 byte 110
 byte 101
 ...
 alignl ' align long
C_sjdk8_67ea41f0_fixjump_L000077_82_L000083 ' <symbol:82>
 byte 99
 byte 111
 byte 110
 byte 116
