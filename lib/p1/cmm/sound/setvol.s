...
' Catalina Export SetVolume

 alignl ' align long
C_S_etV_olume ' <symbol:SetVolume>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_S_etV_olume_3)<<S32 ' NEU4 reg coni
 alignl ' align long
...
C_S_etV_olume_3
 ...
 alignl ' align long
 long I32_BR_B + (@C_S_etV_olume_11)<<S32 ' LTI4 reg coni
 alignl ' align long
C_S_etV_olume_7
' C_S_etV_olume_8 ' (symbol refcount = 0)
 alignl ' align long
 long I32_LODI + (@C__sound_lock)<<S32
 ...
 alignl ' align long
 long I32_BR_Z + (@C_S_etV_olume_7)<<S32 ' EQI4 reg coni
 alignl ' align long
C_S_etV_olume_10
 alignl ' align long
C_S_etV_olume_11
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_S_etV_olume_10)<<S32 ' NEU4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_S_etV_olume_13)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__sound_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 alignl ' align long
C_S_etV_olume_13
' C_S_etV_olume_2 ' (symbol refcount = 0)
