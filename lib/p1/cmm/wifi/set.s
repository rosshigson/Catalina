...
C_wifi_S_E_T_ ' <symbol:wifi_SET>
 ...
 alignl_p1
 long I32_BRNZ + (@C_wifi_S_E_T__2)<<S32 ' NEI4 reg coni
 word I16A_MOVI + R0<<D16A + (16)<<S16A ' RET coni
 alignl_p1
 long I32_JMPA + (@C_wifi_S_E_T__1)<<S32 ' JUMPV addrg
 alignl_label
C_wifi_S_E_T__2
 ...
 alignl_p1
 long @C_wifi_S_E_T__4_L000005 ' reg ARG ADDRG
 alignl_p1
 ...
 alignl_p1
 long I32_BRNZ + (@C_wifi_S_E_T__6)<<S32 ' NEI4 reg coni
 alignl_p1
