...
C_spi_writeE_E_P_R_O_M__2
 ...
 alignl ' align long
 long I32_BR_B + (@C_spi_writeE_E_P_R_O_M__10)<<S32 ' LTI4 reg coni
 alignl ' align long
C_spi_writeE_E_P_R_O_M__6
' C_spi_writeE_E_P_R_O_M__7 ' (symbol refcount = 0)
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 ...
 alignl ' align long
 long I32_BR_Z + (@C_spi_writeE_E_P_R_O_M__6)<<S32 ' EQI4 reg coni
 alignl ' align long
C_spi_writeE_E_P_R_O_M__9
 alignl ' align long
C_spi_writeE_E_P_R_O_M__10
...
' C_spi_writeE_E_P_R_O_M__13 ' (symbol refcount = 0)
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_spi_getC_ontrol)<<S32 ' CALL addrg
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_writeE_E_P_R_O_M__12)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_spi_writeE_E_P_R_O_M__15)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_spi_writeE_E_P_R_O_M__15
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_spi_writeE_E_P_R_O_M__18)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r17)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_spi_writeE_E_P_R_O_M__19)<<S32 ' JUMPV addrg
 alignl ' align long
C_spi_writeE_E_P_R_O_M__18
 word I16A_MOVI + (r17)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_spi_writeE_E_P_R_O_M__19
