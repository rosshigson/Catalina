...
C_spi_stopS_D_C_ard ' <symbol:spi_stopSDCard>
 ...
 alignl ' align long
 long I32_BRNZ + (@C_spi_stopS_D_C_ard_2)<<S32 ' NEU4 reg coni
 alignl ' align long
...
C_spi_stopS_D_C_ard_2
 ...
 alignl ' align long
 long I32_BR_B + (@C_spi_stopS_D_C_ard_10)<<S32 ' LTI4 reg coni
 alignl ' align long
...
' C_spi_stopS_D_C_ard_7 ' (symbol refcount = 0)
 ...
 alignl ' align long
 long I32_BR_Z + (@C_spi_stopS_D_C_ard_6)<<S32 ' EQI4 reg coni
 alignl ' align long
...
C_spi_stopS_D_C_ard_10
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_stopS_D_C_ard_9)<<S32 ' NEU4 reg coni
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
...
' C_spi_stopS_D_C_ard_13 ' (symbol refcount = 0)
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_stopS_D_C_ard_12)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_spi_stopS_D_C_ard_15)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_spi_stopS_D_C_ard_15
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_spi_stopS_D_C_ard_18)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r23)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_spi_stopS_D_C_ard_19)<<S32 ' JUMPV addrg
 alignl ' align long
