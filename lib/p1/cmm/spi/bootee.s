...
C_spi_bootE_E_P_R_O_M__3
 ...
 alignl ' align long
 long I32_BR_B + (@C_spi_bootE_E_P_R_O_M__11)<<S32 ' LTI4 reg coni
 alignl ' align long
C_spi_bootE_E_P_R_O_M__7
' C_spi_bootE_E_P_R_O_M__8 ' (symbol refcount = 0)
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 ...
 alignl ' align long
 long I32_BR_Z + (@C_spi_bootE_E_P_R_O_M__7)<<S32 ' EQI4 reg coni
 alignl ' align long
C_spi_bootE_E_P_R_O_M__10
 alignl ' align long
C_spi_bootE_E_P_R_O_M__11
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_bootE_E_P_R_O_M__10)<<S32 ' NEU4 reg coni
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_bootE_E_P_R_O_M__13)<<S32 ' NEI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_spi_bootE_E_P_R_O_M__15)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_spi_bootE_E_P_R_O_M__13
 ...
 alignl ' align long
C_spi_bootE_E_P_R_O_M__17
 word I16A_CMPS + (r21)<<D16A + (r19)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_spi_bootE_E_P_R_O_M__21)<<S32 ' EQI4 reg reg
 ...
 alignl ' align long
C_spi_bootE_E_P_R_O_M__21
' C_spi_bootE_E_P_R_O_M__18 ' (symbol refcount = 0)
 word I16A_ADDSI + (r21)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_CMPSI + (r21)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_spi_bootE_E_P_R_O_M__17)<<S32 ' LTI4 reg coni
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_spi_bootE_E_P_R_O_M__23)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 long I32_CALA + (@C__lockclr)<<S32 ' CALL addrg
 alignl ' align long
C_spi_bootE_E_P_R_O_M__23
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_spi_bootE_E_P_R_O_M__28)<<S32 ' LEI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_spi_bootE_E_P_R_O_M__28
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_bootE_E_P_R_O_M__27)<<S32 ' NEU4 reg coni
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_spi_getC_ontrol)<<S32 ' CALL addrg
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_spi_bootE_E_P_R_O_M__31)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r15)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_spi_bootE_E_P_R_O_M__32)<<S32 ' JUMPV addrg
 alignl ' align long
C_spi_bootE_E_P_R_O_M__31
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_spi_bootE_E_P_R_O_M__32
