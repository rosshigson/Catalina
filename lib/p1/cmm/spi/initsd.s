...
' Catalina Export spi_initSDCard

 alignl ' align long
C_spi_initS_D_C_ard ' <symbol:spi_initSDCard>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_spi_initS_D_C_ard_2)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_CALA + (@C__initialize_spi)<<S32 ' CALL addrg
 alignl ' align long
C_spi_initS_D_C_ard_2
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_spi_initS_D_C_ard_10)<<S32 ' LTI4 reg coni
 alignl ' align long
C_spi_initS_D_C_ard_6
' C_spi_initS_D_C_ard_7 ' (symbol refcount = 0)
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 ...
 alignl ' align long
 long I32_BR_Z + (@C_spi_initS_D_C_ard_6)<<S32 ' EQI4 reg coni
 alignl ' align long
C_spi_initS_D_C_ard_9
 alignl ' align long
C_spi_initS_D_C_ard_10
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_initS_D_C_ard_9)<<S32 ' NEU4 reg coni
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 ...
 word I16A_SHLI + (r22)<<D16A + (18)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long 268435456 ' reg <- con
 word I16A_OR + (r22)<<D16A + (r20)<<S16A ' BORI/U (1)
 word I16A_MOV + (r20)<<D16A + (r21)<<S16A
 word I16A_SHLI + (r20)<<D16A + (12)<<S16A ' SHLI4 reg coni
 word I16A_OR + (r22)<<D16A + (r20)<<S16A ' BORI/U (1)
 ...
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
 alignl ' align long
C_spi_initS_D_C_ard_12
' C_spi_initS_D_C_ard_13 ' (symbol refcount = 0)
 word I16A_MOVI + (r2)<<D16A + (0)<<S16A ' reg ARG coni
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_spi_getC_ontrol)<<S32 ' CALL addrg
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_spi_initS_D_C_ard_12)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_spi_initS_D_C_ard_15)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C__spi_lock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_spi_initS_D_C_ard_15
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_spi_initS_D_C_ard_18)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r15)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_spi_initS_D_C_ard_19)<<S32 ' JUMPV addrg
 alignl ' align long
C_spi_initS_D_C_ard_18
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_spi_initS_D_C_ard_19
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
' C_spi_initS_D_C_ard_1 ' (symbol refcount = 0)
