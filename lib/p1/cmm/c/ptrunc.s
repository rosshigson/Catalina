...
C__malloc_truncate ' <symbol:_malloc_truncate>
 ...
 word I16A_ADDS + (r17)<<D16A + (r23)<<S16A ' ADDI/P (3)
 ...
 alignl ' align long
 long I32_BRNZ + (@C__malloc_truncate_7)<<S32 ' NEU4 reg reg
 word I16A_MOVI + (r15)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C__malloc_truncate_8)<<S32 ' JUMPV addrg
 alignl ' align long
...
C__malloc_truncate_8
 ...
 alignl ' align long
 long I32_BRNZ + (@C__malloc_truncate_4)<<S32 ' NEI4 reg coni
 word I16A_NEGI + (r22)<<D16A + (-(-4)&$1F)<<S16A ' reg <- conn
 ...
 alignl ' align long
 long I32_BR_Z + (@C__malloc_truncate_5)<<S32 ' EQI4 reg coni
 ...
 alignl ' align long
 long I32_JMPA + (@C__malloc_truncate_5)<<S32 ' JUMPV addrg
 alignl ' align long
