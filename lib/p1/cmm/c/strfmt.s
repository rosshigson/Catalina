...
'
 ...
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001 ' <symbol:str_cvt>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_savg_67e3465f_str_cvt_L000001_3)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((78)&$7FFFF)<<S32 ' reg <- cons
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_3
 ...
 alignl ' align long
 long I32_LODI + (@C_savg_67e3465f_str_cvt_L000001_7_L000008)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRF4 addrg
 word I16A_MOV + (r0)<<D16A + (r22)<<S16A ' setup r0/r1 (2)
 word I16A_MOV + (r1)<<D16A + (r20)<<S16A ' setup r0/r1 (2)
 word I16B_FLTP + FCMP<<S16B
 alignl ' align long
 long I32_BRAE + (@C_savg_67e3465f_str_cvt_L000001_5)<<S32 ' GEF4
 ...
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_5
 word I16B_LODF + ((-12)&$1FF)<<S16B
 ...
 word I16B_FLTP + FCMP<<S16B
 alignl ' align long
 long I32_BR_Z + (@C_savg_67e3465f_str_cvt_L000001_9)<<S32 ' EQF4
 alignl ' align long
 long I32_LODS + (r22)<<D32S + ((80)&$7FFFF)<<S32 ' reg <- cons
 word I16A_MOV + (r11)<<D16A + (r17)<<S16A ' ADDI/P
 word I16A_ADDS + (r11)<<D16A + (r22)<<S16A ' ADDI/P (3)
 alignl ' align long
 long I32_JMPA + (@C_savg_67e3465f_str_cvt_L000001_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_11
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG ADDRLi
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRF4 addrl16
 alignl ' align long
 long I32_LODI + (@C_savg_67e3465f_str_cvt_L000001_14_L000015)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRF4 addrg
 word I16A_MOV + (r0)<<D16A + (r22)<<S16A ' setup r0/r1 (2)
 word I16A_MOV + (r1)<<D16A + (r20)<<S16A ' setup r0/r1 (2)
 ...
 alignl ' align long
 long I32_LODI + (@C_savg_67e3465f_str_cvt_L000001_16_L000017)<<S32
 ...
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_12
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRF4 addrl16
 alignl ' align long
 long I32_LODI + (@C_savg_67e3465f_str_cvt_L000001_7_L000008)<<S32
 ...
 word I16B_FLTP + FCMP<<S16B
 alignl ' align long
 long I32_BRNZ + (@C_savg_67e3465f_str_cvt_L000001_11)<<S32 ' NEF4
 alignl ' align long
 long I32_JMPA + (@C_savg_67e3465f_str_cvt_L000001_19)<<S32 ' JUMPV addrg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_18
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_19
 ...
 alignl ' align long
 long I32_BR_B + (@C_savg_67e3465f_str_cvt_L000001_18)<<S32 ' LTU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_savg_67e3465f_str_cvt_L000001_10)<<S32 ' JUMPV addrg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_9
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRF4 addrl16
 alignl ' align long
 long I32_LODI + (@C_savg_67e3465f_str_cvt_L000001_7_L000008)<<S32
 ...
 word I16B_FLTP + FCMP<<S16B
 alignl ' align long
 long I32_BRBE + (@C_savg_67e3465f_str_cvt_L000001_21)<<S32 ' LEF4
 alignl ' align long
 long I32_JMPA + (@C_savg_67e3465f_str_cvt_L000001_24)<<S32 ' JUMPV addrg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_23
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRF4 addrl16
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNF4 addrl16 reg
 ...
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_24
 alignl ' align long
 long I32_LODI + (@C_savg_67e3465f_str_cvt_L000001_14_L000015)<<S32
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNF4 addrl16 reg
 alignl ' align long
 long I32_LODI + (@C_savg_67e3465f_str_cvt_L000001_26_L000027)<<S32
 word I16A_MOV + (r20)<<D16A + RI<<S16A ' reg <- INDIRF4 addrg
 word I16A_MOV + (r0)<<D16A + (r22)<<S16A ' setup r0/r1 (2)
 word I16A_MOV + (r1)<<D16A + (r20)<<S16A ' setup r0/r1 (2)
 word I16B_FLTP + FCMP<<S16B
 alignl ' align long
 long I32_BR_B + (@C_savg_67e3465f_str_cvt_L000001_23)<<S32 ' LTF4
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_21
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_10
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 alignl ' align long
 long I32_BRNZ + (@C_savg_67e3465f_str_cvt_L000001_28)<<S32 ' NEI4 reg coni
 word I16A_ADDS + (r11)<<D16A + (r15)<<S16A ' ADDI/P (2)
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_28
 word I16A_WRLONG + (r15)<<D16A + (r23)<<S16A ' ASGNI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r11)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r20)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_savg_67e3465f_str_cvt_L000001_33)<<S32 ' GEU4 reg reg
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRBYTE + (r22)<<D16A + (r17)<<S16A ' ASGNU1 reg reg
 word I16A_MOV + (r0)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_savg_67e3465f_str_cvt_L000001_2)<<S32 ' JUMPV addrg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_32
 alignl ' align long
 long I32_LODI + (@C_savg_67e3465f_str_cvt_L000001_14_L000015)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRF4 addrg
 word I16B_LODF + ((8)&$1FF)<<S16B
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_33
 word I16A_MOV + (r20)<<D16A + (r11)<<S16A ' CVI, CVU or LOAD
 word I16A_CMP + (r13)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_savg_67e3465f_str_cvt_L000001_35)<<S32 ' GTU4 reg reg
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((80)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r20)<<D16A + (r17)<<S16A ' ADDI/P (2)
 word I16A_CMP + (r13)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_savg_67e3465f_str_cvt_L000001_32)<<S32 ' LTU4 reg reg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_35
 word I16A_MOV + (r22)<<D16A + (r11)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((80)&$7FFFF)<<S32 ' reg <- cons
 word I16A_ADDS + (r20)<<D16A + (r17)<<S16A ' ADDI/P (2)
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_savg_67e3465f_str_cvt_L000001_36)<<S32 ' LTU4 reg reg
 alignl ' align long
 ...
 long I32_JMPA + (@C_savg_67e3465f_str_cvt_L000001_2)<<S32 ' JUMPV addrg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_36
 ...
 alignl ' align long
 long I32_JMPA + (@C_savg_67e3465f_str_cvt_L000001_39)<<S32 ' JUMPV addrg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_38
 alignl ' align long
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_savg_67e3465f_str_cvt_L000001_41)<<S32 ' LEU4 reg reg
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_ADDS + (r22)<<D16A + (r11)<<S16A ' ADDI/P (2)
 word I16A_MOV + (r11)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
 long I32_JMPA + (@C_savg_67e3465f_str_cvt_L000001_42)<<S32 ' JUMPV addrg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_41
 alignl ' align long
 ...
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_savg_67e3465f_str_cvt_L000001_43)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r13)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r20)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_savg_67e3465f_str_cvt_L000001_45)<<S32 ' LEU4 reg reg
 alignl ' align long
 long I32_MOVI + (r22)<<D32 +(48)<<S32 ' reg <- conli
 word I16A_WRBYTE + (r22)<<D16A + (r13)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_45
 word I16A_ADDSI + (r13)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_43
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_42
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_39
 word I16A_RDBYTE + (r22)<<D16A + (r11)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_savg_67e3465f_str_cvt_L000001_38)<<S32 ' GTI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRBYTE + (r22)<<D16A + (r13)<<S16A ' ASGNU1 reg reg
 word I16A_MOV + (r0)<<D16A + (r17)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_2
...
C__ecvt ' <symbol:_ecvt>
 ...
 alignl ' align long
 long I32_CALA + (@C_savg_67e3465f_str_cvt_L000001)<<S32
...
DAT ' const data segment
 ...
 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_26_L000027 ' <symbol:26>
 long $3f800000 ' float

 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_16_L000017 ' <symbol:16>
 long $3cf5c28f ' float

 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_14_L000015 ' <symbol:14>
 long $41200000 ' float

 alignl ' align long
C_savg_67e3465f_str_cvt_L000001_7_L000008 ' <symbol:7>
 long $0 ' float
