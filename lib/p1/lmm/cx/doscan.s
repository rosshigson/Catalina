...
'
 ...
 alignl ' align long
C_s6n8_690ed760_o_collect_L000003 ' <symbol:o_collect>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r11, r22 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_8 ' EQI4
 cmps r11, r22 wz,wc
 jmp #BR_A
 long @C_s6n8_690ed760_o_collect_L000003_13 ' GTI4
' C_s6n8_690ed760_o_collect_L000003_12 ' (symbol refcount = 0)
 mov r22, #88 ' reg <- coni
 cmps r11, r22 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_8 ' EQI4
 cmps r11, r22 wz,wc
 jmp #BR_B
 long @C_s6n8_690ed760_o_collect_L000003_5 ' LTI4
' C_s6n8_690ed760_o_collect_L000003_14 ' (symbol refcount = 0)
 cmps r11,  #98 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_11 ' EQI4
 cmps r11,  #100 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_9 ' EQI4
 jmp #JMPA
 long @C_s6n8_690ed760_o_collect_L000003_5 ' JUMPV addrg
C_s6n8_690ed760_o_collect_L000003_13
 mov r22, #111 ' reg <- coni
 cmps r11, r22 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_10 ' EQI4
 cmps r11,  #112 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_8 ' EQI4
 cmps r11, r22 wz,wc
 jmp #BR_B
 long @C_s6n8_690ed760_o_collect_L000003_5 ' LTI4
' C_s6n8_690ed760_o_collect_L000003_15 ' (symbol refcount = 0)
 cmps r11,  #117 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_9 ' EQI4
 cmps r11,  #120 wz
 ...
 jmp #JMPA
 long @C_s6n8_690ed760_o_collect_L000003_5 ' JUMPV addrg
C_s6n8_690ed760_o_collect_L000003_8
 mov r13, #16 ' reg <- coni
 jmp #JMPA
 long @C_s6n8_690ed760_o_collect_L000003_6 ' JUMPV addrg
C_s6n8_690ed760_o_collect_L000003_9
 mov r13, #10 ' reg <- coni
 jmp #JMPA
 long @C_s6n8_690ed760_o_collect_L000003_6 ' JUMPV addrg
C_s6n8_690ed760_o_collect_L000003_10
 mov r13, #8 ' reg <- coni
 jmp #JMPA
 long @C_s6n8_690ed760_o_collect_L000003_6 ' JUMPV addrg
C_s6n8_690ed760_o_collect_L000003_11
 mov r13, #2 ' reg <- coni
C_s6n8_690ed760_o_collect_L000003_5
C_s6n8_690ed760_o_collect_L000003_6
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #45 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_18 ' EQI4
 cmps r22,  #43 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_16 ' NEI4
C_s6n8_690ed760_o_collect_L000003_18
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_19 ' EQI4
 mov RI, FP
 add RI, #12
...
C_s6n8_690ed760_o_collect_L000003_19
C_s6n8_690ed760_o_collect_L000003_16
 cmps r21,  #0 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_21 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #48 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_21 ' NEI4
 cmps r13,  #16 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_21 ' NEI4
 mov r22, r15 ' CVI, CVU or LOAD
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_23 ' EQI4
 mov RI, FP
 add RI, #12
 rdlong r2, RI ' reg ARG INDIR ADDRFi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 long 8
 wrlong r0, RI ' ASGNI4 addrl reg
C_s6n8_690ed760_o_collect_L000003_23
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #120 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_25 ' EQI4
 cmps r22,  #88 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_25 ' EQI4
 mov r22, r23 ' CVUI
 ...
 cmps r22,  #105 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_36 ' NEI4
 mov r13, #8 ' reg <- coni
 jmp #JMPA
 long @C_s6n8_690ed760_o_collect_L000003_36 ' JUMPV addrg
C_s6n8_690ed760_o_collect_L000003_25
 cmps r21,  #0 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_36 ' EQI4
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, FP
 ...
 jmp #JMPA
 long @C_s6n8_690ed760_o_collect_L000003_36 ' JUMPV addrg
C_s6n8_690ed760_o_collect_L000003_21
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #105 wz
 jmp #BRNZ
 ...
 jmp #JMPA
 long @C_s6n8_690ed760_o_collect_L000003_36 ' JUMPV addrg
C_s6n8_690ed760_o_collect_L000003_35
 cmps r13,  #10 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_42 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 ...
 cmp r22,  #10 wz,wc 
 jmp #BR_B
 long @C_s6n8_690ed760_o_collect_L000003_45' LTU4
C_s6n8_690ed760_o_collect_L000003_42
 cmps r13,  #16 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_44 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 jmp #LODL
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_45 ' NEI4
C_s6n8_690ed760_o_collect_L000003_44
 cmps r13,  #8 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_47 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, r22
 ...
 cmp r20,  #10 wz,wc 
 jmp #BRAE
 long @C_s6n8_690ed760_o_collect_L000003_47 ' GEU4
 cmps r22,  #56 wz,wc
 jmp #BR_B
 long @C_s6n8_690ed760_o_collect_L000003_45 ' LTI4
C_s6n8_690ed760_o_collect_L000003_47
 cmps r13,  #2 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_37 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 mov r20, r22
 ...
 cmp r20,  #10 wz,wc 
 jmp #BRAE
 long @C_s6n8_690ed760_o_collect_L000003_37 ' GEU4
 cmps r22,  #50 wz,wc
 jmp #BRAE
 long @C_s6n8_690ed760_o_collect_L000003_37 ' GEI4
C_s6n8_690ed760_o_collect_L000003_45
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, FP
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_39 ' EQI4
 mov RI, FP
 add RI, #12
 rdlong r2, RI ' reg ARG INDIR ADDRFi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 long 8
 wrlong r0, RI ' ASGNI4 addrl reg
C_s6n8_690ed760_o_collect_L000003_39
C_s6n8_690ed760_o_collect_L000003_36
 cmps r21,  #0 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_35 ' NEI4
C_s6n8_690ed760_o_collect_L000003_37
 cmps r21,  #0 wz
 jmp #BR_Z
 long @C_s6n8_690ed760_o_collect_L000003_50 ' EQI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 jmp #LODL
 ...
 long @C_ungetc
 add SP, #4 ' CALL addrg
C_s6n8_690ed760_o_collect_L000003_50
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 cmps r22,  #105 wz
 jmp #BRNZ
 long @C_s6n8_690ed760_o_collect_L000003_52 ' NEI4
 mov r13, #0 ' reg <- coni
C_s6n8_690ed760_o_collect_L000003_52
...
' C_s6n8_690ed760_o_collect_L000003_4 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s6n81_690ed760_f_collect_L000054 ' <symbol:f_collect>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r23,  #45 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_58 ' EQI4
 cmps r23,  #43 wz
 jmp #BRNZ
 long @C_s6n81_690ed760_f_collect_L000054_62 ' NEI4
C_s6n81_690ed760_f_collect_L000054_58
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_62 ' EQI4
 ...
 jmp #JMPA
 long @C_s6n81_690ed760_f_collect_L000054_62 ' JUMPV addrg
C_s6n81_690ed760_f_collect_L000054_61
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_64 ' EQI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_getc ' CALL addrg
 mov r23, r0 ' CVI, CVU or LOAD
C_s6n81_690ed760_f_collect_L000054_64
C_s6n81_690ed760_f_collect_L000054_62
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_66 ' EQI4
 mov r22, r23
 subs r22, #48 ' SUBI4 coni
 cmp r22,  #10 wz,wc 
 jmp #BR_B
 long @C_s6n81_690ed760_f_collect_L000054_61' LTU4
C_s6n81_690ed760_f_collect_L000054_66
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_67 ' EQI4
 cmps r23,  #46 wz
 jmp #BRNZ
 long @C_s6n81_690ed760_f_collect_L000054_67 ' NEI4
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, r23 ' CVI, CVU or LOAD
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_72 ' EQI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_getc ' CALL addrg
 mov r23, r0 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s6n81_690ed760_f_collect_L000054_72 ' JUMPV addrg
C_s6n81_690ed760_f_collect_L000054_71
 adds r13, #1 ' ADDI4 coni
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_74 ' EQI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_getc ' CALL addrg
 mov r23, r0 ' CVI, CVU or LOAD
C_s6n81_690ed760_f_collect_L000054_74
C_s6n81_690ed760_f_collect_L000054_72
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_76 ' EQI4
 mov r22, r23
 subs r22, #48 ' SUBI4 coni
 cmp r22,  #10 wz,wc 
 jmp #BR_B
 long @C_s6n81_690ed760_f_collect_L000054_71' LTU4
C_s6n81_690ed760_f_collect_L000054_76
C_s6n81_690ed760_f_collect_L000054_67
 cmps r13,  #0 wz
 jmp #BRNZ
 long @C_s6n81_690ed760_f_collect_L000054_77 ' NEI4
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_79 ' EQI4
 jmp #LODL
 long -1
 mov r22, RI ' reg <- con
 cmps r23, r22 wz
 ...
 long @C_ungetc
 add SP, #4 ' CALL addrg
C_s6n81_690ed760_f_collect_L000054_79
 jmp #LODL
 long -1
 mov r22, RI ' reg <- con
 mov r0, r17 ' ADDI/P
 adds r0, r22 ' ADDI/P (3)
 jmp #JMPA
 long @C_s6n81_690ed760_f_collect_L000054_55 ' JUMPV addrg
C_s6n81_690ed760_f_collect_L000054_77
 mov r13, #0 ' reg <- coni
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_81 ' EQI4
 cmps r23,  #101 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_83 ' EQI4
 cmps r23,  #69 wz
 jmp #BRNZ
 long @C_s6n81_690ed760_f_collect_L000054_81 ' NEI4
C_s6n81_690ed760_f_collect_L000054_83
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, r23 ' CVI, CVU or LOAD
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_84 ' EQI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_getc ' CALL addrg
 mov r23, r0 ' CVI, CVU or LOAD
C_s6n81_690ed760_f_collect_L000054_84
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_92 ' EQI4
 cmps r23,  #43 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_88 ' EQI4
 cmps r23,  #45 wz
 jmp #BRNZ
 long @C_s6n81_690ed760_f_collect_L000054_92 ' NEI4
C_s6n81_690ed760_f_collect_L000054_88
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 mov r20, r23 ' CVI, CVU or LOAD
 ...
 mov r23, r0 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s6n81_690ed760_f_collect_L000054_92 ' JUMPV addrg
C_s6n81_690ed760_f_collect_L000054_91
 adds r13, #1 ' ADDI4 coni
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #1 ' ADDP4 coni
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_94 ' EQI4
 mov r2, r21 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_getc ' CALL addrg
 mov r23, r0 ' CVI, CVU or LOAD
C_s6n81_690ed760_f_collect_L000054_94
C_s6n81_690ed760_f_collect_L000054_92
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_96 ' EQI4
 mov r22, r23
 subs r22, #48 ' SUBI4 coni
 cmp r22,  #10 wz,wc 
 jmp #BR_B
 long @C_s6n81_690ed760_f_collect_L000054_91' LTU4
C_s6n81_690ed760_f_collect_L000054_96
 cmps r13,  #0 wz
 jmp #BRNZ
 long @C_s6n81_690ed760_f_collect_L000054_97 ' NEI4
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_99 ' EQI4
 jmp #LODL
 long -1
 mov r22, RI ' reg <- con
 cmps r23, r22 wz
 ...
 long @C_ungetc
 add SP, #4 ' CALL addrg
C_s6n81_690ed760_f_collect_L000054_99
 jmp #LODL
 long -1
 mov r22, RI ' reg <- con
 mov r0, r17 ' ADDI/P
 ...
 jmp #JMPA
 long @C_s6n81_690ed760_f_collect_L000054_55 ' JUMPV addrg
C_s6n81_690ed760_f_collect_L000054_97
C_s6n81_690ed760_f_collect_L000054_81
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s6n81_690ed760_f_collect_L000054_101 ' EQI4
 jmp #LODL
 long -1
 mov r22, RI ' reg <- con
 cmps r23, r22 wz
 ...
 long @C_ungetc
 add SP, #4 ' CALL addrg
C_s6n81_690ed760_f_collect_L000054_101
 mov r22, #0 ' reg <- coni
 wrbyte r22, r15 ' ASGNU1 reg reg
 jmp #LODL
 long -1
 ...
 mov r0, r15 ' ADDI/P
 adds r0, r22 ' ADDI/P (3)
C_s6n81_690ed760_f_collect_L000054_55
 jmp #POPM ' restore registers
 jmp #RETF
...
C__doscan_184
 ...
 jmp #CALA
 long @C_s6n8_690ed760_o_collect_L000003
...
C__doscan_294
 ...
 jmp #CALA
 long @C_s6n81_690ed760_f_collect_L000054
