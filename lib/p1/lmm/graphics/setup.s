...
C__cgi_cog ' <symbol:_cgi_cog>
 ...
 alignl ' align long
C_s10e0_68fd74e0_colors_L000004 ' <symbol:colors>
 long $0
 long $55555555
 long $aaaaaaaa
 long $ffffffff
 ...
 alignl ' align long
C_s10e01_68fd74e0_font_L000005 ' <symbol:font>
 word $9d62
 word $112a
 word $b0e9
 word $31eb
...
C_g_setup ' <symbol:g_setup>
 ...
 mov r15, #0 ' reg <- coni
 jmp #JMPA
 long @C_g_setup_11 ' JUMPV addrg
C_g_setup_8
 mov r22, r15
 shl r22, #1 ' LSHI4 coni
 jmp #LODL
 long @C_G__V_A_R_+116
...
C_g_setup_15
 ...
 cmps r15, r22 wz,wc
 jmp #BRBE
 long @C_g_setup_8 ' LEI4
 jmp #LODL
 long @C_G__V_A_R_
 wrlong r11, RI ' ASGNI4 addrg reg
 jmp #LODL
 long @C_G__V_A_R_+4
 wrlong r9, RI ' ASGNI4 addrg reg
...
C_g_setup_26
 ...
 jmp #LODL
 long @C_s10e0_68fd74e0_colors_L000004
...
' C_g_setup_27 ' (symbol refcount = 0)
 ...
 adds r17, #4 ' ADDP4 coni
 jmp #LODL
 long @C_s10e01_68fd74e0_font_L000005
 mov r20, RI ' reg <- addrg
