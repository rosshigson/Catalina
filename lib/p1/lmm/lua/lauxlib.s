...
'
 ...
 alignl ' align long
C_s5so_67d10db3_findfield_L000004 ' <symbol:findfield>
 jmp #NEWF
 jmp #PSHM
 ...
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s5so_67d10db3_findfield_L000004_8 ' EQI4
 jmp #LODL
 long -1
 ...
 cmps r0,  #5 wz
 jmp #BR_Z
 long @C_s5so_67d10db3_findfield_L000004_6 ' EQI4
C_s5so_67d10db3_findfield_L000004_8
 mov r0, #0 ' RET coni
 jmp #JMPA
 long @C_s5so_67d10db3_findfield_L000004_5 ' JUMPV addrg
C_s5so_67d10db3_findfield_L000004_6
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_lua_pushnil ' CALL addrg
 jmp #JMPA
 long @C_s5so_67d10db3_findfield_L000004_10 ' JUMPV addrg
C_s5so_67d10db3_findfield_L000004_9
 jmp #LODL
 long -2
 mov r2, RI ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 ...
 cmps r0,  #4 wz
 jmp #BRNZ
 long @C_s5so_67d10db3_findfield_L000004_12 ' NEI4
 jmp #LODL
 long -1
 mov r2, RI ' reg ARG con
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s5so_67d10db3_findfield_L000004_14 ' EQI4
 jmp #LODL
 long -2
 mov r2, RI ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 ...
 jmp #JMPA
 long @C_s5so_67d10db3_findfield_L000004_5 ' JUMPV addrg
C_s5so_67d10db3_findfield_L000004_14
 mov r2, r19
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so_67d10db3_findfield_L000004
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s5so_67d10db3_findfield_L000004_16 ' EQI4
 jmp #LODL
 long @C_s5so_67d10db3_findfield_L000004_18_L000019
 ...
 jmp #JMPA
 long @C_s5so_67d10db3_findfield_L000004_5 ' JUMPV addrg
C_s5so_67d10db3_findfield_L000004_16
C_s5so_67d10db3_findfield_L000004_12
 jmp #LODL
 long -2
 mov r2, RI ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 ...
 long @C_lua_settop
 add SP, #4 ' CALL addrg
C_s5so_67d10db3_findfield_L000004_10
 jmp #LODL
 long -2
 mov r2, RI ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 ...
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_s5so_67d10db3_findfield_L000004_9 ' NEI4
 mov r0, #0 ' RET coni
C_s5so_67d10db3_findfield_L000004_5
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5so2_67d10db3_pushglobalfuncname_L000020 ' <symbol:pushglobalfuncname>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $e80000 ' save registers
 ...
 jmp #LODL
 long @C_s5so2_67d10db3_pushglobalfuncname_L000020_22_L000023
 ...
 add SP, #8 ' CALL addrg
 jmp #LODL
 long @C_s5so2_67d10db3_pushglobalfuncname_L000020_24_L000025
 mov r2, RI ' reg ARG ADDRG
 jmp #LODL
 long -1001000
 mov r3, RI ' reg ARG con
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s5so2_67d10db3_pushglobalfuncname_L000020_26 ' EQI4
 jmp #LODL
 long 0
 mov r2, RI ' reg ARG con
 jmp #LODL
 ...
 mov r2, #3 ' reg ARG coni
 jmp #LODL
 long @C_s5so2_67d10db3_pushglobalfuncname_L000020_30_L000031
 mov r3, RI ' reg ARG ADDRG
 mov RI, FP
 sub RI, #-(-8)
 ...
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_s5so2_67d10db3_pushglobalfuncname_L000020_28 ' NEI4
 mov r22, FP
 ...
 long @C_lua_settop
 add SP, #4 ' CALL addrg
C_s5so2_67d10db3_pushglobalfuncname_L000020_28
 mov r2, r19
 ...
 mov r0, #1 ' RET coni
 jmp #JMPA
 long @C_s5so2_67d10db3_pushglobalfuncname_L000020_21 ' JUMPV addrg
C_s5so2_67d10db3_pushglobalfuncname_L000020_26
 ...
 add SP, #4 ' CALL addrg
 mov r0, #0 ' RET coni
C_s5so2_67d10db3_pushglobalfuncname_L000020_21
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s5so6_67d10db3_pushfuncname_L000032 ' <symbol:pushfuncname>
 jmp #NEWF
 jmp #PSHM
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so2_67d10db3_pushglobalfuncname_L000020
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s5so6_67d10db3_pushfuncname_L000032_34 ' EQI4
 jmp #LODL
 long 0
 mov r2, RI ' reg ARG con
 jmp #LODL
 ...
 jmp #LODL
 long @C_s5so6_67d10db3_pushfuncname_L000032_36_L000037
 mov r3, RI ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 add SP, #4 ' CALL addrg
 jmp #JMPA
 long @C_s5so6_67d10db3_pushfuncname_L000032_35 ' JUMPV addrg
C_s5so6_67d10db3_pushfuncname_L000032_34
 mov r22, r21
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s5so6_67d10db3_pushfuncname_L000032_38 ' EQI4
 mov r22, r21
 ...
 jmp #LODL
 long @C_s5so6_67d10db3_pushfuncname_L000032_40_L000041
 ...
 jmp #JMPA
 long @C_s5so6_67d10db3_pushfuncname_L000032_39 ' JUMPV addrg
C_s5so6_67d10db3_pushfuncname_L000032_38
 mov r22, r21
 ...
 cmps r22,  #109 wz
 jmp #BRNZ
 long @C_s5so6_67d10db3_pushfuncname_L000032_42 ' NEI4
 jmp #LODL
 long @C_s5so6_67d10db3_pushfuncname_L000032_44_L000045
 mov r2, RI ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 add SP, #4 ' CALL addrg
 jmp #JMPA
 long @C_s5so6_67d10db3_pushfuncname_L000032_43 ' JUMPV addrg
C_s5so6_67d10db3_pushfuncname_L000032_42
 mov r22, r21
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 rdbyte r22, r22 ' reg <- INDIRU1 reg
 ...
 cmps r22,  #67 wz
 jmp #BR_Z
 long @C_s5so6_67d10db3_pushfuncname_L000032_46 ' EQI4
 mov r22, r21
 ...
 jmp #LODL
 long @C_s5so6_67d10db3_pushfuncname_L000032_48_L000049
 mov r4, RI ' reg ARG ADDRG
 mov r5, r23 ' CVI, CVU or LOAD
 mov BC, #16 ' arg size, rpsize = 16, spsize = 16
 sub SP, #12 ' stack space for reg ARGs
 ...
 add SP, #12 ' CALL addrg
 jmp #JMPA
 long @C_s5so6_67d10db3_pushfuncname_L000032_47 ' JUMPV addrg
C_s5so6_67d10db3_pushfuncname_L000032_46
 jmp #LODL
 long @C_s5so6_67d10db3_pushfuncname_L000032_50_L000051
 mov r2, RI ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 long @C_lua_pushstring
 add SP, #4 ' CALL addrg
C_s5so6_67d10db3_pushfuncname_L000032_47
C_s5so6_67d10db3_pushfuncname_L000032_43
C_s5so6_67d10db3_pushfuncname_L000032_39
C_s5so6_67d10db3_pushfuncname_L000032_35
' C_s5so6_67d10db3_pushfuncname_L000032_33 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5soc_67d10db3_lastlevel_L000052 ' <symbol:lastlevel>
 jmp #NEWF
 sub SP, #108
 jmp #PSHM
 ...
 mov r21, #1 ' reg <- coni
 jmp #JMPA
 long @C_s5soc_67d10db3_lastlevel_L000052_55 ' JUMPV addrg
C_s5soc_67d10db3_lastlevel_L000052_54
 mov r19, r21 ' CVI, CVU or LOAD
 shl r21, #1 ' LSHI4 coni
C_s5soc_67d10db3_lastlevel_L000052_55
 mov r2, FP
 ...
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_s5soc_67d10db3_lastlevel_L000052_54 ' NEI4
 jmp #JMPA
 long @C_s5soc_67d10db3_lastlevel_L000052_58 ' JUMPV addrg
C_s5soc_67d10db3_lastlevel_L000052_57
 mov r22, r19 ' ADDI/P
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s5soc_67d10db3_lastlevel_L000052_60 ' EQI4
 mov r19, r17
 adds r19, #1 ' ADDI4 coni
 jmp #JMPA
 long @C_s5soc_67d10db3_lastlevel_L000052_61 ' JUMPV addrg
C_s5soc_67d10db3_lastlevel_L000052_60
 mov r21, r17 ' CVI, CVU or LOAD
C_s5soc_67d10db3_lastlevel_L000052_61
C_s5soc_67d10db3_lastlevel_L000052_58
 cmps r19, r21 wz,wc
 jmp #BR_B
 long @C_s5soc_67d10db3_lastlevel_L000052_57 ' LTI4
 mov r0, r21
 subs r0, #1 ' SUBI4 coni
' C_s5soc_67d10db3_lastlevel_L000052_53 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
...
C_luaL__traceback ' <symbol:luaL_traceback>
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_s5soc_67d10db3_lastlevel_L000052 ' CALL addrg
...
C_luaL__traceback_84
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so6_67d10db3_pushfuncname_L000032
 add SP, #4 ' CALL addrg
 mov r2, FP
 sub r2, #-(-384) ' reg ARG ADDRLi
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
' C_luaL__typeerror_125 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s5sor_67d10db3_tag_error_L000136 ' <symbol:tag_error>
 jmp #NEWF
 jmp #PSHM
 long $e80000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 add SP, #8 ' CALL addrg
' C_s5sor_67d10db3_tag_error_L000136_137 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaL__checktype ' <symbol:luaL_checktype>
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5sor_67d10db3_tag_error_L000136
 add SP, #8 ' CALL addrg
...
' C_luaL__optnumber_224 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s5so15_67d10db3_interror_L000228 ' <symbol:interror>
 jmp #NEWF
 jmp #PSHM
 long $e00000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s5so15_67d10db3_interror_L000228_230 ' EQI4
 jmp #LODL
 long @C_s5so15_67d10db3_interror_L000228_232_L000233
 mov r2, RI ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 add SP, #8 ' CALL addrg
 jmp #JMPA
 long @C_s5so15_67d10db3_interror_L000228_231 ' JUMPV addrg
C_s5so15_67d10db3_interror_L000228_230
 mov r2, #3 ' reg ARG coni
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 long @C_s5sor_67d10db3_tag_error_L000136
 add SP, #8 ' CALL addrg
C_s5so15_67d10db3_interror_L000228_231
' C_s5so15_67d10db3_interror_L000228_229 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaL__checkinteger ' <symbol:luaL_checkinteger>
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so15_67d10db3_interror_L000228
 add SP, #4 ' CALL addrg
...
' C_luaL__optinteger_237 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s5so17_67d10db3_resizebox_L000241 ' <symbol:resizebox>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmp r20, r22 wz
 jmp #BRNZ
 long @C_s5so17_67d10db3_resizebox_L000241_243 ' NEU4
 cmp r19, r22 wz
 jmp #BR_Z
 long @C_s5so17_67d10db3_resizebox_L000241_243 ' EQU4
 jmp #LODL
 long @C_s5so17_67d10db3_resizebox_L000241_245_L000246
 mov r2, RI ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 jmp #CALA
 long @C_lua_error ' CALL addrg
C_s5so17_67d10db3_resizebox_L000241_243
 wrlong r15, r17 ' ASGNP4 reg reg
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 wrlong r19, r22 ' ASGNU4 reg reg
 mov r0, r15 ' CVI, CVU or LOAD
' C_s5so17_67d10db3_resizebox_L000241_242 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s5so19_67d10db3_boxgc_L000247 ' <symbol:boxgc>
 jmp #NEWF
 jmp #PSHM
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so17_67d10db3_resizebox_L000241
 add SP, #8 ' CALL addrg
 mov r0, #0 ' RET coni
' C_s5so19_67d10db3_boxgc_L000247_248 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF
...
DAT ' const data segment
 ...
 alignl ' align long
C_s5so1a_67d10db3_boxmt_L000249 ' <symbol:boxmt>
 long @C_s5so1b_67d10db3_250_L000251
 long @C_s5so19_67d10db3_boxgc_L000247
 long @C_s5so1c_67d10db3_252_L000253
 long @C_s5so19_67d10db3_boxgc_L000247
 long $0
 long $0
...
DAT ' code segment
 ...
 alignl ' align long
C_s5so1d_67d10db3_newbox_L000254 ' <symbol:newbox>
 jmp #NEWF
 jmp #PSHM
 long $f00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 ...
 jmp #LODL
 long @C_s5so1d_67d10db3_newbox_L000254_258_L000259
 mov r2, RI ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s5so1d_67d10db3_newbox_L000254_256 ' EQI4
 mov r2, #0 ' reg ARG coni
 jmp #LODL
 long @C_s5so1a_67d10db3_boxmt_L000249
 mov r3, RI ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 add SP, #8 ' CALL addrg
C_s5so1d_67d10db3_newbox_L000254_256
 jmp #LODL
 long -2
 mov r2, RI ' reg ARG con
 mov r3, r23 ' CVI, CVU or LOAD
 ...
 long @C_lua_setmetatable
 add SP, #4 ' CALL addrg
' C_s5so1d_67d10db3_newbox_L000254_255 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5so1f_67d10db3_newbuffsize_L000260 ' <symbol:newbuffsize>
 jmp #NEWF
 jmp #PSHM
 ...
 cmp r22, r20 wz,wc 
 jmp #BRAE
 long @C_s5so1f_67d10db3_newbuffsize_L000260_262 ' GEU4
 jmp #LODL
 long @C_s5so1f_67d10db3_newbuffsize_L000260_264_L000265
 mov r2, RI ' reg ARG ADDRG
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r3, r22 ' reg <- INDIRP4 reg
 ...
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s5so1f_67d10db3_newbuffsize_L000260_261 ' JUMPV addrg
C_s5so1f_67d10db3_newbuffsize_L000260_262
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 add r22, r21 ' ADDU (1)
 cmp r19, r22 wz,wc 
 jmp #BRAE
 long @C_s5so1f_67d10db3_newbuffsize_L000260_266 ' GEU4
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r19, r22 ' ADDU
 add r19, r21 ' ADDU (3)
C_s5so1f_67d10db3_newbuffsize_L000260_266
 mov r0, r19 ' CVI, CVU or LOAD
C_s5so1f_67d10db3_newbuffsize_L000260_261
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5so1h_67d10db3_prepbuffsize_L000268 ' <symbol:prepbuffsize>
 jmp #NEWF
 sub SP, #12
 jmp #PSHM
 long $f80000 ' save registers
 ...
 cmp r22, r21 wz,wc 
 jmp #BR_B
 long @C_s5so1h_67d10db3_prepbuffsize_L000268_270' LTU4
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 ...
 jmp #JMPA
 long @C_s5so1h_67d10db3_prepbuffsize_L000268_269 ' JUMPV addrg
C_s5so1h_67d10db3_prepbuffsize_L000268_270
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 jmp #LODF
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so1f_67d10db3_newbuffsize_L000260
 add SP, #4 ' CALL addrg
 jmp #LODF
 long -12
 ...
 cmp r22, r20 wz
 jmp #BR_Z
 long @C_s5so1h_67d10db3_prepbuffsize_L000268_272 ' EQU4
 mov RI, FP
 sub RI, #-(-12)
 rdlong r2, RI ' reg ARG INDIR ADDRLi
 mov r3, r19 ' CVI, CVU or LOAD
 ...
 wrlong r0, RI ' ASGNP4 addrl reg
 jmp #JMPA
 long @C_s5so1h_67d10db3_prepbuffsize_L000268_273 ' JUMPV addrg
C_s5so1h_67d10db3_prepbuffsize_L000268_272
 jmp #LODL
 long -1
 mov r2, RI ' reg ARG con
 mov r3, r19 ' CVI, CVU or LOAD
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_s5so1d_67d10db3_newbox_L000254 ' CALL addrg
 mov r2, #1 ' reg ARG coni
 mov r3, r19 ' CVI, CVU or LOAD
 mov RI, FP
 sub RI, #-(-8)
 ...
 long @C_memcpy
 add SP, #8 ' CALL addrg
C_s5so1h_67d10db3_prepbuffsize_L000268_273
 mov r22, FP
 ...
 mov r0, r22 ' ADDI/P
 adds r0, r20 ' ADDI/P (3)
C_s5so1h_67d10db3_prepbuffsize_L000268_269
 jmp #POPM ' restore registers
 add SP, #12 ' framesize
 jmp #RETF
...
C_luaL__prepbuffsize ' <symbol:luaL_prepbuffsize>
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so1h_67d10db3_prepbuffsize_L000268
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
' C_luaL__unref_293 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s5so1i_67d10db3_getF__L000296 ' <symbol:getF>
 jmp #NEWF
 jmp #PSHM
 long $ea0000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 cmps r22,  #0 wz,wc
 jmp #BRBE
 long @C_s5so1i_67d10db3_getF__L000296_298 ' LEI4
 rdlong r22, r17 ' reg <- INDIRI4 reg
 wrlong r22, r19 ' ASGNU4 reg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, r17 ' ASGNI4 reg reg
 jmp #JMPA
 long @C_s5so1i_67d10db3_getF__L000296_299 ' JUMPV addrg
C_s5so1i_67d10db3_getF__L000296_298
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 adds r22, #8 ' ADDP4 coni
 ...
 cmps r22,  #0 wz
 jmp #BR_Z
 long @C_s5so1i_67d10db3_getF__L000296_300 ' EQI4
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s5so1i_67d10db3_getF__L000296_297 ' JUMPV addrg
C_s5so1i_67d10db3_getF__L000296_300
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 jmp #LODL
...
C_s5so1i_67d10db3_getF__L000296_299
 mov r0, r17
 adds r0, #8 ' ADDP4 coni
C_s5so1i_67d10db3_getF__L000296_297
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5so1j_67d10db3_errfile_L000302 ' <symbol:errfile>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 long $e80000 ' save registers
 ...
 mov r4, r21 ' CVI, CVU or LOAD
 jmp #LODL
 long @C_s5so1j_67d10db3_errfile_L000302_304_L000305
 mov r5, RI ' reg ARG ADDRG
 sub SP, #16 ' stack space for reg ARGs
 mov RI, r23
 jmp #PSHL ' stack ARG
 ...
 add SP, #4 ' CALL addrg
 mov r0, #6 ' RET coni
' C_s5so1j_67d10db3_errfile_L000302_303 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s5so1l_67d10db3_skipB_O_M__L000306 ' <symbol:skipBOM>
 jmp #NEWF
 jmp #PSHM
 long $f80000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 jmp #LODL
 long @C_s5so1l_67d10db3_skipB_O_M__L000306_308_L000309
 mov r19, RI ' reg <- addrg
 mov r22, #0 ' reg <- coni
 wrlong r22, r23 ' ASGNI4 reg reg
C_s5so1l_67d10db3_skipB_O_M__L000306_310
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 cmps r21, r22 wz
 jmp #BR_Z
 long @C_s5so1l_67d10db3_skipB_O_M__L000306_315 ' EQI4
 mov r22, r19 ' CVI, CVU or LOAD
 mov r19, r22
 ...
 cmps r21, r22 wz
 jmp #BR_Z
 long @C_s5so1l_67d10db3_skipB_O_M__L000306_313 ' EQI4
C_s5so1l_67d10db3_skipB_O_M__L000306_315
 mov r0, r21 ' CVI, CVU or LOAD
 jmp #JMPA
 long @C_s5so1l_67d10db3_skipB_O_M__L000306_307 ' JUMPV addrg
C_s5so1l_67d10db3_skipB_O_M__L000306_313
 ...
 wrbyte r20, r22 ' ASGNU1 reg reg
' C_s5so1l_67d10db3_skipB_O_M__L000306_311 ' (symbol refcount = 0)
 rdbyte r22, r19 ' reg <- INDIRU1 reg
 and r22, cviu_m1 ' zero extend
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_s5so1l_67d10db3_skipB_O_M__L000306_310 ' NEI4
 mov r22, #0 ' reg <- coni
 wrlong r22, r23 ' ASGNI4 reg reg
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 ...
 long @C_getc ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
C_s5so1l_67d10db3_skipB_O_M__L000306_307
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5so1n_67d10db3_skipcomment_L000316 ' <symbol:skipcomment>
 jmp #NEWF
 jmp #PSHM
 long $e80000 ' save registers
 mov r23, r3 ' reg var <- reg arg
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_s5so1l_67d10db3_skipB_O_M__L000306 ' CALL addrg
 wrlong r0, r21 ' ASGNI4 reg reg
 mov r19, r0 ' CVI, CVU or LOAD
 cmps r19,  #35 wz
 jmp #BRNZ
 long @C_s5so1n_67d10db3_skipcomment_L000316_318 ' NEI4
C_s5so1n_67d10db3_skipcomment_L000316_320
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 long @C_getc ' CALL addrg
 mov r19, r0 ' CVI, CVU or LOAD
' C_s5so1n_67d10db3_skipcomment_L000316_321 ' (symbol refcount = 0)
 jmp #LODL
 long -1
 mov r22, RI ' reg <- con
 cmps r19, r22 wz
 jmp #BR_Z
 long @C_s5so1n_67d10db3_skipcomment_L000316_323 ' EQI4
 cmps r19,  #10 wz
 jmp #BRNZ
 long @C_s5so1n_67d10db3_skipcomment_L000316_320 ' NEI4
C_s5so1n_67d10db3_skipcomment_L000316_323
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r2, r22 ' reg <- INDIRP4 reg
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 ...
 mov r0, #1 ' RET coni
 jmp #JMPA
 long @C_s5so1n_67d10db3_skipcomment_L000316_317 ' JUMPV addrg
C_s5so1n_67d10db3_skipcomment_L000316_318
 mov r0, #0 ' RET coni
C_s5so1n_67d10db3_skipcomment_L000316_317
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaL__loadfilex_325
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so1j_67d10db3_errfile_L000302
 add SP, #8 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #JMPA
...
C_luaL__loadfilex_326
 ...
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so1n_67d10db3_skipcomment_L000316
 add SP, #4 ' CALL addrg
 cmps r0,  #0 wz
 jmp #BR_Z
...
C_luaL__loadfilex_356
 ...
 jmp #LODL
 long @C_s5so1i_67d10db3_getF__L000296
 mov r5, RI ' reg ARG ADDRG
 sub SP, #16 ' stack space for reg ARGs
 mov RI, r23
 jmp #PSHL ' stack ARG
...
C_luaL__loadfilex_324
 ...
 alignl ' align long
C_s5so20_67d10db3_getS__L000370 ' <symbol:getS>
 jmp #PSHM
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s5so20_67d10db3_getS__L000370_372 ' NEU4
 jmp #LODL
 long 0
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s5so20_67d10db3_getS__L000370_371 ' JUMPV addrg
C_s5so20_67d10db3_getS__L000370_372
 mov r22, r23
 adds r22, #4 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
...
C_s5so20_67d10db3_getS__L000370_371
 jmp #POPM ' restore registers
 jmp #RETN
...
C_luaL__loadbufferx ' <symbol:luaL_loadbufferx>
 ...
 jmp #LODL
 long @C_s5so20_67d10db3_getS__L000370
 mov r5, RI ' reg ARG ADDRG
 sub SP, #16 ' stack space for reg ARGs
 jmp #PSHF
...
' C_luaL__gsub_456 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s5so2d_67d10db3_l_alloc_L000457 ' <symbol:l_alloc>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 long $ea0000 ' save registers
 ...
 cmp r17,  #0 wz
 jmp #BRNZ
 long @C_s5so2d_67d10db3_l_alloc_L000457_459 ' NEU4
 mov r2, r21 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 ...
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s5so2d_67d10db3_l_alloc_L000457_458 ' JUMPV addrg
C_s5so2d_67d10db3_l_alloc_L000457_459
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, r21 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_s5so2d_67d10db3_l_alloc_L000457_461 ' EQU4
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s5so2d_67d10db3_l_alloc_L000457_463 ' NEU4
 mov r2, r17 ' CVI, CVU or LOAD
 mov r3, #0 ' reg ARG coni
 mov RI, FP
 sub RI, #-(-8)
 ...
 add SP, #8 ' CALL addrg
 jmp #JMPA
 long @C_s5so2d_67d10db3_l_alloc_L000457_464 ' JUMPV addrg
C_s5so2d_67d10db3_l_alloc_L000457_463
 cmp r17, r19 wz,wc 
 jmp #BRBE
 long @C_s5so2d_67d10db3_l_alloc_L000457_465 ' LEU4
 mov r2, r17 ' SUBU
 sub r2, r19 ' SUBU (3)
 mov r3, #0 ' reg ARG coni
 mov r22, FP
 ...
 long @C_memset
 add SP, #8 ' CALL addrg
C_s5so2d_67d10db3_l_alloc_L000457_465
C_s5so2d_67d10db3_l_alloc_L000457_464
C_s5so2d_67d10db3_l_alloc_L000457_461
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r0, r22 ' reg <- INDIRP4 reg
C_s5so2d_67d10db3_l_alloc_L000457_458
 jmp #POPM ' restore registers
 add SP, #4 ' framesize
 jmp #RETF
 ...
 alignl ' align long
C_s5so2e_67d10db3_panic_L000467 ' <symbol:panic>
 jmp #NEWF
 jmp #PSHM
 long $e00000 ' save registers
 mov r23, r2 ' reg var <- reg arg
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s5so2e_67d10db3_panic_L000467_469 ' NEU4
 jmp #LODL
 long @C_s5so2e_67d10db3_panic_L000467_471_L000472
 mov r21, RI ' reg <- addrg
C_s5so2e_67d10db3_panic_L000467_469
 mov r2, r21 ' CVI, CVU or LOAD
 jmp #LODL
 long @C_s5so2e_67d10db3_panic_L000467_473_L000474
 mov r3, RI ' reg ARG ADDRG
 jmp #LODL
 long @C___stderr
 mov r4, RI ' reg ARG ADDRG
 ...
 mov r0, #0 ' RET coni
' C_s5so2e_67d10db3_panic_L000467_468 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5so2k_67d10db3_checkcontrol_L000478 ' <symbol:checkcontrol>
 jmp #NEWF
 jmp #PSHM
 long $e80000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 cmps r19,  #0 wz
 jmp #BRNZ
 long @C_s5so2k_67d10db3_checkcontrol_L000478_482 ' NEI4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r21, r22
 ...
 cmps r22,  #64 wz
 jmp #BR_Z
 long @C_s5so2k_67d10db3_checkcontrol_L000478_480 ' EQI4
C_s5so2k_67d10db3_checkcontrol_L000478_482
 mov r0, #0 ' RET coni
 jmp #JMPA
 long @C_s5so2k_67d10db3_checkcontrol_L000478_479 ' JUMPV addrg
C_s5so2k_67d10db3_checkcontrol_L000478_480
 jmp #LODL
 long @C_s5so2k_67d10db3_checkcontrol_L000478_485_L000486
 mov r2, RI ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_s5so2k_67d10db3_checkcontrol_L000478_483 ' NEI4
 mov r2, r23 ' CVI, CVU or LOAD
 jmp #LODL
 long @C_s5so2h_67d10db3_warnfoff_L000475
 mov r3, RI ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 add SP, #8 ' CALL addrg
 jmp #JMPA
 long @C_s5so2k_67d10db3_checkcontrol_L000478_484 ' JUMPV addrg
C_s5so2k_67d10db3_checkcontrol_L000478_483
 jmp #LODL
 long @C_s5so2k_67d10db3_checkcontrol_L000478_489_L000490
 mov r2, RI ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 ...
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_s5so2k_67d10db3_checkcontrol_L000478_487 ' NEI4
 mov r2, r23 ' CVI, CVU or LOAD
 jmp #LODL
 long @C_s5so2i_67d10db3_warnfon_L000476
 mov r3, RI ' reg ARG ADDRG
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 long @C_lua_setwarnf
 add SP, #8 ' CALL addrg
C_s5so2k_67d10db3_checkcontrol_L000478_487
C_s5so2k_67d10db3_checkcontrol_L000478_484
 mov r0, #1 ' RET coni
C_s5so2k_67d10db3_checkcontrol_L000478_479
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5so2h_67d10db3_warnfoff_L000475 ' <symbol:warnfoff>
 jmp #NEWF
 jmp #PSHM
 ...
 sub SP, #8 ' stack space for reg ARGs
 jmp #CALA
 long @C_s5so2k_67d10db3_checkcontrol_L000478
 add SP, #8 ' CALL addrg
' C_s5so2h_67d10db3_warnfoff_L000475_491 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5so2j_67d10db3_warnfcont_L000477 ' <symbol:warnfcont>
 jmp #NEWF
 jmp #PSHM
 ...
 mov r2, r21 ' CVI, CVU or LOAD
 jmp #LODL
 long @C_s5so2j_67d10db3_warnfcont_L000477_493_L000494
 mov r3, RI ' reg ARG ADDRG
 jmp #LODL
 long @C___stderr
 mov r4, RI ' reg ARG ADDRG
 ...
 cmps r19,  #0 wz
 jmp #BR_Z
 long @C_s5so2j_67d10db3_warnfcont_L000477_495 ' EQI4
 mov r2, r17 ' CVI, CVU or LOAD
 jmp #LODL
 long @C_s5so2j_67d10db3_warnfcont_L000477
 mov r3, RI ' reg ARG ADDRG
 ...
 add SP, #8 ' CALL addrg
 jmp #JMPA
 long @C_s5so2j_67d10db3_warnfcont_L000477_496 ' JUMPV addrg
C_s5so2j_67d10db3_warnfcont_L000477_495
 jmp #LODL
 long @C_s5so2j_67d10db3_warnfcont_L000477_497_L000498
 mov r2, RI ' reg ARG ADDRG
 jmp #LODL
 long @C_s5so2j_67d10db3_warnfcont_L000477_493_L000494
 mov r3, RI ' reg ARG ADDRG
 ...
 long @C_lua_setwarnf
 add SP, #8 ' CALL addrg
C_s5so2j_67d10db3_warnfcont_L000477_496
' C_s5so2j_67d10db3_warnfcont_L000477_492 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 alignl ' align long
C_s5so2i_67d10db3_warnfon_L000476 ' <symbol:warnfon>
 jmp #NEWF
 jmp #PSHM
 long $e80000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_s5so2i_67d10db3_warnfon_L000476_500 ' EQI4
 jmp #JMPA
 long @C_s5so2i_67d10db3_warnfon_L000476_499 ' JUMPV addrg
C_s5so2i_67d10db3_warnfon_L000476_500
 jmp #LODL
 long @C_s5so2i_67d10db3_warnfon_L000476_502_L000503
 mov r2, RI ' reg ARG ADDRG
 jmp #LODL
 long @C_s5so2j_67d10db3_warnfcont_L000477_493_L000494
 mov r3, RI ' reg ARG ADDRG
 ...
 long @C_s5so2j_67d10db3_warnfcont_L000477
 add SP, #8 ' CALL addrg
C_s5so2i_67d10db3_warnfon_L000476_499
 jmp #POPM ' restore registers
 jmp #RETF
...
C_luaL__newstate ' <symbol:luaL_newstate>
 ...
 mov r2, RI ' reg ARG con
 jmp #LODL
 long @C_s5so2d_67d10db3_l_alloc_L000457
 mov r3, RI ' reg ARG ADDRG
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 jmp #CALA
 ...
 jmp #LODL
 long @C_s5so2e_67d10db3_panic_L000467
 mov r2, RI ' reg ARG ADDRG
 mov r3, r23 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
...
C_luaL__checkversion__510_L000511 ' <symbol:510>
 ...
 alignl ' align long
C_s5so2i_67d10db3_warnfon_L000476_502_L000503 ' <symbol:502>
 byte 76
 byte 117
 byte 97
 byte 32
 ...
 alignl ' align long
C_s5so2j_67d10db3_warnfcont_L000477_497_L000498 ' <symbol:497>
 byte 10
 byte 0

 alignl ' align long
C_s5so2j_67d10db3_warnfcont_L000477_493_L000494 ' <symbol:493>
 byte 37
 byte 115
 byte 0

 alignl ' align long
C_s5so2k_67d10db3_checkcontrol_L000478_489_L000490 ' <symbol:489>
 byte 111
 byte 110
 byte 0

 alignl ' align long
C_s5so2k_67d10db3_checkcontrol_L000478_485_L000486 ' <symbol:485>
 byte 111
 byte 102
 byte 102
 byte 0
 ...
 alignl ' align long
C_s5so2e_67d10db3_panic_L000467_473_L000474 ' <symbol:473>
 byte 80
 byte 65
 byte 78
 byte 73
 ...
 alignl ' align long
C_s5so2e_67d10db3_panic_L000467_471_L000472 ' <symbol:471>
 byte 101
 byte 114
 byte 114
 byte 111
...
C_luaL__loadfilex_327_L000328 ' <symbol:327>
 ...
 alignl ' align long
C_s5so1l_67d10db3_skipB_O_M__L000306_308_L000309 ' <symbol:308>
 byte 239
 byte 187
 byte 191
 byte 0
 ...
 alignl ' align long
C_s5so1j_67d10db3_errfile_L000302_304_L000305 ' <symbol:304>
 byte 99
 byte 97
 byte 110
 byte 110
 ...
 alignl ' align long
C_s5so1f_67d10db3_newbuffsize_L000260_264_L000265 ' <symbol:264>
 byte 98
 byte 117
 byte 102
 byte 102
 ...
 alignl ' align long
C_s5so1d_67d10db3_newbox_L000254_258_L000259 ' <symbol:258>
 byte 95
 byte 85
 byte 66
 byte 79
 ...
 alignl ' align long
C_s5so1c_67d10db3_252_L000253 ' <symbol:252>
 byte 95
 byte 95
 byte 99
 byte 108
 ...
 alignl ' align long
C_s5so1b_67d10db3_250_L000251 ' <symbol:250>
 byte 95
 byte 95
 byte 103
 byte 99
 ...
 alignl ' align long
C_s5so17_67d10db3_resizebox_L000241_245_L000246 ' <symbol:245>
 byte 110
 byte 111
 byte 116
 byte 32
 ...
 alignl ' align long
C_s5so15_67d10db3_interror_L000228_232_L000233 ' <symbol:232>
 byte 110
 byte 117
 byte 109
 byte 98
...
C_luaL__traceback_72_L000073 ' <symbol:72>
 ...
 alignl ' align long
C_s5so6_67d10db3_pushfuncname_L000032_50_L000051 ' <symbol:50>
 byte 63
 byte 0

 alignl ' align long
C_s5so6_67d10db3_pushfuncname_L000032_48_L000049 ' <symbol:48>
 byte 102
 byte 117
 byte 110
 byte 99
 ...
 alignl ' align long
C_s5so6_67d10db3_pushfuncname_L000032_44_L000045 ' <symbol:44>
 byte 109
 byte 97
 byte 105
 byte 110
 ...
 alignl ' align long
C_s5so6_67d10db3_pushfuncname_L000032_40_L000041 ' <symbol:40>
 byte 37
 byte 115
 byte 32
 byte 39
 ...
 alignl ' align long
C_s5so6_67d10db3_pushfuncname_L000032_36_L000037 ' <symbol:36>
 byte 102
 byte 117
 byte 110
 byte 99
 ...
 alignl ' align long
C_s5so2_67d10db3_pushglobalfuncname_L000020_30_L000031 ' <symbol:30>
 byte 95
 byte 71
 byte 46
 byte 0
 ...
 alignl ' align long
C_s5so2_67d10db3_pushglobalfuncname_L000020_24_L000025 ' <symbol:24>
 byte 95
 byte 76
 byte 79
 byte 65
 ...
 alignl ' align long
C_s5so2_67d10db3_pushglobalfuncname_L000020_22_L000023 ' <symbol:22>
 byte 102
 byte 0

 alignl ' align long
C_s5so_67d10db3_findfield_L000004_18_L000019 ' <symbol:18>
 byte 46
 byte 0
