...
'
 ...
 alignl ' align long
C_smog_670edb85_strdup_L000005 ' <symbol:strdup>
 jmp #NEWF
 jmp #PSHM
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_smog_670edb85_strdup_L000005_7 ' EQU4
 mov r2, r23 ' CVI, CVU or LOAD
 ...
 long @C_strcpy
 add SP, #4 ' CALL addrg
C_smog_670edb85_strdup_L000005_7
 mov r0, r21 ' CVI, CVU or LOAD
' C_smog_670edb85_strdup_L000005_6 ' (symbol refcount = 0)
...
C__load_L_ua_service_list_76
 ...
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_smog_670edb85_strdup_L000005 ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 mov r20, #20 ' reg <- coni
 mov r0, r20 ' setup r0/r1 (2)
