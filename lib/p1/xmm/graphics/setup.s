...
C__cgi_cog ' <symbol:_cgi_cog>
 ...
 alignl ' align long
C_srqk_690ed898_colors_L000004 ' <symbol:colors>
 long $0
 long $55555555
 long $aaaaaaaa
 long $ffffffff
 ...
 alignl ' align long
C_srqk1_690ed898_font_L000005 ' <symbol:font>
 word $9d62
 word $112a
 word $b0e9
 word $31eb
...
C_g_setup_26
 ...
 jmp #LODL
 long @C_srqk_690ed898_colors_L000004
...
C_g_setup_31
 ...
 shl r22, #1 ' LSHI4 coni
 jmp #LODL
 long @C_G__V_A_R_+180
 mov r20, RI ' reg <- addrg
 adds r20, r22 ' ADDI/P (2)
 jmp #LODL
 long @C_srqk1_690ed898_font_L000005
 mov r18, RI ' reg <- addrg
 adds r22, r18 ' ADDI/P (1)
 mov RI, r22
 jmp #RWRD
