...
C__cgi_cog ' <symbol:_cgi_cog>
 ...
 alignl ' align long
C_shmg_6709f856_colors_L000004 ' <symbol:colors>
 long $0
 long $55555555
 long $aaaaaaaa
 long $ffffffff
 ...
 alignl ' align long
C_shmg1_6709f856_font_L000005 ' <symbol:font>
 word $9d62
 word $112a
 word $b0e9
 word $31eb
...
C_g_setup_26
 ...
 jmp #LODL
 long @C_shmg_6709f856_colors_L000004
...
C_g_setup_31
 ...
 adds r20, r22 ' ADDI/P (2)
 jmp #LODL
 long @C_shmg1_6709f856_font_L000005
 mov r18, RI ' reg <- addrg
 adds r22, r18 ' ADDI/P (1)
 mov RI, r22
 jmp #RWRD
