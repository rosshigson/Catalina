...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s4us_670edb77_rxbase_L000002 ' <symbol:rxbase>
 long $0

 alignl ' align long
C_s4us1_670edb77_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_s4us2_670edb77_initialize_L000004 ' <symbol:initialize>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 long $540000 ' save registers
 jmp #LODI
 long @C_s4us_670edb77_rxbase_L000002
 mov r22, RI ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_s4us2_670edb77_initialize_L000004_6 ' NEU4
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_s4us2_670edb77_initialize_L000004_8 ' LTI4
 ...
 jmp #LODL
 long @C_s4us1_670edb77_lock_L000003
 mov BC, r22
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_s4us2_670edb77_initialize_L000004_10 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_s4us2_670edb77_initialize_L000004_11 ' LTI4
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 jmp #LODI
 ...
 jmp #JMPA
 long @C_s4us2_670edb77_initialize_L000004_11 ' JUMPV addrg
C_s4us2_670edb77_initialize_L000004_10
 jmp #LODI
 long @C_s4us1_670edb77_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
 ...
 mov BC, r22
 jmp #WLNG ' ASGNI4 addrg reg
C_s4us2_670edb77_initialize_L000004_11
C_s4us2_670edb77_initialize_L000004_8
C_s4us2_670edb77_initialize_L000004_6
' C_s4us2_670edb77_initialize_L000004_5 ' (symbol refcount = 0)
...
C_s4_rxflush ' <symbol:s4_rxflush>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_s4us2_670edb77_initialize_L000004 ' CALL addrg
C_s4_rxflush_15
 cmp r23,  #3 wz,wc 
 jmp #BRBE
...
C_s4_rxcount_37
 cmp r23,  #3 wz,wc 
 jmp #BRBE
 long @C_s4_rxcount_39 ' LEU4
 jmp #LODL
 long -1
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s4_rxcount_36 ' JUMPV addrg
C_s4_rxcount_39
 jmp #LODI
 long @C_s4us1_670edb77_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
...
C_s4_rx_49
 cmp r23,  #3 wz,wc 
 jmp #BRBE
 long @C_s4_rx_54 ' LEU4
 jmp #LODL
 long -1
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s4_rx_48 ' JUMPV addrg
C_s4_rx_53
C_s4_rx_54
 mov r2, r23 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_s4_tx_57
 cmp r23,  #3 wz,wc 
 jmp #BRBE
 long @C_s4_tx_59 ' LEU4
 jmp #LODL
 long -1
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s4_tx_56 ' JUMPV addrg
C_s4_tx_59
 jmp #LODI
 long @C_s4us1_670edb77_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
...
C_s4_txflush_74
 cmp r23,  #3 wz,wc 
 jmp #BRBE
 long @C_s4_txflush_76 ' LEU4
 jmp #LODL
 long -1
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s4_txflush_73 ' JUMPV addrg
C_s4_txflush_76
 jmp #LODI
 long @C_s4us1_670edb77_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
...
C_s4_txflush_84
 ...
 cmps r18, r22 wz
 jmp #BRNZ
 long @C_s4_txflush_83 ' NEI4
 jmp #LODI
 long @C_s4us1_670edb77_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_s4_txflush_86 ' LTI4
 jmp #LODI
 long @C_s4us1_670edb77_lock_L000003
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_s4_txcheck_89
 cmp r23,  #3 wz,wc 
 jmp #BRBE
 long @C_s4_txcheck_91 ' LEU4
 jmp #LODL
 long -1
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s4_txcheck_88 ' JUMPV addrg
C_s4_txcheck_91
 jmp #LODI
 long @C_s4us1_670edb77_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
...
C_s4_txcount_101
 cmp r23,  #3 wz,wc 
 jmp #BRBE
 long @C_s4_txcount_103 ' LEU4
 jmp #LODL
 long -1
 mov r0, RI ' reg <- con
 jmp #JMPA
 long @C_s4_txcount_100 ' JUMPV addrg
C_s4_txcount_103
 jmp #LODI
 long @C_s4us1_670edb77_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
