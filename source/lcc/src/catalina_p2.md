...
reg: addrl  " PRIMITIVE(#LODF)\n long %a\n mov %c, RI ' reg <- addrl\n" 7

reg: addrg  " PRIMITIVE(#LODL)\n long @%a\n mov %c, RI ' reg <- addrg\n" 7

reg: special " mov %c, %a ' reg <- special\n" 99

reg: con  " PRIMITIVE(#LODL)\n long %0\n mov %c, RI ' reg <- con\n" 7
...
reg: INDIRI1(addrg) " PRIMITIVE(#LODL)\n long @%0\n rdbyte %c, RI ' reg <- INDIRI1 addrg\n" 7
reg: INDIRI2(addrg) " PRIMITIVE(#LODL)\n long @%0\n rdword %c, RI ' reg <- INDIRI2 addrg\n" 7
reg: INDIRI4(addrg) " PRIMITIVE(#LODI)\n long @%0\n mov %c, RI ' reg <- INDIRI4 addrg\n" 7
reg: INDIRU1(addrg) " PRIMITIVE(#LODL)\n long @%0\n rdbyte %c, RI ' reg <- INDIRU1 addrg\n" 7
reg: INDIRU2(addrg) " PRIMITIVE(#LODL)\n long @%0\n rdword %c, RI ' reg <- INDIRU2 addrg\n" 7
reg: INDIRU4(addrg) " PRIMITIVE(#LODI)\n long @%0\n mov %c, RI ' reg <- INDIRU4 addrg\n" 7
reg: INDIRF4(addrg) " PRIMITIVE(#LODI)\n long @%0\n mov %c, RI ' reg <- INDIRF4 addrg\n" 7
reg: INDIRP4(addrg) " PRIMITIVE(#LODI)\n long @%0\n mov %c, RI ' reg <- INDIRP4 addrg\n" 7
...
reg: INDIRI1(addrl) " PRIMITIVE(#LODF)\n long %0\n rdbyte %c, RI ' reg <- INDIRI1 addrl\n" 7
reg: INDIRI2(addrl) " PRIMITIVE(#LODF)\n long %0\n rdword %c, RI ' reg <- INDIRI2 addrl\n" 7
reg: INDIRI4(addrl) " PRIMITIVE(#LODF)\n long %0\n rdlong %c, RI ' reg <- INDIRI4 addrl\n" 7
reg: INDIRU1(addrl) " PRIMITIVE(#LODF)\n long %0\n rdbyte %c, RI ' reg <- INDIRU1 addrl\n" 7
reg: INDIRU2(addrl) " PRIMITIVE(#LODF)\n long %0\n rdword %c, RI ' reg <- INDIRU2 addrl\n" 7
reg: INDIRU4(addrl) " PRIMITIVE(#LODF)\n long %0\n rdlong %c, RI ' reg <- INDIRU4 addrl\n" 7
reg: INDIRF4(addrl) " PRIMITIVE(#LODF)\n long %0\n rdlong %c, RI ' reg <- INDIRF4 addrl\n" 7
reg: INDIRP4(addrl) " PRIMITIVE(#LODF)\n long %0\n rdlong %c, RI ' reg <- INDIRP4 addrl\n" 7

reg: INDIRI1(addrli) " PRIMITIVE(#LODF)\n long %0\n rdbyte %c, RI ' reg <- INDIRI1 addrli\n" 7
reg: INDIRI2(addrli) " PRIMITIVE(#LODF)\n long %0\n rdword %c, RI ' reg <- INDIRI2 addrli\n" 7
reg: INDIRI4(addrli) " PRIMITIVE(#LODF)\n long %0\n rdlong %c, RI ' reg <- INDIRI4 addrli\n" 7
reg: INDIRU1(addrli) " PRIMITIVE(#LODF)\n long %0\n rdbyte %c, RI ' reg <- INDIRU1 addrli\n" 7
reg: INDIRU2(addrli) " PRIMITIVE(#LODF)\n long %0\n rdword %c, RI ' reg <- INDIRU2 addrli\n" 7
reg: INDIRU4(addrli) " PRIMITIVE(#LODF)\n long %0\n rdlong %c, RI ' reg <- INDIRU4 addrli\n" 7
reg: INDIRF4(addrli) " PRIMITIVE(#LODF)\n long %0\n rdlong %c, RI ' reg <- INDIRF4 addrli\n" 7
reg: INDIRP4(addrli) " PRIMITIVE(#LODF)\n long %0\n rdlong %c, RI ' reg <- INDIRP4 addrli\n" 7
...
stmt: ASGNI1(addrg,reg)   " PRIMITIVE(#LODL)\n long @%0\n wrbyte %1, RI ' ASGNI1 addrg reg\n" 7
stmt: ASGNI2(addrg,reg)   " PRIMITIVE(#LODL)\n long @%0\n wrword %1, RI ' ASGNI2 addrg reg\n" 7
stmt: ASGNI4(addrg,reg)   " PRIMITIVE(#LODL)\n long @%0\n wrlong %1, RI ' ASGNI4 addrg reg\n" 7
stmt: ASGNU1(addrg,reg)   " PRIMITIVE(#LODL)\n long @%0\n wrbyte %1, RI ' ASGNU1 addrg reg\n" 7
stmt: ASGNU2(addrg,reg)   " PRIMITIVE(#LODL)\n long @%0\n wrword %1, RI ' ASGNU2 addrg reg\n" 7
stmt: ASGNU4(addrg,reg)   " PRIMITIVE(#LODL)\n long @%0\n wrlong %1, RI ' ASGNU4 addrg reg\n" 7
stmt: ASGNF4(addrg,reg)   " PRIMITIVE(#LODL)\n long @%0\n wrlong %1, RI ' ASGNF4 addrg reg\n" 7
stmt: ASGNP4(addrg,reg)   " PRIMITIVE(#LODL)\n long @%0\n wrlong %1, RI ' ASGNP4 addrg reg\n" 7
...
stmt: ASGNI1(addrl,reg)   " PRIMITIVE(#LODF)\n long %0\n wrbyte %1, RI ' ASGNI1 addrl reg\n" 7
stmt: ASGNI2(addrl,reg)   " PRIMITIVE(#LODF)\n long %0\n wrword %1, RI ' ASGNI2 addrl reg\n" 7
stmt: ASGNI4(addrl,reg)   " PRIMITIVE(#LODF)\n long %0\n wrlong %1, RI ' ASGNI4 addrl reg\n" 7
stmt: ASGNU1(addrl,reg)   " PRIMITIVE(#LODF)\n long %0\n wrbyte %1, RI ' ASGNU1 addrl reg\n" 7
stmt: ASGNU2(addrl,reg)   " PRIMITIVE(#LODF)\n long %0\n wrword %1, RI ' ASGNU2 addrl reg\n" 7
stmt: ASGNU4(addrl,reg)   " PRIMITIVE(#LODF)\n long %0\n wrlong %1, RI ' ASGNU4 addrl reg\n" 7
stmt: ASGNF4(addrl,reg)   " PRIMITIVE(#LODF)\n long %0\n wrlong %1, RI ' ASGNF4 addrl reg\n" 7
stmt: ASGNP4(addrl,reg)   " PRIMITIVE(#LODF)\n long %0\n wrlong %1, RI ' ASGNP4 addrl reg\n" 7
...
stmt: ASGNI1(addrli,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrbyte RI, BC ' ASGNI1 addrli addrg\n" 9
stmt: ASGNI2(addrli,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrword RI, BC ' ASGNI2 addrli addrg\n" 9
stmt: ASGNI4(addrli,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrlong RI, BC ' ASGNI4 addrli addrg\n" 9
stmt: ASGNU1(addrli,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrbyte RI, BC ' ASGNU1 addrli addrg\n" 9
stmt: ASGNU2(addrli,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrword RI, BC ' ASGNU2 addrli addrg\n" 9
stmt: ASGNU4(addrli,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrlong RI, BC ' ASGNU4 addrli addrg\n" 9
stmt: ASGNF4(addrli,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrlong RI, BC ' ASGNF4 addrli addrg\n" 9
stmt: ASGNP4(addrli,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrlong RI, BC ' ASGNP4 addrli addrg\n" 9

stmt: ASGNI1(addrfi,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrbyte RI, BC ' ASGNI1 addrfi addrg\n" 9
stmt: ASGNI2(addrfi,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrword RI, BC ' ASGNI2 addrfi addrg\n" 9
stmt: ASGNI4(addrfi,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrlong RI, BC ' ASGNI4 addrfi addrg\n" 9
stmt: ASGNU1(addrfi,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrbyte RI, BC ' ASGNU1 addrfi addrg\n" 9
stmt: ASGNU2(addrfi,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrword RI, BC ' ASGNU2 addrfi addrg\n" 9
stmt: ASGNU4(addrfi,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrlong RI, BC ' ASGNU4 addrfi addrg\n" 9
stmt: ASGNF4(addrfi,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrlong RI, BC ' ASGNF4 addrfi addrg\n" 9
stmt: ASGNP4(addrfi,addrg)   " PRIMITIVE(#LODL)\n long @%1\n mov BC, FP\n sub BC, #-(%0)\n wrlong RI, BC ' ASGNP4 addrfi addrg\n" 9
...
stmt: RETI4(con)  " PRIMITIVE(#LODL)\n long %0\n mov r0, RI ' RET con\n" 7
stmt: RETU4(con)  " PRIMITIVE(#LODL)\n long %0\n mov r0, RI ' RET con\n" 7
stmt: RETP4(con)  " PRIMITIVE(#LODL)\n long %0\n mov r0, RI ' RET con\n" 7
stmt: RETF4(con)  " PRIMITIVE(#LODL)\n long %0\n mov r0, RI ' RET con\n" 7
...
reg: CVFI4(reg) " PRIMITIVE(#INFL) ' CVFI4\n" 1
reg: CVIF4(reg) " PRIMITIVE(#FLIN) ' CVIF4\n" 1
...
reg:  ADDF4(reg,reg) "# PRIMITIVE(#FADD) ' ADDF4\n" 5
...
reg:  SUBF4(reg,reg) "# PRIMITIVE(#FSUB) ' SUBF4\n" 5

reg:  SUBI4(reg,coni) "? mov %c, %0\n subs %c, #%1 ' SUBI4 coni\n" 2
reg:  SUBU4(reg,coni) "? mov %c, %0\n sub %c, #%1 ' SUBU4 coni\n" 2
reg:  SUBP4(reg,coni) "? mov %c, %0\n subs %c, #%1 ' SUBP4 coni\n" 2

reg:  DIVI4(reg,reg) "# PRIMITIVE(#DIVS) ' DIVI4\n" 5
reg:  DIVU4(reg,reg) "# PRIMITIVE(#DIVU) ' DIVU4\n" 5
reg:  DIVF4(reg,reg) "# PRIMITIVE(#FDIV) ' DIVF4\n" 5

reg:  MODI4(reg,reg) "# PRIMITIVE(#DIVS) ' MODI4\n" 5
reg:  MODU4(reg,reg) "# PRIMITIVE(#DIVU) ' MODU4\n" 5

reg:  MULI4(reg,reg) "# PRIMITIVE(#MULT) ' MULI4\n" 5
reg:  MULU4(reg,reg) "# PRIMITIVE(#MULT) ' MULU4\n" 5
reg:  MULF4(reg,reg) "# PRIMITIVE(#FMUL) ' MULF4\n" 5
...
stmt:  JUMPV(addrg)           " PRIMITIVE(#JMPA)\n long @%0 ' JUMPV addrg\n" 6

stmt:  LABELV "# %a\n"

stmt: ARGI4(con)  "# PRIMITIVE(#LODL)\n long %0\n PRIMITIVE(#PSHL) ' ARGI4 addrg\n"  1
stmt: ARGU4(con)  "# PRIMITIVE(#LODL)\n long %0\n PRIMITIVE(#PSHL) ' ARGU4 addrg\n"  1
stmt: ARGP4(con)  "# PRIMITIVE(#LODL)\n long %0\n PRIMITIVE(#PSHL) ' ARGP4 addrg\n"  1
stmt: ARGF4(con)  "# PRIMITIVE(#LODL)\n long %0\n PRIMITIVE(#PSHL) ' ARGF4 addrg\n"  1
...
stmt: ARGI4(ADDRGP4)  "# PRIMITIVE(#LODL)\n long @%0\n PRIMITIVE(#PSHL) ' ARGI4 ADDRGP4\n"  1
stmt: ARGU4(ADDRGP4)  "# PRIMITIVE(#LODL)\n long @%0\n PRIMITIVE(#PSHL) ' ARGU4 ADDRGP4\n"  1
stmt: ARGP4(ADDRGP4)  "# PRIMITIVE(#LODL)\n long @%0\n PRIMITIVE(#PSHL) ' ARGP4 ADDRGP4\n"  1
stmt: ARGF4(ADDRGP4)  "# PRIMITIVE(#LODL)\n long @%0\n PRIMITIVE(#PSHL) ' ARGF4 ADDRGP4\n"  1

stmt: ARGI4(ADDRLP4)  "# PRIMITIVE(#LODF)\n long %0\n PRIMITIVE(#PSHL) ' ARGI4 ADDRLP4\n"  1
stmt: ARGU4(ADDRLP4)  "# PRIMITIVE(#LODF)\n long %0\n PRIMITIVE(#PSHL) ' ARGU4 ADDRLP4\n"  1
stmt: ARGP4(ADDRLP4)  "# PRIMITIVE(#LODF)\n long %0\n PRIMITIVE(#PSHL) ' ARGP4 ADDRLP4\n"  1
stmt: ARGF4(ADDRLP4)  "# PRIMITIVE(#LODF)\n long %0\n PRIMITIVE(#PSHL) ' ARGF4 ADDRLP4\n"  1

stmt: ARGI4(ADDRFP4)  "# PRIMITIVE(#LODF)\n long %0\n PRIMITIVE(#PSHL) ' ARGI4 ADDRFP4\n"  1
stmt: ARGU4(ADDRFP4)  "# PRIMITIVE(#LODF)\n long %0\n PRIMITIVE(#PSHL) ' ARGU4 ADDRFP4\n"  1
stmt: ARGP4(ADDRFP4)  "# PRIMITIVE(#LODF)\n long %0\n PRIMITIVE(#PSHL) ' ARGP4 ADDRFP4\n"  1
stmt: ARGF4(ADDRFP4)  "# PRIMITIVE(#LODF)\n long %0\n PRIMITIVE(#PSHL) ' ARGF4 ADDRFP4\n"  1

stmt: ARGI4(INDIRI4(ADDRGP4))  "# PRIMITIVE(#PSHA)\n long @%0 ' ARGI4 INDIRI4 ADDRGP4\n"  1
stmt: ARGU4(INDIRU4(ADDRGP4))  "# PRIMITIVE(#PSHA)\n long @%0 ' ARGU4 INDIRU4 ADDRGP4\n"  1
stmt: ARGP4(INDIRP4(ADDRGP4))  "# PRIMITIVE(#PSHA)\n long @%0 ' ARGP4 INDIRP4 ADDRGP4\n"  1
stmt: ARGF4(INDIRF4(ADDRGP4))  "# PRIMITIVE(#PSHA)\n long @%0 ' ARGF4 INDIRF4 ADDRGP4\n"  1

stmt: ARGI4(INDIRI4(ADDRLP4))  "# PRIMITIVE(#PSHF)\n long %0 ' ARGI4 INDIRI4 ADDRLP4\n"  1
stmt: ARGU4(INDIRU4(ADDRLP4))  "# PRIMITIVE(#PSHF)\n long %0 ' ARGU4 INDIRU4 ADDRLP4\n"  1
stmt: ARGP4(INDIRP4(ADDRLP4))  "# PRIMITIVE(#PSHF)\n long %0 ' ARGP4 INDIRP4 ADDRLP4\n"  1
stmt: ARGF4(INDIRF4(ADDRLP4))  "# PRIMITIVE(#PSHF)\n long %0 ' ARGF4 INDIRF4 ADDRLP4\n"  1

stmt: ARGI4(INDIRI4(ADDRFP4))  "# PRIMITIVE(#PSHF)\n long %0 ' ARGI4 INDIRI4 ADDRFP4\n"  1
stmt: ARGU4(INDIRU4(ADDRFP4))  "# PRIMITIVE(#PSHF)\n long %0 ' ARGU4 INDIRU4 ADDRFP4\n"  1
stmt: ARGP4(INDIRP4(ADDRFP4))  "# PRIMITIVE(#PSHF)\n long %0 ' ARGP4 INDIRP4 ADDRFP4\n"  1
stmt: ARGF4(INDIRF4(ADDRFP4))  "# PRIMITIVE(#PSHF)\n long %0 ' ARGF4 INDIRF4 ADDRFP4\n"  1
