...
/*
generated at Fri Oct 29 15:38:51 2021
...
/* 230 */	1,	/* # truncate\n */
/* 231 */	0,	/* # nothing */
/* 232 */	1,	/*  jmp #INFL ' CVFI4\n */
/* 233 */	1,	/*  jmp #FLIN ' CVIF4\n */
/* 234 */	1,	/*  neg %c, %0 ' NEGI4\n */
/* 235 */	1,	/* ? mov %c, %0\n xor %c, Bit31 ' NEGF4\n */
/* 236 */	1,	/* ? mov %c, %0\n xor %c, all_1s ' BCOMI4\n */
/* 237 */	1,	/* ? mov %c, %0\n xor %c, all_1s ' BCOMU4\n */
...
/* 258 */	1,	/* # mov RI, %0\n sub RI, %1\n mov %c, RI ' SUBU4 reg\n */
/* 259 */	1,	/* # mov RI, %0\n subs RI, %1\n mov %c, RI ' SUBP4 reg\n */
/* 260 */	1,	/* # jmp #FSUB ' SUBF4\n */
/* 261 */	1,	/* ? mov %c, %0\n subs %c, #%1 ' SUBI4 coni\n */
/* 262 */	1,	/* ? mov %c, %0\n sub %c, #%1 ' SUBU4 coni\n */
/* 263 */	1,	/* ? mov %c, %0\n subs %c, #%1 ' SUBP4 coni\n */
/* 264 */	1,	/* # jmp #DIVS ' DIVI4\n */
/* 265 */	1,	/* # jmp #DIVU ' DIVU4\n */
/* 266 */	1,	/* # jmp #FDIV ' DIVF4\n */
/* 267 */	1,	/* # jmp #DIVS ' MODI4\n */
/* 268 */	1,	/* # jmp #DIVU ' MODU4\n */
/* 269 */	1,	/* # jmp #MULT ' MULI4\n */
/* 270 */	1,	/* # jmp #MULT ' MULU4\n */
/* 271 */	1,	/* # jmp #FMUL ' MULF4\n */
/* 272 */	1,	/* # mov RI, %0\n shl RI, %1\n mov %c, RI ' LSHI4 reg\n */
/* 273 */	1,	/* # mov RI, %0\n shl RI, %1\n mov %c, RI ' LSHU4 reg\n */
/* 274 */	1,	/* ? mov %c, %0\n shl %c, #%1 ' LSHI4 coni\n */
/* 275 */	1,	/* ? mov %c, %0\n shl %c, #%1 ' LSHU4 coni\n */
...
/* 312 */	1,	/*  cmp %0, %1 wz\n jmp #BRNZ\n long @%a ' NEU4\n */
/* 313 */	1,	/* # jmp #FCMP\n jmp #BRNZ\n long @%a ' NEF4\n */
/* 314 */	1,	/*  cmps %0, %1 wz,wc\n jmp #BRAE\n long @%a ' GEI4\n */
/* 315 */	1,	/*  cmp %0, %1 wz,wc \n jmp #BRAE\n long @%a ' GEU4\n */
/* 316 */	1,	/* # jmp #FCMP\n jmp #BRAE\n long @%a ' GEF4\n */
/* 317 */	1,	/*  cmps %0, %1 wz,wc\n jmp #BR_A\n long @%a ' GTI4\n */
/* 318 */	1,	/*  cmp %0, %1 wz,wc \n jmp #BR_A\n long @%a ' GTU4\n */
/* 319 */	1,	/* # jmp #FCMP\n jmp #BR_A\n long @%a ' GTF4\n */
