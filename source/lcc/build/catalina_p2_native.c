 ...
 */
#define PRIMITIVE(XXXX) calld PA,XXXX
...
/*
generated at Sat Oct 16 23:39:53 2021
...
/* 108 */	" wrbyte %1, ##@%0 ' ASGNI1 addrg reg\n",	/* stmt: ASGNI1(addrg,reg) */
/* 109 */	" wrword %1, ##@%0 ' ASGNI2 addrg reg\n",	/* stmt: ASGNI2(addrg,reg) */
/* 110 */	" wrlong %1, ##@%0 ' ASGNI4 addrg reg\n",	/* stmt: ASGNI4(addrg,reg) */
/* 111 */	" wrbyte %1, ##@%0 ' ASGNU1 addrg reg\n",	/* stmt: ASGNU1(addrg,reg) */
/* 112 */	" wrword %1, ##@%0 ' ASGNU2 addrg reg\n",	/* stmt: ASGNU2(addrg,reg) */
/* 113 */	" wrlong %1, ##@%0 ' ASGNU4 addrg reg\n",	/* stmt: ASGNU4(addrg,reg) */
/* 114 */	" wrlong %1, ##@%0 ' ASGNF4 addrg reg\n",	/* stmt: ASGNF4(addrg,reg) */
/* 115 */	" wrlong %1, ##@%0 ' ASGNP4 addrg reg\n",	/* stmt: ASGNP4(addrg,reg) */
...
/* 213 */	" mov r0, ##%0 ' RET con\n",	/* stmt: RETI4(con) */
/* 214 */	" mov r0, ##%0 ' RET con\n",	/* stmt: RETU4(con) */
/* 215 */	" mov r0, ##%0 ' RET con\n",	/* stmt: RETP4(con) */
/* 216 */	" mov r0, ##%0 ' RET con\n",	/* stmt: RETF4(con) */
/* 217 */	"# zero extend\n",	/* reg: CVUI1(reg) */
/* 218 */	"# zero extend\n",	/* reg: CVUI2(reg) */
/* 219 */	"# zero extend\n",	/* reg: CVUI4(reg) */
/* 220 */	"# truncate\n",	/* reg: CVUU1(reg) */
...
/* 265 */	" #ifndef NO_INTERRUPTS\n  stalli\n #endif\n qdiv %0, %1 ' DIVU4\n getqx %c\n #ifndef NO_INTERRUPTS\n  allowi\n #endif\n",	/* reg: DIVU4(reg,reg) */
/* 266 */	"# PRIMITIVE(#FDIV) ' DIVF4\n",	/* reg: DIVF4(reg,reg) */
/* 267 */	"# PRIMITIVE(#DIVS) ' MODI4\n",	/* reg: MODI4(reg,reg) */
/* 268 */	" #ifndef NO_INTERRUPTS\n  stalli\n #endif\n qdiv %0, %1 ' MODU4\n getqy %c\n #ifndef NO_INTERRUPTS\n  allowi\n #endif\n",	/* reg: MODU4(reg,reg) */
/* 269 */	" #ifndef NO_INTERRUPTS\n  stalli\n #endif\n qmul %0, %1 ' MULI4\n getqx %c\n #ifndef NO_INTERRUPTS\n  allowi\n #endif\n",	/* reg: MULI4(reg,reg) */
/* 270 */	" #ifndef NO_INTERRUPTS\n  stalli\n #endif\n qmul %0, %1 ' MULU4\n getqx %c\n #ifndef NO_INTERRUPTS\n  allowi\n #endif\n",	/* reg: MULU4(reg,reg) */
...
/* 341 */	"# wrlong %0, --PTRA ' ARGI4 reg\n",	/* stmt: ARGI4(reg) */
/* 342 */	"# wrlong $0, --PTRA ' ARGU4 reg\n",	/* stmt: ARGU4(reg) */
/* 343 */	"# wrlong $0, --PTRA ' ARGP4 reg\n",	/* stmt: ARGP4(reg) */
/* 344 */	"# wrlong $0, --PTRA ' ARGF4 reg\n",	/* stmt: ARGF4(reg) */
...
/* 48 */	1,	/*  mov %c, FP\n add %c, #%a ' reg <- addrfi\n */
/* 49 */	1,	/*  mov %c, ##%a\n adds %c, FP\n ' reg <- addrl\n */
/* 50 */	1,	/*  mov %c, ##@%a ' reg <- addrg\n */
/* 51 */	1,	/*  mov %c, %a ' reg <- special\n */
/* 52 */	1,	/*  mov %c, ##%0 ' reg <- con\n */
...
/* 108 */	1,	/*  wrbyte %1, ##@%0 ' ASGNI1 addrg reg\n */
/* 109 */	1,	/*  wrword %1, ##@%0 ' ASGNI2 addrg reg\n */
/* 110 */	1,	/*  wrlong %1, ##@%0 ' ASGNI4 addrg reg\n */
/* 111 */	1,	/*  wrbyte %1, ##@%0 ' ASGNU1 addrg reg\n */
/* 112 */	1,	/*  wrword %1, ##@%0 ' ASGNU2 addrg reg\n */
/* 113 */	1,	/*  wrlong %1, ##@%0 ' ASGNU4 addrg reg\n */
/* 114 */	1,	/*  wrlong %1, ##@%0 ' ASGNF4 addrg reg\n */
/* 115 */	1,	/*  wrlong %1, ##@%0 ' ASGNP4 addrg reg\n */
...
/* 213 */	1,	/*  mov r0, ##%0 ' RET con\n */
/* 214 */	1,	/*  mov r0, ##%0 ' RET con\n */
/* 215 */	1,	/*  mov r0, ##%0 ' RET con\n */
/* 216 */	1,	/*  mov r0, ##%0 ' RET con\n */
/* 217 */	1,	/* # zero extend\n */
/* 218 */	1,	/* # zero extend\n */
/* 219 */	1,	/* # zero extend\n */
/* 220 */	1,	/* # truncate\n */
...
/* 265 */	1,	/*  #ifndef NO_INTERRUPTS\n  stalli\n #endif\n qdiv %0, %1 ' DIVU4\n getqx %c\n #ifndef NO_INTERRUPTS\n  allowi\n #endif\n */
/* 266 */	1,	/* # PRIMITIVE(#FDIV) ' DIVF4\n */
/* 267 */	1,	/* # PRIMITIVE(#DIVS) ' MODI4\n */
/* 268 */	1,	/*  #ifndef NO_INTERRUPTS\n  stalli\n #endif\n qdiv %0, %1 ' MODU4\n getqy %c\n #ifndef NO_INTERRUPTS\n  allowi\n #endif\n */
/* 269 */	1,	/*  #ifndef NO_INTERRUPTS\n  stalli\n #endif\n qmul %0, %1 ' MULI4\n getqx %c\n #ifndef NO_INTERRUPTS\n  allowi\n #endif\n */
/* 270 */	1,	/*  #ifndef NO_INTERRUPTS\n  stalli\n #endif\n qmul %0, %1 ' MULU4\n getqx %c\n #ifndef NO_INTERRUPTS\n  allowi\n #endif\n */
...
/* 339 */	1,	/* # mov RI, #%0\n wrlong RI, --PTRA ' ARGP4 coni\n */
/* 340 */	1,	/* # mov RI, #%0\n wrlong RI, --PTRA ' ARGF4 coni\n */
/* 341 */	1,	/* # wrlong %0, --PTRA ' ARGI4 reg\n */
/* 342 */	1,	/* # wrlong $0, --PTRA ' ARGU4 reg\n */
/* 343 */	1,	/* # wrlong $0, --PTRA ' ARGP4 reg\n */
/* 344 */	1,	/* # wrlong $0, --PTRA ' ARGF4 reg\n */
/* 345 */	1,	/* # mov RI, ##@%0\n wrlong RI, --PTRA ' ARGI4 ADDRGP4\n */
/* 346 */	1,	/* # mov RI, ##@%0\n wrlong RI, --PTRA ' ARGU4 ADDRGP4\n */
/* 347 */	1,	/* # mov RI, ##@%0\n wrlong RI, --PTRA ' ARGP4 ADDRGP4\n */
/* 348 */	1,	/* # mov RI, ##@%0\n wrlong RI, --PTRA ' ARGF4 ADDRGP4\n */
...
static void _label(NODEPTR_TYPE a) {
	...
	case 1077: /* ASGNI1 */
		...
		/* stmt: ASGNI1(addrg,reg) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_addrg_NT] + ((struct _state *)(RIGHT_CHILD(a)->x.state))->cost[_reg_NT] + 2;
		if (c + 0 < p->cost[_stmt_NT]) {
			p->cost[_stmt_NT] = c + 0;
			p->rule._stmt = 10;
		}
		...
		/* stmt: ASGNI1(addrl,reg) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_addrl_NT] + ((struct _state *)(RIGHT_CHILD(a)->x.state))->cost[_reg_NT] + 4;
		if (c + 0 < p->cost[_stmt_NT]) {
			p->cost[_stmt_NT] = c + 0;
			p->rule._stmt = 34;
		}
		/* stmt: ASGNI1(addrli,reg) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_addrli_NT] + ((struct _state *)(RIGHT_CHILD(a)->x.state))->cost[_reg_NT] + 3;
		if (c + 0 < p->cost[_stmt_NT]) {
			p->cost[_stmt_NT] = c + 0;
			p->rule._stmt = 42;
		}
		/* stmt: ASGNI1(addrfi,reg) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_addrfi_NT] + ((struct _state *)(RIGHT_CHILD(a)->x.state))->cost[_reg_NT] + 3;
		if (c + 0 < p->cost[_stmt_NT]) {
			p->cost[_stmt_NT] = c + 0;
			p->rule._stmt = 50;
		}
		/* stmt: ASGNI1(addrli,addrg) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_addrli_NT] + ((struct _state *)(RIGHT_CHILD(a)->x.state))->cost[_addrg_NT] + 5;
		if (c + 0 < p->cost[_stmt_NT]) {
			p->cost[_stmt_NT] = c + 0;
			p->rule._stmt = 58;
		}
		/* stmt: ASGNI1(addrfi,addrg) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_addrfi_NT] + ((struct _state *)(RIGHT_CHILD(a)->x.state))->cost[_addrg_NT] + 5;
		if (c + 0 < p->cost[_stmt_NT]) {
			p->cost[_stmt_NT] = c + 0;
			p->rule._stmt = 66;
		}
	...
	case 1093: /* INDIRI1 */
		...
		/* reg: INDIRI1(addrg) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_addrg_NT] + 3;
		if (c + 0 < p->cost[_reg_NT]) {
			p->cost[_reg_NT] = c + 0;
			p->rule._reg = 33;
			_closure_reg(a, c + 0);
		...
		/* reg: INDIRI1(addrl) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_addrl_NT] + 4;
		if (c + 0 < p->cost[_reg_NT]) {
			p->cost[_reg_NT] = c + 0;
			p->rule._reg = 49;
			_closure_reg(a, c + 0);
		...
		/* reg: INDIRI1(addrli) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_addrli_NT] + 3;
		if (c + 0 < p->cost[_reg_NT]) {
			p->cost[_reg_NT] = c + 0;
			p->rule._reg = 57;
			_closure_reg(a, c + 0);
	...
	case 4337: /* RETF4 */
		...
		/* stmt: RETF4(con) */
		c = ((struct _state *)(LEFT_CHILD(a)->x.state))->cost[_con_NT] + 2;
		if (c + 0 < p->cost[_stmt_NT]) {
			p->cost[_stmt_NT] = c + 0;
			p->rule._stmt = 108;
		}
      ...
      if (q == NULL) {
         ...
         if (generic(kop) == CNST) {
            ...
            if ((offs >= 0) && (offs < 512)) {
               ...
               print(" mov RI, FP\n adds RI,##%s\n %s\n wrlong RI, --PTRA ' stack ARG ADDRF\n", src); 
            }
         }
...
Interface catalina_native_p2IR = {
   1, 1, 0,  /* char */
   2, 2, 0,  /* short */
   4, 4, 0,  /* int */
   4, 4, 0,  /* long */
