...
typedef enum
{
  DFAEND = -1,                        /* DFAEND is a terminal symbol that matches the
                                   end of input; any value of DFAEND or less in
                                   the parse tree is such a symbol.  Accepting
                                   states of the DFA are those that would have
                                   a transition on DFAEND. */
...
typedef struct
{
  ...
  int first_end;                /* Token value of the first DFAEND in elems. */
} dfa_state;
...
/* Compile the given string of the given length into the given struct dfa.
   ...
   exact matcher. */
extern struct dfa * dfacomp(char *, size_t, int);
