...
#define DO_CPR      670 /* Cursor position report, sent by terminal.
...
#define DO_DOSRC     955 /* RJH : added Restore Cursor for DOS emulation */
#define DO_DOSSM     956 /* RJH : added Set Mode for DOS emulation */
#define DO_DOSRM     957 /* RJH : added Reset Mode for DOS emulation */
#define DO_HPA       958 /* RJH : added Horizontal Position Absolute :
                                  for ISO 6429 emulation */
#define DO_CBT       959 /* RJH : added Cursor Backwards Tabulation :
                                  for ISO 6429 emulation */
#define DO_SL        960 /* RJH : added Shift Left :
                                  for ISO 6429 emulation */
#define DO_SR        961 /* RJH : added Shift Right :
                                  for ISO 6429 emulation */
#define DO_REP       962 /* RJH : added Repeat :
                                  for ISO 6429 emulation */
#define DO_EPA       963 /* RJH : added Start of Guarded Area :
                                  for ISO 6429 emulation */
#define DO_ERM       964 /* RJH : added Erasure Mode :
                                  for ISO 6429 emulation */
#define DO_PRNCL2    965 /* RJH : Added to distinguish from DO_PRNCL, which 
