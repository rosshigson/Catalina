...
struct ParserStruct
{
  ...
  const LPSES pSp; /* RJH : modified for GNAT compiler */
  const LPSTR lpD; /* RJH : modified for GNAT compiler */
  PA_INT iDL;
  ...
  const struct ESC1tbl_rec *ESC1tbl; /* RJH : modified for GNAT compiler */
