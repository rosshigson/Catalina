...
#define POINTERTOINTS( po, in1, in2 ) { union INTSANDPOINTER ip; \
                                        ip.p = (po);       \
                                        in1 = ip.is.i1;    \
                                        in2 = ip.is.i2;    \
                                      }
...
#define INTSTOPOINTER( po, in1, in2 ) { union INTSANDPOINTER ip; \
                                        ip.is.i1 = (in1);  \
                                        ip.is.i2 = (in2);  \
                                        po = ip.p;         \
                                      }
...
/* Called by Parser */
void PASCAL ProcessAnsi( const LPSES pSesptr, PA_INT iCode, LPARGS args ); /* RJH : modified for GNAT compiler */
