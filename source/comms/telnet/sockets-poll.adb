...
--  except changing some package names (e.g. GNAT.Sockets.Poll to Sockets.Poll).
...
with Sockets.Thin;         --  package name modified by RJH

package body Sockets.Poll is     --  package name modified by RJH
...
end Sockets.Poll;   --  package name modified by RJH
