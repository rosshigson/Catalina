...
--  of TCP Urgent (OOB) data. There are no actual changes to this package
--  except the changing of some names (e.g. GNAT.Sockets.Poll.G_Wait to 
--  Sockets.Poll.G_Wait).
...
with Sockets.Thin_Common;            -- package name modified by RJH

procedure Sockets.Poll.G_Wait        -- package name modified by RJH
...
end Sockets.Poll.G_Wait;         -- package name modified by RJH
