...
-- except the changing of GNAT.Sockets.Thin_Common to Sockets.Thin_Common.
...
with Sockets.Thin_Common;       -- modified by RJH

with System;
with System.CRTL;

package Sockets.Thin is  -- package name modified by RJH
