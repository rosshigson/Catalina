...
--  it needed to be renamed (from GNAT.Sockets.Thin_Common to 
--  Sockets.Thin_Common) to stop GNAT complaining about using an internal GNAT
--  package.
...
package body Sockets.Thin_Common is     -- package name modified by RJH
...
end Sockets.Thin_Common;     -- package name modified by RJH
