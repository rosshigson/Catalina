...
package Sockets is    -- package name modified by RJH
   ...
   type Option_Name is
     (Generic_Option,
      ...
      Urgent_Inline_V4,    -- Added by RJH : Urgent (OOB) data received inline
   ...
   Urgent_Inline   : Option_Name renames Urgent_Inline_V4;    -- Added by RJH : Urgent (OOB) data received inline
   ...
   type Request_Name is
     (Non_Blocking_IO,  --  Cause a caller not to wait on blocking operations
      ...
      Urgent_Data);     --  Added by RJH - return whether there is urgent data
   ...
   type Request_Type (Name : Request_Name := Non_Blocking_IO) is record
      case Name is
         ...
         when Urgent_Data =>              -- Added by RJH
            No_Urgent_Data : Boolean;     -- Added by RJH
...
end Sockets;        -- package name modified by RJ
