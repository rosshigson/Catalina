...
--  of TCP Urgent (OOB) data. There are no actual changes to this package, but
--  some needed to be renamed (e.g. from GNAT.Sockets.Thin_Common to 
--  Sockets.Thin_Common) to stop GNAT complaining about using an internal 
--  GNAT package.
...
package body Sockets.Thin is          -- package name modified by RJH
...
end Sockets.Thin;                -- package name modified by RJH
