...
C_spi_writeS_D_C_ard ' <symbol:spi_writeSDCard>
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_spi_writeS_D_C_ard_2  ' NEU4
...
C_spi_writeS_D_C_ard_2
 ...
 cmps r22,  #0 wcz
 if_b jmp #\C_spi_writeS_D_C_ard_7 ' LTI4
 mov r2, ##@C__spi_lock
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
...
C_spi_writeS_D_C_ard_7
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_spi_writeS_D_C_ard_6  ' NEU4
 mov r22, r19
...
' C_spi_writeS_D_C_ard_10 ' (symbol refcount = 0)
 ...
 and r22, r20 ' BANDI/U (3)
 cmp r22,  #0 wz
 if_nz jmp #\C_spi_writeS_D_C_ard_9  ' NEU4
 mov r22, ##@C__spi_lock
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_b jmp #\C_spi_writeS_D_C_ard_12 ' LTI4
 mov r2, ##@C__spi_lock
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_spi_writeS_D_C_ard_12
 ...
 and r22, r20 ' BANDI/U (3)
 cmp r22,  #0 wz
 if_z jmp #\C_spi_writeS_D_C_ard_15 ' EQU4
 mov r17, #1 ' reg <- coni
 jmp #\@C_spi_writeS_D_C_ard_16 ' JUMPV addrg
