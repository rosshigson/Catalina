...
public _malloc_link_free_chunk(mallink *ml);
public _malloc_unlink_free_chunk(mallink *ml);
public mallink *_malloc_first_present(int class);
public mallink *_malloc_search_free_list(int class, size_t n);
