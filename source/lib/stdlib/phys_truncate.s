...
C__malloc_truncate ' <symbol:_malloc_truncate>
 ...
 cmp r22, r20 wz
 if_nz jmp #\C__malloc_truncate_7  ' NEU4
 mov r15, #1 ' reg <- coni
 jmp #\@C__malloc_truncate_8 ' JUMPV addrg
C__malloc_truncate_7
 mov r15, #0 ' reg <- coni
C__malloc_truncate_8
 cmps r15,  #0 wz
 if_nz jmp #\C__malloc_truncate_4 ' NEI4
 mov r22, ##-4 ' reg <- con
 ...
 cmps r22,  #0 wz
 if_z jmp #\C__malloc_truncate_5 ' EQI4
 ...
 add SP, #4 ' CALL addrg
 jmp #\@C__malloc_truncate_5 ' JUMPV addrg
C__malloc_truncate_4
 wrlong r19, ##@C_ml_last ' ASGNP4 addrg reg
