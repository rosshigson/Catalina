...
/*
 * _threadstart_LMM : Start an LMM C program in the specified cog.
 ...
 *
 */
int _threadstart_LMM(uint32_t PC, uint32_t SP, int argc, char *argv[]) {
   return _threadstart_LMM_cog(PC, SP, argc, argv, ANY_COG);
}
