...
C_P_layS_oundP_C_M_ ' <symbol:PlaySoundPCM>
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_P_layS_oundP_C_M__3  ' NEU4
...
C_P_layS_oundP_C_M__3
 ...
 cmps r22,  #0 wcz
 if_b jmp #\C_P_layS_oundP_C_M__8 ' LTI4
...
C_P_layS_oundP_C_M__8
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_P_layS_oundP_C_M__7  ' NEU4
 mov r22, #7 ' reg <- coni
 #ifndef NO_INTERRUPTS
  stalli
 #endif
 ...
 wrlong r20, r22 ' ASGNU4 reg reg
 mov r22, ##$80000007 ' reg <- con
 wrlong r22, r15 ' ASGNU4 reg reg
 mov r22, ##@C__sound_lock
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_b jmp #\C_P_layS_oundP_C_M__10 ' LTI4
 mov r2, ##@C__sound_lock
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
