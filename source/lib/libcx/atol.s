...
C_atol_3
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_atol_2 ' NEI4
 rdbyte r22, r23 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #43 wz
 if_nz jmp #\C_atol_6 ' NEI4
 adds r23, #1 ' ADDP4 coni
 jmp #\@C_atol_11 ' JUMPV addrg
C_atol_6
 rdbyte r22, r23 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #45 wz
 if_nz jmp #\C_atol_11 ' NEI4
 mov r22, #1 ' reg <- coni
 mov RI, FP
 sub RI, #-(-4)
 wrlong r22, RI ' ASGNI4 addrli reg
...
C_atol_11
 ...
 subs r22, #48 ' SUBI4 coni
 cmp r22,  #10 wcz 
 if_b jmp #\C_atol_10 ' LTU4
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #0 wz
 if_z jmp #\C_atol_14 ' EQI4
 neg r19, r21 ' NEGI4
 jmp #\@C_atol_15 ' JUMPV addrg
C_atol_14
