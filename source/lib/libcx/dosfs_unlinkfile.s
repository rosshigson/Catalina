...
C_D_F_S__U_nlinkF_ile_15
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_D_F_S__U_nlinkF_ile_24 ' NEI4
 mov r22, FP
 sub r22, #-(-16) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, ##4087 ' reg <- con
 cmp r22, r20 wcz 
 if_ae jmp #\C_D_F_S__U_nlinkF_ile_25 ' GEU4
C_D_F_S__U_nlinkF_ile_24
 ...
 cmps r20, r22 wz
 if_nz jmp #\C_D_F_S__U_nlinkF_ile_26 ' NEI4
 mov r22, FP
 sub r22, #-(-16) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
...
C_D_F_S__U_nlinkF_ile_26
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #2 wz
 if_nz jmp #\C_D_F_S__U_nlinkF_ile_14 ' NEI4
 mov r22, FP
 sub r22, #-(-16) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, ##$ffffff7 ' reg <- con
 cmp r22, r20 wcz 
 if_b jmp #\C_D_F_S__U_nlinkF_ile_14 ' LTU4
