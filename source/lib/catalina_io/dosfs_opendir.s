...
C_D_F_S__O_penD_ir ' <symbol:DFS_OpenDir>
 ...
 cmp r22,  #0 wz
 if_z jmp #\C_D_F_S__O_penD_ir_7 ' EQU4
 mov r2, r21 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 PRIMITIVE(#CALA)
 long @C_strlen ' CALL addrg
 cmp r0,  #1 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_5  ' NEU4
 rdbyte r22, r21 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #47 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_5 ' NEI4
C_D_F_S__O_penD_ir_7
 mov r22, r23
 adds r22, #1 ' ADDP4 coni
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #2 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_8 ' NEI4
 mov r22, r23
 ...
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #\@C_D_F_S__O_penD_ir_4 ' JUMPV addrg
...
C_D_F_S__O_penD_ir_5
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #2 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_10 ' NEI4
 mov r22, r23
 adds r22, #44 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 wrlong r22, r19 ' ASGNU4 reg reg
 ...
 add SP, #12 ' CALL addrg
 cmp r0,  #0 wz
 if_z jmp #\C_D_F_S__O_penD_ir_17 ' EQU4
...
C_D_F_S__O_penD_ir_17
 ...
 cmps r22,  #47 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_19 ' NEI4
 cmps r22,  #0 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_16 ' NEI4
C_D_F_S__O_penD_ir_19
 jmp #\@C_D_F_S__O_penD_ir_21 ' JUMPV addrg
...
' C_D_F_S__O_penD_ir_24 ' (symbol refcount = 0)
 cmp r15,  #0 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_26  ' NEU4
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_23 ' NEI4
C_D_F_S__O_penD_ir_26
 ...
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_27 ' NEI4
 mov r22, #16 ' reg <- coni
 mov r20, FP
 sub r20, #-(-21) ' reg <- addrli
 rdbyte r20, r20 ' reg <- CVUI4 INDIRU1 reg
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #2 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_30 ' NEI4
 mov r22, FP
 sub r22, #-(-6) ' reg <- addrli
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 mov r20, FP
 ...
 or r22, r20 ' BORI/U (1)
 mov r20, FP
 sub r20, #-(-11) ' reg <- addrli
 rdbyte r20, r20 ' reg <- CVUI4 INDIRU1 reg
 shl r20, #24 ' LSHU4 coni
 or r22, r20 ' BORI/U (1)
 wrlong r22, r19 ' ASGNU4 reg reg
 jmp #\@C_D_F_S__O_penD_ir_31 ' JUMPV addrg
...
C_D_F_S__O_penD_ir_31
 ...
 add SP, #12 ' CALL addrg
 cmp r0,  #0 wz
 if_z jmp #\C_D_F_S__O_penD_ir_44 ' EQU4
 mov r0, ##$ffffffff ' RET con
 jmp #\@C_D_F_S__O_penD_ir_4 ' JUMPV addrg
C_D_F_S__O_penD_ir_27
 ...
 mov r20, #0 ' reg <- coni
 cmps r0, r20 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_44 ' NEI4
 mov r22, FP
...
C_D_F_S__O_penD_ir_44
 rdbyte r22, r17 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #47 wz
 if_z jmp #\C_D_F_S__O_penD_ir_46 ' EQI4
 cmps r22,  #0 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_43 ' NEI4
C_D_F_S__O_penD_ir_46
 rdbyte r22, r17 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #47 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_47 ' NEI4
 adds r17, #1 ' ADDP4 coni
C_D_F_S__O_penD_ir_47
C_D_F_S__O_penD_ir_21
 rdbyte r22, r17 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_20 ' NEI4
 rdlong r22, r19 ' reg <- INDIRU4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_D_F_S__O_penD_ir_49  ' NEU4
 mov r0, #3 ' reg <- coni
 jmp #\@C_D_F_S__O_penD_ir_4 ' JUMPV addrg
C_D_F_S__O_penD_ir_49
 mov r0, #0 ' reg <- coni
