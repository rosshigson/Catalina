...
C_free ' <symbol:free>
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_free_4  ' NEU4
 jmp #\@C_free_3 ' JUMPV addrg
C_free_4
 ...
 cmps r20,  #0 wz
 if_nz jmp #\C_free_8 ' NEI4
 and r22, #2 ' BANDU4 coni
 cmp r22,  #0 wz
 if_z jmp #\C_free_6 ' EQU4
C_free_8
 jmp #\@C_free_3 ' JUMPV addrg
C_free_6
 mov r22, ##-8 ' reg <- con
...
C__malloc_do_free ' <symbol:_malloc_do_free>
 ...
 cmp r22, r20 wz
 if_nz jmp #\C__malloc_do_free_15  ' NEU4
 mov r21, #1 ' reg <- coni
 jmp #\@C__malloc_do_free_16 ' JUMPV addrg
C__malloc_do_free_15
 mov r21, #0 ' reg <- coni
C__malloc_do_free_16
 cmps r21,  #0 wz
 if_nz jmp #\C__malloc_do_free_12 ' NEI4
 mov r22, ##-8 ' reg <- con
 adds r22, r23 ' ADDI/P (2)
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r19, r22 ' ADDI/P
 ...
 cmps r22,  #0 wz
 if_z jmp #\C__malloc_do_free_17 ' EQI4
...
C__malloc_do_free_12
 ...
 adds r22, r23 ' ADDI/P (2)
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r20, ##$fffffffc ' reg <- con
 and r22, r20 ' BANDI/U (1)
 cmp r22,  #0 wz
 if_nz jmp #\C__malloc_do_free_22  ' NEU4
 mov r19, #1 ' reg <- coni
 jmp #\@C__malloc_do_free_23 ' JUMPV addrg
C__malloc_do_free_22
 mov r19, #0 ' reg <- coni
C__malloc_do_free_23
 cmps r19,  #0 wz
 if_nz jmp #\C__malloc_do_free_19 ' NEI4
 mov r22, ##-4 ' reg <- con
 adds r22, r23 ' ADDI/P (2)
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r20, ##$fffffffc ' reg <- con
 ...
 and r22, #1 ' BANDU4 coni
 cmps r22,  #0 wz
 if_z jmp #\C__malloc_do_free_24 ' EQI4
...
C__malloc_do_free_19
 ...
 mov r17, #0 ' reg <- coni
 cmps r17,  #0 wz
 if_z jmp #\C__malloc_do_free_27 ' EQI4
 cmps r17,  #1 wz
 if_z jmp #\C__malloc_do_free_27 ' EQI4
 jmp #\@C__malloc_do_free_26 ' JUMPV addrg
C__malloc_do_free_26
C__malloc_do_free_27
 mov r15, #0 ' reg <- coni
 cmps r15,  #0 wz
 if_z jmp #\C__malloc_do_free_32 ' EQI4
 cmps r15,  #1 wz
 if_z jmp #\C__malloc_do_free_32 ' EQI4
 jmp #\@C__malloc_do_free_31 ' JUMPV addrg
