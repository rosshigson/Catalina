...
C_spi_writeE_E_P_R_O_M_ ' <symbol:spi_writeEEPROM>
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_spi_writeE_E_P_R_O_M__2  ' NEU4
...
C_spi_writeE_E_P_R_O_M__2
 ...
 cmps r22,  #0 wcz
 if_b jmp #\C_spi_writeE_E_P_R_O_M__7 ' LTI4
 mov r2, ##@C__spi_lock
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
...
C_spi_writeE_E_P_R_O_M__7
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_spi_writeE_E_P_R_O_M__6  ' NEU4
 mov r22, r19
...
' C_spi_writeE_E_P_R_O_M__10 ' (symbol refcount = 0)
 ...
 and r22, r20 ' BANDI/U (3)
 cmp r22,  #0 wz
 if_nz jmp #\C_spi_writeE_E_P_R_O_M__9  ' NEU4
 mov r22, ##@C__spi_lock
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_b jmp #\C_spi_writeE_E_P_R_O_M__12 ' LTI4
 mov r2, ##@C__spi_lock
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_spi_writeE_E_P_R_O_M__12
 ...
 and r22, r20 ' BANDI/U (3)
 cmp r22,  #0 wz
 if_z jmp #\C_spi_writeE_E_P_R_O_M__15 ' EQU4
 mov r17, #1 ' reg <- coni
 jmp #\@C_spi_writeE_E_P_R_O_M__16 ' JUMPV addrg
