...
' C_luaM__free__27 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sfls2_670edcd5_tryagain_L000028 ' <symbol:tryagain>
 calld PA,#NEWF
 calld PA,#PSHM
 long $fa8000 ' save registers
 mov r23, r5 ' reg var <- reg arg
 ...
 cmps r20, r22 wz
 if_nz jmp #\C_sfls2_670edcd5_tryagain_L000028_30 ' NEI4
 mov r20, r15
 ...
 add SP, #12 ' CALL indirect
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #\@C_sfls2_670edcd5_tryagain_L000028_29 ' JUMPV addrg
C_sfls2_670edcd5_tryagain_L000028_30
 mov r0, ##0 ' RET con
C_sfls2_670edcd5_tryagain_L000028_29
 calld PA,#POPM ' restore registers
 calld PA,#RETF
...
C_luaM__realloc_ ' <symbol:luaM_realloc_>
 ...
 sub SP, #12 ' stack space for reg ARGs
 calld PA,#CALA
 long @C_sfls2_670edcd5_tryagain_L000028
 add SP, #12 ' CALL addrg
 mov r13, r0 ' CVI, CVU or LOAD
