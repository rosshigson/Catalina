...
/*
 * defined by Ross Higson for Catalina - changing these flags requires
 * the DOSFS libraries to be recompiled ...
 */

#define APPLY_PATCHES 1 // 1 to apply newsgroup patches to original version

#define __CATALINA_DEBUG_DOSFS 0 // 1 to print debugging info

#define __CATALINA_FAT12_SUPPORT 0 // 1 to include FAT12 support

/*
 * the following flag should be set to 1 when using a version of dosfs
 * that supports values of count other than 1 when calling DFS_ReadSector
 * or DFS_WriteSector - versions up to 1.03 always use a count of 1.
 */
#define DOSFS_CAN_COUNT 0

/* 
 * ... end of stuff defined by Ross Higson for Catalina
 */
...
#define DFS_ERRNAME	   6			// name already exists, or is invalid
#define DFS_NOSUPPORT   7        // feature not supported
...
#define DFS_OPENDIR        4        // open a directory for read 
