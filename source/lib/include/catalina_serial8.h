#ifndef CATALINA_SERIALX__H
#define CATALINA_SERIALX__H
 ...
 * or by manually opening and closing the individual ports from C.
 *
 ...
 * Serial8.spin2 in the target_p2 directory) can be manually configured
...
#define s8_getc(port) rxcheck(port)

#endif // CATALINA_SERIALX__H
