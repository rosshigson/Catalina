...
C_gm_bound_limits ' <symbol:gm_bound_limits>
 ...
 wrlong r22, ##@C_scsk_6188bf8d_m_min_L000001 ' ASGNI4 addrg reg
 wrlong r4, ##@C_scsk1_6188bf8d_m_max_L000002 ' ASGNI4 addrg reg
 mov r22, FP
 add r22, #12 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRI4 reg
 wrlong r22, ##@C_scsk_6188bf8d_m_min_L000001+4 ' ASGNI4 addrg reg
 wrlong r3, ##@C_scsk1_6188bf8d_m_max_L000002+4 ' ASGNI4 addrg reg
 wrlong r5, ##@C_scsk_6188bf8d_m_min_L000001+8 ' ASGNI4 addrg reg
 wrlong r2, ##@C_scsk1_6188bf8d_m_max_L000002+8 ' ASGNI4 addrg reg
...
C_gm_bound_scales ' <symbol:gm_bound_scales>
 wrlong r4, ##@C_scsk2_6188bf8d_m_div_L000003 ' ASGNI4 addrg reg
 wrlong r3, ##@C_scsk2_6188bf8d_m_div_L000003+4 ' ASGNI4 addrg reg
 wrlong r2, ##@C_scsk2_6188bf8d_m_div_L000003+8 ' ASGNI4 addrg reg
...
C_gm_abs ' <symbol:gm_abs>
 cmps r2,  #0 wcz
 if_ae jmp #\C_gm_abs_14 ' GEI4
 neg r0, r2 ' NEGI4
 jmp #\@C_gm_abs_13 ' JUMPV addrg
C_gm_abs_14
...
C_gm_bound_preset_19
 ...
 mov r20, ##@C_scsk2_6188bf8d_m_div_L000003 ' reg <- addrg
 ...
 mov r18, ##@C_scsk_6188bf8d_m_min_L000001 ' reg <- addrg
 ...
 getqx r0
  ...
  allowi
 #endif
 mov r18, ##@C_scsk3_6188bf8d_m_acc_L000004 ' reg <- addrg
...
' C_gm_bound_preset_20 ' (symbol refcount = 0)
 ...
 cmps r17,  #3 wcz
 if_b jmp #\C_gm_bound_preset_19 ' LTI4
...
C_gm_limit ' <symbol:gm_limit>
 ...
 mov r19, #0 ' reg <- coni
 cmps r21,  #0 wcz
 if_ae jmp #\C_gm_limit_24 ' GEI4
 mov r0, #0 ' reg <- coni
 jmp #\@C_gm_limit_23 ' JUMPV addrg
C_gm_limit_24
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_scsk2_6188bf8d_m_div_L000003 ' reg <- addrg
 ...
 mov r18, ##@C_scsk1_6188bf8d_m_max_L000002 ' reg <- addrg
 adds r18, r22 ' ADDI/P (2)
 rdlong r18, r18 ' reg <- INDIRI4 reg
 mov r16, ##@C_scsk_6188bf8d_m_min_L000001 ' reg <- addrg
...
C_gm_bound ' <symbol:gm_bound>
 ...
 mov r22, r23
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_scsk3_6188bf8d_m_acc_L000004 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_scsk3_6188bf8d_m_acc_L000004 ' <symbol:m_acc>
 byte 0[12]

 alignl ' align long
C_scsk2_6188bf8d_m_div_L000003 ' <symbol:m_div>
 byte 0[12]

 alignl ' align long
C_scsk1_6188bf8d_m_max_L000002 ' <symbol:m_max>
 byte 0[12]

 alignl ' align long
C_scsk_6188bf8d_m_min_L000001 ' <symbol:m_min>
 byte 0[12]
