 ...
 *
 *  p2asm -v33  Catalina_LMM_library.spin2
 *  spinc -p2 -B2 -n LMM_LUT_LIBRARY Catalina_LMM_library.bin > LMM_library.inc
 *
 *  p2asm -v33  Catalina_CMM_library.spin2
 *  spinc -p2 -B2 -n CMM_LUT_LIBRARY Catalina_CMM_library.bin > CMM_library.inc
 *
 *  p2asm -v33  Catalina_NMM_library.spin2
 *  spinc -p2 -B2 -n NMM_LUT_LIBRARY Catalina_NMM_library.bin > NMM_library.inc
 *
 */
