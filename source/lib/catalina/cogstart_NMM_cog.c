...
/*
 * _cogstart_NMM_cog : Start a NMM C program in the specified cog.
 ...
 *
 */
int _cogstart_NMM_cog(uint32_t PC, uint32_t SP, void *arg, unsigned int cog) {
   struct {
      unsigned long REG;
      unsigned long PC;
      unsigned long SP;
