...
'
 ...
 alignl ' align long
C_sj48_6188bfa6_do_write_L000003 ' <symbol:do_write>
 PRIMITIVE(#PSHM)
 long $ea8000 ' save registers
 mov r23, r4 ' reg var <- reg arg
 mov r21, r3 ' reg var <- reg arg
 mov r19, r2 ' reg var <- reg arg
 jmp #\@C_sj48_6188bfa6_do_write_L000003_6 ' JUMPV addrg
C_sj48_6188bfa6_do_write_L000003_5
 subs r19, r17 ' SUBI/P (1)
 adds r21, r17 ' ADDI/P (2)
C_sj48_6188bfa6_do_write_L000003_6
 ...
 cmps r0,  #0 wcz
 if_be jmp #\C_sj48_6188bfa6_do_write_L000003_8 ' LEI4
 cmps r17, r19 wcz
 if_b jmp #\C_sj48_6188bfa6_do_write_L000003_5 ' LTI4
C_sj48_6188bfa6_do_write_L000003_8
 cmps r17,  #0 wcz
 if_be jmp #\C_sj48_6188bfa6_do_write_L000003_10 ' LEI4
 mov r15, #1 ' reg <- coni
 jmp #\@C_sj48_6188bfa6_do_write_L000003_11 ' JUMPV addrg
C_sj48_6188bfa6_do_write_L000003_10
 mov r15, #0 ' reg <- coni
C_sj48_6188bfa6_do_write_L000003_11
 mov r0, r15 ' CVI, CVU or LOAD
' C_sj48_6188bfa6_do_write_L000003_4 ' (symbol refcount = 0)
 PRIMITIVE(#POPM) ' restore registers
 PRIMITIVE(#RETN)


 alignl ' align long
C_sj481_6188bfa6_get_buf_L000012 ' <symbol:get_buf>
 PRIMITIVE(#NEWF)
 sub SP, #4
 PRIMITIVE(#PSHM)
 ...
 mov r20, ##-1 ' reg <- con
 cmps r22, r20 wz
 if_nz jmp #\C_sj481_6188bfa6_get_buf_L000012_14 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C__locknew ' CALL addrg
 wrlong r0, ##@C___iolock ' ASGNI4 addrg reg
C_sj481_6188bfa6_get_buf_L000012_14
 mov r22, ##@C___iolock
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 mov r20, ##-1 ' reg <- con
 cmps r22, r20 wz
 if_nz jmp #\C_sj481_6188bfa6_get_buf_L000012_16 ' NEI4
 mov r0, ##0 ' RET con
 jmp #\@C_sj481_6188bfa6_get_buf_L000012_13 ' JUMPV addrg
C_sj481_6188bfa6_get_buf_L000012_16
 mov r2, ##@C___iolock
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 ...
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wz
 if_nz jmp #\C_sj481_6188bfa6_get_buf_L000012_18 ' NEI4
 mov RI, ##@C___iobuff
 mov BC, FP
 sub BC, #-(-4)
 ...
 jmp #\@C_sj481_6188bfa6_get_buf_L000012_19 ' JUMPV addrg
C_sj481_6188bfa6_get_buf_L000012_18
 mov r22, ##0 ' reg <- con
 mov RI, FP
 sub RI, #-(-4)
 wrlong r22, RI ' ASGNP4 addrli reg
C_sj481_6188bfa6_get_buf_L000012_19
 mov r2, ##@C___iolock
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_sj481_6188bfa6_get_buf_L000012_13
 PRIMITIVE(#POPM) ' restore registers
 add SP, #4 ' framesize
 PRIMITIVE(#RETF)
...
C___flushbuf_41
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_sj481_6188bfa6_get_buf_L000012 ' CALL addrg
 mov r20, r21
...
C___flushbuf_62
 ...
 sub SP, #8 ' stack space for reg ARGs
 PRIMITIVE(#CALA)
 long @C_sj48_6188bfa6_do_write_L000003
 add SP, #8 ' CALL addrg
 cmps r0,  #0 wz
 if_nz jmp #\C___flushbuf_58 ' NEI4
 mov r22, r21
