/*
 * misc - data and miscellaneous routines (_ytab moved to misc_yt.c)
 */
...
static TABLE TimezoneTable[] = {
	...
	{"AWST", 0,	-HOUR(7) },	/* Australian West Standard */
	{"AWDT", 60*60,	-HOUR(7) },	/* Australian West Daylight */
	{"JT", 0,	-HOUR(7.5) },	/* Java (3pm in Cronusland!) */
	{"CCT", 0,	-HOUR(8) },	/* China Coast, USSR Zone 7 */
	{"JST", 0,	-HOUR(9) },	/* Japan Standard, USSR Zone 8 */
	{"ACST", 0,	-HOUR(9.5) },	/* Australian Central Standard */
	{"ACDT", 60*60,	-HOUR(9.5) },	/* Australian Central Daylight */
	{"AEST", 0,	-HOUR(10) },	/*  Australian Eastern Standard */
	{"AEDT", 60*60,	-HOUR(10) },	/* Australian Eastern Daylight */
