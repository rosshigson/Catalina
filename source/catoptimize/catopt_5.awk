...
/#JMPA ' Catalina Optimizer / || /PRIMITIVE\(#JMPA\) ' Catalina Optimizer / {
   paren1 = substr($0,5,1);
   paren2 = substr($0,6,1)
   if ((paren1 == "(") || (paren2 == "(")) {
...
/#BR_Z ' Catalina Optimizer / || /PRIMITIVE\(#BR_Z\) ' Catalina Optimizer / {
   paren1 = substr($0,5,1);
   paren2 = substr($0,6,1)
   if ((paren1 == "(") || (paren2 == "(")) {
      # using spinnaker or homespun
...
/#BRNZ ' Catalina Optimizer / || /PRIMITIVE\(#BRNZ\) ' Catalina Optimizer / {
   paren1 = substr($0,5,1);
   paren2 = substr($0,6,1)
   if ((paren1 == "(") || (paren2 == "(")) {
      # using spinnaker or homespun
...
/#BRAE ' Catalina Optimizer / || /PRIMITIVE\(#BRAE\) ' Catalina Optimizer / {
   paren1 = substr($0,5,1);
   paren2 = substr($0,6,1)
   if ((paren1 == "(") || (paren2 == "(")) {
      # using spinnaker or homespun
...
/#BR_A ' Catalina Optimizer / || /PRIMITIVE\(#BR_A\) ' Catalina Optimizer /  {
   paren1 = substr($0,5,1);
   paren2 = substr($0,6,1)
   if ((paren1 == "(") || (paren2 == "(")) {
      # using spinnaker or homespun
...
/#BRBE ' Catalina Optimizer / || /PRIMITIVE\(#BRBE\) ' Catalina Optimizer / {
   paren1 = substr($0,5,1);
   paren2 = substr($0,6,1)
   if ((paren1 == "(") || (paren2 == "(")) {
      # using spinnaker or homespun
...
/#BR_B ' Catalina Optimizer / || /PRIMITIVE\(#BR_B\) ' Catalina Optimizer /  {
   paren1 = substr($0,5,1);
   paren2 = substr($0,6,1)
   if ((paren1 == "(") || (paren2 == "(")) {
      # using spinnaker or homespun
