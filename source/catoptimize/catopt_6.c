...
MAIN()
{
  ...
  while (awka_getline(a_TEMP, awka_dol0(0), awka_gets(a_bivar[a_FILENAME]), FALSE, TRUE)->dval > 0 && awka_setNF())
  {
    ...
    if ((awka_vartrue(awka_match(a_TEMP, FALSE, awka_dol0(0), _litr5_awka, NULL))) || awka_vartrue(awka_match(a_TEMP, FALSE, awka_dol0(0), _litr6_awka, NULL)))
    {
      if ((awka_var2dblcmp(awka_doln(6, 0), 0) > 0))
      {
        awka_vardblset(n_awk, (p_awk->dval + awka_getd(awka_doln(6, 0))));
        awka_varcpy(opt_awk, can_optimize_fn(awka_arg1(a_TEMP, awka_doln(6, 0))));
        goto __139;
      }
      awka_vardblset(n_awk, (p_awk->dval + awka_getd(awka_doln(5, 0))));
      awka_varcpy(opt_awk, can_optimize_fn(awka_arg1(a_TEMP, awka_doln(5, 0))));
      __139:;
      if (awka_length(opt_awk) != 0)
      {
        awka_getline(a_TEMP, awka_dol0(2), awka_gets(a_bivar[a_FILENAME]), 0, TRUE);
        if (awka_vartrue(optimize_add_fn(awka_arg1(a_TEMP, opt_awk))))
        {
          awka_varcpy(d_awk, awka_rtrim(a_TEMP, awka_arg2(a_TEMP, awka_doln(2, 0), _lits3_awka)));
        ...
        awka_strcpy(apos_awk, "'");
        awka_varcpy(d_awk, awka_rtrim(a_TEMP, awka_arg2(a_TEMP, awka_doln(2, 0), _lits3_awka)));
        awka_printf(NULL, 0, 0, awka_vararg(a_TEMP, _lits5_awka, opt_awk, n_awk, d_awk, n_awk, n_awk, NULL));
        awka_match(a_TEMP, FALSE, awka_dol0(0), _litr8_awka, NULL);
        __234:;
        goto __261;
      }
      awka_printf(NULL, 0, 0, awka_vararg(a_TEMP, _lits6_awka, awka_doln(1, 0), awka_doln(2, 0), NULL));
      awka_getline(a_TEMP, awka_dol0(2), awka_gets(a_bivar[a_FILENAME]), 0, TRUE);
      awka_print(NULL, 0, 0, awka_arg1(a_TEMP, awka_dol0(0)));
      __261:;
      goto nextrec;
    }
    if ((awka_vartrue(awka_match(a_TEMP, FALSE, awka_dol0(0), _litr9_awka, NULL))) || awka_vartrue(awka_match(a_TEMP, FALSE, awka_dol0(0), _litr10_awka, NULL)))
    {
      if ((awka_var2dblcmp(awka_doln(6, 0), 0) > 0))
      {
        awka_vardblset(n_awk, (p_awk->dval + awka_getd(awka_doln(6, 0))));
...
main(int argc, char *argv[])
{
  ...
  awka_varinit(_lits4_awka); awka_strcpy(_lits4_awka, " %s PC,#(%s-@:Opt_%06d) ' Catalina Optimized %s\n:Opt_%06d\n");
  awka_varinit(_lits5_awka); awka_strcpy(_lits5_awka, " %s PC,#(@:Opt_%06d-%s) ' Catalina Optimized %s\n:Opt_%06d\n");
  awka_varinit(_lits6_awka); awka_strcpy(_lits6_awka, " %s %s\n");
  ...
  awka_varinit(_litr5_awka); awka_strcpy(_litr5_awka, "/ jmp #JMPA ' Catalina Optimizer /"); awka_getre(_litr5_awka);
  awka_varinit(_litr6_awka); awka_strcpy(_litr6_awka, "/ calld PA,#JMPA ' Catalina Optimizer /"); awka_getre(_litr6_awka);
  awka_varinit(_litr7_awka); awka_strcpy(_litr7_awka, "/* printf \" long %s-@:Opt_%06d ' Catalina Optimized %s (%s)\n:Opt_%06d\n\", $2, n, n, opt,n */"); awka_getre(_litr7_awka);
  awka_varinit(_litr8_awka); awka_strcpy(_litr8_awka, "/* printf \" long @:Opt_%06d-%s ' Catalina Optimized %s (%s)\n:Opt_%06d\n\", n, $2, n, opt, n */"); awka_getre(_litr8_awka);
  awka_varinit(_litr9_awka); awka_strcpy(_litr9_awka, "/ jmp #BR.. ' Catalina Optimizer /"); awka_getre(_litr9_awka);
  awka_varinit(_litr10_awka); awka_strcpy(_litr10_awka, "/ calld PA,#BR.. ' Catalina Optimizer /"); awka_getre(_litr10_awka);
  ...
  if (!_lvar) {
    ...
    _lvar[8] = _lits5_awka;
    _lvar[9] = _lits6_awka;
    _lvar[10] = _litr0_awka;
    _lvar[11] = _litr1_awka;
    _lvar[12] = _litr2_awka;
    _lvar[13] = _litr3_awka;
    _lvar[14] = _litr4_awka;
    _lvar[15] = _litr5_awka;
    _lvar[16] = _litr6_awka;
    _lvar[17] = _litr7_awka;
    _lvar[18] = _litr8_awka;
    _lvar[19] = _litr9_awka;
    _lvar[20] = _litr10_awka;
    _lvar[21] = NULL;
  }
  ...
  awka_initgvar(4, "apos_awk", apos_awk);
  _gvar[5].name = NULL;
  _gvar[5].var  = NULL;
