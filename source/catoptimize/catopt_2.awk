...
/^C_/  {
   ...
   if (f == "C__exit") {
      ...
      if ((($1 == "jmp") && ($2 == "#NEWF")) || ($1 == "PRIMITIVE(#NEWF)")) {
         /* strip the call to NEWF - we simulate it later */
         getline;
      }
      if ((($1 == "jmp") && (($2 == "#CALI") || ($2 == "#CALA"))) || ($1 == "PRIMITIVE(#CALI)") || ($1 == "PRIMITIVE(#CALA)")) {
         leaf = 0;
      ...
      if ((($1 == "jmp") && (($2 == "#RETF") || ($2 == "#RETN"))) || ($1 == "PRIMITIVE(#RETF)") || ($1 == "PRIMITIVE(#RETN)")) {
      ...
      if (done == 0) {
         if (left($0,10) == " sub SP, #") {
         ...
         else if ((left($0,10) == " jmp #LODF") || (left($0,17) == " PRIMITIVE(#LODF)")) {
         ...
         else if ((left($0,10) == " jmp #LODL") || (left($0,17) == " PRIMITIVE(#LODL)")) {
            add_line_to_function(f, $0);
            getline;
            add_line_to_function(f, $0);
            getline;
            ...
            else if ((($1 == "jmp") && (($2 == "#RETF") || ($2 == "#RETN"))) || ($1 == "PRIMITIVE(#RETF)") || ($1 == "PRIMITIVE(#RETN)")) {
               /* strip the call to RETF or RETN - we simulate it later */
               done = 1;
            }
         }
      ...
      while (done == 0) {
         ...
         else if ((($1 == "jmp") && (($2 == "#CALI") || ($2 == "#CALA"))) || ($1 == "PRIMITIVE(#CALI)") || ($1 == "PRIMITIVE(#CALA)")) {
            leaf = 0;
         }
         else if ((left($0,10) == " jmp #LODF") || (left($0,17) == " PRIMITIVE(#LODF)")) {
            /* pretend this function uses BC - actually it uses FP */
