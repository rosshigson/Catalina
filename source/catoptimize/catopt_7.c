...
MAIN()
{
  ...
  while (awka_getline(a_TEMP, awka_dol0(0), awka_gets(a_bivar[a_FILENAME]), FALSE, TRUE)->dval > 0 && awka_setNF())
  {
    ...
    if ((awka_vartrue(awka_match(a_TEMP, FALSE, awka_dol0(0), _litr2_awka, NULL))) || awka_vartrue(awka_match(a_TEMP, FALSE, awka_dol0(0), _litr3_awka, NULL)))
    {
      ...
      awka_getline(a_TEMP, awka_dol0(2), awka_gets(a_bivar[a_FILENAME]), 0, TRUE);
      if ((!strcmp(awka_gets(awka_doln(1, 0)), "add")) && !strcmp(awka_gets(awka_doln(2, 0)), "SP,"))
      {
        awka_varcpy(s_awk, awka_ltrim(a_TEMP, awka_arg2(a_TEMP, awka_doln(3, 0), _lits4_awka)));
        goto __112;
      }
      awka_strcpy(s_awk, "-1");
      __112:;
...
main(int argc, char *argv[])
{
  ...
  awka_varinit(_lits2_awka); awka_strcpy(_lits2_awka, "add");
  awka_varinit(_lits3_awka); awka_strcpy(_lits3_awka, "SP,");
  awka_varinit(_lits4_awka); awka_strcpy(_lits4_awka, "#");
  awka_varinit(_lits5_awka); awka_strcpy(_lits5_awka, "-1");
