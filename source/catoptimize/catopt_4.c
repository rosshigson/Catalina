...
a_VAR *_lits0_awka=NULL, *_lits1_awka=NULL, *_lits2_awka=NULL;
...
MAIN()
{
  ...
  while (awka_getline(a_TEMP, awka_dol0(0), awka_gets(a_bivar[a_FILENAME]), FALSE, TRUE)->dval > 0 && awka_setNF())
  {
    ...
    {
      awka_sub(a_TEMP, TRUE, FALSE, _litr3_awka, awka_ro_str2var(""), awka_dol0(2));
      awka_print(NULL, 0, 0, awka_arg1(a_TEMP, awka_strconcat3(a_TEMP, awka_vardup(awka_dol0(0)), _lits2_awka, awka_tmp_dbl2var(++awka_setd(i_awk)))));
      goto nextrec;
    }
...
main(int argc, char *argv[])
{
  ...
  awka_varinit(_lits2_awka); awka_strcpy(_lits2_awka, " ' Catalina Optimizer ");
  ...
  awka_varinit(_litr2_awka); awka_strcpy(_litr2_awka, "/#JMPA/"); awka_getre(_litr2_awka);
  awka_varinit(_litr3_awka); awka_strcpy(_litr3_awka, "\r|\n"); awka_getre(_litr3_awka);
  awka_varinit(_litr4_awka); awka_strcpy(_litr4_awka, "/#BR_Z/"); awka_getre(_litr4_awka);
  awka_varinit(_litr5_awka); awka_strcpy(_litr5_awka, "/#BRNZ/"); awka_getre(_litr5_awka);
  awka_varinit(_litr6_awka); awka_strcpy(_litr6_awka, "/#BRAE/"); awka_getre(_litr6_awka);
  awka_varinit(_litr7_awka); awka_strcpy(_litr7_awka, "/#BR_A/"); awka_getre(_litr7_awka);
  awka_varinit(_litr8_awka); awka_strcpy(_litr8_awka, "/#BRBE/"); awka_getre(_litr8_awka);
  awka_varinit(_litr9_awka); awka_strcpy(_litr9_awka, "/#BR_B/"); awka_getre(_litr9_awka);
  ...
  if (!_lvar) {
    ...
    _lvar[8] = _litr4_awka;
    _lvar[9] = _litr5_awka;
    _lvar[10] = _litr6_awka;
    _lvar[11] = _litr7_awka;
    _lvar[12] = _litr8_awka;
    _lvar[13] = _litr9_awka;
    _lvar[14] = NULL;
  }
