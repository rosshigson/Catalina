...
a_VAR *_lits0_awka=NULL, *_lits1_awka=NULL, *_lits2_awka=NULL, *_lits3_awka=NULL, *_lits4_awka=NULL, *_lits5_awka=NULL, *_lits6_awka=NULL, *_lits7_awka=NULL, *_lits8_awka=NULL, *_lits9_awka=NULL, *_lits10_awka=NULL, *_lits11_awka=NULL, *_lits12_awka=NULL, *_lits13_awka=NULL, *_lits14_awka=NULL, *_lits15_awka=NULL;
      ...
      if (awka_vartrue(code_awk))
      {
        ...
        if (!(awka_vartrue(required_function_fn(awka_arg1(a_TEMP, f_awk)))))
        {
          ...
          while (1)
          {
            ...
            if ((!strcmp(awka_gets(awka_doln(1, 0)), "'")) && !strcmp(awka_gets(awka_left(a_TEMP, awka_doln(2, 0), _litd2_awka)), "end"))
            {
              awka_print(NULL, 0, 0, awka_arg2(a_TEMP, _lits2_awka, awka_dol0(0)));
              break;
              goto __327;
...
main(int argc, char *argv[])
{
  ...
  awka_varinit(_litd2_awka); awka_setd(_litd2_awka) = 3;
  ...
  awka_varinit(_lits4_awka); awka_strcpy(_lits4_awka, "jmp");
  awka_varinit(_lits5_awka); awka_strcpy(_lits5_awka, "#RETF");
  awka_varinit(_lits6_awka); awka_strcpy(_lits6_awka, "#RETN");
  awka_varinit(_lits7_awka); awka_strcpy(_lits7_awka, "calld");
  awka_varinit(_lits8_awka); awka_strcpy(_lits8_awka, "PA,#RETF");
  awka_varinit(_lits9_awka); awka_strcpy(_lits9_awka, "PA,#RETN");
  ...
  awka_varinit(_lits13_awka); awka_strcpy(_lits13_awka, "byte");
  awka_varinit(_lits14_awka); awka_strcpy(_lits14_awka, "word");
  awka_varinit(_lits15_awka); awka_strcpy(_lits15_awka, "long");
