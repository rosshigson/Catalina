...
@echo               or MORPHEUS CPU_1 or MORPHEUS CPU_2 
...
@echo on
spinnaker -p -a RAM_Test.spin -I "%TMP_LCCDIR%\target" -D PC -b %TMP_VAR% -o RAM_Test_PC -l
spinnaker -p -a RAM_Test.spin -I "%TMP_LCCDIR%\target" -D HIRES_VGA -b %TMP_VAR% -o RAM_Test_VGA
spinnaker -p -a RAM_Test.spin -I "%TMP_LCCDIR%\target" -D HIRES_TV -b %TMP_VAR% -o RAM_Test_TV
@echo off
goto done
