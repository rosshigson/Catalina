...
DAT ' initialized data segment
 ...
 long ' align long
C_sc08_619c5630_s8base_L000002 ' <symbol:s8base>
 long $0

 long ' align long
C_sc081_619c5630_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 long ' align long
C_sc083_619c5630_pinconfig_L000005 ' <symbol:pinconfig>
 jmp #NEWF
 sub SP, #4
 jmp #PSHM
 ...
 cmps r17,  #0 wz
 jmp #BRNZ
 long @C_sc083_619c5630_pinconfig_L000005_7 ' NEI4
 mov r22, #62 ' reg <- coni
 mov RI, FP
 sub RI, #-(-4)
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sc083_619c5630_pinconfig_L000005_8 ' EQU4
 mov r22, FP
 ...
 wrlong r22, RI ' ASGNU4 addrli reg
 jmp #JMPA
 long @C_sc083_619c5630_pinconfig_L000005_8 ' JUMPV addrg
C_sc083_619c5630_pinconfig_L000005_7
 ...
 cmps r13,  #0 wz,wc
 jmp #BR_B
 long @C_sc083_619c5630_pinconfig_L000005_11 ' LTI4
 cmps r13,  #3 wz,wc
 jmp #BR_A
 long @C_sc083_619c5630_pinconfig_L000005_11 ' GTI4
 mov r22, r13
 shl r22, #2 ' LSHI4 coni
 jmp #LODL
 long @C_sc083_619c5630_pinconfig_L000005_18_L000020
...
DAT ' const data segment
 ...
 long ' align long
C_sc083_619c5630_pinconfig_L000005_18_L000020 ' <symbol:18>
 long @C_sc083_619c5630_pinconfig_L000005_12
 long @C_sc083_619c5630_pinconfig_L000005_15
 long @C_sc083_619c5630_pinconfig_L000005_16
 long @C_sc083_619c5630_pinconfig_L000005_17

' Catalina Code

DAT ' code segment
C_sc083_619c5630_pinconfig_L000005_15
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 jmp #LODL
 ...
 wrlong r22, RI ' ASGNU4 addrli reg
 jmp #JMPA
 long @C_sc083_619c5630_pinconfig_L000005_12 ' JUMPV addrg
C_sc083_619c5630_pinconfig_L000005_16
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 jmp #LODL
 ...
 jmp #JMPA
 long @C_sc083_619c5630_pinconfig_L000005_12 ' JUMPV addrg
C_sc083_619c5630_pinconfig_L000005_17
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 jmp #LODL
 ...
 sub RI, #-(-4)
 wrlong r22, RI ' ASGNU4 addrli reg
C_sc083_619c5630_pinconfig_L000005_11
C_sc083_619c5630_pinconfig_L000005_12
C_sc083_619c5630_pinconfig_L000005_8
...
' C_sc083_619c5630_pinconfig_L000005_6 ' (symbol refcount = 0)
 ...
 long ' align long
C_sc086_619c5630_p_config_L000021 ' <symbol:p_config>
 jmp #NEWF
 jmp #PSHM
 ...
 jmp #LODI
 long @C_sc08_619c5630_s8base_L000002
 ...
 mov BC, r20
 jmp #WBYT ' ASGNU1 reg reg
' C_sc086_619c5630_p_config_L000021_22 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETF


 long ' align long
C_sc087_619c5630_autoinitialize_L000023 ' <symbol:autoinitialize>
 jmp #PSHM
 long $fea800 ' save registers
 jmp #LODL
 long @C_sc082_619c5630_txrxbuff_L000004
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_sc087_619c5630_autoinitialize_L000023_25 ' EQU4
 mov r15, #0 ' reg <- coni
C_sc087_619c5630_autoinitialize_L000023_27
 mov r21, r15
 ...
 cmps r23,  #0 wz,wc
 jmp #BR_B
 long @C_sc087_619c5630_autoinitialize_L000023_31 ' LTI4
 cmps r23,  #63 wz,wc
 jmp #BR_A
 long @C_sc087_619c5630_autoinitialize_L000023_31 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 jmp #LODI
 long @C_sc08_619c5630_s8base_L000002
 ...
 sub SP, #12 ' stack space for reg ARGs
 jmp #CALA
 long @C_sc083_619c5630_pinconfig_L000005
 add SP, #12 ' CALL addrg
 mov r2, r19
 ...
 jmp #CALA
 long @C_sc086_619c5630_p_config_L000021
 add SP, #20 ' CALL addrg
C_sc087_619c5630_autoinitialize_L000023_31
 ...
 cmps r23,  #0 wz,wc
 jmp #BR_B
 long @C_sc087_619c5630_autoinitialize_L000023_33 ' LTI4
 cmps r23,  #63 wz,wc
 jmp #BR_A
 long @C_sc087_619c5630_autoinitialize_L000023_33 ' GTI4
 mov r22, r21
 shl r22, #4 ' LSHI4 coni
 jmp #LODI
 long @C_sc08_619c5630_s8base_L000002
 ...
 long @C_sc086_619c5630_p_config_L000021
 add SP, #20 ' CALL addrg
C_sc087_619c5630_autoinitialize_L000023_33
 add r19, #128 ' ADDU4 coni
 add r17, #128 ' ADDU4 coni
' C_sc087_619c5630_autoinitialize_L000023_28 ' (symbol refcount = 0)
 adds r15, #1 ' ADDI4 coni
 cmps r15,  #8 wz,wc
 jmp #BR_B
 long @C_sc087_619c5630_autoinitialize_L000023_27 ' LTI4
C_sc087_619c5630_autoinitialize_L000023_25
' C_sc087_619c5630_autoinitialize_L000023_24 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 jmp #RETN


 long ' align long
C_sc088_619c5630_initialize_L000035 ' <symbol:initialize>
 jmp #NEWF
 sub SP, #8
 jmp #PSHM
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_sc088_619c5630_initialize_L000035_37 ' NEU4
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_sc088_619c5630_initialize_L000035_39 ' LTI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 ...
 jmp #LODL
 long @C_sc081_619c5630_lock_L000003
 mov BC, r22
 ...
 cmps r22,  #0 wz
 jmp #BRNZ
 long @C_sc088_619c5630_initialize_L000035_41 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_sc088_619c5630_initialize_L000035_42 ' LTI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 regl
 jmp #LODI
 ...
 jmp #WLNG ' ASGNU4 reg reg
 jmp #JMPA
 long @C_sc088_619c5630_initialize_L000035_42 ' JUMPV addrg
C_sc088_619c5630_initialize_L000035_41
 jmp #LODI
 long @C_sc081_619c5630_lock_L000003
 mov r22, RI ' reg <- INDIRI4 addrg
 ...
 mov BC, r22
 jmp #WLNG ' ASGNI4 addrg reg
C_sc088_619c5630_initialize_L000035_42
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_sc087_619c5630_autoinitialize_L000023 ' CALL addrg
C_sc088_619c5630_initialize_L000035_39
C_sc088_619c5630_initialize_L000035_37
' C_sc088_619c5630_initialize_L000035_36 ' (symbol refcount = 0)
 jmp #POPM ' restore registers
 add SP, #8 ' framesize
 jmp #RETF
...
C_s8_closeport ' <symbol:s8_closeport>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 jmp #CALA
 long @C_sc088_619c5630_initialize_L000035 ' CALL addrg
C_s8_closeport_46
 cmp r23,  #8 wz,wc 
 jmp #BRAE
...
DAT ' uninitialized data segment
 ...
 long ' align long
C_sc082_619c5630_txrxbuff_L000004 ' <symbol:txrxbuff>
 byte 0[1024]
