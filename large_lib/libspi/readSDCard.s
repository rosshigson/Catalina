...
C_spi_readS_D_C_ard_2
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_spi_readS_D_C_ard_10 ' LTI4
...
' C_spi_readS_D_C_ard_7 ' (symbol refcount = 0)
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_spi_readS_D_C_ard_6 ' EQI4
...
' C_spi_readS_D_C_ard_13 ' (symbol refcount = 0)
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_spi_readS_D_C_ard_12 ' NEU4
 jmp #LODI
 long @C__spi_lock
 mov r22, RI ' reg <- INDIRI4 addrg
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_spi_readS_D_C_ard_15 ' LTI4
 jmp #LODI
 long @C__spi_lock
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_spi_readS_D_C_ard_15
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_spi_readS_D_C_ard_18 ' EQU4
 mov r17, #1 ' reg <- coni
 jmp #JMPA
 long @C_spi_readS_D_C_ard_19 ' JUMPV addrg
