...
C_spi_bootE_E_P_R_O_M__3
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_spi_bootE_E_P_R_O_M__11 ' LTI4
...
' C_spi_bootE_E_P_R_O_M__8 ' (symbol refcount = 0)
 ...
 cmps r0,  #0 wz
 jmp #BR_Z
 long @C_spi_bootE_E_P_R_O_M__7 ' EQI4
...
C_spi_bootE_E_P_R_O_M__11
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_spi_bootE_E_P_R_O_M__10 ' NEU4
 ...
 cmps r0,  #0 wz
 jmp #BRNZ
 long @C_spi_bootE_E_P_R_O_M__13 ' NEI4
 jmp #LODI
 long @C__spi_lock
 mov r22, RI ' reg <- INDIRI4 addrg
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_spi_bootE_E_P_R_O_M__15 ' LTI4
 jmp #LODI
 long @C__spi_lock
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_spi_bootE_E_P_R_O_M__17
 cmps r21, r19 wz
 jmp #BR_Z
 long @C_spi_bootE_E_P_R_O_M__21 ' EQI4
 cmps r21, r17 wz
 jmp #BR_Z
 long @C_spi_bootE_E_P_R_O_M__21 ' EQI4
...
' C_spi_bootE_E_P_R_O_M__18 ' (symbol refcount = 0)
 ...
 cmps r21,  #8 wz,wc
 jmp #BR_B
 long @C_spi_bootE_E_P_R_O_M__17 ' LTI4
 jmp #LODL
 long $80000000
 ...
 cmps r22,  #0 wz,wc
 jmp #BR_B
 long @C_spi_bootE_E_P_R_O_M__23 ' LTI4
 jmp #LODI
 long @C__spi_lock
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_spi_bootE_E_P_R_O_M__23
 ...
 cmps r22,  #0 wz,wc
 jmp #BRBE
 long @C_spi_bootE_E_P_R_O_M__28 ' LEI4
 jmp #LODI
 long @C__spi_lock
 mov r2, RI ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
...
C_spi_bootE_E_P_R_O_M__28
 ...
 cmp r22,  #0 wz
 jmp #BRNZ
 long @C_spi_bootE_E_P_R_O_M__27 ' NEU4
 mov r2, #0 ' reg ARG coni
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 jmp #CALA
 long @C_spi_getC_ontrol ' CALL addrg
 ...
 cmp r22,  #0 wz
 jmp #BR_Z
 long @C_spi_bootE_E_P_R_O_M__31 ' EQU4
 mov r15, #1 ' reg <- coni
 jmp #JMPA
 long @C_spi_bootE_E_P_R_O_M__32 ' JUMPV addrg
