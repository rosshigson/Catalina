...
DAT ' initialized data segment
 ...
 alignl ' align long
C_skrc_6174ada4_maxE_xponent_L000003 ' <symbol:maxExponent>
 long 511

 alignl ' align long
C_skrc1_6174ada4_powersO_f10_L000004 ' <symbol:powersOf10>
 long $41200000 ' float
 long $42c80000 ' float
 long $461c4000 ' float
 long $4cbebc20 ' float
...
C_strtod_16
 ...
 word I16A_SUBS + (r19)<<D16A + (r13)<<S16A ' SUBI/P (1)
 word I16A_CMPSI + (r10)<<D16A + (0)<<S16A
 alignl ' align long
...
C_strtod_23
 ...
 alignl ' align long
C_strtod_24
 word I16A_CMPSI + (r13)<<D16A + (18)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_strtod_25)<<S32 ' LEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (18)<<S16A ' reg <- coni
 word I16A_MOV + (r6)<<D16A + (r10)<<S16A
 word I16A_SUBSI + (r6)<<D16A + (18)<<S16A ' SUBI4 reg coni
 word I16A_MOV + (r13)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_strtod_26)<<S32 ' JUMPV addrg
 alignl ' align long
C_strtod_25
 word I16A_MOV + (r6)<<D16A + (r10)<<S16A ' SUBI/P
 word I16A_SUBS + (r6)<<D16A + (r13)<<S16A ' SUBI/P (3)
 alignl ' align long
C_strtod_26
 ...
 word I16A_MOV + (r7)<<D16A + RI<<S16A ' reg <- INDIRF4 addrg
 word I16A_MOV + (r19)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
...
C_strtod_46
 ...
 word I16A_SUBS + (r15)<<D16A + (r6)<<S16A
 word I16A_NEG + (r15)<<D16A + (r15)<<S16A ' SUBI/P (2)
 alignl ' align long
 long I32_JMPA + (@C_strtod_57)<<S32 ' JUMPV addrg
 alignl ' align long
C_strtod_56
 word I16A_ADDS + (r15)<<D16A + (r6)<<S16A ' ADDI/P (2)
 alignl ' align long
C_strtod_57
...
C_strtod_59
 alignl ' align long
 long I32_LODI + (@C_skrc_6174ada4_maxE_xponent_L000003)<<S32
...
C_strtod_60
 ...
 alignl ' align long
 long @C_skrc1_6174ada4_powersO_f10_L000004 ' reg <- addrg
 alignl ' align long
...
C_strtod_64
 ...
 word I16A_RDLONG + (r22)<<D16A + (r11)<<S16A ' reg <- INDIRF4 reg
...
' C_strtod_65 ' (symbol refcount = 0)
 word I16A_SARI + (r15)<<D16A + (1)<<S16A ' SHRI4 reg coni
...
C_strtod_67
 ...
 word I16A_MOV + (r0)<<D16A + (r7)<<S16A ' setup r0/r1 (2)
