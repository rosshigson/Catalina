...
C_mktime ' <symbol:mktime>
 ...
 word I16A_MOV + (r22)<<D16A + (r18)<<S16A ' ADDI/P
...
C_mktime_45
 ...
 word I16A_CMPS + (r20)<<D16A + (r18)<<S16A
 alignl ' align long
...
C_mktime_52
 ...
 alignl ' align long
 long I32_LODS + (r18)<<D32S + ((400)&$7FFFF)<<S32 ' reg <- cons
 word I16A_MOV + (r0)<<D16A + (r19)<<S16A ' setup r0/r1 (2)
 word I16A_MOV + (r1)<<D16A + (r18)<<S16A ' setup r0/r1 (2)
 word I16B_DIVS ' DIVI
 word I16A_MOV + (r18)<<D16A + (r1)<<S16A ' CVI, CVU or LOAD
...
C_mktime_63
 ...
 word I16A_WRLONG + (r1)<<D16A + (r20)<<S16A ' ASGNI4 reg reg
 alignl ' align long
