...
'
 ...
 alignl ' align long
C_s148_6188bf50_do_write_L000003 ' <symbol:do_write>
 alignl ' align long
 ...
 alignl ' align long
 long I32_JMPA + (@C_s148_6188bf50_do_write_L000003_6)<<S32 ' JUMPV addrg
 alignl ' align long
C_s148_6188bf50_do_write_L000003_5
 word I16A_SUBS + (r19)<<D16A + (r17)<<S16A ' SUBI/P (1)
 word I16A_ADDS + (r21)<<D16A + (r17)<<S16A ' ADDI/P (2)
 alignl ' align long
C_s148_6188bf50_do_write_L000003_6
 ...
 alignl ' align long
 long I32_BRBE + (@C_s148_6188bf50_do_write_L000003_8)<<S32 ' LEI4 reg coni
 word I16A_CMPS + (r17)<<D16A + (r19)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s148_6188bf50_do_write_L000003_5)<<S32 ' LTI4 reg reg
 alignl ' align long
C_s148_6188bf50_do_write_L000003_8
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s148_6188bf50_do_write_L000003_10)<<S32 ' LEI4 reg coni
 word I16A_MOVI + (r15)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_s148_6188bf50_do_write_L000003_11)<<S32 ' JUMPV addrg
 alignl ' align long
C_s148_6188bf50_do_write_L000003_10
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_s148_6188bf50_do_write_L000003_11
 word I16A_MOV + (r0)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
' C_s148_6188bf50_do_write_L000003_4 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_s1481_6188bf50_get_buf_L000012 ' <symbol:get_buf>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s1481_6188bf50_get_buf_L000012_14)<<S32 ' NEI4 reg reg
 alignl ' align long
 ...
 alignl ' align long
C_s1481_6188bf50_get_buf_L000012_14
 alignl ' align long
 long I32_LODI + (@C___iolock)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_NEGI + (r20)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s1481_6188bf50_get_buf_L000012_16)<<S32 ' NEI4 reg reg
 word I16B_LODL + R0<<D16B
 alignl ' align long
 long 0 ' RET con
 alignl ' align long
 long I32_JMPA + (@C_s1481_6188bf50_get_buf_L000012_13)<<S32 ' JUMPV addrg
 alignl ' align long
C_s1481_6188bf50_get_buf_L000012_16
 alignl ' align long
 long I32_LODI + (@C___iolock)<<S32
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s1481_6188bf50_get_buf_L000012_18)<<S32 ' NEI4 reg coni
 ...
 alignl ' align long
 long I32_JMPA + (@C_s1481_6188bf50_get_buf_L000012_19)<<S32 ' JUMPV addrg
 alignl ' align long
C_s1481_6188bf50_get_buf_L000012_18
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long 0 ' reg <- con
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNP4 addrl16 reg
 alignl ' align long
C_s1481_6188bf50_get_buf_L000012_19
 alignl ' align long
 long I32_LODI + (@C___iolock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 alignl ' align long
C_s1481_6188bf50_get_buf_L000012_13
...
C___flushbuf_41
 alignl ' align long
 long I32_CALA + (@C_s1481_6188bf50_get_buf_L000012)<<S32 ' CALL addrg
 word I16A_MOV + (r20)<<D16A + (r21)<<S16A
...
C___flushbuf_62
 ...
 word I16B_CPREP + 50<<S16B ' arg size, rpsize = 12, spsize = 12
 alignl ' align long
 long I32_CALA + (@C_s148_6188bf50_do_write_L000003)<<S32
 word I16A_ADDI + SP<<D16A + 8<<S16A ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
