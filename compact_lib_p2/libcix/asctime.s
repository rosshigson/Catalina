...
'
 ...
 alignl ' align long
C_s20o_5f5d7cdf_two_digits_L000001 ' <symbol:two_digits>
 alignl ' align long
 ...
 word I16A_MOV + (r22)<<D16A + (r1)<<S16A ' ADDI/P
 word I16A_ADDS + (r22)<<D16A + (r20)<<S16A ' ADDI/P (3)
 word I16A_WRBYTE + (r22)<<D16A + (r23)<<S16A ' ASGNU1 reg reg
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s20o_5f5d7cdf_two_digits_L000001_3)<<S32 ' NEI4 reg coni
 ...
 word I16A_WRBYTE + (r22)<<D16A + (r23)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_s20o_5f5d7cdf_two_digits_L000001_3
...
' C_s20o_5f5d7cdf_two_digits_L000001_2 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_s20o1_5f5d7cdf_four_digits_L000005 ' <symbol:four_digits>
 alignl ' align long
 ...
 word I16A_MOV + (r23)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r0)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
' C_s20o1_5f5d7cdf_four_digits_L000005_6 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
C_asctime_16
 ...
 alignl ' align long
 long I32_CALA + (@C_s20o_5f5d7cdf_two_digits_L000001)<<S32
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_s20o1_5f5d7cdf_four_digits_L000005)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
