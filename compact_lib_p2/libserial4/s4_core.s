...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sgp4_6174adb1_rxbase_L000002 ' <symbol:rxbase>
 long $0

 alignl ' align long
C_sgp41_6174adb1_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_sgp42_6174adb1_initialize_L000004 ' <symbol:initialize>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $540000<<S32 ' save registers
 alignl ' align long
 long I32_LODI + (@C_sgp4_6174adb1_rxbase_L000002)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sgp42_6174adb1_initialize_L000004_6)<<S32 ' NEU4 reg coni
 ...
 alignl ' align long
 long I32_BR_B + (@C_sgp42_6174adb1_initialize_L000004_8)<<S32 ' LTI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODA + (@C_sgp4_6174adb1_rxbase_L000002)<<S32
 word I16A_WRLONG + (r20)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sgp41_6174adb1_lock_L000003 ' reg <- addrg
 word I16A_SHRI + (r22)<<D16A + (24)<<S16A ' SHRU4 reg coni
 alignl ' align long
 long I32_LODA + (@C_sgp41_6174adb1_lock_L000003)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16A_RDLONG + (r22)<<D16A + (r20)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sgp42_6174adb1_initialize_L000004_10)<<S32 ' NEI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODI + (@C_sgp41_6174adb1_lock_L000003)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sgp42_6174adb1_initialize_L000004_11)<<S32 ' LTI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 alignl ' align long
 long I32_LODI + (@C_sgp41_6174adb1_lock_L000003)<<S32
 ...
 alignl ' align long
 long I32_JMPA + (@C_sgp42_6174adb1_initialize_L000004_11)<<S32 ' JUMPV addrg
 alignl ' align long
C_sgp42_6174adb1_initialize_L000004_10
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
C_sgp42_6174adb1_initialize_L000004_11
 alignl ' align long
C_sgp42_6174adb1_initialize_L000004_8
 alignl ' align long
C_sgp42_6174adb1_initialize_L000004_6
' C_sgp42_6174adb1_initialize_L000004_5 ' (symbol refcount = 0)
...
C_s4_rxflush ' <symbol:s4_rxflush>
 ...
 alignl ' align long
 long I32_CALA + (@C_sgp42_6174adb1_initialize_L000004)<<S32 ' CALL addrg
 alignl ' align long
C_s4_rxflush_15
