...
C_m_bound_limits ' <symbol:m_bound_limits>
 ...
 alignl ' align long
 long I32_LODA + (@C_s440_616ac933_m_min_L000002)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODA + (@C_s4401_616ac933_m_max_L000003)<<S32
 word I16A_WRLONG + (r4)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 long I32_LODA + (@C_s440_616ac933_m_min_L000002+4)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODA + (@C_s4401_616ac933_m_max_L000003+4)<<S32
 word I16A_WRLONG + (r3)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODA + (@C_s440_616ac933_m_min_L000002+8)<<S32
 word I16A_WRLONG + (r5)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODA + (@C_s4401_616ac933_m_max_L000003+8)<<S32
...
C_m_bound_scales ' <symbol:m_bound_scales>
 alignl ' align long
 long I32_LODA + (@C_s4402_616ac933_m_div_L000004)<<S32
 word I16A_WRLONG + (r4)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODA + (@C_s4402_616ac933_m_div_L000004+4)<<S32
 word I16A_WRLONG + (r3)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_LODA + (@C_s4402_616ac933_m_div_L000004+8)<<S32
 word I16A_WRLONG + (r2)<<D16A + RI<<S16A ' ASGNI4 addrg reg
...
C_m_bound_preset_20
 ...
 alignl ' align long
 long @C_s4402_616ac933_m_div_L000004 ' reg <- addrg
 ...
 alignl ' align long
 long @C_s440_616ac933_m_min_L000002 ' reg <- addrg
 ...
 word I16B_LODL + (r18)<<D16B
 alignl ' align long
 long @C_s4403_616ac933_m_acc_L000005 ' reg <- addrg
...
C_m_limit_25
 ...
 word I16B_LODL + (r18)<<D16B
 alignl ' align long
 long @C_s4401_616ac933_m_max_L000003 ' reg <- addrg
 word I16A_ADDS + (r18)<<D16A + (r22)<<S16A ' ADDI/P (2)
 word I16A_RDLONG + (r18)<<D16A + (r18)<<S16A ' reg <- INDIRI4 reg
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_s4403_616ac933_m_acc_L000005 ' <symbol:m_acc>
 byte 0[12]

 alignl ' align long
C_s4402_616ac933_m_div_L000004 ' <symbol:m_div>
 byte 0[12]

 alignl ' align long
C_s4401_616ac933_m_max_L000003 ' <symbol:m_max>
 byte 0[12]

 alignl ' align long
C_s440_616ac933_m_min_L000002 ' <symbol:m_min>
 byte 0[12]
