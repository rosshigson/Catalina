...
C_fclose ' <symbol:fclose>
 ...
 alignl ' align long
 long I32_BRNZ + (@C_fclose_4)<<S32 ' NEI4 reg reg
 alignl ' align long
...
C_fclose_4
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_fclose_6)<<S32 ' NEI4 reg reg
 alignl ' align long
...
C_fclose_8
 ...
 alignl ' align long
 long I32_BRNZ + (@C_fclose_12)<<S32 ' NEU4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_fclose_10)<<S32 ' JUMPV addrg
 alignl ' align long
C_fclose_12
' C_fclose_9 ' (symbol refcount = 0)
 ...
 alignl ' align long
 long I32_BR_B + (@C_fclose_8)<<S32 ' LTI4 reg coni
 alignl ' align long
C_fclose_10
 word I16A_CMPSI + (r21)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_fclose_14)<<S32 ' LTI4 reg coni
 word I16A_NEGI + (r19)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 alignl ' align long
 long I32_JMPA + (@C_fclose_16)<<S32 ' JUMPV addrg
 alignl ' align long
C_fclose_14
 ...
 alignl ' align long
 long I32_BR_Z + (@C_fclose_17)<<S32 ' EQI4 reg coni
 word I16A_NEGI + (r19)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 alignl ' align long
C_fclose_17
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_fclose_19)<<S32 ' EQI4 reg coni
 word I16A_NEGI + (r19)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 alignl ' align long
C_fclose_19
 ...
 alignl ' align long
 long I32_BR_Z + (@C_fclose_21)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_fclose_21)<<S32 ' EQU4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 ...
 alignl ' align long
 long I32_BRNZ + (@C_fclose_23)<<S32 ' NEU4 reg reg
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_LODA + (@C___ioused)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
 long I32_JMPA + (@C_fclose_24)<<S32 ' JUMPV addrg
 alignl ' align long
C_fclose_23
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 alignl ' align long
 long I32_BR_B + (@C_fclose_25)<<S32 ' LTI4 reg coni
 alignl ' align long
C_fclose_25
 alignl ' align long
C_fclose_24
