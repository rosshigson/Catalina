...
C_fopen ' <symbol:fopen>
 ...
 alignl ' align long
 long I32_BRNZ + (@C_fopen_4)<<S32 ' NEI4 reg reg
 alignl ' align long
...
C_fopen_4
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_fopen_6)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_fopen_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_fopen_6
 alignl ' align long
 long I32_LODI + (@C___iolock)<<S32
 ...
 alignl ' align long
 long I32_JMPA + (@C_fopen_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_fopen_9
 word I16A_CMPSI + (r19)<<D16A + (7)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_fopen_14)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_fopen_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_fopen_14
...
C_fopen_12
 ...
 alignl ' align long
 long I32_BRNZ + (@C_fopen_9)<<S32 ' NEI4 reg coni
 ...
 word I16A_CMPS + (r9)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_fopen_23)<<S32 ' GTI4 reg coni
' C_fopen_22 ' (symbol refcount = 0)
 alignl ' align long
 long I32_MOVI + RI<<D32 + (97)<<S32
 word I16A_CMPS + (r9)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_fopen_21)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_fopen_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_fopen_23
 ...
 word I16A_CMPS + (r9)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_fopen_20)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_fopen_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_fopen_19
 ...
 word I16A_MOVI + (r11)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_fopen_25)<<S32 ' JUMPV addrg
 alignl ' align long
C_fopen_20
 alignl ' align long
...
C_fopen_24
 ...
 alignl ' align long
 long I32_BR_Z + (@C_fopen_31)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (43)<<S32
 word I16A_CMPS + (r8)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_fopen_26)<<S32 ' LTI4 reg coni
' C_fopen_32 ' (symbol refcount = 0)
 ...
 alignl ' align long
 long I32_JMPA + (@C_fopen_26)<<S32 ' JUMPV addrg
 alignl ' align long
C_fopen_31
...
C_fopen_25
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_fopen_24)<<S32 ' NEI4 reg coni
 alignl ' align long
C_fopen_26
 alignl ' align long
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_fopen_35)<<S32 ' NEI4 reg coni
 ...
 alignl ' align long
 long I32_BRAE + (@C_fopen_33)<<S32 ' GEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (16)<<S16A ' reg <- coni
 word I16A_AND + (r22)<<D16A + (r10)<<S16A ' BANDI/U (2)
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_fopen_33)<<S32 ' EQI4 reg coni
 alignl ' align long
C_fopen_35
 alignl ' align long
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_fopen_36)<<S32 ' LEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (1)<<S16A ' reg <- coni
 word I16A_OR + (r22)<<D16A + (r15)<<S16A ' BORI/U (2)
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_fopen_36)<<S32 ' EQI4 reg coni
...
C_fopen_33
 ...
 alignl ' align long
 long I32_BRAE + (@C_fopen_38)<<S32 ' GEI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_fopen_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_fopen_38
 ...
 alignl ' align long
 long I32_BRNZ + (@C_fopen_40)<<S32 ' NEI4 reg coni
 alignl ' align long
...
C_fopen_8
 ...
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_fopen_42)<<S32 ' EQI4 reg reg
 alignl ' align long
 long I32_LODI + (@C___iolock)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
