...
'
 ...
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005 ' <symbol:o_collect>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long @C_skn81_6174adc2_inp_buf_L000004 ' reg <- addrg
 ...
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_10)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (105)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_skn82_6174adc2_o_collect_L000005_15)<<S32 ' GTI4 reg coni
' C_skn82_6174adc2_o_collect_L000005_14 ' (symbol refcount = 0)
 alignl ' align long
 ...
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_skn82_6174adc2_o_collect_L000005_7)<<S32 ' LTI4 reg coni
' C_skn82_6174adc2_o_collect_L000005_16 ' (symbol refcount = 0)
 alignl ' align long
 long I32_MOVI + RI<<D32 + (98)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_13)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (100)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_11)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_skn82_6174adc2_o_collect_L000005_7)<<S32 ' JUMPV addrg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_15
 alignl ' align long
 long I32_MOVI + RI<<D32 + (111)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_12)<<S32 ' EQI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_skn82_6174adc2_o_collect_L000005_7)<<S32 ' LTI4 reg coni
' C_skn82_6174adc2_o_collect_L000005_17 ' (symbol refcount = 0)
 alignl ' align long
 ...
 long I32_JMPA + (@C_skn82_6174adc2_o_collect_L000005_7)<<S32 ' JUMPV addrg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_10
 word I16A_MOVI + (r13)<<D16A + (16)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_skn82_6174adc2_o_collect_L000005_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_11
 word I16A_MOVI + (r13)<<D16A + (10)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_skn82_6174adc2_o_collect_L000005_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_12
 word I16A_MOVI + (r13)<<D16A + (8)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_skn82_6174adc2_o_collect_L000005_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_13
 word I16A_MOVI + (r13)<<D16A + (2)<<S16A ' reg <- coni
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_7
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_8
 ...
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_20)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (43)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_18)<<S32 ' NEI4 reg coni
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_20
 ...
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_21)<<S32 ' EQI4 reg coni
 ...
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_21
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_18
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_23)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_23)<<S32 ' NEI4 reg coni
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_25)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_getc)<<S32 ' CALL addrg
 ...
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_25
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 long I32_MOVI + RI<<D32 + (120)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_27)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (88)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_38)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r13)<<D16A + (8)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_skn82_6174adc2_o_collect_L000005_38)<<S32 ' JUMPV addrg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_27
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_38)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r15)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDP4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 ...
 long I32_JMPA + (@C_skn82_6174adc2_o_collect_L000005_38)<<S32 ' JUMPV addrg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_23
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 long I32_MOVI + RI<<D32 + (105)<<S32
 ...
 long I32_JMPA + (@C_skn82_6174adc2_o_collect_L000005_38)<<S32 ' JUMPV addrg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_37
 word I16A_CMPSI + (r13)<<D16A + (10)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_44)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_skn82_6174adc2_o_collect_L000005_47)<<S32 ' LTU4 reg coni
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_44
 word I16A_CMPSI + (r13)<<D16A + (16)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_46)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_47)<<S32 ' NEI4 reg coni
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_46
 word I16A_CMPSI + (r13)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_49)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((48)&$7FFFF)<<S32 ' reg <- cons
 ...
 alignl ' align long
 long I32_BRAE + (@C_skn82_6174adc2_o_collect_L000005_49)<<S32 ' GEU4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (56)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_skn82_6174adc2_o_collect_L000005_47)<<S32 ' LTI4 reg coni
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_49
 word I16A_CMPSI + (r13)<<D16A + (2)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_39)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 long I32_LODS + (r20)<<D32S + ((48)&$7FFFF)<<S32 ' reg <- cons
 ...
 word I16A_CMPI + (r20)<<D16A + (10)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_skn82_6174adc2_o_collect_L000005_39)<<S32 ' GEU4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (50)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRAE + (@C_skn82_6174adc2_o_collect_L000005_39)<<S32 ' GEI4 reg coni
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_47
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r15)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDP4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_41)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_getc)<<S32 ' CALL addrg
 ...
 word I16A_WRLONG + (r0)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_41
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_38
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_37)<<S32 ' NEI4 reg coni
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_39
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_52)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_NEGI + (r20)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16A_CMPS + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_skn82_6174adc2_o_collect_L000005_52)<<S32 ' EQI4 reg reg
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16B_LODF + ((8)&$1FF)<<S16B
 ...
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_52
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 long I32_MOVI + RI<<D32 + (105)<<S32
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_skn82_6174adc2_o_collect_L000005_54)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r13)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_skn82_6174adc2_o_collect_L000005_54
...
' C_skn82_6174adc2_o_collect_L000005_6 ' (symbol refcount = 0)
...
C__doscan_133
 ...
 alignl ' align long
 long I32_CALA + (@C_skn82_6174adc2_o_collect_L000005)<<S32
...
C__doscan_143
 ...
 alignl ' align long
 long @C_skn81_6174adc2_inp_buf_L000004 ' reg ARG ADDRG
...
C__doscan_196
 ...
 alignl ' align long
 long @C_skn8_6174adc2_X_table_L000003 ' reg <- addrg
 alignl ' align long
...
C__doscan_200
 ...
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_skn8_6174adc2_X_table_L000003+256 ' reg <- addrg
...
C__doscan_209
 word I16A_MOVI + (r22)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_LODA + (@C_skn8_6174adc2_X_table_L000003+45)<<S32
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_skn81_6174adc2_inp_buf_L000004 ' <symbol:inp_buf>
 byte 0[512]

 alignl ' align long
C_skn8_6174adc2_X_table_L000003 ' <symbol:Xtable>
 byte 0[256]
