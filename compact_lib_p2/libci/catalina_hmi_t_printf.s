...
C_t_vprintf_10
 ...
 word I16A_MOV + (r20)<<D16A + (r19)<<S16A ' CVUI
...
C_t_vprintf_20
 ...
 alignl ' align long
 long I32_BR_Z + (@C_t_vprintf_29)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (100)<<S32
 word I16A_CMPS + (r13)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_t_vprintf_31)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (100)<<S32
 word I16A_CMPS + (r13)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_t_vprintf_36)<<S32 ' GTI4 reg coni
...
C_t_vprintf_36
 ...
 word I16A_CMPS + (r13)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_t_vprintf_33)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_t_vprintf_26)<<S32 ' JUMPV addrg
 alignl ' align long
C_t_vprintf_29
...
C_t_vprintf_6
 ...
 alignl ' align long
 long I32_BR_Z + (@C_t_vprintf_37)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + (r3)<<D16A + (1)<<S16A ' reg ARG coni
