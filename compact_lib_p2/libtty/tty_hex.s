...
C_tty_hex ' <symbol:tty_hex>
 ...
 alignl ' align long
 long I32_BRAE + (@C_tty_hex_2)<<S32 ' GEI4 reg coni
 word I16A_MOVI + (r21)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
C_tty_hex_2
 word I16A_CMPSI + (r21)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_tty_hex_4)<<S32 ' LEI4 reg coni
...
C_tty_hex_4
 ...
 alignl ' align long
 long I32_JMPA + (@C_tty_hex_9)<<S32 ' JUMPV addrg
 alignl ' align long
C_tty_hex_6
 ...
 alignl ' align long
 long I32_BRBE + (@C_tty_hex_10)<<S32 ' LEI4 reg coni
...
C_tty_hex_9
 ...
 alignl ' align long
 long I32_BR_B + (@C_tty_hex_6)<<S32 ' LTI4 reg reg
