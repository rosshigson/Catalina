...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sgus_6132d19e_s8base_L000002 ' <symbol:s8base>
 long $0

 alignl ' align long
C_sgus1_6132d19e_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_sgus3_6132d19e_pinclear_L000005 ' <symbol:pinclear>
 alignl ' align long
...
' C_sgus3_6132d19e_pinclear_L000005_6 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_sgus4_6132d19e_pinstart_L000007 ' <symbol:pinstart>
 alignl ' align long
...
' C_sgus4_6132d19e_pinstart_L000007_8 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_sgus5_6132d19e_pinconfig_L000009 ' <symbol:pinconfig>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sgus5_6132d19e_pinconfig_L000009_11)<<S32 ' NEI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sgus5_6132d19e_pinconfig_L000009_12)<<S32 ' EQU4 reg coni
 word I16B_LODF + ((-4)&$1FF)<<S16B
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sgus5_6132d19e_pinconfig_L000009_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_sgus5_6132d19e_pinconfig_L000009_11
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_sgus5_6132d19e_pinconfig_L000009_15)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r13)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sgus5_6132d19e_pinconfig_L000009_15)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r13)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sgus5_6132d19e_pinconfig_L000009_22_L000024 ' reg <- addrg
...
DAT ' const data segment
 ...
 alignl ' align long
C_sgus5_6132d19e_pinconfig_L000009_22_L000024 ' <symbol:22>
 long @C_sgus5_6132d19e_pinconfig_L000009_16
 long @C_sgus5_6132d19e_pinconfig_L000009_19
 long @C_sgus5_6132d19e_pinconfig_L000009_20
 long @C_sgus5_6132d19e_pinconfig_L000009_21

' Catalina Code

DAT ' code segment
 alignl ' align long
C_sgus5_6132d19e_pinconfig_L000009_19
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sgus5_6132d19e_pinconfig_L000009_16)<<S32 ' JUMPV addrg
 alignl ' align long
C_sgus5_6132d19e_pinconfig_L000009_20
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 long I32_JMPA + (@C_sgus5_6132d19e_pinconfig_L000009_16)<<S32 ' JUMPV addrg
 alignl ' align long
C_sgus5_6132d19e_pinconfig_L000009_21
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
C_sgus5_6132d19e_pinconfig_L000009_15
 alignl ' align long
C_sgus5_6132d19e_pinconfig_L000009_16
 alignl ' align long
C_sgus5_6132d19e_pinconfig_L000009_12
 alignl ' align long
 ...
 alignl ' align long
 long I32_CALA + (@C_sgus4_6132d19e_pinstart_L000007)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
' C_sgus5_6132d19e_pinconfig_L000009_10 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sgus8_6132d19e_p_config_L000025 ' <symbol:p_config>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODI + (@C_sgus_6132d19e_s8base_L000002)<<S32
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_sgus8_6132d19e_p_config_L000025_26 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_sgus9_6132d19e_autoinitialize_L000027 ' <symbol:autoinitialize>
 alignl ' align long
 long I32_PSHM + $fea800<<S32 ' save registers
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_sgus2_6132d19e_txrxbuff_L000004 ' reg <- addrg
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sgus9_6132d19e_autoinitialize_L000027_29)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sgus9_6132d19e_autoinitialize_L000027_31
 ...
 alignl ' align long
 long I32_BR_B + (@C_sgus9_6132d19e_autoinitialize_L000027_35)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (63)<<S32
 word I16A_CMPS + (r23)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sgus9_6132d19e_autoinitialize_L000027_35)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_SHLI + (r22)<<D16A + (4)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_sgus_6132d19e_s8base_L000002)<<S32
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_sgus5_6132d19e_pinconfig_L000009)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 alignl ' align long
 ...
 alignl ' align long
 long I32_CALA + (@C_sgus8_6132d19e_p_config_L000025)<<S32
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 alignl ' align long
C_sgus9_6132d19e_autoinitialize_L000027_35
 ...
 word I16A_CMPSI + (r23)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sgus9_6132d19e_autoinitialize_L000027_37)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (63)<<S32
 word I16A_CMPS + (r23)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sgus9_6132d19e_autoinitialize_L000027_37)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_SHLI + (r22)<<D16A + (4)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_sgus_6132d19e_s8base_L000002)<<S32
 ...
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 alignl ' align long
C_sgus9_6132d19e_autoinitialize_L000027_37
 alignl ' align long
 long I32_MOVI + (r22)<<D32 +(128)<<S32 ' reg <- conli
 word I16A_ADD + (r19)<<D16A + (r22)<<S16A ' ADDU (1)
 word I16A_ADD + (r17)<<D16A + (r22)<<S16A ' ADDU (1)
' C_sgus9_6132d19e_autoinitialize_L000027_32 ' (symbol refcount = 0)
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_CMPSI + (r15)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sgus9_6132d19e_autoinitialize_L000027_31)<<S32 ' LTI4 reg coni
 alignl ' align long
C_sgus9_6132d19e_autoinitialize_L000027_29
' C_sgus9_6132d19e_autoinitialize_L000027_28 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_sgusa_6132d19e_initialize_L000039 ' <symbol:initialize>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sgusa_6132d19e_initialize_L000039_41)<<S32 ' NEU4 reg coni
 ...
 alignl ' align long
 long I32_BR_B + (@C_sgusa_6132d19e_initialize_L000039_43)<<S32 ' LTI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODA + (@C_sgus_6132d19e_s8base_L000002)<<S32
 word I16A_WRLONG + (r20)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sgus1_6132d19e_lock_L000003 ' reg <- addrg
 word I16A_SHRI + (r22)<<D16A + (24)<<S16A ' SHRU4 reg coni
 alignl ' align long
 long I32_LODA + (@C_sgus1_6132d19e_lock_L000003)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16A_RDLONG + (r22)<<D16A + (r20)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sgusa_6132d19e_initialize_L000039_45)<<S32 ' NEI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODI + (@C_sgus1_6132d19e_lock_L000003)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sgusa_6132d19e_initialize_L000039_46)<<S32 ' LTI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 alignl ' align long
 long I32_LODI + (@C_sgus1_6132d19e_lock_L000003)<<S32
 ...
 alignl ' align long
 long I32_JMPA + (@C_sgusa_6132d19e_initialize_L000039_46)<<S32 ' JUMPV addrg
 alignl ' align long
C_sgusa_6132d19e_initialize_L000039_45
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_sgus1_6132d19e_lock_L000003 ' reg <- addrg
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
C_sgusa_6132d19e_initialize_L000039_46
 alignl ' align long
 long I32_CALA + (@C_sgus9_6132d19e_autoinitialize_L000027)<<S32 ' CALL addrg
 alignl ' align long
C_sgusa_6132d19e_initialize_L000039_43
 alignl ' align long
C_sgusa_6132d19e_initialize_L000039_41
' C_sgusa_6132d19e_initialize_L000039_40 ' (symbol refcount = 0)
...
C_s8_closeport ' <symbol:s8_closeport>
 ...
 alignl ' align long
 long I32_CALA + (@C_sgusa_6132d19e_initialize_L000039)<<S32 ' CALL addrg
 alignl ' align long
C_s8_closeport_50
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sgus3_6132d19e_pinclear_L000005)<<S32 ' CALL addrg
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 alignl ' align long
 long I32_LODI + (@C_sgus_6132d19e_s8base_L000002)<<S32
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_sgus2_6132d19e_txrxbuff_L000004 ' <symbol:txrxbuff>
 byte 0[1024]
