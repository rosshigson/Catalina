...
'       CMM kernel, and in catalina_threads.h !!! (P1 only)
...
:fc_code_start
        ...
        add     t1, #32*4        ' point to flag save area
#else
...
:save   wrlong  0-0, t1
        ...
        add     t2, #4           ' point to the thread register save area
#ifdef P2
        setq    #32-1           ' load 32 registers ...
        rdlong  r0, t2           ' ... from register save area
        add     t2, #32*4        ' point to flag save area
#else
