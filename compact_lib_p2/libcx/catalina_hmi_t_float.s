...
C_itoa ' <symbol:itoa>
 ...
 alignl ' align long
 long @C_sk78_6132d1bd_itoa_buf_L000001+12-1 ' reg <- addrg
...
' C_itoa_2 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_sk781_6132d1bd_N_anO_rI_nf_L000012 ' <symbol:NanOrInf>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sk781_6132d1bd_N_anO_rI_nf_L000012_14)<<S32 ' NEU4 reg reg
 word I16B_LODF + ((-4)&$1FF)<<S16B
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sk781_6132d1bd_N_anO_rI_nf_L000012_16)<<S32 ' NEU4 reg coni
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sk781_6132d1bd_N_anO_rI_nf_L000012_18)<<S32 ' EQU4 reg coni
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sk781_6132d1bd_N_anO_rI_nf_L000012_18
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_sk781_6132d1bd_N_anO_rI_nf_L000012_20_L000021 ' reg ARG ADDRG
 ...
 alignl ' align long
 long I32_JMPA + (@C_sk781_6132d1bd_N_anO_rI_nf_L000012_13)<<S32 ' JUMPV addrg
 alignl ' align long
C_sk781_6132d1bd_N_anO_rI_nf_L000012_16
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sk781_6132d1bd_N_anO_rI_nf_L000012_22)<<S32 ' EQU4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r21)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r21)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sk781_6132d1bd_N_anO_rI_nf_L000012_22
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C_sk781_6132d1bd_N_anO_rI_nf_L000012_24_L000025 ' reg ARG ADDRG
 word I16A_MOV + (r3)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_strcpy)<<S32
 ...
 long I32_JMPA + (@C_sk781_6132d1bd_N_anO_rI_nf_L000012_13)<<S32 ' JUMPV addrg
 alignl ' align long
C_sk781_6132d1bd_N_anO_rI_nf_L000012_14
 word I16B_LODL + R0<<D16B
 alignl ' align long
 long 0 ' RET con
 alignl ' align long
C_sk781_6132d1bd_N_anO_rI_nf_L000012_13
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long
...
C_t_float_27
 ...
 word I16B_CPREP + 33<<S16B ' arg size, rpsize = 8, spsize = 8
 alignl ' align long
 long I32_CALA + (@C_sk781_6132d1bd_N_anO_rI_nf_L000012)<<S32
 word I16A_ADDI + SP<<D16A + 4<<S16A ' CALL addrg
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_sk78_6132d1bd_itoa_buf_L000001 ' <symbol:itoa_buf>
 byte 0[12]
...
C_t_float_33_L000034 ' <symbol:33>
 ...
 alignl ' align long
C_sk781_6132d1bd_N_anO_rI_nf_L000012_24_L000025 ' <symbol:24>
 byte 110
 byte 97
 byte 110
 byte 0
 ...
 alignl ' align long
C_sk781_6132d1bd_N_anO_rI_nf_L000012_20_L000021 ' <symbol:20>
 byte 105
 byte 110
 byte 102
 byte 0
