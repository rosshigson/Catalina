...
C_D_F_S__O_penD_ir_31
 ...
 word I16A_CMPI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_D_F_S__O_penD_ir_44)<<S32 ' EQU4 reg coni
 word I16A_NEGI + (r0)<<D16A + (-($ffffffff)&$1F)<<S16A ' reg <- conn
 alignl ' align long
 long I32_JMPA + (@C_D_F_S__O_penD_ir_4)<<S32 ' JUMPV addrg
 alignl ' align long
...
C_D_F_S__O_penD_ir_44
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_D_F_S__O_penD_ir_46)<<S32 ' EQI4 reg coni
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__O_penD_ir_43)<<S32 ' NEI4 reg coni
 alignl ' align long
C_D_F_S__O_penD_ir_46
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__O_penD_ir_47)<<S32 ' NEI4 reg coni
 word I16A_ADDSI + (r17)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
...
C_D_F_S__O_penD_ir_21
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__O_penD_ir_49)<<S32 ' NEU4 reg coni
 word I16A_MOVI + R0<<D16A + (3)<<S16A ' RET coni
 alignl ' align long
 long I32_JMPA + (@C_D_F_S__O_penD_ir_4)<<S32 ' JUMPV addrg
 alignl ' align long
