...
C_g_tri ' <symbol:g_tri>
 ...
 alignl ' align long
 long I32_PSHM + $fffc00<<S32 ' save registers
...
C_g_tri_3
 ...
 word I16A_MOV + (r18)<<D16A + (r20)<<S16A ' SUBI/P
 word I16A_SUBS + (r18)<<D16A + (r17)<<S16A ' SUBI/P (3)
 word I16A_MOV + (r16)<<D16A + (r19)<<S16A ' SUBI/P
 word I16A_SUBS + (r16)<<D16A + (r22)<<S16A ' SUBI/P (3)
 word I16A_SHLI + (r16)<<D16A + (16)<<S16A ' SHLI4 reg coni
 word I16A_MOV + (r14)<<D16A + (r18)<<S16A
 ...
 word I16A_MOV + (r14)<<D16A + (r20)<<S16A ' SUBI/P
 word I16A_SUBS + (r14)<<D16A + (r21)<<S16A ' SUBI/P (3)
 word I16A_MOV + (r12)<<D16A + (r23)<<S16A ' SUBI/P
 word I16A_SUBS + (r12)<<D16A + (r22)<<S16A ' SUBI/P (3)
 word I16A_SHLI + (r12)<<D16A + (16)<<S16A ' SHLI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r14)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_MOV + (r0)<<D16A + (r12)<<S16A ' setup r0/r1 (2)
 word I16A_MOV + (r1)<<D16A + (r22)<<S16A ' setup r0/r1 (2)
 word I16B_DIVS ' DIVI
 word I16A_MOV + (r22)<<D16A + (r0)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r12)<<D16A + (r19)<<S16A ' SUBI/P
 word I16A_SUBS + (r12)<<D16A + (r23)<<S16A ' SUBI/P (3)
 word I16A_SHLI + (r12)<<D16A + (16)<<S16A ' SHLI4 reg coni
 ...
 word I16A_MOV + (r3)<<D16A + (r14)<<S16A ' CVI, CVU or LOAD
