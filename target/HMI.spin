...
'
#ifdef SUPPORT_MORPHEUS_HIRES_VGA
...
#ifdef CATALYST
'
' For Catalyst, we use the 660 longs prior to the service table
' as our HMI buffer (the extra 20 is for the Spin object pointer 
' table). It is the caller's responsibility to ensure that this
' space is no longer being used before setting up and starting
' this HMI plugin.
'
