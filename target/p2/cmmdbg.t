...
'-------------------------------------------------------------------------------
'
' CMM_blackcat - CMM target for Catalina programs with BlackCat or BlackBox
'                debugging. 
'
...
' Quick Hub Loader is used for both SCARD and Serial Load for CMM programs 
...
' !!! sbrkinit should not be here, it should be in cmm_progend.t, but it 
