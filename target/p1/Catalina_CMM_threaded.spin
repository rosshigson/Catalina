...
wait
   ...
   if_z  jmp     #wait          '$58 6 .. (required to relocate segments)
         ...
         sub     SP,#(Common#THREAD_BLOCK_SIZE-Common#THREAD_AFF_OFF)*4 '$64 18 top of stack will be first thread block
         cogid   t1             '$65 19 set up ...
         shl     t1,#8          '$66 20 ... affinity, flags ...
         wrlong  t1,SP          '$67 21 ... and set ticks to zero
         sub     SP,#Common#THREAD_AFF_OFF*4 '$68 22 point to begining of thread block
...
I32_PSHF     
         ...
         adds   t2,FP
                                ' fall through to ...
I32_PSHA  
         rdlong t1,t2           ' read long from address s
         jmp    #I32_PSHt1      ' write it to stack
I32_PSHM     
