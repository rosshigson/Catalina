...
DAT ' initialized data segment
 ...
 alignl ' align long
C_s9qc_6174ad7a_s8base_L000002 ' <symbol:s8base>
 long $0

 alignl ' align long
C_s9qc1_6174ad7a_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_s9qc3_6174ad7a_pinconfig_L000005 ' <symbol:pinconfig>
 alignl ' align long
 long I32_NEWF + 4<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_s9qc3_6174ad7a_pinconfig_L000005_7)<<S32 ' NEI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_s9qc3_6174ad7a_pinconfig_L000005_8)<<S32 ' EQU4 reg coni
 word I16B_LODF + ((-4)&$1FF)<<S16B
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_s9qc3_6174ad7a_pinconfig_L000005_8)<<S32 ' JUMPV addrg
 alignl ' align long
C_s9qc3_6174ad7a_pinconfig_L000005_7
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_s9qc3_6174ad7a_pinconfig_L000005_11)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r13)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s9qc3_6174ad7a_pinconfig_L000005_11)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r13)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLI4 reg coni
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_s9qc3_6174ad7a_pinconfig_L000005_18_L000020 ' reg <- addrg
...
DAT ' const data segment
 ...
 alignl ' align long
C_s9qc3_6174ad7a_pinconfig_L000005_18_L000020 ' <symbol:18>
 long @C_s9qc3_6174ad7a_pinconfig_L000005_12
 long @C_s9qc3_6174ad7a_pinconfig_L000005_15
 long @C_s9qc3_6174ad7a_pinconfig_L000005_16
 long @C_s9qc3_6174ad7a_pinconfig_L000005_17

' Catalina Code

DAT ' code segment
 alignl ' align long
C_s9qc3_6174ad7a_pinconfig_L000005_15
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_s9qc3_6174ad7a_pinconfig_L000005_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_s9qc3_6174ad7a_pinconfig_L000005_16
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 long I32_JMPA + (@C_s9qc3_6174ad7a_pinconfig_L000005_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_s9qc3_6174ad7a_pinconfig_L000005_17
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
C_s9qc3_6174ad7a_pinconfig_L000005_11
 alignl ' align long
C_s9qc3_6174ad7a_pinconfig_L000005_12
 alignl ' align long
C_s9qc3_6174ad7a_pinconfig_L000005_8
 alignl ' align long
...
' C_s9qc3_6174ad7a_pinconfig_L000005_6 ' (symbol refcount = 0)
 word I16B_POPM + 1<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s9qc6_6174ad7a_p_config_L000021 ' <symbol:p_config>
 alignl ' align long
 long I32_NEWF + 0<<S32
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODI + (@C_s9qc_6174ad7a_s8base_L000002)<<S32
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
' C_s9qc6_6174ad7a_p_config_L000021_22 ' (symbol refcount = 0)
 word I16B_POPM + 0<<S16B ' restore registers, do pop frame, do return
 alignl ' align long

 alignl ' align long
C_s9qc7_6174ad7a_autoinitialize_L000023 ' <symbol:autoinitialize>
 alignl ' align long
 long I32_PSHM + $fea800<<S32 ' save registers
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_s9qc2_6174ad7a_txrxbuff_L000004 ' reg <- addrg
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s9qc7_6174ad7a_autoinitialize_L000023_25)<<S32 ' EQU4 reg coni
 word I16A_MOVI + (r15)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_s9qc7_6174ad7a_autoinitialize_L000023_27
 ...
 alignl ' align long
 long I32_BR_B + (@C_s9qc7_6174ad7a_autoinitialize_L000023_31)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (63)<<S32
 word I16A_CMPS + (r23)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s9qc7_6174ad7a_autoinitialize_L000023_31)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_SHLI + (r22)<<D16A + (4)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_s9qc_6174ad7a_s8base_L000002)<<S32
 ...
 word I16B_CPREP + 67<<S16B ' arg size, rpsize = 16, spsize = 16
 alignl ' align long
 long I32_CALA + (@C_s9qc3_6174ad7a_pinconfig_L000005)<<S32
 word I16A_ADDI + SP<<D16A + 12<<S16A ' CALL addrg
 alignl ' align long
 ...
 alignl ' align long
 long I32_CALA + (@C_s9qc6_6174ad7a_p_config_L000021)<<S32
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 alignl ' align long
C_s9qc7_6174ad7a_autoinitialize_L000023_31
 ...
 word I16A_CMPSI + (r23)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s9qc7_6174ad7a_autoinitialize_L000023_33)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (63)<<S32
 word I16A_CMPS + (r23)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_s9qc7_6174ad7a_autoinitialize_L000023_33)<<S32 ' GTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A
 word I16A_SHLI + (r22)<<D16A + (4)<<S16A ' SHLI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_s9qc_6174ad7a_s8base_L000002)<<S32
 ...
 word I16A_ADDI + SP<<D16A + 20<<S16A ' CALL addrg
 alignl ' align long
C_s9qc7_6174ad7a_autoinitialize_L000023_33
 alignl ' align long
 long I32_MOVI + (r22)<<D32 +(128)<<S32 ' reg <- conli
 word I16A_ADD + (r19)<<D16A + (r22)<<S16A ' ADDU (1)
 word I16A_ADD + (r17)<<D16A + (r22)<<S16A ' ADDU (1)
' C_s9qc7_6174ad7a_autoinitialize_L000023_28 ' (symbol refcount = 0)
 word I16A_ADDSI + (r15)<<D16A + (1)<<S16A ' ADDI4 reg coni
 word I16A_CMPSI + (r15)<<D16A + (8)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s9qc7_6174ad7a_autoinitialize_L000023_27)<<S32 ' LTI4 reg coni
 alignl ' align long
C_s9qc7_6174ad7a_autoinitialize_L000023_25
' C_s9qc7_6174ad7a_autoinitialize_L000023_24 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_s9qc8_6174ad7a_initialize_L000035 ' <symbol:initialize>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s9qc8_6174ad7a_initialize_L000035_37)<<S32 ' NEU4 reg coni
 ...
 alignl ' align long
 long I32_BR_B + (@C_s9qc8_6174ad7a_initialize_L000035_39)<<S32 ' LTI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODA + (@C_s9qc_6174ad7a_s8base_L000002)<<S32
 word I16A_WRLONG + (r20)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_s9qc1_6174ad7a_lock_L000003 ' reg <- addrg
 word I16A_SHRI + (r22)<<D16A + (24)<<S16A ' SHRU4 reg coni
 alignl ' align long
 long I32_LODA + (@C_s9qc1_6174ad7a_lock_L000003)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16A_RDLONG + (r22)<<D16A + (r20)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s9qc8_6174ad7a_initialize_L000035_41)<<S32 ' NEI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODI + (@C_s9qc1_6174ad7a_lock_L000003)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s9qc8_6174ad7a_initialize_L000035_42)<<S32 ' LTI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 alignl ' align long
 long I32_LODI + (@C_s9qc1_6174ad7a_lock_L000003)<<S32
 ...
 alignl ' align long
 long I32_JMPA + (@C_s9qc8_6174ad7a_initialize_L000035_42)<<S32 ' JUMPV addrg
 alignl ' align long
C_s9qc8_6174ad7a_initialize_L000035_41
 word I16B_LODL + (r22)<<D16B
 alignl ' align long
 long @C_s9qc1_6174ad7a_lock_L000003 ' reg <- addrg
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
C_s9qc8_6174ad7a_initialize_L000035_42
 alignl ' align long
 long I32_CALA + (@C_s9qc7_6174ad7a_autoinitialize_L000023)<<S32 ' CALL addrg
 alignl ' align long
C_s9qc8_6174ad7a_initialize_L000035_39
 alignl ' align long
C_s9qc8_6174ad7a_initialize_L000035_37
' C_s9qc8_6174ad7a_initialize_L000035_36 ' (symbol refcount = 0)
...
C_s8_closeport ' <symbol:s8_closeport>
 ...
 alignl ' align long
 long I32_CALA + (@C_s9qc8_6174ad7a_initialize_L000035)<<S32 ' CALL addrg
 alignl ' align long
C_s8_closeport_46
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_s9qc2_6174ad7a_txrxbuff_L000004 ' <symbol:txrxbuff>
 byte 0[1024]
