...
C_D_F_S__U_nlinkF_ile_15
 ...
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__U_nlinkF_ile_24)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-16)&$1FF)<<S16B
 ...
 alignl ' align long
 long I32_BRAE + (@C_D_F_S__U_nlinkF_ile_25)<<S32 ' GEU4 reg reg
 alignl ' align long
C_D_F_S__U_nlinkF_ile_24
 ...
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__U_nlinkF_ile_26)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-16)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
...
C_D_F_S__U_nlinkF_ile_26
 ...
 alignl ' align long
 long I32_BRNZ + (@C_D_F_S__U_nlinkF_ile_14)<<S32 ' NEI4 reg coni
 word I16B_LODF + ((-16)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 ...
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_D_F_S__U_nlinkF_ile_14)<<S32 ' LTU4 reg reg
 alignl ' align long
