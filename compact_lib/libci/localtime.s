...
C_localtime ' <symbol:localtime>
 ...
 word I16A_MOV + (r22)<<D16A + (r18)<<S16A ' SUBI/P
 word I16A_SUBS + (r22)<<D16A + (r0)<<S16A ' SUBI/P (3)
 ...
 word I16A_MOV + (r22)<<D16A + (r20)<<S16A ' SUBI/P
 word I16A_SUBS + (r22)<<D16A + (r1)<<S16A ' SUBI/P (3)
 ...
 word I16A_ADD + (r22)<<D16A + (r1)<<S16A ' ADDU (3)
 word I16A_WRLONG + (r22)<<D16A + (r21)<<S16A ' ASGNI4 reg reg
 word I16A_MOV + (r2)<<D16A + (r21)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
