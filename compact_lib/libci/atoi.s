...
C_atoi ' <symbol:atoi>
 ...
 alignl ' align long
 long I32_JMPA + (@C_atoi_3)<<S32 ' JUMPV addrg
 alignl ' align long
C_atoi_2
...
C_atoi_3
 ...
 alignl ' align long
 long I32_BRNZ + (@C_atoi_2)<<S32 ' NEI4 reg coni
 word I16A_RDBYTE + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_atoi_6)<<S32 ' NEI4 reg coni
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_atoi_11)<<S32 ' JUMPV addrg
 alignl ' align long
C_atoi_6
 word I16A_RDBYTE + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_atoi_11)<<S32 ' NEI4 reg coni
...
C_atoi_11
 ...
 alignl ' align long
 long I32_BR_B + (@C_atoi_10)<<S32 ' LTU4 reg coni
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_atoi_14)<<S32 ' EQI4 reg coni
 word I16A_NEG + (r19)<<D16A + (r21)<<S16A ' NEGI4
 alignl ' align long
 long I32_JMPA + (@C_atoi_15)<<S32 ' JUMPV addrg
 alignl ' align long
C_atoi_14
