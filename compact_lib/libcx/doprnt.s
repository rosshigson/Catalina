...
'
 ...
 alignl ' align long
C_sjik_6174ad95_gnum_L000001 ' <symbol:gnum>
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjik_6174ad95_gnum_L000001_3)<<S32 ' NEI4 reg coni
 ...
 alignl ' align long
 long I32_JMPA + (@C_sjik_6174ad95_gnum_L000001_4)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik_6174ad95_gnum_L000001_3
 word I16A_MOVI + (r17)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjik_6174ad95_gnum_L000001_6)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik_6174ad95_gnum_L000001_5
 ...
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
C_sjik_6174ad95_gnum_L000001_6
 word I16A_RDBYTE + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRU1 reg
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_sjik_6174ad95_gnum_L000001_8)<<S32 ' LTI4 reg coni
 word I16A_CMPSI + (r15)<<D16A + (9)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_sjik_6174ad95_gnum_L000001_5)<<S32 ' LEI4 reg coni
 alignl ' align long
C_sjik_6174ad95_gnum_L000001_8
 word I16A_WRLONG + (r17)<<D16A + (r21)<<S16A ' ASGNI4 reg reg
 alignl ' align long
C_sjik_6174ad95_gnum_L000001_4
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sjik_6174ad95_gnum_L000001_2 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjik1_6174ad95_o_print_L000009 ' <symbol:o_print>
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_14)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (32)<<S32
 word I16A_CMPS + (r13)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjik1_6174ad95_o_print_L000009_11)<<S32 ' LTI4 reg coni
' C_sjik1_6174ad95_o_print_L000009_22 ' (symbol refcount = 0)
 alignl ' align long
 long I32_MOVI + RI<<D32 + (64)<<S32
 word I16A_CMPS + (r13)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_17)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_11)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_14
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_15)<<S32 ' EQI4 reg coni
 ...
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_15
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDSI + (r20)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_17
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_18)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDSI + (r20)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_18
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDSI + (r20)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_11
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_20)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDSI + (r20)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_20
 word I16B_LODF + ((8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrl16
 word I16A_RDLONG + (r20)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 word I16A_ADDSI + (r20)<<D16A + (4)<<S16A ' ADDP4 reg coni
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_12
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_23)<<S32 ' EQI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRAE + (@C_sjik1_6174ad95_o_print_L000009_25)<<S32 ' GEI4 reg coni
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_26)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_25
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_27)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r23)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_28)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_27
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_29)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r23)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_29
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_28
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_26
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNU4 addrl16 reg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_23
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_31)<<S32 ' EQI4 reg coni
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjik1_6174ad95_o_print_L000009_31)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r23)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
 ...
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_31
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjik1_6174ad95_o_print_L000009_33)<<S32 ' NEU4 reg coni
 word I16A_CMPSI + (r19)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjik1_6174ad95_o_print_L000009_34)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_10)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_33
 word I16B_LODF + ((12)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrl16
 word I16A_MOVI + (r20)<<D16A + (8)<<S16A ' reg <- coni
 word I16A_AND + (r22)<<D16A + (r20)<<S16A ' BANDI/U (1)
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_40)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_39)<<S32 ' EQI4 reg coni
 alignl ' align long
 ...
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_39)<<S32 ' EQI4 reg coni
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_40
 word I16A_MOV + (r22)<<D16A + (r21)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjik1_6174ad95_o_print_L000009_37)<<S32 ' NEI4 reg coni
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_39
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r23)<<D16A + (r22)<<S16A
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjik1_6174ad95_o_print_L000009_42)<<S32 ' NEI4 reg coni
 alignl ' align long
 long I32_LODS + (r11)<<D32S + ((88)&$7FFFF)<<S32 ' reg <- cons
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_43)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_42
 alignl ' align long
 long I32_LODS + (r11)<<D32S + ((120)&$7FFFF)<<S32 ' reg <- cons
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_43
 word I16A_MOV + (r20)<<D16A + (r11)<<S16A ' CVI, CVU or LOAD
 word I16A_WRBYTE + (r20)<<D16A + (r22)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_37
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_34
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_49)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (105)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_A + (@C_sjik1_6174ad95_o_print_L000009_52)<<S32 ' GTI4 reg coni
' C_sjik1_6174ad95_o_print_L000009_51 ' (symbol refcount = 0)
 alignl ' align long
 long I32_MOVI + RI<<D32 + (88)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_50)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (88)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sjik1_6174ad95_o_print_L000009_44)<<S32 ' LTI4 reg coni
' C_sjik1_6174ad95_o_print_L000009_53 ' (symbol refcount = 0)
 alignl ' align long
 long I32_MOVI + RI<<D32 + (98)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_47)<<S32 ' EQI4 reg coni
 alignl ' align long
 ...
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_49)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_44)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_52
 alignl ' align long
 long I32_MOVI + RI<<D32 + (111)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjik1_6174ad95_o_print_L000009_48)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_MOVI + RI<<D32 + (112)<<S32
 word I16A_CMPS + (r11)<<D16A + RI<<S16A
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_sjik1_6174ad95_o_print_L000009_44)<<S32 ' LTI4 reg coni
' C_sjik1_6174ad95_o_print_L000009_54 ' (symbol refcount = 0)
 alignl ' align long
 ...
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_44)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_47
 word I16A_MOVI + (r22)<<D16A + (2)<<S16A ' reg <- coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_45)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_48
 ...
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_45)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_49
 word I16A_MOVI + (r22)<<D16A + (10)<<S16A ' reg <- coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_45)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_50
 word I16A_MOVI + (r22)<<D16A + (16)<<S16A ' reg <- coni
 word I16B_LODF + ((-12)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_44
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_45
 ...
 word I16A_CMPS + (r22)<<D16A + RI<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjik1_6174ad95_o_print_L000009_55)<<S32 ' NEI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_sjik1_6174ad95_o_print_L000009_58)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_57
 ...
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_58
 word I16A_MOV + (r22)<<D16A + (r15)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r20)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_CMP + (r22)<<D16A + (r20)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjik1_6174ad95_o_print_L000009_57)<<S32 ' NEU4 reg reg
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_55
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_sjik1_6174ad95_o_print_L000009_10
...
C__doprnt_72
 ...
 alignl ' align long
 long I32_CALA + (@C_sjik_6174ad95_gnum_L000001)<<S32
...
C__doprnt_131
 ...
 alignl ' align long
 long I32_CALA + (@C_sjik1_6174ad95_o_print_L000009)<<S32
