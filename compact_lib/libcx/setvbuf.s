...
C_setvbuf ' <symbol:setvbuf>
 ...
 alignl ' align long
 long I32_BR_Z + (@C_setvbuf_4)<<S32 ' EQI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_JMPA + (@C_setvbuf_3)<<S32 ' JUMPV addrg
 alignl ' align long
C_setvbuf_4
 ...
 alignl ' align long
 long I32_BR_Z + (@C_setvbuf_6)<<S32 ' EQU4 reg coni
 ...
 alignl ' align long
 long I32_BR_Z + (@C_setvbuf_6)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
 word I16A_RDLONG + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRP4 reg
 ...
 alignl ' align long
 long I32_BR_Z + (@C_setvbuf_8)<<S32 ' EQU4 reg reg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (16)<<S16A ' ADDP4 reg coni
...
C_setvbuf_6
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_setvbuf_10)<<S32 ' EQU4 reg coni
 word I16A_CMPI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_setvbuf_10)<<S32 ' NEU4 reg coni
...
C_setvbuf_10
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_setvbuf_12)<<S32 ' NEU4 reg coni
 word I16A_CMPSI + (r19)<<D16A + (4)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_setvbuf_12)<<S32 ' EQI4 reg coni
 word I16A_CMPI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_setvbuf_16)<<S32 ' EQU4 reg coni
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_setvbuf_14)<<S32 ' NEU4 reg coni
 alignl ' align long
C_setvbuf_16
 word I16A_NEGI + (r22)<<D16A + (-(-1)&$1F)<<S16A ' reg <- conn
 word I16B_LODF + ((-4)&$1FF)<<S16B
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrl16 reg
 alignl ' align long
 long I32_JMPA + (@C_setvbuf_15)<<S32 ' JUMPV addrg
 alignl ' align long
C_setvbuf_14
 word I16A_MOVI + (r22)<<D16A + (8)<<S16A ' reg <- coni
 word I16A_MOV + (r20)<<D16A + (r23)<<S16A
...
C_setvbuf_12
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_setvbuf_17)<<S32 ' NEU4 reg coni
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
 word I16A_MOVI + (r20)<<D16A + (1)<<S16A ' reg <- coni
 word I16A_WRLONG + (r20)<<D16A + (r22)<<S16A ' ASGNI4 reg reg
 alignl ' align long
 long I32_JMPA + (@C_setvbuf_18)<<S32 ' JUMPV addrg
 alignl ' align long
C_setvbuf_17
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_ADDSI + (r22)<<D16A + (12)<<S16A ' ADDP4 reg coni
