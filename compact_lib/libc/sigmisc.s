...
'
 ...
 alignl ' align long
C_shrg_5f5d7c8c___testsigset_L000001 ' <symbol:__testsigset>
 alignl ' align long
 long I32_PSHM + $800000<<S32 ' save registers
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_CMPSI + (r23)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_shrg_5f5d7c8c___testsigset_L000001_4)<<S32 ' EQI4 reg coni
 word I16A_CMPSI + (r23)<<D16A + (1)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_shrg_5f5d7c8c___testsigset_L000001_4)<<S32 ' EQI4 reg coni
 alignl ' align long
 long I32_JMPA + (@C_shrg_5f5d7c8c___testsigset_L000001_3)<<S32 ' JUMPV addrg
 alignl ' align long
C_shrg_5f5d7c8c___testsigset_L000001_3
 alignl ' align long
C_shrg_5f5d7c8c___testsigset_L000001_4
' C_shrg_5f5d7c8c___testsigset_L000001_2 ' (symbol refcount = 0)
