...
C_gmtime ' <symbol:gmtime>
 ...
 word I16A_RDLONG + (r13)<<D16A + (r23)<<S16A ' reg <- INDIRU4 reg
 alignl ' align long
 long I32_LODS + (r15)<<D32S + ((1970)&$7FFFF)<<S32 ' reg <- cons
...
C_gmtime_11
 alignl ' align long
 long I32_LODS + (r11)<<D32S + ((366)&$7FFFF)<<S32 ' reg <- cons
 alignl ' align long
 long I32_JMPA + (@C_gmtime_10)<<S32 ' JUMPV addrg
 alignl ' align long
C_gmtime_9
 alignl ' align long
 long I32_LODS + (r11)<<D32S + ((365)&$7FFFF)<<S32 ' reg <- cons
 alignl ' align long
C_gmtime_10
 word I16A_MOV + (r22)<<D16A + (r11)<<S16A ' CVI, CVU or LOAD
 word I16A_SUB + (r17)<<D16A + (r22)<<S16A ' SUBU (1)
...
C_gmtime_13
 ...
 word I16A_SUBS + (r20)<<D16A + (r15)<<S16A
