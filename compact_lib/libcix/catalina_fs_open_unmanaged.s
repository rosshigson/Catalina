...
C__open_unmanaged_11
 ...
 alignl ' align long
 long I32_BR_B + (@C__open_unmanaged_16)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C__open_unmanaged_2)<<S32 ' JUMPV addrg
...
C__open_unmanaged_14
 ...
 alignl ' align long
 long I32_BRNZ + (@C__open_unmanaged_11)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (28)<<S16A ' reg <- coni
 word I16A_MOV + (r0)<<D16A + (r22)<<S16A ' setup r0/r1 (2)
 word I16A_MOV + (r1)<<D16A + (r17)<<S16A ' setup r0/r1 (2)
 word I16B_MULT ' MULT(I/U)
 ...
 alignl ' align long
 long I32_BR_Z + (@C__open_unmanaged_18)<<S32 ' EQU4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C__open_unmanaged_2)<<S32 ' JUMPV addrg
