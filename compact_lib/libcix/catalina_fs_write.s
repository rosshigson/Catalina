...
C__write_5
 ...
 alignl ' align long
 long @C___iotab+24 ' reg ARG ADDRG
...
C__write_3
 ...
 alignl ' align long
 long I32_BRNZ + (@C__write_10)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r17)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C__write_15)<<S32 ' JUMPV addrg
 alignl ' align long
C__write_12
 word I16B_LODL + (r2)<<D16B
 alignl ' align long
 long @C___iotab+48 ' reg ARG ADDRG
 word I16A_MOV + (r22)<<D16A + (r17)<<S16A ' ADDI/P
 word I16A_ADDS + (r22)<<D16A + (r21)<<S16A ' ADDI/P (3)
 word I16A_RDBYTE + (r22)<<D16A + (r22)<<S16A ' reg <- INDIRU1 reg
 word I16A_MOV + (r3)<<D16A + (r22)<<S16A ' CVUI
...
C__write_15
 word I16A_CMPS + (r17)<<D16A + (r19)<<S16A
 alignl ' align long
 long I32_BR_B + (@C__write_12)<<S32 ' LTI4 reg reg
 word I16A_MOV + (r0)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
 long I32_JMPA + (@C__write_2)<<S32 ' JUMPV addrg
 alignl ' align long
C__write_10
 ...
 alignl ' align long
 long I32_BRNZ + (@C__write_17)<<S32 ' NEI4 reg coni
 alignl ' align long
