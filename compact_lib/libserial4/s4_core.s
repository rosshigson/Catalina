...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sclg_616ac8ed_rxbase_L000002 ' <symbol:rxbase>
 long $0

 alignl ' align long
C_sclg1_616ac8ed_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_sclg2_616ac8ed_initialize_L000004 ' <symbol:initialize>
 alignl ' align long
 long I32_NEWF + 8<<S32
 alignl ' align long
 long I32_PSHM + $540000<<S32 ' save registers
 alignl ' align long
 long I32_LODI + (@C_sclg_616ac8ed_rxbase_L000002)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRP4 addrg
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sclg2_616ac8ed_initialize_L000004_6)<<S32 ' NEU4 reg coni
 ...
 alignl ' align long
 long I32_BR_B + (@C_sclg2_616ac8ed_initialize_L000004_8)<<S32 ' LTI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODA + (@C_sclg_616ac8ed_rxbase_L000002)<<S32
 word I16A_WRLONG + (r20)<<D16A + RI<<S16A ' ASGNP4 addrg reg
 word I16B_LODL + (r20)<<D16B
 alignl ' align long
 long @C_sclg1_616ac8ed_lock_L000003 ' reg <- addrg
 word I16A_SHRI + (r22)<<D16A + (24)<<S16A ' SHRU4 reg coni
 alignl ' align long
 long I32_LODA + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 word I16A_RDLONG + (r22)<<D16A + (r20)<<S16A ' reg <- INDIRI4 reg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sclg2_616ac8ed_initialize_L000004_10)<<S32 ' NEI4 reg coni
 alignl ' align long
 ...
 alignl ' align long
 long I32_LODI + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_sclg2_616ac8ed_initialize_L000004_11)<<S32 ' LTI4 reg coni
 word I16B_LODF + ((-8)&$1FF)<<S16B
 word I16A_RDLONG + (r22)<<D16A + RI<<S16A ' reg <- INDIRU4 addrl16
 alignl ' align long
 long I32_LODI + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 ...
 alignl ' align long
 long I32_JMPA + (@C_sclg2_616ac8ed_initialize_L000004_11)<<S32 ' JUMPV addrg
 alignl ' align long
C_sclg2_616ac8ed_initialize_L000004_10
 ...
 word I16A_WRLONG + (r22)<<D16A + RI<<S16A ' ASGNI4 addrg reg
 alignl ' align long
C_sclg2_616ac8ed_initialize_L000004_11
 alignl ' align long
C_sclg2_616ac8ed_initialize_L000004_8
 alignl ' align long
C_sclg2_616ac8ed_initialize_L000004_6
' C_sclg2_616ac8ed_initialize_L000004_5 ' (symbol refcount = 0)
...
C_s4_rxflush ' <symbol:s4_rxflush>
 ...
 alignl ' align long
 long I32_CALA + (@C_sclg2_616ac8ed_initialize_L000004)<<S32 ' CALL addrg
 alignl ' align long
C_s4_rxflush_15
...
C_s4_rx ' <symbol:s4_rx>
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s4_rx_37)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_CALA + (@C_sclg2_616ac8ed_initialize_L000004)<<S32 ' CALL addrg
 alignl ' align long
C_s4_rx_37
 word I16A_CMPI + (r23)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s4_rx_42)<<S32 ' LEU4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_s4_rx_36)<<S32 ' JUMPV addrg
 alignl ' align long
C_s4_rx_41
 alignl ' align long
C_s4_rx_42
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s4_rx_41)<<S32 ' LTI4 reg coni
...
C_s4_tx ' <symbol:s4_tx>
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s4_tx_45)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_CALA + (@C_sclg2_616ac8ed_initialize_L000004)<<S32 ' CALL addrg
 alignl ' align long
C_s4_tx_45
 word I16A_CMPI + (r23)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s4_tx_47)<<S32 ' LEU4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_s4_tx_44)<<S32 ' JUMPV addrg
 alignl ' align long
C_s4_tx_47
 alignl ' align long
 long I32_LODI + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s4_tx_55)<<S32 ' LTI4 reg coni
 alignl ' align long
C_s4_tx_51
...
C_s4_tx_55
 ...
 word I16A_CMPS + (r18)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s4_tx_54)<<S32 ' EQI4 reg reg
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 alignl ' align long
 long I32_LODI + (@C_sclg_616ac8ed_rxbase_L000002)<<S32
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s4_tx_57)<<S32 ' EQI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
...
C_s4_tx_57
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s4_tx_59)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_s4_txflush ' <symbol:s4_txflush>
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s4_txflush_62)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_CALA + (@C_sclg2_616ac8ed_initialize_L000004)<<S32 ' CALL addrg
 alignl ' align long
C_s4_txflush_62
 word I16A_CMPI + (r23)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s4_txflush_64)<<S32 ' LEU4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_s4_txflush_61)<<S32 ' JUMPV addrg
 alignl ' align long
C_s4_txflush_64
 alignl ' align long
 long I32_LODI + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s4_txflush_72)<<S32 ' LTI4 reg coni
 alignl ' align long
C_s4_txflush_68
' C_s4_txflush_69 ' (symbol refcount = 0)
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s4_txflush_68)<<S32 ' EQI4 reg coni
 alignl ' align long
C_s4_txflush_71
 alignl ' align long
C_s4_txflush_72
 ...
 word I16A_CMPS + (r18)<<D16A + (r22)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s4_txflush_71)<<S32 ' NEI4 reg reg
 alignl ' align long
 long I32_LODI + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 word I16A_MOV + (r22)<<D16A + RI<<S16A ' reg <- INDIRI4 addrg
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s4_txflush_74)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
...
C_s4_txcheck ' <symbol:s4_txcheck>
 ...
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_s4_txcheck_77)<<S32 ' NEU4 reg coni
 alignl ' align long
 long I32_CALA + (@C_sclg2_616ac8ed_initialize_L000004)<<S32 ' CALL addrg
 alignl ' align long
C_s4_txcheck_77
 word I16A_CMPI + (r23)<<D16A + (3)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_s4_txcheck_79)<<S32 ' LEU4 reg coni
 alignl ' align long
 long I32_LODS + R0<<D32S + ((-1)&$7FFFF)<<S32 ' RET cons
 alignl ' align long
 long I32_JMPA + (@C_s4_txcheck_76)<<S32 ' JUMPV addrg
 alignl ' align long
C_s4_txcheck_79
 alignl ' align long
 long I32_LODI + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s4_txcheck_81)<<S32 ' LTI4 reg coni
 alignl ' align long
C_s4_txcheck_83
' C_s4_txcheck_84 ' (symbol refcount = 0)
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_s4_txcheck_83)<<S32 ' EQI4 reg coni
 alignl ' align long
C_s4_txcheck_81
 word I16A_MOV + (r22)<<D16A + (r23)<<S16A
 word I16A_SHLI + (r22)<<D16A + (2)<<S16A ' SHLU4 reg coni
 ...
 word I16A_CMPSI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_B + (@C_s4_txcheck_86)<<S32 ' LTI4 reg coni
 alignl ' align long
 long I32_LODI + (@C_sclg1_616ac8ed_lock_L000003)<<S32
 word I16A_MOV + (r2)<<D16A + RI<<S16A ' reg ARG INDIR ADDRG
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
