...
'
 ...
 alignl ' align long
C_sjmo_619c5668_isspace_L000001 ' <symbol:isspace>
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_Z + (@C_sjmo_619c5668_isspace_L000001_8)<<S32 ' EQI4 reg coni
 ...
 alignl ' align long
 long I32_BRNZ + (@C_sjmo_619c5668_isspace_L000001_4)<<S32 ' NEI4 reg coni
 alignl ' align long
C_sjmo_619c5668_isspace_L000001_8
 word I16A_MOVI + (r23)<<D16A + (1)<<S16A ' reg <- coni
 alignl ' align long
 long I32_JMPA + (@C_sjmo_619c5668_isspace_L000001_5)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjmo_619c5668_isspace_L000001_4
 word I16A_MOVI + (r23)<<D16A + (0)<<S16A ' reg <- coni
 alignl ' align long
C_sjmo_619c5668_isspace_L000001_5
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sjmo_619c5668_isspace_L000001_2 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjmo1_619c5668_trim_L000009 ' <symbol:trim>
 alignl ' align long
 long I32_PSHM + $c00000<<S32 ' save registers
 word I16A_MOV + (r23)<<D16A + (r2)<<S16A ' reg var <- reg arg
 alignl ' align long
 long I32_JMPA + (@C_sjmo1_619c5668_trim_L000009_12)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjmo1_619c5668_trim_L000009_11
 word I16A_ADDSI + (r23)<<D16A + (1)<<S16A ' ADDP4 reg coni
 alignl ' align long
C_sjmo1_619c5668_trim_L000009_12
 ...
 alignl ' align long
 long I32_CALA + (@C_sjmo_619c5668_isspace_L000001)<<S32 ' CALL addrg
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjmo1_619c5668_trim_L000009_11)<<S32 ' NEI4 reg coni
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sjmo1_619c5668_trim_L000009_10 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long

 alignl ' align long
C_sjmo2_619c5668__scanf_gets_L000014 ' <symbol:_scanf_gets>
 alignl ' align long
 ...
 alignl ' align long
 long I32_JMPA + (@C_sjmo2_619c5668__scanf_gets_L000014_17)<<S32 ' JUMPV addrg
 alignl ' align long
C_sjmo2_619c5668__scanf_gets_L000014_16
 ...
 alignl ' align long
C_sjmo2_619c5668__scanf_gets_L000014_17
 word I16A_MOV + (r22)<<D16A + (r19)<<S16A ' CVI, CVU or LOAD
 word I16A_MOV + (r19)<<D16A + (r22)<<S16A
 word I16A_SUBI + (r19)<<D16A + (1)<<S16A ' SUBU4 reg coni
 word I16A_CMPI + (r22)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjmo2_619c5668__scanf_gets_L000014_19)<<S32 ' EQU4 reg coni
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjmo2_619c5668__scanf_gets_L000014_16)<<S32 ' NEI4 reg coni
 word I16A_RDBYTE + (r22)<<D16A + (r23)<<S16A ' reg <- INDIRU1 reg
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVUI
 word I16B_TRN1 + (r2)<<D16B ' zero extend
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 ...
 word I16A_CMPSI + (r0)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BR_Z + (@C_sjmo2_619c5668__scanf_gets_L000014_16)<<S32 ' EQI4 reg coni
 alignl ' align long
C_sjmo2_619c5668__scanf_gets_L000014_19
 word I16A_CMPSI + (r17)<<D16A + (0)<<S16A
 alignl ' align long
 long I32_BRNZ + (@C_sjmo2_619c5668__scanf_gets_L000014_20)<<S32 ' NEI4 reg coni
 word I16A_MOVI + (r22)<<D16A + (0)<<S16A ' reg <- coni
 word I16A_WRBYTE + (r22)<<D16A + (r21)<<S16A ' ASGNU1 reg reg
 alignl ' align long
C_sjmo2_619c5668__scanf_gets_L000014_20
 word I16A_MOV + (r0)<<D16A + (r23)<<S16A ' CVI, CVU or LOAD
' C_sjmo2_619c5668__scanf_gets_L000014_15 ' (symbol refcount = 0)
 word I16B_POPM + $80<<S16B ' restore registers, do not pop frame, do return
 alignl ' align long
...
C__doscanf_23
 ...
 word I16A_MOVI + BC<<D16A + 4<<S16A ' arg size, rpsize = 4, spsize = 4
 alignl ' align long
 long I32_CALA + (@C_sjmo1_619c5668_trim_L000009)<<S32 ' CALL addrg
...
C__doscanf_46
 ...
 alignl ' align long
 long I32_CALA + (@C_sjmo2_619c5668__scanf_gets_L000014)<<S32
