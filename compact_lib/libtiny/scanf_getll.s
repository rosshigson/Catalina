...
'
 ...
 alignl ' align long
C_sgo0_6132d15e_charT_oI_nt_L000001 ' <symbol:charToInt>
 alignl ' align long
 ...
 alignl ' align long
 long I32_BR_B + (@C_sgo0_6132d15e_charT_oI_nt_L000001_3)<<S32 ' LTI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_SUBSI + (r22)<<D16A + (7)<<S16A ' SUBI4 reg coni
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_sgo0_6132d15e_charT_oI_nt_L000001_3
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 word I16A_CMPSI + (r22)<<D16A + (15)<<S16A
 alignl ' align long
 long I32_BRBE + (@C_sgo0_6132d15e_charT_oI_nt_L000001_5)<<S32 ' LEI4 reg coni
 word I16A_MOV + (r22)<<D16A + (r2)<<S16A ' CVUI
 word I16B_TRN1 + (r22)<<D16B ' zero extend
 alignl ' align long
 ...
 word I16A_MOV + (r2)<<D16A + (r22)<<S16A ' CVI, CVU or LOAD
 alignl ' align long
C_sgo0_6132d15e_charT_oI_nt_L000001_5
 word I16A_MOV + (r0)<<D16A + (r2)<<S16A ' CVUI
 word I16B_TRN1 + (r0)<<D16B ' zero extend
' C_sgo0_6132d15e_charT_oI_nt_L000001_2 ' (symbol refcount = 0)
...
C__scanf_getll_19
 ...
 alignl ' align long
 long I32_CALA + (@C_sgo0_6132d15e_charT_oI_nt_L000001)<<S32 ' CALL addrg
