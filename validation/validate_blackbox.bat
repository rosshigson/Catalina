...
call compile_and_debug_xmm_p1 %1 test_suite -ltiny -lc -C SMALL
call compile_and_debug_xmm_p1 %1 test_suite -ltiny -lc -C LARGE

call compile_and_debug_p1 %1 test_suite -lc 
call compile_and_debug_p1 %1 test_suite -lc -C COMPACT
call compile_and_debug_xmm_p1 %1 test_suite -lc -C SMALL
call compile_and_debug_xmm_p1 %1 test_suite -lc -C LARGE

call compile_and_debug_p1 %1 test_suite -lci 
call compile_and_debug_p1 %1 test_suite -lci -C COMPACT
call compile_and_debug_xmm_p1 %1 test_suite -lci -C SMALL
call compile_and_debug_xmm_p1 %1 test_suite -lci -C LARGE

call compile_and_debug_p1 %1 test_suite -lcix 
call compile_and_debug_p1 %1 test_suite -lcix -C COMPACT
call compile_and_debug_xmm_p1 %1 test_suite -lcix -C SMALL
call compile_and_debug_xmm_p1 %1 test_suite -lcix -C LARGE

call compile_and_debug_p1 %1 test_suite -lcx 
call compile_and_debug_p1 %1 test_suite -lcx -C COMPACT
call compile_and_debug_xmm_p1 %1 test_suite -lcx -C SMALL
call compile_and_debug_xmm_p1 %1 test_suite -lcx -C LARGE
