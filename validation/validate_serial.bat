...
call compile_and_run_p2 %1 test_dosfs -C SD -O2 -lcx -lm 
...
call compile_and_run_p2 %1 test_dosfs -C SD -O3 -lcx -lm 
...
call compile_and_run_p2 %1 test_dosfs -C SD -O4 -lcx -lm 
...
call compile_and_run_p2 %1 test_dosfs -C SD -O5 -lcx -lm 
