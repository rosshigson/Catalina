...
'-------------------------------------------------------------------------------
'
' Catalina_Common - Common definitions for the minimal Catalina LMM target.
' 
'                   This file also contains routines for setting up and using 
'                   the registry from Spin.
'
'                   The file Custom_DEf.inc (included by this file) must be 
'                   configured to suit your propeller platform.
'
' Version 3.1 - Simplified version
' Version 3.3 - Bring into line with default target
' Version 3.10 - Added LMM_TTY, LMM_VGI, LMM_VDB, LMM_SPI
...
' Include basic definitions and constants for the custom platform
'
...
CGI_DATA        = PROXY_XFER - 4               ' $7E44 CHECK cgi_data.e
'
...
'
' Now resume defining Loadtime Hub Layout (note overlap with registry!!!):
'
...
SVC_RTC_DEBUG    = 44 ' LMM_RTC 10 or RTC_FIL 10
SVC_RTC_SETFREQ  = 45 ' LMM_RTC 6 or RTC_FIL 6
SVC_RTC_GETCLOCK = 46 ' LMM_RTC 7 or RTC_FIL 7
SVC_RTC_SETTIME  = 47 ' LMM_RTC 8 or RTC_FIL 8
SVC_RTC_GETTIME  = 48 ' LMM_RTC 9 or RTC_FIL 9
...
'
SVC_RESERVED     = 64 ' Services 1..64 reserved for Catalina
'
