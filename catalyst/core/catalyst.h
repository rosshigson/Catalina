...
#if defined(__CATALINA_PC)||defined(__CATALINA_TTY)||defined(__CATALINA_TTY256)
#define SERIAL_HMI
#endif
...
/*
 * This section contains options that MUST MATCH Catalina_Common.spin. 
 *
 * *** DO NOT change them here without also changing that file!!! ***
 *
...
// these must match Catalina_constants.inc
#define MAX_COGS        16
