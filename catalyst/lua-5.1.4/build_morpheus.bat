...
set CATALINA_DEFINE=MORPHEUS CPU_2 PC VT100 PROXY_SD PROXY_KEYBOARD PROXY_SCREEN NO_MOUSE CLOCK %1 %2 %3 %4 %5
make -f Makefile.Catalina clean
make -f Makefile.Catalina
call unset CATALINA_DEFINE

call build_pasm_tmp_var %1 %2 %3 %4 %5
spinnaker -p -a "%TMP_LCCDIR%\utilities\Generic_Proxy_Server" -o proxy -I "%TMP_LCCDIR%\target" -b -D MORPHEUS -D CPU_1 -D PC -D NO_MOUSE %TMP_VAR%
cd ..
