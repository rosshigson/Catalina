...
#ifndef lint
static char *sccsid = "@(#)normal.c	2.43 (Chris & John Downey) 8/12/94";
#endif
...
#ifdef CATALINA
 /* K_PGUP */	do_page,		COMMAND,
 /* K_PGDOWN */	do_page,		COMMAND,
 /* K_END */	do_HLM,		COMMAND | TARGET | TGT_LINE | TGT_INCLUSIVE,
#endif 
};
