...
C_itoa ' <symbol:itoa>
 ...
 mov r19, ##@C_s264_619c5703_itoa_buf_L000001+12-1 ' reg <- addrg
 mov r22, #0 ' reg <- coni
 mov RI, FP
 sub RI, #-(-4)
...
' C_itoa_2 ' (symbol refcount = 0)
 ...
 alignl ' align long
C_s2641_619c5703_N_anO_rI_nf_L000012 ' <symbol:NanOrInf>
 PRIMITIVE(#NEWF)
 sub SP, #4
 PRIMITIVE(#PSHM)
 ...
 cmp r20, r22 wz
 if_nz jmp #\C_s2641_619c5703_N_anO_rI_nf_L000012_14  ' NEU4
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_s2641_619c5703_N_anO_rI_nf_L000012_16  ' NEU4
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 ...
 and r22, r20 ' BANDI/U (1)
 cmp r22,  #0 wz
 if_z jmp #\C_s2641_619c5703_N_anO_rI_nf_L000012_18 ' EQU4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r21, r22
 adds r21, #1 ' ADDP4 coni
 mov r20, #45 ' reg <- coni
 wrbyte r20, r22 ' ASGNU1 reg reg
C_s2641_619c5703_N_anO_rI_nf_L000012_18
 mov r2, ##@C_s2641_619c5703_N_anO_rI_nf_L000012_20_L000021 ' reg ARG ADDRG
 ...
 jmp #\@C_s2641_619c5703_N_anO_rI_nf_L000012_13 ' JUMPV addrg
C_s2641_619c5703_N_anO_rI_nf_L000012_16
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, ##$80000000 ' reg <- con
 and r22, r20 ' BANDI/U (1)
 cmp r22,  #0 wz
 if_z jmp #\C_s2641_619c5703_N_anO_rI_nf_L000012_22 ' EQU4
 mov r22, r21 ' CVI, CVU or LOAD
 mov r21, r22
 adds r21, #1 ' ADDP4 coni
 mov r20, #45 ' reg <- coni
 wrbyte r20, r22 ' ASGNU1 reg reg
C_s2641_619c5703_N_anO_rI_nf_L000012_22
 mov r2, ##@C_s2641_619c5703_N_anO_rI_nf_L000012_24_L000025 ' reg ARG ADDRG
 mov r3, r21 ' CVI, CVU or LOAD
 mov BC, #8 ' arg size, rpsize = 8, spsize = 8
 sub SP, #4 ' stack space for reg ARGs
 PRIMITIVE(#CALA)
 ...
 adds r0, #3 ' ADDP4 coni
 jmp #\@C_s2641_619c5703_N_anO_rI_nf_L000012_13 ' JUMPV addrg
C_s2641_619c5703_N_anO_rI_nf_L000012_14
 mov r0, ##0 ' RET con
C_s2641_619c5703_N_anO_rI_nf_L000012_13
 PRIMITIVE(#POPM) ' restore registers
 add SP, #4 ' framesize
 PRIMITIVE(#RETF)
...
C_t_float_27
 ...
 sub SP, #4 ' stack space for reg ARGs
 PRIMITIVE(#CALA)
 long @C_s2641_619c5703_N_anO_rI_nf_L000012
 add SP, #4 ' CALL addrg
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_s264_619c5703_itoa_buf_L000001 ' <symbol:itoa_buf>
 byte 0[12]
...
C_t_float_33_L000034 ' <symbol:33>
 ...
 alignl ' align long
C_s2641_619c5703_N_anO_rI_nf_L000012_24_L000025 ' <symbol:24>
 byte 110
 byte 97
 byte 110
 byte 0
 ...
 alignl ' align long
C_s2641_619c5703_N_anO_rI_nf_L000012_20_L000021 ' <symbol:20>
 byte 105
 byte 110
 byte 102
 byte 0
