...
C_fseek ' <symbol:fseek>
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_fseek_2 ' EQI4
 cmps r19,  #1 wz
 if_nz jmp #\C_fseek_4 ' NEI4
 mov r22, r23
 adds r22, #16 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRP4 reg
 cmp r22,  #0 wz
 if_z jmp #\C_fseek_4 ' EQU4
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRI4 reg
...
C_fseek_8
 ...
 mov r20, ##-1 ' reg <- con
 cmps r22, r20 wz
 if_nz jmp #\C_fseek_11 ' NEI4
 mov r17, ##-1 ' reg <- con
 jmp #\@C_fseek_12 ' JUMPV addrg
C_fseek_11
 mov r17, #0 ' reg <- coni
C_fseek_12
