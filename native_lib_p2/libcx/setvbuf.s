...
C_setvbuf_10
 ...
 cmps r19,  #4 wz
 if_z jmp #\C_setvbuf_12 ' EQI4
 cmp r17,  #0 wz
 if_z jmp #\C_setvbuf_16 ' EQU4
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_setvbuf_14  ' NEU4
C_setvbuf_16
 mov r22, ##-1 ' reg <- con
 mov RI, FP
 sub RI, #-(-4)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #\@C_setvbuf_15 ' JUMPV addrg
C_setvbuf_14
 mov r22, r23
 adds r22, #8 ' ADDP4 coni
 rdlong r20, r22 ' reg <- INDIRI4 reg
...
C_setvbuf_12
 ...
 mov r22, r21 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_setvbuf_17  ' NEU4
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
 mov r20, #1 ' reg <- coni
 wrlong r20, r22 ' ASGNI4 reg reg
 jmp #\@C_setvbuf_18 ' JUMPV addrg
C_setvbuf_17
 mov r22, r23
 adds r22, #12 ' ADDP4 coni
