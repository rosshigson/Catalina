...
C_realloc ' <symbol:realloc>
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C_realloc_4  ' NEU4
 mov r2, r21 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 PRIMITIVE(#CALA)
 long @C_malloc ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
 jmp #\@C_realloc_3 ' JUMPV addrg
C_realloc_4
 cmp r21,  #0 wz
 if_nz jmp #\C_realloc_6  ' NEU4
...
C_realloc_6
 ...
 cmp r21,  #8 wcz 
 if_ae jmp #\C_realloc_8 ' GEU4
 mov r21, #8 ' reg <- coni
 jmp #\@C_realloc_9 ' JUMPV addrg
C_realloc_8
 mov r22, r21
...
C_realloc_13
 ...
 cmp r22, r20 wz
 if_nz jmp #\C_realloc_12  ' NEU4
 rdlong r13, r13 ' reg <- INDIRP4 reg
 mov r22, r11 ' CVI, CVU or LOAD
 cmp r22,  #0 wz
 if_nz jmp #\C_realloc_15  ' NEU4
 mov r22, ##-8 ' reg <- con
 adds r22, r19 ' ADDI/P (2)
 rdlong r22, r22 ' reg <- INDIRU4 reg
 sub r22, #8 ' SUBU4 coni
...
C_realloc_17
 ...
 cmp r21, r15 wcz 
 if_be jmp #\C_realloc_19 ' LEU4
 mov r22, r19 ' CVI, CVU or LOAD
 mov r20, ##@C_ml_last
 rdlong r20, r20 ' reg <- INDIRP4 addrg
 cmp r22, r20 wz
 if_nz jmp #\C_realloc_22  ' NEU4
 mov r13, #1 ' reg <- coni
 jmp #\@C_realloc_23 ' JUMPV addrg
C_realloc_22
 mov r13, #0 ' reg <- coni
C_realloc_23
 mov r22, #0 ' reg <- coni
 cmps r13, r22 wz
 if_nz jmp #\C_realloc_19 ' NEI4
 mov r20, ##-8 ' reg <- con
 mov r18, r19 ' ADDI/P
