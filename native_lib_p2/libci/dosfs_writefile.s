...
C_D_F_S__W_riteF_ile ' <symbol:DFS_WriteFile>
 ...
 cmps r22,  #0 wz
 if_nz jmp #\C_D_F_S__W_riteF_ile_5 ' NEI4
 mov r0, ##$ffffffff ' RET con
 jmp #\@C_D_F_S__W_riteF_ile_4 ' JUMPV addrg
C_D_F_S__W_riteF_ile_5
 mov r15, r17 ' CVI, CVU or LOAD
 mov r22, #0 ' reg <- coni
 wrlong r22, r19 ' ASGNU4 reg reg
 jmp #\@C_D_F_S__W_riteF_ile_8 ' JUMPV addrg
C_D_F_S__W_riteF_ile_7
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_D_F_S__W_riteF_ile_11 ' EQI4
 ...
 cmp r15, r22 wcz 
 if_b jmp #\C_D_F_S__W_riteF_ile_15 ' LTU4
 mov r22, r9 ' CVUI
 ...
 add SP, #8 ' CALL addrg
 cmp r13,  #0 wz
 if_nz jmp #\C_D_F_S__W_riteF_ile_17  ' NEU4
 mov r2, #1 ' reg ARG coni
 mov r3, r11 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov r22, FP
...
C_D_F_S__W_riteF_ile_17
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r20, r22 wcz 
 if_ae jmp #\C_D_F_S__W_riteF_ile_19 ' GEU4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r20, r22
...
C_D_F_S__W_riteF_ile_19
 ...
 subs r22, r20 ' SUBI/P (1)
 sub r15, r22 ' SUBU (1)
 jmp #\@C_D_F_S__W_riteF_ile_12 ' JUMPV addrg
C_D_F_S__W_riteF_ile_15
 ...
 add SP, #8 ' CALL addrg
 cmp r13,  #0 wz
 if_nz jmp #\C_D_F_S__W_riteF_ile_21  ' NEU4
 mov r2, #1 ' reg ARG coni
 mov r3, r11 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov r22, FP
...
C_D_F_S__W_riteF_ile_21
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r20, r22 wcz 
 if_ae jmp #\C_D_F_S__W_riteF_ile_23 ' GEU4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r20, r22
...
C_D_F_S__W_riteF_ile_11
 mov r22, ##512 ' reg <- con
 cmp r15, r22 wcz 
 if_b jmp #\C_D_F_S__W_riteF_ile_25 ' LTU4
 mov r2, #1 ' reg ARG coni
 mov r3, r11 ' CVI, CVU or LOAD
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r20, r22 wcz 
 if_ae jmp #\C_D_F_S__W_riteF_ile_27 ' GEU4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r20, r22
...
C_D_F_S__W_riteF_ile_27
 ...
 sub RI, #-(-4)
 wrlong r22, RI ' ASGNU4 addrli reg
 jmp #\@C_D_F_S__W_riteF_ile_26 ' JUMPV addrg
C_D_F_S__W_riteF_ile_25
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r20, r22 wcz 
 if_ae jmp #\C_D_F_S__W_riteF_ile_29 ' GEU4
 mov r2, #1 ' reg ARG coni
 mov r3, r11 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov r22, FP
 ...
 mov r13, r0 ' CVI, CVU or LOAD
 cmp r13,  #0 wz
 if_nz jmp #\C_D_F_S__W_riteF_ile_30  ' NEU4
 mov r2, r15 ' CVI, CVU or LOAD
 mov r3, r21 ' CVI, CVU or LOAD
 mov r4, r23 ' CVI, CVU or LOAD
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 ...
 add SP, #12 ' CALL addrg
 mov r13, r0 ' CVI, CVU or LOAD
 jmp #\@C_D_F_S__W_riteF_ile_30 ' JUMPV addrg
...
C_D_F_S__W_riteF_ile_30
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r20, r22 wcz 
 if_ae jmp #\C_D_F_S__W_riteF_ile_33 ' GEU4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r20, r22
...
C_D_F_S__W_riteF_ile_12
 ...
 rdlong r20, r20 ' reg <- INDIRI4 reg
 cmps r22, r20 wz
 if_z jmp #\C_D_F_S__W_riteF_ile_35 ' EQI4
 mov r22, #0 ' reg <- coni
 mov RI, FP
 sub RI, #-(-4)
 wrlong r22, RI ' ASGNU4 addrli reg
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_D_F_S__W_riteF_ile_37 ' NEI4
 mov r0, #7 ' reg <- coni
 jmp #\@C_D_F_S__W_riteF_ile_4 ' JUMPV addrg
C_D_F_S__W_riteF_ile_37
 ...
 rdbyte r18, r18 ' reg <- CVUI4 INDIRU1 reg
 cmps r18, r20 wz
 if_nz jmp #\C_D_F_S__W_riteF_ile_42 ' NEI4
 adds r22, #20 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, ##$fff8 ' reg <- con
 cmp r22, r20 wcz 
 if_ae jmp #\C_D_F_S__W_riteF_ile_41 ' GEU4
C_D_F_S__W_riteF_ile_42
 ...
 rdbyte r20, r20 ' reg <- CVUI4 INDIRU1 reg
 cmps r20,  #2 wz
 if_nz jmp #\C_D_F_S__W_riteF_ile_39 ' NEI4
 adds r22, #20 ' ADDP4 coni
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, ##$ffffff8 ' reg <- con
 cmp r22, r20 wcz 
 if_b jmp #\C_D_F_S__W_riteF_ile_39 ' LTU4
C_D_F_S__W_riteF_ile_41
 ...
 cmp r7, r22 wz
 if_nz jmp #\C_D_F_S__W_riteF_ile_43  ' NEU4
 mov r0, ##$ffffffff ' RET con
 jmp #\@C_D_F_S__W_riteF_ile_4 ' JUMPV addrg
C_D_F_S__W_riteF_ile_43
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #1 wz
 if_z jmp #\C_D_F_S__W_riteF_ile_48 ' EQI4
 cmps r22,  #2 wz
 if_z jmp #\C_D_F_S__W_riteF_ile_49 ' EQI4
 jmp #\@C_D_F_S__W_riteF_ile_45 ' JUMPV addrg
C_D_F_S__W_riteF_ile_48
 mov r7, ##$fff8 ' reg <- con
 jmp #\@C_D_F_S__W_riteF_ile_46 ' JUMPV addrg
C_D_F_S__W_riteF_ile_49
 mov r7, ##$ffffff8 ' reg <- con
 jmp #\@C_D_F_S__W_riteF_ile_46 ' JUMPV addrg
...
C_D_F_S__W_riteF_ile_8
 mov r22, #0 ' reg <- coni
 cmp r15, r22 wz
 if_z jmp #\C_D_F_S__W_riteF_ile_50 ' EQU4
 cmp r13, r22 wz
 if_z jmp #\C_D_F_S__W_riteF_ile_7 ' EQU4
C_D_F_S__W_riteF_ile_50
 ...
 add SP, #12 ' CALL addrg
 cmp r0,  #0 wz
 if_z jmp #\C_D_F_S__W_riteF_ile_51 ' EQU4
 mov r0, ##$ffffffff ' RET con
 jmp #\@C_D_F_S__W_riteF_ile_4 ' JUMPV addrg
C_D_F_S__W_riteF_ile_51
 ...
 add SP, #12 ' CALL addrg
 cmp r0,  #0 wz
 if_z jmp #\C_D_F_S__W_riteF_ile_53 ' EQU4
 mov r0, ##$ffffffff ' RET con
 jmp #\@C_D_F_S__W_riteF_ile_4 ' JUMPV addrg
