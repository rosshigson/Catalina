...
C__cgi_cog ' <symbol:_cgi_cog>
 ...
 alignl ' align long
C_sms0_619c56df_colors_L000004 ' <symbol:colors>
 long $0
 long $55555555
 long $aaaaaaaa
 long $ffffffff
 ...
 alignl ' align long
C_sms01_619c56df_font_L000005 ' <symbol:font>
 word $9d62
 word $112a
 word $b0e9
 word $31eb
...
C_g_setup ' <symbol:g_setup>
 ...
 mov r17, ##@C_G__V_A_R_+84 ' reg <- addrg
 ...
 wrlong r22, ##@C__display_base ' ASGNU4 addrg reg
 mov r2, r19 ' CVI, CVU or LOAD
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 PRIMITIVE(#CALA)
 long @C_cgi_bitmap_base ' CALL addrg
 mov r22, r0 ' CVI, CVU or LOAD
...
C_g_setup_11
 ...
 cmps r22,  #31 wcz
 if_ae jmp #\C_g_setup_14 ' GEI4
 mov r22, r11
 subs r22, #1 ' SUBI4 coni
 mov RI, FP
 sub RI, #-(-8)
 wrlong r22, RI ' ASGNI4 addrli reg
 jmp #\@C_g_setup_15 ' JUMPV addrg
C_g_setup_14
 mov r22, #31 ' reg <- coni
 mov RI, FP
 sub RI, #-(-8)
...
C_g_setup_15
 ...
 wrlong r22, ##@C_G__V_A_R_+8 ' ASGNI4 addrg reg
 #ifndef NO_INTERRUPTS
  stalli
 #endif
 qmul r11, r9 ' MULI4
 ...
 PRIMITIVE(#DIVS) ' DIVI
 wrlong r0, ##@C_G__V_A_R_+12 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+16 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+20 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+24 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
...
C_g_setup_26
 ...
 mov r18, ##@C_sms0_619c56df_colors_L000004 ' reg <- addrg
...
' C_g_setup_27 ' (symbol refcount = 0)
 ...
 mov r17, r22
 adds r17, #4 ' ADDP4 coni
 mov r20, ##@C_sms01_619c56df_font_L000005 ' reg <- addrg
