...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sdjc_5f5d7d4a_rxbase_L000002 ' <symbol:rxbase>
 long $0

 alignl ' align long
C_sdjc1_5f5d7d4a_lock_L000003 ' <symbol:lock>
 long -1
...
DAT ' code segment
 ...
 alignl ' align long
C_sdjc2_5f5d7d4a_initialize_L000004 ' <symbol:initialize>
 PRIMITIVE(#NEWF)
 sub SP, #8
 PRIMITIVE(#PSHM)
 long $540000 ' save registers
 mov r22, ##@C_sdjc_5f5d7d4a_rxbase_L000002
 rdlong r22, r22 ' reg <- INDIRP4 addrg
 cmp r22,  #0 wz
 if_nz jmp #\C_sdjc2_5f5d7d4a_initialize_L000004_6  ' NEU4
 ...
 cmps r22,  #0 wcz
 if_b jmp #\C_sdjc2_5f5d7d4a_initialize_L000004_8 ' LTI4
 ...
 wrlong r20, ##@C_sdjc_5f5d7d4a_rxbase_L000002 ' ASGNP4 addrg reg
 mov r20, ##@C_sdjc1_5f5d7d4a_lock_L000003 ' reg <- addrg
 shr r22, #24 ' RSHU4 coni
 wrlong r22, ##@C_sdjc1_5f5d7d4a_lock_L000003 ' ASGNI4 addrg reg
 rdlong r22, r20 ' reg <- INDIRI4 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_sdjc2_5f5d7d4a_initialize_L000004_10 ' NEI4
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C__locknew ' CALL addrg
 wrlong r0, ##@C_sdjc1_5f5d7d4a_lock_L000003 ' ASGNI4 addrg reg
 mov r22, ##@C_sdjc1_5f5d7d4a_lock_L000003
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_b jmp #\C_sdjc2_5f5d7d4a_initialize_L000004_11 ' LTI4
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRU4 reg
 mov r20, ##@C_sdjc1_5f5d7d4a_lock_L000003
 ...
 jmp #\@C_sdjc2_5f5d7d4a_initialize_L000004_11 ' JUMPV addrg
C_sdjc2_5f5d7d4a_initialize_L000004_10
 mov r22, ##@C_sdjc1_5f5d7d4a_lock_L000003 ' reg <- addrg
 rdlong r22, r22 ' reg <- INDIRI4 reg
 subs r22, #1 ' SUBI4 coni
 wrlong r22, ##@C_sdjc1_5f5d7d4a_lock_L000003 ' ASGNI4 addrg reg
C_sdjc2_5f5d7d4a_initialize_L000004_11
C_sdjc2_5f5d7d4a_initialize_L000004_8
C_sdjc2_5f5d7d4a_initialize_L000004_6
' C_sdjc2_5f5d7d4a_initialize_L000004_5 ' (symbol refcount = 0)
...
C_tty_rxflush ' <symbol:tty_rxflush>
 ...
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_sdjc2_5f5d7d4a_initialize_L000004 ' CALL addrg
C_tty_rxflush_17
C_tty_rxflush_18
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
...
C_tty_rxcheck_21
 ...
 mov r2, ##@C_sdjc1_5f5d7d4a_lock_L000003
 rdlong r2, r2
 ' reg ARG INDIR ADDRG
 mov BC, #4 ' arg size, rpsize = 4, spsize = 4
 PRIMITIVE(#CALA)
