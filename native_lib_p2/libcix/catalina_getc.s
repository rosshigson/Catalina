...
DAT ' initialized data segment
 ...
 alignl ' align long
C_sk68_6132d1fd_unget_count_L000002 ' <symbol:unget_count>
 long 0
...
C_catalina_getc ' <symbol:catalina_getc>
 ...
 mov r22, ##@C_sk68_6132d1fd_unget_count_L000002
 rdlong r22, r22 ' reg <- INDIRI4 addrg
 cmps r22,  #0 wcz
 if_be jmp #\C_catalina_getc_7 ' LEI4
 mov r22, ##@C_sk68_6132d1fd_unget_count_L000002 ' reg <- addrg
 rdlong r22, r22 ' reg <- INDIRI4 reg
 subs r22, #1 ' SUBI4 coni
 wrlong r22, ##@C_sk68_6132d1fd_unget_count_L000002 ' ASGNI4 addrg reg
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_sk681_6132d1fd_unget_buff_L000003 ' reg <- addrg
...
C_catalina_ungetc ' <symbol:catalina_ungetc>
 ...
 wrlong r20, ##@C_sk68_6132d1fd_unget_count_L000002 ' ASGNI4 addrg reg
 shl r22, #2 ' LSHI4 coni
 mov r20, ##@C_sk681_6132d1fd_unget_buff_L000003 ' reg <- addrg
 adds r22, r20 ' ADDI/P (1)
...
DAT ' uninitialized data segment
 ...
 alignl ' align long
C_sk681_6132d1fd_unget_buff_L000003 ' <symbol:unget_buff>
 byte 0[40]
