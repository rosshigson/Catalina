...
C_D_F_S__O_penF_ile_34
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_D_F_S__O_penF_ile_37  ' NEU4
 mov r22, r17
 ...
 add r20, r18 ' ADDU (1)
 wrlong r20, r22 ' ASGNU4 reg reg
 jmp #\@C_D_F_S__O_penF_ile_38 ' JUMPV addrg
...
C_D_F_S__O_penF_ile_38
 ...
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
 cmps r22,  #2 wz
 if_nz jmp #\C_D_F_S__O_penF_ile_42 ' NEI4
 mov r22, r17
 ...
 or r20, r18 ' BORI/U (1)
 wrlong r20, r22 ' ASGNU4 reg reg
 jmp #\@C_D_F_S__O_penF_ile_43 ' JUMPV addrg
...
C_D_F_S__O_penF_ile_30
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_D_F_S__O_penF_ile_54 ' EQI4
 mov r2, FP
 sub r2, #-(-32) ' reg ARG ADDRLi
 mov r3, FP
 sub r3, #-(-112) ' reg ARG ADDRLi
 ...
 cmps r0,  #0 wz
 if_z jmp #\C_D_F_S__O_penF_ile_56 ' EQI4
...
C_D_F_S__O_penF_ile_56
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #6 wz
 if_nz jmp #\C_D_F_S__O_penF_ile_68 ' NEI4
 mov r22, FP
 sub r22, #-(-21) ' reg <- addrli
 rdbyte r22, r22 ' reg <- CVUI4 INDIRU1 reg
...
C_D_F_S__O_penF_ile_68
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #0 wz
 if_nz jmp #\C_D_F_S__O_penF_ile_75  ' NEU4
 mov r22, r17
 adds r22, #4 ' ADDP4 coni
 mov r20, FP
 add r20, #8 ' reg <- addrfi
 ...
 add r20, r18 ' ADDU (1)
 wrlong r20, r22 ' ASGNU4 reg reg
 jmp #\@C_D_F_S__O_penF_ile_76 ' JUMPV addrg
...
C_D_F_S__O_penF_ile_76
 ...
 add SP, #12 ' CALL addrg
 cmp r0,  #0 wz
 if_z jmp #\C_D_F_S__O_penF_ile_80 ' EQU4
 mov r0, ##$ffffffff ' RET con
 jmp #\@C_D_F_S__O_penF_ile_4 ' JUMPV addrg
C_D_F_S__O_penF_ile_80
 ...
 add SP, #12 ' CALL addrg
 cmp r0,  #0 wz
 if_z jmp #\C_D_F_S__O_penF_ile_83 ' EQU4
 mov r0, ##$ffffffff ' RET con
 jmp #\@C_D_F_S__O_penF_ile_4 ' JUMPV addrg
C_D_F_S__O_penF_ile_83
 ...
 cmps r11,  #0 wz
 if_z jmp #\C_D_F_S__O_penF_ile_88 ' EQI4
 cmps r11,  #1 wz
 if_z jmp #\C_D_F_S__O_penF_ile_89 ' EQI4
 cmps r11,  #2 wz
 if_z jmp #\C_D_F_S__O_penF_ile_90 ' EQI4
 jmp #\@C_D_F_S__O_penF_ile_85 ' JUMPV addrg
C_D_F_S__O_penF_ile_88
 mov r0, #7 ' reg <- coni
 jmp #\@C_D_F_S__O_penF_ile_4 ' JUMPV addrg
C_D_F_S__O_penF_ile_89
 mov r13, ##$fff8 ' reg <- con
 jmp #\@C_D_F_S__O_penF_ile_86 ' JUMPV addrg
...
C_D_F_S__O_penF_ile_86
 ...
 and r22, cviu_m1 ' zero extend
 cmps r22,  #6 wz
 if_nz jmp #\C_D_F_S__O_penF_ile_91 ' NEI4
 mov r22, FP
 add r22, #8 ' reg <- addrfi
 rdlong r22, r22 ' reg <- INDIRP4 reg
 mov r20, r17
 ...
 rdlong r22, r22 ' reg <- INDIRU4 reg
 cmp r22,  #2 wcz 
 if_a jmp #\C_D_F_S__O_penF_ile_93 ' GTU4
 mov r22, #0 ' reg <- coni
 mov RI, FP
 sub RI, #-(-128)
 wrlong r22, RI ' ASGNU4 addrli reg
C_D_F_S__O_penF_ile_93
 ...
 long @C_memset
 add SP, #8 ' CALL addrg
 jmp #\@C_D_F_S__O_penF_ile_98 ' JUMPV addrg
...
C_D_F_S__O_penF_ile_98
 cmp r9, r7 wcz 
 if_a jmp #\C_D_F_S__O_penF_ile_95 ' GTU4
 mov r2, #11 ' reg ARG coni
 mov r3, ##@C_D_F_S__O_penF_ile_99_L000100 ' reg ARG ADDRG
 mov r4, FP
 sub r4, #-(-32) ' reg ARG ADDRLi
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
 ...
 add SP, #8 ' CALL addrg
 mov r2, #11 ' reg ARG coni
 mov r3, ##@C_D_F_S__O_penF_ile_105_L000106 ' reg ARG ADDRG
 mov r4, FP
 sub r4, #-(-32) ' reg ARG ADDRLi
 mov BC, #12 ' arg size, rpsize = 12, spsize = 12
 sub SP, #8 ' stack space for reg ARGs
