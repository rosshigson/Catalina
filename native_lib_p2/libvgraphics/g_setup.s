...
C__vdb_cog ' <symbol:_vdb_cog>
 ...
 alignl ' align long
C_sdpo_619c56e0_font_L000004 ' <symbol:font>
 word $9d62
 word $112a
 word $b0e9
 word $31eb
...
C_g_setup ' <symbol:g_setup>
 ...
 mov r15, ##@C_G__V_A_R_+96 ' reg <- addrg
 ...
 wrlong r22, ##@C__vgi_cog ' ASGNI4 addrg reg
 ...
 mov r22, r0
 adds r22, #128 ' ADDI4 coni
 wrlong r22, ##@C__vdb_cog ' ASGNI4 addrg reg
 mov BC, #0 ' arg size, rpsize = 0, spsize = 0
 PRIMITIVE(#CALA)
 long @C_cgi_display_base ' CALL addrg
 wrlong r0, ##@C__display_base ' ASGNP4 addrg reg
 mov r22, FP
...
C_g_setup_10
 cmps r7, r19 wcz
 if_b jmp #\C_g_setup_7 ' LTI4
 mov r11, #0 ' reg <- coni
 jmp #\@C_g_setup_14 ' JUMPV addrg
C_g_setup_11
 mov r13, #0 ' reg <- coni
 jmp #\@C_g_setup_18 ' JUMPV addrg
C_g_setup_15
 #ifndef NO_INTERRUPTS
  stalli
 #endif
...
C_g_setup_22
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r7, r22 wcz
 if_b jmp #\C_g_setup_19 ' LTI4
 mov r7, #0 ' reg <- coni
 jmp #\@C_g_setup_26 ' JUMPV addrg
C_g_setup_23
 mov r22, r9
 shl r22, #6 ' LSHI4 coni
 #ifndef NO_INTERRUPTS
 ...
 mov r18, ##@C_G__V_A_R_+164 ' reg <- addrg
 adds r20, r18 ' ADDI/P (1)
...
C_g_setup_30
 ...
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r7, r22 wcz
 if_b jmp #\C_g_setup_23 ' LTI4
 mov r22, FP
 sub r22, #-(-32) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 wrword r22, ##@C_G__V_A_R_ ' ASGNI2 addrg reg
 mov r22, FP
 sub r22, #-(-4) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 wrword r22, ##@C_G__V_A_R_+2 ' ASGNI2 addrg reg
 mov r22, r9 ' CVI, CVU or LOAD
 wrword r22, ##@C_G__V_A_R_+4 ' ASGNI2 addrg reg
 mov r22, FP
 sub r22, #-(-36) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 reg
 wrlong r22, ##@C_G__V_A_R_+8 ' ASGNP4 addrg reg
 mov r22, FP
 sub r22, #-(-8) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 reg
 wrlong r22, ##@C_G__V_A_R_+12 ' ASGNP4 addrg reg
 mov r22, FP
 sub r22, #-(-12) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 reg
 wrlong r22, ##@C_G__V_A_R_+16 ' ASGNP4 addrg reg
 mov r22, FP
 sub r22, #-(-16) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRP4 reg
 wrlong r22, ##@C_G__V_A_R_+20 ' ASGNP4 addrg reg
 wrlong r17, ##@C_G__V_A_R_+24 ' ASGNP4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+28 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+32 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+36 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+40 ' ASGNI4 addrg reg
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+44 ' ASGNI4 addrg reg
 shl r9, #4 ' LSHI4 coni
 mov r22, r9 ' SUBI/P
 ...
 mov r22, #0 ' reg <- coni
 wrlong r22, ##@C_G__V_A_R_+80 ' ASGNI4 addrg reg
 mov r22, FP
 sub r22, #-(-32) ' reg <- addrli
 rdlong r22, r22 ' reg <- INDIRI4 reg
 cmps r22,  #0 wz
 if_nz jmp #\C_g_setup_44 ' NEI4
 mov r22, ##$ffffffff ' reg <- con
 wrlong r22, ##@C_G__V_A_R_+80+4 ' ASGNI4 addrg reg
 mov r22, ##$ffffffff ' reg <- con
 wrlong r22, ##@C_G__V_A_R_+80+8 ' ASGNI4 addrg reg
 mov r22, ##$ffffffff ' reg <- con
 wrlong r22, ##@C_G__V_A_R_+80+12 ' ASGNI4 addrg reg
 jmp #\@C_g_setup_45 ' JUMPV addrg
C_g_setup_44
 mov r22, ##1431655765 ' reg <- con
 wrlong r22, ##@C_G__V_A_R_+80+4 ' ASGNI4 addrg reg
 mov r22, ##$aaaaaaaa ' reg <- con
 wrlong r22, ##@C_G__V_A_R_+80+8 ' ASGNI4 addrg reg
 mov r22, ##$ffffffff ' reg <- con
 wrlong r22, ##@C_G__V_A_R_+80+12 ' ASGNI4 addrg reg
C_g_setup_45
...
C_g_setup_58
 ...
 mov r18, ##@C_sdpo_619c56e0_font_L000004 ' reg <- addrg
 adds r22, r18 ' ADDI/P (1)
 rdword r22, r22 ' reg <- CVUI4 INDIRU2 reg
 wrword r22, r20 ' ASGNI2 reg reg
' C_g_setup_59 ' (symbol refcount = 0)
 adds r7, #1 ' ADDI4 coni
 cmps r7,  #183 wcz
 if_b jmp #\C_g_setup_58 ' LTI4
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #4 ' ADDP4 coni
 mov r20, ##@C_G__V_A_R_+364 ' reg <- addrg
 ...
 mov r15, r22
 adds r15, #4 ' ADDP4 coni
 mov r20, ##@C_G__V_A_R_+20 ' reg <- addrg
 wrlong r20, r22 ' ASGNI4 reg reg
 mov r22, r15 ' CVI, CVU or LOAD
 mov r15, r22
 adds r15, #4 ' ADDP4 coni
 mov r20, ##@C_G__V_A_R_+164 ' reg <- addrg
 wrlong r20, r22 ' ASGNI4 reg reg
 mov r22, ##@C_G__V_A_R_+48 ' reg <- addrg
