...
C_D_F_S__G_etP_tnS_tart ' <symbol:DFS_GetPtnStart>
 ...
 mov RI, FP
 add RI,#8
 wrbyte r22, RI ' ASGNU1 addrfi reg
 mov r13, #0 ' reg <- coni
 mov r22, FP
 ...
 cmps r22,  #3 wcz
 if_be jmp #\C_D_F_S__G_etP_tnS_tart_5 ' LEI4
 mov r0, ##$ffffffff ' RET con
 jmp #\@C_D_F_S__G_etP_tnS_tart_4 ' JUMPV addrg
C_D_F_S__G_etP_tnS_tart_5
 ...
 cmp r0,  #0 wz
 if_z jmp #\C_D_F_S__G_etP_tnS_tart_7 ' EQU4
 mov r0, ##$ffffffff ' RET con
 jmp #\@C_D_F_S__G_etP_tnS_tart_4 ' JUMPV addrg
C_D_F_S__G_etP_tnS_tart_7
 ...
 cmp r22,  #0 wz
 if_z jmp #\C_D_F_S__G_etP_tnS_tart_9 ' EQU4
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 shl r22, #4 ' LSHI4 coni
 mov r20, r15
...
C_D_F_S__G_etP_tnS_tart_9
 ...
 cmp r22,  #0 wz
 if_z jmp #\C_D_F_S__G_etP_tnS_tart_11 ' EQU4
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 shl r22, #4 ' LSHI4 coni
 mov r20, r15
...
C_D_F_S__G_etP_tnS_tart_11
 ...
 cmp r22,  #0 wz
 if_z jmp #\C_D_F_S__G_etP_tnS_tart_13 ' EQU4
 mov r22, r23 ' CVUI
 and r22, cviu_m1 ' zero extend
 shl r22, #4 ' LSHI4 coni
 mov r20, r15
