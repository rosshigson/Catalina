...
C__malloc_sell_out ' <symbol:_malloc_sell_out>
 ...
 mov r23, ##@C__malloc_store ' reg <- addrg
 jmp #\@C__malloc_sell_out_7 ' JUMPV addrg
C__malloc_sell_out_4
 rdlong r21, r23 ' reg <- INDIRP4 reg
 jmp #\@C__malloc_sell_out_10 ' JUMPV addrg
...
C__malloc_sell_out_10
 ...
 cmp r22,  #0 wz
 if_nz jmp #\C__malloc_sell_out_9  ' NEU4
' C__malloc_sell_out_5 ' (symbol refcount = 0)
 adds r23, #4 ' ADDP4 coni
C__malloc_sell_out_7
 mov r22, r23 ' CVI, CVU or LOAD
 mov r20, ##@C__malloc_store+128 ' reg <- addrg
 cmp r22, r20 wcz 
 if_b jmp #\C__malloc_sell_out_4 ' LTU4
 mov r0, #0 ' reg <- coni
