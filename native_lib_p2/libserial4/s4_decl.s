...
C_s4_decl ' <symbol:s4_decl>
 ...
 mov r11, #0 ' reg <- coni
 cmps r19,  #1 wcz
 if_ae jmp #\C_s4_decl_2 ' GEI4
 mov r19, #1 ' reg <- coni
C_s4_decl_2
 cmps r19,  #10 wcz
 if_be jmp #\C_s4_decl_4 ' LEI4
 mov r19, #10 ' reg <- coni
C_s4_decl_4
 cmps r21,  #0 wcz
 if_ae jmp #\C_s4_decl_6 ' GEI4
 neg r21, r21 ' NEGI4
...
C_s4_decl_6
 ...
 cmps r22,  #0 wz
 if_z jmp #\C_s4_decl_8 ' EQI4
 mov r22, #10 ' reg <- coni
 mov r13, r22 ' SUBI/P
 subs r13, r19 ' SUBI/P (3)
 jmp #\@C_s4_decl_13 ' JUMPV addrg
C_s4_decl_10
 mov r22, #10 ' reg <- coni
...
C_s4_decl_13
 cmps r13,  #0 wcz
 if_a jmp #\C_s4_decl_10 ' GTI4
C_s4_decl_8
 mov r13, #0 ' reg <- coni
 jmp #\@C_s4_decl_17 ' JUMPV addrg
C_s4_decl_14
 cmps r21, r15 wcz
 if_b jmp #\C_s4_decl_18 ' LTI4
 ...
 mov r11, ##-1 ' reg <- con
 jmp #\@C_s4_decl_19 ' JUMPV addrg
C_s4_decl_18
 cmps r15,  #1 wz
 if_z jmp #\C_s4_decl_23 ' EQI4
 mov r22, #0 ' reg <- coni
 cmps r11, r22 wz
 if_nz jmp #\C_s4_decl_23 ' NEI4
 mov r20, r17
 and r20, #2 ' BANDI4 coni
 cmps r20, r22 wz
 if_z jmp #\C_s4_decl_20 ' EQI4
C_s4_decl_23
 ...
 long @C_s4_tx
 add SP, #4 ' CALL addrg
 jmp #\@C_s4_decl_21 ' JUMPV addrg
C_s4_decl_20
 mov r22, r17
 and r22, #1 ' BANDI4 coni
 cmps r22,  #0 wz
 if_z jmp #\C_s4_decl_24 ' EQI4
