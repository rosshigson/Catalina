...
r16      sub     SP,#4          '$10 top of stack will be first thread block
r17      cogid   t1             '$11 set up ...
r18      shl     t1,#8          '$12 ... affinity, flags ...
r19      wrlong  t1,SP          '$13 ... and set ticks to zero
r20      sub     SP,#33*4       '$14 point to begining of thread block
...
kernel_init                     '
         rdword  reg,par        '$53 1 get registry address (used later)
         cogid   r1             '$54 2 calculate ...
         shl     r1,#2          '$55 3 ... our ...
         add     r1,reg         '$56 4 ... request block address
         rdword  req,r1         '$57 5 ... (used later) ...
         wrlong  req,r1         '$58 6 ... and register ourselves
         mov     r0,par         '$59 7 load my dynamic data block addr
         add     r0,#4          '$5a 8 point to initial PC
         rdlong  PC,r0          '$5b 9 load initial PC
         add     r0,#4          '$5c 10 point to initial SP
         rdlong  SP,r0          '$5d 11 load initial SP
         add     r0,#4          '$5e 12 point to argc/argv/return address
         rdlong  r3, r0         '$5f 13 set up argc
         add     r0, #4         '$60 14 set up ...
...
'
        ...
        org     $13c
'
' NOTE IF THESE CHANGE, CHANGE threads_compact_misc.e and catalina_threads.h !!!
'
