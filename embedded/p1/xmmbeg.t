...
#ifdef LARGE
'
' For the large address model, we force the code segment to start at $8000,
' plus the $0010 offset which is normal for LMM and small XMM programs.
' We fill this unused space with zeroes - it will be removed from the image
' later (to save space).
'
Catalina_Prologue_Pad
        byte $00[$8000 - @Catalina_Prologue_Pad - $0010]
#endif
'
