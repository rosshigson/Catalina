 ...
 *   is displayed, simply edit the build_all batch script (build_all.bat on   *
 *   Windows) and replace 0x7BAC with the correct address (which will be      *
 *   displayed by this program when run). Then rebuild the program and run    *
 *   it again. You may need to do this for each subsidiary program.           *
 *                                                                            *
