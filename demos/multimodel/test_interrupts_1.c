 ...
 *                                                                           *
 *    NOTE 1: This program will only work on the P2, since the P1 does not   *
 *            support interrupts.                                            *
 *                                                                           *
 *    NOTE 2: On the P2_EVAL we use 3 pins (56, 57 & 58) but on the          *
 *            P2_EDGE we only use 2 pins (38 & 39) since pin 40 is used      *
 *            by the PSRAM. On other platforms we use 3 pins (0, 1, 2)       *
 *                                                                           *
