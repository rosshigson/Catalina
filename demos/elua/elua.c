...
#pragma catapult common options(-W-w -p2 -C CONST_ARGS -C SIMPLE -C VT100 -C MHZ_200 -C CLOCK -lcx -lmc -llua linit.c -C LUA_SERVICE)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult secondary client(shared_data_t) address(0x15494) mode(CMM) stack(100000) options(-lthreads)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult primary server binary(elua) mode(XMM)
