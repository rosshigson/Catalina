...
#pragma catapult common options(-W-w -p2 -C CONST_ARGS -C SIMPLE -C VT100 -C CR_ON_LF -C MHZ_200 -C CLOCK -O5 -lcx -lmc -C ENABLE_PROPELLER)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult secondary client(shared_data_t) address(0x19BFC) mode(CMM) stack(100000) options(-llua -lthreads linit.c)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult primary server binary(elua) mode(XMM) options(-llua linit.c)
