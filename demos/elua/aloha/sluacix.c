#pragma catapult primary server binary(sluacix) mode(CMM) options(-W-w -p2 -O5 -lluax linit.c -C LUA_SERVICE dsptch_l.c aloha.c -lcix -lmc -lserial2 -C SIMPLE -C VT100 -C MHZ_200 -C CLOCK -C LUA_NO_OPT)
/******************************************************************************
