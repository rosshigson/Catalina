#pragma catapult primary server binary(sluacix) mode(CMM) options(-W-w -p2 -O5 -lluax iinit.c dsptch_l.c aloha.c -lcix -lmc -lserial2 -C SIMPLE -C VT100 -C CR_ON_LF -C MHZ_200 -C CLOCK)
/******************************************************************************
