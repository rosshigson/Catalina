...
#pragma catapult common options(-W-w -p2 -C CONST_ARGS -C SIMPLE -C VT100 -C MHZ_200 -C CLOCK -O5 -lcx -lmc -lserial8 -lwifi -llua linit.c -C LUA_SERVICE aloha.c)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult secondary client(shared_data_t) address(0x115F8) mode(CMM) stack(100000) options(-lthreads)
