 ...
 *                                                                            *
 *    rlua client.lua remote.lua                                              *
 *                                                                            *
 * And on the other Propeller, execute:                                       *
 *                                                                            *
 *    rlua remote.lua server.lua                                              *
 *                                                                            *
...
#pragma catapult common options(-W-w -p2 -C CONST_ARGS -C SIMPLE -C VT100 -C MHZ_200 -C CLOCK -O5 -lcx -lmc -lserial8 -lwifi -llua -C ENABLE_PROPELLER aloha.c linit.c)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult secondary client(shared_data_t) address(0xE760) mode(CMM) stack(120000) options(-lthreads)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult primary server binary(rlua) mode(XMM) options(dsptch_l.c)
