 ...
 *                                                                            *
 *    rluafx client.lux remote.lux                                            *
 *                                                                            *
 * And on the other Propeller, execute:                                       *
 *                                                                            *
 *    rluafx remote.lux server.lux                                            *
 *                                                                            *
...
#pragma catapult common options(-W-w -p2 -C CONST_ARGS -C SIMPLE -C VT100 -C MHZ_200 -C CLOCK -lcx -lmc -lluax linit.c -C LUA_SERVICE -C DISABLE_SERIAL -C PROTECT_PLUGINS)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult primary server binary(rluafx) mode(XMM) options(dsptch_l.c -lwifi -lserial2)
