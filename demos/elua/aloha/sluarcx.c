#pragma catapult primary server binary(sluarcx) mode(CMM) options(-W-w -p2 -O5 -lluax linit.c -C LUA_SERVICE dsptch_l.c -lcx -lmc -lwifi -lserial2 -C SIMPLE -C VT100 -C MHZ_200 -C CLOCK -C PROTECT_PLUGINS -C DISABLE_SERIAL)
/******************************************************************************
