#pragma catapult primary server binary(sluafx) mode(NMM) options(-W-w -p2 -O5 -lluax linit.c -C LUA_SERVICE dsptch_l.c aloha.c -lcx -lmc -lserial2 -C SIMPLE -C VT100 -C MHZ_200 -C CLOCK)
/******************************************************************************
