#pragma catapult primary server binary(sluafix) mode(NMM) options(-W-w -p2 -O5 -lluax linit.c -C LUA_SERVICE dsptch_l.c aloha.c -lcix -lmc -lserial2 -C MHZ_200 -C CLOCK -C LUA_NO_OPT)
/******************************************************************************
