...
#pragma catapult common options(-W-w -p2 -C CONST_ARGS -C SIMPLE -C VT100 -C CR_ON_LF -O5 -C MHZ_200 -C CLOCK -lcx -lmc -lserial2 -C ENABLE_PROPELLER -C ENABLE_HMI aloha.c)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult secondary client(shared_data_t) address(0x177DC) mode(CMM) stack(150000) options(-lluax -lthreads xinit.c)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult primary server binary(eluax) mode(XMM) options(-lluax xinit.c dsptch_l.c)
