#pragma catapult primary server binary(sluacx) mode(CMM) options(-W-w -p2 -O5 -lluax xinit.c dsptch_l.c aloha.c -lcx -lmc -lserial2 -C SIMPLE -C VT100 -C CR_ON_LF -C MHZ_200 -C CLOCK)
/******************************************************************************
