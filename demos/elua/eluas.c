...
#pragma catapult common options(-W-w -p2 -C CONST_ARGS -O5 -C MHZ_200 -C CLOCK -lcx -lmc -llua linit.c -C LUA_SERVICE)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult secondary client(shared_data_t) address(0x24FE8) mode(CMM) stack(80000)
