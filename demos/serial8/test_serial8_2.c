 ...
 * example:
 *
 *   catalina test_serial82.c -p2 -lci -lserial8 -C NO_HMI
 *
 */
...
void test_port (int PORT, int rx, int tx) {
   int ch = 0;
   int i;
   static char txbuff[BUFF_SIZE];
   static char rxbuff[BUFF_SIZE];
