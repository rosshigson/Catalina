 ...
 * tests one port at a time (as defined by PORT, below).
 *
 * NOTE:
 *
 ...
 * For example:
 *
 *   catalina test_serial8_1.c -p2 -lci -lserial8 -C NO_HMI
 *
 ...
 *
 *   catalina test_serial8_1.c -p2 -lci -lserial8 -lthreads -C LORES_VGA
 */
...
void main() {
   ...
   s8_openport(PORT, 230400, 0, 
       63, rxbuff, rxbuff+BUFF_SIZE, 
       62, txbuff, txbuff+BUFF_SIZE);
