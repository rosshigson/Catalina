...
echo.
echo   ERROR: The Multi Port Serial driver is not supported on the Propeller 1.
echo.
 
goto done

:build_p2
catalina -p2 -lci -lserial8 test_serial81.c -o test1 -C NO_HMI
catalina -p2 -lci -lserial8 test_serial82.c -o test2 -C NO_HMI
catalina -p2 -lci -lserial8 -lthreads test_serial81.c -o test3 -C LORES_VGA
