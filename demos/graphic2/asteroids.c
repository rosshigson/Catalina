...
//asteroids.c (note that the main program is in main.c)
...
void draw_asteroids(struct asteroid asteroids[], int size) {
	...
	for (i = 0; i < size; i++) {
		...
		if (asteroids[i].alive) {
			...
			draw_line(asteroids[i].world_vert[0].x, asteroids[i].world_vert[0].y, asteroids[i].world_vert[1].x, asteroids[i].world_vert[1].y, (int)asteroids[i].size+1);
			draw_line(asteroids[i].world_vert[1].x, asteroids[i].world_vert[1].y, asteroids[i].world_vert[2].x, asteroids[i].world_vert[2].y, (int)asteroids[i].size+1);
			draw_line(asteroids[i].world_vert[2].x, asteroids[i].world_vert[2].y, asteroids[i].world_vert[3].x, asteroids[i].world_vert[3].y, (int)asteroids[i].size+1);
			draw_line(asteroids[i].world_vert[3].x, asteroids[i].world_vert[3].y, asteroids[i].world_vert[4].x, asteroids[i].world_vert[4].y, (int)asteroids[i].size+1);
			draw_line(asteroids[i].world_vert[4].x, asteroids[i].world_vert[4].y, asteroids[i].world_vert[5].x, asteroids[i].world_vert[5].y, (int)asteroids[i].size+1);
			draw_line(asteroids[i].world_vert[5].x, asteroids[i].world_vert[5].y, asteroids[i].world_vert[6].x, asteroids[i].world_vert[6].y, (int)asteroids[i].size+1);
			draw_line(asteroids[i].world_vert[6].x, asteroids[i].world_vert[6].y, asteroids[i].world_vert[7].x, asteroids[i].world_vert[7].y, (int)asteroids[i].size+1);
			draw_line(asteroids[i].world_vert[7].x, asteroids[i].world_vert[7].y, asteroids[i].world_vert[8].x, asteroids[i].world_vert[8].y, (int)asteroids[i].size+1);
			draw_line(asteroids[i].world_vert[8].x, asteroids[i].world_vert[8].y, asteroids[i].world_vert[9].x, asteroids[i].world_vert[9].y, (int)asteroids[i].size+1);
			draw_line(asteroids[i].world_vert[9].x, asteroids[i].world_vert[9].y, asteroids[i].world_vert[0].x, asteroids[i].world_vert[0].y, (int)asteroids[i].size+1);
		}
		...
		draw_pixel(cpy.x, cpy.y, 0x00ff00ff);
		*/
	}
}
