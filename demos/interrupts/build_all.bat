...
echo.
echo ERROR: These programs require a Propeller 2
echo.

goto done

:build_p2
catalina -p2 -lci -linterrupts test_interrupts.c -C NO_MOUSE -C NO_FP 
catalina -p2 -lci -linterrupts -lthreads test_threads_and_interrupts.c -C NO_MOUSE -C NO_FP 
goto done
