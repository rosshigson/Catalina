/*
 * Simple argument processing test program.
 *
 ...
 *
 * Optinally add -C NO_ARGUMENTS to disable the display of arguments.
 * Optionally add -C DISPLAY_REGISTRY to enable the display of the registry.
 *
 * Note that NO_ARGUMENTS is not the same as NO_ARGS. The former disables only
