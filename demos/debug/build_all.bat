...
catalina debug_main.c debug_functions_1.c debug_functions_2.c -lci -g3 -o example
goto done

:build_p2
catalina -p2 debug_main.c debug_functions_1.c debug_functions_2.c -lci -g3 -o example
goto done
