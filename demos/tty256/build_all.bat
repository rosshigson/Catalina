...
echo.
echo    ======================
echo    BUILDING SERIAL4 DEMOS
echo    ======================
echo.

catalina -lci -ltty256 test_tty.c -o tty1 -C NO_HMI
catalina -lci -ltty256 -lthreads test_tty.c -o tty2 -C TV 

call build_pasm_tmp_var %1 %2 %3 %4 %5 %6 %7 %8 %9 
spinnaker -p -a -I "%TMP_LCCDIR%\target" test_tty.spin -b -o tty3 -D TTY_SPIN %TMP_VAR%
