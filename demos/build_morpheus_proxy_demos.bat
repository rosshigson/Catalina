...
REM
@echo.
catalina test_suite.c -o test_1_client_2 -lc -C MORPHEUS -C CPU_2 -C PROXY_KEYBOARD -C NO_MOUSE
@echo.
...
REM
@echo.
catalina test_terminal.c -o test_2_client_2 -lc -C MORPHEUS -C CPU_2 -C PROXY_KEYBOARD -C PROXY_MOUSE
@echo.
...
@echo.
catalina test_stdio_fs.c -lcx -C SMALL -o test_3_client_2 -C MORPHEUS -C CPU_2 -C PROXY_KEYBOARD -C PROXY_MOUSE -C PROXY_SD -C NO_FP -C NO_ARGS
@echo.
...
REM
@echo.
catalina test_suite.c -o test_4_client_1 -lc -C MORPHEUS -C CPU_1 -C PROXY_SCREEN
@echo.
