...
echo.
echo    ====================
echo    BUILDING SOUND DEMOS
echo    ====================
echo.

catalina sound_demo.c -lsound -lci -C NO_MOUSE -C NO_FLOAT
catalina -lci -lvgraphics -lsound spacewar.c -C NO_MOUSE -C NO_ARGS -C NO_HMI -C NO_INTERLACE -C NO_FLOAT -C NO_EXIT -C DOUBLE_BUFFER -O5 -C EEPROM
