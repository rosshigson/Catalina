/*
 * Simple WebSocket client test program. 
 *
 ...
 * the SERVER_IP (see below) IP address must be set to "192.168.4.1" since
 * this is the default IP address for the WiFi module in AP mode.
 *
...
#define SERVER_IP         "192.168.4.1" // IP address of Server propeller
