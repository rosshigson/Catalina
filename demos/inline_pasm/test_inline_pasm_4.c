 ...
 * - this  is because COMPACT mode requires a different PASM format. See the *
 * program test_inline_pasm_3.c for a version that works in other modes.     *
 *                                                                           *
 * Compile this program with a command like:                                 *
 *                                                                           *
 *   catalina -lci -C TTY -C C3 -C COMPACT test_inline_pasm_4.c              *
 *                                                                           *
 *****************************************************************************/
