...
echo.
echo    ===========================
echo    BUILDING MULTI-THREAD DEMOS
echo    ===========================
echo.
...
catalina -lci -lthreads dining_philosophers.c -C NO_MOUSE -C NO_FP 
catalina -lci -lthreads resource_thread_lock.c -C NO_MOUSE -C NO_FP 
catalina -lci -lthreads test_dynamic_kernel.c -C NO_MOUSE -C NO_FP 
catalina -lci -lthreads test_multiple_threads.c -C NO_MOUSE -C NO_FP 
catalina -lci -lthreads test_maximum_threads.c -C NO_MOUSE -C NO_FP
catalina -lci -lthreads test_thread_arguments.c -C NO_MOUSE -C NO_FP 
catalina -lci -lthreads test_thread_affinity.c -C NO_MOUSE -C NO_FP 
catalina -lci -lthreads test_thread_operations.c -C NO_MOUSE -C NO_FP 
goto done

:build_p2
catalina -p2 -lci -lthreads dining_philosophers.c -C NO_MOUSE -C NO_FP 
catalina -p2 -lci -lthreads resource_thread_lock.c -C NO_MOUSE -C NO_FP 
catalina -p2 -lci -lthreads test_dynamic_kernel.c -C NO_MOUSE -C NO_FP 
catalina -p2 -lci -lthreads test_multiple_threads.c -C NO_MOUSE -C NO_FP 
catalina -p2 -lci -lthreads test_maximum_threads.c -C NO_MOUSE -C NO_FP 
catalina -p2 -lci -lthreads test_thread_arguments.c -C NO_MOUSE -C NO_FP 
catalina -p2 -lci -lthreads test_thread_affinity.c -C NO_MOUSE -C NO_FP 
catalina -p2 -lci -lthreads test_thread_operations.c -C NO_MOUSE -C NO_FP 
goto done
