...
'
'
'  To use this module (assuming it is called Catalyst_Arguments, and that
...
'
'   Version 5.3 - update comments only.
}
...
' compiled using a SPIN compiler that supported "#include", such as the 
' HomeSpun or OpenSpin/Spinnaker SPIN compilers).
...
ARGV_ADDR  = $7E6C              ' address of argv will be saved in this WORD
