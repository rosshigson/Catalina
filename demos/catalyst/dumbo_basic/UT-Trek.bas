...
304  R1=INT(RND(1)*8+1)
306  R2=INT(RND(1)*8+1)
308  C2=R1
310  C3=R2
...
1225  D(I)=0
1230  NEXT I
1240  IF RND(1)>.20 THEN 1320
1250  R1=INT(RND(1)*7+1)
1260  IF RND(1)>.5 THEN 1300
1270  D(R1)=D(R1)-(RND(1)*5+1)
...
1499  Z2=0
1500  S1=INT(RND(1)*8+1)
1510  S2=INT(RND(1)*8+1)
1550  GOTO 400
...
3116  IF (M$ =" YES") OR (M$ = "yes") OR (M$ = "Y") or (M$ = "y") THEN 6500
3120  GOSUB 3460
3130  X=S1
3132  Y=S2
3134  P=P-1
...
5033  INPUT S$
5034  IF (S$<>"YES") AND (S$<>"yes") AND (S$<>"Y") AND (S$<>"y") THEN 5049
5035  A7=1
5036  N9=1
5038  GOTO 5110
5049  PRINT
...
7502  IF RND(1)>.15 THEN 7600
7504  GOTO 7508
7506  IF RND(1)>.10 THEN 7600
7508  Z3=INT(RND(1)*8+1)
7510  Z4=INT(RND(1)*8+1)
...
8155  PRINT
8160  GOTO 955
8200  RANDOMIZE RANDOM
8205  REM PRINT
8206  REM PRINT "   TYPE A WIERD NUMBER BETWEEN 0.0 AND 1.0 :";
8207  REM INPUT E6
8208  REM E9=RND(E6)
8210  RETURN
...
9010  R1=INT(RND(1)*8+1)
9020  R2=INT(RND(1)*8+1)
...
9163  PRINT "DO YOU NEED FURTHER INSTRUCTIONS (REVISED 18 APRIL 73) - TYPE YES or NO";
9164  INPUT A$
9166  PRINT
9170  IF (A$<>"YES") AND (A$<>"yes") AND (A$<>"Y") AND (A$<>"y") THEN 400
9175  GOSUB 9980
...
9995  INPUT A$
9996  IF (A$ = "YES") OR (A$ = "yes") OR (A$ = "Y") OR (A$ = "y") THEN 5
9997  PRINT
9998  PRINT "  ** AVE ATQUE VALE **"
9999  END

10200 REM PRINT N2 USING 4 CHARACTERS
10210 IF N2 >= 1000 GOTO 10270
10220 IF N2 >= 100 GOTO 10260
10230 IF N2 >= 10 GOTO 10250
10240 PRINT " ";
10250 PRINT " ";
10260 PRINT " ";
10270 PRINT N2;
