...
223 PRINT TAB(YY); "   '-------- --'      / /"
224 PRINT TAB(YY); "       ,---' '-------/ /--,"
225 PRINT TAB(YY); "        '----------------'" : PRINT : PRINT : FOR ZZ=1 TO 7 : PRINT CHR$(11); : NEXT ZZ : NEXT YY
...
1300 INPUT I5$ : IF LEFT$(I5$,1)="N" OR LEFT$(I5$,1)="n" THEN GOSUB 10000 ELSE IF LEFT$(I5$,1)="Y" OR LEFT$(I5$,1)="y" THEN 1310 ELSE 1280
1310 PRINT CHR$(26)
...
6330 INPUT "LET HIM STEP FORWARD AND ENTER 'AYE'";A$ : PRINT A$ : IF A$="AYE"THEN 10
...
6400 IF T = T0 GOTO 6290 : "YOUR EFFICIENCY RATING IS";1000*(K7/(T-T0))^2 : GOTO 6290
