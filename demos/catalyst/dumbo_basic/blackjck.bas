...
330 REM-- 11-21...SOFT or HARD 11-21
340 REM-- 22-32...SOFT 11-21
350 REM--  32+ ...BUSTED
360 Q=0 : Q1=0
370 FOR Q2=1 TO R(I)
380 X=P(I,Q2)
...
520 Q=Q+X1 : Q1=Q1+X1 : REM Q is soft, Q1 is hard
530 IF X1>1 GOTO 620 : REM not ace - check if busted
540 IF Q<=11 THEN Q=Q+10 : REM make ace soft
620 REM : PRINT "X=";X;"Q=";Q;"Q1=";Q1 : REM uncomment to print diagnostics
630 IF Q>31 OR Q1>21 THEN Q=-1 : REM busted
640 RETURN
...
1410 REM  I1$ and I2$ DEFINED ELSEWHERE
1420 H2 = 0 : INPUT H$: H$=LEFT$(H$,1)
1430 FOR H=1 TO H1 STEP 2
1440 IF H$=MID$(I1$,H,1) THEN H2 = H
1445 IF H$=MID$(I2$,H,1) THEN H2 = H
1450 NEXT H
1460 IF H2 > 0 THEN 1480 ELSE PRINT "TYPE ";MID$(I1$,1,H1-1);" OR ";MID$(I1$,H1,2);" PLEASE";
1470 GOTO 1420
1480 H=(H2+1)/2
1490 RETURN
...
1770 INPUT N
1775 PRINT
1780 IF N<1 OR N>7 OR N>INT(N) THEN PRINT "NUMBER OF PLAYERS MUST BE 1 TO 7" : GOTO 1760
...
1900 FOR I=1 TO N
1910 IF Z(I)<=0 OR Z(I)>500 THEN PRINT "BETS MUST BE BETWEEN 0 AND 500" : GOTO 1880
1920 B(I)=Z(I)
1930 NEXT I
1940 PRINT: PRINT "PLAYER";
1950 FOR I=1 TO N
1960 PRINT I;"   ";
1970 NEXT I
1980 PRINT "DEALER"
...
2180 FOR I=1 TO N
2190 IF Z(I)<0 OR Z(I)>B(I)/2 THEN PRINT "THIS INSURANCE BET MUST BE BETWEEN 0 AND "; B(I)/2 : GOTO 2160
2200 NEXT I
2210 FOR I=1 TO N
2220 S(I)=Z(I)*(3*(P(D1,2)>=10))-Z(I)
2230 NEXT I
...
2350 PRINT:REM--NOW PLAY THE HANDS
2360 FOR I=1 TO N
2370 PRINT "PLAYER";I;
2380 H1=7
2390 GOSUB 1410
...
3345 PRINT
3350 GOSUB 1200
3355 REM GOSUB 4000 ' REM uncomment to print diagnostics
3360 GOTO 1810
3400 AA=AA-10*(AA>=22): RETURN
3410 AB=AB-10*(AB>=22): RETURN
3420 AC=AC-10*(AC>=22): RETURN
4000 PRINT : REM diagnostic function - call to examine hands
4001 FOR II = 1 TO 15
4010 PRINT USING "##"; "P(";II;")=";
4020 FOR JJ = 1 TO 11
4030 PRINT USING "###";P(II,JJ);
4040 NEXT JJ
4050 PRINT
4060 NEXT II
4070 PRINT
