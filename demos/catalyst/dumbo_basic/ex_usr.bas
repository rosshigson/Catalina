...
15 '
16 ' See the file "example.pasm" for how the following data (which is our
17 ' compiled assembly language USR functions) was generated:
18 '

20 DATA &Hfd647258 : '  drvl #57         ' light LED to prove we were called
21 DATA &Hf6002c18 : '  mov r0,r2        ' divide arg ...
22 DATA &Hf0442c01 : '  shr r0,#1        ' ... by 2
23 DATA &Hfe000006 : '  PRIMITIVE(#RETN) ' and return

24 DATA &Hfd647458 : '  drvl #58         ' light LED to prove we were called
25 DATA &Hfac02c18 : '  rdbyte r0, r2    ' get first char of string ...
26 DATA &Hf1042c01 : '  add r0, #1       ' ... increment it ...
27 DATA &Hfc402c18 : '  wrbyte r0, r2    ' ... and save it back
28 DATA &Hf6002c18 : '  mov r0,r2        ' put string in r0
29 DATA &Hfe000006 : '  PRIMITIVE(#RETN) ' and return

40 ' Dimension an array of (integers) suitable for our program sizes:
41 '
42 DIM PROG%(10)
43 SIZE% = 10 ' Define this so we can use the correct size in the code below 
...
203 '
210 DEF USR0 = &H33918 : ' We get this value (i.e. @C_sqrt) from dbasic.lst
220 DEF USR1 = VARPTR(PROG%(1))
230 DEF USR2 = VARPTR(PROG%(5))
