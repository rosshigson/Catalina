...
220  INPUT U$
230  U$ = " " + U$ + " "
240  REM  GET RID OF APOSTROPHES, CONVERT TO UPPER CASE
250  I$=""
260  FOR L = 1 TO LEN(U$)
270  Z = ASC(MID$(U$,L,1))
280  IF Z = 39 THEN 320
290  IF Z < 97 THEN 310
300  Z = Z - 32
310  I$ = I$ + CHR$(Z)
320  NEXT L
330  IF LEFT$(I$, 9) <> " SHUT UP " THEN 340
331  PRINT "IF THAT'S HOW YOU FEEL--GOODBYE..."
332  STOP
340  IF I$ <> P$ THEN 370
...
540  L = T
550  GOTO 590
560 K = 37 : rem WE DIDN'T FIND ANY KEYWORDS
570 GOTO 850
580  REM
...
810  NEXT L
820  NEXT X
830  IF MID$(C$, 2, 1) = " " THEN C$ = MID$(C$, 2, LEN(C$) - 1) : rem ONLY 1SPACE
840  REM
...
890  READ Z$
900  NEXT X
910  FOR X = 1 TO R(K) : rem READ RIGHT REPLY
920  READ F$
930  NEXT X
940 R(K) = R(K) + 1
...
1090 C1$ = "IN BASIC"
1100 GOSUB 1030
1110 C1$ = "MODIFIED FROM CYBER 175 AT UNIVERSITY OF ILLINOIS"
1120 GOSUB 1030
...
1270 GOSUB 1030
1280  PRINT "< INITIALIZING - PLEASE WAIT ...>" : PRINT
1320  RETURN
1330  REM
