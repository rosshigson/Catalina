 ...
 * MOST OF THIS FILE IS GENERATED FROM tokenizer.pl USING PERL
 *
 * You can get ActivePerl for Windows from:
 *     http://www.activestate.com/activeperl/
 *
 * To create the contents of this "parse_token" procedure, run 
 * the tokenizer perl script as "perl tokenizer.pl > xxx" and
 ...
 *
 * 2. There are six places that must be manually amended:
 ...
 *    'E' 'O' 'F' should return xEOF - see line 451 below
 *    'I' 'N' 'P' 'U' 'T' should return INPUT - see line 677 below
 *    'V' 'A' 'R' 'P' 'T' 'R' should return INPUT - see line 1524 below
 ...
 * the "tokenizer.pl" script - then run the script. Note that
