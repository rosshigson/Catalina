...
call build_all %* VGA CR_ON_LF COLOR_4 OPTIMIZE MHZ_200 RTC NO_LINENOISE
...
cd xvi-2.51
call build_all  %* VGA CR_ON_LF COLOR_4 OPTIMIZE MHZ_200 LARGE
copy src\xvi.bin ..\image\bin\xl_vi.bin
cd ..

cd lua-5.4.8
call build_all  %* VGA CR_ON_LF COLOR_4 OPTIMIZE MHZ_200 SMALL
