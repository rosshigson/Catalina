...
make -B lburg -f makefile.mgw HOSTFILE=etc\\catalina_win32.c LCCDIR=%TMP_LCCDIR%
...
catalina -p2 -L %TMP_LIBPATH% -I ..\..\include -C CLOCK -C NO_KEYBOARD %EXTRA_OPTIONS% -o rcc -lrcc ..\src\main.c -I..\src -l%TMP_PSRAM% -lcx -y -u -O5
cd ..\..\..
