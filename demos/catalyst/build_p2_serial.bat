...
call build_all %* SIMPLE VT100 USE_COLOR OPTIMIZE MHZ_200 
...
cd xvi-2.51
call build_all %* SIMPLE VT100 USE_COLOR OPTIMIZE MHZ_200 LARGE
copy src\xvi.bin ..\image\bin\xl_vi.bin
cd ..

cd lua-5.4.8
call build_all %* SIMPLE VT100 USE_COLOR OPTIMIZE MHZ_200 SMALL
