...
echo.
echo    =======================
echo    BUILDING GRAPHICS DEMOS
echo    =======================
echo.

catalina -lci -lvgraphics spacewar.c -C NO_MOUSE -C NO_ARGS -C NO_HMI -C NO_FLOAT -C NO_EXIT -C COMPACT -C DOUBLE_BUFFER -O3

catalina -lci -lvgraphics graphics_demo.c -C NO_ARGS -C NO_HMI -C NO_FLOAT -C NO_EXIT -C COMPACT -C DOUBLE_BUFFER -O3

catalina -lci -lvgraphics catalina_4.c -C NO_HMI -C NO_FLOAT -C COMPACT -C NO_MOUSE -C NO_ARGS -C NO_EXIT -O3
