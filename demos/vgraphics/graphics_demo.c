#if defined(__CATALINA_libvgraphics)
#include <catalina_vgraphics.h>
#else
...
int main(void) {
  ...
  while (1) {
    ...
    g_textmode(1, 1, 6, 5);
#if defined(__CATALINA_libvgraphics) && !defined(__CATALINA_VGA_4_COLOR)
