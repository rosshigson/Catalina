...
//===================================================================
// 32-bit error codes
#define DOSFS_OK          0         // no error
#define DOSFS_EOF         1         // end of file (not an error)
#define DOSFS_WRITEPROT   2         // volume is write protected
#define DOSFS_NOTFOUND    3         // path or file not found
#define DOSFS_PATHLEN     4         // path too long
#define DOSFS_ALLOCNEW    5         // must allocate new directory cluster
#define DOSFS_ERRNAME     6         // name already exists, or is invalid
#define DOSFS_NOSUPPORT   7         // feature not supported
#define DOSFS_ERRMISC     0xffffffffUL // generic error

//===================================================================
// File access modes
#define DOSFS_READ       1         // read-only
#define DOSFS_WRITE      2         // write-only
#define DOSFS_OPENDIR    4         // open a directory for read 
#define DOSFS_CREATEDIR (2+4)      // create dir (NTRF100521)
...
*/
#define DOSFS_DI_BLANKENT   0x01   // Searching for blank entry
...
/*
	Delete a directory (note that it must already be empty, or you will lose
   clusters!)
	scratch must point to a sector-sized buffer
*/
uint32_t DOSFS_UnlinkDir(PVOLINFO volinfo, uint8_t *path, uint8_t *scratch);
