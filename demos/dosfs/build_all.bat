...
echo.
echo    ===========================
echo    BUILDING DOSFS TEST PROGRAM
echo    ===========================
echo.
...
@echo on
catalina test_dosfs.c -o test_dosfs dosfs.c dosfs_read.c dosfs_write.c dosfs_renamefile.c -C SD -lci
catalina test_dosfs.c -o test_dosfs dosfs.c dosfs_read.c dosfs_write.c dosfs_renamefile.c -C SD -lci -g3 -o debug_dosfs
@echo off
goto done

:build_p2
@echo on
catalina -p2 test_dosfs.c -o test_dosfs dosfs.c dosfs_read.c dosfs_write.c dosfs_renamefile.c -C SD -lci
catalina -p2 test_dosfs.c -o test_dosfs dosfs.c dosfs_read.c dosfs_write.c dosfs_renamefile.c -C SD -lci -g3 -o debug_dosfs
@echo off
goto done
