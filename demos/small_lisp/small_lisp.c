/* small_lisp.c: high-speed LISP interpreter */

/*
 * Original (lisp.c) by G J Chaitin.
 * 
 * Modified for Catalina by Ross Higson.
 * 
 * http://www.umcs.maine.edu/~chaitin/unknowable/ch2.html 
 *
 * If that site is no longer available, try ...
 * 
...
#define SIZE 1500 /* numbers of nodes of tree storage */

#elif defined(__CATALINA_NATIVE)

#define SIZE 10000 /* numbers of nodes of tree storage */

#else

#define SIZE 500 /* numbers of nodes of tree storage */
