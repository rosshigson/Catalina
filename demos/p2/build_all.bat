...
echo.
echo    =========================
echo    BUILDING PROPELLER2 DEMOS
echo    =========================
echo.
...
:build_p2
call p2_asm flash.pasm
bindump flash.bin -c -p 0x > flash.inc
catalina -p2 -lci test_p2.c utilities.c 
catalina -p2 -lci test_p2_smartpins.c  
catalina -p2 -lci test_p2_clock.c  
goto done
