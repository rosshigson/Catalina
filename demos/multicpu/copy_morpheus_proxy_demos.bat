...
copy test_2_client_2.binary %1T2_C.2
copy test_2_server_1.binary %1T2_S.1

copy test_3_client_2.binary %1T3_C.2
copy test_3_server_1.binary %1T3_S.1

copy test_4_client_1.binary %1%T4_C.1
copy test_4_server_2.binary %1%T4_S.2
:done
