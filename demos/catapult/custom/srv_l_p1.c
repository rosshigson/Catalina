 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult secondary hub_client(shared_data_t) address(0x6060) mode(CMM) stack(500)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult primary binary(srv_l_p1) mode(XMM) options(-C FLASH -C CACHED_1K -llua dispatch_lua.c linit.c)
...
char *lua_code = 
   ...
   "     return data(shared);"
   "   end"
   "   function func_7(c1, c2)" // example CHAR_2_SVC
   "     print('Hello World (from Lua func_7!)');"
   "     i = string.find(c1, c2);"
   "     if i then"
   "        return i;"
   "     else"
