 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult secondary hub_function(shared_data_t) mode(CMM) address(0x4A1C) stack(8000) options(-lci -lthreads -C NO_FLOAT)
 ...
 *                                                                            *
 ******************************************************************************/
#pragma catapult primary binary(lua_p1) mode(XMM) options(-W-w -C CACHED_1K -C FLASH -C CLOCK -lcx -llua linit.c)
