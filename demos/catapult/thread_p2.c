...
#pragma catapult secondary func_1 mode(CMM) address(0x77ECC) stack(1000)
...
#pragma catapult secondary func_2 mode(LMM) address(0x71FD0) stack(20000) options(-lthreads)
