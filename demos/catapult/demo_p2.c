/*
 * demo_p2.c : run secondary programs at a fixed Hub address.
 *             
...
#pragma catapult secondary func_1 mode(COMPACT) address(0x40000) stack(500)
...
#pragma catapult secondary func_2 mode(TINY) address(0x40000) stack(500)
